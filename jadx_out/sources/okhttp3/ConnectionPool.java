...
public final class ConnectionPool {
    ...
    public ConnectionPool(@l RealConnectionPool delegate) {
    ...
    public ConnectionPool(int i5, long j5, @l TimeUnit timeUnit) {
