...
public final class CipherSuite {
    ...
    public static final class Companion {
        ...
        public final CipherSuite init(String str, int i5) {
        ...
        private final String secondaryName(String str) {
            boolean s22;
            boolean s23;
            s22 = e0.s2(str, "TLS_", false, 2, null);
            if (s22) {
            ...
            s23 = e0.s2(str, "SSL_", false, 2, null);
            if (s23) {
        ...
        @l
        @m
        public final synchronized CipherSuite forJavaName(@l String javaName) {
    ...
    static {
        ...
        ORDER_BY_NAME = new Comparator<String>() { // from class: okhttp3.CipherSuite$Companion$ORDER_BY_NAME$1
            ...
            public int compare(@l String a5, @l String b5) {
                l0.p(a5, "a");
                l0.p(b5, "b");
    ...
    public /* synthetic */ CipherSuite(String str, w wVar) {
        this(str);
    }

    @l
    @m
    public static final synchronized CipherSuite forJavaName(@l String str) {
    ...
    public final String m6483deprecated_javaName() {
