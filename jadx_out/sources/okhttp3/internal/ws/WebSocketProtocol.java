...
public final class WebSocketProtocol {
    ...
    @l
    public final String acceptHeader(@l String key) {
        l0.p(key, "key");
        return n.Companion.l(key + ACCEPT_MAGIC).sha1().base64();
    }
    ...
    public final void toggleMask(@l l.a cursor, @p4.l byte[] key) {
        l0.p(cursor, "cursor");
        l0.p(key, "key");
        int length = key.length;
        int i5 = 0;
        do {
            byte[] bArr = cursor.f20993e;
            int i6 = cursor.f20994f;
            int i7 = cursor.f20995g;
            if (bArr != null) {
                while (i6 < i7) {
                    int i8 = i5 % length;
    ...
    public final void validateCloseCode(int i5) {
        ...
        l0.m(closeCodeExceptionMessage);
