...
public final class JavaNetAuthenticator implements Authenticator {
    ...
    public JavaNetAuthenticator(@l Dns defaultDns) {
    ...
    private final InetAddress connectToInetAddress(Proxy proxy, HttpUrl httpUrl, Dns dns) throws IOException {
        ...
        if (i5 == 1) {
            y22 = e0.y2(dns.lookup(httpUrl.host()));
    ...
    @m
    public Request authenticate(@m Route route, @l Response response) throws IOException {
        boolean z4;
        Proxy proxy;
        boolean K1;
        Dns dns;
        ...
        for (Challenge challenge : challenges) {
            K1 = kotlin.text.e0.K1("Basic", challenge.scheme(), true);
            if (K1) {
                ...
                if (z4) {
                    ...
                    l0.n(address2, "null cannot be cast to non-null type java.net.InetSocketAddress");
                ...
                if (requestPasswordAuthentication != null) {
                    if (z4) {
                        str = AUTH.PROXY_AUTH_RESP;
                    } else {
                        str = AUTH.WWW_AUTH_RESP;
                    }
    ...
    public /* synthetic */ JavaNetAuthenticator(Dns dns, int i5, w wVar) {
