...
public class IApplicationThreadICSMR1 {
    public static Class<?> TYPE = RefClass.load((Class<?>) IApplicationThreadICSMR1.class, "android.app.IApplicationThread");

    @MethodParams({IBinder.class, ServiceInfo.class, CompatibilityInfo.class})
    public static RefMethod<Void> scheduleCreateService;

    @MethodReflectParams({"android.content.Intent", "android.content.pm.ActivityInfo", "android.content.res.CompatibilityInfo", com.swift.sandhook.annotation.MethodReflectParams.INT, "java.lang.String", "android.os.Bundle", "boolean"})
