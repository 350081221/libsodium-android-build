...
public class PackageParserLollipop {
    public static Class<?> TYPE = RefClass.load((Class<?>) PackageParserLollipop.class, "android.content.pm.PackageParser");
    ...
    @MethodReflectParams({"android.content.pm.PackageParser$Package", "[I", com.swift.sandhook.annotation.MethodReflectParams.INT, com.swift.sandhook.annotation.MethodReflectParams.LONG, com.swift.sandhook.annotation.MethodReflectParams.LONG, "java.util.HashSet", "android.content.pm.PackageUserState"})
