...
public final class d2 implements Collection<c2>, w3.a {
    ...
    /* loaded from: classes3.dex */
    public static final class a implements Iterator<c2>, w3.a {
        ...
        public int a() {
            ...
            if (i5 >= iArr.length) {
                throw new NoSuchElementException(String.valueOf(this.f19243b));
            }
            this.f19243b = i5 + 1;
            return c2.l(iArr[i5]);
        }
        ...
        public boolean hasNext() {
            return this.f19243b < this.f19242a.length;
        }
    ...
    @p4.l
    @a1
    public static int[] g(@p4.l int[] storage) {
    ...
    public static boolean j(int[] iArr, int i5) {
        boolean q8;
        q8 = kotlin.collections.p.q8(iArr, i5);
        return q8;
    }
    ...
    */
    public static boolean k(int[] r4, @p4.l java.util.Collection<kotlin.c2> r5) {
        /*
        ...
        L16:
            ...
            boolean r2 = r0 instanceof kotlin.c2
            r3 = 0
            if (r2 == 0) goto L33
            kotlin.c2 r0 = (kotlin.c2) r0
            int r0 = r0.l0()
            boolean r0 = kotlin.collections.l.q8(r4, r0)
            if (r0 == 0) goto L33
            r0 = r1
            goto L34
        L33:
        ...
        L37:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.d2.k(int[], java.util.Collection):boolean");
    }

    public static boolean l(int[] iArr, Object obj) {
        return (obj instanceof d2) && kotlin.jvm.internal.l0.g(iArr, ((d2) obj).w());
    }
    ...
    @p4.l
    public static Iterator<c2> t(int[] iArr) {
        return new a(iArr);
    }

    public static final void u(int[] iArr, int i5, int i6) {
        iArr[i5] = i6;
    }
    ...
    public boolean containsAll(@p4.l Collection<? extends Object> elements) {
        ...
        return k(this.f19241a, elements);
    }

    @Override // java.util.Collection
    public boolean equals(Object obj) {
        return l(this.f19241a, obj);
    }

    @Override // java.util.Collection
    public int hashCode() {
        return r(this.f19241a);
    }

    public boolean i(int i5) {
        return j(this.f19241a, i5);
    }

    @Override // java.util.Collection
    public boolean isEmpty() {
        return s(this.f19241a);
    }
