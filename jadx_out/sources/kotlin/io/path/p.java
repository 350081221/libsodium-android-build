...
public interface p {
    void a(@p4.l v3.p<? super Path, ? super BasicFileAttributes, ? extends FileVisitResult> pVar);

    void b(@p4.l v3.p<? super Path, ? super IOException, ? extends FileVisitResult> pVar);

    void c(@p4.l v3.p<? super Path, ? super IOException, ? extends FileVisitResult> pVar);

    void d(@p4.l v3.p<? super Path, ? super BasicFileAttributes, ? extends FileVisitResult> pVar);
}
