...
public final class j<T> implements Collection<T>, w3.a {

    /* renamed from: a, reason: collision with root package name */
    @p4.l
    private final T[] f19138a;

    /* renamed from: b, reason: collision with root package name */
    private final boolean f19139b;

    public j(@p4.l T[] values, boolean z4) {
    ...
    public boolean isEmpty() {
        return this.f19138a.length == 0;
    }

    @Override // java.util.Collection, java.lang.Iterable
    @p4.l
    public Iterator<T> iterator() {
        return kotlin.jvm.internal.i.a(this.f19138a);
    }
    ...
    public final Object[] toArray() {
        return v.h(this.f19138a, this.f19139b);
    }
