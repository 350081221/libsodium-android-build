...
public final class g<V> extends kotlin.collections.e<V> implements Collection<V>, w3.b {

    /* renamed from: a, reason: collision with root package name */
    @l
    private final d<?, V> f19105a;

    public g(@l d<?, V> backing) {
        l0.p(backing, "backing");
        this.f19105a = backing;
    }
    ...
    public boolean contains(Object obj) {
        return this.f19105a.containsValue(obj);
    }
    ...
    public Iterator<V> iterator() {
        return this.f19105a.valuesIterator$kotlin_stdlib();
    }

    @Override // java.util.AbstractCollection, java.util.Collection
    public boolean remove(Object obj) {
        return this.f19105a.removeValue$kotlin_stdlib(obj);
    }

    @Override // java.util.AbstractCollection, java.util.Collection
    public boolean removeAll(@l Collection<? extends Object> elements) {
        l0.p(elements, "elements");
        this.f19105a.checkIsMutable$kotlin_stdlib();
