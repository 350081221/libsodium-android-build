...
public final class f<E> extends kotlin.collections.h<E> implements Set<E>, w3.h {

    /* renamed from: a, reason: collision with root package name */
    @l
    private final d<E, ?> f19104a;

    public f(@l d<E, ?> backing) {
        l0.p(backing, "backing");
        this.f19104a = backing;
    }
    ...
    public Iterator<E> iterator() {
        return this.f19104a.keysIterator$kotlin_stdlib();
    }

    @Override // java.util.AbstractCollection, java.util.Collection, java.util.Set
    public boolean remove(Object obj) {
        return this.f19104a.removeKey$kotlin_stdlib(obj) >= 0;
    }

    @Override // java.util.AbstractSet, java.util.AbstractCollection, java.util.Collection, java.util.Set
    public boolean removeAll(@l Collection<? extends Object> elements) {
        l0.p(elements, "elements");
        this.f19104a.checkIsMutable$kotlin_stdlib();
