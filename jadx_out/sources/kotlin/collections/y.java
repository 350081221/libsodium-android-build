...
public class y extends x {
    ...
    /* loaded from: classes3.dex */
    public static final class a<T> implements Iterator<T>, w3.a {

        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ Enumeration<T> f19192a;

        a(Enumeration<T> enumeration) {
            this.f19192a = enumeration;
        }

        @Override // java.util.Iterator
        public boolean hasNext() {
            return this.f19192a.hasMoreElements();
        }

        @Override // java.util.Iterator
        public T next() {
            return this.f19192a.nextElement();
        }
    ...
    @p4.l
    public static <T> Iterator<T> c0(@p4.l Enumeration<T> enumeration) {
