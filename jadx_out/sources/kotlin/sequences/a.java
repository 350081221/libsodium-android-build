...
public final class a<T> implements m<T> {
    ...
    @p4.l
    private final AtomicReference<m<T>> f19601a;

    public a(@p4.l m<? extends T> sequence) {
        l0.p(sequence, "sequence");
        this.f19601a = new AtomicReference<>(sequence);
    }

    @Override // kotlin.sequences.m
    @p4.l
    public Iterator<T> iterator() {
        m<T> andSet = this.f19601a.getAndSet(null);
        if (andSet != null) {
