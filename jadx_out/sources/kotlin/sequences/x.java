...
public final class x<T> implements m<T> {
    ...
    @p4.l
    private final m<T> f19682a;

    /* renamed from: b, reason: collision with root package name */
    @p4.l
    private final v3.l<T, Boolean> f19683b;
    ...
    public static final class a implements Iterator<T>, w3.a {
        ...
        /* renamed from: a, reason: collision with root package name */
        @p4.l
        private final Iterator<T> f19684a;
        ...
        final /* synthetic */ x<T> f19687d;

        a(x<T> xVar) {
            this.f19687d = xVar;
            this.f19684a = ((x) xVar).f19682a.iterator();
        }

        private final void a() {
            if (this.f19684a.hasNext()) {
                T next = this.f19684a.next();
                if (((Boolean) ((x) this.f19687d).f19683b.invoke(next)).booleanValue()) {
                    this.f19685b = 1;
                    this.f19686c = next;
                    return;
                }
    ...
    public x(@p4.l m<? extends T> sequence, @p4.l v3.l<? super T, Boolean> predicate) {
        l0.p(sequence, "sequence");
        l0.p(predicate, "predicate");
        this.f19682a = sequence;
        this.f19683b = predicate;
    }
