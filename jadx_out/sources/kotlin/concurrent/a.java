...
public final class a {
    @f
    private static final <T> T a(ReentrantReadWriteLock reentrantReadWriteLock, v3.a<? extends T> action) {
    ...
    @f
    private static final <T> T b(Lock lock, v3.a<? extends T> action) {
        l0.p(lock, "<this>");
        l0.p(action, "action");
        lock.lock();
        try {
    ...
    @f
    private static final <T> T c(ReentrantReadWriteLock reentrantReadWriteLock, v3.a<? extends T> action) {
        int i5;
        l0.p(reentrantReadWriteLock, "<this>");
        l0.p(action, "action");
        ReentrantReadWriteLock.ReadLock readLock = reentrantReadWriteLock.readLock();
