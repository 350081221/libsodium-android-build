...
public final class MediaBrowserCompat {
    ...
    private static class CustomActionResultReceiver extends ResultReceiver {
        ...
        protected void onReceiveResult(int i5, Bundle bundle) {
            ...
            if (i5 != -1) {
                if (i5 != 0) {
                    if (i5 != 1) {
                        Log.w(MediaBrowserCompat.TAG, "Unknown result code: " + i5 + " (extras=" + this.mExtras + ", resultData=" + bundle + ")");
                        return;
                    }
    ...
    public static class MediaBrowserImplBase implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
        ...
        public class MediaServiceConnection implements ServiceConnection {
            ...
            boolean isCurrent(String str) {
                ...
                if (mediaBrowserImplBase.mServiceConnection == this && (i5 = mediaBrowserImplBase.mState) != 0 && i5 != 1) {
                    return true;
                }
                int i6 = mediaBrowserImplBase.mState;
                if (i6 != 0 && i6 != 1) {
            ...
            public void onServiceConnected(final ComponentName componentName, final IBinder iBinder) {
                postOrRun(new Runnable() { // from class: android.support.v4.media.MediaBrowserCompat.MediaBrowserImplBase.MediaServiceConnection.1
                    @Override // java.lang.Runnable
                    public void run() {
                        boolean z4 = MediaBrowserCompat.DEBUG;
                        if (z4) {
                ...
                public void run() {
                    ...
                    if (mediaBrowserImplBase.mServiceBinderWrapper == null) {
                        if (mediaBrowserImplBase.mCallbacksMessenger == null) {
                            ...
                            try {
                                MediaBrowserImplBase mediaBrowserImplBase3 = MediaBrowserImplBase.this;
                                z4 = mediaBrowserImplBase3.mContext.bindService(intent, mediaBrowserImplBase3.mServiceConnection, 1);
        ...
        public void disconnect() {
            ...
            this.mHandler.post(new Runnable() { // from class: android.support.v4.media.MediaBrowserCompat.MediaBrowserImplBase.2
                ...
                public void run() {
                    ...
                    MediaBrowserImplBase mediaBrowserImplBase2 = MediaBrowserImplBase.this;
                    int i5 = mediaBrowserImplBase2.mState;
                    mediaBrowserImplBase2.forceCloseConnection();
                    if (i5 != 0) {
                        MediaBrowserImplBase.this.mState = i5;
                    }
                    if (MediaBrowserCompat.DEBUG) {
            ...
            try {
                for (Map.Entry<String, Subscription> entry : this.mSubscriptions.entrySet()) {
                    ...
                    for (int i5 = 0; i5 < callbacks.size(); i5++) {
                        this.mServiceBinderWrapper.addSubscription(key, callbacks.get(i5).mToken, optionsList.get(i5), this.mCallbacksMessenger);
                    }
                }
            } catch (RemoteException unused) {
    ...
    public static class ServiceBinderWrapper {
        ...
        private void sendRequest(int i5, Bundle bundle, Messenger messenger) throws RemoteException {
    ...
    public static class Subscription {
        ...
        public SubscriptionCallback getCallback(Bundle bundle) {
            for (int i5 = 0; i5 < this.mOptionsList.size(); i5++) {
                if (MediaBrowserCompatUtils.areSameOptions(this.mOptionsList.get(i5), bundle)) {
        ...
        public void putCallback(Bundle bundle, SubscriptionCallback subscriptionCallback) {
            for (int i5 = 0; i5 < this.mOptionsList.size(); i5++) {
                if (MediaBrowserCompatUtils.areSameOptions(this.mOptionsList.get(i5), bundle)) {
                    this.mCallbacks.set(i5, subscriptionCallback);
                    return;
                }
            }
