...
public class MediaSessionCompat {
    ...
    public static abstract class Callback {
        ...
        private class StubApi21 implements MediaSessionCompatApi21.Callback {
                ...
                try {
                    ...
                    if (str.equals(MediaControllerCompat.COMMAND_REMOVE_QUEUE_ITEM_AT)) {
                        ...
                        if (mediaSessionImplApi212 != null && mediaSessionImplApi212.mQueue != null) {
                            int i5 = bundle.getInt(MediaControllerCompat.COMMAND_ARGUMENT_INDEX, -1);
                            if (i5 >= 0 && i5 < mediaSessionImplApi212.mQueue.size()) {
                                queueItem = mediaSessionImplApi212.mQueue.get(i5);
                            }
                            if (queueItem != null) {
            ...
            public void onSkipToQueueItem(long j5) {
                Callback.this.onSkipToQueueItem(j5);
            }
    ...
    static class MediaSessionImplApi18 extends MediaSessionImplBase {
        ...
        int getRccTransportControlFlagsFromActions(long j5) {
            int rccTransportControlFlagsFromActions = super.getRccTransportControlFlagsFromActions(j5);
            return (j5 & 256) != 0 ? rccTransportControlFlagsFromActions | 256 : rccTransportControlFlagsFromActions;
        }
            ...
            if (callback == null) {
                ...
                this.mRcc.setPlaybackPositionUpdateListener(new RemoteControlClient.OnPlaybackPositionUpdateListener() { // from class: android.support.v4.media.session.MediaSessionCompat.MediaSessionImplApi18.1
                    ...
                    public void onPlaybackPositionUpdate(long j5) {
                        MediaSessionImplApi18.this.postToHandler(18, -1, -1, Long.valueOf(j5), null);
                    }
                });
            }
        }
    ...
    static class MediaSessionImplApi19 extends MediaSessionImplApi18 {
        ...
        int getRccTransportControlFlagsFromActions(long j5) {
            int rccTransportControlFlagsFromActions = super.getRccTransportControlFlagsFromActions(j5);
            return (j5 & 128) != 0 ? rccTransportControlFlagsFromActions | 512 : rccTransportControlFlagsFromActions;
        }
    ...
    public static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        class MediaSessionStub extends IMediaSession.Stub {
            ...
            public void adjustVolume(int i5, int i6, String str) {
                MediaSessionImplBase.this.adjustVolume(i5, i6);
            }
            ...
            public long getFlags() {
                long j5;
                synchronized (MediaSessionImplBase.this.mLock) {
                    j5 = MediaSessionImplBase.this.mFlags;
                }
                return j5;
            }
            ...
            public ParcelableVolumeInfo getVolumeAttributes() {
                ...
                synchronized (MediaSessionImplBase.this.mLock) {
                    MediaSessionImplBase mediaSessionImplBase = MediaSessionImplBase.this;
                    i5 = mediaSessionImplBase.mVolumeType;
                    i6 = mediaSessionImplBase.mLocalStream;
                    ...
                    if (i5 == 2) {
                        ...
                        streamMaxVolume = mediaSessionImplBase.mAudioManager.getStreamMaxVolume(i6);
                        streamVolume = MediaSessionImplBase.this.mAudioManager.getStreamVolume(i6);
                    }
                }
            ...
            void postToHandler(int i5) {
                MediaSessionImplBase.this.postToHandler(i5, 0, 0, null, null);
            }
            ...
            public void setVolumeTo(int i5, int i6, String str) {
                MediaSessionImplBase.this.setVolumeTo(i5, i6);
            }
            ...
            void postToHandler(int i5, int i6) {
                MediaSessionImplBase.this.postToHandler(i5, i6, 0, null, null);
            }

            void postToHandler(int i5, Object obj) {
                MediaSessionImplBase.this.postToHandler(i5, 0, 0, obj, null);
            }

            void postToHandler(int i5, Object obj, int i6) {
                MediaSessionImplBase.this.postToHandler(i5, i6, 0, obj, null);
            }

            void postToHandler(int i5, Object obj, Bundle bundle) {
                MediaSessionImplBase.this.postToHandler(i5, 0, 0, obj, bundle);
            }
        }
        ...
        private void sendCaptioningEnabled(boolean z4) {
            for (int beginBroadcast = this.mControllerCallbacks.beginBroadcast() - 1; beginBroadcast >= 0; beginBroadcast--) {
                try {
                    this.mControllerCallbacks.getBroadcastItem(beginBroadcast).onCaptioningEnabledChanged(z4);
        ...
        private void sendRepeatMode(int i5) {
            for (int beginBroadcast = this.mControllerCallbacks.beginBroadcast() - 1; beginBroadcast >= 0; beginBroadcast--) {
                try {
                    this.mControllerCallbacks.getBroadcastItem(beginBroadcast).onRepeatModeChanged(i5);
                } catch (RemoteException unused) {
                }
            }
            this.mControllerCallbacks.finishBroadcast();
        ...
        private void sendShuffleMode(int i5) {
            for (int beginBroadcast = this.mControllerCallbacks.beginBroadcast() - 1; beginBroadcast >= 0; beginBroadcast--) {
                try {
                    this.mControllerCallbacks.getBroadcastItem(beginBroadcast).onShuffleModeChanged(i5);
                } catch (RemoteException unused) {
                }
            }
            this.mControllerCallbacks.finishBroadcast();
        ...
        void adjustVolume(int i5, int i6) {
            ...
            this.mAudioManager.adjustStreamVolume(this.mLocalStream, i5, i6);
        }
        ...
        int getRccStateFromState(int i5) {
            switch (i5) {
                case 0:
                    return 0;
                case 1:
        ...
        void postToHandler(int i5, int i6, int i7, Object obj, Bundle bundle) {
            synchronized (this.mLock) {
                MessageHandler messageHandler = this.mHandler;
                if (messageHandler != null) {
                    Message obtainMessage = messageHandler.obtainMessage(i5, i6, i7, obj);
                    Bundle bundle2 = new Bundle();
        ...
        public void setPlaybackToLocal(int i5) {
            ...
            this.mLocalStream = i5;
            this.mVolumeType = 1;
            int i6 = this.mVolumeType;
            int i7 = this.mLocalStream;
            sendVolumeInfoChanged(new ParcelableVolumeInfo(i6, i7, 2, this.mAudioManager.getStreamMaxVolume(i7), this.mAudioManager.getStreamVolume(this.mLocalStream)));
        }
        ...
        void setVolumeTo(int i5, int i6) {
            ...
            this.mAudioManager.setStreamVolume(this.mLocalStream, i5, i6);
        }
    ...
    public static final class Token implements Parcelable {
        ...
        @Override // android.os.Parcelable
        public void writeToParcel(Parcel parcel, int i5) {
            parcel.writeParcelable((Parcelable) this.mInner, i5);
        }
            ...
            if (playbackStateCompat.getPosition() != -1) {
                if (playbackStateCompat.getState() == 3 || playbackStateCompat.getState() == 4 || playbackStateCompat.getState() == 5) {
                    if (playbackStateCompat.getLastPositionUpdateTime() > 0) {
                        ...
                        return new PlaybackStateCompat.Builder(playbackStateCompat).setState(playbackStateCompat.getState(), j5, playbackStateCompat.getPlaybackSpeed(), elapsedRealtime).build();
                    }
                    return playbackStateCompat;
                }
                return playbackStateCompat;
    ...
    public void setCaptioningEnabled(boolean z4) {
        this.mImpl.setCaptioningEnabled(z4);
    }
    ...
    public void setPlaybackToLocal(int i5) {
        this.mImpl.setPlaybackToLocal(i5);
    }
    ...
    public void setRatingType(int i5) {
        this.mImpl.setRatingType(i5);
    }

    public void setRepeatMode(int i5) {
        this.mImpl.setRepeatMode(i5);
    }
    ...
    public static final class ResultReceiverWrapper implements Parcelable {
        ...
        @Override // android.os.Parcelable
        public void writeToParcel(Parcel parcel, int i5) {
            this.mResultReceiver.writeToParcel(parcel, i5);
        }
    ...
    static class MediaSessionImplApi21 implements MediaSessionImpl {
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setFlags(int i5) {
            MediaSessionCompatApi21.setFlags(this.mSessionObj, i5);
        }
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setPlaybackToLocal(int i5) {
            MediaSessionCompatApi21.setPlaybackToLocal(this.mSessionObj, i5);
        }
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setRatingType(int i5) {
            MediaSessionCompatApi22.setRatingType(this.mSessionObj, i5);
        }
