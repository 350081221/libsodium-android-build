...
public final class MediaControllerCompat {
    ...
    public static abstract class Callback implements IBinder.DeathRecipient {
        ...
        private static class StubApi21 implements MediaControllerCompatApi21.Callback {
            ...
            public void onAudioInfoChanged(int i5, int i6, int i7, int i8, int i9) {
                Callback callback = this.mCallback.get();
                if (callback != null) {
                    callback.onAudioInfoChanged(new PlaybackInfo(i5, i6, i7, i8, i9));
                }
            }
        ...
        private static class StubCompat extends IMediaControllerCallback.Stub {
            ...
            public void onCaptioningEnabledChanged(boolean z4) throws RemoteException {
                Callback callback = this.mCallback.get();
                if (callback != null) {
                    callback.postToHandler(11, Boolean.valueOf(z4), null);
                }
            }
            ...
            @Override // android.support.v4.media.session.IMediaControllerCallback
            public void onShuffleModeChangedRemoved(boolean z4) throws RemoteException {
            }
        ...
        void postToHandler(int i5, Object obj, Bundle bundle) {
            ...
            if (messageHandler != null) {
                Message obtainMessage = messageHandler.obtainMessage(i5, obj);
    ...
    public interface MediaControllerImpl {
        ...
        void addQueueItem(MediaDescriptionCompat mediaDescriptionCompat, int i5);
    ...
    public static abstract class TransportControls {
        ...
        public abstract void setCaptioningEnabled(boolean z4);

        public abstract void setRating(RatingCompat ratingCompat);

        public abstract void setRating(RatingCompat ratingCompat, Bundle bundle);

        public abstract void setRepeatMode(int i5);

        public abstract void setShuffleMode(int i5);
    ...
    static class TransportControlsBase extends TransportControls {
        ...
        public void setCaptioningEnabled(boolean z4) {
            try {
                this.mBinder.setCaptioningEnabled(z4);
            } catch (RemoteException e5) {
    ...
    public void removeQueueItemAt(int i5) {
        ...
        if (queue != null && i5 >= 0 && i5 < queue.size() && (queueItem = queue.get(i5)) != null) {
    ...
    static class TransportControlsApi21 extends TransportControls {
        ...
        @Override // android.support.v4.media.session.MediaControllerCompat.TransportControls
        public void seekTo(long j5) {
            MediaControllerCompatApi21.TransportControls.seekTo(this.mControlsObj, j5);
        }
        ...
        public void setCaptioningEnabled(boolean z4) {
            ...
            bundle.putBoolean(MediaSessionCompat.ACTION_ARGUMENT_CAPTIONING_ENABLED, z4);
        ...
        public void setRepeatMode(int i5) {
            Bundle bundle = new Bundle();
            bundle.putInt(MediaSessionCompat.ACTION_ARGUMENT_REPEAT_MODE, i5);
        ...
        public void setShuffleMode(int i5) {
            Bundle bundle = new Bundle();
            bundle.putInt(MediaSessionCompat.ACTION_ARGUMENT_SHUFFLE_MODE, i5);
        ...
        @Override // android.support.v4.media.session.MediaControllerCompat.TransportControls
        public void skipToQueueItem(long j5) {
            MediaControllerCompatApi21.TransportControls.skipToQueueItem(this.mControlsObj, j5);
        }
    ...
    static class MediaControllerImplApi21 implements MediaControllerImpl {
        ...
        @Override // android.support.v4.media.session.MediaControllerCompat.MediaControllerImpl
        public void adjustVolume(int i5, int i6) {
            MediaControllerCompatApi21.adjustVolume(this.mControllerObj, i5, i6);
        }
        ...
        @Override // android.support.v4.media.session.MediaControllerCompat.MediaControllerImpl
        public void setVolumeTo(int i5, int i6) {
            MediaControllerCompatApi21.setVolumeTo(this.mControllerObj, i5, i6);
        }
