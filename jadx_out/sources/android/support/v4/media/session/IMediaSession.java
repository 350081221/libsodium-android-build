...
public interface IMediaSession extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IMediaSession {
        ...
        public static class Proxy implements IMediaSession {
            ...
            @Override // android.support.v4.media.session.IMediaSession
            public void addQueueItemAt(MediaDescriptionCompat mediaDescriptionCompat, int i5) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.support.v4.media.session.IMediaSession
            public void adjustVolume(int i5, int i6, String str) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.support.v4.media.session.IMediaSession
            public void removeQueueItemAt(int i5) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.support.v4.media.session.IMediaSession
            public void setVolumeTo(int i5, int i6, String str) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.support.v4.media.session.IMediaSession
            public void skipToQueueItem(long j5) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
    ...
    void addQueueItemAt(MediaDescriptionCompat mediaDescriptionCompat, int i5) throws RemoteException;

    void adjustVolume(int i5, int i6, String str) throws RemoteException;
    ...
    void removeQueueItemAt(int i5) throws RemoteException;
    ...
    void setCaptioningEnabled(boolean z4) throws RemoteException;

    void setRepeatMode(int i5) throws RemoteException;

    void setShuffleMode(int i5) throws RemoteException;

    void setShuffleModeEnabledRemoved(boolean z4) throws RemoteException;

    void setVolumeTo(int i5, int i6, String str) throws RemoteException;

    void skipToQueueItem(long j5) throws RemoteException;
