...
public interface IMediaControllerCallback extends IInterface {
            ...
            if (i5 != 1598968902) {
                ...
                switch (i5) {
                    ...
                    case 10:
                        ...
                        onShuffleModeChangedRemoved(z4);
                        return true;
                    case 11:
                        parcel.enforceInterface(DESCRIPTOR);
                        if (parcel.readInt() != 0) {
    ...
    void onCaptioningEnabledChanged(boolean z4) throws RemoteException;
    ...
    void onShuffleModeChanged(int i5) throws RemoteException;

    void onShuffleModeChangedRemoved(boolean z4) throws RemoteException;
