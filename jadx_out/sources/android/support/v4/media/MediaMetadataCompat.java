...
public final class MediaMetadataCompat implements Parcelable {
    ...
    public MediaDescriptionCompat getDescription() {
        ...
        if (!TextUtils.isEmpty(text)) {
            ...
            while (i5 < 3) {
                ...
                int i7 = i6 + 1;
                CharSequence text2 = getText(strArr[i6]);
                if (!TextUtils.isEmpty(text2)) {
                    charSequenceArr[i5] = text2;
                    i5++;
                }
                i6 = i7;
            }
        ...
        while (true) {
            ...
            if (i9 < strArr3.length) {
                String string2 = getString(strArr3[i9]);
    ...
    public static final class Builder {
        ...
        private Bitmap scaleBitmap(Bitmap bitmap, int i5) {
            float f5 = i5;
            ...
            for (String str : this.mBundle.keySet()) {
                ...
                if (obj instanceof Bitmap) {
                    ...
                    if (bitmap.getHeight() > i5 || bitmap.getWidth() > i5) {
                        putBitmap(str, scaleBitmap(bitmap, i5));
                    }
                }
            }
        }
