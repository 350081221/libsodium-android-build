...
final class LegacyHttpDateTime {
    ...
    public static class TimeOfDay {
        ...
        TimeOfDay(int h5, int m5, int s5) {
            this.hour = h5;
            this.minute = m5;
            this.second = s5;
        }
    ...
    private static TimeOfDay getTime(String timeString) {
        ...
        if (timeString.charAt(i5) != ':') {
            hour = (hour * 10) + (timeString.charAt(i5) - 48);
            i5++;
        }
        int i6 = i5 + 1 + 1;
        int minute = ((timeString.charAt(r1) - 48) * 10) + (timeString.charAt(i6) - 48);
        int i7 = i6 + 1 + 1 + 1 + 1;
        int second = ((timeString.charAt(r3) - 48) * 10) + (timeString.charAt(r2) - 48);
