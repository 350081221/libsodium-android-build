...
public class RequestHandle {
    ...
    private String computeDigest(String A1, String A2, String nonce, String QOP, String nc, String cnonce) {
        ...
        if (QOP.equalsIgnoreCase(b.f16161n)) {
    ...
    private String H(String param) {
        if (param != null) {
            try {
                ...
                byte[] d5 = md5.digest(param.getBytes());
                if (d5 != null) {
                    return bufferToHex(d5);
                }
                return null;
        ...
        if (buffer != null) {
            ...
            if (length > 0) {
                ...
                for (int i5 = 0; i5 < length; i5++) {
                    byte l5 = (byte) (buffer[i5] & cx.f12477m);
                    byte h5 = (byte) ((buffer[i5] & 240) >> 4);
                    hex.append(hexChars[h5]);
                    hex.append(hexChars[l5]);
                }
                return hex.toString();
            }
            return "";
