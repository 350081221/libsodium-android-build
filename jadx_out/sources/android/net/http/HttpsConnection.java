        ...
        if (this.mProxyHost != null) {
            ...
            try {
                ...
                try {
                    ...
                    for (Header h5 : req.mHttpRequest.getAllHeaders()) {
                        String headerName = h5.getName().toLowerCase(Locale.ROOT);
                        if (headerName.startsWith("proxy") || headerName.equals("keep-alive") || headerName.equals(c.f19042f)) {
                            proxyReq.addHeader(h5);
                        }
                    }
                    ...
                    if (statusCode == 200) {
                        try {
                            ...
                            String errorMessage = e5.getMessage();
                ...
                String errorMessage5 = e9.getMessage();
            ...
            try {
                ...
                String errorMessage6 = e10.getMessage();
