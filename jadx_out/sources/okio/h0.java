...
public final class h0 extends s {
    ...
    @p4.l
    private final FileChannel f20918e;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public h0(boolean z4, @p4.l FileChannel fileChannel) {
        super(z4);
        kotlin.jvm.internal.l0.p(fileChannel, "fileChannel");
        this.f20918e = fileChannel;
    }

    @Override // okio.s
    protected synchronized void A() {
        this.f20918e.force(true);
    }

    @Override // okio.s
    protected synchronized int H(long j5, @p4.l byte[] array, int i5, int i6) {
        kotlin.jvm.internal.l0.p(array, "array");
        this.f20918e.position(j5);
        ...
        while (true) {
            ...
            int read = this.f20918e.read(wrap);
            if (read == -1) {
                if (i7 == 0) {
                    return -1;
                }
    ...
    protected synchronized void M(long j5, @p4.l byte[] array, int i5, int i6) {
        kotlin.jvm.internal.l0.p(array, "array");
        this.f20918e.position(j5);
        this.f20918e.write(ByteBuffer.wrap(array, i5, i6));
    }
