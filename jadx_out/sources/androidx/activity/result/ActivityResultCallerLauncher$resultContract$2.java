...
final class ActivityResultCallerLauncher$resultContract$2 extends n0 implements v3.a<AnonymousClass1> {
    ...
    public final AnonymousClass1 invoke() {
        ...
        return new ActivityResultContract<r2, O>() { // from class: androidx.activity.result.ActivityResultCallerLauncher$resultContract$2.1
            @Override // androidx.activity.result.contract.ActivityResultContract
            public O parseResult(int i5, @m Intent intent) {
                return (O) activityResultCallerLauncher.getCallerContract().parseResult(i5, intent);
            }

            @Override // androidx.activity.result.contract.ActivityResultContract
            @l
            public Intent createIntent(@l Context context, @l r2 input) {
