...
public final class LocalActivityResultRegistryOwner {
    ...
    @Composable
    @m
    public final ActivityResultRegistryOwner getCurrent(@m Composer composer, int i5) {
    ...
    @l
    public final ProvidedValue<ActivityResultRegistryOwner> provides(@l ActivityResultRegistryOwner activityResultRegistryOwner) {
