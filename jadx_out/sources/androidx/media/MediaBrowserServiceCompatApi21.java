...
class MediaBrowserServiceCompatApi21 {
    ...
    static class MediaBrowserServiceAdaptor extends MediaBrowserService {
        ...
        public MediaBrowserService.BrowserRoot onGetRoot(String str, int i5, Bundle bundle) {
            ...
            BrowserRoot onGetRoot = serviceCompatProxy.onGetRoot(str, i5, bundle2);
            if (onGetRoot == null) {
                return null;
            }
    ...
    static class ResultWrapper<T> {
        ...
        public void sendResult(T t5) {
            if (t5 instanceof List) {
                this.mResultObj.sendResult(parcelListToItemList((List) t5));
                return;
            }
    ...
    public interface ServiceCompatProxy {
        BrowserRoot onGetRoot(String str, int i5, Bundle bundle);
