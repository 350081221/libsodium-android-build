...
public class AudioAttributesCompat implements VersionedParcelable {
    ...
    public static void setForceLegacyBehavior(boolean z4) {
        sForceLegacyBehavior = z4;
    }

    static int toVolumeStreamType(boolean z4, AudioAttributesCompat audioAttributesCompat) {
        return toVolumeStreamType(z4, audioAttributesCompat.getFlags(), audioAttributesCompat.getUsage());
    }

    static int usageForStreamType(int i5) {
        switch (i5) {
            case 0:
                return 2;
            case 1:
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static int toVolumeStreamType(boolean z4, int i5, int i6) {
        if ((i5 & 1) == 1) {
            return z4 ? 1 : 7;
        }
        if ((i5 & 4) == 4) {
    ...
    public static class Builder {
        ...
        public Builder setFlags(int i5) {
            this.mFlags = (i5 & AudioAttributesCompat.FLAG_ALL) | this.mFlags;
            return this;
        }

        /* JADX WARN: Can't fix incorrect switch cases order, some code will duplicate */
        Builder setInternalLegacyStreamType(int i5) {
            switch (i5) {
                case 0:
                    this.mContentType = 1;
                    break;
