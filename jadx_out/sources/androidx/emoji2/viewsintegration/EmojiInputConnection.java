...
final class EmojiInputConnection extends InputConnectionWrapper {
    ...
    public boolean deleteSurroundingText(int i5, int i6) {
        if (!this.mEmojiCompatDeleteHelper.handleDeleteSurroundingText(this, getEditable(), i5, i6, false) && !super.deleteSurroundingText(i5, i6)) {
            return false;
        }
        return true;
    }
    ...
    public boolean deleteSurroundingTextInCodePoints(int i5, int i6) {
        if (!this.mEmojiCompatDeleteHelper.handleDeleteSurroundingText(this, getEditable(), i5, i6, true) && !super.deleteSurroundingTextInCodePoints(i5, i6)) {
            return false;
        }
        return true;
    }
