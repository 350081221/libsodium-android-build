...
public class FlexBuffersBuilder {
    ...
    public static class Value {
        ...
        public static int elemWidth(int i5, int i6, long j5, int i7, int i8) {
            ...
            for (int i9 = 1; i9 <= 32; i9 *= 2) {
                int widthUInBits = FlexBuffersBuilder.widthUInBits((int) (((paddingBytes(i7, i9) + i7) + (i8 * i9)) - j5));
    ...
    private int align(int i5) {
        int i6 = 1 << i5;
        int paddingBytes = Value.paddingBytes(this.bb.writePosition(), i6);
        while (true) {
            int i7 = paddingBytes - 1;
            if (paddingBytes != 0) {
                this.bb.put((byte) 0);
                paddingBytes = i7;
            } else {
    ...
    private Value createKeyVector(int i5, int i6) {
        ...
        while (i7 < this.stack.size()) {
            i7++;
            max = Math.max(max, Value.elemWidth(4, 0, this.stack.get(i7).key, this.bb.writePosition(), i7));
        }
        int align = align(max);
        writeInt(j5, align);
        int writePosition = this.bb.writePosition();
        while (i5 < this.stack.size()) {
            int i8 = this.stack.get(i5).key;
            writeOffset(this.stack.get(i5).key, align);
            i5++;
        }
    ...
    private Value createVector(int i5, int i6, int i7, boolean z4, boolean z5, Value value) {
        ...
        if (!z4) {
            while (i14 < this.stack.size()) {
                this.bb.put(this.stack.get(i14).storedPackedType(i12));
                i14++;
            }
        }
        if (value != null) {
        ...
        return new Value(i5, i9, i12, writePosition);
    }
    ...
    private void writeOffset(long j5, int i5) {
        writeInt((int) (this.bb.writePosition() - j5), i5);
    }
    ...
    public int endMap(String str, int i5) {
        ...
        Value createVector = createVector(putKey, i5, this.stack.size() - i5, false, false, createKeyVector(i5, this.stack.size() - i5));
    ...
    public int endVector(String str, int i5, boolean z4, boolean z5) {
        Value createVector = createVector(putKey(str), i5, this.stack.size() - i5, z4, z5, null);
        while (this.stack.size() > i5) {
    ...
    private void putUInt(String str, long j5) {
        ...
        if (widthUInBits == 0) {
            uInt64 = Value.uInt8(putKey, (int) j5);
        } else if (widthUInBits == 1) {
            uInt64 = Value.uInt16(putKey, (int) j5);
        } else if (widthUInBits == 2) {
            uInt64 = Value.uInt32(putKey, (int) j5);
        } else {
            uInt64 = Value.uInt64(putKey, j5);
        }
    ...
    public FlexBuffersBuilder(ReadWriteBuf readWriteBuf, int i5) {
        ...
        this.keyComparator = new Comparator<Value>() { // from class: androidx.emoji2.text.flatbuffer.FlexBuffersBuilder.1
            ...
            public int compare(Value value, Value value2) {
                ...
                int i7 = value2.key;
                do {
                    b5 = FlexBuffersBuilder.this.bb.get(i6);
