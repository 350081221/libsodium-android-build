...
public class EmojiCompat {
    ...
    public static class CompatInternal {
        ...
        int getEmojiEnd(@NonNull CharSequence charSequence, @IntRange(from = 0) int i5) {
            return -1;
        }
        ...
        int getEmojiStart(@NonNull CharSequence charSequence, @IntRange(from = 0) int i5) {
            return -1;
        }
        ...
        boolean hasEmojiGlyph(@NonNull CharSequence charSequence, int i5) {
            return false;
        }
        ...
        CharSequence process(@NonNull CharSequence charSequence, @IntRange(from = 0) int i5, @IntRange(from = 0) int i6, @IntRange(from = 0) int i7, boolean z4) {
            return charSequence;
        }
    ...
    private static final class CompatInternal19 extends CompatInternal {
        ...
        @Override // androidx.emoji2.text.EmojiCompat.CompatInternal
        int getEmojiEnd(@NonNull CharSequence charSequence, int i5) {
        ...
        @Override // androidx.emoji2.text.EmojiCompat.CompatInternal
        int getEmojiStart(@NonNull CharSequence charSequence, int i5) {
        ...
        @Override // androidx.emoji2.text.EmojiCompat.CompatInternal
        CharSequence process(@NonNull CharSequence charSequence, int i5, int i6, int i7, boolean z4) {
    ...
    public static class ListenerDispatcher implements Runnable {
        ...
        ListenerDispatcher(@NonNull InitCallback initCallback, int i5) {
        ...
        ListenerDispatcher(@NonNull Collection<InitCallback> collection, int i5) {
            this(collection, i5, null);
        }

        ListenerDispatcher(@NonNull Collection<InitCallback> collection, int i5, @Nullable Throwable th) {
    ...
    public static boolean handleDeleteSurroundingText(@NonNull InputConnection inputConnection, @NonNull Editable editable, @IntRange(from = 0) int i5, @IntRange(from = 0) int i6, boolean z4) {
        return EmojiProcessor.handleDeleteSurroundingText(inputConnection, editable, i5, i6, z4);
    }
    ...
    public CharSequence process(@Nullable CharSequence charSequence, @IntRange(from = 0) int i5, @IntRange(from = 0) int i6, @IntRange(from = 0) int i7, int i8) {
        ...
        if (i8 != 1) {
            z4 = i8 != 2 ? this.mReplaceAll : false;
        } else {
            z4 = true;
        }
        return this.mHelper.process(charSequence, i5, i6, i7, z4);
    }
