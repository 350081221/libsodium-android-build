...
public final class ShareCompat {
    ...
    public static class IntentBuilder {
        ...
        */
        ...
        @NonNull
        public IntentBuilder setChooserTitle(@StringRes int i5) {
    ...
    public static class IntentReader {
        ...
        public Drawable getCallingActivityIcon() {
            ...
            try {
                ...
                Log.e(TAG, "Could not retrieve icon for calling activity", e5);
                return null;
            }
        }
        ...
        public Drawable getCallingApplicationIcon() {
            ...
            try {
                ...
                Log.e(TAG, "Could not retrieve icon for calling application", e5);
                return null;
            }
        }
        ...
        public CharSequence getCallingApplicationLabel() {
            ...
            try {
                ...
                Log.e(TAG, "Could not retrieve label for calling application", e5);
                return null;
            }
        }
    ...
    @Deprecated
    public static void configureMenuItem(@NonNull Menu menu, @IdRes int i5, @NonNull IntentBuilder intentBuilder) {
