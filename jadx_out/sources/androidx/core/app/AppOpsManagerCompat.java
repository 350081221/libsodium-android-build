...
public final class AppOpsManagerCompat {
    ...
    static class Api29Impl {
        ...
        @DoNotInline
        static int checkOpNoThrow(@Nullable AppOpsManager appOpsManager, @NonNull String str, int i5, @NonNull String str2) {
    ...
    public static int checkOrNoteProxyOp(@NonNull Context context, int i5, @NonNull String str, @NonNull String str2) {
    ...
    public static int noteOp(@NonNull Context context, @NonNull String str, int i5, @NonNull String str2) {
        return ((AppOpsManager) context.getSystemService("appops")).noteOp(str, i5, str2);
    }

    public static int noteOpNoThrow(@NonNull Context context, @NonNull String str, int i5, @NonNull String str2) {
        return ((AppOpsManager) context.getSystemService("appops")).noteOpNoThrow(str, i5, str2);
    }
