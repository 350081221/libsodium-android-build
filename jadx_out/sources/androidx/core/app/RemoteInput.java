...
public final class RemoteInput {
    ...
    public static class Api26Impl {
        ...
        @DoNotInline
        static RemoteInput.Builder setAllowDataType(RemoteInput.Builder builder, String str, boolean z4) {
    ...
    public static final class Builder {
        ...
        @NonNull
        public Builder setAllowDataType(@NonNull String str, boolean z4) {
            if (z4) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public RemoteInput(String str, CharSequence charSequence, CharSequence[] charSequenceArr, boolean z4, int i5, Bundle bundle, Set<String> set) {
        this.mResultKey = str;
        this.mLabel = charSequence;
        this.mChoices = charSequenceArr;
        this.mAllowFreeFormTextInput = z4;
    ...
    public static void setResultsSource(@NonNull Intent intent, int i5) {
        if (Build.VERSION.SDK_INT >= 28) {
