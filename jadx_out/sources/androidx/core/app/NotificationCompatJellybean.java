...
public class NotificationCompatJellybean {
    ...
    private static RemoteInput[] fromBundleArray(Bundle[] bundleArr) {
        ...
        for (int i5 = 0; i5 < bundleArr.length; i5++) {
            remoteInputArr[i5] = fromBundle(bundleArr[i5]);
        }
        return remoteInputArr;
    }

    public static NotificationCompat.Action getAction(Notification notification, int i5) {
        Bundle bundle;
            ...
            try {
                try {
                    ...
                    if (actionObjectsLocked != null) {
                        Object obj = actionObjectsLocked[i5];
                        ...
                        if (extras != null && (sparseParcelableArray = extras.getSparseParcelableArray(NotificationCompatExtras.EXTRA_ACTION_EXTRAS)) != null) {
                            bundle = (Bundle) sparseParcelableArray.get(i5);
                        } else {
                            bundle = null;
                        }
    ...
    public static Bundle getBundleForAction(NotificationCompat.Action action) {
        ...
        if (iconCompat != null) {
            i5 = iconCompat.getResId();
        } else {
            i5 = 0;
        }
        bundle2.putInt(KEY_ICON, i5);
    ...
    public static NotificationCompat.Action readAction(int i5, CharSequence charSequence, PendingIntent pendingIntent, Bundle bundle) {
        ...
        return new NotificationCompat.Action(i5, charSequence, pendingIntent, bundle, remoteInputArr, remoteInputArr2, z4, 0, true, false, false);
    }
    ...
    private static Bundle[] toBundleArray(RemoteInput[] remoteInputArr) {
        ...
        for (int i5 = 0; i5 < remoteInputArr.length; i5++) {
            bundleArr[i5] = toBundle(remoteInputArr[i5]);
        }
        return bundleArr;
    }
    ...
    public static Bundle writeActionAndGetExtras(Notification.Builder builder, NotificationCompat.Action action) {
        ...
        builder.addAction(i5, action.getTitle(), action.getActionIntent());
