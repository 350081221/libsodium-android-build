...
public class NotificationCompat {
    ...
    public static class Action {
        ...
        public static final class WearableExtender implements Extender {
            ...
            public WearableExtender m6398clone() {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public Action(int i5, @Nullable CharSequence charSequence, @Nullable PendingIntent pendingIntent, @Nullable Bundle bundle, @Nullable RemoteInput[] remoteInputArr, @Nullable RemoteInput[] remoteInputArr2, boolean z4, int i6, boolean z5, boolean z6, boolean z7) {
    ...
    public static class CallStyle extends Style {
        ...
        private Action makeAction(int i5, int i6, Integer num, int i7, PendingIntent pendingIntent) {
            ...
            Action build = new Action.Builder(IconCompat.createWithResource(this.mBuilder.mContext, i5), spannableStringBuilder, pendingIntent).build();
        ...
        public ArrayList<Action> getActionsListWithSystemActions() {
            ...
            if (arrayList2 != null) {
                for (Action action : arrayList2) {
                    ...
                    } else if (!isActionAddedByCallStyle(action) && i5 > 1) {
                        arrayList.add(action);
                        i5--;
                    }
    ...
    public static final class WearableExtender implements Extender {
        ...
        @NonNull
        /* renamed from: clone, reason: merged with bridge method [inline-methods] */
        public WearableExtender m6399clone() {
            WearableExtender wearableExtender = new WearableExtender();
    ...
    static Action getActionCompatFromAction(@NonNull Notification.Action action) {
        ...
        if (remoteInputs == null) {
            ...
            for (int i8 = 0; i8 < remoteInputs.length; i8++) {
                ...
                if (Build.VERSION.SDK_INT >= 29) {
                    i5 = Api29Impl.getEditChoicesBeforeSending(remoteInput);
                } else {
                    i5 = 0;
                }
                remoteInputArr2[i8] = new RemoteInput(resultKey, label, choices, allowFreeFormInput, i5, Api20Impl.getExtras(remoteInput), null);
            }
        ...
        if (i9 >= 28) {
            i6 = Api28Impl.getSemanticAction(action);
        } else {
            i6 = Api20Impl.getExtras(action).getInt("android.support.action.semanticAction", 0);
        }
        int i10 = i6;
        if (i9 >= 29) {
            z5 = Api29Impl.isContextual(action);
        } else {
            z5 = false;
        }
        if (i9 >= 31) {
            z6 = Api31Impl.isAuthenticationRequired(action);
        }
        boolean z8 = z6;
        if (Api23Impl.getIcon(action) == null && (i7 = action.icon) != 0) {
            return new Action(i7, action.title, action.actionIntent, Api20Impl.getExtras(action), remoteInputArr, (RemoteInput[]) null, z4, i10, z7, z5, z8);
        }
        if (Api23Impl.getIcon(action) != null) {
            iconCompat = IconCompat.createFromIconOrNullIfZeroResId(Api23Impl.getIcon(action));
        }
        return new Action(iconCompat, action.title, action.actionIntent, Api20Impl.getExtras(action), remoteInputArr, (RemoteInput[]) null, z4, i10, z7, z5, z8);
    }
    ...
    public static final class CarExtender implements Extender {
        ...
        private static UnreadConversation getUnreadConversationFromBundle(@Nullable Bundle bundle) {
            ...
            if (remoteInput2 != null) {
                ...
                remoteInput = new RemoteInput(resultKey, label, choices, allowFreeFormInput, i5, Api20Impl.getExtras(remoteInput2), null);
            }
            ...
            static Message getMessageFromBundle(@NonNull Bundle bundle) {
                ...
                try {
                    if (bundle.containsKey(KEY_TEXT) && bundle.containsKey("time")) {
                        ...
                        Message message = new Message(bundle.getCharSequence(KEY_TEXT), bundle.getLong("time"), person);
