...
public final class CursorKt {
    @m
    public static final byte[] getBlobOrNull(@l Cursor cursor, int i5) {
        if (cursor.isNull(i5)) {
            return null;
        }
    ...
    @m
    public static final Double getDoubleOrNull(@l Cursor cursor, int i5) {
        if (cursor.isNull(i5)) {
            return null;
        }
    ...
    @m
    public static final Float getFloatOrNull(@l Cursor cursor, int i5) {
        if (cursor.isNull(i5)) {
            return null;
        }
    ...
    @m
    public static final Integer getIntOrNull(@l Cursor cursor, int i5) {
        if (cursor.isNull(i5)) {
            return null;
        }
    ...
    @m
    public static final Long getLongOrNull(@l Cursor cursor, int i5) {
        if (cursor.isNull(i5)) {
            return null;
        }
    ...
    @m
    public static final Short getShortOrNull(@l Cursor cursor, int i5) {
        if (cursor.isNull(i5)) {
            return null;
        }
    ...
    @m
    public static final String getStringOrNull(@l Cursor cursor, int i5) {
        if (cursor.isNull(i5)) {
            return null;
        }
