...
public final class ComplexColorCompat {
    ...
    private ComplexColorCompat(Shader shader, ColorStateList colorStateList, @ColorInt int i5) {
        this.mShader = shader;
    ...
    @NonNull
    private static ComplexColorCompat createFromXml(@NonNull Resources resources, @ColorRes int i5, @Nullable Resources.Theme theme) throws IOException, XmlPullParserException {
        int next;
    ...
    public static ComplexColorCompat from(@ColorInt int i5) {
