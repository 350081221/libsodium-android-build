...
public final class GradientColorInflaterCompat {
    ...
    private static ColorStops checkColors(@Nullable ColorStops colorStops, @ColorInt int i5, @ColorInt int i6, boolean z4, @ColorInt int i7) {
        if (colorStops != null) {
            return colorStops;
        }
        if (z4) {
            return new ColorStops(i5, i7, i6);
        }
        return new ColorStops(i5, i6);
    }
    ...
    */
    ...
    public static final class ColorStops {
        ...
        ColorStops(@ColorInt int i5, @ColorInt int i6) {
            this.mColors = new int[]{i5, i6};
            this.mOffsets = new float[]{0.0f, 1.0f};
        }

        ColorStops(@ColorInt int i5, @ColorInt int i6, @ColorInt int i7) {
