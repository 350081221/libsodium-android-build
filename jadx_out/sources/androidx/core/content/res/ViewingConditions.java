...
public final class ViewingConditions {
    ...
    static ViewingConditions make(@NonNull float[] fArr, float f5, float f6, float f7, boolean z4) {
        ...
        if (z4) {
            ...
            exp = (1.0f - (((float) Math.exp(((-f5) - 42.0f) / 92.0f)) * 0.2777778f)) * f16;
        }
        double d5 = exp;
        if (d5 > 1.0d) {
            exp = 1.0f;
        ...
        float f18 = 1.0f / ((5.0f * f5) + 1.0f);
        float f19 = f18 * f18 * f18 * f18;
        float f20 = 1.0f - f19;
        float cbrt = (f19 * f5) + (0.1f * f20 * f20 * ((float) Math.cbrt(f5 * 5.0d)));
        ...
        float pow2 = (float) Math.pow(((fArr6[2] * cbrt) * f15) / 100.0d, 0.42d);
        float[] fArr7 = {(float) Math.pow(((fArr6[0] * cbrt) * f13) / 100.0d, 0.42d), (float) Math.pow(((fArr6[1] * cbrt) * f14) / 100.0d, 0.42d), pow2};
        float f21 = fArr7[0];
        float f22 = fArr7[1];
        return new ViewingConditions(yFromLStar, ((((f21 * 400.0f) / (f21 + 27.13f)) * 2.0f) + ((f22 * 400.0f) / (f22 + 27.13f)) + (((400.0f * pow2) / (pow2 + 27.13f)) * 0.05f)) * pow, pow, pow, f17, f16, fArr6, cbrt, (float) Math.pow(cbrt, 0.25d), sqrt);
    }
