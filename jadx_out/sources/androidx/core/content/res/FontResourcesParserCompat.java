...
public class FontResourcesParserCompat {
    ...
    public static final class FontFileResourceEntry {
        ...
        public FontFileResourceEntry(@NonNull String str, int i5, boolean z4, @Nullable String str2, int i6, int i7) {
            this.mFileName = str;
            this.mWeight = i5;
            this.mItalic = z4;
    ...
    @NonNull
    public static List<List<byte[]>> readCerts(@NonNull Resources resources, @ArrayRes int i5) {
        if (i5 == 0) {
    ...
    private static FontFileResourceEntry readFont(XmlPullParser xmlPullParser, Resources resources) throws XmlPullParserException, IOException {
        ...
        return new FontFileResourceEntry(string2, i6, z4, string, i10, resourceId);
    }
    ...
    public static final class ProviderResourceEntry implements FamilyResourceEntry {
        ...
        public ProviderResourceEntry(@NonNull FontRequest fontRequest, int i5, int i6, @Nullable String str) {
        ...
        public ProviderResourceEntry(@NonNull FontRequest fontRequest, int i5, int i6) {
