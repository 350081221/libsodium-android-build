...
public final class ColorStateListInflaterCompat {
    ...
    @Nullable
    public static ColorStateList inflate(@NonNull Resources resources, @XmlRes int i5, @Nullable Resources.Theme theme) {
        try {
    ...
    @ColorInt
    private static int modulateColorAlpha(@ColorInt int i5, @FloatRange(from = 0.0d, to = 1.0d) float f5, @FloatRange(from = 0.0d, to = 100.0d) float f6) {
        boolean z4;
