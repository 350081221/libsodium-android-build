...
public final class PermissionChecker {
    ...
    public static int checkPermission(@NonNull Context context, @NonNull String str, int i5, int i6, @Nullable String str2) {
        boolean z4;
        ...
        if (myUid == i6 && ObjectsCompat.equals(packageName, str2)) {
            z4 = true;
        } else {
            z4 = false;
        }
        if (z4) {
            noteProxyOpNoThrow = AppOpsManagerCompat.checkOrNoteProxyOp(context, i6, permissionToOp, str2);
        } else {
