...
public class FileProvider extends ContentProvider {
    ...
    public static class SimplePathStrategy implements PathStrategy {
        ...
        private boolean belongsToRoot(@NonNull String str, @NonNull String str2) {
            ...
            if (!removeTrailingSlash.equals(removeTrailingSlash2)) {
                if (!removeTrailingSlash.startsWith(removeTrailingSlash2 + ClassPathElement.SEPARATOR_CHAR)) {
                    return false;
                }
            }
            return true;
        ...
        public Uri getUriForFile(File file) {
            ...
            try {
                ...
                if (entry != null) {
                    ...
                    return new Uri.Builder().scheme("content").authority(this.mAuthority).encodedPath(Uri.encode(entry.getKey()) + ClassPathElement.SEPARATOR_CHAR + Uri.encode(substring, "/")).build();
                }
    ...
    @VisibleForTesting
    static XmlResourceParser getFileProviderPathsMetaData(Context context, String str, @Nullable ProviderInfo providerInfo, int i5) {
    ...
    public void attachInfo(@NonNull Context context, @NonNull ProviderInfo providerInfo) {
        ...
        if (!providerInfo.exported) {
            if (providerInfo.grantUriPermissions) {
                String str = providerInfo.authority.split(a1.i.f136b)[0];
                synchronized (this.mLock) {
                    this.mAuthority = str;
                }
                HashMap<String, PathStrategy> hashMap = sCache;
    ...
    protected FileProvider(@XmlRes int i5) {
