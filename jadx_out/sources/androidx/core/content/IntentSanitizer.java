...
public class IntentSanitizer {
    ...
    public static class Api31Impl {
        ...
        @DoNotInline
        static void checkOtherMembers(int i5, ClipData.Item item, Consumer<String> consumer) {
            TextLinks textLinks;
    ...
    public static final class Builder {
        ...
        public IntentSanitizer build() {
            boolean z4 = this.mAllowAnyComponent;
            if ((z4 && this.mAllowSomeComponents) || (!z4 && !this.mAllowSomeComponents)) {
    ...
    */
    ...
    public Intent sanitize(@NonNull Intent intent, @NonNull Consumer<String> consumer) {
        ...
        if ((this.mAllowAnyComponent && component == null) || this.mAllowedComponents.test(component)) {
            ...
            intent2.setComponent(new ComponentName(SharedLibraryInfo.PLATFORM_PACKAGE_NAME, "java.lang.Void"));
        }
