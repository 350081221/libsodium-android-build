...
class RequestExecutor {
    ...
    private static class DefaultThreadFactory implements ThreadFactory {
        ...
        DefaultThreadFactory(@NonNull String str, int i5) {
    ...
    public static ThreadPoolExecutor createDefaultExecutor(@NonNull String str, int i5, @IntRange(from = 0) int i6) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static <T> T submit(@NonNull ExecutorService executorService, @NonNull Callable<T> callable, @IntRange(from = 0) int i5) throws InterruptedException {
        try {
            ...
            throw new InterruptedException(m0.a.Z);
        }
    }
}
