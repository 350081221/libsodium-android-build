...
public class FontsContractCompat {
    ...
    public static class FontFamilyResult {
        ...
        public static FontFamilyResult create(int i5, @Nullable FontInfo[] fontInfoArr) {
    ...
    public static class FontInfo {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public static FontInfo create(@NonNull Uri uri, @IntRange(from = 0) int i5, @IntRange(from = 1, to = 1000) int i6, boolean z4, int i7) {
    ...
    public static Typeface getFontSync(Context context, FontRequest fontRequest, @Nullable ResourcesCompat.FontCallback fontCallback, @Nullable Handler handler, boolean z4, int i5, int i6) {
        return requestFont(context, fontRequest, i6, z4, i5, ResourcesCompat.FontCallback.getHandler(handler), new TypefaceCompat.ResourcesCallbackAdapter(fontCallback));
    }
