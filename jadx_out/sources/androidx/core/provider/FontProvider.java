...
class FontProvider {
    ...
    static FontsContractCompat.FontInfo[] query(Context context, FontRequest fontRequest, String str, CancellationSignal cancellationSignal) {
        ...
        try {
            boolean z4 = true;
            int i10 = 0;
            cursor = make.query(build, new String[]{bm.f12336d, FontsContractCompat.Columns.FILE_ID, FontsContractCompat.Columns.TTC_INDEX, FontsContractCompat.Columns.VARIATION_SETTINGS, FontsContractCompat.Columns.WEIGHT, FontsContractCompat.Columns.ITALIC, FontsContractCompat.Columns.RESULT_CODE}, "query = ?", new String[]{fontRequest.getQuery()}, null, cancellationSignal);
            if (cursor != null && cursor.getCount() > 0) {
                int columnIndex = cursor.getColumnIndex(FontsContractCompat.Columns.RESULT_CODE);
                ArrayList arrayList2 = new ArrayList();
                int columnIndex2 = cursor.getColumnIndex(bm.f12336d);
                ...
                while (cursor.moveToNext()) {
                    ...
                    if (columnIndex5 != -1) {
                        i8 = cursor.getInt(columnIndex5);
                    } else {
                        i8 = 400;
                    }
                    if (columnIndex6 != -1 && cursor.getInt(columnIndex6) == z4) {
                        i9 = i7;
                    } else {
                        i9 = i7;
                        z4 = false;
                    }
                    arrayList2.add(FontsContractCompat.FontInfo.create(withAppendedId, i6, i8, z4, i9));
                    z4 = true;
                    i10 = 0;
                }
