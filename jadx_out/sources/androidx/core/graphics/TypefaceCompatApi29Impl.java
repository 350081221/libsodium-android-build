...
public class TypefaceCompatApi29Impl extends TypefaceCompatBaseImpl {
    ...
    */
    private android.graphics.fonts.Font findBaseFont(@androidx.annotation.NonNull android.graphics.fonts.FontFamily r6, int r7) {
        ...
        L14:
            r0.<init>(r1, r7)
            android.graphics.fonts.Font r7 = androidx.core.graphics.j0.a(r6, r2)
            android.graphics.fonts.FontStyle r1 = androidx.core.graphics.r0.a(r7)
            int r1 = getMatchScore(r0, r1)
        L23:
            int r2 = androidx.core.graphics.k0.a(r6)
            if (r3 >= r2) goto L3c
            android.graphics.fonts.Font r2 = androidx.core.graphics.j0.a(r6, r3)
            android.graphics.fonts.FontStyle r4 = androidx.core.graphics.r0.a(r2)
    ...
    public Typeface createFromFontFamilyFilesResourceEntry(Context context, FontResourcesParserCompat.FontFamilyFilesResourceEntry fontFamilyFilesResourceEntry, Resources resources, int i5) {
        ...
        try {
            ...
            style = findBaseFont(build, i5).getStyle();
