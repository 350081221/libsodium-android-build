...
public final class ColorUtils {
    ...
    static class Api26Impl {
        ...
        static Color compositeColors(Color color, Color color2) {
            ...
            if (Objects.equals(model, model2)) {
                ...
                alpha = color.alpha();
                alpha2 = color2.alpha();
                float f5 = alpha2 * (1.0f - alpha);
                componentCount = color2.getComponentCount();
                int i5 = componentCount - 1;
                float f6 = alpha + f5;
                components2[i5] = f6;
                if (f6 > 0.0f) {
                    alpha /= f6;
                ...
                for (int i6 = 0; i6 < i5; i6++) {
                    components2[i6] = (components[i6] * alpha) + (components2[i6] * f5);
                }
    ...
    public static int XYZToColor(@FloatRange(from = 0.0d, to = 95.047d) double d5, @FloatRange(from = 0.0d, to = 100.0d) double d6, @FloatRange(from = 0.0d, to = 108.883d) double d7) {
        ...
        double d9;
        double d10;
        double d11 = (((3.2406d * d5) + ((-1.5372d) * d6)) + ((-0.4986d) * d7)) / 100.0d;
        double d12 = ((((-0.9689d) * d5) + (1.8758d * d6)) + (0.0415d * d7)) / 100.0d;
        double d13 = (((0.0557d * d5) + ((-0.204d) * d6)) + (1.057d * d7)) / 100.0d;
        if (d11 > 0.0031308d) {
    ...
    public static void XYZToLAB(@FloatRange(from = 0.0d, to = 95.047d) double d5, @FloatRange(from = 0.0d, to = 100.0d) double d6, @FloatRange(from = 0.0d, to = 108.883d) double d7, @NonNull double[] dArr) {
        if (dArr.length == 3) {
            ...
            double pivotXyzComponent2 = pivotXyzComponent(d6 / 100.0d);
    ...
    public static void colorToM3HCT(@ColorInt int i5, @NonNull @Size(3) float[] fArr) {
