...
public final class PointerIconCompat {
    ...
    @NonNull
    public static PointerIconCompat create(@NonNull Bitmap bitmap, float f5, float f6) {
        return new PointerIconCompat(Api24Impl.create(bitmap, f5, f6));
    }

    @NonNull
    public static PointerIconCompat getSystemIcon(@NonNull Context context, int i5) {
        return new PointerIconCompat(Api24Impl.getSystemIcon(context, i5));
    }

    @NonNull
    public static PointerIconCompat load(@NonNull Resources resources, int i5) {
