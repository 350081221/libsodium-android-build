...
public class WindowInsetsCompat {
    ...
    public static class BuilderImpl {
        ...
        void setInsets(int i5, @NonNull Insets insets) {
        ...
        void setInsetsIgnoringVisibility(int i5, @NonNull Insets insets) {
            if (i5 == 8) {
        ...
        void setVisible(int i5, boolean z4) {
        }
    ...
    private static class BuilderImpl30 extends BuilderImpl29 {
        ...
        @Override // androidx.core.view.WindowInsetsCompat.BuilderImpl
        void setVisible(int i5, boolean z4) {
            this.mPlatBuilder.setVisible(TypeImpl30.toPlatformType(i5), z4);
        }
    ...
    public static class Impl20 extends Impl {
        ...
        @NonNull
        protected Insets getInsetsForType(int i5, boolean z4) {
            int i6;
    ...
    public static Insets insetInsets(@NonNull Insets insets, int i5, int i6, int i7, int i8) {
