...
public class AccessibilityDelegateCompat {
    ...
    public boolean performAccessibilityAction(@NonNull View view, int i5, @Nullable Bundle bundle) {
        ...
        if (!z4) {
            z4 = this.mOriginalDelegate.performAccessibilityAction(view, i5, bundle);
        }
