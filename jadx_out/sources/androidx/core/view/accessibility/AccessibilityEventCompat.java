...
public final class AccessibilityEventCompat {
    ...
    static class Api34Impl {
        ...
        @DoNotInline
        static void setAccessibilityDataSensitive(AccessibilityEvent accessibilityEvent, boolean z4) {
            accessibilityEvent.setAccessibilityDataSensitive(z4);
        }
    }
    ...
    public static void setAccessibilityDataSensitive(@NonNull AccessibilityEvent accessibilityEvent, boolean z4) {
        if (Build.VERSION.SDK_INT >= 34) {
            Api34Impl.setAccessibilityDataSensitive(accessibilityEvent, z4);
        }
    }

    public static void setAction(@NonNull AccessibilityEvent accessibilityEvent, int i5) {
        accessibilityEvent.setAction(i5);
    }

    public static void setContentChangeTypes(@NonNull AccessibilityEvent accessibilityEvent, int i5) {
        accessibilityEvent.setContentChangeTypes(i5);
    }

    public static void setMovementGranularity(@NonNull AccessibilityEvent accessibilityEvent, int i5) {
