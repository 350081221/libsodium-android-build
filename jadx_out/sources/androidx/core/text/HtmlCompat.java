...
public final class HtmlCompat {
    ...
    @NonNull
    public static Spanned fromHtml(@NonNull String str, int i5) {
        return Api24Impl.fromHtml(str, i5);
    }

    @NonNull
    public static String toHtml(@NonNull Spanned spanned, int i5) {
        return Api24Impl.toHtml(spanned, i5);
    }

    @NonNull
    public static Spanned fromHtml(@NonNull String str, int i5, @Nullable Html.ImageGetter imageGetter, @Nullable Html.TagHandler tagHandler) {
