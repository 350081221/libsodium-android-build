...
final class FakeDrag {
    ...
    private void addFakeMotionEvent(long j5, int i5, float f5, float f6) {
        MotionEvent obtain = MotionEvent.obtain(this.mFakeDragBeginTime, j5, i5, f5, f6, 0);
    ...
    public boolean fakeDragBy(float f5) {
        ...
        float f7 = this.mRequestedDragDistance - f5;
        ...
        if (!z4) {
            f8 = this.mRequestedDragDistance;
        }
        this.mRecyclerView.scrollBy(i5, i6);
        addFakeMotionEvent(uptimeMillis, 2, f6, f8);
        return true;
    }
