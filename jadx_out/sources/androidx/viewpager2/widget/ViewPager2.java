...
public final class ViewPager2 extends ViewGroup {
    ...
    public abstract class AccessibilityProvider {
        ...
        boolean handlesLmPerformAccessibilityAction(int i5) {
            return false;
        }

        boolean handlesPerformAccessibilityAction(int i5, Bundle bundle) {
            return false;
        }
        ...
        boolean onLmPerformAccessibilityAction(int i5) {
            throw new IllegalStateException("Not implemented.");
        }

        boolean onPerformAccessibilityAction(int i5, Bundle bundle) {
            throw new IllegalStateException("Not implemented.");
        }
    ...
    public class PageAwareAccessibilityProvider extends AccessibilityProvider {
        ...
        void setCurrentItemFromAccessibilityCommand(int i5) {
            if (ViewPager2.this.isUserInputEnabled()) {
        ...
        void updatePageAccessibilityActions() {
            ...
            if (ViewPager2.this.getOrientation() == 0) {
                ...
                if (ViewPager2.this.mCurrentItem > 0) {
                    ViewCompat.replaceAccessibilityAction(viewPager2, new AccessibilityNodeInfoCompat.AccessibilityActionCompat(i6, null), null, this.mActionPageBackward);
                    return;
                }
                return;
            }
    ...
    public void requestTransform() {
        ...
        float f5 = (float) (relativeScrollPosition - i5);
        this.mPageTransformerAdapter.onPageScrolled(i5, f5, Math.round(getPageSize() * f5));
    }
    ...
    void setCurrentItemInternal(int i5, boolean z4) {
        int i6;
