...
public abstract class DynamicAnimation<T extends DynamicAnimation<T>> implements AnimationHandler.AnimationFrameCallback {
    ...
    public static final ViewProperty Z = new ViewProperty(bi.aG) { // from class: androidx.dynamicanimation.animation.DynamicAnimation.11
        @Override // androidx.dynamicanimation.animation.FloatPropertyCompat
        public float getValue(View view) {
    ...
    public boolean doAnimationFrame(long j5) {
        ...
        this.mLastFrameTime = j5;
        boolean updateValueAndVelocity = updateValueAndVelocity(j5 - j6);
    ...
    abstract float getAcceleration(float f5, float f6);
    ...
    abstract boolean isAtEquilibrium(float f5, float f6);
    ...
    void setPropertyValue(float f5) {
    ...
    abstract void setValueThreshold(float f5);
    ...
    abstract boolean updateValueAndVelocity(long j5);
