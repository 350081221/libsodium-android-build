...
public final class HintConstants {
    ...
    @NonNull
    public static String generateSmsOtpHintForCharacterPosition(int i5) {
        Preconditions.checkArgumentInRange(i5, 1, 8, "characterPosition");
        return (AUTOFILL_HINT_SMS_OTP + i5).intern();
    }
}
