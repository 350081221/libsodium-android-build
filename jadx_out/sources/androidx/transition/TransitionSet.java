...
public class TransitionSet extends Transition {
    ...
    public void runAnimators() {
        ...
        if (!this.mPlayTogether) {
            for (int i5 = 1; i5 < this.mTransitions.size(); i5++) {
                Transition transition = this.mTransitions.get(i5 - 1);
                final Transition transition2 = this.mTransitions.get(i5);
    ...
    */
    ...
    public Transition mo6419clone() {
        TransitionSet transitionSet = (TransitionSet) super.mo6419clone();
        transitionSet.mTransitions = new ArrayList<>();
        int size = this.mTransitions.size();
        for (int i5 = 0; i5 < size; i5++) {
            transitionSet.addTransitionInternal(this.mTransitions.get(i5).mo6419clone());
        }
