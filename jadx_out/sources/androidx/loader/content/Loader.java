...
public class Loader<D> {
    ...
    @NonNull
    public String dataToString(@Nullable D d5) {
    ...
    @MainThread
    public void deliverResult(@Nullable D d5) {
    ...
    @MainThread
    public void registerListener(int i5, @NonNull OnLoadCompleteListener<D> onLoadCompleteListener) {
