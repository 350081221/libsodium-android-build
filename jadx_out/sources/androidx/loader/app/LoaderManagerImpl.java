...
public class LoaderManagerImpl extends LoaderManager {
    ...
    public static class LoaderViewModel extends ViewModel {
        ...
        public void dump(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
            if (this.mLoaders.size() > 0) {
                ...
                for (int i5 = 0; i5 < this.mLoaders.size(); i5++) {
                    LoaderInfo valueAt = this.mLoaders.valueAt(i5);
                    printWriter.print(str);
                    printWriter.print("  #");
        ...
        <D> LoaderInfo<D> getLoader(int i5) {
            return this.mLoaders.get(i5);
        }

        boolean hasRunningLoaders() {
            int size = this.mLoaders.size();
            for (int i5 = 0; i5 < size; i5++) {
                if (this.mLoaders.valueAt(i5).isCallbackWaitingForData()) {
                    return true;
                }
            }
            return false;
        ...
        void markForRedelivery() {
            int size = this.mLoaders.size();
            for (int i5 = 0; i5 < size; i5++) {
                this.mLoaders.valueAt(i5).markForRedelivery();
            }
        }
        ...
        public void onCleared() {
            ...
            int size = this.mLoaders.size();
            for (int i5 = 0; i5 < size; i5++) {
                this.mLoaders.valueAt(i5).destroy(true);
            }
            this.mLoaders.clear();
        }

        void putLoader(int i5, @NonNull LoaderInfo loaderInfo) {
            this.mLoaders.put(i5, loaderInfo);
        }

        void removeLoader(int i5) {
    ...
    @NonNull
    @MainThread
    private <D> Loader<D> createAndInstallLoader(int i5, @Nullable Bundle bundle, @NonNull LoaderManager.LoaderCallbacks<D> loaderCallbacks, @Nullable Loader<D> loader) {
        try {
            ...
            if (onCreateLoader != null) {
                ...
                this.mLoaderViewModel.putLoader(i5, loaderInfo);
    ...
    public void destroyLoader(int i5) {
        if (!this.mLoaderViewModel.isCreatingLoader()) {
            if (Looper.getMainLooper() == Looper.myLooper()) {
                ...
                LoaderInfo loader = this.mLoaderViewModel.getLoader(i5);
                if (loader != null) {
                    loader.destroy(true);
    ...
    public <D> Loader<D> getLoader(int i5) {
        if (!this.mLoaderViewModel.isCreatingLoader()) {
            LoaderInfo<D> loader = this.mLoaderViewModel.getLoader(i5);
            if (loader != null) {
    ...
    public <D> Loader<D> initLoader(int i5, @Nullable Bundle bundle, @NonNull LoaderManager.LoaderCallbacks<D> loaderCallbacks) {
        if (!this.mLoaderViewModel.isCreatingLoader()) {
            if (Looper.getMainLooper() == Looper.myLooper()) {
                ...
                if (loader == null) {
                    return createAndInstallLoader(i5, bundle, loaderCallbacks, null);
                }
                if (DEBUG) {
    ...
    public <D> Loader<D> restartLoader(int i5, @Nullable Bundle bundle, @NonNull LoaderManager.LoaderCallbacks<D> loaderCallbacks) {
        ...
        if (!this.mLoaderViewModel.isCreatingLoader()) {
            if (Looper.getMainLooper() == Looper.myLooper()) {
                ...
                LoaderInfo<D> loader2 = this.mLoaderViewModel.getLoader(i5);
                if (loader2 != null) {
                    loader = loader2.destroy(false);
                } else {
                    loader = null;
                }
                return createAndInstallLoader(i5, bundle, loaderCallbacks, loader);
            }
