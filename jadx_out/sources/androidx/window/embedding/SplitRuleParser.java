...
public final class SplitRuleParser {
    private final ComponentName buildClassName(String str, CharSequence charSequence) {
        ...
        if (charSequence != null) {
            ...
            if (!z4) {
                ...
                o32 = f0.o3(obj, ClassPathElement.SEPARATOR_CHAR, 0, false, 6, null);
                if (o32 > 0) {
                ...
                if (!l0.g(obj, org.slf4j.d.ANY_MARKER)) {
                    o33 = f0.o3(obj, external.org.apache.commons.lang3.d.f15957a, 0, false, 6, null);
                    if (o33 < 0) {
                        return new ComponentName(str, str + external.org.apache.commons.lang3.d.f15957a + obj);
                    }
                }
    ...
    private final SplitPairRule parseSplitPairRule(Context context, XmlResourceParser xmlResourceParser) {
        ...
        k5 = l1.k();
        return new SplitPairRule(k5, z4, z5, z6, dimension, dimension2, f5, i5);
    }
    ...
    private final SplitPlaceholderRule parseSplitPlaceholderRule(Context context, XmlResourceParser xmlResourceParser) {
        ...
        return new SplitPlaceholderRule(k5, component, dimension, dimension2, f5, i5);
    }

    /* JADX WARN: Can't fix incorrect switch cases order, some code will duplicate */
    /* JADX WARN: Failed to find 'out' block for switch in B:26:0x0049. Please report as an issue. */
    private final Set<EmbeddingRule> parseSplitXml(Context context, int i5) {
    ...
    @m
    public final Set<EmbeddingRule> parseSplitRules$window_release(@l Context context, int i5) {
