...
public final class ExtensionsWindowLayoutInfoAdapter {
    ...
    @m
    public final FoldingFeature translate$window_release(@l Activity activity, @l androidx.window.extensions.layout.FoldingFeature oemFeature) {
    ...
    @l
    public final WindowLayoutInfo translate$window_release(@l Activity activity, @l androidx.window.extensions.layout.WindowLayoutInfo info) {
