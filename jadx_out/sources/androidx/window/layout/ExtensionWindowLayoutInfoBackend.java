...
public final class ExtensionWindowLayoutInfoBackend implements WindowBackend {
    ...
    private static final class MulticastConsumer implements java.util.function.Consumer<androidx.window.extensions.layout.WindowLayoutInfo> {
        ...
        public final void addListener(@l Consumer<WindowLayoutInfo> listener) {
        ...
        public final void removeListener(@l Consumer<WindowLayoutInfo> listener) {
            l0.p(listener, "listener");
            ReentrantLock reentrantLock = this.multicastConsumerLock;
            reentrantLock.lock();
            try {
        ...
        public void accept(@l androidx.window.extensions.layout.WindowLayoutInfo value) {
            l0.p(value, "value");
            ReentrantLock reentrantLock = this.multicastConsumerLock;
            reentrantLock.lock();
            try {
    ...
    public ExtensionWindowLayoutInfoBackend(@l WindowLayoutComponent component) {
