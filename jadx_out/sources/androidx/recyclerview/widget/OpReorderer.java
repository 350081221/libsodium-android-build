...
class OpReorderer {
    ...
    void swapMoveRemove(List<AdapterHelper.UpdateOp> list, int i5, AdapterHelper.UpdateOp updateOp, int i6, AdapterHelper.UpdateOp updateOp2) {
        boolean z4;
        ...
        if (i11 <= i12) {
            ...
            if (i11 < i12 + i13) {
                updateOp3 = this.mCallback.obtainUpdateOp(2, i11 + 1, (i12 + i13) - i11, null);
