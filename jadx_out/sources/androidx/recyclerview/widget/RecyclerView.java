...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public static abstract class LayoutManager {
        ...
        */
        ...
        public void measureChild(@NonNull View view, int i5, int i6) {
            ...
            int childMeasureSpec = getChildMeasureSpec(getWidth(), getWidthMode(), getPaddingLeft() + getPaddingRight() + i7, ((ViewGroup.MarginLayoutParams) layoutParams).width, canScrollHorizontally());
            int childMeasureSpec2 = getChildMeasureSpec(getHeight(), getHeightMode(), getPaddingTop() + getPaddingBottom() + i8, ((ViewGroup.MarginLayoutParams) layoutParams).height, canScrollVertically());
        ...
        public void measureChildWithMargins(@NonNull View view, int i5, int i6) {
            ...
            int i7 = i5 + itemDecorInsetsForChild.left + itemDecorInsetsForChild.right;
            int i8 = i6 + itemDecorInsetsForChild.top + itemDecorInsetsForChild.bottom;
            int childMeasureSpec = getChildMeasureSpec(getWidth(), getWidthMode(), getPaddingLeft() + getPaddingRight() + ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin + ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin + i7, ((ViewGroup.MarginLayoutParams) layoutParams).width, canScrollHorizontally());
            int childMeasureSpec2 = getChildMeasureSpec(getHeight(), getHeightMode(), getPaddingTop() + getPaddingBottom() + ((ViewGroup.MarginLayoutParams) layoutParams).topMargin + ((ViewGroup.MarginLayoutParams) layoutParams).bottomMargin + i8, ((ViewGroup.MarginLayoutParams) layoutParams).height, canScrollVertically());
            if (shouldMeasureChild(view, childMeasureSpec, childMeasureSpec2, layoutParams)) {
                view.measure(childMeasureSpec, childMeasureSpec2);
            }
        }
        ...
        public boolean shouldMeasureChild(View view, int i5, int i6, LayoutParams layoutParams) {
            if (!view.isLayoutRequested() && this.mMeasurementCacheEnabled && isMeasurementUpToDate(view.getWidth(), i5, ((ViewGroup.MarginLayoutParams) layoutParams).width) && isMeasurementUpToDate(view.getHeight(), i6, ((ViewGroup.MarginLayoutParams) layoutParams).height)) {
                return false;
            }
            return true;
        }
        ...
        public boolean shouldReMeasureChild(View view, int i5, int i6, LayoutParams layoutParams) {
            if (this.mMeasurementCacheEnabled && isMeasurementUpToDate(view.getMeasuredWidth(), i5, ((ViewGroup.MarginLayoutParams) layoutParams).width) && isMeasurementUpToDate(view.getMeasuredHeight(), i6, ((ViewGroup.MarginLayoutParams) layoutParams).height)) {
                return false;
            }
            return true;
        }
    ...
    public static class RecycledViewPool {
        ...
        public void clear() {
            for (int i5 = 0; i5 < this.mScrap.size(); i5++) {
                this.mScrap.valueAt(i5).mScrapHeap.clear();
            }
        }
        ...
        void factorInBindTime(int i5, long j5) {
        ...
        void factorInCreateTime(int i5, long j5) {
            ScrapData scrapDataForType = getScrapDataForType(i5);
        ...
        void onAdapterChanged(Adapter adapter, Adapter adapter2, boolean z4) {
            if (adapter != null) {
                detach();
            }
        ...
        long runningAverage(long j5, long j6) {
        ...
        boolean willBindInTime(int i5, long j5, long j6) {
            long j7 = getScrapDataForType(i5).mBindRunningAverageNs;
            return j7 == 0 || j5 + j7 < j6;
        }

        boolean willCreateInTime(int i5, long j5, long j6) {
    ...
    public final class Recycler {
        ...
        ViewHolder getChangedScrapViewForPosition(int i5) {
            int size;
        ...
        ViewHolder getScrapOrCachedViewForId(long j5, int i5, boolean z4) {
        ...
        ViewHolder getScrapOrHiddenOrCachedHolderForPosition(int i5, boolean z4) {
        ...
        void offsetPositionRecordsForInsert(int i5, int i6) {
            ...
            for (int i7 = 0; i7 < size; i7++) {
                ...
                if (viewHolder != null && viewHolder.mPosition >= i5) {
                    viewHolder.offsetPosition(i6, true);
                }
            }
        }
        ...
        void offsetPositionRecordsForRemove(int i5, int i6, boolean z4) {
            int i7 = i5 + i6;
        ...
        void recycleCachedViewAt(int i5) {
            addViewHolderToRecycledViewPool(this.mCachedViews.get(i5), true);
        ...
        */
        ...
        void viewRangeUpdate(int i5, int i6) {
            int i7;
            int i8 = i6 + i5;
            for (int size = this.mCachedViews.size() - 1; size >= 0; size--) {
                ViewHolder viewHolder = this.mCachedViews.get(size);
        ...
        View getViewForPosition(int i5, boolean z4) {
    ...
    public static abstract class SmoothScroller {
        ...
        void onAnimation(int i5, int i6) {
        ...
        protected abstract void onSeekTargetStep(@Px int i5, @Px int i6, @NonNull State state, @NonNull Action action);
    ...
    public class ViewFlinger implements Runnable {
        ...
        private int computeScrollDuration(int i5, int i6, int i7, int i8) {
            boolean z4;
            int height;
            int i9;
            int abs = Math.abs(i5);
            ...
            float f5 = height;
            float f6 = i10;
            float distanceInfluenceForSnapDuration = f6 + (distanceInfluenceForSnapDuration(Math.min(1.0f, (sqrt2 * 1.0f) / f5)) * f6);
            if (sqrt > 0) {
                i9 = Math.round(Math.abs(distanceInfluenceForSnapDuration / sqrt) * 1000.0f) * 4;
            } else {
                if (!z4) {
                    abs = abs2;
                }
        ...
        public void run() {
            ...
            if (overScroller.computeScrollOffset()) {
                ...
                if (RecyclerView.this.getOverScrollMode() != 2) {
                    RecyclerView.this.considerReleasingGlowsOnScroll(i8, i9);
                }
                ...
                if (recyclerView3.mAdapter != null) {
                    ...
                    if (smoothScroller != null && !smoothScroller.isPendingInitialRun() && smoothScroller.isRunning()) {
                        ...
                        if (itemCount == 0) {
                            ...
                            smoothScroller.onAnimation(i6, i5);
                        } else {
                            smoothScroller.onAnimation(i6, i5);
                        }
                    }
                ...
                if (!overScroller.isFinished() && ((!z4 && i10 == 0) || (!z5 && i11 == 0))) {
                    z6 = false;
                } else {
                    z6 = true;
                }
                ...
                if (!z7 && z6) {
                    ...
                    if (gapWorker != null) {
                        gapWorker.postFromTraversal(recyclerView7, i6, i5);
                    }
                }
            }
        ...
        public void smoothScrollBy(int i5, int i6, int i7, @Nullable Interpolator interpolator) {
            if (i7 == Integer.MIN_VALUE) {
                i7 = computeScrollDuration(i5, i6, 0, 0);
            }
            int i8 = i7;
    ...
    public static abstract class ViewHolder {
        ...
        void flagRemovedAndOffsetPosition(int i5, int i6, boolean z4) {
            addFlags(8);
        ...
        void offsetPosition(int i5, boolean z4) {
        ...
        void setScrapContainer(Recycler recycler, boolean z4) {
    ...
    private String getFullClassName(Context context, String str) {
        ...
        return RecyclerView.class.getPackage().getName() + d.f15957a + str;
    }
    ...
    */
    ...
    public ViewHolder findViewHolderForAdapterPosition(int i5) {
        ...
        for (int i6 = 0; i6 < unfilteredChildCount; i6++) {
            ...
            if (childViewHolderInt != null && !childViewHolderInt.isRemoved() && getAdapterPositionFor(childViewHolderInt) == i5) {
    ...
    public boolean fling(int i5, int i6) {
        ...
        if (!dispatchNestedPreFling(f5, f6)) {
            ...
            if (z4) {
                ...
                this.mViewFlinger.fling(max, Math.max(-i8, Math.min(i6, i8)));
                return true;
            }
        }
        return false;
    ...
    public View focusSearch(View view, int i5) {
        ...
        if (!isPreferredNextFocus(view, view2, i5)) {
            return super.focusSearch(view, i5);
        }
        return view2;
    }
    ...
    */
    ...
    boolean scrollByInternal(int i5, int i6, MotionEvent motionEvent) {
        int i7;
        int i8;
        int i9;
        int i10;
    ...
    void scrollStep(int i5, int i6, @Nullable int[] iArr) {
        int i7;
        int i8;
        startInterceptRequestLayout();
        onEnterLayoutOrScroll();
    ...
    @VisibleForTesting
    boolean setChildImportantForAccessibilityInternal(ViewHolder viewHolder, int i5) {
        if (isComputingLayout()) {
    ...
    */
    ...
    void smoothScrollBy(@Px int i5, @Px int i6, @Nullable Interpolator interpolator, int i7, boolean z4) {
        LayoutManager layoutManager = this.mLayout;
        if (layoutManager == null) {
            Log.e(TAG, "Cannot smooth scroll without a LayoutManager set. Call setLayoutManager with a non-null argument.");
            return;
