...
public class LinearSnapHelper extends SnapHelper {
    ...
    private int estimateNextPositionDiffForFling(RecyclerView.LayoutManager layoutManager, OrientationHelper orientationHelper, int i5, int i6) {
        ...
        if (Math.abs(calculateScrollDistance[0]) > Math.abs(calculateScrollDistance[1])) {
            i7 = calculateScrollDistance[0];
        } else {
            i7 = calculateScrollDistance[1];
        }
    ...
    public int findTargetSnapPosition(RecyclerView.LayoutManager layoutManager, int i5, int i6) {
        ...
        int i10 = 0;
        if (layoutManager.canScrollHorizontally()) {
            i8 = estimateNextPositionDiffForFling(layoutManager, getHorizontalHelper(layoutManager), i5, 0);
        ...
        if (layoutManager.canScrollVertically()) {
            i9 = estimateNextPositionDiffForFling(layoutManager, getVerticalHelper(layoutManager), 0, i6);
