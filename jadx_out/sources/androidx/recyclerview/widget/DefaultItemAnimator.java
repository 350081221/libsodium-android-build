...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    void animateMoveImpl(final RecyclerView.ViewHolder viewHolder, int i5, int i6, int i7, int i8) {
        final View view = viewHolder.itemView;
        final int i9 = i7 - i5;
        final int i10 = i8 - i6;
        if (i9 != 0) {
    ...
    public void runPendingAnimations() {
        ...
        if (z7) {
            ...
            ViewCompat.postOnAnimationDelayed(arrayList3.get(0).itemView, runnable3, j5 + Math.max(j6, j7));
        }
    }
