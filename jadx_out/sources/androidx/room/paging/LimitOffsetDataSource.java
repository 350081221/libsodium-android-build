...
public abstract class LimitOffsetDataSource<T> extends PositionalDataSource<T> {
    ...
    protected LimitOffsetDataSource(@NonNull RoomDatabase roomDatabase, @NonNull SupportSQLiteQuery supportSQLiteQuery, boolean z4, @NonNull String... strArr) {
    ...
    protected LimitOffsetDataSource(@NonNull RoomDatabase roomDatabase, @NonNull SupportSQLiteQuery supportSQLiteQuery, boolean z4, boolean z5, @NonNull String... strArr) {
    ...
    protected LimitOffsetDataSource(@NonNull RoomDatabase roomDatabase, @NonNull RoomSQLiteQuery roomSQLiteQuery, boolean z4, @NonNull String... strArr) {
        this(roomDatabase, roomSQLiteQuery, z4, true, strArr);
    }

    protected LimitOffsetDataSource(@NonNull RoomDatabase roomDatabase, @NonNull RoomSQLiteQuery roomSQLiteQuery, boolean z4, boolean z5, @NonNull String... strArr) {
