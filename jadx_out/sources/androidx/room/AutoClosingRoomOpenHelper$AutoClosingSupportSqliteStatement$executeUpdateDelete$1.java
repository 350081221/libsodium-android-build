...
final class AutoClosingRoomOpenHelper$AutoClosingSupportSqliteStatement$executeUpdateDelete$1 extends n0 implements v3.l<SupportSQLiteStatement, Integer> {
    ...
    @Override // v3.l
    @p4.l
    public final Integer invoke(@p4.l SupportSQLiteStatement obj) {
        l0.p(obj, "obj");
