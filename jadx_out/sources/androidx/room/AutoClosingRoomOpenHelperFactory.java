...
public final class AutoClosingRoomOpenHelperFactory implements SupportSQLiteOpenHelper.Factory {
    ...
    public AutoClosingRoomOpenHelperFactory(@p4.l SupportSQLiteOpenHelper.Factory delegate, @p4.l AutoCloser autoCloser) {
    ...
    @p4.l
    public AutoClosingRoomOpenHelper create(@p4.l SupportSQLiteOpenHelper.Configuration configuration) {
