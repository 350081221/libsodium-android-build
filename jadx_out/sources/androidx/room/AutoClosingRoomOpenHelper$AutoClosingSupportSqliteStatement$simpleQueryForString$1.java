...
final class AutoClosingRoomOpenHelper$AutoClosingSupportSqliteStatement$simpleQueryForString$1 extends n0 implements v3.l<SupportSQLiteStatement, String> {
    ...
    @Override // v3.l
    @p4.m
    public final String invoke(@p4.l SupportSQLiteStatement obj) {
        l0.p(obj, "obj");
