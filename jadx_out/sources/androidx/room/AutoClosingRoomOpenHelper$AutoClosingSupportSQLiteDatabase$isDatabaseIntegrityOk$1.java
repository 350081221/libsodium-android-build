...
final class AutoClosingRoomOpenHelper$AutoClosingSupportSQLiteDatabase$isDatabaseIntegrityOk$1 extends n0 implements v3.l<SupportSQLiteDatabase, Boolean> {
    ...
    @Override // v3.l
    @p4.l
    public final Boolean invoke(@p4.l SupportSQLiteDatabase obj) {
        l0.p(obj, "obj");
