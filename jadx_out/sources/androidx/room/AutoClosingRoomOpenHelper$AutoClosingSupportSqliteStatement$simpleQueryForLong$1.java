...
final class AutoClosingRoomOpenHelper$AutoClosingSupportSqliteStatement$simpleQueryForLong$1 extends n0 implements v3.l<SupportSQLiteStatement, Long> {
    ...
    @Override // v3.l
    @p4.l
    public final Long invoke(@p4.l SupportSQLiteStatement obj) {
        l0.p(obj, "obj");
