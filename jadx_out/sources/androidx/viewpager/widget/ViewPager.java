...
public class ViewPager extends ViewGroup {
    ...
    public static class SavedState extends AbsSavedState {
        ...
        public String toString() {
            return "FragmentPager.SavedState{" + Integer.toHexString(System.identityHashCode(this)) + " position=" + this.position + i.f138d;
        }
    ...
    private void calculatePageOffsets(ItemInfo itemInfo, int i5, ItemInfo itemInfo2) {
        ...
        while (i15 >= 0) {
            ...
            f10 -= itemInfo7.widthFactor + f5;
            itemInfo7.offset = f10;
            if (i7 == 0) {
        ...
        while (i17 < size2) {
            ...
            if (i6 == i14) {
                this.mLastOffset = (itemInfo8.widthFactor + f11) - 1.0f;
            }
            itemInfo8.offset = f11;
            f11 += itemInfo8.widthFactor + f5;
            i17++;
            i16++;
        }
        this.mNeedCalculatePageOffsets = false;
    ...
    private int determineTargetPage(int i5, float f5, int i6, int i7) {
        ...
        if (this.mItems.size() > 0) {
            return Math.max(this.mItems.get(0).position, Math.min(i5, this.mItems.get(r4.size() - 1).position));
        }
        return i5;
    }
    ...
    private ItemInfo infoForCurrentScrollPosition() {
        ...
        if (clientWidth > 0) {
            f6 = this.mPageMargin / clientWidth;
        } else {
            f6 = 0.0f;
        }
        int i6 = 0;
        ...
        while (i6 < this.mItems.size()) {
            ...
            if (f5 >= f9 && i6 != this.mItems.size() - 1) {
    ...
    private boolean isGutterDrag(float f5, float f6) {
        return (f5 < ((float) this.mGutterSize) && f6 > 0.0f) || (f5 > ((float) (getWidth() - this.mGutterSize)) && f6 < 0.0f);
    }
    ...
    private boolean pageScrolled(int i5) {
        ...
        float f6 = ((i5 / f5) - infoForCurrentScrollPosition.offset) / (infoForCurrentScrollPosition.widthFactor + (i6 / f5));
        this.mCalledSuper = false;
    ...
    private void scrollToItem(int i5, boolean z4, int i6, boolean z5) {
        ...
        if (infoForPosition != null) {
            i7 = (int) (getClientWidth() * Math.max(this.mFirstOffset, Math.min(infoForPosition.offset, this.mLastOffset)));
        } else {
            i7 = 0;
        }
        if (z4) {
    ...
    ItemInfo addNewItem(int i5, int i6) {
    ...
    */
    ...
    public boolean canScrollHorizontally(int i5) {
        ...
        if (i5 <= 0 || scrollX >= ((int) (clientWidth * this.mLastOffset))) {
            return false;
        }
        return true;
    }
    ...
    float distanceInfluenceForSnapDuration(float f5) {
    ...
    ItemInfo infoForPosition(int i5) {
            ...
            if (action != 0) {
                if (action != 2) {
                    ...
                    if (i5 != -1) {
                        ...
                        float f6 = x4 - this.mLastMotionX;
                        float abs = Math.abs(f6);
                        float y4 = motionEvent.getY(findPointerIndex);
                        float abs2 = Math.abs(y4 - this.mInitialMotionY);
                        if (f6 != 0.0f && !isGutterDrag(this.mLastMotionX, f6) && canScroll(this, false, (int) f6, (int) x4, (int) y4)) {
    ...
    */
        ...
        if (action != 0) {
            if (action != 1) {
                if (action != 2) {
                    ...
                    if (this.mIsBeingDragged) {
                        z4 = false | performDrag(motionEvent.getX(motionEvent.findPointerIndex(this.mActivePointerId)));
                    }
                }
            } else if (this.mIsBeingDragged) {
                VelocityTracker velocityTracker = this.mVelocityTracker;
                ...
                setCurrentItemInternal(determineTargetPage(infoForCurrentScrollPosition.position, ((scrollX / f7) - infoForCurrentScrollPosition.offset) / (infoForCurrentScrollPosition.widthFactor + (this.mPageMargin / f7)), xVelocity, (int) (motionEvent.getX(motionEvent.findPointerIndex(this.mActivePointerId)) - this.mInitialMotionX)), true, true, xVelocity);
                z4 = resetTouch();
            }
        } else {
            this.mScroller.abortAnimation();
    ...
    void setCurrentItemInternal(int i5, boolean z4, boolean z5) {
    ...
    void smoothScrollTo(int i5, int i6) {
    ...
    */
    ...
    void setCurrentItemInternal(int i5, boolean z4, boolean z5, int i6) {
        PagerAdapter pagerAdapter = this.mAdapter;
    ...
    void smoothScrollTo(int i5, int i6, int i7) {
        int scrollX;
        int abs;
        if (getChildCount() == 0) {
            setScrollingCacheEnabled(false);
        ...
        float f5 = clientWidth;
        float f6 = i11;
        float distanceInfluenceForSnapDuration = f6 + (distanceInfluenceForSnapDuration(Math.min(1.0f, (Math.abs(i9) * 1.0f) / f5)) * f6);
        int abs2 = Math.abs(i7);
        if (abs2 > 0) {
            abs = Math.round(Math.abs(distanceInfluenceForSnapDuration / abs2) * 1000.0f) * 4;
        } else {
            abs = (int) (((Math.abs(i9) / ((f5 * this.mAdapter.getPageWidth(this.mCurItem)) + this.mPageMargin)) + 1.0f) * 100.0f);
        }
