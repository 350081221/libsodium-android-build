...
public class AnimatedVectorDrawableCompat extends VectorDrawableCommon implements Animatable2Compat {
            ...
            if (animatedVectorDrawableCompatState != null) {
                ...
                if (arrayList != null) {
                    ...
                    for (int i5 = 0; i5 < size; i5++) {
                        Animator animator = animatedVectorDrawableCompatState.mAnimators.get(i5);
    ...
    @Nullable
    public static AnimatedVectorDrawableCompat create(@NonNull Context context, @DrawableRes int i5) {
    ...
    private void setupColorAnimator(Animator animator) {
        ...
        if ((animator instanceof AnimatorSet) && (childAnimations = ((AnimatorSet) animator).getChildAnimations()) != null) {
            for (int i5 = 0; i5 < childAnimations.size(); i5++) {
                setupColorAnimator(childAnimations.get(i5));
            }
        }
    ...
    protected boolean onLevelChange(int i5) {
        ...
        return this.mAnimatedVectorState.mVectorDrawable.setLevel(i5);
    }
        ...
        if (this.mAnimatorListener == null) {
            this.mAnimatorListener = new AnimatorListenerAdapter() { // from class: androidx.vectordrawable.graphics.drawable.AnimatedVectorDrawableCompat.2
                ...
                public void onAnimationEnd(Animator animator) {
                    ...
                    int size = arrayList.size();
                    for (int i5 = 0; i5 < size; i5++) {
                        ((Animatable2Compat.AnimationCallback) arrayList.get(i5)).onAnimationEnd(AnimatedVectorDrawableCompat.this);
                    }
                }
                ...
                public void onAnimationStart(Animator animator) {
                    ...
                    int size = arrayList.size();
                    for (int i5 = 0; i5 < size; i5++) {
                        ((Animatable2Compat.AnimationCallback) arrayList.get(i5)).onAnimationStart(AnimatedVectorDrawableCompat.this);
                    }
                }
            };
        }
    ...
    public void setAlpha(int i5) {
        ...
        if (drawable != null) {
            ...
            this.mAnimatedVectorState.mVectorDrawable.setAlpha(i5);
        }
    }
    ...
    public void setAutoMirrored(boolean z4) {
        ...
        if (drawable != null) {
            ...
            this.mAnimatedVectorState.mVectorDrawable.setAutoMirrored(z4);
        }
    }
    ...
    public void setTint(int i5) {
        ...
        if (drawable != null) {
            ...
            this.mAnimatedVectorState.mVectorDrawable.setTint(i5);
        }
    }
    ...
    public boolean setVisible(boolean z4, boolean z5) {
        ...
        this.mAnimatedVectorState.mVectorDrawable.setVisible(z4, z5);
