...
public final class NavGraphViewModelLazyKt$navGraphViewModels$5 extends n0 implements v3.a<CreationExtras> {
    final /* synthetic */ d0<NavBackStackEntry> $backStackEntry$delegate;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public NavGraphViewModelLazyKt$navGraphViewModels$5(d0<NavBackStackEntry> d0Var) {
        super(0);
    ...
    public final CreationExtras invoke() {
        ...
        return m6414navGraphViewModels$lambda2.getDefaultViewModelCreationExtras();
    }
}
