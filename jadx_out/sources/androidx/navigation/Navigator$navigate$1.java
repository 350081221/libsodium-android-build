...
public final class Navigator$navigate$1 extends n0 implements l<NavBackStackEntry, NavBackStackEntry> {
    ...
    @Override // v3.l
    @m
    public final NavBackStackEntry invoke(@p4.l NavBackStackEntry backStackEntry) {
        ...
        if (destination != null && (navigate = this.this$0.navigate(destination, backStackEntry.getArguments(), this.$navOptions, this.$navigatorExtras)) != null) {
            return l0.g(navigate, destination) ? backStackEntry : this.this$0.getState().createBackStackEntry(navigate, navigate.addInDefaultArgs(backStackEntry.getArguments()));
        }
        return null;
    }
}
