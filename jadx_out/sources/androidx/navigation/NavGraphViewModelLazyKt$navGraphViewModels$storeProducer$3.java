...
public final class NavGraphViewModelLazyKt$navGraphViewModels$storeProducer$3 extends n0 implements v3.a<ViewModelStore> {
    final /* synthetic */ d0<NavBackStackEntry> $backStackEntry$delegate;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public NavGraphViewModelLazyKt$navGraphViewModels$storeProducer$3(d0<NavBackStackEntry> d0Var) {
        super(0);
    ...
    public final ViewModelStore invoke() {
        ...
        return m6414navGraphViewModels$lambda2.getViewModelStore();
    }
}
