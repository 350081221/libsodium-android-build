...
public final class NavBackStackEntryProviderKt$SaveableStateProvider$1 extends n0 implements p<Composer, Integer, r2> {
    ...
    public NavBackStackEntryProviderKt$SaveableStateProvider$1(SaveableStateHolder saveableStateHolder, p<? super Composer, ? super Integer, r2> pVar, int i5) {
        super(2);
