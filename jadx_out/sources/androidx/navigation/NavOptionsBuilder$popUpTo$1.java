...
public final class NavOptionsBuilder$popUpTo$1 extends n0 implements l<PopUpToBuilder, r2> {
    ...
    public final void invoke2(@p4.l PopUpToBuilder popUpToBuilder) {
        l0.p(popUpToBuilder, "$this$null");
    }
}
