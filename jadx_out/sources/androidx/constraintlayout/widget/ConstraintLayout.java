...
public class ConstraintLayout extends ViewGroup {
    ...
    public class Measurer implements BasicMeasure.Measurer {
        ...
        public final void didMeasures() {
            ...
            if (size > 0) {
                for (int i6 = 0; i6 < size; i6++) {
                    ((ConstraintHelper) this.layout.mConstraintHelpers.get(i6)).updatePostMeasure(this.layout);
                }
            }
        }
        ...
        public final void measure(ConstraintWidget constraintWidget, BasicMeasure.Measure measure) {
            ...
            if (i14 != 1) {
                if (i14 != 2) {
                    if (i14 != 3) {
                        ...
                        makeMeasureSpec = ViewGroup.getChildMeasureSpec(this.layoutWidthSpec, i13 + constraintWidget.getHorizontalMargin(), -1);
                    }
                } else {
                    makeMeasureSpec = ViewGroup.getChildMeasureSpec(this.layoutWidthSpec, i13, -2);
                }
                    ...
                    if (i16 != 3) {
                        if (i16 != 4) {
                            ...
                            if (i17 == BasicMeasure.Measure.TRY_GIVEN_DIMENSIONS || i17 == BasicMeasure.Measure.USE_GIVEN_DIMENSIONS) {
                                ...
                                if (measure.measureStrategy != BasicMeasure.Measure.USE_GIVEN_DIMENSIONS && z13 && ((!z13 || !z14) && !(view instanceof Placeholder) && !constraintWidget.isResolvedVertically())) {
                                    z15 = false;
                                } else {
                                    z15 = true;
                                }
                        ...
                        makeMeasureSpec2 = ViewGroup.getChildMeasureSpec(this.layoutHeightSpec, i12 + constraintWidget.getVerticalMargin(), -1);
                    }
                } else {
                    makeMeasureSpec2 = ViewGroup.getChildMeasureSpec(this.layoutHeightSpec, i12, -2);
                }
            ...
            if (i18 != BasicMeasure.Measure.TRY_GIVEN_DIMENSIONS && i18 != BasicMeasure.Measure.USE_GIVEN_DIMENSIONS && z4 && constraintWidget.mMatchConstraintDefaultWidth == 0 && z5 && constraintWidget.mMatchConstraintDefaultHeight == 0) {
                i9 = -1;
                i7 = 0;
                baseline = 0;
                i5 = 0;
                ...
                if (i21 > 0) {
                    i7 = Math.max(i21, measuredHeight);
                    i6 = makeMeasureSpec;
                } else {
                    i6 = makeMeasureSpec;
                    i7 = measuredHeight;
                ...
                if (!Optimizer.enabled(ConstraintLayout.this.mOptimizationLevel, 1)) {
                    if (z8 && z6) {
                        i5 = (int) ((i7 * constraintWidget.mDimensionRatio) + 0.5f);
                    } else if (z9 && z7) {
                        i7 = (int) ((i5 / constraintWidget.mDimensionRatio) + 0.5f);
                    }
                }
                if (measuredWidth != i5 || measuredHeight != i7) {
                    if (measuredWidth != i5) {
                        i8 = View.MeasureSpec.makeMeasureSpec(i5, 1073741824);
                    } else {
                        i8 = i6;
                    }
            ...
            if (i5 == measure.horizontalDimension && i7 == measure.verticalDimension) {
                z11 = false;
            } else {
                z11 = true;
            }
            measure.measuredNeedsSolverPass = z11;
            ...
            measure.measuredWidth = i5;
            measure.measuredHeight = i7;
    ...
    public void applyConstraintsFromLayoutParams(boolean z4, View view, ConstraintWidget constraintWidget, LayoutParams layoutParams, SparseArray<ConstraintWidget> sparseArray) {
        ...
        if (i14 != -1) {
            ...
            if (i10 != -1) {
                ...
                if (constraintWidget8 != null) {
                    constraintWidget.immediateConnect(ConstraintAnchor.Type.RIGHT, constraintWidget8, ConstraintAnchor.Type.LEFT, ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin, i13);
                }
        ...
        if (z4 && ((i5 = layoutParams.editorAbsoluteX) != -1 || layoutParams.editorAbsoluteY != -1)) {
    ...
    public void resolveMeasuredDimension(int i5, int i6, int i7, int i8, boolean z4, boolean z5) {
        ...
        int i9 = measurer.paddingHeight;
        int resolveSizeAndState = View.resolveSizeAndState(i7 + measurer.paddingWidth, i5, 0);
    ...
    protected void setSelfDimensionBehaviour(ConstraintWidgetContainer constraintWidgetContainer, int i5, int i6, int i7, int i8) {
