...
public class ConstraintSet {
    ...
    class WriteXmlEngine {
        ...
        private void writeBaseDimension(String str, int i5, int i6) throws IOException {
            if (i5 != i6) {
                ...
                this.writer.write(SPACE + str + "=\"" + i5 + "dp\"");
            }
        }
        ...
        private void writeEnum(String str, int i5, String[] strArr, int i6) throws IOException {
            if (i5 != i6) {
                this.writer.write(SPACE + str + "=\"" + strArr[i5] + "\"");
            }
        }

        String getName(int i5) {
            if (this.idMap.containsKey(Integer.valueOf(i5))) {
                return "@+id/" + this.idMap.get(Integer.valueOf(i5)) + "";
            }
            if (i5 == 0) {
        ...
        void writeCircle(int i5, float f5, int i6) throws IOException {
            if (i5 == -1) {
                return;
            }
            ...
            this.writer.write(", " + f5);
            this.writer.write(i6 + "]");
        }

        void writeConstraint(String str, int i5, String str2, int i6, int i7) throws IOException {
            if (i5 == -1) {
                return;
            }
        ...
        void writeVariable(String str, int i5) throws IOException {
            if (i5 == 0 || i5 == -1) {
                return;
            }
            this.writer.write(SPACE + str + "=\"" + i5 + "\"\n");
        }

        void writeXmlConstraint(String str, int i5) throws IOException {
            if (i5 == -1) {
                return;
            }
            this.writer.write(SPACE + str);
        ...
        void writeVariable(String str, float f5, float f6) throws IOException {
            if (f5 == f6) {
                return;
            }
            this.writer.write(SPACE + str);
    ...
    private Constraint fillFromAttributeList(Context context, AttributeSet attributeSet, boolean z4) {
        ...
        populateConstraint(context, constraint, obtainStyledAttributes, z4);
        obtainStyledAttributes.recycle();
        return constraint;
    }
    ...
    */
    ...
    public static void parseDimensionRatioString(ConstraintLayout.LayoutParams layoutParams, String str) {
        ...
        layoutParams.dimensionRatioValue = f5;
        layoutParams.dimensionRatioSide = i5;
    }

    private void populateConstraint(Context context, Constraint constraint, TypedArray typedArray, boolean z4) {
        if (z4) {
        ...
        if (i8 >= 0) {
            if (i11 >= 0) {
                if (f5 > 0.0f && f5 <= 1.0f) {
                    ...
                    if (constraint3 != null) {
                        constraint3.layout.horizontalBias = f5;
                        return;
                    }
                    return;
                }
    ...
    public void parseStringAttributes(Constraint constraint, String str) {
        ...
        for (int i5 = 0; i5 < splitString.length; i5++) {
            String[] split = splitString[i5].split(ContainerUtils.KEY_VALUE_DELIMITER);
    ...
    public void removeFromHorizontalChain(int i5) {
        ...
        if (i6 != -1 && i7 != -1) {
            ...
            if (i12 != -1) {
                connect(i6, 2, i12, 2, 0);
            } else {
                int i13 = layout.leftToLeft;
                if (i13 != -1) {
                    connect(i7, 1, i13, 1, 0);
                }
            }
        }
        clear(i5, 1);
    ...
    public void clone(ConstraintSet constraintSet) {
        ...
        for (Integer num : constraintSet.mConstraints.keySet()) {
            Constraint constraint = constraintSet.mConstraints.get(num);
            if (constraint != null) {
                this.mConstraints.put(num, constraint.m6397clone());
            }
        }
    }
    ...
    class WriteJsonEngine {
        ...
        private void writeDimension(String str, int i5, int i6, float f5, int i7, int i8, boolean z4) throws IOException {
            if (i5 == 0) {
                if (i8 == -1 && i7 == -1) {
                    if (i6 != 1) {
                        if (i6 == 2) {
                            this.writer.write(SPACE + str + ": '" + f5 + "%',\n");
                            return;
                        }
                        return;
                    }
                ...
                if (i6 != 0) {
                    if (i6 != 1) {
                        if (i6 == 2) {
                            this.writer.write(SPACE + str + ": {'" + f5 + "'% ," + i7 + ", " + i8 + "}\n");
                            return;
                        }
                        return;
                    }
                    this.writer.write(SPACE + str + ": {'wrap' ," + i7 + ", " + i8 + "}\n");
                    return;
                }
                this.writer.write(SPACE + str + ": {'spread' ," + i7 + ", " + i8 + "}\n");
                return;
            }
            if (i5 == -2) {
        ...
        private void writeGuideline(int i5, int i6, int i7, float f5) {
        }

        String getName(int i5) {
            if (this.idMap.containsKey(Integer.valueOf(i5))) {
                return "'" + this.idMap.get(Integer.valueOf(i5)) + "'";
            }
            if (i5 == 0) {
                return "'parent'";
            }
        ...
        void writeVariable(String str, float f5) throws IOException {
            if (f5 == -1.0f) {
                return;
            }
            this.writer.write(SPACE + str);
