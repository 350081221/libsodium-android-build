    ...
    private void defineChainProperties() {
        ...
        while (!z5) {
            ...
            if (constraintWidget.getVisibility() != 8) {
                ...
                int margin = this.mTotalSize + constraintWidget.mListAnchors[i5].getMargin();
                this.mTotalSize = margin;
                int i7 = i5 + 1;
                this.mTotalSize = margin + constraintWidget.mListAnchors[i7].getMargin();
                int margin2 = this.mTotalMargins + constraintWidget.mListAnchors[i5].getMargin();
                this.mTotalMargins = margin2;
                this.mTotalMargins = margin2 + constraintWidget.mListAnchors[i7].getMargin();
