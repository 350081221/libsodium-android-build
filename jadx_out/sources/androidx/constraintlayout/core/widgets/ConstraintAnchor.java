...
public class ConstraintAnchor {
    ...
    private boolean isConnectionToMe(ConstraintWidget constraintWidget, HashSet<ConstraintWidget> hashSet) {
        ...
        for (int i5 = 0; i5 < size; i5++) {
            ConstraintAnchor constraintAnchor = anchors.get(i5);
    ...
    public void findDependents(int i5, ArrayList<WidgetGroup> arrayList, WidgetGroup widgetGroup) {
        ...
        if (hashSet != null) {
            ...
            while (it.hasNext()) {
                Grouping.findDependents(it.next().mOwner, i5, arrayList, widgetGroup);
            }
        }
    }
