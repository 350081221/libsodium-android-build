...
public class VerticalWidgetRun extends WidgetRun {
    ...
    void apply() {
        ...
        if (!z4 && this.dimensionBehavior == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
            ConstraintWidget constraintWidget3 = this.widget;
            int i5 = constraintWidget3.mMatchConstraintDefaultHeight;
            if (i5 != 2) {
                if (i5 == 3 && !constraintWidget3.isInVerticalChain()) {
    ...
    public void update(Dependency dependency) {
        ...
        if (dimensionDependency.readyToSolve && !dimensionDependency.resolved && this.dimensionBehavior == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
            ...
            if (i7 != 2) {
                if (i7 == 3 && constraintWidget2.horizontalRun.dimension.resolved) {
                    ...
                    if (dimensionRatioSide != -1) {
                        if (dimensionRatioSide != 0) {
                            if (dimensionRatioSide != 1) {
                                ...
                                ConstraintWidget constraintWidget3 = this.widget;
                                f5 = constraintWidget3.horizontalRun.dimension.value;
                                dimensionRatio = constraintWidget3.getDimensionRatio();
                            }
                        } else {
                            f6 = r7.horizontalRun.dimension.value * this.widget.getDimensionRatio();
                            i5 = (int) (f6 + 0.5f);
                            this.dimension.resolve(i5);
                        }
                    } else {
                        ConstraintWidget constraintWidget4 = this.widget;
                        f5 = constraintWidget4.horizontalRun.dimension.value;
            ...
            if (dependencyNode2.readyToSolve) {
                ...
                if (!this.dimension.resolved && this.dimensionBehavior == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
                    ...
                    if (constraintWidget5.mMatchConstraintDefaultWidth == 0 && !constraintWidget5.isInVerticalChain()) {
                        ...
                        int i9 = i8 + dependencyNode5.margin;
                ...
                if (!this.dimension.resolved && this.dimensionBehavior == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT && this.matchConstraintsType == 1 && this.start.targets.size() > 0 && this.end.targets.size() > 0) {
                    ...
                    int i11 = (this.end.targets.get(0).value + this.end.margin) - (dependencyNode6.value + this.start.margin);
                    DimensionDependency dimensionDependency2 = this.dimension;
                    int i12 = dimensionDependency2.wrapValue;
                    if (i11 < i12) {
                ...
                if (this.dimension.resolved && this.start.targets.size() > 0 && this.end.targets.size() > 0) {
                    ...
                    int i13 = dependencyNode7.value + this.start.margin;
                    int i14 = dependencyNode8.value + this.end.margin;
                    ...
                    this.start.resolve((int) (i13 + 0.5f + (((i14 - i13) - this.dimension.value) * verticalBiasPercent)));
