...
public class Direct {
    ...
    private static void horizontalSolvingPass(int i5, ConstraintWidget constraintWidget, BasicMeasure.Measurer measurer, boolean z4) {
        ...
        if (anchor.getDependents() != null && anchor.hasFinalValue()) {
            ...
            while (it.hasNext()) {
                ...
                int i7 = i5 + 1;
                boolean canMeasure = canMeasure(i7, constraintWidget2);
                ...
                if (horizontalDimensionBehaviour == dimensionBehaviour && !canMeasure) {
                    if (constraintWidget2.getHorizontalDimensionBehaviour() == dimensionBehaviour && constraintWidget2.mMatchConstraintMaxWidth >= 0 && constraintWidget2.mMatchConstraintMinWidth >= 0 && ((constraintWidget2.getVisibility() == 8 || (constraintWidget2.mMatchConstraintDefaultWidth == 0 && constraintWidget2.getDimensionRatio() == 0.0f)) && !constraintWidget2.isInHorizontalChain() && !constraintWidget2.isInVirtualLayout() && z6 && !constraintWidget2.isInHorizontalChain())) {
                        solveHorizontalMatchConstraint(i7, constraintWidget, measurer, constraintWidget2, z4);
                    }
                    ...
                    if (next == constraintAnchor5 && constraintWidget2.mRight.mTarget == null) {
                        ...
                        horizontalSolvingPass(i7, constraintWidget2, measurer, z4);
                    } else {
                        ...
                        if (next == constraintAnchor6 && constraintAnchor5.mTarget == null) {
                            ...
                            horizontalSolvingPass(i7, constraintWidget2, measurer, z4);
                        } else if (z6 && !constraintWidget2.isInHorizontalChain()) {
                            solveHorizontalCenterConstraints(i7, measurer, constraintWidget2, z4);
                        }
                    }
                }
                z7 = true;
        ...
        if (anchor2.getDependents() != null && anchor2.hasFinalValue()) {
            ...
            while (it2.hasNext()) {
                ...
                int i8 = i5 + 1;
                boolean canMeasure2 = canMeasure(i8, constraintWidget3);
                ...
                if (horizontalDimensionBehaviour2 == dimensionBehaviour2 && !canMeasure2) {
                    if (constraintWidget3.getHorizontalDimensionBehaviour() == dimensionBehaviour2 && constraintWidget3.mMatchConstraintMaxWidth >= 0 && constraintWidget3.mMatchConstraintMinWidth >= 0 && (constraintWidget3.getVisibility() == 8 || (constraintWidget3.mMatchConstraintDefaultWidth == 0 && constraintWidget3.getDimensionRatio() == 0.0f))) {
                        if (!constraintWidget3.isInHorizontalChain() && !constraintWidget3.isInVirtualLayout() && z5 && !constraintWidget3.isInHorizontalChain()) {
                            solveHorizontalMatchConstraint(i8, constraintWidget, measurer, constraintWidget3, z4);
                        }
                    }
                    ...
                    if (next2 == constraintAnchor7 && constraintWidget3.mRight.mTarget == null) {
                        ...
                        horizontalSolvingPass(i8, constraintWidget3, measurer, z4);
                    } else {
                        ...
                        if (next2 == constraintAnchor8 && constraintAnchor7.mTarget == null) {
                            ...
                            solveHorizontalCenterConstraints(i8, measurer, constraintWidget3, z4);
                        }
                    }
                }
            }
    ...
    */
    ...
    private static void solveHorizontalCenterConstraints(int i5, BasicMeasure.Measurer measurer, ConstraintWidget constraintWidget, boolean z4) {
        ...
        if (i6 > 0) {
            f5 = (horizontalBiasPercent * i6) + 0.5f;
        } else {
            f5 = horizontalBiasPercent * i6;
        }
    ...
    private static void solveHorizontalMatchConstraint(int i5, ConstraintWidget constraintWidget, BasicMeasure.Measurer measurer, ConstraintWidget constraintWidget2, boolean z4) {
        ...
        if (finalValue2 >= finalValue) {
            ...
            int i8 = finalValue + ((int) ((horizontalBiasPercent * ((finalValue2 - finalValue) - width2)) + 0.5f));
            constraintWidget2.setFinalHorizontal(i8, width2 + i8);
    ...
    private static void solveVerticalCenterConstraints(int i5, BasicMeasure.Measurer measurer, ConstraintWidget constraintWidget) {
        ...
        if (i6 > 0) {
            f5 = (verticalBiasPercent * i6) + 0.5f;
        } else {
            f5 = verticalBiasPercent * i6;
        }
        int i7 = (int) f5;
    ...
    private static void solveVerticalMatchConstraint(int i5, ConstraintWidget constraintWidget, BasicMeasure.Measurer measurer, ConstraintWidget constraintWidget2) {
        ...
        if (finalValue2 >= finalValue) {
            ...
            if (constraintWidget2.getVisibility() != 8) {
                ...
                if (i7 > 0) {
                    height2 = Math.min(i7, height2);
                }
            }
            int i8 = finalValue + ((int) ((verticalBiasPercent * ((finalValue2 - finalValue) - height2)) + 0.5f));
            constraintWidget2.setFinalVertical(i8, height2 + i8);
    ...
    private static void verticalSolvingPass(int i5, ConstraintWidget constraintWidget, BasicMeasure.Measurer measurer) {
            ...
            while (it.hasNext()) {
                ...
                if (verticalDimensionBehaviour == dimensionBehaviour && !canMeasure) {
                    if (constraintWidget2.getVerticalDimensionBehaviour() == dimensionBehaviour && constraintWidget2.mMatchConstraintMaxHeight >= 0 && constraintWidget2.mMatchConstraintMinHeight >= 0 && (constraintWidget2.getVisibility() == 8 || (constraintWidget2.mMatchConstraintDefaultHeight == 0 && constraintWidget2.getDimensionRatio() == 0.0f))) {
                        if (!constraintWidget2.isInVerticalChain() && !constraintWidget2.isInVirtualLayout() && z5 && !constraintWidget2.isInVerticalChain()) {
                    ...
                    if (next == constraintAnchor5 && constraintWidget2.mBottom.mTarget == null) {
                        ...
                        if (next == constraintAnchor6 && constraintAnchor5.mTarget == null) {
                            ...
                            verticalSolvingPass(i7, constraintWidget2, measurer);
                        } else if (z5 && !constraintWidget2.isInVerticalChain()) {
        ...
        if (anchor3.getDependents() != null && anchor3.hasFinalValue()) {
            ...
            while (it3.hasNext()) {
                ...
                int i9 = i5 + 1;
                boolean canMeasure3 = canMeasure(i9, constraintWidget4);
