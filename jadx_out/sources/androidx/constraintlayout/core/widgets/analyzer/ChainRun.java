...
public class ChainRun extends WidgetRun {
    ...
    private ConstraintWidget getFirstVisibleWidget() {
        for (int i5 = 0; i5 < this.widgets.size(); i5++) {
            WidgetRun widgetRun = this.widgets.get(i5);
    ...
    public void applyToWidget() {
        for (int i5 = 0; i5 < this.widgets.size(); i5++) {
            this.widgets.get(i5).applyToWidget();
        }
    }
    ...
    public long getWrapDimension() {
        ...
        for (int i5 = 0; i5 < size; i5++) {
            j5 = j5 + r4.start.margin + this.widgets.get(i5).getWrapDimension() + r4.end.margin;
        }
        return j5;
    }
    ...
    boolean supportsWrapComputation() {
        int size = this.widgets.size();
        for (int i5 = 0; i5 < size; i5++) {
            if (!this.widgets.get(i5).supportsWrapComputation()) {
                return false;
            }
        }
        return true;
