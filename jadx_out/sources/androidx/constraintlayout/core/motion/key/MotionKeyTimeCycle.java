...
public class MotionKeyTimeCycle extends MotionKey {
    ...
    */
    ...
    public boolean setValue(int i5, float f5) {
        if (i5 == 315) {
            this.mProgress = toFloat(Float.valueOf(f5));
            return true;
        }
        if (i5 == 401) {
            this.mCurveFit = toInt(Float.valueOf(f5));
            return true;
        }
        if (i5 == 403) {
            this.mAlpha = f5;
        ...
        if (i5 == 416) {
            this.mTransitionPathRotate = toFloat(Float.valueOf(f5));
            return true;
        }
        if (i5 == 423) {
            this.mWavePeriod = toFloat(Float.valueOf(f5));
            return true;
        }
        if (i5 != 424) {
            switch (i5) {
                case 304:
                    this.mTranslationX = toFloat(Float.valueOf(f5));
                    return true;
                case 305:
                    this.mTranslationY = toFloat(Float.valueOf(f5));
                    return true;
                case 306:
                    this.mTranslationZ = toFloat(Float.valueOf(f5));
                    return true;
                case 307:
                    this.mElevation = toFloat(Float.valueOf(f5));
                    return true;
                case 308:
                    this.mRotationX = toFloat(Float.valueOf(f5));
                    return true;
                case 309:
                    this.mRotationY = toFloat(Float.valueOf(f5));
                    return true;
                case 310:
                    this.mRotation = toFloat(Float.valueOf(f5));
                    return true;
                case 311:
                    this.mScaleX = toFloat(Float.valueOf(f5));
                    return true;
                case 312:
                    this.mScaleY = toFloat(Float.valueOf(f5));
                    return true;
                default:
                    return super.setValue(i5, f5);
            }
        }
        this.mWaveOffset = toFloat(Float.valueOf(f5));
        return true;
    }
