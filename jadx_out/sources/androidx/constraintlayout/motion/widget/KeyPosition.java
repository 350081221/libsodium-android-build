...
public class KeyPosition extends KeyPositionBase {
    ...
    private void calcCartesianPosition(float f5, float f6, float f7, float f8) {
        ...
        this.mCalculatedPositionX = (int) (f5 + (f9 * f12) + (f14 * f13));
        this.mCalculatedPositionY = (int) (f6 + (f12 * f10) + (f13 * f11));
    }
    ...
    private void calcScreenPosition(int i5, int i6) {
        ...
        float f6 = 0;
        this.mCalculatedPositionX = ((i5 - 0) * f5) + f6;
        this.mCalculatedPositionY = ((i6 - 0) * f5) + f6;
    }
    ...
    void calcPosition(int i5, int i6, float f5, float f6, float f7, float f8) {
    ...
    void positionCartAttributes(RectF rectF, RectF rectF2, float f5, float f6, String[] strArr, float[] fArr) {
    ...
    void positionPathAttributes(RectF rectF, RectF rectF2, float f5, float f6, String[] strArr, float[] fArr) {
        float centerX = rectF.centerX();
        float centerY = rectF.centerY();
        float centerX2 = rectF2.centerX() - centerX;
        float centerY2 = rectF2.centerY() - centerY;
    ...
    void positionScreenAttributes(View view, RectF rectF, RectF rectF2, float f5, float f6, String[] strArr, float[] fArr) {
        rectF.centerX();
        rectF.centerY();
        rectF2.centerX();
        rectF2.centerY();
