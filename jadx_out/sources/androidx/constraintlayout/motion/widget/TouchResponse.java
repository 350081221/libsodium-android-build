...
public class TouchResponse {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public float dot(float f5, float f6) {
        return (f5 * this.mTouchDirectionX) + (f6 * this.mTouchDirectionY);
    }
    ...
    public float getProgressDirection(float f5, float f6) {
        ...
        return (f6 * this.mTouchDirectionY) / fArr2[1];
    }
    ...
    public void processTouchEvent(MotionEvent motionEvent, MotionLayout.MotionTracker motionTracker, int i5, MotionScene motionScene) {
        ...
        if (action != 0) {
            if (action != 1) {
                if (action == 2) {
                    ...
                    if (Math.abs((this.mTouchDirectionX * rawX) + (this.mTouchDirectionY * rawY)) > this.mDragThreshold || this.mDragStarted) {
                        ...
                        float[] fArr2 = this.mAnchorDpDt;
                        if (Math.abs(((f10 * fArr2[0]) + (this.mTouchDirectionY * fArr2[1])) * this.mDragScale) < 0.01d) {
                            float[] fArr3 = this.mAnchorDpDt;
                            fArr3[0] = 0.01f;
                            fArr3[1] = 0.01f;
                        }
                        if (this.mTouchDirectionX != 0.0f) {
                            f8 = rawX / this.mAnchorDpDt[0];
                        } else {
                            f8 = rawY / this.mAnchorDpDt[1];
                        }
                        float max = Math.max(Math.min(progress + f8, 1.0f), 0.0f);
                        ...
                        if (max != progress2) {
                            ...
                            if (this.mTouchDirectionX != 0.0f) {
                                f9 = xVelocity / this.mAnchorDpDt[0];
                            } else {
                                f9 = yVelocity / this.mAnchorDpDt[1];
                            }
                            this.mMotionLayout.mLastVelocity = f9;
                        } else {
            ...
            if (i8 != -1) {
                this.mMotionLayout.getAnchorDpDt(i8, progress3, this.mTouchAnchorX, this.mTouchAnchorY, this.mAnchorDpDt);
            } else {
            ...
            if (!Float.isNaN(f5)) {
                f6 = (f5 / 3.0f) + progress3;
            } else {
                f6 = progress3;
            }
            if (f6 != 0.0f && f6 != 1.0f && (i6 = this.mOnTouchUp) != 3) {
                if (f6 < 0.5d) {
                    f7 = 0.0f;
                } else {
                    f7 = 1.0f;
    ...
    */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void scrollMove(float f5, float f6) {
        float f7;
        float progress = this.mMotionLayout.getProgress();
        if (!this.mDragStarted) {
            this.mDragStarted = true;
        ...
        float[] fArr = this.mAnchorDpDt;
        if (Math.abs((f8 * fArr[0]) + (this.mTouchDirectionY * fArr[1])) < 0.01d) {
            float[] fArr2 = this.mAnchorDpDt;
            fArr2[0] = 0.01f;
            fArr2[1] = 0.01f;
        }
        ...
        if (f9 != 0.0f) {
            f7 = (f5 * f9) / this.mAnchorDpDt[0];
        } else {
            f7 = (f6 * this.mTouchDirectionY) / this.mAnchorDpDt[1];
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void scrollUp(float f5, float f6) {
        float f7;
        boolean z4;
        boolean z5 = false;
        this.mDragStarted = false;
        ...
        float[] fArr = this.mAnchorDpDt;
        float f9 = fArr[0];
        float f10 = this.mTouchDirectionY;
        float f11 = fArr[1];
        float f12 = 0.0f;
        if (f8 != 0.0f) {
            f7 = (f5 * f8) / f9;
        ...
        if (progress != 0.0f) {
            ...
            if (z5 & z4) {
                ...
                motionLayout.touchAnimateTo(i5, f12, f7);
            }
        }
    }
    ...
    void setAutoCompleteMode(int i5) {
        this.mAutoCompleteMode = i5;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public void setDown(float f5, float f6) {
        this.mLastTouchX = f5;
        this.mLastTouchY = f6;
    }
    ...
    public void setTouchAnchorLocation(float f5, float f6) {
        this.mTouchAnchorX = f5;
        this.mTouchAnchorY = f6;
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void setUpTouchEvent(float f5, float f6) {
        this.mLastTouchX = f5;
        this.mLastTouchY = f6;
        this.mDragStarted = false;
    }
    ...
    public void setupTouch() {
        ...
        if (i5 != -1) {
            view = this.mMotionLayout.findViewById(i5);
            if (view == null) {
