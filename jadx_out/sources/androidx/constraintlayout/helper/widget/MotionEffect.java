        ...
        if (attributeSet != null) {
            ...
            for (int i5 = 0; i5 < indexCount; i5++) {
                ...
                if (index == R.styleable.MotionEffect_motionEffect_start) {
                    int i6 = obtainStyledAttributes.getInt(index, this.motionEffectStart);
                    this.motionEffectStart = i6;
                    this.motionEffectStart = Math.max(Math.min(i6, 99), 0);
                } else if (index == R.styleable.MotionEffect_motionEffect_end) {
                    int i7 = obtainStyledAttributes.getInt(index, this.motionEffectEnd);
                    this.motionEffectEnd = i7;
                    this.motionEffectEnd = Math.max(Math.min(i7, 99), 0);
            ...
            int i8 = this.motionEffectStart;
            int i9 = this.motionEffectEnd;
            if (i8 == i9) {
                if (i8 > 0) {
                    this.motionEffectStart = i8 - 1;
                } else {
                    this.motionEffectEnd = i9 + 1;
                }
            }
