...
final class AnchorFunctions$verticalAnchorFunctions$1 extends n0 implements q<ConstraintReference, Object, LayoutDirection, ConstraintReference> {
    ...
    public final ConstraintReference invoke(@l ConstraintReference arrayOf, @l Object other, @l LayoutDirection layoutDirection) {
        ...
        l0.o(leftToLeft, "leftToLeft(other)");
        return leftToLeft;
    }
}
