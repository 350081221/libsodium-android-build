...
final class Dimension$Companion$percent$1 extends n0 implements l<State, androidx.constraintlayout.core.state.Dimension> {
    ...
    public final androidx.constraintlayout.core.state.Dimension invoke(@p4.l State it) {
        ...
        l0.o(suggested, "Percent(0, percent).suggested(0)");
        return suggested;
    }
}
