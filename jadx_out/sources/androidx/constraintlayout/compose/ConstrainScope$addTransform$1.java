...
final class ConstrainScope$addTransform$1 extends n0 implements l<State, r2> {
    final /* synthetic */ l<ConstraintReference, r2> $change;
    final /* synthetic */ ConstrainScope this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public ConstrainScope$addTransform$1(l<? super ConstraintReference, r2> lVar, ConstrainScope constrainScope) {
        super(1);
        this.$change = lVar;
    ...
    public final void invoke2(@p4.l State state) {
        l0.p(state, "state");
        l<ConstraintReference, r2> lVar = this.$change;
