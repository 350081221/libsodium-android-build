...
public final class ConstraintLayoutBaseScope$createGuidelineFromStart$2 extends n0 implements l<State, r2> {
    final /* synthetic */ float $fraction;
    final /* synthetic */ int $id;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ConstraintLayoutBaseScope$createGuidelineFromStart$2(int i5, float f5) {
        super(1);
        this.$id = i5;
        this.$fraction = f5;
    }
    ...
    public final void invoke2(@p4.l State state) {
        ...
        if (state.getLayoutDirection() == LayoutDirection.Ltr) {
            verticalGuideline.percent(f5);
        } else {
            verticalGuideline.percent(1.0f - f5);
        }
    }
}
