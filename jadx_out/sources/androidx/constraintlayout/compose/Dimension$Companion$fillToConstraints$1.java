...
final class Dimension$Companion$fillToConstraints$1 extends n0 implements l<State, androidx.constraintlayout.core.state.Dimension> {
    ...
    public final androidx.constraintlayout.core.state.Dimension invoke(@p4.l State it) {
        ...
        l0.o(Suggested, "Suggested(SPREAD_DIMENSION)");
        return Suggested;
    }
}
