...
public final class ConstraintLayoutBaseScope$createHorizontalChain$1 extends n0 implements l<State, r2> {
    ...
    public ConstraintLayoutBaseScope$createHorizontalChain$1(int i5, ConstrainedLayoutReference[] constrainedLayoutReferenceArr, ChainStyle chainStyle) {
        super(1);
        this.$id = i5;
