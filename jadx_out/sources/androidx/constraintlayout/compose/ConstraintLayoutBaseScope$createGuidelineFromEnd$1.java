...
final class ConstraintLayoutBaseScope$createGuidelineFromEnd$1 extends n0 implements l<State, r2> {
    final /* synthetic */ int $id;
    final /* synthetic */ float $offset;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ConstraintLayoutBaseScope$createGuidelineFromEnd$1(int i5, float f5) {
        super(1);
        this.$id = i5;
        this.$offset = f5;
    }
