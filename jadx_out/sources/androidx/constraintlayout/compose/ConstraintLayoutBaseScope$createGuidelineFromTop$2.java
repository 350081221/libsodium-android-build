...
public final class ConstraintLayoutBaseScope$createGuidelineFromTop$2 extends n0 implements l<State, r2> {
    final /* synthetic */ float $fraction;
    final /* synthetic */ int $id;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ConstraintLayoutBaseScope$createGuidelineFromTop$2(int i5, float f5) {
        super(1);
        this.$id = i5;
        this.$fraction = f5;
    }
