...
final class ConstrainScope$circular$1 extends n0 implements l<State, r2> {
    ...
    public ConstrainScope$circular$1(ConstrainScope constrainScope, ConstrainedLayoutReference constrainedLayoutReference, float f5, float f6) {
        super(1);
    ...
    public final void invoke2(@p4.l State state) {
        l0.p(state, "state");
        state.constraints(this.this$0.getId$compose_release()).circularConstraint(this.$other.getId(), this.$angle, state.convertDimension(Dp.m6042boximpl(this.$distance)));
    }
}
