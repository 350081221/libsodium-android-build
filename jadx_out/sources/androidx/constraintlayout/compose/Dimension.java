...
public interface Dimension {
    ...
    public static final class Companion {
        ...
        @l
        public final Dimension percent(float f5) {
            return new DimensionDescription(new Dimension$Companion$percent$1(f5));
        }

        @l
        /* renamed from: preferredValue-0680j_4, reason: not valid java name */
        public final MinCoercible m6349preferredValue0680j_4(float f5) {
            return new DimensionDescription(new Dimension$Companion$preferredValue$1(f5));
        }

        @l
        public final Dimension ratio(@l String ratio) {
            l0.p(ratio, "ratio");
        ...
        public final Dimension m6350value0680j_4(float f5) {
            return new DimensionDescription(new Dimension$Companion$value$1(f5));
        }
    }
