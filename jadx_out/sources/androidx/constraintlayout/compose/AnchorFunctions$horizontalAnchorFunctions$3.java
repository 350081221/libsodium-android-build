...
final class AnchorFunctions$horizontalAnchorFunctions$3 extends n0 implements p<ConstraintReference, Object, ConstraintReference> {
    ...
    public final ConstraintReference invoke(@l ConstraintReference arrayOf, @l Object other) {
        ...
        l0.o(bottomToTop, "bottomToTop(other)");
        return bottomToTop;
    }
}
