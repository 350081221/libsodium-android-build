...
public final class ConstraintLayoutBaseScope$createAbsoluteLeftBarrier$1 extends n0 implements l<State, r2> {
    ...
    public ConstraintLayoutBaseScope$createAbsoluteLeftBarrier$1(int i5, float f5, ConstrainedLayoutReference[] constrainedLayoutReferenceArr) {
        super(1);
        this.$id = i5;
        this.$margin = f5;
