...
final class AnchorFunctions$baselineAnchorFunction$1 extends n0 implements p<ConstraintReference, Object, ConstraintReference> {
    ...
    @Override // v3.p
    public final ConstraintReference invoke(@l ConstraintReference constraintReference, @l Object other) {
        l0.p(constraintReference, "$this$null");
        l0.p(other, "other");
        ...
        l0.o(baselineToBaseline, "baselineToBaseline(other)");
