...
public abstract class BaseHorizontalAnchorable implements HorizontalAnchorable {
    ...
    public BaseHorizontalAnchorable(@l List<v3.l<State, r2>> tasks, int i5) {
        l0.p(tasks, "tasks");
        this.tasks = tasks;
        this.index = i5;
    }
    ...
    public final void mo6299linkToVpY3zN4(@l ConstraintLayoutBaseScope.HorizontalAnchor anchor, float f5, float f6) {
        l0.p(anchor, "anchor");
        this.tasks.add(new BaseHorizontalAnchorable$linkTo$1(this, anchor, f5, f6));
    }
}
