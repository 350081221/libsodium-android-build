...
public final class ConstraintLayoutBaseScope$createAbsoluteRightBarrier$1 extends n0 implements l<State, r2> {
    ...
    public ConstraintLayoutBaseScope$createAbsoluteRightBarrier$1(int i5, float f5, ConstrainedLayoutReference[] constrainedLayoutReferenceArr) {
        super(1);
        this.$id = i5;
        this.$margin = f5;
    ...
    public final void invoke2(@p4.l State state) {
        ...
        if (array != null) {
            ...
            barrier.margin(state.convertDimension(Dp.m6042boximpl(this.$margin)));
            return;
        }
