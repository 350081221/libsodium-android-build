...
final class ConstrainScope$alpha$1 extends n0 implements l<ConstraintReference, r2> {
    final /* synthetic */ float $value;
    final /* synthetic */ ConstrainScope this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ConstrainScope$alpha$1(ConstrainScope constrainScope, float f5) {
        super(1);
    ...
    public final void invoke2(@p4.l ConstraintReference addTransform) {
        ...
        if (l0.g(this.this$0.getVisibility(), Visibility.Companion.getInvisible())) {
            return;
        }
