...
public class MotionLabel extends View implements FloatLayout {
    ...
    private float getHorizontalOffset() {
        ...
        return ((((f6 - getPaddingLeft()) - getPaddingRight()) - measureText) * (this.mTextPanX + 1.0f)) / 2.0f;
    }
    ...
    private float getVerticalOffset() {
        ...
        float paddingTop = (f6 - getPaddingTop()) - getPaddingBottom();
    ...
    Bitmap blur(Bitmap bitmap, int i5) {
        System.nanoTime();
    ...
    public void layout(int i5, int i6, int i7, int i8) {
        ...
        float f5 = isNaN ? 1.0f : this.mTextSize / this.mBaseTextSize;
        ...
        if (this.mAutoSize) {
            ...
            float f6 = (this.mFloatWidth - this.mPaddingRight) - this.mPaddingLeft;
            float f7 = (this.mFloatHeight - this.mPaddingBottom) - this.mPaddingTop;
            if (isNaN) {
                float f8 = width;
                float f9 = height;
                if (f8 * f7 > f9 * f6) {
                    this.mPaint.setTextSize((this.paintTextSize * f6) / f8);
                } else {
    ...
    public void setTextSize(float f5) {
        float f6;
        this.mTextSize = f5;
        Log.v(TAG, Debug.getLoc() + "  " + f5 + " / " + this.mBaseTextSize);
        TextPaint textPaint = this.mPaint;
        if (!Float.isNaN(this.mBaseTextSize)) {
    ...
    public void layout(float f5, float f6, float f7, float f8) {
        ...
        if (this.mAutoSize) {
            ...
            float f11 = (f9 - this.mPaddingRight) - this.mPaddingLeft;
            float f12 = (f10 - this.mPaddingBottom) - this.mPaddingTop;
            float width = this.mTempRect.width();
            if (width * f12 > height * f11) {
                this.mPaint.setTextSize((this.paintTextSize * f11) / width);
            } else {
                this.mPaint.setTextSize((this.paintTextSize * f12) / height);
            }
