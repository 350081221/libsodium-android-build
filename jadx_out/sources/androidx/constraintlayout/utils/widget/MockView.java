...
public class MockView extends View {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.mDrawDiagonals) {
            ...
            float f5 = width;
            float f6 = height;
            canvas.drawLine(0.0f, 0.0f, f5, f6, this.mPaintDiagonals);
            canvas.drawLine(0.0f, f6, f5, 0.0f, this.mPaintDiagonals);
            canvas.drawLine(0.0f, 0.0f, f5, 0.0f, this.mPaintDiagonals);
            canvas.drawLine(f5, 0.0f, f5, f6, this.mPaintDiagonals);
            canvas.drawLine(f5, f6, 0.0f, f6, this.mPaintDiagonals);
            canvas.drawLine(0.0f, f6, 0.0f, 0.0f, this.mPaintDiagonals);
        }
