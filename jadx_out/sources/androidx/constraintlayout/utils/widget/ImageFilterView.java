...
public class ImageFilterView extends AppCompatImageView {
    ...
    public static class ImageMatrix {
        ...
        private void warmth(float f5) {
            ...
            if (f8 < 66.0f) {
                if (f8 > 19.0f) {
                    f7 = (((float) Math.log(f8 - 10.0f)) * 138.51773f) - 305.0448f;
                } else {
                    f7 = 0.0f;
                }
            } else {
        ...
        public void updateMatrix(ImageView imageView) {
            ...
            if (f5 != 1.0f) {
                saturation(f5);
                this.mColorMatrix.set(this.f353m);
                z4 = true;
            } else {
                z4 = false;
            }
            ...
            if (f7 != 1.0f) {
                warmth(f7);
                this.mTmpColorMatrix.set(this.f353m);
                this.mColorMatrix.postConcat(this.mTmpColorMatrix);
                z4 = true;
            }
