...
public final class ProfileVerifier {
    ...
    public static class CompilationStatus {
        ...
        CompilationStatus(int i5, boolean z4, boolean z5) {
            this.mResultCode = i5;
    ...
    @NonNull
    public static n1.a<CompilationStatus> getCompilationStatusAsync() {
        return sFuture;
    }
    ...
    private static CompilationStatus setCompilationStatus(int i5, boolean z4, boolean z5) {
        CompilationStatus compilationStatus = new CompilationStatus(i5, z4, z5);
