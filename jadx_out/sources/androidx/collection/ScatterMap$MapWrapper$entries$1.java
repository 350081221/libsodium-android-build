...
public final class ScatterMap$MapWrapper$entries$1<K, V> implements Set<Map.Entry<? extends K, ? extends V>>, w3.a {
    ...
    public boolean containsAll(@l Collection<? extends Object> elements) {
        ...
        while (it.hasNext()) {
            ...
            if (!l0.g(scatterMap.get(entry.getKey()), entry.getValue())) {
                return false;
            }
        }
        return true;
    ...
    public Iterator<Map.Entry<K, V>> iterator() {
        Iterator<Map.Entry<K, V>> a5;
        a5 = q.a(new ScatterMap$MapWrapper$entries$1$iterator$1(this.this$0, null));
        return a5;
    }
    ...
    public boolean contains(@l Map.Entry<? extends K, ? extends V> element) {
