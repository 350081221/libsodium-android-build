...
public final class MutableLongFloatMap extends LongFloatMap {
    ...
    public /* synthetic */ MutableLongFloatMap(int i5, int i6, w wVar) {
        this((i6 & 1) != 0 ? 6 : i5);
    }
    ...
    */
    ...
    public final float getOrPut(long j5, @l v3.a<Float> defaultValue) {
    ...
    public final void plusAssign(@l LongFloatMap from) {
        l0.p(from, "from");
        putAll(from);
    }
    ...
    public final void putAll(@l LongFloatMap from) {
        boolean z4;
        l0.p(from, "from");
        long[] jArr = from.keys;
    ...
    public final void removeIf(@l p<? super Long, ? super Float, Boolean> predicate) {
        boolean z4;
            ...
            while (true) {
                ...
                if ((((~j5) << 7) & j5 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i7 = 0; i7 < i6; i7++) {
                        ...
                        if (z4) {
                            int i8 = (i5 << 3) + i7;
                            if (predicate.invoke(Long.valueOf(this.keys[i8]), Float.valueOf(this.values[i8])).booleanValue()) {
                                removeValueAt(i8);
                            }
                        }
                        j5 >>= 8;
