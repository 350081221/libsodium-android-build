...
public final class MutableIntIntMap extends IntIntMap {
    ...
    public /* synthetic */ MutableIntIntMap(int i5, int i6, w wVar) {
        this((i6 & 1) != 0 ? 6 : i5);
    }
    ...
    */
    ...
    private final void resizeStorage(int i5) {
        ...
        while (i8 < i7) {
            ...
            if (z4) {
                ...
                iArr3[findFirstAvailableSlot] = i9;
                iArr4[findFirstAvailableSlot] = iArr2[i6];
            } else {
                i6 = i8;
            }
            i8 = i6 + 1;
    ...
    public final int getOrPut(int i5, @l v3.a<Integer> defaultValue) {
    ...
    public final void plusAssign(@l IntIntMap from) {
        l0.p(from, "from");
        putAll(from);
    }

    public final void put(int i5, int i6) {
        set(i5, i6);
    }

    public final void putAll(@l IntIntMap from) {
        boolean z4;
        l0.p(from, "from");
        int[] iArr = from.keys;
    ...
    public final void removeIf(@l p<? super Integer, ? super Integer, Boolean> predicate) {
        boolean z4;
            ...
            while (true) {
                ...
                if ((((~j5) << 7) & j5 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i7 = 0; i7 < i6; i7++) {
                        ...
                        if (z4) {
                            int i8 = (i5 << 3) + i7;
                            if (predicate.invoke(Integer.valueOf(this.keys[i8]), Integer.valueOf(this.values[i8])).booleanValue()) {
                                removeValueAt(i8);
                            }
                        }
                        j5 >>= 8;
    ...
    public final int put(int i5, int i6, int i7) {
        int findInsertIndex = findInsertIndex(i5);
        if (findInsertIndex < 0) {
            findInsertIndex = ~findInsertIndex;
        } else {
            i7 = this.values[findInsertIndex];
        }
        this.keys[findInsertIndex] = i5;
        this.values[findInsertIndex] = i6;
        return i7;
    ...
    public final boolean remove(int i5, int i6) {
        int findKeyIndex = findKeyIndex(i5);
