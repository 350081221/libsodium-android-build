...
public final class MutableFloatFloatMap extends FloatFloatMap {
    ...
    public /* synthetic */ MutableFloatFloatMap(int i5, int i6, w wVar) {
        this((i6 & 1) != 0 ? 6 : i5);
    }
    ...
    */
    ...
    private final void resizeStorage(int i5) {
        ...
        while (i8 < i7) {
            ...
            if (z4) {
                ...
                fArr3[findFirstAvailableSlot] = f5;
                fArr4[findFirstAvailableSlot] = fArr2[i6];
            } else {
                i6 = i8;
            }
            i8 = i6 + 1;
    ...
    public final float getOrPut(float f5, @l v3.a<Float> defaultValue) {
    ...
    public final void plusAssign(@l FloatFloatMap from) {
        l0.p(from, "from");
        putAll(from);
    }

    public final void put(float f5, float f6) {
        set(f5, f6);
    }

    public final void putAll(@l FloatFloatMap from) {
        boolean z4;
        l0.p(from, "from");
    ...
    public final void removeIf(@l p<? super Float, ? super Float, Boolean> predicate) {
        boolean z4;
            ...
            while (true) {
                ...
                if ((((~j5) << 7) & j5 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i7 = 0; i7 < i6; i7++) {
                        ...
                        if (z4) {
                            int i8 = (i5 << 3) + i7;
                            if (predicate.invoke(Float.valueOf(this.keys[i8]), Float.valueOf(this.values[i8])).booleanValue()) {
                                removeValueAt(i8);
                            }
                        }
                        j5 >>= 8;
    ...
    public final float put(float f5, float f6, float f7) {
        int findInsertIndex = findInsertIndex(f5);
        if (findInsertIndex < 0) {
            findInsertIndex = ~findInsertIndex;
        } else {
    ...
    public final boolean remove(float f5, float f6) {
        int findKeyIndex = findKeyIndex(f5);
        if (findKeyIndex >= 0) {
            if (this.values[findKeyIndex] == f6) {
                removeValueAt(findKeyIndex);
                return true;
            }
        }
