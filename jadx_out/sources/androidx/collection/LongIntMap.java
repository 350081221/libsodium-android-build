...
public abstract class LongIntMap {
    ...
    public /* synthetic */ LongIntMap(w wVar) {
        this();
    }
    ...
    public static /* synthetic */ String joinToString$default(LongIntMap longIntMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i5, CharSequence charSequence4, int i6, Object obj) {
        if (obj != null) {
        ...
        return longIntMap.joinToString(charSequence, charSequence5, charSequence6, i7, charSequence4);
    }

    public final boolean all(@l p<? super Long, ? super Integer, Boolean> predicate) {
        boolean z4;
            ...
            while (true) {
                ...
                if ((((~j5) << 7) & j5 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i7 = 0; i7 < i6; i7++) {
                        ...
                        if (z4) {
                            int i8 = (i5 << 3) + i7;
                            if (!predicate.invoke(Long.valueOf(jArr[i8]), Integer.valueOf(iArr[i8])).booleanValue()) {
                                return false;
                            }
                        }
                        j5 >>= 8;
                ...
                if ((((~j5) << 7) & j5 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i9 < i8) {
                        ...
                        if (z4) {
                            int i10 = (i6 << 3) + i9;
                            i5 = i9;
                            if (iArr[i10] != longIntMap.get(jArr[i10])) {
                                return false;
                            }
                            i7 = 8;
                        } else {
    ...
    */
    ...
    public final void forEach(@l p<? super Long, ? super Integer, r2> block) {
        boolean z4;
        l0.p(block, "block");
        long[] jArr = this.keys;
        int[] iArr = this.values;
            ...
            while (true) {
                ...
                if ((((~j5) << 7) & j5 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i7 = 0; i7 < i6; i7++) {
                        ...
                        if (z4) {
                            int i8 = (i5 << 3) + i7;
                            block.invoke(Long.valueOf(jArr[i8]), Integer.valueOf(iArr[i8]));
                        }
                        j5 >>= 8;
                    }
                    if (i6 != 8) {
    ...
    public final int getOrDefault(long j5, int i5) {
        int findKeyIndex = findKeyIndex(j5);
        if (findKeyIndex >= 0) {
            return this.values[findKeyIndex];
        }
    ...
    public final int getOrElse(long j5, @l v3.a<Integer> defaultValue) {
                ...
                if ((((~j5) << 7) & j5 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i9 = 0; i9 < i8; i9++) {
                        ...
                        if (z4) {
                            int i10 = (i6 << 3) + i9;
                            long j6 = jArr[i10];
                            i7 += Integer.hashCode(iArr[i10]) ^ Long.hashCode(j6);
                        }
                        j5 >>= 8;
                    }
                    if (i8 != 8) {
    ...
    public static /* synthetic */ String joinToString$default(LongIntMap longIntMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i5, CharSequence charSequence4, p transform, int i6, Object obj) {
        long[] jArr;
        long[] jArr2;
        int i7;
        if (obj == null) {
    ...
    public final boolean any(@l p<? super Long, ? super Integer, Boolean> predicate) {
        l0.p(predicate, "predicate");
        long[] jArr = this.keys;
        int[] iArr = this.values;
        long[] jArr2 = this.metadata;
    ...
    public final int count(@l p<? super Long, ? super Integer, Boolean> predicate) {
        l0.p(predicate, "predicate");
        long[] jArr = this.keys;
        int[] iArr = this.values;
        long[] jArr2 = this.metadata;
            ...
            while (true) {
                ...
                if ((((~j5) << 7) & j5 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i9 = 0; i9 < i8; i9++) {
                        if ((255 & j5) < 128) {
                            int i10 = (i6 << 3) + i9;
                            if (predicate.invoke(Long.valueOf(jArr[i10]), Integer.valueOf(iArr[i10])).booleanValue()) {
                                i7++;
                            }
                        }
                        j5 >>= 8;
    ...
    @l
    @i
    public final String joinToString(@l CharSequence charSequence, @l CharSequence prefix, @l CharSequence postfix, int i5, @l CharSequence truncated, @l p<? super Long, ? super Integer, ? extends CharSequence> transform) {
                ...
                if ((((~j5) << 7) & j5 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i10 < i9) {
                        if ((j5 & 255) < 128) {
                            ...
                            sb.append(transform.invoke(Long.valueOf(j6), Integer.valueOf(i12)));
                            i7++;
                        }
                        j5 >>= 8;
                        i10++;
    ...
    @l
    @i
    public final String joinToString(@l CharSequence charSequence, @l CharSequence prefix, @l CharSequence postfix, int i5, @l p<? super Long, ? super Integer, ? extends CharSequence> transform) {
        CharSequence separator = charSequence;
        l0.p(separator, "separator");
        l0.p(prefix, "prefix");
        l0.p(postfix, "postfix");
    ...
    @l
    @i
    public final String joinToString(@l CharSequence separator, @l CharSequence prefix, @l CharSequence postfix, @l p<? super Long, ? super Integer, ? extends CharSequence> transform) {
        int i5;
        l0.p(separator, "separator");
        l0.p(prefix, "prefix");
        l0.p(postfix, "postfix");
    ...
    @l
    @i
    public final String joinToString(@l CharSequence separator, @l CharSequence prefix, @l p<? super Long, ? super Integer, ? extends CharSequence> transform) {
        int i5;
        l0.p(separator, "separator");
        l0.p(prefix, "prefix");
        l0.p(transform, "transform");
    ...
    @l
    @i
    public final String joinToString(@l CharSequence separator, @l p<? super Long, ? super Integer, ? extends CharSequence> transform) {
        int i5;
        l0.p(separator, "separator");
        l0.p(transform, "transform");
        StringBuilder sb = new StringBuilder();
    ...
    @l
    @i
    public final String joinToString(@l p<? super Long, ? super Integer, ? extends CharSequence> transform) {
        int i5;
        l0.p(transform, "transform");
        StringBuilder sb = new StringBuilder();
        sb.append((CharSequence) "");
