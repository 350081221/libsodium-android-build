...
@f(c = "androidx.collection.MutableScatterMap$MutableMapWrapper$values$1$iterator$1$iterator$1", f = "ScatterMap.kt", i = {0, 0, 0, 0, 0, 0, 0}, l = {1495}, m = "invokeSuspend", n = {"$this$iterator", "m$iv", "lastIndex$iv", "i$iv", "slot$iv", "bitCount$iv", "j$iv"}, s = {"L$0", "L$1", "I$0", "I$1", "J$0", "I$2", "I$3"})
...
final class MutableScatterMap$MutableMapWrapper$values$1$iterator$1$iterator$1 extends k implements p<o<? super Integer>, d<? super r2>, Object> {
    int I$0;
    int I$1;
    int I$2;
    int I$3;
    ...
    public MutableScatterMap$MutableMapWrapper$values$1$iterator$1$iterator$1(MutableScatterMap<K, V> mutableScatterMap, d<? super MutableScatterMap$MutableMapWrapper$values$1$iterator$1$iterator$1> dVar) {
        super(2, dVar);
    ...
    public final Object invoke(@l o<? super Integer> oVar, @m d<? super r2> dVar) {
        return ((MutableScatterMap$MutableMapWrapper$values$1$iterator$1$iterator$1) create(oVar, dVar)).invokeSuspend(r2.f19517a);
    }
