...
public final class MutableFloatLongMap extends FloatLongMap {
    ...
    public /* synthetic */ MutableFloatLongMap(int i5, int i6, w wVar) {
        this((i6 & 1) != 0 ? 6 : i5);
    }
    ...
    */
    ...
    private final void resizeStorage(int i5) {
        ...
        while (i8 < i7) {
            ...
            if (z4) {
                ...
                i6 = i8;
                jArr4[i10] = (jArr4[i10] & (~(255 << i11))) | (j5 << i11);
                int i12 = this._capacity;
                int i13 = ((findFirstAvailableSlot - 7) & i12) + (i12 & 7);
                int i14 = i13 >> 3;
                int i15 = (i13 & 7) << 3;
                jArr4[i14] = (jArr4[i14] & (~(255 << i15))) | (j5 << i15);
    ...
    public final long getOrPut(float f5, @l v3.a<Long> defaultValue) {
    ...
    public final void plusAssign(@l FloatLongMap from) {
        l0.p(from, "from");
        putAll(from);
    }

    public final void put(float f5, long j5) {
        set(f5, j5);
    }

    public final void putAll(@l FloatLongMap from) {
        boolean z4;
        l0.p(from, "from");
    ...
    public final void removeIf(@l p<? super Float, ? super Long, Boolean> predicate) {
        boolean z4;
            ...
            while (true) {
                ...
                if ((((~j5) << 7) & j5 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i7 = 0; i7 < i6; i7++) {
                        ...
                        if (z4) {
                            int i8 = (i5 << 3) + i7;
                            if (predicate.invoke(Float.valueOf(this.keys[i8]), Long.valueOf(this.values[i8])).booleanValue()) {
                                removeValueAt(i8);
                            }
                        }
                        j5 >>= 8;
    ...
    public final void set(float f5, long j5) {
    ...
    public final long put(float f5, long j5, long j6) {
        int findInsertIndex = findInsertIndex(f5);
        if (findInsertIndex < 0) {
            findInsertIndex = ~findInsertIndex;
        } else {
    ...
    public final boolean remove(float f5, long j5) {
        int findKeyIndex = findKeyIndex(f5);
