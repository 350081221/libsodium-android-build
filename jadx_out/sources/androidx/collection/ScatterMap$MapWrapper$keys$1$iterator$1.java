...
@f(c = "androidx.collection.ScatterMap$MapWrapper$keys$1$iterator$1", f = "ScatterMap.kt", i = {0, 0, 0, 0, 0, 0, 0, 0}, l = {726}, m = "invokeSuspend", n = {"$this$iterator", "k$iv", "m$iv$iv", "lastIndex$iv$iv", "i$iv$iv", "slot$iv$iv", "bitCount$iv$iv", "j$iv$iv"}, s = {"L$0", "L$1", "L$2", "I$0", "I$1", "J$0", "I$2", "I$3"})
...
final class ScatterMap$MapWrapper$keys$1$iterator$1<K> extends k implements p<o<? super K>, d<? super r2>, Object> {
    int I$0;
    int I$1;
    int I$2;
    int I$3;
    ...
    @Override // v3.p
    @m
    public final Object invoke(@l o<? super K> oVar, @m d<? super r2> dVar) {
        return ((ScatterMap$MapWrapper$keys$1$iterator$1) create(oVar, dVar)).invokeSuspend(r2.f19517a);
    }
