...
public final class MutableLongLongMap extends LongLongMap {
    ...
    public /* synthetic */ MutableLongLongMap(int i5, int i6, w wVar) {
        this((i6 & 1) != 0 ? 6 : i5);
    }
    ...
    */
    ...
    private final void resizeStorage(int i5) {
        ...
        while (i8 < i7) {
            ...
            if (z4) {
                ...
                jArr = jArr3;
                jArr2 = jArr4;
                jArr8[i10] = (jArr8[i10] & (~(255 << i11))) | (j6 << i11);
                int i12 = this._capacity;
                int i13 = ((findFirstAvailableSlot - 7) & i12) + (i12 & 7);
                int i14 = i13 >> 3;
                int i15 = (i13 & 7) << 3;
                jArr8[i14] = (j6 << i15) | (jArr8[i14] & (~(255 << i15)));
                jArr6[findFirstAvailableSlot] = j5;
                jArr7[findFirstAvailableSlot] = jArr5[i6];
            } else {
                jArr = jArr3;
                jArr2 = jArr4;
                i6 = i8;
    ...
    public final long getOrPut(long j5, @l v3.a<Long> defaultValue) {
    ...
    public final void plusAssign(@l LongLongMap from) {
        l0.p(from, "from");
        putAll(from);
    }

    public final void put(long j5, long j6) {
        set(j5, j6);
    }

    public final void putAll(@l LongLongMap from) {
        boolean z4;
        l0.p(from, "from");
        long[] jArr = from.keys;
    ...
    public final void removeIf(@l p<? super Long, ? super Long, Boolean> predicate) {
        boolean z4;
            ...
            while (true) {
                ...
                if ((((~j5) << 7) & j5 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i7 = 0; i7 < i6; i7++) {
                        ...
                        if (z4) {
                            int i8 = (i5 << 3) + i7;
                            if (predicate.invoke(Long.valueOf(this.keys[i8]), Long.valueOf(this.values[i8])).booleanValue()) {
                                removeValueAt(i8);
                            }
                        }
                        j5 >>= 8;
    ...
    public final void set(long j5, long j6) {
    ...
    public final long put(long j5, long j6, long j7) {
        int findInsertIndex = findInsertIndex(j5);
        if (findInsertIndex < 0) {
            findInsertIndex = ~findInsertIndex;
        } else {
            j7 = this.values[findInsertIndex];
        }
        this.keys[findInsertIndex] = j5;
        this.values[findInsertIndex] = j6;
        return j7;
    ...
    public final boolean remove(long j5, long j6) {
        int findKeyIndex = findKeyIndex(j5);
