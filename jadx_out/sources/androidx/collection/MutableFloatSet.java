...
public final class MutableFloatSet extends FloatSet {
    ...
    public /* synthetic */ MutableFloatSet(int i5, int i6, w wVar) {
        this((i6 & 1) != 0 ? 6 : i5);
    }
    ...
    */
    ...
    private final void resizeStorage(int i5) {
        ...
        while (i8 < i7) {
            ...
            if (z4) {
                ...
                int i14 = i13 >> 3;
                int i15 = (i13 & 7) << 3;
                jArr2[i14] = ((~(255 << i15)) & jArr2[i14]) | (j5 << i15);
    ...
    public final boolean add(float f5) {
        int i5 = this._size;
        this.elements[findAbsoluteInsertIndex(f5)] = f5;
        if (this._size != i5) {
            return true;
        }
        return false;
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final void minusAssign(float r17) {
        /*
            r16 = this;
            r0 = r16
    ...
    */
    ...
    public final boolean addAll(@l FloatSet elements) {
        l0.p(elements, "elements");
        int i5 = this._size;
        plusAssign(elements);
        return i5 != this._size;
    ...
    public final boolean removeAll(@l FloatSet elements) {
        l0.p(elements, "elements");
        int i5 = this._size;
        minusAssign(elements);
        return i5 != this._size;
    ...
    public final void plusAssign(@l FloatSet elements) {
        l0.p(elements, "elements");
    ...
    public final void minusAssign(@l FloatSet elements) {
        l0.p(elements, "elements");
        float[] fArr = elements.elements;
        long[] jArr = elements.metadata;
        int length = jArr.length - 2;
