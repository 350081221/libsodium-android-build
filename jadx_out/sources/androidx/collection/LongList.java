...
public abstract class LongList {
    ...
    public /* synthetic */ LongList(int i5, w wVar) {
        this(i5);
    }
    ...
    public final boolean containsAll(@l LongList elements) {
        kotlin.ranges.l W1;
    ...
    public final long elementAtOrElse(@IntRange(from = 0) int i5, @l v3.l<? super Integer, Long> defaultValue) {
    ...
    public final <R> R fold(R r5, @l p<? super R, ? super Long, ? extends R> operation) {
        l0.p(operation, "operation");
        long[] jArr = this.content;
        int i5 = this._size;
        for (int i6 = 0; i6 < i5; i6++) {
            r5 = operation.invoke(r5, Long.valueOf(jArr[i6]));
        }
        return r5;
    }

    public final <R> R foldIndexed(R r5, @l q<? super Integer, ? super R, ? super Long, ? extends R> operation) {
        l0.p(operation, "operation");
        long[] jArr = this.content;
        int i5 = this._size;
        for (int i6 = 0; i6 < i5; i6++) {
            R r6 = r5;
            r5 = operation.invoke(Integer.valueOf(i6), r6, Long.valueOf(jArr[i6]));
        }
        return r5;
    }

    public final <R> R foldRight(R r5, @l p<? super Long, ? super R, ? extends R> operation) {
        l0.p(operation, "operation");
        long[] jArr = this.content;
        int i5 = this._size;
        while (true) {
            ...
            r5 = operation.invoke(Long.valueOf(jArr[i5]), r5);
        }
    }

    public final <R> R foldRightIndexed(R r5, @l q<? super Integer, ? super Long, ? super R, ? extends R> operation) {
        l0.p(operation, "operation");
        long[] jArr = this.content;
        int i5 = this._size;
        while (true) {
            ...
            r5 = operation.invoke(Integer.valueOf(i5), Long.valueOf(jArr[i5]), r5);
        }
    }

    public final void forEach(@l v3.l<? super Long, r2> block) {
        l0.p(block, "block");
        long[] jArr = this.content;
        int i5 = this._size;
        for (int i6 = 0; i6 < i5; i6++) {
    ...
    public final void forEachIndexed(@l p<? super Integer, ? super Long, r2> block) {
        l0.p(block, "block");
        long[] jArr = this.content;
        int i5 = this._size;
        for (int i6 = 0; i6 < i5; i6++) {
    ...
    public final void forEachReversed(@l v3.l<? super Long, r2> block) {
        l0.p(block, "block");
        long[] jArr = this.content;
        int i5 = this._size;
        while (true) {
    ...
    public final void forEachReversedIndexed(@l p<? super Integer, ? super Long, r2> block) {
        l0.p(block, "block");
        long[] jArr = this.content;
        int i5 = this._size;
        while (true) {
    ...
    public final int indexOfFirst(@l v3.l<? super Long, Boolean> predicate) {
    ...
    public final int indexOfLast(@l v3.l<? super Long, Boolean> predicate) {
        l0.p(predicate, "predicate");
        long[] jArr = this.content;
        int i5 = this._size;
        do {
        ...
        } while (!predicate.invoke(Long.valueOf(jArr[i5])).booleanValue());
        return i5;
    }
    ...
    public final boolean reversedAny(@l v3.l<? super Long, Boolean> predicate) {
        l0.p(predicate, "predicate");
        long[] jArr = this.content;
    ...
    public static /* synthetic */ String joinToString$default(LongList longList, CharSequence separator, CharSequence prefix, CharSequence postfix, int i5, CharSequence truncated, v3.l transform, int i6, Object obj) {
        if (obj == null) {
            if ((i6 & 1) != 0) {
                separator = ", ";
            }
            ...
            while (true) {
                if (i8 < i7) {
                    ...
                    sb.append((CharSequence) transform.invoke(Long.valueOf(j5)));
                    i8++;
                } else {
                    sb.append(postfix);
                    break;
    ...
    public final boolean any(@l v3.l<? super Long, Boolean> predicate) {
        l0.p(predicate, "predicate");
        long[] jArr = this.content;
        int i5 = this._size;
        for (int i6 = 0; i6 < i5; i6++) {
    ...
    public final int count(@l v3.l<? super Long, Boolean> predicate) {
        l0.p(predicate, "predicate");
        long[] jArr = this.content;
        int i5 = this._size;
        int i6 = 0;
    ...
    public final long first(@l v3.l<? super Long, Boolean> predicate) {
        l0.p(predicate, "predicate");
        long[] jArr = this.content;
        int i5 = this._size;
        for (int i6 = 0; i6 < i5; i6++) {
    ...
    public final long last(@l v3.l<? super Long, Boolean> predicate) {
        long j5;
        l0.p(predicate, "predicate");
        long[] jArr = this.content;
        int i5 = this._size;
        ...
        } while (!predicate.invoke(Long.valueOf(j5)).booleanValue());
        return j5;
    }

    @l
    @i
    public final String joinToString(@l CharSequence separator, @l CharSequence prefix, @l CharSequence postfix, int i5, @l CharSequence truncated, @l v3.l<? super Long, ? extends CharSequence> transform) {
        l0.p(separator, "separator");
        l0.p(prefix, "prefix");
        l0.p(postfix, "postfix");
        l0.p(truncated, "truncated");
        ...
        while (true) {
            if (i7 < i6) {
                ...
                sb.append(transform.invoke(Long.valueOf(j5)));
                i7++;
            } else {
                sb.append(postfix);
                break;
    ...
    @l
    @i
    public final String joinToString(@l CharSequence separator, @l CharSequence prefix, @l CharSequence postfix, int i5, @l v3.l<? super Long, ? extends CharSequence> transform) {
        l0.p(separator, "separator");
        l0.p(prefix, "prefix");
        l0.p(postfix, "postfix");
        l0.p(transform, "transform");
    ...
    @l
    @i
    public final String joinToString(@l CharSequence separator, @l CharSequence prefix, @l CharSequence postfix, @l v3.l<? super Long, ? extends CharSequence> transform) {
        l0.p(separator, "separator");
        l0.p(prefix, "prefix");
        l0.p(postfix, "postfix");
        l0.p(transform, "transform");
    ...
    @l
    @i
    public final String joinToString(@l CharSequence separator, @l CharSequence prefix, @l v3.l<? super Long, ? extends CharSequence> transform) {
        l0.p(separator, "separator");
        l0.p(prefix, "prefix");
        l0.p(transform, "transform");
        StringBuilder sb = new StringBuilder();
    ...
    @l
    @i
    public final String joinToString(@l CharSequence separator, @l v3.l<? super Long, ? extends CharSequence> transform) {
        l0.p(separator, "separator");
        l0.p(transform, "transform");
        StringBuilder sb = new StringBuilder();
        sb.append((CharSequence) "");
    ...
    @l
    @i
    public final String joinToString(@l v3.l<? super Long, ? extends CharSequence> transform) {
        l0.p(transform, "transform");
        StringBuilder sb = new StringBuilder();
        sb.append((CharSequence) "");
        long[] jArr = this.content;
