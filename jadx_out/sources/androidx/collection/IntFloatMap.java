...
public abstract class IntFloatMap {
    ...
    public /* synthetic */ IntFloatMap(w wVar) {
        this();
    }
    ...
    public static /* synthetic */ String joinToString$default(IntFloatMap intFloatMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i5, CharSequence charSequence4, int i6, Object obj) {
        ...
        return intFloatMap.joinToString(charSequence, charSequence5, charSequence6, i7, charSequence4);
    }

    public final boolean all(@l p<? super Integer, ? super Float, Boolean> predicate) {
        boolean z4;
            ...
            while (true) {
                ...
                if ((((~j5) << 7) & j5 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i7 = 0; i7 < i6; i7++) {
                        ...
                        if (z4) {
                            int i8 = (i5 << 3) + i7;
                            if (!predicate.invoke(Integer.valueOf(iArr[i8]), Float.valueOf(fArr[i8])).booleanValue()) {
                                return false;
                            }
                        }
                        j5 >>= 8;
    ...
    */
    ...
    public final void forEach(@l p<? super Integer, ? super Float, r2> block) {
        boolean z4;
        l0.p(block, "block");
        int[] iArr = this.keys;
        float[] fArr = this.values;
    ...
    public final float getOrDefault(int i5, float f5) {
        int findKeyIndex = findKeyIndex(i5);
        if (findKeyIndex >= 0) {
            return this.values[findKeyIndex];
        }
    ...
    public final float getOrElse(int i5, @l v3.a<Float> defaultValue) {
                ...
                if ((((~j5) << 7) & j5 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i9 = 0; i9 < i8; i9++) {
                        ...
                        if (z4) {
                            int i10 = (i6 << 3) + i9;
                            int i11 = iArr[i10];
                            i7 += Float.hashCode(fArr[i10]) ^ Integer.hashCode(i11);
                        }
                        j5 >>= 8;
                    }
                    if (i8 != 8) {
    ...
    public static /* synthetic */ String joinToString$default(IntFloatMap intFloatMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i5, CharSequence charSequence4, p transform, int i6, Object obj) {
        long[] jArr;
        long[] jArr2;
        int i7;
        if (obj == null) {
    ...
    public final boolean any(@l p<? super Integer, ? super Float, Boolean> predicate) {
        l0.p(predicate, "predicate");
        int[] iArr = this.keys;
        float[] fArr = this.values;
        long[] jArr = this.metadata;
    ...
    public final int count(@l p<? super Integer, ? super Float, Boolean> predicate) {
        l0.p(predicate, "predicate");
        int[] iArr = this.keys;
        float[] fArr = this.values;
        long[] jArr = this.metadata;
            ...
            while (true) {
                ...
                if ((((~j5) << 7) & j5 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i9 = 0; i9 < i8; i9++) {
                        if ((255 & j5) < 128) {
                            int i10 = (i6 << 3) + i9;
                            if (predicate.invoke(Integer.valueOf(iArr[i10]), Float.valueOf(fArr[i10])).booleanValue()) {
                                i7++;
                            }
                        }
                        j5 >>= 8;
    ...
    @l
    @i
    public final String joinToString(@l CharSequence charSequence, @l CharSequence prefix, @l CharSequence postfix, int i5, @l CharSequence truncated, @l p<? super Integer, ? super Float, ? extends CharSequence> transform) {
                ...
                if ((((~j5) << 7) & j5 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i10 < i9) {
                        if ((j5 & 255) < 128) {
                            ...
                            sb.append(transform.invoke(Integer.valueOf(i12), Float.valueOf(f5)));
                            i7++;
                        }
                        j5 >>= 8;
                        i10++;
    ...
    @l
    @i
    public final String joinToString(@l CharSequence charSequence, @l CharSequence prefix, @l CharSequence postfix, int i5, @l p<? super Integer, ? super Float, ? extends CharSequence> transform) {
        CharSequence separator = charSequence;
        l0.p(separator, "separator");
        l0.p(prefix, "prefix");
        l0.p(postfix, "postfix");
    ...
    @l
    @i
    public final String joinToString(@l CharSequence separator, @l CharSequence prefix, @l CharSequence postfix, @l p<? super Integer, ? super Float, ? extends CharSequence> transform) {
        int i5;
        l0.p(separator, "separator");
        l0.p(prefix, "prefix");
        l0.p(postfix, "postfix");
    ...
    @l
    @i
    public final String joinToString(@l CharSequence separator, @l CharSequence prefix, @l p<? super Integer, ? super Float, ? extends CharSequence> transform) {
        int i5;
        l0.p(separator, "separator");
        l0.p(prefix, "prefix");
        l0.p(transform, "transform");
    ...
    @l
    @i
    public final String joinToString(@l CharSequence separator, @l p<? super Integer, ? super Float, ? extends CharSequence> transform) {
        int i5;
        l0.p(separator, "separator");
        l0.p(transform, "transform");
        StringBuilder sb = new StringBuilder();
    ...
    @l
    @i
    public final String joinToString(@l p<? super Integer, ? super Float, ? extends CharSequence> transform) {
        int i5;
        l0.p(transform, "transform");
        StringBuilder sb = new StringBuilder();
        sb.append((CharSequence) "");
