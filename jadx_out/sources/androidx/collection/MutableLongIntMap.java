...
public final class MutableLongIntMap extends LongIntMap {
    ...
    public /* synthetic */ MutableLongIntMap(int i5, int i6, w wVar) {
        this((i6 & 1) != 0 ? 6 : i5);
    }
    ...
    */
    ...
    public final int getOrPut(long j5, @l v3.a<Integer> defaultValue) {
    ...
    public final void plusAssign(@l LongIntMap from) {
        l0.p(from, "from");
        putAll(from);
    }

    public final void put(long j5, int i5) {
        set(j5, i5);
    }

    public final void putAll(@l LongIntMap from) {
        boolean z4;
        l0.p(from, "from");
        long[] jArr = from.keys;
    ...
    public final void removeIf(@l p<? super Long, ? super Integer, Boolean> predicate) {
        boolean z4;
            ...
            while (true) {
                ...
                if ((((~j5) << 7) & j5 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i7 = 0; i7 < i6; i7++) {
                        ...
                        if (z4) {
                            int i8 = (i5 << 3) + i7;
                            if (predicate.invoke(Long.valueOf(this.keys[i8]), Integer.valueOf(this.values[i8])).booleanValue()) {
                                removeValueAt(i8);
                            }
                        }
                        j5 >>= 8;
    ...
    public final void set(long j5, int i5) {
    ...
    public MutableLongIntMap(int i5) {
        super(null);
        if (i5 >= 0) {
    ...
    public final int put(long j5, int i5, int i6) {
        int findInsertIndex = findInsertIndex(j5);
        if (findInsertIndex < 0) {
            findInsertIndex = ~findInsertIndex;
        } else {
    ...
    public final boolean remove(long j5, int i5) {
        int findKeyIndex = findKeyIndex(j5);
