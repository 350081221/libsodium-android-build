...
public final class MutableIntLongMap extends IntLongMap {
    ...
    public /* synthetic */ MutableIntLongMap(int i5, int i6, w wVar) {
        this((i6 & 1) != 0 ? 6 : i5);
    }
    ...
    */
    ...
    private final void resizeStorage(int i5) {
        ...
        while (i8 < i7) {
            ...
            if (z4) {
                ...
                i6 = i8;
                jArr4[i11] = (jArr4[i11] & (~(255 << i12))) | (j5 << i12);
                int i13 = this._capacity;
                int i14 = ((findFirstAvailableSlot - 7) & i13) + (i13 & 7);
                int i15 = i14 >> 3;
                int i16 = (i14 & 7) << 3;
                jArr4[i15] = (jArr4[i15] & (~(255 << i16))) | (j5 << i16);
    ...
    public final long getOrPut(int i5, @l v3.a<Long> defaultValue) {
    ...
    public final void plusAssign(@l IntLongMap from) {
        l0.p(from, "from");
        putAll(from);
    }

    public final void put(int i5, long j5) {
        set(i5, j5);
    }

    public final void putAll(@l IntLongMap from) {
        boolean z4;
        l0.p(from, "from");
        int[] iArr = from.keys;
    ...
    public final void removeIf(@l p<? super Integer, ? super Long, Boolean> predicate) {
        boolean z4;
            ...
            while (true) {
                ...
                if ((((~j5) << 7) & j5 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i7 = 0; i7 < i6; i7++) {
                        ...
                        if (z4) {
                            int i8 = (i5 << 3) + i7;
                            if (predicate.invoke(Integer.valueOf(this.keys[i8]), Long.valueOf(this.values[i8])).booleanValue()) {
                                removeValueAt(i8);
                            }
                        }
                        j5 >>= 8;
    ...
    public MutableIntLongMap(int i5) {
        super(null);
        if (i5 >= 0) {
    ...
    public final long put(int i5, long j5, long j6) {
        int findInsertIndex = findInsertIndex(i5);
        if (findInsertIndex < 0) {
            findInsertIndex = ~findInsertIndex;
        } else {
    ...
    public final boolean remove(int i5, long j5) {
        int findKeyIndex = findKeyIndex(i5);
