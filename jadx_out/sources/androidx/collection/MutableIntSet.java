...
public final class MutableIntSet extends IntSet {
    ...
    public /* synthetic */ MutableIntSet(int i5, int i6, w wVar) {
        this((i6 & 1) != 0 ? 6 : i5);
    }
    ...
    */
    ...
    private final void resizeStorage(int i5) {
        ...
        while (i8 < i7) {
            ...
            if (z4) {
                ...
                int i15 = i14 >> 3;
                int i16 = (i14 & 7) << 3;
                jArr2[i15] = ((~(255 << i16)) & jArr2[i15]) | (j5 << i16);
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final void minusAssign(int r19) {
        /*
            r18 = this;
            r0 = r18
    ...
    */
    ...
    public final boolean addAll(@l IntSet elements) {
        l0.p(elements, "elements");
        int i5 = this._size;
        plusAssign(elements);
        return i5 != this._size;
    ...
    public final boolean removeAll(@l IntSet elements) {
        l0.p(elements, "elements");
        int i5 = this._size;
        minusAssign(elements);
        return i5 != this._size;
    ...
    public final void plusAssign(@l IntSet elements) {
        l0.p(elements, "elements");
    ...
    public final void minusAssign(@l IntSet elements) {
        l0.p(elements, "elements");
        int[] iArr = elements.elements;
        long[] jArr = elements.metadata;
        int length = jArr.length - 2;
