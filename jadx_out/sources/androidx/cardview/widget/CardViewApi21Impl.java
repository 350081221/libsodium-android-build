...
public class CardViewApi21Impl implements CardViewImpl {
    ...
    public void setMaxElevation(CardViewDelegate cardViewDelegate, float f5) {
        getCardBackground(cardViewDelegate).setPadding(f5, cardViewDelegate.getUseCompatPadding(), cardViewDelegate.getPreventCornerOverlap());
        updatePadding(cardViewDelegate);
    }

    @Override // androidx.cardview.widget.CardViewImpl
    public void setRadius(CardViewDelegate cardViewDelegate, float f5) {
        getCardBackground(cardViewDelegate).setRadius(f5);
    }
