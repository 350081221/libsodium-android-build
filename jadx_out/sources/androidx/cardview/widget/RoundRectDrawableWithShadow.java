...
class RoundRectDrawableWithShadow extends Drawable {
    ...
    private void buildShadowCorners() {
        ...
        paint.setShader(new RadialGradient(0.0f, 0.0f, f9, new int[]{i5, i5, this.mShadowEndColor}, new float[]{0.0f, f8, 1.0f}, Shader.TileMode.CLAMP));
        Paint paint2 = this.mEdgeShadowPaint;
        float f10 = this.mCornerRadius;
        float f11 = this.mShadowSize;
        int i6 = this.mShadowStartColor;
        paint2.setShader(new LinearGradient(0.0f, (-f10) + f11, 0.0f, (-f10) - f11, new int[]{i6, i6, this.mShadowEndColor}, new float[]{0.0f, 0.5f, 1.0f}, Shader.TileMode.CLAMP));
        this.mEdgeShadowPaint.setAntiAlias(false);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static float calculateHorizontalPadding(float f5, float f6, boolean z4) {
        return z4 ? (float) (f5 + ((1.0d - COS_45) * f6)) : f5;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static float calculateVerticalPadding(float f5, float f6, boolean z4) {
        return z4 ? (float) ((f5 * SHADOW_MULTIPLIER) + ((1.0d - COS_45) * f6)) : f5 * SHADOW_MULTIPLIER;
    }
