...
class FragmentAnim {
    ...
    public static AnimationOrAnimator loadAnimation(@NonNull Context context, @NonNull Fragment fragment, boolean z4, boolean z5) {
        int nextTransition = fragment.getNextTransition();
        int nextAnim = getNextAnim(fragment, z4, z5);
        boolean z6 = false;
        ...
        if (nextAnim == 0 && nextTransition != 0) {
            nextAnim = transitToAnimResourceId(context, nextTransition, z4);
        }
        if (nextAnim != 0) {
    ...
    @AnimRes
    private static int transitToAnimResourceId(@NonNull Context context, int i5, boolean z4) {
        if (i5 != 4097) {
            if (i5 != 8194) {
                if (i5 != 8197) {
                    if (i5 != 4099) {
