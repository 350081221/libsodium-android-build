...
public abstract class FragmentStatePagerAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(@NonNull ViewGroup viewGroup, int i5) {
        Fragment.SavedState savedState;
        Fragment fragment;
        if (this.mFragments.size() > i5 && (fragment = this.mFragments.get(i5)) != null) {
            return fragment;
        }
        if (this.mCurTransaction == null) {
            this.mCurTransaction = this.mFragmentManager.beginTransaction();
        ...
        if (this.mSavedState.size() > i5 && (savedState = this.mSavedState.get(i5)) != null) {
    ...
    public Parcelable saveState() {
        ...
        for (int i5 = 0; i5 < this.mFragments.size(); i5++) {
            ...
            if (fragment != null && fragment.isAdded()) {
                ...
                this.mFragmentManager.putFragment(bundle, "f" + i5, fragment);
            }
        }
        return bundle;
    }
    ...
    public FragmentStatePagerAdapter(@NonNull FragmentManager fragmentManager, int i5) {
        this.mCurTransaction = null;
