...
public final class BackStackRecord extends FragmentTransaction implements FragmentManager.BackStackEntry, FragmentManager.OpGenerator {
        ...
        while (size >= 0) {
            ...
            if (op.mFromExpandedOp) {
                if (op.mCmd == 8) {
                    ...
                    int i5 = op.mFragment.mContainerId;
                    op.mCmd = 2;
                    op.mFromExpandedOp = false;
                    for (int i6 = size - 1; i6 >= 0; i6--) {
                        FragmentTransaction.Op op2 = this.mOps.get(i6);
                        if (op2.mFromExpandedOp && op2.mFragment.mContainerId == i5) {
                            this.mOps.remove(i6);
                            size--;
                        }
                    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    @Override // androidx.fragment.app.FragmentTransaction
    public void doAddOp(int i5, Fragment fragment, @Nullable String str, int i6) {
                ...
                if (i6 != 2) {
                    if (i6 != 3 && i6 != 6) {
                        ...
                        if (fragment3 == fragment2) {
                            this.mOps.add(i5, new FragmentTransaction.Op(9, fragment3));
                            i5++;
                            fragment2 = null;
                        }
                    }
                    ...
                    int i7 = fragment4.mContainerId;
                    boolean z4 = false;
                    for (int size = arrayList.size() - 1; size >= 0; size--) {
                        Fragment fragment5 = arrayList.get(size);
                        if (fragment5.mContainerId == i7) {
                            if (fragment5 == fragment4) {
                                z4 = true;
                            } else {
                                if (fragment5 == fragment2) {
                                    this.mOps.add(i5, new FragmentTransaction.Op(9, fragment5, true));
                                    i5++;
                                    fragment2 = null;
                                }
