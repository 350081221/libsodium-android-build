...
public final class FragmentViewModelLazyKt$viewModels$3 extends n0 implements v3.a<CreationExtras> {
    final /* synthetic */ d0<ViewModelStoreOwner> $owner$delegate;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public FragmentViewModelLazyKt$viewModels$3(d0<? extends ViewModelStoreOwner> d0Var) {
        super(0);
