...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner, ActivityResultCaller {
    ...
    public boolean performCreateOptionsMenu(@NonNull Menu menu, @NonNull MenuInflater menuInflater) {
        ...
        return z4 | this.mChildFragmentManager.dispatchCreateOptionsMenu(menu, menuInflater);
    }
    ...
    public boolean performPrepareOptionsMenu(@NonNull Menu menu) {
        ...
        return z4 | this.mChildFragmentManager.dispatchPrepareOptionsMenu(menu);
    }
    ...
    public final void requestPermissions(@NonNull String[] strArr, int i5) {
        if (this.mHost != null) {
            getParentFragmentManager().launchRequestPermissions(this, strArr, i5);
            return;
        }
    ...
    public void setAllowEnterTransitionOverlap(boolean z4) {
        ensureAnimationInfo().mAllowEnterTransitionOverlap = Boolean.valueOf(z4);
    }

    public void setAllowReturnTransitionOverlap(boolean z4) {
        ensureAnimationInfo().mAllowReturnTransitionOverlap = Boolean.valueOf(z4);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public void setAnimations(@AnimRes int i5, @AnimRes int i6, @AnimRes int i7, @AnimRes int i8) {
    ...
    public void startIntentSenderForResult(@NonNull IntentSender intentSender, int i5, @Nullable Intent intent, int i6, int i7, int i8, @Nullable Bundle bundle) throws IntentSender.SendIntentException {
        if (this.mHost != null) {
            ...
            getParentFragmentManager().launchStartIntentSenderForResult(this, intentSender, i5, intent, i6, i7, i8, bundle);
            return;
        }
        throw new IllegalStateException("Fragment " + this + " not attached to Activity");
    }
    ...
    @Nullable
    private Fragment getTargetFragment(boolean z4) {
        String str;
        if (z4) {
