...
public class ListFragment extends Fragment {
    ...
    private final AdapterView.OnItemClickListener mOnClickListener = new AdapterView.OnItemClickListener() { // from class: androidx.fragment.app.ListFragment.2
        ...
        public void onItemClick(AdapterView<?> adapterView, View view, int i5, long j5) {
            ListFragment.this.onListItemClick((ListView) adapterView, view, i5, j5);
        }
    };
    ...
    public void onListItemClick(@NonNull ListView listView, @NonNull View view, int i5, long j5) {
    }
