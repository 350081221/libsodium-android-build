...
public final class FragmentManagerViewModel extends ViewModel {
    ...
    private void clearNonConfigStateInternal(@NonNull String str, boolean z4) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void clearNonConfigState(@NonNull Fragment fragment, boolean z4) {
        if (FragmentManager.isLoggingEnabled(3)) {
            Log.d("FragmentManager", "Clearing non-config state for " + fragment);
        }
        clearNonConfigStateInternal(fragment.mWho, z4);
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void clearNonConfigState(@NonNull String str, boolean z4) {
        if (FragmentManager.isLoggingEnabled(3)) {
            Log.d("FragmentManager", "Clearing non-config state for saved state of Fragment " + str);
        }
        clearNonConfigStateInternal(str, z4);
    }
}
