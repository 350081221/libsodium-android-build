...
public class FragmentStateManager {
    ...
    int computeExpectedState() {
        ...
        int i6 = AnonymousClass2.$SwitchMap$androidx$lifecycle$Lifecycle$State[fragment.mMaxState.ordinal()];
        if (i6 != 1) {
            if (i6 != 2) {
                if (i6 != 3) {
                    if (i6 != 4) {
        ...
        if (fragment2.mFromLayout) {
            if (fragment2.mInLayout) {
                ...
                i5 = this.mFragmentManagerState < 4 ? Math.min(i5, fragment2.mState) : Math.min(i5, 1);
            }
        }
        ...
        if (FragmentManager.isLoggingEnabled(2)) {
            Log.v("FragmentManager", "computeExpectedState() of " + i5 + " for " + this.mFragment);
        }
        return i5;
    }
    ...
    void destroy() {
        ...
        if (z5) {
            ...
            if (fragmentHostCallback instanceof ViewModelStoreOwner) {
                z6 = this.mFragmentStore.getNonConfig().isCleared();
            } else if (fragmentHostCallback.getContext() instanceof Activity) {
                z6 = true ^ ((Activity) fragmentHostCallback.getContext()).isChangingConfigurations();
            }
            if ((z4 && !this.mFragment.mBeingSaved) || z6) {
        ...
        try {
            ...
            while (true) {
                ...
                if (computeExpectedState != i5) {
                    ...
                    if (!z4 && i5 == -1 && fragment.mRemoving && !fragment.isInBackStack() && !this.mFragment.mBeingSaved) {
                        if (FragmentManager.isLoggingEnabled(3)) {
