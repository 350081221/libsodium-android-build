...
public final class FragmentViewModelLazyKt$viewModels$6 extends n0 implements v3.a<ViewModelStore> {
    final /* synthetic */ d0<ViewModelStoreOwner> $owner$delegate;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public FragmentViewModelLazyKt$viewModels$6(d0<? extends ViewModelStoreOwner> d0Var) {
        super(0);
