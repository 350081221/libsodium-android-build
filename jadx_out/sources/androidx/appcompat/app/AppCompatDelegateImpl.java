...
public class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    private int calculateNightMode() {
        ...
        return i5 != -100 ? i5 : AppCompatDelegate.getDefaultNightMode();
    }
    ...
    private boolean onKeyUpPanel(int i5, KeyEvent keyEvent) {
        boolean z4;
        ...
        boolean z5 = true;
        PanelFeatureState panelState = getPanelState(i5, true);
        if (i5 == 0 && (decorContentParent = this.mDecorContentParent) != null && decorContentParent.canShowOverflowMenu() && !ViewConfiguration.get(this.mContext).hasPermanentMenuKey()) {
    ...
    */
    ...
    void callOnPanelClosed(int i5, PanelFeatureState panelFeatureState, Menu menu) {
        if (menu == null) {
    ...
    public View createView(View view, String str, @NonNull Context context, @NonNull AttributeSet attributeSet) {
        ...
        if (z6) {
            ...
            if (this.mLayoutIncludeDetector.detect(attributeSet)) {
                z4 = true;
                return this.mAppCompatViewInflater.createView(view, str, context, attributeSet, z4, z6, true, VectorEnabledTintResources.shouldBeUsed());
            }
            if (attributeSet instanceof XmlPullParser) {
                ...
                z5 = shouldInheritContext((ViewParent) view);
            }
        }
        z4 = z5;
        return this.mAppCompatViewInflater.createView(view, str, context, attributeSet, z4, z6, true, VectorEnabledTintResources.shouldBeUsed());
    ...
    void doInvalidatePanelMenu(int i5) {
    ...
    public <T extends View> T findViewById(@IdRes int i5) {
        ensureSubDecor();
        return (T) this.mWindow.findViewById(i5);
    }
    ...
    protected PanelFeatureState getPanelState(int i5, boolean z4) {
        PanelFeatureState[] panelFeatureStateArr = this.mPanels;
    ...
    int mapNightMode(@NonNull Context context, int i5) {
        if (i5 == -100) {
            return -1;
        }
        if (i5 != -1) {
    ...
    */
    ...
    boolean onKeyShortcut(int i5, KeyEvent keyEvent) {
        ActionBar supportActionBar = getSupportActionBar();
    ...
    */
    ...
    void closePanel(PanelFeatureState panelFeatureState, boolean z4) {
        ViewGroup viewGroup;
        DecorContentParent decorContentParent;
