...
public class AlertController {
        ...
        private void createListView(final AlertController alertController) {
            ...
            if (this.mIsMultiChoice) {
                if (this.mCursor == null) {
                    ...
                    listAdapter = new CursorAdapter(this.mContext, this.mCursor, false) { // from class: androidx.appcompat.app.AlertController.AlertParams.2
                        ...
                        public void bindView(View view, Context context, Cursor cursor) {
                            ...
                            recycleListView2.setItemChecked(position, z4);
                        }
                ...
                if (this.mIsSingleChoice) {
                    i5 = alertController.mSingleChoiceItemLayout;
                } else {
                    i5 = alertController.mListItemLayout;
                }
                int i6 = i5;
                if (this.mCursor != null) {
                    listAdapter = new SimpleCursorAdapter(this.mContext, i6, this.mCursor, new String[]{this.mLabelColumn}, new int[]{R.id.text1});
                } else {
                    listAdapter = this.mAdapter;
                    if (listAdapter == null) {
                        listAdapter = new CheckedItemAdapter(this.mContext, i6, R.id.text1, this.mItems);
                    }
                }
            }
            ...
            if (this.mOnClickListener != null) {
                recycleListView.setOnItemClickListener(new AdapterView.OnItemClickListener() { // from class: androidx.appcompat.app.AlertController.AlertParams.3
                    ...
                    public void onItemClick(AdapterView<?> adapterView, View view, int i7, long j5) {
                        AlertParams.this.mOnClickListener.onClick(alertController.mDialog, i7);
                ...
                recycleListView.setOnItemClickListener(new AdapterView.OnItemClickListener() { // from class: androidx.appcompat.app.AlertController.AlertParams.4
                    ...
                    public void onItemClick(AdapterView<?> adapterView, View view, int i7, long j5) {
                        ...
                        AlertParams.this.mOnCheckboxClickListener.onClick(alertController.mDialog, i7, recycleListView.isItemChecked(i7));
                    }
                });
            }
        ...
        public void setHasDecor(boolean z4, boolean z5) {
            ...
            if (!z5 || !z4) {
                ...
                if (z4) {
                    ...
                    i5 = this.mPaddingTopNoTitle;
                }
                int paddingRight = getPaddingRight();
                if (z5) {
                    i6 = getPaddingBottom();
                } else {
                    i6 = this.mPaddingBottomNoButtons;
                }
    ...
    private void setupView() {
        ...
        if (!z6 && resolvePanel2 != null && (findViewById3 = resolvePanel2.findViewById(androidx.appcompat.R.id.textSpacerNoButtons)) != null) {
        ...
        if (!z4) {
            ...
            if (view != null) {
                ...
                setScrollIndicators(resolvePanel2, view, z5 | i8, 3);
            }
        }
