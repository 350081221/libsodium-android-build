...
class TwilightCalculator {
    ...
    public void calculateTwilight(long j5, double d5, double d6) {
        double d7 = (0.01720197f * (((float) (j5 - UTC_2000)) / 8.64E7f)) + 6.24006f;
        ...
        double round = ((float) Math.round((r3 - J0) - r7)) + J0 + ((-d6) / 360.0d) + (Math.sin(d7) * 0.0053d) + (Math.sin(2.0d * sin) * (-0.0069d));
