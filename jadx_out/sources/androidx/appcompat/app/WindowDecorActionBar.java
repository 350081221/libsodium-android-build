...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    public class ActionModeImpl extends ActionMode implements MenuBuilder.Callback {
        ...
        public void setSubtitle(int i5) {
            setSubtitle(WindowDecorActionBar.this.mContext.getResources().getString(i5));
        }

        @Override // androidx.appcompat.view.ActionMode
        public void setTitle(int i5) {
            setTitle(WindowDecorActionBar.this.mContext.getResources().getString(i5));
        }
    }
    ...
    public void removeTabAt(int i5) {
        ...
        if (i6 == i5) {
            if (this.mTabs.isEmpty()) {
                ...
                tabImpl = this.mTabs.get(Math.max(0, i5 - 1));
            }
            selectTab(tabImpl);
        }
    }
