...
public class AlertDialog extends AppCompatDialog implements DialogInterface {
    ...
    public static class Builder {
        ...
        public Builder setIconAttribute(@AttrRes int i5) {
            ...
            this.P.mContext.getTheme().resolveAttribute(i5, typedValue, true);
        ...
        public Builder setInverseBackgroundForced(boolean z4) {
            this.P.mForceInverseBackground = z4;
            return this;
        }
        ...
        public Builder(@NonNull Context context, @StyleRes int i5) {
            this.P = new AlertController.AlertParams(new ContextThemeWrapper(context, AlertDialog.resolveDialogTheme(context, i5)));
            this.mTheme = i5;
        }
