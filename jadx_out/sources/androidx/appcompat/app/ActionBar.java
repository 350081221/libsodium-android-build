...
public abstract class ActionBar {
    ...
    public interface OnNavigationListener {
        boolean onNavigationItemSelected(int i5, long j5);
    }
    ...
    @Deprecated
    public abstract void addTab(Tab tab, int i5, boolean z4);

    @Deprecated
    public abstract void addTab(Tab tab, boolean z4);
    ...
    public abstract void setDisplayHomeAsUpEnabled(boolean z4);

    public abstract void setDisplayOptions(int i5);

    public abstract void setDisplayOptions(int i5, int i6);

    public abstract void setDisplayShowCustomEnabled(boolean z4);

    public abstract void setDisplayShowHomeEnabled(boolean z4);

    public abstract void setDisplayShowTitleEnabled(boolean z4);

    public abstract void setDisplayUseLogoEnabled(boolean z4);
