...
public class DrawableContainerCompat extends Drawable implements Drawable.Callback {
    ...
    public static abstract class DrawableContainerState extends Drawable.ConstantState {
        ...
        public DrawableContainerState(DrawableContainerState drawableContainerState, DrawableContainerCompat drawableContainerCompat, Resources resources) {
            ...
            if (drawableContainerState != null) {
                i5 = drawableContainerState.mDensity;
            } else {
                i5 = 0;
            }
            int resolveDensity = DrawableContainerCompat.resolveDensity(resources, i5);
                ...
                for (int i7 = 0; i7 < i6; i7++) {
                    ...
                    if (drawable != null) {
                        ...
                        if (constantState != null) {
                            this.mDrawableFutures.put(i7, constantState);
                        } else {
                            this.mDrawables[i7] = drawableArr[i7];
                        }
                    }
                }
                return;
        ...
        public final Drawable getChild(int i5) {
            ...
            this.mDrawables[i5] = prepareDrawable;
        ...
        final boolean setLayoutDirection(int i5, int i6) {
    ...
    static int resolveDensity(@Nullable Resources resources, int i5) {
        if (resources != null) {
