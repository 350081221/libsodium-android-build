...
public class StateListDrawableCompat extends DrawableContainerCompat {
    ...
    public static class StateListState extends DrawableContainerCompat.DrawableContainerState {
        ...
        public void growArray(int i5, int i6) {
            super.growArray(i5, i6);
            int[][] iArr = new int[i6];
            System.arraycopy(this.mStateSets, 0, iArr, 0, i5);
    ...
    */
    ...
    Drawable getStateDrawable(int i5) {
        return this.mStateListState.getChild(i5);
    }
    ...
    int[] getStateSet(int i5) {
        return this.mStateListState.mStateSets[i5];
    }
