...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    private Drawable getIcon1(Cursor cursor) {
        ...
        Drawable drawableFromResourceValue = getDrawableFromResourceValue(cursor.getString(i5));
    ...
    private Drawable getIcon2(Cursor cursor) {
        int i5 = this.mIconName2Col;
        if (i5 == -1) {
            return null;
        }
        return getDrawableFromResourceValue(cursor.getString(i5));
    }

    private static String getStringOrNull(Cursor cursor, int i5) {
        if (i5 == -1) {
            return null;
        }
        try {
    ...
    private void setViewDrawable(ImageView imageView, Drawable drawable, int i5) {
    ...
    Cursor getSearchManagerSuggestions(SearchableInfo searchableInfo, String str, int i5) {
    ...
    public void setQueryRefinement(int i5) {
        this.mQueryRefinement = i5;
    }
}
