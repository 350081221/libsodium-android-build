...
class TooltipPopup {
    ...
    private void computePosition(View view, int i5, int i6, boolean z4, WindowManager.LayoutParams layoutParams) {
        ...
        if (rect.left < 0 && rect.top < 0) {
            ...
            int identifier = resources2.getIdentifier("status_bar_height", "dimen", SharedLibraryInfo.PLATFORM_PACKAGE_NAME);
            if (identifier != 0) {
        ...
        layoutParams.x = (i11 + i5) - (appRootView.getWidth() / 2);
        ...
        if (measuredHeight + i14 <= this.mTmpDisplayFrame.height()) {
            layoutParams.y = i14;
        } else {
            layoutParams.y = i13;
        }
