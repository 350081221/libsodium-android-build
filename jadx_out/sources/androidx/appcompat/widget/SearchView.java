...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public static class Api29Impl {
        ...
        @DoNotInline
        static void setInputMethodMode(SearchAutoComplete searchAutoComplete, int i5) {
    ...
    public interface OnSuggestionListener {
        boolean onSuggestionClick(int i5);

        boolean onSuggestionSelect(int i5);
    }
    ...
    public static class SavedState extends AbsSavedState {
        ...
        public String toString() {
            return "SearchView.SavedState{" + Integer.toHexString(System.identityHashCode(this)) + " isIconified=" + this.isIconified + a1.i.f138d;
        }
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            if (action != 0) {
                if (action != 1 && action != 2) {
                    ...
                    z5 = this.mDelegateTargeted;
                    if (z5 && !this.mSlopBounds.contains(x4, y4)) {
                        z6 = z5;
                        z4 = false;
                    }
                }
                ...
                if (this.mTargetBounds.contains(x4, y4)) {
            ...
            if (z4 && !this.mActualBounds.contains(x4, y4)) {
    ...
    private Intent createIntent(String str, Uri uri, String str2, String str3, int i5, String str4) {
    ...
    private Intent createIntentFromSuggestion(Cursor cursor, int i5, String str) {
        int i6;
        Uri parse;
        String columnString;
        try {
            ...
            return createIntent(str2, parse, SuggestionsAdapter.getColumnString(cursor, "suggest_intent_extra_data"), SuggestionsAdapter.getColumnString(cursor, "suggest_intent_query"), i5, str);
            ...
            Log.w(LOG_TAG, "Search suggestions cursor at row " + i6 + " returned exception.", e5);
            return null;
        }
    }
    ...
    private boolean launchSuggestion(int i5, int i6, String str) {
        Cursor cursor = this.mSuggestionsAdapter.getCursor();
        if (cursor != null && cursor.moveToPosition(i5)) {
            launchIntent(createIntentFromSuggestion(cursor, i6, str));
            return true;
        }
        return false;
    }
    ...
    private void rewriteQueryFromSuggestion(int i5) {
    ...
    private void updateSearchAutoComplete() {
        ...
        if (this.mSearchable.getSuggestAuthority() != null) {
            ...
            suggestionsAdapter2.setQueryRefinement(i5);
        }
    }
    ...
    private void updateSubmitButton(boolean z4) {
        int i5;
        if (this.mSubmitButtonEnabled && isSubmitAreaEnabled() && hasFocus() && (z4 || !this.mVoiceButtonEnabled)) {
            i5 = 0;
        } else {
            i5 = 8;
        }
        this.mGoButton.setVisibility(i5);
    }
    ...
    void adjustDropDownSizeAndPosition() {
        ...
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            if (this.mIconifiedByDefault) {
                i5 = resources.getDimensionPixelSize(R.dimen.abc_dropdownitem_icon_width) + resources.getDimensionPixelSize(R.dimen.abc_dropdownitem_text_padding_left);
            } else {
                i5 = 0;
            }
            ...
            this.mSearchSrcTextView.setDropDownHorizontalOffset(i6);
    ...
    void launchQuerySearch(int i5, String str, String str2) {
        getContext().startActivity(createIntent("android.intent.action.SEARCH", null, null, str2, i5, str));
    }
    ...
    boolean onItemClicked(int i5, int i6, String str) {
        OnSuggestionListener onSuggestionListener = this.mOnSuggestionListener;
        if (onSuggestionListener != null && onSuggestionListener.onSuggestionClick(i5)) {
            return false;
        }
        launchSuggestion(i5, 0, null);
        this.mSearchSrcTextView.setImeVisibility(false);
        dismissSuggestions();
        return true;
    }

    boolean onItemSelected(int i5) {
        OnSuggestionListener onSuggestionListener = this.mOnSuggestionListener;
        if (onSuggestionListener != null && onSuggestionListener.onSuggestionSelect(i5)) {
            return false;
        }
        rewriteQueryFromSuggestion(i5);
        return true;
    }
    ...
    public void onMeasure(int i5, int i6) {
        ...
        if (mode != Integer.MIN_VALUE) {
            if (mode != 0) {
                if (mode == 1073741824 && (i7 = this.mMaxWidth) > 0) {
    ...
    boolean onSuggestionsKey(View view, int i5, KeyEvent keyEvent) {
        int length;
    ...
    public void setQueryRefinementEnabled(boolean z4) {
        ...
        if (cursorAdapter instanceof SuggestionsAdapter) {
            ...
            suggestionsAdapter.setQueryRefinement(i5);
        }
    }
    ...
    public SearchView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i5) {
        ...
        this.mTextKeyListener = new View.OnKeyListener() { // from class: androidx.appcompat.widget.SearchView.6
            ...
            public boolean onKey(View view, int i6, KeyEvent keyEvent) {
                ...
                if (searchView.mSearchSrcTextView.isPopupShowing() && SearchView.this.mSearchSrcTextView.getListSelection() != -1) {
                    return SearchView.this.onSuggestionsKey(view, i6, keyEvent);
                }
                if (SearchView.this.mSearchSrcTextView.isEmpty() || !keyEvent.hasNoModifiers() || keyEvent.getAction() != 1 || i6 != 66) {
                    return false;
                }
        ...
        AdapterView.OnItemClickListener onItemClickListener = new AdapterView.OnItemClickListener() { // from class: androidx.appcompat.widget.SearchView.8
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i6, long j5) {
                SearchView.this.onItemClicked(i6, 0, null);
            }
        };
        ...
        AdapterView.OnItemSelectedListener onItemSelectedListener = new AdapterView.OnItemSelectedListener() { // from class: androidx.appcompat.widget.SearchView.9
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i6, long j5) {
                SearchView.this.onItemSelected(i6);
            }
        ...
        imageView.setImageDrawable(obtainStyledAttributes.getDrawable(i6));
        ...
        imageView5.setImageDrawable(obtainStyledAttributes.getDrawable(i6));
        ...
        int i7 = obtainStyledAttributes.getInt(R.styleable.SearchView_android_imeOptions, -1);
        if (i7 != -1) {
            setImeOptions(i7);
        }
        int i8 = obtainStyledAttributes.getInt(R.styleable.SearchView_android_inputType, -1);
        if (i8 != -1) {
            setInputType(i8);
        }
