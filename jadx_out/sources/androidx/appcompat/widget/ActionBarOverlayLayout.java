...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent, NestedScrollingParent2, NestedScrollingParent3 {
    ...
    */
    ...
    private void init(Context context) {
        ...
        this.mIgnoreWindowContentOverlay = z5;
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.mWindowContentOverlay != null && !this.mIgnoreWindowContentOverlay) {
            if (this.mActionBarTop.getVisibility() == 0) {
                i5 = (int) (this.mActionBarTop.getBottom() + this.mActionBarTop.getTranslationY() + 0.5f);
            } else {
                i5 = 0;
            }
            this.mWindowContentOverlay.setBounds(0, i5, getWidth(), this.mWindowContentOverlay.getIntrinsicHeight() + i5);
    ...
    public void setOverlayMode(boolean z4) {
        ...
        if (z4 && getContext().getApplicationInfo().targetSdkVersion < 19) {
            z5 = true;
        } else {
            z5 = false;
        }
