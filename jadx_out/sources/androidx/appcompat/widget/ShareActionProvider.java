...
public class ShareActionProvider extends ActionProvider {
    ...
    public void onPrepareSubMenu(SubMenu subMenu) {
        ...
        for (int i5 = 0; i5 < min; i5++) {
            ResolveInfo activity = activityChooserModel.getActivity(i5);
            subMenu.add(0, i5, i5, activity.loadLabel(packageManager)).setIcon(activity.loadIcon(packageManager)).setOnMenuItemClickListener(this.mOnMenuItemClickListener);
        }
        if (min < activityCount) {
            ...
            for (int i6 = 0; i6 < activityCount; i6++) {
                ...
                addSubMenu.add(0, i6, i6, activity2.loadLabel(packageManager)).setIcon(activity2.loadIcon(packageManager)).setOnMenuItemClickListener(this.mOnMenuItemClickListener);
            }
        }
    }
