...
public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    public void animateToVisibility(int i5) {
        ViewPropertyAnimatorCompat viewPropertyAnimatorCompat = setupAnimatorToVisibility(i5, DEFAULT_FADE_DURATION_MS);
    ...
    public void setNavigationMode(int i5) {
        ...
        if (i5 != i6) {
            if (i6 != 1) {
                if (i6 == 2 && (view = this.mTabView) != null) {
                    ViewParent parent = view.getParent();
                    Toolbar toolbar = this.mToolbar;
                    if (parent == toolbar) {
                        toolbar.removeView(this.mTabView);
    ...
    public void setVisibility(int i5) {
        this.mToolbar.setVisibility(i5);
    }
    ...
    @Override // androidx.appcompat.widget.DecorToolbar
    public ViewPropertyAnimatorCompat setupAnimatorToVisibility(final int i5, long j5) {
        float f5;
        ...
        return animate.alpha(f5).setDuration(j5).setListener(new ViewPropertyAnimatorListenerAdapter() { // from class: androidx.appcompat.widget.ToolbarWidgetWrapper.2
            ...
            public void onAnimationEnd(View view) {
                if (!this.mCanceled) {
                    ToolbarWidgetWrapper.this.mToolbar.setVisibility(i5);
                }
            }
