...
public class ActionBarContextView extends AbsActionBarView {
    ...
    protected void onLayout(boolean z4, int i5, int i6, int i7, int i8) {
        ...
        if (view != null && view.getVisibility() != 8) {
            ...
            int next = AbsActionBarView.next(paddingLeft, i9, isLayoutRtl);
            paddingLeft = AbsActionBarView.next(next + positionChild(this.mClose, next, paddingTop, paddingTop2, isLayoutRtl), i10, isLayoutRtl);
        }
        int i11 = paddingLeft;
