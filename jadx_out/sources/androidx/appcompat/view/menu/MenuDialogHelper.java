...
class MenuDialogHelper implements DialogInterface.OnKeyListener, DialogInterface.OnClickListener, DialogInterface.OnDismissListener, MenuPresenter.Callback {
    ...
    public void onClick(DialogInterface dialogInterface, int i5) {
        this.mMenu.performItemAction((MenuItemImpl) this.mPresenter.getAdapter().getItem(i5), 0);
    }

    @Override // androidx.appcompat.view.menu.MenuPresenter.Callback
    public void onCloseMenu(@NonNull MenuBuilder menuBuilder, boolean z4) {
        if (z4 || menuBuilder == this.mMenu) {
            dismiss();
        }
    ...
    public boolean onKey(DialogInterface dialogInterface, int i5, KeyEvent keyEvent) {
        ...
        return this.mMenu.performShortcut(i5, keyEvent, 0);
    }
