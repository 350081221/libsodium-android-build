...
public class MenuItemWrapperICS extends BaseMenuWrapper implements MenuItem {
    ...
    public void setShowAsAction(int i5) {
        this.mWrappedObject.setShowAsAction(i5);
    }

    @Override // android.view.MenuItem
    public MenuItem setShowAsActionFlags(int i5) {
        this.mWrappedObject.setShowAsActionFlags(i5);
        return this;
    }
    ...
    public MenuItem setAlphabeticShortcut(char c5, int i5) {
        this.mWrappedObject.setAlphabeticShortcut(c5, i5);
        return this;
    }

    @Override // android.view.MenuItem
    public MenuItem setIcon(int i5) {
        this.mWrappedObject.setIcon(i5);
        return this;
    }

    @Override // android.view.MenuItem
    public MenuItem setNumericShortcut(char c5, int i5) {
        this.mWrappedObject.setNumericShortcut(c5, i5);
        return this;
    }

    @Override // android.view.MenuItem
    public MenuItem setShortcut(char c5, char c6, int i5, int i6) {
        this.mWrappedObject.setShortcut(c5, c6, i5, i6);
        return this;
    }
    ...
    public MenuItem setActionView(int i5) {
        this.mWrappedObject.setActionView(i5);
        View actionView = this.mWrappedObject.getActionView();
