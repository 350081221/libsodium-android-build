...
public class SupportMenuInflater extends MenuInflater {
    ...
    public class MenuState {
        ...
        private void setItem(MenuItem menuItem) {
            ...
            enabled.setCheckable(z4).setTitleCondensed(this.itemTitleCondensed).setIcon(this.itemIconResId);
            int i5 = this.itemShowAsAction;
            if (i5 >= 0) {
        ...
        public void readItem(AttributeSet attributeSet) {
            ...
            if (obtainStyledAttributes.hasValue(i5)) {
                this.itemCheckable = obtainStyledAttributes.getBoolean(i5, false) ? 1 : 0;
            } else {
            ...
            if (obtainStyledAttributes.hasValue(i6)) {
                this.itemIconTintMode = DrawableUtils.parseTintMode(obtainStyledAttributes.getInt(i6, -1), this.itemIconTintMode);
            } else {
                this.itemIconTintMode = null;
            }
            int i7 = R.styleable.MenuItem_iconTint;
            if (obtainStyledAttributes.hasValue(i7)) {
                this.itemIconTintList = obtainStyledAttributes.getColorStateList(i7);
            } else {
