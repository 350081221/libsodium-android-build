...
public class WindowCallbackWrapper implements Window.Callback {
    ...
    static class Api23Impl {
        ...
        @DoNotInline
        static android.view.ActionMode onWindowStartingActionMode(Window.Callback callback, ActionMode.Callback callback2, int i5) {
    ...
    static class Api24Impl {
        ...
        @DoNotInline
        static void onProvideKeyboardShortcuts(Window.Callback callback, List<KeyboardShortcutGroup> list, Menu menu, int i5) {
