...
final class BorderModifierNode$drawRoundRectBorder$2 extends n0 implements v3.l<ContentDrawScope, r2> {
    ...
    public final void invoke2(@p4.l ContentDrawScope contentDrawScope) {
        ...
        DrawScope.m4267drawPathGBMwjPU$default(contentDrawScope, this.$roundedRectPath, this.$brush, 0.0f, null, null, 0, 60, null);
    }
}
