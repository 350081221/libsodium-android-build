...
final class BasicTextField2Kt$TextFieldCursorHandle$1$1 extends n0 implements l<SemanticsPropertyReceiver, r2> {
    ...
    public final void invoke2(@p4.l SemanticsPropertyReceiver semanticsPropertyReceiver) {
        semanticsPropertyReceiver.set(SelectionHandlesKt.getSelectionHandleInfoKey(), new SelectionHandleInfo(Handle.Cursor, this.$cursorHandleState.m1156getPositionF1C5BW0(), SelectionHandleAnchor.Middle, true, null));
    }
}
