...
public final class MaxLengthTransformationKt {
    ...
    public static final InputTransformation maxLengthInChars(@l InputTransformation.Companion companion, int i5) {
        return new MaxLengthFilter(i5, false);
    }

    @Stable
    @l
    @ExperimentalFoundationApi
    public static final InputTransformation maxLengthInCodepoints(@l InputTransformation.Companion companion, int i5) {
        return new MaxLengthFilter(i5, true);
    }
}
