...
final class StatelessInputConnection$commitText$1 extends n0 implements l<EditingBuffer, r2> {
    final /* synthetic */ int $newCursorPosition;
    final /* synthetic */ CharSequence $text;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public StatelessInputConnection$commitText$1(CharSequence charSequence, int i5) {
        super(1);
