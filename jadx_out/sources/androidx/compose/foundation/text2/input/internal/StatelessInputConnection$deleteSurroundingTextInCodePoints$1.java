...
final class StatelessInputConnection$deleteSurroundingTextInCodePoints$1 extends n0 implements l<EditingBuffer, r2> {
    final /* synthetic */ int $afterLength;
    final /* synthetic */ int $beforeLength;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public StatelessInputConnection$deleteSurroundingTextInCodePoints$1(int i5, int i6) {
        super(1);
        this.$beforeLength = i5;
        this.$afterLength = i6;
    }
