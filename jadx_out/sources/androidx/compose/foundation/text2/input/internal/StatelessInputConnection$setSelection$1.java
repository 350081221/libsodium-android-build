...
final class StatelessInputConnection$setSelection$1 extends n0 implements l<EditingBuffer, r2> {
    final /* synthetic */ int $end;
    final /* synthetic */ int $start;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public StatelessInputConnection$setSelection$1(int i5, int i6) {
        super(1);
        this.$start = i5;
        this.$end = i6;
    }
