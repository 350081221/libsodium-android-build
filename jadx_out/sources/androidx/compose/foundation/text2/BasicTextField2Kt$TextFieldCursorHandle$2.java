...
@f(c = "androidx.compose.foundation.text2.BasicTextField2Kt$TextFieldCursorHandle$2", f = "BasicTextField2.kt", i = {}, l = {503}, m = "invokeSuspend", n = {}, s = {})
...
final class BasicTextField2Kt$TextFieldCursorHandle$2 extends o implements p<PointerInputScope, d<? super r2>, Object> {
    ...
    public final Object invoke(@l PointerInputScope pointerInputScope, @m d<? super r2> dVar) {
        return ((BasicTextField2Kt$TextFieldCursorHandle$2) create(pointerInputScope, dVar)).invokeSuspend(r2.f19517a);
    }
    ...
    public final Object invokeSuspend(@l Object obj) {
        ...
        if (i5 != 0) {
            ...
            this.label = 1;
            if (textFieldSelectionState.cursorHandleGestures(pointerInputScope, this) == l5) {
                return l5;
            }
        }
        return r2.f19517a;
