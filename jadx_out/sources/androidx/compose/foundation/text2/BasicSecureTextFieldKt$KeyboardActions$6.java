...
final class BasicSecureTextFieldKt$KeyboardActions$6 extends n0 implements l<KeyboardActionScope, r2> {
    ...
    public final void invoke2(@p4.l KeyboardActionScope keyboardActionScope) {
        ...
        if (imeActionHandler.mo1062onImeActionKlQnJC8(companion.m5728getSendeUduSuo())) {
            return;
        }
        keyboardActionScope.mo852defaultKeyboardActionKlQnJC8(companion.m5728getSendeUduSuo());
    }
}
