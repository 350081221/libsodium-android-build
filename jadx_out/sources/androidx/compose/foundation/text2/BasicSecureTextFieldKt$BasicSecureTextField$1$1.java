...
public final class BasicSecureTextFieldKt$BasicSecureTextField$1$1 extends n0 implements l<TextFieldValue, r2> {
    ...
    public BasicSecureTextFieldKt$BasicSecureTextField$1$1(l<? super String, r2> lVar, MutableState<TextFieldValue> mutableState) {
        super(1);
    ...
    public final void invoke2(@p4.l TextFieldValue textFieldValue) {
        ...
        if (!l0.g(text, BasicSecureTextField_TLP4tmw$lambda$2.getText())) {
