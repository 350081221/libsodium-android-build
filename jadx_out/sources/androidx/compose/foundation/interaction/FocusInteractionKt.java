...
public final class FocusInteractionKt {
    @l
    @Composable
    public static final State<Boolean> collectIsFocusedAsState(@l InteractionSource interactionSource, @m Composer composer, int i5) {
        composer.startReplaceableGroup(-1805515472);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1805515472, i5, -1, "androidx.compose.foundation.interaction.collectIsFocusedAsState (FocusInteraction.kt:64)");
        }
