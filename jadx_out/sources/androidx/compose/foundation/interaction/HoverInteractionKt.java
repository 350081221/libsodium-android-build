...
public final class HoverInteractionKt {
    @l
    @Composable
    public static final State<Boolean> collectIsHoveredAsState(@l InteractionSource interactionSource, @m Composer composer, int i5) {
        composer.startReplaceableGroup(1206586544);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1206586544, i5, -1, "androidx.compose.foundation.interaction.collectIsHoveredAsState (HoverInteraction.kt:64)");
        }
