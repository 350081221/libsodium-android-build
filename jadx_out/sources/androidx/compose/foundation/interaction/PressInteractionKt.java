...
public final class PressInteractionKt {
    @l
    @Composable
    public static final State<Boolean> collectIsPressedAsState(@l InteractionSource interactionSource, @m Composer composer, int i5) {
        composer.startReplaceableGroup(-1692965168);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1692965168, i5, -1, "androidx.compose.foundation.interaction.collectIsPressedAsState (PressInteraction.kt:83)");
        }
