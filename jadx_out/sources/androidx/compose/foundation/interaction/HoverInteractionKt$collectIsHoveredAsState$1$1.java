...
public final class HoverInteractionKt$collectIsHoveredAsState$1$1 extends o implements p<s0, d<? super r2>, Object> {
    ...
    public final Object invoke(@l s0 s0Var, @m d<? super r2> dVar) {
        return ((HoverInteractionKt$collectIsHoveredAsState$1$1) create(s0Var, dVar)).invokeSuspend(r2.f19517a);
    }
