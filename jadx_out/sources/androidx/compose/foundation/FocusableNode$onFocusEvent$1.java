...
final class FocusableNode$onFocusEvent$1 extends kotlin.coroutines.jvm.internal.o implements v3.p<s0, kotlin.coroutines.d<? super r2>, Object> {
    int label;
    ...
    public final Object invoke(@p4.l s0 s0Var, @p4.m kotlin.coroutines.d<? super r2> dVar) {
        return ((FocusableNode$onFocusEvent$1) create(s0Var, dVar)).invokeSuspend(r2.f19517a);
    }
    ...
    public final Object invokeSuspend(@p4.l Object obj) {
        ...
        if (i5 != 0) {
            ...
            this.label = 1;
            if (BringIntoViewRequester.bringIntoView$default(bringIntoViewRequester, null, this, 1, null) == l5) {
                return l5;
            }
        }
        return r2.f19517a;
