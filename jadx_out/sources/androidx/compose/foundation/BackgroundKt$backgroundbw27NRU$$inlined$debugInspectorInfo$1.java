...
public final class BackgroundKt$backgroundbw27NRU$$inlined$debugInspectorInfo$1 extends n0 implements v3.l<InspectorInfo, r2> {
    final /* synthetic */ long $color$inlined;
    final /* synthetic */ Shape $shape$inlined;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public BackgroundKt$backgroundbw27NRU$$inlined$debugInspectorInfo$1(long j5, Shape shape) {
        super(1);
    ...
    public final void invoke2(@p4.l InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.setValue(Color.m3724boximpl(this.$color$inlined));
        inspectorInfo.getProperties().set(TypedValues.Custom.S_COLOR, Color.m3724boximpl(this.$color$inlined));
