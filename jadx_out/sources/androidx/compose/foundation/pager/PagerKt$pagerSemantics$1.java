...
final class PagerKt$pagerSemantics$1 extends n0 implements l<SemanticsPropertyReceiver, r2> {
    ...
    public static final class AnonymousClass1 extends n0 implements v3.a<Boolean> {
        ...
        AnonymousClass1(PagerState pagerState, s0 s0Var) {
            super(0);
    ...
    public static final class AnonymousClass2 extends n0 implements v3.a<Boolean> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        AnonymousClass2(PagerState pagerState, s0 s0Var) {
            super(0);
            this.$state = pagerState;
            this.$scope = s0Var;
        }
    ...
    /* loaded from: classes.dex */
    public static final class AnonymousClass3 extends n0 implements v3.a<Boolean> {
        final /* synthetic */ s0 $scope;
        final /* synthetic */ PagerState $state;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        AnonymousClass3(PagerState pagerState, s0 s0Var) {
            super(0);
            this.$state = pagerState;
            this.$scope = s0Var;
        }
    ...
    /* loaded from: classes.dex */
    public static final class AnonymousClass4 extends n0 implements v3.a<Boolean> {
        final /* synthetic */ s0 $scope;
        final /* synthetic */ PagerState $state;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        AnonymousClass4(PagerState pagerState, s0 s0Var) {
            super(0);
            this.$state = pagerState;
            this.$scope = s0Var;
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public PagerKt$pagerSemantics$1(boolean z4, PagerState pagerState, s0 s0Var) {
        super(1);
        this.$isVertical = z4;
        this.$state = pagerState;
        this.$scope = s0Var;
