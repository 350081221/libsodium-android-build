...
public final class PagerKt$HorizontalPager$2 extends n0 implements p<Composer, Integer, r2> {
    ...
    public PagerKt$HorizontalPager$2(PagerState pagerState, Modifier modifier, PaddingValues paddingValues, PageSize pageSize, int i5, float f5, Alignment.Vertical vertical, SnapFlingBehavior snapFlingBehavior, boolean z4, boolean z5, l<? super Integer, ? extends Object> lVar, NestedScrollConnection nestedScrollConnection, r<? super PagerScope, ? super Integer, ? super Composer, ? super Integer, r2> rVar, int i6, int i7, int i8) {
        super(2);
    ...
    public final void invoke(@m Composer composer, int i5) {
        PagerKt.m781HorizontalPagerxYaah8o(this.$state, this.$modifier, this.$contentPadding, this.$pageSize, this.$beyondBoundsPageCount, this.$pageSpacing, this.$verticalAlignment, this.$flingBehavior, this.$userScrollEnabled, this.$reverseLayout, this.$key, this.$pageNestedScrollConnection, this.$pageContent, composer, RecomposeScopeImplKt.updateChangedFlags(this.$$changed | 1), RecomposeScopeImplKt.updateChangedFlags(this.$$changed1), this.$$default);
    }
}
