...
public final class PagerKt$pagerSemantics$performForwardPaging$1 extends o implements p<s0, d<? super r2>, Object> {
    ...
    public final Object invoke(@l s0 s0Var, @m d<? super r2> dVar) {
        return ((PagerKt$pagerSemantics$performForwardPaging$1) create(s0Var, dVar)).invokeSuspend(r2.f19517a);
    }
    ...
    public final Object invokeSuspend(@l Object obj) {
        ...
        if (i5 != 0) {
            ...
            this.label = 1;
            if (PagerStateKt.animateToNextPage(pagerState, this) == l5) {
                return l5;
            }
        }
        return r2.f19517a;
