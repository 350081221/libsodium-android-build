...
final class BasicTooltip_androidKt$TooltipPopup$1 extends n0 implements v3.a<r2> {
    final /* synthetic */ s0 $scope;
    final /* synthetic */ BasicTooltipState $state;

    /* JADX INFO: Access modifiers changed from: package-private */
    @kotlin.coroutines.jvm.internal.f(c = "androidx.compose.foundation.BasicTooltip_androidKt$TooltipPopup$1$1", f = "BasicTooltip.android.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public BasicTooltip_androidKt$TooltipPopup$1(BasicTooltipState basicTooltipState, s0 s0Var) {
        super(0);
        this.$state = basicTooltipState;
        this.$scope = s0Var;
    }
