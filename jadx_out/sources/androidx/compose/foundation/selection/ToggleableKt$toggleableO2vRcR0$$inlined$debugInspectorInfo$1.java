...
public final class ToggleableKt$toggleableO2vRcR0$$inlined$debugInspectorInfo$1 extends n0 implements l<InspectorInfo, r2> {
    ...
    public ToggleableKt$toggleableO2vRcR0$$inlined$debugInspectorInfo$1(boolean z4, MutableInteractionSource mutableInteractionSource, Indication indication, boolean z5, Role role, l lVar) {
        super(1);
    ...
    public final void invoke2(@p4.l InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set(b.f22420d, Boolean.valueOf(this.$value$inlined));
