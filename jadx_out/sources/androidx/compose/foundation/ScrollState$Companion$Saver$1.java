...
final class ScrollState$Companion$Saver$1 extends n0 implements v3.p<SaverScope, ScrollState, Integer> {
    ...
    @Override // v3.p
    @p4.m
    public final Integer invoke(@p4.l SaverScope saverScope, @p4.l ScrollState scrollState) {
