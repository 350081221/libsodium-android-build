...
public final class RoundedCornerShape extends CornerBasedShape {
    ...
    public RoundedCornerShape(@l CornerSize cornerSize, @l CornerSize cornerSize2, @l CornerSize cornerSize3, @l CornerSize cornerSize4) {
    ...
    public Outline mo806createOutlineLjSzlW0(long j5, float f5, float f6, float f7, float f8, @l LayoutDirection layoutDirection) {
        ...
        Rect m3583toRectuvyYCjk = SizeKt.m3583toRectuvyYCjk(j5);
        ...
        long CornerRadius$default = CornerRadiusKt.CornerRadius$default(f9, 0.0f, 2, null);
        if (layoutDirection == layoutDirection2) {
            f10 = f6;
        } else {
            f10 = f5;
        }
        long CornerRadius$default2 = CornerRadiusKt.CornerRadius$default(f10, 0.0f, 2, null);
        if (layoutDirection == layoutDirection2) {
            f11 = f7;
        } else {
            f11 = f8;
        }
        long CornerRadius$default3 = CornerRadiusKt.CornerRadius$default(f11, 0.0f, 2, null);
        if (layoutDirection == layoutDirection2) {
            f12 = f8;
        } else {
            f12 = f7;
        }
        return new Outline.Rounded(RoundRectKt.m3545RoundRectZAM2FJo(m3583toRectuvyYCjk, CornerRadius$default, CornerRadius$default2, CornerRadius$default3, CornerRadiusKt.CornerRadius$default(f12, 0.0f, 2, null)));
    }
    ...
    public boolean equals(@m Object obj) {
        ...
        if (l0.g(getTopStart(), roundedCornerShape.getTopStart()) && l0.g(getTopEnd(), roundedCornerShape.getTopEnd()) && l0.g(getBottomEnd(), roundedCornerShape.getBottomEnd()) && l0.g(getBottomStart(), roundedCornerShape.getBottomStart())) {
            return true;
        }
        return false;
    }
    ...
    @Override // androidx.compose.foundation.shape.CornerBasedShape
    @l
    public RoundedCornerShape copy(@l CornerSize cornerSize, @l CornerSize cornerSize2, @l CornerSize cornerSize3, @l CornerSize cornerSize4) {
