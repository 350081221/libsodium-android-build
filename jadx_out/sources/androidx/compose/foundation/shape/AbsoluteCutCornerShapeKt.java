...
public final class AbsoluteCutCornerShapeKt {
    @l
    public static final AbsoluteCutCornerShape AbsoluteCutCornerShape(@l CornerSize cornerSize) {
    ...
    public static final AbsoluteCutCornerShape m807AbsoluteCutCornerShape0680j_4(float f5) {
        return AbsoluteCutCornerShape(CornerSizeKt.m815CornerSize0680j_4(f5));
    }

    @l
    /* renamed from: AbsoluteCutCornerShape-a9UjIt4, reason: not valid java name */
    public static final AbsoluteCutCornerShape m808AbsoluteCutCornerShapea9UjIt4(float f5, float f6, float f7, float f8) {
        return new AbsoluteCutCornerShape(CornerSizeKt.m815CornerSize0680j_4(f5), CornerSizeKt.m815CornerSize0680j_4(f6), CornerSizeKt.m815CornerSize0680j_4(f7), CornerSizeKt.m815CornerSize0680j_4(f8));
    }

    /* renamed from: AbsoluteCutCornerShape-a9UjIt4$default, reason: not valid java name */
    public static /* synthetic */ AbsoluteCutCornerShape m809AbsoluteCutCornerShapea9UjIt4$default(float f5, float f6, float f7, float f8, int i5, Object obj) {
        if ((i5 & 1) != 0) {
        ...
        return m808AbsoluteCutCornerShapea9UjIt4(f5, f6, f7, f8);
    }
    ...
    @l
    public static final AbsoluteCutCornerShape AbsoluteCutCornerShape(@IntRange(from = 0, to = 100) int i5, @IntRange(from = 0, to = 100) int i6, @IntRange(from = 0, to = 100) int i7, @IntRange(from = 0, to = 100) int i8) {
