...
final class SelectionGesturesKt$mouseSelection$shouldConsumeUp$2 extends n0 implements l<PointerInputChange, r2> {
    ...
    public final void invoke2(@p4.l PointerInputChange pointerInputChange) {
        if (this.$observer.mo968onDrag3MmeM6k(pointerInputChange.m4872getPositionF1C5BW0(), this.$selectionAdjustment)) {
