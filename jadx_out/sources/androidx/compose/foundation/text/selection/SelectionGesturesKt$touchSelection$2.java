...
final class SelectionGesturesKt$touchSelection$2 extends n0 implements l<PointerInputChange, r2> {
    ...
    public final void invoke2(@p4.l PointerInputChange pointerInputChange) {
        this.$observer.mo896onDragk4lQ0M(PointerEventKt.positionChange(pointerInputChange));
