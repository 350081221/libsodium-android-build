...
public final class SelectionManager_androidKt$selectionMagnifier$1 extends n0 implements q<Modifier, Composer, Integer, Modifier> {
    ...
    public static final class AnonymousClass1 extends n0 implements v3.a<Offset> {
        ...
        public /* bridge */ /* synthetic */ Offset invoke() {
            return Offset.m3482boximpl(m1034invokeF1C5BW0());
        }

        /* renamed from: invoke-F1C5BW0, reason: not valid java name */
        public final long m1034invokeF1C5BW0() {
            return SelectionManagerKt.m1030calculateSelectionMagnifierCenterAndroidO0kMr_c(this.$manager, SelectionManager_androidKt$selectionMagnifier$1.invoke$lambda$1(this.$magnifierSize$delegate));
        }
    }
    ...
    public final Modifier invoke(@l Modifier modifier, @m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1914520728, i5, -1, "androidx.compose.foundation.text.selection.selectionMagnifier.<anonymous> (SelectionManager.android.kt:45)");
        }
