...
public final class SelectionManager_androidKt$selectionMagnifier$1$2$1 extends n0 implements l<v3.a<? extends Offset>, Modifier> {
    ...
    public static final class AnonymousClass1 extends n0 implements l<Density, Offset> {
        ...
        public /* bridge */ /* synthetic */ Offset invoke(Density density) {
            return Offset.m3482boximpl(m1035invoketuRUvjQ(density));
        }

        /* renamed from: invoke-tuRUvjQ, reason: not valid java name */
        public final long m1035invoketuRUvjQ(@p4.l Density density) {
    ...
    public static final class AnonymousClass2 extends n0 implements l<DpSize, r2> {
        ...
        public /* bridge */ /* synthetic */ r2 invoke(DpSize dpSize) {
            m1036invokeEaSLcWc(dpSize.m6150unboximpl());
            return r2.f19517a;
        }

        /* renamed from: invoke-EaSLcWc, reason: not valid java name */
        public final void m1036invokeEaSLcWc(long j5) {
            MutableState<IntSize> mutableState = this.$magnifierSize$delegate;
            Density density = this.$density;
            SelectionManager_androidKt$selectionMagnifier$1.invoke$lambda$2(mutableState, IntSizeKt.IntSize(density.mo298roundToPx0680j_4(DpSize.m6142getWidthD9Ej5fM(j5)), density.mo298roundToPx0680j_4(DpSize.m6140getHeightD9Ej5fM(j5))));
        }
    }
