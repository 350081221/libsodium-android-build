...
public final class HeightInLinesModifierKt$heightInLines$$inlined$debugInspectorInfo$1 extends n0 implements l<InspectorInfo, r2> {
    ...
    public HeightInLinesModifierKt$heightInLines$$inlined$debugInspectorInfo$1(int i5, int i6, TextStyle textStyle) {
        super(1);
        this.$minLines$inlined = i5;
        this.$maxLines$inlined = i6;
