...
public final class VerticalScrollLayoutModifier implements LayoutModifier {
    ...
    public VerticalScrollLayoutModifier(@l TextFieldScrollerPosition textFieldScrollerPosition, int i5, @l TransformedText transformedText, @l a<TextLayoutResultProxy> aVar) {
    ...
    public static /* synthetic */ VerticalScrollLayoutModifier copy$default(VerticalScrollLayoutModifier verticalScrollLayoutModifier, TextFieldScrollerPosition textFieldScrollerPosition, int i5, TransformedText transformedText, a aVar, int i6, Object obj) {
        if ((i6 & 1) != 0) {
        ...
        return verticalScrollLayoutModifier.copy(textFieldScrollerPosition, i5, transformedText, aVar);
    }
    ...
    @l
    public final VerticalScrollLayoutModifier copy(@l TextFieldScrollerPosition textFieldScrollerPosition, int i5, @l TransformedText transformedText, @l a<TextLayoutResultProxy> aVar) {
        return new VerticalScrollLayoutModifier(textFieldScrollerPosition, i5, transformedText, aVar);
    }
    ...
    public boolean equals(@m Object obj) {
        ...
        return l0.g(this.scrollerPosition, verticalScrollLayoutModifier.scrollerPosition) && this.cursorOffset == verticalScrollLayoutModifier.cursorOffset && l0.g(this.transformedText, verticalScrollLayoutModifier.transformedText) && l0.g(this.textLayoutResultProvider, verticalScrollLayoutModifier.textLayoutResultProvider);
    }
    ...
    public MeasureResult mo56measure3p2s80s(@l MeasureScope measureScope, @l Measurable measurable, long j5) {
        ...
        return MeasureScope.layout$default(measureScope, mo4998measureBRTryo0.getWidth(), min, null, new VerticalScrollLayoutModifier$measure$1(measureScope, this, mo4998measureBRTryo0, min), 4, null);
    }
