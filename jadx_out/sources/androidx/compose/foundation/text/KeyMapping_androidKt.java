...
public final class KeyMapping_androidKt {
    ...
    private static final KeyMapping platformDefaultKeyMapping = new KeyMapping() { // from class: androidx.compose.foundation.text.KeyMapping_androidKt$platformDefaultKeyMapping$1
        ...
        public KeyCommand mo851mapZmokQxo(@l KeyEvent keyEvent) {
            KeyCommand keyCommand = null;
            if (KeyEvent_androidKt.m4742isShiftPressedZmokQxo(keyEvent) && KeyEvent_androidKt.m4739isAltPressedZmokQxo(keyEvent)) {
            ...
            if (keyCommand == null) {
                return KeyMappingKt.getDefaultKeyMapping().mo851mapZmokQxo(keyEvent);
            }
            return keyCommand;
        }
    };
