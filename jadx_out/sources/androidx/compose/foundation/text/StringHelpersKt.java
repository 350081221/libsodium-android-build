...
public final class StringHelpersKt {
    public static final int findParagraphEnd(@l CharSequence charSequence, int i5) {
    ...
    public static final int findParagraphStart(@l CharSequence charSequence, int i5) {
        while (i5 > 0) {
    ...
    public static final long getParagraphBoundary(@l CharSequence charSequence, int i5) {
