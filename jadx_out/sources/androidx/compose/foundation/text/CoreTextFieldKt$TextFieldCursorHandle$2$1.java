...
final class CoreTextFieldKt$TextFieldCursorHandle$2$1 extends n0 implements l<SemanticsPropertyReceiver, r2> {
    final /* synthetic */ long $position;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CoreTextFieldKt$TextFieldCursorHandle$2$1(long j5) {
        super(1);
        this.$position = j5;
    }
    ...
    public final void invoke2(@p4.l SemanticsPropertyReceiver semanticsPropertyReceiver) {
        semanticsPropertyReceiver.set(SelectionHandlesKt.getSelectionHandleInfoKey(), new SelectionHandleInfo(Handle.Cursor, this.$position, SelectionHandleAnchor.Middle, true, null));
    }
}
