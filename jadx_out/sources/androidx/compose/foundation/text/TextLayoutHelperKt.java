...
public final class TextLayoutHelperKt {
    ...
    public static final boolean m926canReuse7_7YC6M(@l TextLayoutResult textLayoutResult, @l AnnotatedString annotatedString, @l TextStyle textStyle, @l List<AnnotatedString.Range<Placeholder>> list, int i5, boolean z4, int i6, @l Density density, @l LayoutDirection layoutDirection, @l FontFamily.Resolver resolver, long j5) {
        TextLayoutInput layoutInput = textLayoutResult.getLayoutInput();
        if (textLayoutResult.getMultiParagraph().getIntrinsics().getHasStaleResolvedFonts() || !l0.g(layoutInput.getText(), annotatedString) || !layoutInput.getStyle().hasSameLayoutAffectingAttributes(textStyle) || !l0.g(layoutInput.getPlaceholders(), list) || layoutInput.getMaxLines() != i5 || layoutInput.getSoftWrap() != z4 || !TextOverflow.m5978equalsimpl0(layoutInput.m5514getOverflowgIe3tQ8(), i6) || !l0.g(layoutInput.getDensity(), density) || layoutInput.getLayoutDirection() != layoutDirection || !l0.g(layoutInput.getFontFamilyResolver(), resolver) || Constraints.m6002getMinWidthimpl(j5) != Constraints.m6002getMinWidthimpl(layoutInput.m5513getConstraintsmsEJaDk())) {
            return false;
        }
        if (!z4 && !TextOverflow.m5978equalsimpl0(i6, TextOverflow.Companion.m5986getEllipsisgIe3tQ8())) {
            return true;
        }
        if (Constraints.m6000getMaxWidthimpl(j5) != Constraints.m6000getMaxWidthimpl(layoutInput.m5513getConstraintsmsEJaDk()) || Constraints.m5999getMaxHeightimpl(j5) != Constraints.m5999getMaxHeightimpl(layoutInput.m5513getConstraintsmsEJaDk())) {
            return false;
        }
        return true;
    }
