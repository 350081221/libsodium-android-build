...
public final class BasicTextFieldKt$BasicTextField$15 extends n0 implements p<Composer, Integer, r2> {
    ...
    public BasicTextFieldKt$BasicTextField$15(TextFieldValue textFieldValue, l<? super TextFieldValue, r2> lVar, Modifier modifier, boolean z4, boolean z5, TextStyle textStyle, KeyboardOptions keyboardOptions, KeyboardActions keyboardActions, boolean z6, int i5, VisualTransformation visualTransformation, l<? super TextLayoutResult, r2> lVar2, MutableInteractionSource mutableInteractionSource, Brush brush, q<? super p<? super Composer, ? super Integer, r2>, ? super Composer, ? super Integer, r2> qVar, int i6, int i7, int i8) {
        super(2);
