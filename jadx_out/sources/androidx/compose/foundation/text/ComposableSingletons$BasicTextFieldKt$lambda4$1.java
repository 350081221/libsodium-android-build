...
final class ComposableSingletons$BasicTextFieldKt$lambda4$1 extends n0 implements q<p<? super Composer, ? super Integer, ? extends r2>, Composer, Integer, r2> {
    ...
    public final void invoke(@l p<? super Composer, ? super Integer, r2> pVar, @m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-34833998, i5, -1, "androidx.compose.foundation.text.ComposableSingletons$BasicTextFieldKt.lambda-4.<anonymous> (BasicTextField.kt:378)");
        }
