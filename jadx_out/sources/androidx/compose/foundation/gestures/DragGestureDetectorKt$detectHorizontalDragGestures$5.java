...
@f(c = "androidx.compose.foundation.gestures.DragGestureDetectorKt$detectHorizontalDragGestures$5", f = "DragGestureDetector.kt", i = {0, 1, 1}, l = {538, 540, 551}, m = "invokeSuspend", n = {"$this$awaitEachGesture", "$this$awaitEachGesture", "overSlop"}, s = {"L$0", "L$0", "L$1"})
@i0(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\u0010\u0002\u001a\u00020\u0001*\u00020\u0000H\u008a@"}, d2 = {"Landroidx/compose/ui/input/pointer/AwaitPointerEventScope;", "Lkotlin/r2;", "<anonymous>"}, k = 3, mv = {1, 8, 0})
/* loaded from: classes.dex */
public final class DragGestureDetectorKt$detectHorizontalDragGestures$5 extends k implements p<AwaitPointerEventScope, d<? super r2>, Object> {
    final /* synthetic */ a<r2> $onDragCancel;
    final /* synthetic */ a<r2> $onDragEnd;
    final /* synthetic */ l<Offset, r2> $onDragStart;
    final /* synthetic */ p<PointerInputChange, Float, r2> $onHorizontalDrag;
    ...
    public static final class AnonymousClass1 extends n0 implements l<PointerInputChange, r2> {
        ...
        public final void invoke2(@p4.l PointerInputChange pointerInputChange) {
            this.$onHorizontalDrag.invoke(pointerInputChange, Float.valueOf(Offset.m3493getXimpl(PointerEventKt.positionChange(pointerInputChange))));
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public DragGestureDetectorKt$detectHorizontalDragGestures$5(l<? super Offset, r2> lVar, p<? super PointerInputChange, ? super Float, r2> pVar, a<r2> aVar, a<r2> aVar2, d<? super DragGestureDetectorKt$detectHorizontalDragGestures$5> dVar) {
        super(2, dVar);
    ...
    public final Object invoke(@p4.l AwaitPointerEventScope awaitPointerEventScope, @m d<? super r2> dVar) {
        return ((DragGestureDetectorKt$detectHorizontalDragGestures$5) create(awaitPointerEventScope, dVar)).invokeSuspend(r2.f19517a);
    }
    ...
    */
    public final java.lang.Object invokeSuspend(@p4.l java.lang.Object r13) {
        ...
        L4d:
            ...
            r4 = r1
            r9 = r12
            java.lang.Object r13 = androidx.compose.foundation.gestures.DragGestureDetectorKt.m328awaitHorizontalPointerSlopOrCancellationgDDlDlE(r4, r5, r7, r8, r9)
            if (r13 != r0) goto L70
            return r0
        L70:
            r3 = r1
        ...
        L72:
            ...
            r4.invoke(r5)
            v3.p<androidx.compose.ui.input.pointer.PointerInputChange, java.lang.Float, kotlin.r2> r4 = r12.$onHorizontalDrag
            float r1 = r1.element
            ...
            v3.p<androidx.compose.ui.input.pointer.PointerInputChange, java.lang.Float, kotlin.r2> r1 = r12.$onHorizontalDrag
            r13.<init>(r1)
            r1 = 0
            r12.L$0 = r1
            r12.L$1 = r1
            r12.label = r2
            java.lang.Object r13 = androidx.compose.foundation.gestures.DragGestureDetectorKt.m340horizontalDragjO51t88(r3, r4, r13, r12)
            if (r13 != r0) goto La7
            return r0
        La7:
