...
public final class AnchoredDraggableState$anchoredDrag$4 extends o implements l<d<? super r2>, Object> {
    final /* synthetic */ r<AnchoredDragScope, DraggableAnchors<T>, T, d<? super r2>, Object> $block;
    ...
    @i0(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\u0010\u0005\u001a\u0014\u0012\n\u0012\b\u0012\u0004\u0012\u00028\u00000\u0002\u0012\u0004\u0012\u00028\u00000\u0001\"\u0004\b\u0000\u0010\u0000H\n¢\u0006\u0004\b\u0003\u0010\u0004"}, d2 = {"T", "Lkotlin/u0;", "Landroidx/compose/foundation/gestures/DraggableAnchors;", "invoke", "()Lkotlin/u0;", "<anonymous>"}, k = 3, mv = {1, 8, 0})
    ...
    @i0(d1 = {"\u0000\u0012\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u0010\u0005\u001a\u00020\u0004\"\u0004\b\u0000\u0010\u00002\u0018\u0010\u0003\u001a\u0014\u0012\n\u0012\b\u0012\u0004\u0012\u00028\u00000\u0002\u0012\u0004\u0012\u00028\u00000\u0001H\u008a@"}, d2 = {"T", "Lkotlin/u0;", "Landroidx/compose/foundation/gestures/DraggableAnchors;", "<name for destructuring parameter 0>", "Lkotlin/r2;", "<anonymous>"}, k = 3, mv = {1, 8, 0})
    ...
    public static final class AnonymousClass2<T> extends o implements p<u0<? extends DraggableAnchors<T>, ? extends T>, d<? super r2>, Object> {
        ...
        AnonymousClass2(r<? super AnchoredDragScope, ? super DraggableAnchors<T>, ? super T, ? super d<? super r2>, ? extends Object> rVar, AnchoredDraggableState<T> anchoredDraggableState, d<? super AnonymousClass2> dVar) {
            super(2, dVar);
            this.$block = rVar;
            this.this$0 = anchoredDraggableState;
        }
        ...
        @Override // v3.p
        @m
        public final Object invoke(@p4.l u0<? extends DraggableAnchors<T>, ? extends T> u0Var, @m d<? super r2> dVar) {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public AnchoredDraggableState$anchoredDrag$4(AnchoredDraggableState<T> anchoredDraggableState, T t5, r<? super AnchoredDragScope, ? super DraggableAnchors<T>, ? super T, ? super d<? super r2>, ? extends Object> rVar, d<? super AnchoredDraggableState$anchoredDrag$4> dVar) {
        super(1, dVar);
        this.this$0 = anchoredDraggableState;
        this.$targetValue = t5;
        this.$block = rVar;
