...
@f(c = "androidx.compose.foundation.gestures.AnchoredDraggableKt$restartable$2", f = "AnchoredDraggable.kt", i = {}, l = {711}, m = "invokeSuspend", n = {}, s = {})
@i0(d1 = {"\u0000\f\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\u0010\u0003\u001a\u00020\u0002\"\u0004\b\u0000\u0010\u0000*\u00020\u0001H\u008a@"}, d2 = {"I", "Lkotlinx/coroutines/s0;", "Lkotlin/r2;", "<anonymous>"}, k = 3, mv = {1, 8, 0})
/* loaded from: classes.dex */
final class AnchoredDraggableKt$restartable$2 extends o implements p<s0, d<? super r2>, Object> {
    final /* synthetic */ p<I, d<? super r2>, Object> $block;
    ...
    public static final class AnonymousClass1<T> implements j {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        @f(c = "androidx.compose.foundation.gestures.AnchoredDraggableKt$restartable$2$1$2", f = "AnchoredDraggable.kt", i = {}, l = {717}, m = "invokeSuspend", n = {}, s = {})
        @i0(d1 = {"\u0000\f\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\u0010\u0003\u001a\u00020\u0002\"\u0004\b\u0000\u0010\u0000*\u00020\u0001H\u008a@"}, d2 = {"I", "Lkotlinx/coroutines/s0;", "Lkotlin/r2;", "<anonymous>"}, k = 3, mv = {1, 8, 0})
        ...
        public static final class AnonymousClass2 extends o implements p<s0, d<? super r2>, Object> {
            ...
            AnonymousClass2(p<? super I, ? super d<? super r2>, ? extends Object> pVar, I i5, s0 s0Var, d<? super AnonymousClass2> dVar) {
                super(2, dVar);
                this.$block = pVar;
            ...
            public final Object invokeSuspend(@l Object obj) {
                ...
                if (i5 != 0) {
                    ...
                    e1.n(obj);
                    p<I, d<? super r2>, Object> pVar = this.$block;
        ...
        /* JADX WARN: Multi-variable type inference failed */
        AnonymousClass1(k1.h<l2> hVar, s0 s0Var, p<? super I, ? super d<? super r2>, ? extends Object> pVar) {
        ...
        */
        public final java.lang.Object emit(I r8, @p4.l kotlin.coroutines.d<? super kotlin.r2> r9) {
            ...
            L5e:
                ...
                return r8
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.gestures.AnchoredDraggableKt$restartable$2.AnonymousClass1.emit(java.lang.Object, kotlin.coroutines.d):java.lang.Object");
        }
    }
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public AnchoredDraggableKt$restartable$2(a<? extends I> aVar, p<? super I, ? super d<? super r2>, ? extends Object> pVar, d<? super AnchoredDraggableKt$restartable$2> dVar) {
        super(2, dVar);
        this.$inputs = aVar;
        this.$block = pVar;
    }
