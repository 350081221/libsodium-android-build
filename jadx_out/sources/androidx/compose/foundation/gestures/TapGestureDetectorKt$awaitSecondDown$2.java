...
@f(c = "androidx.compose.foundation.gestures.TapGestureDetectorKt$awaitSecondDown$2", f = "TapGestureDetector.kt", i = {0, 0}, l = {Opcodes.REM_INT_LIT16}, m = "invokeSuspend", n = {"$this$withTimeoutOrNull", "minUptime"}, s = {"L$0", "J$0"})
...
public final class TapGestureDetectorKt$awaitSecondDown$2 extends k implements p<AwaitPointerEventScope, d<? super PointerInputChange>, Object> {
    ...
    public TapGestureDetectorKt$awaitSecondDown$2(PointerInputChange pointerInputChange, d<? super TapGestureDetectorKt$awaitSecondDown$2> dVar) {
        super(2, dVar);
    ...
    public final Object invoke(@l AwaitPointerEventScope awaitPointerEventScope, @m d<? super PointerInputChange> dVar) {
        return ((TapGestureDetectorKt$awaitSecondDown$2) create(awaitPointerEventScope, dVar)).invokeSuspend(r2.f19517a);
    }
