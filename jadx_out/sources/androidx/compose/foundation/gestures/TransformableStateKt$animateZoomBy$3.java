...
@f(c = "androidx.compose.foundation.gestures.TransformableStateKt$animateZoomBy$3", f = "TransformableState.kt", i = {}, l = {138}, m = "invokeSuspend", n = {}, s = {})
@i0(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\u0010\u0002\u001a\u00020\u0001*\u00020\u0000H\u008a@"}, d2 = {"Landroidx/compose/foundation/gestures/TransformScope;", "Lkotlin/r2;", "<anonymous>"}, k = 3, mv = {1, 8, 0})
/* loaded from: classes.dex */
final class TransformableStateKt$animateZoomBy$3 extends o implements p<TransformScope, d<? super r2>, Object> {
    ...
    public static final class AnonymousClass1 extends n0 implements l<AnimationScope<Float, AnimationVector1D>, r2> {
        ...
        public final void invoke2(@p4.l AnimationScope<Float, AnimationVector1D> animationScope) {
            TransformScope.m410transformByd4ec7I$default(this.$$this$transform, (this.$previous.element > 0.0f ? 1 : (this.$previous.element == 0.0f ? 0 : -1)) == 0 ? 1.0f : animationScope.getValue().floatValue() / this.$previous.element, 0L, 0.0f, 6, null);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public TransformableStateKt$animateZoomBy$3(k1.e eVar, float f5, AnimationSpec<Float> animationSpec, d<? super TransformableStateKt$animateZoomBy$3> dVar) {
        super(2, dVar);
        this.$previous = eVar;
        this.$zoomFactor = f5;
    ...
    public final Object invoke(@p4.l TransformScope transformScope, @m d<? super r2> dVar) {
        return ((TransformableStateKt$animateZoomBy$3) create(transformScope, dVar)).invokeSuspend(r2.f19517a);
    }
