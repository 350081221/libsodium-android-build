...
final class ScrollableNode$onKeyEvent$1$1 extends o implements p<s0, d<? super r2>, Object> {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ScrollableNode$onKeyEvent$1$1(ScrollingLogic scrollingLogic, long j5, d<? super ScrollableNode$onKeyEvent$1$1> dVar) {
        super(2, dVar);
        this.$this_with = scrollingLogic;
        this.$scrollAmount = j5;
    }
    ...
    public final Object invoke(@l s0 s0Var, @m d<? super r2> dVar) {
        return ((ScrollableNode$onKeyEvent$1$1) create(s0Var, dVar)).invokeSuspend(r2.f19517a);
    }
