...
public final class SnapPositionInLayoutKt {
    public static final float calculateDistanceToDesiredSnapPosition(int i5, int i6, int i7, int i8, int i9, int i10, @l SnapPositionInLayout snapPositionInLayout) {
        return i9 - snapPositionInLayout.position(i5, i8, i6, i7, i10);
    }
}
