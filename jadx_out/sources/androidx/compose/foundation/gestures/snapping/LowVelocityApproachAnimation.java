...
public final class LowVelocityApproachAnimation implements ApproachAnimation<Float, AnimationVector1D> {
    ...
    public Object approachAnimation(@l ScrollScope scrollScope, float f5, float f6, @l v3.l<? super Float, r2> lVar, @l d<? super AnimationResult<Float, AnimationVector1D>> dVar) {
        Object l5;
        Object access$animateWithTarget = SnapFlingBehaviorKt.access$animateWithTarget(scrollScope, Math.abs(f5) * Math.signum(f6), f5, AnimationStateKt.AnimationState$default(0.0f, f6, 0L, 0L, false, 28, null), this.lowVelocityAnimationSpec, lVar, dVar);
        l5 = kotlin.coroutines.intrinsics.d.l();
        return access$animateWithTarget == l5 ? access$animateWithTarget : (AnimationResult) access$animateWithTarget;
    }
}
