...
final class DefaultTransformableState$transform$2 extends o implements p<s0, d<? super r2>, Object> {
    final /* synthetic */ p<TransformScope, d<? super r2>, Object> $block;
    final /* synthetic */ MutatePriority $transformPriority;
    int label;
    final /* synthetic */ DefaultTransformableState this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    @f(c = "androidx.compose.foundation.gestures.DefaultTransformableState$transform$2$1", f = "TransformableState.kt", i = {}, l = {Opcodes.INVOKE_CUSTOM}, m = "invokeSuspend", n = {}, s = {})
    ...
    /* loaded from: classes.dex */
    public static final class AnonymousClass1 extends o implements p<TransformScope, d<? super r2>, Object> {
        final /* synthetic */ p<TransformScope, d<? super r2>, Object> $block;
        ...
        AnonymousClass1(DefaultTransformableState defaultTransformableState, p<? super TransformScope, ? super d<? super r2>, ? extends Object> pVar, d<? super AnonymousClass1> dVar) {
            super(2, dVar);
        ...
        public final Object invoke(@l TransformScope transformScope, @m d<? super r2> dVar) {
            return ((AnonymousClass1) create(transformScope, dVar)).invokeSuspend(r2.f19517a);
        }
        ...
        public final Object invokeSuspend(@l Object obj) {
            ...
            try {
                if (i5 != 0) {
                    ...
                    p<TransformScope, d<? super r2>, Object> pVar = this.$block;
                    this.label = 1;
                    if (pVar.invoke(transformScope, this) == l5) {
                        return l5;
                    }
                }
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public DefaultTransformableState$transform$2(DefaultTransformableState defaultTransformableState, MutatePriority mutatePriority, p<? super TransformScope, ? super d<? super r2>, ? extends Object> pVar, d<? super DefaultTransformableState$transform$2> dVar) {
        super(2, dVar);
        this.this$0 = defaultTransformableState;
    ...
    public final Object invoke(@l s0 s0Var, @m d<? super r2> dVar) {
        return ((DefaultTransformableState$transform$2) create(s0Var, dVar)).invokeSuspend(r2.f19517a);
    }
    ...
    public final Object invokeSuspend(@l Object obj) {
        ...
        if (i5 != 0) {
            ...
            this.label = 1;
            if (mutatorMutex.mutateWith(transformScope, mutatePriority, anonymousClass1, this) == l5) {
                return l5;
            }
        }
        return r2.f19517a;
