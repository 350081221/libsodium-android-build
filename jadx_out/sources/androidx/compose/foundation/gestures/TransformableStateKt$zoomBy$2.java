...
@f(c = "androidx.compose.foundation.gestures.TransformableStateKt$zoomBy$2", f = "TransformableState.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
@i0(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\u0010\u0002\u001a\u00020\u0001*\u00020\u0000H\u008a@"}, d2 = {"Landroidx/compose/foundation/gestures/TransformScope;", "Lkotlin/r2;", "<anonymous>"}, k = 3, mv = {1, 8, 0})
/* loaded from: classes.dex */
final class TransformableStateKt$zoomBy$2 extends o implements p<TransformScope, d<? super r2>, Object> {
    ...
    public final Object invoke(@l TransformScope transformScope, @m d<? super r2> dVar) {
        return ((TransformableStateKt$zoomBy$2) create(transformScope, dVar)).invokeSuspend(r2.f19517a);
    }
    ...
    public final Object invokeSuspend(@l Object obj) {
        ...
        if (this.label == 0) {
            e1.n(obj);
            ((TransformScope) this.L$0).mo320transformByd4ec7I(this.$zoomFactor, Offset.Companion.m3509getZeroF1C5BW0(), 0.0f);
            return r2.f19517a;
        }
