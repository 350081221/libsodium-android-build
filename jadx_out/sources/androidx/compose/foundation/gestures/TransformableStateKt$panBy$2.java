...
final class TransformableStateKt$panBy$2 extends o implements p<TransformScope, d<? super r2>, Object> {
    ...
    public TransformableStateKt$panBy$2(long j5, d<? super TransformableStateKt$panBy$2> dVar) {
        super(2, dVar);
        this.$offset = j5;
    }
    ...
    public final Object invoke(@l TransformScope transformScope, @m d<? super r2> dVar) {
        return ((TransformableStateKt$panBy$2) create(transformScope, dVar)).invokeSuspend(r2.f19517a);
    }
    ...
    public final Object invokeSuspend(@l Object obj) {
        ...
        if (this.label == 0) {
            e1.n(obj);
            ((TransformScope) this.L$0).mo320transformByd4ec7I(1.0f, this.$offset, 0.0f);
            return r2.f19517a;
        }
