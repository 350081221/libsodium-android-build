...
public final class AnchoredDraggableState$Companion$Saver$3<T> extends n0 implements l<T, AnchoredDraggableState<T>> {
    ...
    public AnchoredDraggableState$Companion$Saver$3(l<? super Float, Float> lVar, a<Float> aVar, AnimationSpec<Float> animationSpec, l<? super T, Boolean> lVar2) {
        super(1);
