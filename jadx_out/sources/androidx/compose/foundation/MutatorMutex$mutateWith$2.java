...
@kotlin.coroutines.jvm.internal.f(c = "androidx.compose.foundation.MutatorMutex$mutateWith$2", f = "MutatorMutex.kt", i = {0, 0, 1, 1}, l = {Opcodes.REM_INT_LIT8, 173}, m = "invokeSuspend", n = {"mutator", "$this$withLock_u24default$iv", "mutator", "$this$withLock_u24default$iv"}, s = {"L$0", "L$1", "L$0", "L$1"})
...
public final class MutatorMutex$mutateWith$2<R> extends kotlin.coroutines.jvm.internal.o implements v3.p<s0, kotlin.coroutines.d<? super R>, Object> {
    ...
    public MutatorMutex$mutateWith$2(MutatePriority mutatePriority, MutatorMutex mutatorMutex, v3.p<? super T, ? super kotlin.coroutines.d<? super R>, ? extends Object> pVar, T t5, kotlin.coroutines.d<? super MutatorMutex$mutateWith$2> dVar) {
        super(2, dVar);
