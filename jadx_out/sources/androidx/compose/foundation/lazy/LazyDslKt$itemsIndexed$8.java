...
public final class LazyDslKt$itemsIndexed$8 extends n0 implements r<LazyItemScope, Integer, Composer, Integer, r2> {
    final /* synthetic */ s<LazyItemScope, Integer, T, Composer, Integer, r2> $itemContent;
    final /* synthetic */ T[] $items;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public LazyDslKt$itemsIndexed$8(s<? super LazyItemScope, ? super Integer, ? super T, ? super Composer, ? super Integer, r2> sVar, T[] tArr) {
        super(4);
    ...
    public final void invoke(@l LazyItemScope lazyItemScope, int i5, @m Composer composer, int i6) {
        ...
        this.$itemContent.invoke(lazyItemScope, Integer.valueOf(i5), this.$items[i5], composer, Integer.valueOf((i7 & 14) | (i7 & 112)));
        if (ComposerKt.isTraceInProgress()) {
