...
final class LazySaveableStateHolder$Companion$saver$2 extends n0 implements l<Map<String, ? extends List<? extends Object>>, LazySaveableStateHolder> {
    ...
    @Override // v3.l
    @m
    public final LazySaveableStateHolder invoke(@p4.l Map<String, ? extends List<? extends Object>> map) {
