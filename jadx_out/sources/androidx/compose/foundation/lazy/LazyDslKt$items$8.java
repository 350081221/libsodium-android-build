...
public final class LazyDslKt$items$8 extends n0 implements r<LazyItemScope, Integer, Composer, Integer, r2> {
    final /* synthetic */ r<LazyItemScope, T, Composer, Integer, r2> $itemContent;
    final /* synthetic */ T[] $items;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public LazyDslKt$items$8(r<? super LazyItemScope, ? super T, ? super Composer, ? super Integer, r2> rVar, T[] tArr) {
        super(4);
    ...
    public final void invoke(@l LazyItemScope lazyItemScope, int i5, @m Composer composer, int i6) {
        ...
        this.$itemContent.invoke(lazyItemScope, this.$items[i5], composer, Integer.valueOf(i7 & 14));
        if (ComposerKt.isTraceInProgress()) {
