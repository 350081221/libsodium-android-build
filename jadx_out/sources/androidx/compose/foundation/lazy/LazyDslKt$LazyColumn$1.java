...
public final class LazyDslKt$LazyColumn$1 extends n0 implements p<Composer, Integer, r2> {
    ...
    public LazyDslKt$LazyColumn$1(Modifier modifier, LazyListState lazyListState, PaddingValues paddingValues, boolean z4, Arrangement.Vertical vertical, Alignment.Horizontal horizontal, FlingBehavior flingBehavior, boolean z5, l<? super LazyListScope, r2> lVar, int i5, int i6) {
        super(2);
