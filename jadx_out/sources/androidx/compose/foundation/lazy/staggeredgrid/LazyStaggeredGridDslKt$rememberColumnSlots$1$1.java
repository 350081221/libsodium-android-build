...
final class LazyStaggeredGridDslKt$rememberColumnSlots$1$1 extends n0 implements p<Density, Constraints, LazyStaggeredGridSlots> {
    ...
    public /* bridge */ /* synthetic */ LazyStaggeredGridSlots invoke(Density density, Constraints constraints) {
        return m741invoke0kLqBqw(density, constraints.m6006unboximpl());
    }

    @l
    /* renamed from: invoke-0kLqBqw, reason: not valid java name */
    public final LazyStaggeredGridSlots m741invoke0kLqBqw(@l Density density, long j5) {
        boolean z4;
        ...
        if (z4) {
            ...
            int[] calculateCrossAxisCellSizes = staggeredGridCells.calculateCrossAxisCellSizes(density, m6000getMaxWidthimpl, density.mo298roundToPx0680j_4(horizontal.mo468getSpacingD9Ej5fM()));
            int[] iArr = new int[calculateCrossAxisCellSizes.length];
            horizontal.arrange(density, m6000getMaxWidthimpl, calculateCrossAxisCellSizes, layoutDirection, iArr);
