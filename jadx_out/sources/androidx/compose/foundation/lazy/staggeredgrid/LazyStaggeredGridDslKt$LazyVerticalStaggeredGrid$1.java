...
public final class LazyStaggeredGridDslKt$LazyVerticalStaggeredGrid$1 extends n0 implements p<Composer, Integer, r2> {
    ...
    public final void invoke(@m Composer composer, int i5) {
        LazyStaggeredGridDslKt.m740LazyVerticalStaggeredGridzadm560(this.$columns, this.$modifier, this.$state, this.$contentPadding, this.$reverseLayout, this.$verticalItemSpacing, this.$horizontalArrangement, this.$flingBehavior, this.$userScrollEnabled, this.$content, composer, RecomposeScopeImplKt.updateChangedFlags(this.$$changed | 1), this.$$default);
    }
}
