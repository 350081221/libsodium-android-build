...
public final class LazyStaggeredGridDslKt$items$10 extends n0 implements r<LazyStaggeredGridItemScope, Integer, Composer, Integer, r2> {
    final /* synthetic */ r<LazyStaggeredGridItemScope, T, Composer, Integer, r2> $itemContent;
    final /* synthetic */ T[] $items;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public LazyStaggeredGridDslKt$items$10(r<? super LazyStaggeredGridItemScope, ? super T, ? super Composer, ? super Integer, r2> rVar, T[] tArr) {
        super(4);
    ...
    public final void invoke(@l LazyStaggeredGridItemScope lazyStaggeredGridItemScope, int i5, @m Composer composer, int i6) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(2101296000, i7, -1, "androidx.compose.foundation.lazy.staggeredgrid.items.<anonymous> (LazyStaggeredGridDsl.kt:420)");
        }
        this.$itemContent.invoke(lazyStaggeredGridItemScope, this.$items[i5], composer, Integer.valueOf(i7 & 14));
        if (ComposerKt.isTraceInProgress()) {
