...
public final class LazyStaggeredGridSpanProvider {
    ...
    public LazyStaggeredGridSpanProvider(@l IntervalList<LazyStaggeredGridInterval> intervalList) {
    ...
    public final boolean isFullSpan(int i5) {
        boolean z4;
        if (i5 >= 0 && i5 < this.intervals.getSize()) {
            z4 = true;
        } else {
            z4 = false;
        }
        ...
        IntervalList.Interval<LazyStaggeredGridInterval> interval = this.intervals.get(i5);
        v3.l<Integer, StaggeredGridItemSpan> span = interval.getValue().getSpan();
