...
final class LazyStaggeredGridMeasureKt$measure$1$29 extends n0 implements l<Placeable.PlacementScope, r2> {
    ...
    public final void invoke2(@p4.l Placeable.PlacementScope placementScope) {
        ...
        for (int i5 = 0; i5 < size; i5++) {
            list.get(i5).place(placementScope, lazyStaggeredGridMeasureContext);
        }
        ObservableScopeInvalidator.m721attachToScopeimpl(this.$this_measure.getState().m761getPlacementScopeInvalidatorzYiylxw$foundation_release());
    }
}
