...
public final class LazyStaggeredGridDslKt$itemsIndexed$5 extends n0 implements r<LazyStaggeredGridItemScope, Integer, Composer, Integer, r2> {
    ...
    public final void invoke(@l LazyStaggeredGridItemScope lazyStaggeredGridItemScope, int i5, @m Composer composer, int i6) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(284833944, i7, -1, "androidx.compose.foundation.lazy.staggeredgrid.itemsIndexed.<anonymous> (LazyStaggeredGridDsl.kt:381)");
        }
        this.$itemContent.invoke(lazyStaggeredGridItemScope, Integer.valueOf(i5), this.$items.get(i5), composer, Integer.valueOf((i7 & 14) | (i7 & 112)));
        if (ComposerKt.isTraceInProgress()) {
