...
public final class LazyStaggeredGridState$scrollToItem$2 extends o implements p<ScrollScope, d<? super r2>, Object> {
    ...
    public LazyStaggeredGridState$scrollToItem$2(LazyStaggeredGridState lazyStaggeredGridState, int i5, int i6, d<? super LazyStaggeredGridState$scrollToItem$2> dVar) {
        super(2, dVar);
    ...
    public final Object invoke(@l ScrollScope scrollScope, @m d<? super r2> dVar) {
        return ((LazyStaggeredGridState$scrollToItem$2) create(scrollScope, dVar)).invokeSuspend(r2.f19517a);
    }
