...
final class LazyStaggeredGridDslKt$itemsIndexed$9$1 extends n0 implements l<Integer, StaggeredGridItemSpan> {
    ...
    public final StaggeredGridItemSpan invoke(int i5) {
        return this.$span.invoke(Integer.valueOf(i5), this.$items[i5]);
    }
