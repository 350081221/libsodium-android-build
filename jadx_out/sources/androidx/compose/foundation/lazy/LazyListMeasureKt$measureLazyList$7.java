...
final class LazyListMeasureKt$measureLazyList$7 extends n0 implements l<Placeable.PlacementScope, r2> {
    ...
    public LazyListMeasureKt$measureLazyList$7(List<LazyListMeasuredItem> list, LazyListMeasuredItem lazyListMeasuredItem, boolean z4, MutableState<r2> mutableState) {
        super(1);
