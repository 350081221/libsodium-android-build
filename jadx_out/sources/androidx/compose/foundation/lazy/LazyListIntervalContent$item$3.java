...
final class LazyListIntervalContent$item$3 extends n0 implements r<LazyItemScope, Integer, Composer, Integer, r2> {
    final /* synthetic */ q<LazyItemScope, Composer, Integer, r2> $content;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public LazyListIntervalContent$item$3(q<? super LazyItemScope, ? super Composer, ? super Integer, r2> qVar) {
        super(4);
        this.$content = qVar;
    }
    ...
    public final void invoke(@l LazyItemScope lazyItemScope, int i5, @m Composer composer, int i6) {
        ...
        this.$content.invoke(lazyItemScope, composer, Integer.valueOf(i6 & 14));
        if (ComposerKt.isTraceInProgress()) {
