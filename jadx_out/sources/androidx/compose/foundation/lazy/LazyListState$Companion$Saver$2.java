...
final class LazyListState$Companion$Saver$2 extends n0 implements l<List<? extends Integer>, LazyListState> {
    ...
    public final LazyListState invoke2(@p4.l List<Integer> list) {
