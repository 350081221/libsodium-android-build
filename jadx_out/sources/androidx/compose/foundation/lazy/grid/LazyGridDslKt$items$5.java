...
public final class LazyGridDslKt$items$5 extends n0 implements r<LazyGridItemScope, Integer, Composer, Integer, r2> {
    final /* synthetic */ r<LazyGridItemScope, T, Composer, Integer, r2> $itemContent;
    final /* synthetic */ List<T> $items;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public LazyGridDslKt$items$5(r<? super LazyGridItemScope, ? super T, ? super Composer, ? super Integer, r2> rVar, List<? extends T> list) {
        super(4);
    ...
    public final void invoke(@l LazyGridItemScope lazyGridItemScope, int i5, @m Composer composer, int i6) {
        ...
        this.$itemContent.invoke(lazyGridItemScope, this.$items.get(i5), composer, Integer.valueOf(i7 & 14));
        if (ComposerKt.isTraceInProgress()) {
