...
public final class LazyGridDslKt$items$8 extends n0 implements p<LazyGridItemSpanScope, Integer, GridItemSpan> {
    ...
    public /* bridge */ /* synthetic */ GridItemSpan invoke(LazyGridItemSpanScope lazyGridItemSpanScope, Integer num) {
        return GridItemSpan.m670boximpl(m680invoke_orMbw(lazyGridItemSpanScope, num.intValue()));
    }

    /* renamed from: invoke-_-orMbw, reason: not valid java name */
    public final long m680invoke_orMbw(@l LazyGridItemSpanScope lazyGridItemSpanScope, int i5) {
        return this.$span.invoke(lazyGridItemSpanScope, this.$items[i5]).m677unboximpl();
    }
}
