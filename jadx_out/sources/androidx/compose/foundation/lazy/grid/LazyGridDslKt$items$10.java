...
public final class LazyGridDslKt$items$10 extends n0 implements r<LazyGridItemScope, Integer, Composer, Integer, r2> {
    final /* synthetic */ r<LazyGridItemScope, T, Composer, Integer, r2> $itemContent;
    final /* synthetic */ T[] $items;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public LazyGridDslKt$items$10(r<? super LazyGridItemScope, ? super T, ? super Composer, ? super Integer, r2> rVar, T[] tArr) {
        super(4);
    ...
    public final void invoke(@l LazyGridItemScope lazyGridItemScope, int i5, @m Composer composer, int i6) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(407562193, i7, -1, "androidx.compose.foundation.lazy.grid.items.<anonymous> (LazyGridDsl.kt:527)");
        }
        this.$itemContent.invoke(lazyGridItemScope, this.$items[i5], composer, Integer.valueOf(i7 & 14));
        if (ComposerKt.isTraceInProgress()) {
