...
public interface LazyGridItemScope {
    ...
    static /* synthetic */ Modifier animateItemPlacement$default(LazyGridItemScope lazyGridItemScope, Modifier modifier, FiniteAnimationSpec finiteAnimationSpec, int i5, Object obj) {
        if (obj == null) {
            if ((i5 & 1) != 0) {
