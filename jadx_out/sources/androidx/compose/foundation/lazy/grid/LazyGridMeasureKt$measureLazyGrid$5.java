...
final class LazyGridMeasureKt$measureLazyGrid$5 extends n0 implements l<Placeable.PlacementScope, r2> {
    ...
    public LazyGridMeasureKt$measureLazyGrid$5(List<LazyGridMeasuredItem> list, MutableState<r2> mutableState) {
        super(1);
