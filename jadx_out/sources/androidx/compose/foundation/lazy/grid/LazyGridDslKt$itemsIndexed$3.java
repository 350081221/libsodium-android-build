...
public final class LazyGridDslKt$itemsIndexed$3 extends n0 implements p<LazyGridItemSpanScope, Integer, GridItemSpan> {
    ...
    public /* bridge */ /* synthetic */ GridItemSpan invoke(LazyGridItemSpanScope lazyGridItemSpanScope, Integer num) {
        return GridItemSpan.m670boximpl(m681invoke_orMbw(lazyGridItemSpanScope, num.intValue()));
    }

    /* renamed from: invoke-_-orMbw, reason: not valid java name */
    public final long m681invoke_orMbw(@l LazyGridItemSpanScope lazyGridItemSpanScope, int i5) {
        return this.$span.invoke(lazyGridItemSpanScope, Integer.valueOf(i5), this.$items.get(i5)).m677unboximpl();
    }
}
