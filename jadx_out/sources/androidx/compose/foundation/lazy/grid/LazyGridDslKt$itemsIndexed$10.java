...
public final class LazyGridDslKt$itemsIndexed$10 extends n0 implements r<LazyGridItemScope, Integer, Composer, Integer, r2> {
    final /* synthetic */ s<LazyGridItemScope, Integer, T, Composer, Integer, r2> $itemContent;
    final /* synthetic */ T[] $items;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public LazyGridDslKt$itemsIndexed$10(s<? super LazyGridItemScope, ? super Integer, ? super T, ? super Composer, ? super Integer, r2> sVar, T[] tArr) {
        super(4);
    ...
    public final void invoke(@l LazyGridItemScope lazyGridItemScope, int i5, @m Composer composer, int i6) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-911455938, i7, -1, "androidx.compose.foundation.lazy.grid.itemsIndexed.<anonymous> (LazyGridDsl.kt:560)");
        }
        this.$itemContent.invoke(lazyGridItemScope, Integer.valueOf(i5), this.$items[i5], composer, Integer.valueOf((i7 & 14) | (i7 & 112)));
        if (ComposerKt.isTraceInProgress()) {
