...
final class WrapContentElement$Companion$width$1 extends n0 implements p<IntSize, LayoutDirection, IntOffset> {
    ...
    public /* bridge */ /* synthetic */ IntOffset invoke(IntSize intSize, LayoutDirection layoutDirection) {
        return IntOffset.m6163boximpl(m657invoke5SAbXVA(intSize.m6218unboximpl(), layoutDirection));
    }

    /* renamed from: invoke-5SAbXVA, reason: not valid java name */
    public final long m657invoke5SAbXVA(long j5, @l LayoutDirection layoutDirection) {
        return IntOffsetKt.IntOffset(this.$align.align(0, IntSize.m6214getWidthimpl(j5), layoutDirection), 0);
    }
}
