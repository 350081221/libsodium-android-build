...
final class IntrinsicWidthNode extends IntrinsicSizeModifier {
    ...
    public IntrinsicWidthNode(@l IntrinsicSize intrinsicSize, boolean z4) {
    ...
    public long mo507calculateContentConstraintsl58MMJ0(@l MeasureScope measureScope, @l Measurable measurable, long j5) {
        ...
        if (this.width == IntrinsicSize.Min) {
            maxIntrinsicWidth = measurable.minIntrinsicWidth(Constraints.m5999getMaxHeightimpl(j5));
        } else {
            maxIntrinsicWidth = measurable.maxIntrinsicWidth(Constraints.m5999getMaxHeightimpl(j5));
        }
        if (maxIntrinsicWidth < 0) {
            maxIntrinsicWidth = 0;
        }
        return Constraints.Companion.m6010fixedWidthOenEA2s(maxIntrinsicWidth);
    }
    ...
    public final void setWidth(@l IntrinsicSize intrinsicSize) {
        this.width = intrinsicSize;
    }
}
