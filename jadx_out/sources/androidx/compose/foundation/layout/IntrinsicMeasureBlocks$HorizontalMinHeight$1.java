...
final class IntrinsicMeasureBlocks$HorizontalMinHeight$1 extends n0 implements q<List<? extends IntrinsicMeasurable>, Integer, Integer, Integer> {
    ...
    public final Integer invoke(@l List<? extends IntrinsicMeasurable> list, int i5, int i6) {
        int intrinsicSize;
        intrinsicSize = RowColumnImplKt.intrinsicSize(list, AnonymousClass1.INSTANCE, AnonymousClass2.INSTANCE, i5, i6, LayoutOrientation.Horizontal, LayoutOrientation.Vertical);
