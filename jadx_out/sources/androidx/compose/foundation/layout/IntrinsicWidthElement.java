...
final class IntrinsicWidthElement extends ModifierNodeElement<IntrinsicWidthNode> {
    ...
    public IntrinsicWidthElement(@l IntrinsicSize intrinsicSize, boolean z4, @l v3.l<? super InspectorInfo, r2> lVar) {
    ...
    public boolean equals(@m Object obj) {
        ...
        if (this.width == intrinsicWidthElement.width && this.enforceIncoming == intrinsicWidthElement.enforceIncoming) {
            return true;
        }
        return false;
    }
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public void update(@l IntrinsicWidthNode intrinsicWidthNode) {
