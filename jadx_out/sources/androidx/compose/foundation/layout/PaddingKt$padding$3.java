...
final class PaddingKt$padding$3 extends n0 implements l<InspectorInfo, r2> {
    final /* synthetic */ float $all;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public PaddingKt$padding$3(float f5) {
        super(1);
        this.$all = f5;
    }
    ...
    public final void invoke2(@p4.l InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.setValue(Dp.m6042boximpl(this.$all));
    }
}
