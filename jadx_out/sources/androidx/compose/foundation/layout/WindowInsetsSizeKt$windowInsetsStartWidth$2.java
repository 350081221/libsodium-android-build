...
final class WindowInsetsSizeKt$windowInsetsStartWidth$2 extends n0 implements q<WindowInsets, LayoutDirection, Density, Integer> {
    ...
    @Override // v3.q
    @l
    public final Integer invoke(@l WindowInsets windowInsets, @l LayoutDirection layoutDirection, @l Density density) {
        int right;
        if (layoutDirection == LayoutDirection.Ltr) {
            right = windowInsets.getLeft(density, layoutDirection);
        } else {
