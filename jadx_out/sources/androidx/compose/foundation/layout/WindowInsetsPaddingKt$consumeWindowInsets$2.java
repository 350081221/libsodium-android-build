...
public final class WindowInsetsPaddingKt$consumeWindowInsets$2 extends n0 implements q<Modifier, Composer, Integer, Modifier> {
    ...
    public final Modifier invoke(@l Modifier modifier, @m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(788931215, i5, -1, "androidx.compose.foundation.layout.consumeWindowInsets.<anonymous> (WindowInsetsPadding.kt:81)");
        }
