...
public final class BoxWithConstraintsKt$BoxWithConstraints$2 extends n0 implements p<Composer, Integer, r2> {
    ...
    public BoxWithConstraintsKt$BoxWithConstraints$2(Modifier modifier, Alignment alignment, boolean z4, q<? super BoxWithConstraintsScope, ? super Composer, ? super Integer, r2> qVar, int i5, int i6) {
        super(2);
