...
public final class SizeKt$requiredSizeInqDBjuR0$$inlined$debugInspectorInfo$1 extends n0 implements l<InspectorInfo, r2> {
    ...
    public SizeKt$requiredSizeInqDBjuR0$$inlined$debugInspectorInfo$1(float f5, float f6, float f7, float f8) {
        super(1);
    ...
    public final void invoke2(@p4.l InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("minWidth", Dp.m6042boximpl(this.$minWidth$inlined));
        inspectorInfo.getProperties().set("minHeight", Dp.m6042boximpl(this.$minHeight$inlined));
        inspectorInfo.getProperties().set("maxWidth", Dp.m6042boximpl(this.$maxWidth$inlined));
        inspectorInfo.getProperties().set("maxHeight", Dp.m6042boximpl(this.$maxHeight$inlined));
    }
}
