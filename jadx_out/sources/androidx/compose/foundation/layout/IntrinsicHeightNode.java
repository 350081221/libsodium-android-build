...
final class IntrinsicHeightNode extends IntrinsicSizeModifier {
    ...
    public IntrinsicHeightNode(@l IntrinsicSize intrinsicSize, boolean z4) {
    ...
    public long mo507calculateContentConstraintsl58MMJ0(@l MeasureScope measureScope, @l Measurable measurable, long j5) {
        int maxIntrinsicHeight;
        if (this.height == IntrinsicSize.Min) {
            maxIntrinsicHeight = measurable.minIntrinsicHeight(Constraints.m6000getMaxWidthimpl(j5));
        } else {
            maxIntrinsicHeight = measurable.maxIntrinsicHeight(Constraints.m6000getMaxWidthimpl(j5));
        }
        if (maxIntrinsicHeight < 0) {
            maxIntrinsicHeight = 0;
        }
        return Constraints.Companion.m6009fixedHeightOenEA2s(maxIntrinsicHeight);
    }
    ...
    public void setEnforceIncoming(boolean z4) {
        this.enforceIncoming = z4;
    }

    public final void setHeight(@l IntrinsicSize intrinsicSize) {
        this.height = intrinsicSize;
    }
}
