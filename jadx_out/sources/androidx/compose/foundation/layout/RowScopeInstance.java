...
public final class RowScopeInstance implements RowScope {
    ...
    @Stable
    @l
    public Modifier align(@l Modifier modifier, @l Alignment.Vertical vertical) {
    ...
    @Stable
    @l
    public Modifier alignBy(@l Modifier modifier, @l HorizontalAlignmentLine horizontalAlignmentLine) {
    ...
    @Stable
    @l
    public Modifier alignByBaseline(@l Modifier modifier) {
