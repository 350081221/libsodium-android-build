...
public final class SizeKt$widthInVpY3zN4$$inlined$debugInspectorInfo$1 extends n0 implements l<InspectorInfo, r2> {
    final /* synthetic */ float $max$inlined;
    final /* synthetic */ float $min$inlined;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SizeKt$widthInVpY3zN4$$inlined$debugInspectorInfo$1(float f5, float f6) {
        super(1);
        this.$min$inlined = f5;
        this.$max$inlined = f6;
    }
