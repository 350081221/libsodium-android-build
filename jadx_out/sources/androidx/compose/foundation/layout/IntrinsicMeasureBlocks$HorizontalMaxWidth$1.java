...
final class IntrinsicMeasureBlocks$HorizontalMaxWidth$1 extends n0 implements q<List<? extends IntrinsicMeasurable>, Integer, Integer, Integer> {
    ...
    public final Integer invoke(@l List<? extends IntrinsicMeasurable> list, int i5, int i6) {
        ...
        intrinsicSize = RowColumnImplKt.intrinsicSize(list, anonymousClass1, anonymousClass2, i5, i6, layoutOrientation, layoutOrientation);
