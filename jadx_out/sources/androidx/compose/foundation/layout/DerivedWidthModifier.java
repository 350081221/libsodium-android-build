...
final class DerivedWidthModifier extends InspectorValueInfo implements LayoutModifier, ModifierLocalConsumer {
    ...
    public DerivedWidthModifier(@l WindowInsets windowInsets, @l v3.l<? super InspectorInfo, r2> lVar, @l q<? super WindowInsets, ? super LayoutDirection, ? super Density, Integer> qVar) {
        super(lVar);
    ...
    public boolean equals(@m Object obj) {
        ...
        if (l0.g(this.insets, derivedWidthModifier.insets) && l0.g(this.widthCalc, derivedWidthModifier.widthCalc)) {
            return true;
        }
        return false;
    }
    ...
    public MeasureResult mo56measure3p2s80s(@l MeasureScope measureScope, @l Measurable measurable, long j5) {
        ...
        if (intValue == 0) {
            return MeasureScope.layout$default(measureScope, 0, 0, null, DerivedWidthModifier$measure$1.INSTANCE, 4, null);
        }
        Placeable mo4998measureBRTryo0 = measurable.mo4998measureBRTryo0(Constraints.m5991copyZbe2FdA$default(j5, intValue, intValue, 0, 0, 12, null));
        return MeasureScope.layout$default(measureScope, intValue, mo4998measureBRTryo0.getHeight(), null, new DerivedWidthModifier$measure$2(mo4998measureBRTryo0), 4, null);
    }
