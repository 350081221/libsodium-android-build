...
public final class AlignmentLineKt$paddingFromY_r0B1c$$inlined$debugInspectorInfo$1 extends n0 implements l<InspectorInfo, r2> {
    ...
    public AlignmentLineKt$paddingFromY_r0B1c$$inlined$debugInspectorInfo$1(AlignmentLine alignmentLine, long j5, long j6) {
        super(1);
    ...
    public final void invoke2(@p4.l InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("before", TextUnit.m6225boximpl(this.$before$inlined));
        inspectorInfo.getProperties().set("after", TextUnit.m6225boximpl(this.$after$inlined));
    }
}
