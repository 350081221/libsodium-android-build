...
public final class SliderKt$rangeSliderEndThumbSemantics$1 extends kotlin.jvm.internal.n0 implements v3.l<SemanticsPropertyReceiver, r2> {
    ...
    public static final class AnonymousClass1 extends kotlin.jvm.internal.n0 implements v3.l<Float, Boolean> {
        ...
        public final Boolean invoke(float f5) {
            ...
            if (this.$state.getEndSteps$material3_release() > 0 && (endSteps$material3_release = this.$state.getEndSteps$material3_release() + 1) >= 0) {
                ...
                int i5 = 0;
                while (true) {
                    float lerp = MathHelpersKt.lerp(this.$valueRange.getStart().floatValue(), this.$valueRange.getEndInclusive().floatValue(), i5 / (this.$state.getEndSteps$material3_release() + 1));
                    float f8 = lerp - H;
                    if (Math.abs(f8) <= f6) {
                        f6 = Math.abs(f8);
                        f7 = lerp;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SliderKt$rangeSliderEndThumbSemantics$1(boolean z4, kotlin.ranges.f<Float> fVar, RangeSliderState rangeSliderState) {
        super(1);
        this.$enabled = z4;
        this.$valueRange = fVar;
        this.$state = rangeSliderState;
