...
public final class NavigationBarDefaults {
    ...
    private static final float Elevation = NavigationBarTokens.INSTANCE.m2949getContainerElevationD9Ej5fM();
    ...
    public final long getContainerColor(@p4.m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1528098623, i5, -1, "androidx.compose.material3.NavigationBarDefaults.<get-containerColor> (NavigationBar.kt:278)");
        }
    ...
    public final float m2005getElevationD9Ej5fM() {
        return Elevation;
    }
    ...
    public final WindowInsets getWindowInsets(@p4.m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1938678202, i5, -1, "androidx.compose.material3.NavigationBarDefaults.<get-windowInsets> (NavigationBar.kt:285)");
        }
