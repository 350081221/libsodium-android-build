...
final class CheckboxKt$CheckboxImpl$checkCenterGravitationShiftFraction$1 extends kotlin.jvm.internal.n0 implements v3.q<Transition.Segment<ToggleableState>, Composer, Integer, FiniteAnimationSpec<Float>> {
    ...
    public final FiniteAnimationSpec<Float> invoke(@p4.l Transition.Segment<ToggleableState> segment, @p4.m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1324481169, i5, -1, "androidx.compose.material3.CheckboxImpl.<anonymous> (Checkbox.kt:283)");
        }
