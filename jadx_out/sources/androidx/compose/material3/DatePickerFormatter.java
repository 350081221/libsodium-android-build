...
public interface DatePickerFormatter {
    static /* synthetic */ String formatDate$default(DatePickerFormatter datePickerFormatter, Long l5, Locale locale, boolean z4, int i5, Object obj) {
        if (obj != null) {
        ...
        return datePickerFormatter.formatDate(l5, locale, z4);
    }

    @p4.m
    String formatDate(@p4.m Long l5, @p4.l Locale locale, boolean z4);

    @p4.m
    String formatMonthYear(@p4.m Long l5, @p4.l Locale locale);
}
