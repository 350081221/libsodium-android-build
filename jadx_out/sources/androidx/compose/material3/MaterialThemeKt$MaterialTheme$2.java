...
public final class MaterialThemeKt$MaterialTheme$2 extends kotlin.jvm.internal.n0 implements v3.p<Composer, Integer, r2> {
    ...
    public MaterialThemeKt$MaterialTheme$2(ColorScheme colorScheme, Shapes shapes, Typography typography, v3.p<? super Composer, ? super Integer, r2> pVar, int i5, int i6) {
        super(2);
