...
public final class CheckboxKt$Checkbox$3 extends kotlin.jvm.internal.n0 implements v3.p<Composer, Integer, r2> {
    ...
    public CheckboxKt$Checkbox$3(boolean z4, v3.l<? super Boolean, r2> lVar, Modifier modifier, boolean z5, CheckboxColors checkboxColors, MutableInteractionSource mutableInteractionSource, int i5, int i6) {
        super(2);
        this.$checked = z4;
