...
public final class TooltipKt$animateTooltip$2$alpha$2 extends kotlin.jvm.internal.n0 implements v3.q<Transition.Segment<Boolean>, Composer, Integer, FiniteAnimationSpec<Float>> {
    ...
    public final FiniteAnimationSpec<Float> invoke(@p4.l Transition.Segment<Boolean> segment, @p4.m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-281714272, i5, -1, "androidx.compose.material3.animateTooltip.<anonymous>.<anonymous> (Tooltip.kt:676)");
        }
