...
public final class DatePickerKt$Year$2 extends kotlin.jvm.internal.n0 implements v3.p<Composer, Integer, r2> {
    final /* synthetic */ v3.p<Composer, Integer, r2> $content;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public DatePickerKt$Year$2(v3.p<? super Composer, ? super Integer, r2> pVar) {
        super(2);
        this.$content = pVar;
    }
    ...
    public final void invoke(@p4.m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1573188346, i5, -1, "androidx.compose.material3.Year.<anonymous> (DatePicker.kt:2117)");
        }
