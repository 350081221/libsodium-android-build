...
final class ComposableSingletons$ScaffoldKt$lambda4$1 extends kotlin.jvm.internal.n0 implements v3.p<Composer, Integer, r2> {
    ...
    public final void invoke(@p4.m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1545895435, i5, -1, "androidx.compose.material3.ComposableSingletons$ScaffoldKt.lambda-4.<anonymous> (Scaffold.kt:90)");
        }
        if (ComposerKt.isTraceInProgress()) {
