...
final class ComposableSingletons$TimePickerKt$lambda1$1 extends kotlin.jvm.internal.n0 implements v3.q<RowScope, Composer, Integer, r2> {
    ...
    public final void invoke(@p4.l RowScope rowScope, @p4.m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1425358052, i5, -1, "androidx.compose.material3.ComposableSingletons$TimePickerKt.lambda-1.<anonymous> (TimePicker.kt:1118)");
        }
        Strings.Companion companion = Strings.Companion;
        TextKt.m2452Text4IGK_g(Strings_androidKt.m2294getStringNWtq28(Strings.m2225constructorimpl(R.string.m3c_time_picker_am), composer, 0), (Modifier) null, 0L, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (v3.l<? super TextLayoutResult, r2>) null, (TextStyle) null, composer, 0, 0, 131070);
        if (ComposerKt.isTraceInProgress()) {
