...
public final class SearchBar_androidKt$SearchBarInputField$5$2$1 extends kotlin.jvm.internal.n0 implements v3.p<Composer, Integer, r2> {
    final /* synthetic */ v3.p<Composer, Integer, r2> $trailing;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public SearchBar_androidKt$SearchBarInputField$5$2$1(v3.p<? super Composer, ? super Integer, r2> pVar) {
        super(2);
        this.$trailing = pVar;
    }
    ...
    public final void invoke(@p4.m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1558904811, i5, -1, "androidx.compose.material3.SearchBarInputField.<anonymous>.<anonymous>.<anonymous> (SearchBar.android.kt:490)");
        }
        Modifier.Companion companion = Modifier.Companion;
        f5 = SearchBar_androidKt.SearchBarIconOffsetX;
        Modifier m514offsetVpY3zN4$default = OffsetKt.m514offsetVpY3zN4$default(companion, Dp.m6044constructorimpl(-f5), 0.0f, 2, null);
        v3.p<Composer, Integer, r2> pVar = this.$trailing;
