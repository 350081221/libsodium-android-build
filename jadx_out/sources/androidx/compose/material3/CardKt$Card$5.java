...
public final class CardKt$Card$5 extends kotlin.jvm.internal.n0 implements v3.p<Composer, Integer, r2> {
    ...
    public CardKt$Card$5(v3.a<r2> aVar, Modifier modifier, boolean z4, Shape shape, CardColors cardColors, CardElevation cardElevation, BorderStroke borderStroke, MutableInteractionSource mutableInteractionSource, v3.q<? super ColumnScope, ? super Composer, ? super Integer, r2> qVar, int i5, int i6) {
        super(2);
        this.$onClick = aVar;
