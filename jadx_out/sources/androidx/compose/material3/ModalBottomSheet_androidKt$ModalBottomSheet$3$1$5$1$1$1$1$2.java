...
final class ModalBottomSheet_androidKt$ModalBottomSheet$3$1$5$1$1$1$1$2 extends kotlin.jvm.internal.n0 implements v3.a<Boolean> {
    final /* synthetic */ s0 $scope;
    final /* synthetic */ SheetState $sheetState;
    final /* synthetic */ SheetState $this_with;

    /* JADX INFO: Access modifiers changed from: package-private */
    @kotlin.coroutines.jvm.internal.f(c = "androidx.compose.material3.ModalBottomSheet_androidKt$ModalBottomSheet$3$1$5$1$1$1$1$2$1", f = "ModalBottomSheet.android.kt", i = {}, l = {Opcodes.CONST_METHOD_HANDLE}, m = "invokeSuspend", n = {}, s = {})
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ModalBottomSheet_androidKt$ModalBottomSheet$3$1$5$1$1$1$1$2(SheetState sheetState, s0 s0Var, SheetState sheetState2) {
        super(0);
    ...
    public final Boolean invoke() {
        if (this.$this_with.getAnchoredDraggableState$material3_release().getConfirmValueChange$material3_release().invoke(SheetValue.Expanded).booleanValue()) {
