...
public final class TimePickerKt$TimeSelector$3 extends kotlin.jvm.internal.n0 implements v3.p<Composer, Integer, r2> {
    ...
    public TimePickerKt$TimeSelector$3(int i5, TimePickerState timePickerState, int i6, long j5) {
        super(2);
        this.$selection = i5;
    ...
    public final void invoke(@p4.m Composer composer, int i5) {
        ...
        String m2486numberContentDescriptionYKJpE6Y = TimePickerKt.m2486numberContentDescriptionYKJpE6Y(this.$selection, this.$state.is24hour(), this.$value, composer, 0);
        ...
        boolean changed = composer.changed(m2486numberContentDescriptionYKJpE6Y);
        Object rememberedValue = composer.rememberedValue();
        if (changed || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = new TimePickerKt$TimeSelector$3$1$1$1(m2486numberContentDescriptionYKJpE6Y);
            composer.updateRememberedValue(rememberedValue);
        }
        composer.endReplaceableGroup();
        TextKt.m2452Text4IGK_g(ActualJvm_jvmKt.toLocalString$default(i6, 2, 0, false, 6, null), SemanticsModifierKt.semantics$default(companion, false, (v3.l) rememberedValue, 1, null), j5, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (v3.l<? super TextLayoutResult, r2>) null, (TextStyle) null, composer, 0, 0, 131064);
        composer.endReplaceableGroup();
        composer.endNode();
        composer.endReplaceableGroup();
        composer.endReplaceableGroup();
