...
final class NavigationRailKt$placeIcon$1 extends kotlin.jvm.internal.n0 implements v3.l<Placeable.PlacementScope, r2> {
    ...
    public NavigationRailKt$placeIcon$1(Placeable placeable, Placeable placeable2, int i5, int i6, Placeable placeable3, int i7, int i8, int i9, int i10) {
        super(1);
