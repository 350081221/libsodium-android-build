...
final class SwitchKt$Switch$2$1 extends kotlin.jvm.internal.n0 implements v3.a<r2> {
    final /* synthetic */ float $minBound;
    final /* synthetic */ Animatable<Float, AnimationVector1D> $offset;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SwitchKt$Switch$2$1(Animatable<Float, AnimationVector1D> animatable, float f5) {
        super(0);
