...
public final class NavigationBarKt$NavigationBarItemLayout$3 extends kotlin.jvm.internal.n0 implements v3.p<Composer, Integer, r2> {
    ...
    public NavigationBarKt$NavigationBarItemLayout$3(v3.p<? super Composer, ? super Integer, r2> pVar, v3.p<? super Composer, ? super Integer, r2> pVar2, v3.p<? super Composer, ? super Integer, r2> pVar3, v3.p<? super Composer, ? super Integer, r2> pVar4, boolean z4, v3.a<Float> aVar, int i5) {
        super(2);
