...
public final class SliderDefaults$Track$3$1 extends kotlin.jvm.internal.n0 implements v3.l<DrawScope, r2> {
    ...
    public SliderDefaults$Track$3$1(SliderState sliderState, long j5, long j6, long j7, long j8) {
        super(1);
    ...
    public final void invoke2(@p4.l DrawScope drawScope) {
        SliderDefaults.INSTANCE.m2194drawTrackLUBghH0(drawScope, this.$sliderState.getTickFractions$material3_release(), 0.0f, this.$sliderState.getCoercedValueAsFraction$material3_release(), this.$inactiveTrackColor, this.$activeTrackColor, this.$inactiveTickColor, this.$activeTickColor);
    }
}
