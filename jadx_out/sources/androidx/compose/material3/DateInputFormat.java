...
public final class DateInputFormat {
    ...
    public DateInputFormat(@p4.l String str, char c5) {
        String i22;
        this.patternWithDelimiters = str;
        this.delimiter = c5;
        i22 = kotlin.text.e0.i2(str, String.valueOf(c5), "", false, 4, null);
        this.patternWithoutDelimiters = i22;
    }

    public static /* synthetic */ DateInputFormat copy$default(DateInputFormat dateInputFormat, String str, char c5, int i5, Object obj) {
        if ((i5 & 1) != 0) {
            str = dateInputFormat.patternWithDelimiters;
        }
        if ((i5 & 2) != 0) {
            c5 = dateInputFormat.delimiter;
        }
        return dateInputFormat.copy(str, c5);
    }
    ...
    @p4.l
    public final DateInputFormat copy(@p4.l String str, char c5) {
        return new DateInputFormat(str, c5);
    }
    ...
    public boolean equals(@p4.m Object obj) {
        ...
        return kotlin.jvm.internal.l0.g(this.patternWithDelimiters, dateInputFormat.patternWithDelimiters) && this.delimiter == dateInputFormat.delimiter;
    }
