...
final class TabRowKt$ScrollableTabRow$1 extends kotlin.jvm.internal.n0 implements v3.q<List<? extends TabPosition>, Composer, Integer, r2> {
    ...
    public final void invoke(@p4.l List<TabPosition> list, @p4.m Composer composer, int i5) {
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-913748678, i5, -1, "androidx.compose.material3.ScrollableTabRow.<anonymous> (TabRow.kt:820)");
        }
