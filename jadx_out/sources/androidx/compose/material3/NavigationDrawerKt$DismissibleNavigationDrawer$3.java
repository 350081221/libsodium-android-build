...
public final class NavigationDrawerKt$DismissibleNavigationDrawer$3 extends kotlin.jvm.internal.n0 implements v3.p<Composer, Integer, r2> {
    ...
    public NavigationDrawerKt$DismissibleNavigationDrawer$3(v3.p<? super Composer, ? super Integer, r2> pVar, Modifier modifier, DrawerState drawerState, boolean z4, v3.p<? super Composer, ? super Integer, r2> pVar2, int i5, int i6) {
        super(2);
