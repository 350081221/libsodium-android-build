...
public final class TextFieldDefaults$TextFieldDecorationBox$2 extends kotlin.jvm.internal.n0 implements v3.p<Composer, Integer, r2> {
    ...
    public TextFieldDefaults$TextFieldDecorationBox$2(TextFieldDefaults textFieldDefaults, String str, v3.p<? super Composer, ? super Integer, r2> pVar, boolean z4, boolean z5, VisualTransformation visualTransformation, InteractionSource interactionSource, boolean z6, v3.p<? super Composer, ? super Integer, r2> pVar2, v3.p<? super Composer, ? super Integer, r2> pVar3, v3.p<? super Composer, ? super Integer, r2> pVar4, v3.p<? super Composer, ? super Integer, r2> pVar5, v3.p<? super Composer, ? super Integer, r2> pVar6, v3.p<? super Composer, ? super Integer, r2> pVar7, v3.p<? super Composer, ? super Integer, r2> pVar8, Shape shape, TextFieldColors textFieldColors, PaddingValues paddingValues, v3.p<? super Composer, ? super Integer, r2> pVar9, int i5, int i6, int i7) {
        super(2);
