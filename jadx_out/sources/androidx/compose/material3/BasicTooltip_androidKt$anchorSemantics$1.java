...
public final class BasicTooltip_androidKt$anchorSemantics$1 extends kotlin.jvm.internal.n0 implements v3.l<SemanticsPropertyReceiver, r2> {
    ...
    public static final class AnonymousClass1 extends kotlin.jvm.internal.n0 implements v3.a<Boolean> {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        @kotlin.coroutines.jvm.internal.f(c = "androidx.compose.material3.BasicTooltip_androidKt$anchorSemantics$1$1$1", f = "BasicTooltip.android.kt", i = {}, l = {Opcodes.DIV_INT_LIT8}, m = "invokeSuspend", n = {}, s = {})
        ...
        /* loaded from: classes.dex */
        public static final class C00551 extends kotlin.coroutines.jvm.internal.o implements v3.p<s0, kotlin.coroutines.d<? super r2>, Object> {
            final /* synthetic */ BasicTooltipState $state;
            int label;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C00551(BasicTooltipState basicTooltipState, kotlin.coroutines.d<? super C00551> dVar) {
                super(2, dVar);
            ...
            public final kotlin.coroutines.d<r2> create(@p4.m Object obj, @p4.l kotlin.coroutines.d<?> dVar) {
                return new C00551(this.$state, dVar);
            }

            @Override // v3.p
            @p4.m
            public final Object invoke(@p4.l s0 s0Var, @p4.m kotlin.coroutines.d<? super r2> dVar) {
                return ((C00551) create(s0Var, dVar)).invokeSuspend(r2.f19517a);
            }
        ...
        public final Boolean invoke() {
            kotlinx.coroutines.k.f(this.$scope, null, null, new C00551(this.$state, null), 3, null);
            return Boolean.TRUE;
        }
    }
