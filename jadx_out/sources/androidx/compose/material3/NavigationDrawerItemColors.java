...
public interface NavigationDrawerItemColors {
    @p4.l
    @Composable
    State<Color> badgeColor(boolean z4, @p4.m Composer composer, int i5);

    @p4.l
    @Composable
    State<Color> containerColor(boolean z4, @p4.m Composer composer, int i5);

    @p4.l
    @Composable
    State<Color> iconColor(boolean z4, @p4.m Composer composer, int i5);

    @p4.l
    @Composable
    State<Color> textColor(boolean z4, @p4.m Composer composer, int i5);
}
