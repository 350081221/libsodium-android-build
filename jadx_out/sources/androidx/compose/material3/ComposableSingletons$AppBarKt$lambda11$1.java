...
final class ComposableSingletons$AppBarKt$lambda11$1 extends kotlin.jvm.internal.n0 implements v3.p<Composer, Integer, r2> {
    ...
    public final void invoke(@p4.m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-2107138081, i5, -1, "androidx.compose.material3.ComposableSingletons$AppBarKt.lambda-11.<anonymous> (AppBar.kt:1850)");
        }
        if (ComposerKt.isTraceInProgress()) {
