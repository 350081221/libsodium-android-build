...
final class NavigationBarKt$NavigationBarItemLayout$1$2$1 extends kotlin.jvm.internal.n0 implements v3.l<GraphicsLayerScope, r2> {
    final /* synthetic */ boolean $alwaysShowLabel;
    final /* synthetic */ v3.a<Float> $animationProgress;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public NavigationBarKt$NavigationBarItemLayout$1$2$1(boolean z4, v3.a<Float> aVar) {
        super(1);
