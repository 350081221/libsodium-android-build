...
public final class SnackbarKt$Snackbar$1 extends kotlin.jvm.internal.n0 implements v3.p<Composer, Integer, r2> {
    ...
    public static final class AnonymousClass1 extends kotlin.jvm.internal.n0 implements v3.p<Composer, Integer, r2> {
        ...
        AnonymousClass1(v3.p<? super Composer, ? super Integer, r2> pVar, v3.p<? super Composer, ? super Integer, r2> pVar2, v3.p<? super Composer, ? super Integer, r2> pVar3, TextStyle textStyle, long j5, long j6, boolean z4) {
            super(2);
            this.$action = pVar;
            this.$content = pVar2;
        ...
        public final void invoke(@p4.m Composer composer, int i5) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(835891690, i5, -1, "androidx.compose.material3.Snackbar.<anonymous>.<anonymous> (Snackbar.kt:118)");
            }
            if (this.$action == null) {
                composer.startReplaceableGroup(-2104362406);
                SnackbarKt.m2219OneRowSnackbarkKq0p4A(this.$content, null, this.$dismissAction, this.$actionTextStyle, this.$actionContentColor, this.$dismissActionContentColor, composer, 48);
                composer.endReplaceableGroup();
            } else if (this.$actionOnNewLine) {
                composer.startReplaceableGroup(-2104362092);
                SnackbarKt.m2218NewLineButtonSnackbarkKq0p4A(this.$content, this.$action, this.$dismissAction, this.$actionTextStyle, this.$actionContentColor, this.$dismissActionContentColor, composer, 0);
                composer.endReplaceableGroup();
            } else {
                composer.startReplaceableGroup(-2104361812);
                SnackbarKt.m2219OneRowSnackbarkKq0p4A(this.$content, this.$action, this.$dismissAction, this.$actionTextStyle, this.$actionContentColor, this.$dismissActionContentColor, composer, 0);
                composer.endReplaceableGroup();
            }
            if (ComposerKt.isTraceInProgress()) {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public SnackbarKt$Snackbar$1(v3.p<? super Composer, ? super Integer, r2> pVar, v3.p<? super Composer, ? super Integer, r2> pVar2, v3.p<? super Composer, ? super Integer, r2> pVar3, long j5, long j6, boolean z4) {
        super(2);
        this.$action = pVar;
        this.$content = pVar2;
        this.$dismissAction = pVar3;
    ...
    public final void invoke(@p4.m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1829663446, i5, -1, "androidx.compose.material3.Snackbar.<anonymous> (Snackbar.kt:115)");
        }
