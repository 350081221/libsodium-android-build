...
public final class ButtonKt$FilledTonalButton$2 extends kotlin.jvm.internal.n0 implements v3.p<Composer, Integer, r2> {
    ...
    public ButtonKt$FilledTonalButton$2(v3.a<r2> aVar, Modifier modifier, boolean z4, Shape shape, ButtonColors buttonColors, ButtonElevation buttonElevation, BorderStroke borderStroke, PaddingValues paddingValues, MutableInteractionSource mutableInteractionSource, v3.q<? super RowScope, ? super Composer, ? super Integer, r2> qVar, int i5, int i6) {
        super(2);
        this.$onClick = aVar;
