...
public final class ProgressIndicatorKt$LinearProgressIndicator$2$1 extends kotlin.jvm.internal.n0 implements v3.l<DrawScope, r2> {
    ...
    public ProgressIndicatorKt$LinearProgressIndicator$2$1(long j5, int i5, v3.a<Float> aVar, long j6) {
        super(1);
        this.$trackColor = j5;
        this.$strokeCap = i5;
    ...
    public final void invoke2(@p4.l DrawScope drawScope) {
        ...
        ProgressIndicatorKt.m2088drawLinearIndicatorqYKTg0g(drawScope, 0.0f, this.$coercedProgress.invoke().floatValue(), this.$color, m3559getHeightimpl, this.$strokeCap);
    }
}
