...
final class BottomSheetScaffoldKt$StandardBottomSheet$3$1$1$1$1$2 extends kotlin.jvm.internal.n0 implements v3.a<Boolean> {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public BottomSheetScaffoldKt$StandardBottomSheet$3$1$1$1$1$2(s0 s0Var, SheetState sheetState) {
        super(0);
        this.$scope = s0Var;
        this.$this_with = sheetState;
    }
