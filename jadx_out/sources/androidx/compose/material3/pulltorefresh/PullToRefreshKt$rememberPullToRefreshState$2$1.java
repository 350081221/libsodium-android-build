...
final class PullToRefreshKt$rememberPullToRefreshState$2$1 extends n0 implements a<PullToRefreshState> {
    final /* synthetic */ a<Boolean> $enabled;
    final /* synthetic */ float $positionalThresholdPx;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public PullToRefreshKt$rememberPullToRefreshState$2$1(float f5, a<Boolean> aVar) {
        super(0);
        this.$positionalThresholdPx = f5;
        this.$enabled = aVar;
    }
