...
public final class ChipKt$SuggestionChip$2 extends kotlin.jvm.internal.n0 implements v3.p<Composer, Integer, r2> {
    ...
    public ChipKt$SuggestionChip$2(v3.a<r2> aVar, v3.p<? super Composer, ? super Integer, r2> pVar, Modifier modifier, boolean z4, v3.p<? super Composer, ? super Integer, r2> pVar2, Shape shape, ChipColors chipColors, ChipElevation chipElevation, BorderStroke borderStroke, MutableInteractionSource mutableInteractionSource, int i5, int i6) {
        super(2);
        this.$onClick = aVar;
        this.$label = pVar;
