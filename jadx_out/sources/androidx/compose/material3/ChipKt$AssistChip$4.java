...
public final class ChipKt$AssistChip$4 extends kotlin.jvm.internal.n0 implements v3.p<Composer, Integer, r2> {
    ...
    public ChipKt$AssistChip$4(v3.a<r2> aVar, v3.p<? super Composer, ? super Integer, r2> pVar, Modifier modifier, boolean z4, v3.p<? super Composer, ? super Integer, r2> pVar2, v3.p<? super Composer, ? super Integer, r2> pVar3, Shape shape, ChipColors chipColors, ChipElevation chipElevation, ChipBorder chipBorder, MutableInteractionSource mutableInteractionSource, int i5, int i6, int i7) {
        super(2);
        this.$onClick = aVar;
        this.$label = pVar;
