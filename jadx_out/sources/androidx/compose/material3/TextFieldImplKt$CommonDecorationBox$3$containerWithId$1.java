...
public final class TextFieldImplKt$CommonDecorationBox$3$containerWithId$1 extends kotlin.jvm.internal.n0 implements v3.p<Composer, Integer, r2> {
    final /* synthetic */ v3.p<Composer, Integer, r2> $container;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public TextFieldImplKt$CommonDecorationBox$3$containerWithId$1(v3.p<? super Composer, ? super Integer, r2> pVar) {
        super(2);
        this.$container = pVar;
    }
    ...
    public final void invoke(@p4.m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-2124779163, i5, -1, "androidx.compose.material3.CommonDecorationBox.<anonymous>.<anonymous> (TextFieldImpl.kt:198)");
        }
        Modifier layoutId = LayoutIdKt.layoutId(Modifier.Companion, TextFieldImplKt.ContainerId);
        v3.p<Composer, Integer, r2> pVar = this.$container;
        ...
        v3.q<SkippableUpdater<ComposeUiNode>, Composer, Integer, r2> modifierMaterializerOf = LayoutKt.modifierMaterializerOf(layoutId);
