...
public final class TextFieldTransitionScope$Transition$prefixSuffixOpacity$2 extends kotlin.jvm.internal.n0 implements v3.q<Transition.Segment<InputPhase>, Composer, Integer, FiniteAnimationSpec<Float>> {
    ...
    public final FiniteAnimationSpec<Float> invoke(@p4.l Transition.Segment<InputPhase> segment, @p4.m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1189967029, i5, -1, "androidx.compose.material3.TextFieldTransitionScope.Transition.<anonymous> (TextFieldImpl.kt:356)");
        }
