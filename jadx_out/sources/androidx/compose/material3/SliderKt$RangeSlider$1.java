...
public final class SliderKt$RangeSlider$1 extends kotlin.jvm.internal.n0 implements v3.q<RangeSliderState, Composer, Integer, r2> {
    ...
    public SliderKt$RangeSlider$1(MutableInteractionSource mutableInteractionSource, SliderColors sliderColors, boolean z4) {
        super(3);
    ...
    public final void invoke(@p4.l RangeSliderState rangeSliderState, @p4.m Composer composer, int i5) {
        ...
        SliderDefaults.INSTANCE.m2195Thumb9LiSoMs(this.$startInteractionSource, null, this.$colors, this.$enabled, 0L, composer, 196614, 18);
        if (ComposerKt.isTraceInProgress()) {
