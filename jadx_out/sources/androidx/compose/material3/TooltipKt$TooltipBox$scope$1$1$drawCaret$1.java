...
final class TooltipKt$TooltipBox$scope$1$1$drawCaret$1 extends kotlin.jvm.internal.n0 implements v3.l<CacheDrawScope, DrawResult> {
    ...
    public TooltipKt$TooltipBox$scope$1$1$drawCaret$1(v3.p<? super CacheDrawScope, ? super LayoutCoordinates, DrawResult> pVar, MutableState<LayoutCoordinates> mutableState) {
        super(1);
        this.$draw = pVar;
    ...
    public final DrawResult invoke(@p4.l CacheDrawScope cacheDrawScope) {
        ...
        return pVar.invoke(cacheDrawScope, TooltipBox$lambda$1);
    }
}
