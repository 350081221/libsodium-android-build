...
public final class TextFieldImplKt$CommonDecorationBox$3$decoratedSuffix$1 extends kotlin.jvm.internal.n0 implements v3.p<Composer, Integer, r2> {
    ...
    public TextFieldImplKt$CommonDecorationBox$3$decoratedSuffix$1(float f5, long j5, TextStyle textStyle, v3.p<? super Composer, ? super Integer, r2> pVar) {
        super(2);
    ...
    public final void invoke(@p4.m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(907456412, i5, -1, "androidx.compose.material3.CommonDecorationBox.<anonymous>.<anonymous> (TextFieldImpl.kt:163)");
        }
        Modifier alpha = AlphaKt.alpha(Modifier.Companion, this.$prefixSuffixAlphaProgress);
        long j5 = this.$suffixColor;
        TextStyle textStyle = this.$bodyLarge;
        v3.p<Composer, Integer, r2> pVar = this.$suffix;
