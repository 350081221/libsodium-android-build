...
public final class SnapFlingBehavior$animateDecay$2 extends kotlin.jvm.internal.n0 implements v3.l<AnimationScope<Float, AnimationVector1D>, r2> {
    ...
    public SnapFlingBehavior$animateDecay$2(float f5, SnapFlingBehavior snapFlingBehavior, k1.e eVar, ScrollScope scrollScope) {
        super(1);
    ...
    public final void invoke2(@p4.l AnimationScope<Float, AnimationVector1D> animationScope) {
        ...
        if (Math.abs(animationScope.getValue().floatValue()) >= Math.abs(this.$targetOffset)) {
            ...
            SnapFlingBehavior.animateDecay$consumeDelta(animationScope, this.$this_animateDecay, coerceToTarget - this.$previousValue.element);
