...
final class TabKt$Tab$5 extends kotlin.jvm.internal.n0 implements v3.p<Composer, Integer, r2> {
    ...
    public TabKt$Tab$5(Modifier modifier, boolean z4, MutableInteractionSource mutableInteractionSource, Indication indication, boolean z5, v3.a<r2> aVar, v3.q<? super ColumnScope, ? super Composer, ? super Integer, r2> qVar) {
        super(2);
