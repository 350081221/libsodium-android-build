...
public final class TextFieldKt$TextField$8 extends kotlin.jvm.internal.n0 implements v3.p<Composer, Integer, r2> {
    ...
    public TextFieldKt$TextField$8(String str, v3.l<? super String, r2> lVar, Modifier modifier, boolean z4, boolean z5, TextStyle textStyle, v3.p<? super Composer, ? super Integer, r2> pVar, v3.p<? super Composer, ? super Integer, r2> pVar2, v3.p<? super Composer, ? super Integer, r2> pVar3, v3.p<? super Composer, ? super Integer, r2> pVar4, v3.p<? super Composer, ? super Integer, r2> pVar5, boolean z6, VisualTransformation visualTransformation, KeyboardOptions keyboardOptions, KeyboardActions keyboardActions, boolean z7, int i5, int i6, MutableInteractionSource mutableInteractionSource, Shape shape, TextFieldColors textFieldColors, int i7, int i8, int i9, int i10) {
        super(2);
        this.$value = str;
