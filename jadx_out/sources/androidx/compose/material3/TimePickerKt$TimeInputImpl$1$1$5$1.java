...
final class TimePickerKt$TimeInputImpl$1$1$5$1 extends kotlin.jvm.internal.n0 implements v3.l<TextFieldValue, r2> {
    ...
    public final void invoke2(@p4.l TextFieldValue textFieldValue) {
        ...
        int m2177getMinuteJiIwxys = Selection.Companion.m2177getMinuteJiIwxys();
        TimePickerState timePickerState = this.$state;
        TimeInputImpl$lambda$8 = TimePickerKt.TimeInputImpl$lambda$8(this.$minuteValue$delegate);
        TimePickerKt.m2487timeInputOnChangegIWD5Rc(m2177getMinuteJiIwxys, timePickerState, textFieldValue, TimeInputImpl$lambda$8, 59, new AnonymousClass1(this.$minuteValue$delegate));
    }
}
