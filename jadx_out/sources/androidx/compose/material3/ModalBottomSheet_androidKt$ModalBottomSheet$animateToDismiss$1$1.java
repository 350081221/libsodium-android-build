...
public final class ModalBottomSheet_androidKt$ModalBottomSheet$animateToDismiss$1$1 extends kotlin.jvm.internal.n0 implements v3.a<r2> {
    ...
    /* loaded from: classes.dex */
    public static final class AnonymousClass2 extends kotlin.jvm.internal.n0 implements v3.l<Throwable, r2> {
        final /* synthetic */ v3.a<r2> $onDismissRequest;
        final /* synthetic */ SheetState $sheetState;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        AnonymousClass2(SheetState sheetState, v3.a<r2> aVar) {
            super(1);
            this.$sheetState = sheetState;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ModalBottomSheet_androidKt$ModalBottomSheet$animateToDismiss$1$1(SheetState sheetState, s0 s0Var, v3.a<r2> aVar) {
        super(0);
        this.$sheetState = sheetState;
        this.$scope = s0Var;
        this.$onDismissRequest = aVar;
    ...
    public final void invoke2() {
        l2 f5;
        if (this.$sheetState.getAnchoredDraggableState$material3_release().getConfirmValueChange$material3_release().invoke(SheetValue.Hidden).booleanValue()) {
            f5 = kotlinx.coroutines.k.f(this.$scope, null, null, new AnonymousClass1(this.$sheetState, null), 3, null);
            f5.t0(new AnonymousClass2(this.$sheetState, this.$onDismissRequest));
        }
    }
}
