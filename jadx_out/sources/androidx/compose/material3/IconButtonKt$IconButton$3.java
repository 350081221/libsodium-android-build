...
public final class IconButtonKt$IconButton$3 extends kotlin.jvm.internal.n0 implements v3.p<Composer, Integer, r2> {
    ...
    public IconButtonKt$IconButton$3(v3.a<r2> aVar, Modifier modifier, boolean z4, IconButtonColors iconButtonColors, MutableInteractionSource mutableInteractionSource, v3.p<? super Composer, ? super Integer, r2> pVar, int i5, int i6) {
        super(2);
        this.$onClick = aVar;
