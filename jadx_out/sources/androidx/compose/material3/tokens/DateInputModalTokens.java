...
public final class DateInputModalTokens {
    ...
    private static final float ContainerElevation = ElevationTokens.INSTANCE.m2802getLevel3D9Ej5fM();
    private static final float ContainerHeight = Dp.m6044constructorimpl((float) 512.0d);
    ...
    private static final float HeaderContainerHeight = Dp.m6044constructorimpl((float) 120.0d);

    static {
        float f5 = (float) 328.0d;
        ContainerWidth = Dp.m6044constructorimpl(f5);
        HeaderContainerWidth = Dp.m6044constructorimpl(f5);
    ...
    public final float m2760getContainerElevationD9Ej5fM() {
        return ContainerElevation;
    }

    /* renamed from: getContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m2761getContainerHeightD9Ej5fM() {
