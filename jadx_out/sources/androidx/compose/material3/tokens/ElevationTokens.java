...
public final class ElevationTokens {
    ...
    private static final float Level0 = Dp.m6044constructorimpl((float) 0.0d);
    private static final float Level1 = Dp.m6044constructorimpl((float) 1.0d);
    private static final float Level2 = Dp.m6044constructorimpl((float) 3.0d);
    private static final float Level3 = Dp.m6044constructorimpl((float) 6.0d);
    private static final float Level4 = Dp.m6044constructorimpl((float) 8.0d);
    private static final float Level5 = Dp.m6044constructorimpl((float) 12.0d);

    private ElevationTokens() {
    }

    /* renamed from: getLevel0-D9Ej5fM, reason: not valid java name */
    public final float m2799getLevel0D9Ej5fM() {
        return Level0;
    }

    /* renamed from: getLevel1-D9Ej5fM, reason: not valid java name */
    public final float m2800getLevel1D9Ej5fM() {
        return Level1;
    }

    /* renamed from: getLevel2-D9Ej5fM, reason: not valid java name */
    public final float m2801getLevel2D9Ej5fM() {
        return Level2;
    }

    /* renamed from: getLevel3-D9Ej5fM, reason: not valid java name */
    public final float m2802getLevel3D9Ej5fM() {
        return Level3;
    }

    /* renamed from: getLevel4-D9Ej5fM, reason: not valid java name */
    public final float m2803getLevel4D9Ej5fM() {
        return Level4;
    }

    /* renamed from: getLevel5-D9Ej5fM, reason: not valid java name */
    public final float m2804getLevel5D9Ej5fM() {
        return Level5;
    }
}
