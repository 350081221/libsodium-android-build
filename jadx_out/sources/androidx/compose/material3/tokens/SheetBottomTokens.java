...
public final class SheetBottomTokens {
    ...
    private static final float DockedDragHandleHeight = Dp.m6044constructorimpl((float) 4.0d);
    private static final float DockedDragHandleWidth = Dp.m6044constructorimpl((float) 32.0d);
    ...
    static {
        ...
        DockedModalContainerElevation = elevationTokens.m2800getLevel1D9Ej5fM();
        DockedStandardContainerElevation = elevationTokens.m2800getLevel1D9Ej5fM();
    }
    ...
    public final float m3108getDockedDragHandleHeightD9Ej5fM() {
        return DockedDragHandleHeight;
    }

    /* renamed from: getDockedDragHandleWidth-D9Ej5fM, reason: not valid java name */
    public final float m3109getDockedDragHandleWidthD9Ej5fM() {
    ...
    public final float m3110getDockedModalContainerElevationD9Ej5fM() {
        return DockedModalContainerElevation;
    }

    /* renamed from: getDockedStandardContainerElevation-D9Ej5fM, reason: not valid java name */
    public final float m3111getDockedStandardContainerElevationD9Ej5fM() {
