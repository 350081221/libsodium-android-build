...
final class ButtonElevation$animateElevation$1$1 extends kotlin.coroutines.jvm.internal.o implements v3.p<s0, kotlin.coroutines.d<? super r2>, Object> {
    ...
    public ButtonElevation$animateElevation$1$1(InteractionSource interactionSource, SnapshotStateList<Interaction> snapshotStateList, kotlin.coroutines.d<? super ButtonElevation$animateElevation$1$1> dVar) {
        super(2, dVar);
    ...
    public final Object invoke(@p4.l s0 s0Var, @p4.m kotlin.coroutines.d<? super r2> dVar) {
        return ((ButtonElevation$animateElevation$1$1) create(s0Var, dVar)).invokeSuspend(r2.f19517a);
    }
    ...
    public final Object invokeSuspend(@p4.l Object obj) {
        ...
        if (i5 != 0) {
            ...
            kotlinx.coroutines.flow.j<? super Interaction> jVar = new kotlinx.coroutines.flow.j() { // from class: androidx.compose.material3.ButtonElevation$animateElevation$1$1.1
