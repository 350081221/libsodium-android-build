...
public final class SliderKt$Slider$6 extends kotlin.jvm.internal.n0 implements v3.q<SliderState, Composer, Integer, r2> {
    ...
    public SliderKt$Slider$6(MutableInteractionSource mutableInteractionSource, SliderColors sliderColors, boolean z4) {
        super(3);
    ...
    public final void invoke(@p4.l SliderState sliderState, @p4.m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1756326375, i5, -1, "androidx.compose.material3.Slider.<anonymous> (Slider.kt:251)");
        }
