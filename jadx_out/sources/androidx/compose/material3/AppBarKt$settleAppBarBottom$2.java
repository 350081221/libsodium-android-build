...
public final class AppBarKt$settleAppBarBottom$2 extends kotlin.jvm.internal.n0 implements v3.l<AnimationScope<Float, AnimationVector1D>, r2> {
    ...
    public AppBarKt$settleAppBarBottom$2(k1.e eVar, BottomAppBarState bottomAppBarState, k1.e eVar2) {
        super(1);
        this.$lastValue = eVar;
