...
final class TabIndicatorOffsetNode$measure$3 extends kotlin.coroutines.jvm.internal.o implements v3.p<s0, kotlin.coroutines.d<? super r2>, Object> {
    ...
    public TabIndicatorOffsetNode$measure$3(Animatable<Dp, AnimationVector1D> animatable, float f5, kotlin.coroutines.d<? super TabIndicatorOffsetNode$measure$3> dVar) {
        super(2, dVar);
    ...
    public final Object invoke(@p4.l s0 s0Var, @p4.m kotlin.coroutines.d<? super r2> dVar) {
        return ((TabIndicatorOffsetNode$measure$3) create(s0Var, dVar)).invokeSuspend(r2.f19517a);
    }
    ...
    public final Object invokeSuspend(@p4.l Object obj) {
        ...
        if (i5 != 0) {
            ...
            Dp m6042boximpl = Dp.m6042boximpl(this.$indicatorOffset);
            this.label = 1;
