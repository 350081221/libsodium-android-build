...
public final class DateRangePickerKt$DateRangePickerContent$2 extends kotlin.jvm.internal.n0 implements v3.p<Composer, Integer, r2> {
    ...
    public DateRangePickerKt$DateRangePickerContent$2(Long l5, Long l6, long j5, v3.p<? super Long, ? super Long, r2> pVar, v3.l<? super Long, r2> lVar, CalendarModel calendarModel, kotlin.ranges.l lVar2, DatePickerFormatter datePickerFormatter, SelectableDates selectableDates, DatePickerColors datePickerColors, int i5) {
        super(2);
