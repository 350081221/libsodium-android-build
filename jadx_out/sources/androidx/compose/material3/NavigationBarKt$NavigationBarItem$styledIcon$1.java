...
public final class NavigationBarKt$NavigationBarItem$styledIcon$1 extends kotlin.jvm.internal.n0 implements v3.p<Composer, Integer, r2> {
    ...
    public NavigationBarKt$NavigationBarItem$styledIcon$1(NavigationBarItemColors navigationBarItemColors, boolean z4, boolean z5, v3.p<? super Composer, ? super Integer, r2> pVar, boolean z6, v3.p<? super Composer, ? super Integer, r2> pVar2) {
        super(2);
    ...
    public final void invoke(@p4.m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1419576100, i5, -1, "androidx.compose.material3.NavigationBarItem.<anonymous> (NavigationBar.kt:175)");
        }
