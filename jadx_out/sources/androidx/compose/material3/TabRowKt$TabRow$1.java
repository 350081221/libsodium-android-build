...
final class TabRowKt$TabRow$1 extends kotlin.jvm.internal.n0 implements v3.q<List<? extends TabPosition>, Composer, Integer, r2> {
    ...
    public final void invoke(@p4.l List<TabPosition> list, @p4.m Composer composer, int i5) {
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-2052073983, i5, -1, "androidx.compose.material3.TabRow.<anonymous> (TabRow.kt:302)");
        }
