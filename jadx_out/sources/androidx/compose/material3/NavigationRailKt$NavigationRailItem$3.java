...
public final class NavigationRailKt$NavigationRailItem$3 extends kotlin.jvm.internal.n0 implements v3.p<Composer, Integer, r2> {
    ...
    public NavigationRailKt$NavigationRailItem$3(boolean z4, v3.a<r2> aVar, v3.p<? super Composer, ? super Integer, r2> pVar, Modifier modifier, boolean z5, v3.p<? super Composer, ? super Integer, r2> pVar2, boolean z6, NavigationRailItemColors navigationRailItemColors, MutableInteractionSource mutableInteractionSource, int i5, int i6) {
        super(2);
        this.$selected = z4;
        this.$onClick = aVar;
        this.$icon = pVar;
