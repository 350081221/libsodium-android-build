...
@kotlin.coroutines.jvm.internal.f(c = "androidx.compose.material3.SegmentedButtonKt$interactionCountAsState$1$1", f = "SegmentedButton.kt", i = {}, l = {402}, m = "invokeSuspend", n = {}, s = {})
@kotlin.i0(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\u0010\u0002\u001a\u00020\u0001*\u00020\u0000H\u008a@"}, d2 = {"Lkotlinx/coroutines/s0;", "Lkotlin/r2;", "<anonymous>"}, k = 3, mv = {1, 8, 0})
/* loaded from: classes.dex */
final class SegmentedButtonKt$interactionCountAsState$1$1 extends kotlin.coroutines.jvm.internal.o implements v3.p<s0, kotlin.coroutines.d<? super r2>, Object> {
    ...
    public SegmentedButtonKt$interactionCountAsState$1$1(InteractionSource interactionSource, MutableIntState mutableIntState, kotlin.coroutines.d<? super SegmentedButtonKt$interactionCountAsState$1$1> dVar) {
        super(2, dVar);
    ...
    public final Object invoke(@p4.l s0 s0Var, @p4.m kotlin.coroutines.d<? super r2> dVar) {
        return ((SegmentedButtonKt$interactionCountAsState$1$1) create(s0Var, dVar)).invokeSuspend(r2.f19517a);
    }
    ...
    public final Object invokeSuspend(@p4.l Object obj) {
        ...
        if (i5 != 0) {
            ...
            e1.n(obj);
            kotlinx.coroutines.flow.i<Interaction> interactions = this.$this_interactionCountAsState.getInteractions();
            final MutableIntState mutableIntState = this.$interactionCount;
            kotlinx.coroutines.flow.j<? super Interaction> jVar = new kotlinx.coroutines.flow.j() { // from class: androidx.compose.material3.SegmentedButtonKt$interactionCountAsState$1$1.1
