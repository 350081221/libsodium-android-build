...
final class FadeInFadeOutState<T> {
    ...
    public final void setCurrent(@p4.m Object obj) {
        this.current = obj;
    }

    public final void setItems(@p4.l List<FadeInFadeOutAnimationItem<T>> list) {
        this.items = list;
    }

    public final void setScope(@p4.m RecomposeScope recomposeScope) {
