...
public final class IconButtonKt$OutlinedIconToggleButton$4 extends kotlin.jvm.internal.n0 implements v3.p<Composer, Integer, r2> {
    ...
    public IconButtonKt$OutlinedIconToggleButton$4(boolean z4, v3.l<? super Boolean, r2> lVar, Modifier modifier, boolean z5, Shape shape, IconToggleButtonColors iconToggleButtonColors, BorderStroke borderStroke, MutableInteractionSource mutableInteractionSource, v3.p<? super Composer, ? super Integer, r2> pVar, int i5, int i6) {
        super(2);
        this.$checked = z4;
