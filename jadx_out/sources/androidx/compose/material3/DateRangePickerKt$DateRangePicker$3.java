...
public final class DateRangePickerKt$DateRangePicker$3 extends kotlin.jvm.internal.n0 implements v3.p<Composer, Integer, r2> {
    ...
    public final void invoke(@p4.m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-185279404, i5, -1, "androidx.compose.material3.DateRangePicker.<anonymous> (DateRangePicker.kt:95)");
        }
        ...
        dateRangePickerDefaults.m1821DateRangePickerHeadlinev84Udv0(selectedStartDateMillis, selectedEndDateMillis, mo1831getDisplayModejFl4v0, datePickerFormatter, PaddingKt.padding(companion, paddingValues), composer, 221184, 0);
        if (ComposerKt.isTraceInProgress()) {
