...
public final class ProgressIndicatorDefaults {
    ...
    private static final float CircularStrokeWidth = CircularProgressIndicatorTokens.INSTANCE.m2662getActiveIndicatorWidthD9Ej5fM();

    static {
        StrokeCap.Companion companion = StrokeCap.Companion;
        LinearStrokeCap = companion.m4085getButtKaPHkGw();
        CircularDeterminateStrokeCap = companion.m4085getButtKaPHkGw();
        CircularIndeterminateStrokeCap = companion.m4087getSquareKaPHkGw();
    ...
    @u3.h(name = "getCircularColor")
    @Composable
    public final long getCircularColor(@p4.m Composer composer, int i5) {
        composer.startReplaceableGroup(1803349725);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1803349725, i5, -1, "androidx.compose.material3.ProgressIndicatorDefaults.<get-circularColor> (ProgressIndicator.kt:601)");
        }
    ...
    public final int m2065getCircularDeterminateStrokeCapKaPHkGw() {
        return CircularDeterminateStrokeCap;
    }

    /* renamed from: getCircularIndeterminateStrokeCap-KaPHkGw, reason: not valid java name */
    public final int m2066getCircularIndeterminateStrokeCapKaPHkGw() {
        return CircularIndeterminateStrokeCap;
    }

    /* renamed from: getCircularStrokeWidth-D9Ej5fM, reason: not valid java name */
    public final float m2067getCircularStrokeWidthD9Ej5fM() {
        return CircularStrokeWidth;
    }

    @u3.h(name = "getCircularTrackColor")
    @Composable
    public final long getCircularTrackColor(@p4.m Composer composer, int i5) {
        composer.startReplaceableGroup(-404222247);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-404222247, i5, -1, "androidx.compose.material3.ProgressIndicatorDefaults.<get-circularTrackColor> (ProgressIndicator.kt:608)");
        }
        long m3769getTransparent0d7_KjU = Color.Companion.m3769getTransparent0d7_KjU();
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return m3769getTransparent0d7_KjU;
    }

    @u3.h(name = "getLinearColor")
    @Composable
    public final long getLinearColor(@p4.m Composer composer, int i5) {
        composer.startReplaceableGroup(-914312983);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-914312983, i5, -1, "androidx.compose.material3.ProgressIndicatorDefaults.<get-linearColor> (ProgressIndicator.kt:597)");
        }
    ...
    public final int m2068getLinearStrokeCapKaPHkGw() {
        return LinearStrokeCap;
    }

    @u3.h(name = "getLinearTrackColor")
    @Composable
    public final long getLinearTrackColor(@p4.m Composer composer, int i5) {
        composer.startReplaceableGroup(1677541593);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1677541593, i5, -1, "androidx.compose.material3.ProgressIndicatorDefaults.<get-linearTrackColor> (ProgressIndicator.kt:605)");
        }
