...
final class DatePickerKt$YearPicker$1$2$1$1$1$1 extends kotlin.jvm.internal.n0 implements v3.l<SemanticsPropertyReceiver, r2> {
    ...
    public DatePickerKt$YearPicker$1$2$1$1$1$1(LazyGridState lazyGridState, int i5, s0 s0Var, String str, String str2) {
        super(1);
    ...
    public final void invoke2(@p4.l SemanticsPropertyReceiver semanticsPropertyReceiver) {
        ...
        if (this.$lazyGridState.getFirstVisibleItemIndex() != this.$it) {
            ...
            if (!z4) {
                customScrollActions = kotlin.collections.w.E();
