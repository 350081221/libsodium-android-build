...
public final class ModalBottomSheet_androidKt$ModalBottomSheet$settleToDismiss$1$1 extends kotlin.jvm.internal.n0 implements v3.l<Float, r2> {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ModalBottomSheet_androidKt$ModalBottomSheet$settleToDismiss$1$1(s0 s0Var, SheetState sheetState, v3.a<r2> aVar) {
        super(1);
        this.$scope = s0Var;
        this.$sheetState = sheetState;
        this.$onDismissRequest = aVar;
    ...
    public final void invoke(float f5) {
        l2 f6;
        f6 = kotlinx.coroutines.k.f(this.$scope, null, null, new AnonymousClass1(this.$sheetState, f5, null), 3, null);
        f6.t0(new AnonymousClass2(this.$sheetState, this.$onDismissRequest));
    }
}
