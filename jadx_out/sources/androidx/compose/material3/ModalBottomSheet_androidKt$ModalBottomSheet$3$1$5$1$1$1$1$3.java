...
final class ModalBottomSheet_androidKt$ModalBottomSheet$3$1$5$1$1$1$1$3 extends kotlin.jvm.internal.n0 implements v3.a<Boolean> {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ModalBottomSheet_androidKt$ModalBottomSheet$3$1$5$1$1$1$1$3(SheetState sheetState, s0 s0Var) {
        super(0);
        this.$this_with = sheetState;
        this.$scope = s0Var;
    }
    ...
    public final Boolean invoke() {
        if (this.$this_with.getAnchoredDraggableState$material3_release().getConfirmValueChange$material3_release().invoke(SheetValue.PartiallyExpanded).booleanValue()) {
