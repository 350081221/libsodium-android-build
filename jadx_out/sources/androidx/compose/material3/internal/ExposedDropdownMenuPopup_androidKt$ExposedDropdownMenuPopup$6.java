...
public final class ExposedDropdownMenuPopup_androidKt$ExposedDropdownMenuPopup$6 extends n0 implements p<Composer, Integer, r2> {
    ...
    public ExposedDropdownMenuPopup_androidKt$ExposedDropdownMenuPopup$6(a<r2> aVar, PopupPositionProvider popupPositionProvider, p<? super Composer, ? super Integer, r2> pVar, int i5, int i6) {
        super(2);
