...
final class DateRangePickerKt$VerticalMonthsList$1$2$1$1$1$1$2$1 extends kotlin.jvm.internal.n0 implements v3.l<SemanticsPropertyReceiver, r2> {
    final /* synthetic */ List<CustomAccessibilityAction> $customAccessibilityAction;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public DateRangePickerKt$VerticalMonthsList$1$2$1$1$1$1$2$1(List<CustomAccessibilityAction> list) {
        super(1);
    ...
    public final void invoke2(@p4.l SemanticsPropertyReceiver semanticsPropertyReceiver) {
        SemanticsPropertiesKt.setCustomActions(semanticsPropertyReceiver, this.$customAccessibilityAction);
    }
}
