...
public final class DateRangePickerKt$VerticalMonthsList$3 extends kotlin.jvm.internal.n0 implements v3.p<Composer, Integer, r2> {
    ...
    public DateRangePickerKt$VerticalMonthsList$3(LazyListState lazyListState, Long l5, Long l6, v3.p<? super Long, ? super Long, r2> pVar, v3.l<? super Long, r2> lVar, CalendarModel calendarModel, kotlin.ranges.l lVar2, DatePickerFormatter datePickerFormatter, SelectableDates selectableDates, DatePickerColors datePickerColors, int i5) {
        super(2);
