...
final class ComposableSingletons$AppBarKt$lambda10$1 extends kotlin.jvm.internal.n0 implements v3.q<RowScope, Composer, Integer, r2> {
    ...
    public final void invoke(@p4.l RowScope rowScope, @p4.m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-703422839, i5, -1, "androidx.compose.material3.ComposableSingletons$AppBarKt.lambda-10.<anonymous> (AppBar.kt:342)");
        }
        if (ComposerKt.isTraceInProgress()) {
