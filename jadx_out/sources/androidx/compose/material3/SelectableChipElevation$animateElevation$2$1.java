...
public final class SelectableChipElevation$animateElevation$2$1 extends kotlin.coroutines.jvm.internal.o implements v3.p<s0, kotlin.coroutines.d<? super r2>, Object> {
    ...
    public SelectableChipElevation$animateElevation$2$1(Animatable<Dp, AnimationVector1D> animatable, float f5, boolean z4, Interaction interaction, MutableState<Interaction> mutableState, kotlin.coroutines.d<? super SelectableChipElevation$animateElevation$2$1> dVar) {
        super(2, dVar);
    ...
    public final Object invoke(@p4.l s0 s0Var, @p4.m kotlin.coroutines.d<? super r2> dVar) {
        return ((SelectableChipElevation$animateElevation$2$1) create(s0Var, dVar)).invokeSuspend(r2.f19517a);
    }
