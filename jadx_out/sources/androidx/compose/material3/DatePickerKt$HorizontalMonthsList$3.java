...
public final class DatePickerKt$HorizontalMonthsList$3 extends kotlin.jvm.internal.n0 implements v3.p<Composer, Integer, r2> {
    ...
    public DatePickerKt$HorizontalMonthsList$3(LazyListState lazyListState, Long l5, v3.l<? super Long, r2> lVar, v3.l<? super Long, r2> lVar2, CalendarModel calendarModel, kotlin.ranges.l lVar3, DatePickerFormatter datePickerFormatter, SelectableDates selectableDates, DatePickerColors datePickerColors, int i5) {
        super(2);
