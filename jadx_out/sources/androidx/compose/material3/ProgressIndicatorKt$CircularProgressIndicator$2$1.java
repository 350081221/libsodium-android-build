...
public final class ProgressIndicatorKt$CircularProgressIndicator$2$1 extends kotlin.jvm.internal.n0 implements v3.l<DrawScope, r2> {
    ...
    public ProgressIndicatorKt$CircularProgressIndicator$2$1(v3.a<Float> aVar, long j5, Stroke stroke, long j6) {
        super(1);
    ...
    public final void invoke2(@p4.l DrawScope drawScope) {
        float floatValue = 360.0f * this.$coercedProgress.invoke().floatValue();
        ProgressIndicatorKt.m2085drawCircularIndicatorTrackbw27NRU(drawScope, this.$trackColor, this.$stroke);
        ProgressIndicatorKt.m2086drawDeterminateCircularIndicator42QJj7c(drawScope, 270.0f, floatValue, this.$color, this.$stroke);
    }
}
