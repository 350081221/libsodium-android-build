...
public final class ChipElevation {
    ...
    public /* synthetic */ ChipElevation(float f5, float f6, float f7, float f8, float f9, float f10, kotlin.jvm.internal.w wVar) {
    ...
    private final State<Dp> animateElevation(boolean z4, InteractionSource interactionSource, Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-2071499570, i5, -1, "androidx.compose.material3.ChipElevation.animateElevation (Chip.kt:2095)");
        }
        ...
        if (z5 || rememberedValue3 == companion.getEmpty()) {
            rememberedValue3 = new ChipElevation$animateElevation$1$1(interactionSource, snapshotStateList, null);
        ...
        if (changedInstance2 || rememberedValue5 == companion.getEmpty()) {
            Object chipElevation$animateElevation$2$1 = new ChipElevation$animateElevation$2$1(animatable, f6, z4, interaction, mutableState, null);
            composer.updateRememberedValue(chipElevation$animateElevation$2$1);
            rememberedValue5 = chipElevation$animateElevation$2$1;
        }
        composer.endReplaceableGroup();
    ...
    public boolean equals(@p4.m Object obj) {
        ...
        if (Dp.m6049equalsimpl0(this.elevation, chipElevation.elevation) && Dp.m6049equalsimpl0(this.pressedElevation, chipElevation.pressedElevation) && Dp.m6049equalsimpl0(this.focusedElevation, chipElevation.focusedElevation) && Dp.m6049equalsimpl0(this.hoveredElevation, chipElevation.hoveredElevation) && Dp.m6049equalsimpl0(this.disabledElevation, chipElevation.disabledElevation)) {
            return true;
        }
        return false;
    }
    ...
    public final State<Dp> shadowElevation$material3_release(boolean z4, @p4.l InteractionSource interactionSource, @p4.m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1881877139, i5, -1, "androidx.compose.material3.ChipElevation.shadowElevation (Chip.kt:2087)");
        }
    ...
    public final float m1667tonalElevationu2uoSUM$material3_release(boolean z4) {
