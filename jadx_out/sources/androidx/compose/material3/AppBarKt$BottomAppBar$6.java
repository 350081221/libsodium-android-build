...
public final class AppBarKt$BottomAppBar$6 extends kotlin.jvm.internal.n0 implements v3.p<Composer, Integer, r2> {
    ...
    public AppBarKt$BottomAppBar$6(WindowInsets windowInsets, PaddingValues paddingValues, v3.q<? super RowScope, ? super Composer, ? super Integer, r2> qVar) {
        super(2);
    ...
    public final void invoke(@p4.m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1243053520, i5, -1, "androidx.compose.material3.BottomAppBar.<anonymous> (AppBar.kt:629)");
        }
        Modifier padding = PaddingKt.padding(SizeKt.m588height3ABfNKs(WindowInsetsPaddingKt.windowInsetsPadding(SizeKt.fillMaxWidth$default(Modifier.Companion, 0.0f, 1, null), this.$windowInsets), BottomAppBarTokens.INSTANCE.m2641getContainerHeightD9Ej5fM()), this.$contentPadding);
