...
public final class SliderKt$RangeSlider$15 extends kotlin.jvm.internal.n0 implements v3.q<RangeSliderState, Composer, Integer, r2> {
    ...
    public SliderKt$RangeSlider$15(MutableInteractionSource mutableInteractionSource, SliderColors sliderColors, boolean z4) {
        super(3);
    ...
    public final void invoke(@p4.l RangeSliderState rangeSliderState, @p4.m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1016457138, i5, -1, "androidx.compose.material3.RangeSlider.<anonymous> (Slider.kt:635)");
        }
