...
final class AlertDialogKt$AlertDialogContent$1$1$3$1 extends kotlin.jvm.internal.n0 implements v3.p<Composer, Integer, r2> {
    ...
    public AlertDialogKt$AlertDialogContent$1$1$3$1(ColumnScope columnScope, v3.p<? super Composer, ? super Integer, r2> pVar) {
        super(2);
    ...
    public final void invoke(@p4.m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-796843771, i5, -1, "androidx.compose.material3.AlertDialogContent.<anonymous>.<anonymous>.<anonymous>.<anonymous> (AlertDialog.kt:98)");
        }
