...
public final class CheckDrawingCache {
    ...
    public CheckDrawingCache(@p4.l Path path, @p4.l PathMeasure pathMeasure, @p4.l Path path2) {
        this.checkPath = path;
    ...
    public /* synthetic */ CheckDrawingCache(Path path, PathMeasure pathMeasure, Path path2, int i5, kotlin.jvm.internal.w wVar) {
