...
final class TooltipStateImpl$show$2 extends kotlin.coroutines.jvm.internal.o implements v3.l<kotlin.coroutines.d<? super r2>, Object> {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public TooltipStateImpl$show$2(TooltipStateImpl tooltipStateImpl, v3.l<? super kotlin.coroutines.d<? super r2>, ? extends Object> lVar, kotlin.coroutines.d<? super TooltipStateImpl$show$2> dVar) {
        super(1, dVar);
    ...
    public final Object invoke(@p4.m kotlin.coroutines.d<? super r2> dVar) {
        return ((TooltipStateImpl$show$2) create(dVar)).invokeSuspend(r2.f19517a);
    }
