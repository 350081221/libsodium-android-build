...
final class MinimumInteractiveModifierNode$measure$1 extends kotlin.jvm.internal.n0 implements v3.l<Placeable.PlacementScope, r2> {
    ...
    public MinimumInteractiveModifierNode$measure$1(int i5, Placeable placeable, int i6) {
        super(1);
        this.$width = i5;
