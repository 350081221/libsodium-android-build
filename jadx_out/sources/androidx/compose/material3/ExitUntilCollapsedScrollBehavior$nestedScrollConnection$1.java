    ...
    */
    public java.lang.Object mo390onPostFlingRZ2iAVY(long r10, long r12, @p4.l kotlin.coroutines.d<? super androidx.compose.ui.unit.Velocity> r14) {
        ...
        L80:
            ...
            return r10
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.ExitUntilCollapsedScrollBehavior$nestedScrollConnection$1.mo390onPostFlingRZ2iAVY(long, long, kotlin.coroutines.d):java.lang.Object");
    }
    ...
    public long mo391onPostScrollDzOQY0M(long j5, long j6, int i5) {
        ...
        if (Offset.m3494getYimpl(j6) >= 0.0f && Offset.m3494getYimpl(j5) >= 0.0f) {
            ...
            if (Offset.m3494getYimpl(j6) > 0.0f) {
                float heightOffset = this.this$0.getState().getHeightOffset();
                this.this$0.getState().setHeightOffset(this.this$0.getState().getHeightOffset() + Offset.m3494getYimpl(j6));
        ...
        this.this$0.getState().setHeightOffset(this.this$0.getState().getHeightOffset() + Offset.m3494getYimpl(j5));
    ...
    public long mo392onPreScrollOzD1aCk(long j5, int i5) {
        boolean z4;
        if (this.this$0.getCanScroll().invoke().booleanValue() && Offset.m3494getYimpl(j5) <= 0.0f) {
            float heightOffset = this.this$0.getState().getHeightOffset();
            this.this$0.getState().setHeightOffset(this.this$0.getState().getHeightOffset() + Offset.m3494getYimpl(j5));
