...
public final class ModalBottomSheet_androidKt$Scrim$dismissSheet$1$1 extends kotlin.coroutines.jvm.internal.o implements v3.p<PointerInputScope, kotlin.coroutines.d<? super r2>, Object> {
    ...
    public static final class AnonymousClass1 extends kotlin.jvm.internal.n0 implements v3.l<Offset, r2> {
        ...
        public /* bridge */ /* synthetic */ r2 invoke(Offset offset) {
            m2003invokek4lQ0M(offset.m3503unboximpl());
            return r2.f19517a;
        }

        /* renamed from: invoke-k-4lQ0M, reason: not valid java name */
        public final void m2003invokek4lQ0M(long j5) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ModalBottomSheet_androidKt$Scrim$dismissSheet$1$1(v3.a<r2> aVar, kotlin.coroutines.d<? super ModalBottomSheet_androidKt$Scrim$dismissSheet$1$1> dVar) {
        super(2, dVar);
        this.$onDismissRequest = aVar;
    }
    ...
    public final Object invoke(@p4.l PointerInputScope pointerInputScope, @p4.m kotlin.coroutines.d<? super r2> dVar) {
        return ((ModalBottomSheet_androidKt$Scrim$dismissSheet$1$1) create(pointerInputScope, dVar)).invokeSuspend(r2.f19517a);
    }
