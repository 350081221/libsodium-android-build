...
public final class NavigationRailKt$placeLabelAndIcon$1 extends kotlin.jvm.internal.n0 implements v3.l<Placeable.PlacementScope, r2> {
    ...
    public NavigationRailKt$placeLabelAndIcon$1(Placeable placeable, boolean z4, float f5, Placeable placeable2, int i5, float f6, float f7, Placeable placeable3, int i6, float f8, Placeable placeable4, int i7, float f9, int i8, MeasureScope measureScope) {
        super(1);
    ...
    */
    public final void invoke2(@p4.l androidx.compose.ui.layout.Placeable.PlacementScope r17) {
        /*
            ...
            float r1 = r4.mo304toPx0680j_4(r1)
            float r3 = r3 - r1
            float r3 = r3 + r5
