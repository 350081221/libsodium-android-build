...
final class NavigationBarKt$NavigationBarItem$3$indicator$1 extends kotlin.jvm.internal.n0 implements v3.p<Composer, Integer, r2> {
    ...
    public final void invoke(@p4.m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-474426875, i5, -1, "androidx.compose.material3.NavigationBarItem.<anonymous>.<anonymous> (NavigationBar.kt:250)");
        }
        ...
        BoxKt.Box(BackgroundKt.m200backgroundbw27NRU(GraphicsLayerModifierKt.graphicsLayer(layoutId, (v3.l) rememberedValue), this.$colors.m2010getIndicatorColor0d7_KjU$material3_release(), ShapesKt.getValue(NavigationBarTokens.INSTANCE.getActiveIndicatorShape(), composer, 6)), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
