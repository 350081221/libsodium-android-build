...
public final class AlertDialogDefaults {
    ...
    private static final float TonalElevation = DialogTokens.INSTANCE.m2782getContainerElevationD9Ej5fM();
    ...
    public final long getContainerColor(@p4.m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-285850401, i5, -1, "androidx.compose.material3.AlertDialogDefaults.<get-containerColor> (AndroidAlertDialog.android.kt:219)");
        }
    ...
    @u3.h(name = "getIconContentColor")
    @Composable
    public final long getIconContentColor(@p4.m Composer composer, int i5) {
        composer.startReplaceableGroup(1074292351);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1074292351, i5, -1, "androidx.compose.material3.AlertDialogDefaults.<get-iconContentColor> (AndroidAlertDialog.android.kt:222)");
        }
    ...
    public final Shape getShape(@p4.m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-331760525, i5, -1, "androidx.compose.material3.AlertDialogDefaults.<get-shape> (AndroidAlertDialog.android.kt:216)");
        }
    ...
    @u3.h(name = "getTextContentColor")
    @Composable
    public final long getTextContentColor(@p4.m Composer composer, int i5) {
        composer.startReplaceableGroup(-1352479489);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1352479489, i5, -1, "androidx.compose.material3.AlertDialogDefaults.<get-textContentColor> (AndroidAlertDialog.android.kt:228)");
        }
    ...
    @u3.h(name = "getTitleContentColor")
    @Composable
    public final long getTitleContentColor(@p4.m Composer composer, int i5) {
        composer.startReplaceableGroup(11981687);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(11981687, i5, -1, "androidx.compose.material3.AlertDialogDefaults.<get-titleContentColor> (AndroidAlertDialog.android.kt:225)");
        }
    ...
    public final float m1547getTonalElevationD9Ej5fM() {
