...
public final class DatePickerKt$DateEntryContainer$2$1$1$1$1 extends kotlin.jvm.internal.n0 implements v3.p<Composer, Integer, r2> {
    ...
    public DatePickerKt$DateEntryContainer$2$1$1$1$1(RowScope rowScope, v3.p<? super Composer, ? super Integer, r2> pVar) {
        super(2);
    ...
    public final void invoke(@p4.m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-962031352, i5, -1, "androidx.compose.material3.DateEntryContainer.<anonymous>.<anonymous>.<anonymous>.<anonymous>.<anonymous> (DatePicker.kt:1331)");
        }
