...
public final class NavigationDrawerKt$DismissibleNavigationDrawer$1$1 extends kotlin.jvm.internal.n0 implements v3.a<r2> {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public NavigationDrawerKt$DismissibleNavigationDrawer$1$1(DrawerState drawerState, Density density, float f5, float f6) {
        super(0);
