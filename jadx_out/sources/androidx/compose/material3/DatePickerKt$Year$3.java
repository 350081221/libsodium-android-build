...
public final class DatePickerKt$Year$3 extends kotlin.jvm.internal.n0 implements v3.p<Composer, Integer, r2> {
    ...
    public DatePickerKt$Year$3(Modifier modifier, boolean z4, boolean z5, v3.a<r2> aVar, boolean z6, String str, DatePickerColors datePickerColors, v3.p<? super Composer, ? super Integer, r2> pVar, int i5) {
        super(2);
