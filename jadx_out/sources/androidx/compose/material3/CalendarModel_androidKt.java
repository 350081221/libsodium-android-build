...
public final class CalendarModel_androidKt {
    ...
    public static final CalendarModel createCalendarModel(@p4.l Locale locale) {
    ...
    @p4.l
    @ExperimentalMaterial3Api
    public static final String formatWithSkeleton(long j5, @p4.l String str, @p4.l Locale locale, @p4.l Map<String, Object> map) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            return CalendarModelImpl.Companion.formatWithPattern(j5, obj2, locale, map);
        }
        return LegacyCalendarModelImpl.Companion.formatWithPattern(j5, obj2, locale, map);
    }
}
