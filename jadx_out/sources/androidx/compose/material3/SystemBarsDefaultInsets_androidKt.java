...
public final class SystemBarsDefaultInsets_androidKt {
    @p4.l
    @u3.h(name = "getSystemBarsForVisualComponents")
    @Composable
    public static final WindowInsets getSystemBarsForVisualComponents(@p4.l WindowInsets.Companion companion, @p4.m Composer composer, int i5) {
        composer.startReplaceableGroup(1816710665);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1816710665, i5, -1, "androidx.compose.material3.<get-systemBarsForVisualComponents> (SystemBarsDefaultInsets.android.kt:24)");
        }
