...
public final class DatePickerKt$Month$1$1$3 extends kotlin.jvm.internal.n0 implements v3.p<Composer, Integer, r2> {
    ...
    public DatePickerKt$Month$1$1$3(int i5) {
        super(2);
        this.$dayNumber = i5;
    }
    ...
    public final void invoke(@p4.m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-2095706591, i5, -1, "androidx.compose.material3.Month.<anonymous>.<anonymous>.<anonymous> (DatePicker.kt:1872)");
        }
        TextKt.m2452Text4IGK_g(ActualJvm_jvmKt.toLocalString$default(this.$dayNumber + 1, 0, 0, false, 7, null), SemanticsModifierKt.clearAndSetSemantics(Modifier.Companion, AnonymousClass1.INSTANCE), 0L, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, TextAlign.m5929boximpl(TextAlign.Companion.m5936getCentere0LSkKk()), 0L, 0, false, 0, 0, (v3.l<? super TextLayoutResult, r2>) null, (TextStyle) null, composer, 0, 0, 130556);
        if (ComposerKt.isTraceInProgress()) {
