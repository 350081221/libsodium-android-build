...
final class DateRangeInputKt$DateRangeInputContent$2$3 extends kotlin.jvm.internal.n0 implements v3.p<Composer, Integer, r2> {
    ...
    public final void invoke(@p4.m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(665407211, i5, -1, "androidx.compose.material3.DateRangeInputContent.<anonymous>.<anonymous> (DateRangeInput.kt:82)");
        }
