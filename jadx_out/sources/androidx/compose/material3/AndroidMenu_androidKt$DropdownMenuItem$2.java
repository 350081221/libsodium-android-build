...
public final class AndroidMenu_androidKt$DropdownMenuItem$2 extends kotlin.jvm.internal.n0 implements v3.p<Composer, Integer, r2> {
    ...
    public AndroidMenu_androidKt$DropdownMenuItem$2(v3.p<? super Composer, ? super Integer, r2> pVar, v3.a<r2> aVar, Modifier modifier, v3.p<? super Composer, ? super Integer, r2> pVar2, v3.p<? super Composer, ? super Integer, r2> pVar3, boolean z4, MenuItemColors menuItemColors, PaddingValues paddingValues, MutableInteractionSource mutableInteractionSource, int i5, int i6) {
        super(2);
        this.$text = pVar;
        this.$onClick = aVar;
