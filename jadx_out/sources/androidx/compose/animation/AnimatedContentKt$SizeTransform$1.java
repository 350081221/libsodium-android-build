...
public final class AnimatedContentKt$SizeTransform$1 extends n0 implements p<IntSize, IntSize, SpringSpec<IntSize>> {
    ...
    public /* bridge */ /* synthetic */ SpringSpec<IntSize> invoke(IntSize intSize, IntSize intSize2) {
        return m29invokeTemP2vQ(intSize.m6218unboximpl(), intSize2.m6218unboximpl());
    }

    @l
    /* renamed from: invoke-TemP2vQ, reason: not valid java name */
    public final SpringSpec<IntSize> m29invokeTemP2vQ(long j5, long j6) {
        return AnimationSpecKt.spring$default(0.0f, 400.0f, IntSize.m6206boximpl(VisibilityThresholdsKt.getVisibilityThreshold(IntSize.Companion)), 1, null);
    }
}
