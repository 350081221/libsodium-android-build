...
final class AnimatedContentTransitionScopeImpl$slideIntoContainer$1 extends n0 implements l<Integer, Integer> {
    ...
    public AnimatedContentTransitionScopeImpl$slideIntoContainer$1(l<? super Integer, Integer> lVar, AnimatedContentTransitionScopeImpl<S> animatedContentTransitionScopeImpl) {
        super(1);
    ...
    public final Integer invoke(int i5) {
        ...
        int m6214getWidthimpl = IntSize.m6214getWidthimpl(m51getCurrentSizeYbymL2g);
        ...
        return lVar.invoke(Integer.valueOf(m6214getWidthimpl - IntOffset.m6172getXimpl(m50calculateOffsetemnUabE)));
    }
}
