...
public final class AnimatedVisibilityKt$AnimatedVisibility$4 extends n0 implements p<Composer, Integer, r2> {
    ...
    public AnimatedVisibilityKt$AnimatedVisibility$4(RowScope rowScope, boolean z4, Modifier modifier, EnterTransition enterTransition, ExitTransition exitTransition, String str, q<? super AnimatedVisibilityScope, ? super Composer, ? super Integer, r2> qVar, int i5, int i6) {
        super(2);
