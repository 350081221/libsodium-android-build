...
public interface FloatAnimationSpec extends AnimationSpec<Float> {
    ...
    public static final class DefaultImpls {
        @Deprecated
        public static float getEndVelocity(@l FloatAnimationSpec floatAnimationSpec, float f5, float f6, float f7) {
    ...
    @l
    default <V extends AnimationVector> VectorizedFloatAnimationSpec<V> vectorize(@l TwoWayConverter<Float, V> twoWayConverter) {
