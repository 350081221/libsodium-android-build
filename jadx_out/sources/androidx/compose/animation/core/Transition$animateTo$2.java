...
public final class Transition$animateTo$2 extends n0 implements p<Composer, Integer, r2> {
    ...
    public Transition$animateTo$2(Transition<S> transition, S s5, int i5) {
        super(2);
