...
public final class TargetBasedAnimation<T, V extends AnimationVector> implements Animation<T, V> {
    ...
    public TargetBasedAnimation(@l VectorizedAnimationSpec<V> vectorizedAnimationSpec, @l TwoWayConverter<T, V> twoWayConverter, T t5, T t6, @m V v4) {
        ...
        V v5 = (v4 == null || (v5 = (V) AnimationVectorsKt.copy(v4)) == null) ? (V) AnimationVectorsKt.newInstance(getTypeConverter().getConvertToVector().invoke(t5)) : v5;
    ...
    public T getValueFromNanos(long j5) {
        if (!isFinishedFromNanos(j5)) {
            V valueFromNanos = this.animationSpec.getValueFromNanos(j5, this.initialValueVector, this.targetValueVector, this.initialVelocityVector);
            int size$animation_core_release = valueFromNanos.getSize$animation_core_release();
            for (int i5 = 0; i5 < size$animation_core_release; i5++) {
                if (!(!Float.isNaN(valueFromNanos.get$animation_core_release(i5)))) {
                    throw new IllegalStateException(("AnimationVector cannot contain a NaN. " + valueFromNanos + ". Animation: " + this + ", playTimeNanos: " + j5).toString());
                }
            }
    ...
    public V getVelocityVectorFromNanos(long j5) {
        if (!isFinishedFromNanos(j5)) {
            return this.animationSpec.getVelocityFromNanos(j5, this.initialValueVector, this.targetValueVector, this.initialVelocityVector);
        }
    ...
    public /* synthetic */ TargetBasedAnimation(VectorizedAnimationSpec vectorizedAnimationSpec, TwoWayConverter twoWayConverter, Object obj, Object obj2, AnimationVector animationVector, int i5, w wVar) {
    ...
    public /* synthetic */ TargetBasedAnimation(AnimationSpec animationSpec, TwoWayConverter twoWayConverter, Object obj, Object obj2, AnimationVector animationVector, int i5, w wVar) {
    ...
    public TargetBasedAnimation(@l AnimationSpec<T> animationSpec, @l TwoWayConverter<T, V> twoWayConverter, T t5, T t6, @m V v4) {
        this(animationSpec.vectorize(twoWayConverter), twoWayConverter, t5, t6, v4);
    }
}
