...
public interface VectorizedAnimationSpec<V extends AnimationVector> {
    ...
    public static final class DefaultImpls {
        @l
        @Deprecated
        public static <V extends AnimationVector> V getEndVelocity(@l VectorizedAnimationSpec<V> vectorizedAnimationSpec, @l V v4, @l V v5, @l V v6) {
            return (V) VectorizedAnimationSpec.super.getEndVelocity(v4, v5, v6);
        }
    }

    long getDurationNanos(@l V v4, @l V v5, @l V v6);

    @l
    default V getEndVelocity(@l V v4, @l V v5, @l V v6) {
        return getVelocityFromNanos(getDurationNanos(v4, v5, v6), v4, v5, v6);
    }

    @l
    V getValueFromNanos(long j5, @l V v4, @l V v5, @l V v6);

    @l
    V getVelocityFromNanos(long j5, @l V v4, @l V v5, @l V v6);
