...
public final class VectorizedSpringSpec<V extends AnimationVector> implements VectorizedFiniteAnimationSpec<V> {
    ...
    public long getDurationNanos(@l V v4, @l V v5, @l V v6) {
        return this.$$delegate_0.getDurationNanos(v4, v5, v6);
    }

    @Override // androidx.compose.animation.core.VectorizedAnimationSpec
    @l
    public V getEndVelocity(@l V v4, @l V v5, @l V v6) {
        return this.$$delegate_0.getEndVelocity(v4, v5, v6);
    }
    ...
    public V getValueFromNanos(long j5, @l V v4, @l V v5, @l V v6) {
        return this.$$delegate_0.getValueFromNanos(j5, v4, v5, v6);
    }

    @Override // androidx.compose.animation.core.VectorizedAnimationSpec
    @l
    public V getVelocityFromNanos(long j5, @l V v4, @l V v5, @l V v6) {
        return this.$$delegate_0.getVelocityFromNanos(j5, v4, v5, v6);
    }
    ...
    public /* synthetic */ VectorizedSpringSpec(float f5, float f6, AnimationVector animationVector, int i5, w wVar) {
        this((i5 & 1) != 0 ? 1.0f : f5, (i5 & 2) != 0 ? 1500.0f : f6, (i5 & 4) != 0 ? null : animationVector);
    }

    public VectorizedSpringSpec(float f5, float f6, @m V v4) {
        this(f5, f6, VectorizedAnimationSpecKt.access$createSpringAnimations(v4, f5, f6));
    }
}
