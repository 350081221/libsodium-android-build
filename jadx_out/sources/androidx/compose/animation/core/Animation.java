...
public interface Animation<T, V extends AnimationVector> {
    ...
    public static final class DefaultImpls {
        @Deprecated
        public static <T, V extends AnimationVector> boolean isFinishedFromNanos(@l Animation<T, V> animation, long j5) {
            return Animation.super.isFinishedFromNanos(j5);
        }
    }
    ...
    default boolean isFinishedFromNanos(long j5) {
        return j5 >= getDurationNanos();
    }
