...
public interface VectorizedDurationBasedAnimationSpec<V extends AnimationVector> extends VectorizedFiniteAnimationSpec<V> {
    ...
    public static final class DefaultImpls {
        @Deprecated
        public static <V extends AnimationVector> long getDurationNanos(@l VectorizedDurationBasedAnimationSpec<V> vectorizedDurationBasedAnimationSpec, @l V v4, @l V v5, @l V v6) {
            return VectorizedDurationBasedAnimationSpec.super.getDurationNanos(v4, v5, v6);
        }

        @l
        @Deprecated
        public static <V extends AnimationVector> V getEndVelocity(@l VectorizedDurationBasedAnimationSpec<V> vectorizedDurationBasedAnimationSpec, @l V v4, @l V v5, @l V v6) {
            return (V) VectorizedDurationBasedAnimationSpec.super.getEndVelocity(v4, v5, v6);
        }
    ...
    default long getDurationNanos(@l V v4, @l V v5, @l V v6) {
