...
public interface VectorizedDecayAnimationSpec<V extends AnimationVector> {
    ...
    long getDurationNanos(@l V v4, @l V v5);

    @l
    V getTargetValue(@l V v4, @l V v5);

    @l
    V getValueFromNanos(long j5, @l V v4, @l V v5);

    @l
    V getVelocityFromNanos(long j5, @l V v4, @l V v5);
}
