...
final class InfiniteAnimationPolicyKt$withInfiniteAnimationFrameNanos$2<R> extends o implements l<kotlin.coroutines.d<? super R>, Object> {
    ...
    public InfiniteAnimationPolicyKt$withInfiniteAnimationFrameNanos$2(l<? super Long, ? extends R> lVar, kotlin.coroutines.d<? super InfiniteAnimationPolicyKt$withInfiniteAnimationFrameNanos$2> dVar) {
        super(1, dVar);
        this.$onFrame = lVar;
    }
    ...
    @Override // v3.l
    @m
    public final Object invoke(@m kotlin.coroutines.d<? super R> dVar) {
