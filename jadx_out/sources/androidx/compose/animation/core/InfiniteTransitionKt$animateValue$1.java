...
final class InfiniteTransitionKt$animateValue$1 extends n0 implements v3.a<r2> {
    ...
    public InfiniteTransitionKt$animateValue$1(T t5, InfiniteTransition.TransitionAnimationState<T, V> transitionAnimationState, T t6, InfiniteRepeatableSpec<T> infiniteRepeatableSpec) {
        super(0);
    ...
    public final void invoke2() {
        if (l0.g(this.$initialValue, this.$transitionAnimation.getInitialValue$animation_core_release()) && l0.g(this.$targetValue, this.$transitionAnimation.getTargetValue$animation_core_release())) {
            return;
        }
