...
public final class Animatable$stop$2 extends o implements l<kotlin.coroutines.d<? super r2>, Object> {
    int label;
    ...
    public final Object invoke(@m kotlin.coroutines.d<? super r2> dVar) {
        return ((Animatable$stop$2) create(dVar)).invokeSuspend(r2.f19517a);
    }
