...
public final class Transition$updateTarget$3 extends n0 implements p<Composer, Integer, r2> {
    ...
    public Transition$updateTarget$3(Transition<S> transition, S s5, int i5) {
        super(2);
