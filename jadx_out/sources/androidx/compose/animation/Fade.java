...
public final class Fade {
    ...
    public Fade(float f5, @l FiniteAnimationSpec<Float> finiteAnimationSpec) {
        this.alpha = f5;
    ...
    @l
    public final Fade copy(float f5, @l FiniteAnimationSpec<Float> finiteAnimationSpec) {
    ...
    public boolean equals(@m Object obj) {
        ...
        Fade fade = (Fade) obj;
        return Float.compare(this.alpha, fade.alpha) == 0 && l0.g(this.animationSpec, fade.animationSpec);
    }
