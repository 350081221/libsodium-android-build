...
public final class AnimatedVisibilityKt$AnimatedVisibility$13 extends n0 implements p<Composer, Integer, r2> {
    ...
    public AnimatedVisibilityKt$AnimatedVisibility$13(Transition<T> transition, l<? super T, Boolean> lVar, Modifier modifier, EnterTransition enterTransition, ExitTransition exitTransition, q<? super AnimatedVisibilityScope, ? super Composer, ? super Integer, r2> qVar, int i5, int i6) {
        super(2);
