...
public abstract class EnterTransition {
    ...
    public /* synthetic */ EnterTransition(w wVar) {
        this();
    }

    public boolean equals(@m Object obj) {
        return (obj instanceof EnterTransition) && l0.g(((EnterTransition) obj).getData$animation_release(), getData$animation_release());
    }
    ...
    @Stable
    @l
    public final EnterTransition plus(@l EnterTransition enterTransition) {
        Map n02;
        ...
        n02 = a1.n0(getData$animation_release().getEffectsMap(), enterTransition.getData$animation_release().getEffectsMap());
        return new EnterTransitionImpl(new TransitionData(fade2, slide2, changeSize2, scale, false, n02, 16, null));
    }
