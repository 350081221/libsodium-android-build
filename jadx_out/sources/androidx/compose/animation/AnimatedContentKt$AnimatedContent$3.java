...
public final class AnimatedContentKt$AnimatedContent$3 extends n0 implements p<Composer, Integer, r2> {
    ...
    public AnimatedContentKt$AnimatedContent$3(S s5, Modifier modifier, l<? super AnimatedContentTransitionScope<S>, ContentTransform> lVar, Alignment alignment, String str, l<? super S, ? extends Object> lVar2, r<? super AnimatedContentScope, ? super S, ? super Composer, ? super Integer, r2> rVar, int i5, int i6) {
        super(2);
        this.$targetState = s5;
