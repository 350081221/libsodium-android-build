...
final class AnimatedContentTransitionScopeImpl$slideOutOfContainer$4 extends n0 implements l<Integer, Integer> {
    ...
    public AnimatedContentTransitionScopeImpl$slideOutOfContainer$4(AnimatedContentTransitionScopeImpl<S> animatedContentTransitionScopeImpl, l<? super Integer, Integer> lVar) {
        super(1);
    ...
    public final Integer invoke(int i5) {
        ...
        return lVar.invoke(Integer.valueOf((-IntOffset.m6173getYimpl(m50calculateOffsetemnUabE)) + IntSize.m6213getHeightimpl(m6218unboximpl)));
    }
}
