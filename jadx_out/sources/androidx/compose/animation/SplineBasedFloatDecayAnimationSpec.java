...
public final class SplineBasedFloatDecayAnimationSpec implements FloatDecayAnimationSpec {
    ...
    private final float flingDistance(float f5) {
        return this.flingCalculator.flingDistance(f5) * Math.signum(f5);
    }
    ...
    public long getDurationNanos(float f5, float f6) {
        return this.flingCalculator.flingDuration(f6) * AnimationKt.MillisToNanos;
    }
    ...
    public float getValueFromNanos(long j5, float f5, float f6) {
        return f5 + this.flingCalculator.flingInfo(f6).position(j5 / AnimationKt.MillisToNanos);
    }

    @Override // androidx.compose.animation.core.FloatDecayAnimationSpec
    public float getVelocityFromNanos(long j5, float f5, float f6) {
        return this.flingCalculator.flingInfo(f6).velocity(j5 / AnimationKt.MillisToNanos);
    }
}
