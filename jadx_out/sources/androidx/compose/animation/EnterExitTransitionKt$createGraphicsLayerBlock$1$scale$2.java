...
public final class EnterExitTransitionKt$createGraphicsLayerBlock$1$scale$2 extends n0 implements l<EnterExitState, Float> {
    ...
    public EnterExitTransitionKt$createGraphicsLayerBlock$1$scale$2(EnterTransition enterTransition, ExitTransition exitTransition) {
        super(1);
