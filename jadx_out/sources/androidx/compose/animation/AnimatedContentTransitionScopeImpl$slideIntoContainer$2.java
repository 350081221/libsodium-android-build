...
final class AnimatedContentTransitionScopeImpl$slideIntoContainer$2 extends n0 implements l<Integer, Integer> {
    ...
    public AnimatedContentTransitionScopeImpl$slideIntoContainer$2(l<? super Integer, Integer> lVar, AnimatedContentTransitionScopeImpl<S> animatedContentTransitionScopeImpl) {
        super(1);
