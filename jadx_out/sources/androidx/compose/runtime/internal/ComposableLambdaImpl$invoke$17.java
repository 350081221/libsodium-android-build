...
public final class ComposableLambdaImpl$invoke$17 extends n0 implements p<Composer, Integer, r2> {
    ...
    public final void invoke(@l Composer composer, int i5) {
        this.this$0.invoke(this.$p1, this.$p2, this.$p3, this.$p4, this.$p5, this.$p6, this.$p7, this.$p8, this.$p9, this.$p10, this.$p11, this.$p12, this.$p13, this.$p14, this.$p15, this.$p16, this.$p17, composer, RecomposeScopeImplKt.updateChangedFlags(this.$changed) | 1, RecomposeScopeImplKt.updateChangedFlags(this.$changed1));
    }
}
