...
public final class SubList$listIterator$1<T> implements ListIterator<T>, f {
    final /* synthetic */ k1.f $current;
    final /* synthetic */ SubList<T> this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    public SubList$listIterator$1(k1.f fVar, SubList<T> subList) {
        this.$current = fVar;
        this.this$0 = subList;
    }
    ...
    @Override // java.util.ListIterator, java.util.Iterator
    public T next() {
        int i5 = this.$current.element + 1;
        SnapshotStateListKt.validateRange(i5, this.this$0.size());
        this.$current.element = i5;
        return this.this$0.get(i5);
    }
    ...
    @Override // java.util.ListIterator
    public T previous() {
        int i5 = this.$current.element;
        SnapshotStateListKt.validateRange(i5, this.this$0.size());
        this.$current.element = i5 - 1;
        return this.this$0.get(i5);
    }
