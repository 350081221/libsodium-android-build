...
final class GlobalSnapshot$takeNestedMutableSnapshot$1 extends n0 implements l<SnapshotIdSet, MutableSnapshot> {
    ...
    final /* synthetic */ l<Object, r2> $writeObserver;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public GlobalSnapshot$takeNestedMutableSnapshot$1(l<Object, r2> lVar, l<Object, r2> lVar2) {
        super(1);
    ...
    @Override // v3.l
    @p4.l
    public final MutableSnapshot invoke(@p4.l SnapshotIdSet snapshotIdSet) {
        int i5;
        synchronized (SnapshotKt.getLock()) {
            i5 = SnapshotKt.nextSnapshotId;
            SnapshotKt.nextSnapshotId = i5 + 1;
        }
        return new MutableSnapshot(i5, snapshotIdSet, this.$readObserver, this.$writeObserver);
    }
}
