...
public final class StateMapMutableKeysIterator<K, V> extends StateMapMutableIterator<K, V> implements Iterator<K>, d {
    public StateMapMutableKeysIterator(@l SnapshotStateMap<K, V> snapshotStateMap, @l Iterator<? extends Map.Entry<? extends K, ? extends V>> it) {
