...
public final class StateMapMutableValuesIterator<K, V> extends StateMapMutableIterator<K, V> implements Iterator<V>, d {
    public StateMapMutableValuesIterator(@l SnapshotStateMap<K, V> snapshotStateMap, @l Iterator<? extends Map.Entry<? extends K, ? extends V>> it) {
