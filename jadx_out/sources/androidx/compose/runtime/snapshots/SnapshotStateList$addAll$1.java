...
final class SnapshotStateList$addAll$1<T> extends n0 implements l<List<T>, Boolean> {
    ...
    public SnapshotStateList$addAll$1(int i5, Collection<? extends T> collection) {
        super(1);
        this.$index = i5;
