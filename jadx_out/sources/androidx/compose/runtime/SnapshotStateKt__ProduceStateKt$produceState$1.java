...
public final class SnapshotStateKt__ProduceStateKt$produceState$1 extends o implements p<s0, d<? super r2>, Object> {
    ...
    public SnapshotStateKt__ProduceStateKt$produceState$1(p<? super ProduceStateScope<T>, ? super d<? super r2>, ? extends Object> pVar, MutableState<T> mutableState, d<? super SnapshotStateKt__ProduceStateKt$produceState$1> dVar) {
        super(2, dVar);
        this.$producer = pVar;
    ...
    public final Object invoke(@l s0 s0Var, @m d<? super r2> dVar) {
        return ((SnapshotStateKt__ProduceStateKt$produceState$1) create(s0Var, dVar)).invokeSuspend(r2.f19517a);
    }
