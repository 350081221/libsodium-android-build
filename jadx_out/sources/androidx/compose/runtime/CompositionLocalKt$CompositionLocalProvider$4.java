...
public final class CompositionLocalKt$CompositionLocalProvider$4 extends n0 implements p<Composer, Integer, r2> {
    ...
    public CompositionLocalKt$CompositionLocalProvider$4(CompositionLocalContext compositionLocalContext, p<? super Composer, ? super Integer, r2> pVar, int i5) {
        super(2);
