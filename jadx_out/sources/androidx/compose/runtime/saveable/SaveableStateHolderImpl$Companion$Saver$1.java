...
final class SaveableStateHolderImpl$Companion$Saver$1 extends n0 implements p<SaverScope, SaveableStateHolderImpl, Map<Object, Map<String, ? extends List<? extends Object>>>> {
    ...
    @Override // v3.p
    @m
    public final Map<Object, Map<String, List<Object>>> invoke(@l SaverScope saverScope, @l SaveableStateHolderImpl saveableStateHolderImpl) {
