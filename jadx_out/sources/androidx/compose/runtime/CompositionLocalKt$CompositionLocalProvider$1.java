...
public final class CompositionLocalKt$CompositionLocalProvider$1 extends n0 implements p<Composer, Integer, r2> {
    ...
    public CompositionLocalKt$CompositionLocalProvider$1(ProvidedValue<?>[] providedValueArr, p<? super Composer, ? super Integer, r2> pVar, int i5) {
        super(2);
