...
public interface PersistentMap<K, V> extends ImmutableMap<K, V> {
    ...
    @Override // java.util.Map
    @l
    PersistentMap<K, V> put(K k5, V v4);

    @Override // java.util.Map
    @l
    PersistentMap<K, V> putAll(@l Map<? extends K, ? extends V> map);

    @Override // java.util.Map
    @l
    PersistentMap<K, V> remove(K k5);

    @Override // java.util.Map
    @l
    PersistentMap<K, V> remove(K k5, V v4);
}
