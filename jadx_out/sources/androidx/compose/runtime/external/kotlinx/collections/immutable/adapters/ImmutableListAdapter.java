...
public final class ImmutableListAdapter<E> implements ImmutableList<E>, List<E>, a {
    ...
    public ImmutableListAdapter(@l List<? extends E> list) {
        this.impl = list;
    }
    ...
    public ListIterator<E> listIterator(int i5) {
        return this.impl.listIterator(i5);
    }
    ...
    public ImmutableList<E> subList(int i5, int i6) {
        return new ImmutableListAdapter(this.impl.subList(i5, i6));
    }
}
