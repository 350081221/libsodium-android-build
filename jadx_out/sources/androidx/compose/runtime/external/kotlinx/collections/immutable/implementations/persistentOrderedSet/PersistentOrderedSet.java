...
public final class PersistentOrderedSet<E> extends i<E> implements PersistentSet<E> {
    ...
    public PersistentOrderedSet(@m Object obj, @m Object obj2, @l PersistentHashMap<E, Links> persistentHashMap) {
    ...
    public PersistentSet<E> add(E e5) {
        if (this.hashMap.containsKey(e5)) {
            return this;
        }
        if (isEmpty()) {
            return new PersistentOrderedSet(e5, e5, this.hashMap.put((PersistentHashMap<E, Links>) e5, (E) new Links()));
        }
        Object obj = this.lastElement;
        Object obj2 = this.hashMap.get(obj);
        l0.m(obj2);
        return new PersistentOrderedSet(this.firstElement, e5, this.hashMap.put((PersistentHashMap<E, Links>) obj, (Object) ((Links) obj2).withNext(e5)).put((PersistentHashMap) e5, (E) new Links(obj)));
    }
    ...
    public PersistentSet<E> remove(E e5) {
        Links links = this.hashMap.get(e5);
        if (links == null) {
            return this;
        }
        PersistentHashMap remove = this.hashMap.remove((PersistentHashMap<E, Links>) e5);
        if (links.getHasPrevious()) {
            V v4 = remove.get(links.getPrevious());
            l0.m(v4);
            remove = remove.put((PersistentHashMap) links.getPrevious(), (Object) ((Links) v4).withNext(links.getNext()));
        }
        if (links.getHasNext()) {
            V v5 = remove.get(links.getNext());
            l0.m(v5);
            remove = remove.put((PersistentHashMap) links.getNext(), (Object) ((Links) v5).withPrevious(links.getPrevious()));
        }
