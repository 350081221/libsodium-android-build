...
public final class MutableMapEntry<K, V> extends MapEntry<K, V> implements Map.Entry<K, V>, g.a {
    ...
    public V setValue(V v4) {
        V value = getValue();
        setValue((MutableMapEntry<K, V>) v4);
        this.parentIterator.setValue(getKey(), v4);
        return value;
    }
}
