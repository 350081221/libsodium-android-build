...
public interface PersistentSet<E> extends ImmutableSet<E>, PersistentCollection<E> {
    ...
    @l
    PersistentSet<E> add(E e5);

    @Override // java.util.Set, java.util.Collection, androidx.compose.runtime.external.kotlinx.collections.immutable.PersistentCollection
    @l
    PersistentSet<E> addAll(@l Collection<? extends E> collection);
    ...
    @Override // java.util.Set, java.util.Collection, androidx.compose.runtime.external.kotlinx.collections.immutable.PersistentCollection
    @l
    PersistentSet<E> remove(E e5);

    @Override // java.util.Set, java.util.Collection, androidx.compose.runtime.external.kotlinx.collections.immutable.PersistentCollection
    @l
    PersistentSet<E> removeAll(@l Collection<? extends E> collection);

    @Override // androidx.compose.runtime.external.kotlinx.collections.immutable.PersistentCollection
    @l
    PersistentSet<E> removeAll(@l v3.l<? super E, Boolean> lVar);

    @Override // java.util.Set, java.util.Collection, androidx.compose.runtime.external.kotlinx.collections.immutable.PersistentCollection
    @l
    PersistentSet<E> retainAll(@l Collection<? extends E> collection);
}
