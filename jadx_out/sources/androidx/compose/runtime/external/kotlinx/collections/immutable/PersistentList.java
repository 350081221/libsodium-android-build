...
public interface PersistentList<E> extends ImmutableList<E>, PersistentCollection<E> {
    ...
    @Override // java.util.List
    @l
    PersistentList<E> addAll(int i5, @l Collection<? extends E> collection);

    @Override // java.util.List, java.util.Collection, androidx.compose.runtime.external.kotlinx.collections.immutable.PersistentCollection
    @l
    PersistentList<E> addAll(@l Collection<? extends E> collection);
    ...
    @Override // java.util.List, java.util.Collection, androidx.compose.runtime.external.kotlinx.collections.immutable.PersistentCollection
    @l
    PersistentList<E> removeAll(@l Collection<? extends E> collection);

    @Override // androidx.compose.runtime.external.kotlinx.collections.immutable.PersistentCollection
    @l
    PersistentList<E> removeAll(@l v3.l<? super E, Boolean> lVar);

    @l
    PersistentList<E> removeAt(int i5);

    @Override // java.util.List, java.util.Collection, androidx.compose.runtime.external.kotlinx.collections.immutable.PersistentCollection
    @l
    PersistentList<E> retainAll(@l Collection<? extends E> collection);
