...
public final class PersistentOrderedMapBuilderEntries<K, V> extends AbstractMapBuilderEntries<Map.Entry<K, V>, K, V> {
    ...
    public PersistentOrderedMapBuilderEntries(@l PersistentOrderedMapBuilder<K, V> persistentOrderedMapBuilder) {
    ...
    public boolean containsEntry(@l Map.Entry<? extends K, ? extends V> entry) {
        V v4 = this.builder.get(entry.getKey());
        if (v4 != null) {
            return l0.g(v4, entry.getValue());
        }
    ...
    @Override // androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableMap.AbstractMapBuilderEntries
    public boolean removeEntry(@l Map.Entry<? extends K, ? extends V> entry) {
