...
public interface PersistentCollection<E> extends ImmutableCollection<E> {
    ...
    @l
    PersistentCollection<E> add(E e5);

    @Override // java.util.Collection
    @l
    PersistentCollection<E> addAll(@l Collection<? extends E> collection);
    ...
    @Override // java.util.Collection
    @l
    PersistentCollection<E> remove(E e5);

    @Override // java.util.Collection
    @l
    PersistentCollection<E> removeAll(@l Collection<? extends E> collection);

    @l
    PersistentCollection<E> removeAll(@l v3.l<? super E, Boolean> lVar);

    @Override // java.util.Collection
    @l
    PersistentCollection<E> retainAll(@l Collection<? extends E> collection);
}
