...
final class Recomposer$awaitIdle$2 extends o implements p<Recomposer.State, d<? super Boolean>, Object> {
    ...
    public final Object invoke(@l Recomposer.State state, @m d<? super Boolean> dVar) {
        return ((Recomposer$awaitIdle$2) create(state, dVar)).invokeSuspend(r2.f19517a);
    }
