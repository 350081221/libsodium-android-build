...
public interface WindowRecomposerFactory {
    ...
    public static final class Companion {
        ...
        @p4.l
        private static final WindowRecomposerFactory LifecycleAware = new WindowRecomposerFactory() { // from class: androidx.compose.ui.platform.j2
    ...
    @p4.l
    Recomposer createRecomposer(@p4.l View view);
}
