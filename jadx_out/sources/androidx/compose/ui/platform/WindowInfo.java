...
public interface WindowInfo {
    ...
    static /* synthetic */ void m5352getKeyboardModifiersk7X9c1A$annotations() {
    }

    @ExperimentalComposeUiApi
    /* renamed from: getKeyboardModifiers-k7X9c1A, reason: not valid java name */
    default int mo5353getKeyboardModifiersk7X9c1A() {
        return WindowInfoImpl.Companion.getGlobalKeyboardModifiers$ui_release().getValue().m4940unboximpl();
    }
