...
public interface ViewRootForInspector {
    ...
    public static final class DefaultImpls {
        @Deprecated
        @p4.m
        public static AbstractComposeView getSubCompositionView(@p4.l ViewRootForInspector viewRootForInspector) {
            return ViewRootForInspector.super.getSubCompositionView();
        }

        @Deprecated
        @p4.m
        public static View getViewRoot(@p4.l ViewRootForInspector viewRootForInspector) {
