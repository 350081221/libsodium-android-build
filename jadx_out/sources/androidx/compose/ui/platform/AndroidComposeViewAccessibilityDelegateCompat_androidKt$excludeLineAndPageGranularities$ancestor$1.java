...
final class AndroidComposeViewAccessibilityDelegateCompat_androidKt$excludeLineAndPageGranularities$ancestor$1 extends kotlin.jvm.internal.n0 implements v3.l<LayoutNode, Boolean> {
    ...
    public final Boolean invoke(@p4.l LayoutNode layoutNode) {
        ...
        return Boolean.valueOf((collapsedSemantics$ui_release != null && collapsedSemantics$ui_release.isMergingSemanticsOfDescendants()) && collapsedSemantics$ui_release.contains(SemanticsActions.INSTANCE.getSetText()));
    }
}
