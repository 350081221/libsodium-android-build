...
public final class AndroidClipboardManager_androidKt {
    ...
    @p4.m
    public static final AnnotatedString convertToAnnotatedString(@p4.m CharSequence charSequence) {
        int we;
        ...
        we = kotlin.collections.p.we(annotationArr);
        if (we >= 0) {
            while (true) {
    ...
    @p4.l
    public static final CharSequence convertToCharSequence(@p4.l AnnotatedString annotatedString) {
