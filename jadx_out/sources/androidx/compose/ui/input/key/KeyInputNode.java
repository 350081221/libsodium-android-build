...
final class KeyInputNode extends Modifier.Node implements KeyInputModifierNode {
    ...
    public KeyInputNode(@m l<? super KeyEvent, Boolean> lVar, @m l<? super KeyEvent, Boolean> lVar2) {
        this.onEvent = lVar;
    ...
    public boolean mo169onKeyEventZmokQxo(@p4.l android.view.KeyEvent keyEvent) {
    ...
    public boolean mo171onPreKeyEventZmokQxo(@p4.l android.view.KeyEvent keyEvent) {
