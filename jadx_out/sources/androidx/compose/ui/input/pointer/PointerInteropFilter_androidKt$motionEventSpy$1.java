...
@f(c = "androidx.compose.ui.input.pointer.PointerInteropFilter_androidKt$motionEventSpy$1", f = "PointerInteropFilter.android.kt", i = {}, l = {345}, m = "invokeSuspend", n = {}, s = {})
@i0(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\u0010\u0002\u001a\u00020\u0001*\u00020\u0000H\u008a@"}, d2 = {"Landroidx/compose/ui/input/pointer/PointerInputScope;", "Lkotlin/r2;", "<anonymous>"}, k = 3, mv = {1, 8, 0})
/* loaded from: classes.dex */
final class PointerInteropFilter_androidKt$motionEventSpy$1 extends o implements p<PointerInputScope, d<? super r2>, Object> {
    final /* synthetic */ l<MotionEvent, r2> $watcher;
    private /* synthetic */ Object L$0;
    int label;

    /* JADX INFO: Access modifiers changed from: package-private */
    @f(c = "androidx.compose.ui.input.pointer.PointerInteropFilter_androidKt$motionEventSpy$1$1", f = "PointerInteropFilter.android.kt", i = {0}, l = {347}, m = "invokeSuspend", n = {"$this$awaitPointerEventScope"}, s = {"L$0"})
    ...
    public static final class AnonymousClass1 extends k implements p<AwaitPointerEventScope, d<? super r2>, Object> {
        ...
        AnonymousClass1(l<? super MotionEvent, r2> lVar, d<? super AnonymousClass1> dVar) {
            super(2, dVar);
            this.$watcher = lVar;
        }
        ...
        */
        public final java.lang.Object invokeSuspend(@p4.l java.lang.Object r7) {
            ...
            L39:
                ...
                if (r7 == 0) goto L46
                v3.l<android.view.MotionEvent, kotlin.r2> r4 = r0.$watcher
                r4.invoke(r7)
            L46:
                r7 = r0
                r0 = r1
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public PointerInteropFilter_androidKt$motionEventSpy$1(l<? super MotionEvent, r2> lVar, d<? super PointerInteropFilter_androidKt$motionEventSpy$1> dVar) {
        super(2, dVar);
        this.$watcher = lVar;
    }
    ...
    public final Object invoke(@p4.l PointerInputScope pointerInputScope, @m d<? super r2> dVar) {
        return ((PointerInteropFilter_androidKt$motionEventSpy$1) create(pointerInputScope, dVar)).invokeSuspend(r2.f19517a);
    }
