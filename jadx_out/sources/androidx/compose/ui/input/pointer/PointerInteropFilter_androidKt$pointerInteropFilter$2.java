...
public final class PointerInteropFilter_androidKt$pointerInteropFilter$2 extends n0 implements q<Modifier, Composer, Integer, Modifier> {
    ...
    public PointerInteropFilter_androidKt$pointerInteropFilter$2(l<? super MotionEvent, Boolean> lVar, RequestDisallowInterceptTouchEvent requestDisallowInterceptTouchEvent) {
        super(3);
    ...
    public final Modifier invoke(@p4.l Modifier modifier, @m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(374375707, i5, -1, "androidx.compose.ui.input.pointer.pointerInteropFilter.<anonymous> (PointerInteropFilter.android.kt:78)");
        }
