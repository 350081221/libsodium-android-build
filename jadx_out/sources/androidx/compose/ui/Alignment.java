...
public interface Alignment {
    ...
    public interface Horizontal {
        int align(int i5, int i6, @l LayoutDirection layoutDirection);
    }
    ...
    public interface Vertical {
        int align(int i5, int i6);
    }

    /* renamed from: align-KFBX0sM, reason: not valid java name */
    long mo3370alignKFBX0sM(long j5, long j6, @l LayoutDirection layoutDirection);
}
