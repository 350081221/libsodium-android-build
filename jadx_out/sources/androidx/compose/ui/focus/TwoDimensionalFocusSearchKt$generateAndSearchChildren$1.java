...
public final class TwoDimensionalFocusSearchKt$generateAndSearchChildren$1 extends n0 implements l<BeyondBoundsLayout.BeyondBoundsScope, Boolean> {
    ...
    public TwoDimensionalFocusSearchKt$generateAndSearchChildren$1(FocusTargetNode focusTargetNode, FocusTargetNode focusTargetNode2, int i5, l<? super FocusTargetNode, Boolean> lVar) {
        super(1);
    ...
    public final Boolean invoke(@p4.l BeyondBoundsLayout.BeyondBoundsScope beyondBoundsScope) {
        boolean m3457searchChildren4C6V_qg;
        m3457searchChildren4C6V_qg = TwoDimensionalFocusSearchKt.m3457searchChildren4C6V_qg(this.$this_generateAndSearchChildren, this.$focusedItem, this.$direction, this.$onFound);
        Boolean valueOf = Boolean.valueOf(m3457searchChildren4C6V_qg);
