...
public final class Rect {
    ...
    public static /* synthetic */ void m3518getSizeNHjbRc$annotations() {
    }
    ...
    public final boolean m3519containsk4lQ0M(long j5) {
    ...
    @l
    public final Rect copy(float f5, float f6, float f7, float f8) {
        return new Rect(f5, f6, f7, f8);
    }

    @Stable
    @l
    public final Rect deflate(float f5) {
        return inflate(-f5);
    }
    ...
    public final long m3526getSizeNHjbRc() {
    ...
    public final long m3527getTopCenterF1C5BW0() {
        return OffsetKt.Offset(this.left + (getWidth() / 2.0f), this.top);
    }

    /* renamed from: getTopLeft-F1C5BW0, reason: not valid java name */
    public final long m3528getTopLeftF1C5BW0() {
        return OffsetKt.Offset(this.left, this.top);
    }

    /* renamed from: getTopRight-F1C5BW0, reason: not valid java name */
    public final long m3529getTopRightF1C5BW0() {
    ...
    @Stable
    @l
    public final Rect inflate(float f5) {
        return new Rect(this.left - f5, this.top - f5, this.right + f5, this.bottom + f5);
    }

    @Stable
    @l
    public final Rect intersect(@l Rect rect) {
    ...
    public final boolean overlaps(@l Rect rect) {
    ...
    @Stable
    @l
    public final Rect translate(float f5, float f6) {
        return new Rect(this.left + f5, this.top + f6, this.right + f5, this.bottom + f6);
    }

    @Stable
    @l
    /* renamed from: translate-k-4lQ0M, reason: not valid java name */
    public final Rect m3530translatek4lQ0M(long j5) {
        return new Rect(this.left + Offset.m3493getXimpl(j5), this.top + Offset.m3494getYimpl(j5), this.right + Offset.m3493getXimpl(j5), this.bottom + Offset.m3494getYimpl(j5));
    }

    @Stable
    @l
    public final Rect intersect(float f5, float f6, float f7, float f8) {
        return new Rect(Math.max(this.left, f5), Math.max(this.top, f6), Math.min(this.right, f7), Math.min(this.bottom, f8));
    }
}
