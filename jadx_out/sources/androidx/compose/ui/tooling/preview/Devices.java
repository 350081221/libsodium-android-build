...
public final class Devices {
    ...
    @k(message = "Use [androidx.wear.tooling.preview.devices.WearDevices.LARGE_ROUND] from the wear:wear-tooling-preview library instead")
    public static /* synthetic */ void getWEAR_OS_LARGE_ROUND$annotations() {
    }

    @k(message = "Use [androidx.wear.tooling.preview.devices.WearDevices.RECT] from the wear:wear-tooling-preview library instead")
    public static /* synthetic */ void getWEAR_OS_RECT$annotations() {
    }

    @k(message = "Use [androidx.wear.tooling.preview.devices.WearDevices.SMALL_ROUND] from the wear:wear-tooling-preview library instead")
    public static /* synthetic */ void getWEAR_OS_SMALL_ROUND$annotations() {
    }

    @k(message = "Use [androidx.wear.tooling.preview.devices.WearDevices.SQUARE] from the wear:wear-tooling-preview library instead")
