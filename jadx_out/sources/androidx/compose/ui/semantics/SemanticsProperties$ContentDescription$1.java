...
final class SemanticsProperties$ContentDescription$1 extends n0 implements p<List<? extends String>, List<? extends String>, List<? extends String>> {
    ...
    */
    public final java.util.List<java.lang.String> invoke2(@p4.m java.util.List<java.lang.String> r1, @p4.l java.util.List<java.lang.String> r2) {
        /*
            r0 = this;
            if (r1 == 0) goto L10
