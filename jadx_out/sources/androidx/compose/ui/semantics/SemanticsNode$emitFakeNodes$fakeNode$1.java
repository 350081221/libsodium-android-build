...
final class SemanticsNode$emitFakeNodes$fakeNode$1 extends n0 implements l<SemanticsPropertyReceiver, r2> {
    ...
    public final void invoke2(@p4.l SemanticsPropertyReceiver semanticsPropertyReceiver) {
        SemanticsPropertiesKt.m5389setRolekuIjeqM(semanticsPropertyReceiver, this.$nodeRole.m5372unboximpl());
    }
}
