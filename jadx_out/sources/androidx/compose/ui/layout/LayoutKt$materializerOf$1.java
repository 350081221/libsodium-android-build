...
public final class LayoutKt$materializerOf$1 extends n0 implements q<SkippableUpdater<ComposeUiNode>, Composer, Integer, r2> {
    ...
    public /* bridge */ /* synthetic */ r2 invoke(SkippableUpdater<ComposeUiNode> skippableUpdater, Composer composer, Integer num) {
        m5012invokeDeg8D_g(skippableUpdater.m3262unboximpl(), composer, num.intValue());
        return r2.f19517a;
    }

    @Composable
    /* renamed from: invoke-Deg8D_g, reason: not valid java name */
    public final void m5012invokeDeg8D_g(@l Composer composer, @m Composer composer2, int i5) {
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1586257396, i5, -1, "androidx.compose.ui.layout.materializerOf.<anonymous> (Layout.kt:203)");
        }
