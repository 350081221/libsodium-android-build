...
final class OnPlacedNode extends Modifier.Node implements LayoutAwareModifierNode {
    ...
    public OnPlacedNode(@l v3.l<? super LayoutCoordinates, r2> lVar) {
        this.callback = lVar;
    }
