...
public final class AlignmentLineKt {
    ...
    public static final int merge(@l AlignmentLine alignmentLine, int i5, int i6) {
        return alignmentLine.getMerger$ui_release().invoke(Integer.valueOf(i5), Integer.valueOf(i6)).intValue();
    }
}
