...
public final class LayoutKt$MultiMeasureLayout$2 extends n0 implements p<Composer, Integer, r2> {
    ...
    public LayoutKt$MultiMeasureLayout$2(Modifier modifier, p<? super Composer, ? super Integer, r2> pVar, MeasurePolicy measurePolicy, int i5, int i6) {
        super(2);
