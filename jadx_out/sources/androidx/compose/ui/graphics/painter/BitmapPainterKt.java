...
public final class BitmapPainterKt {
    ...
    public static final BitmapPainter m4349BitmapPainterQZhYCtY(@l ImageBitmap imageBitmap, long j5, long j6, int i5) {
        BitmapPainter bitmapPainter = new BitmapPainter(imageBitmap, j5, j6, null);
        bitmapPainter.m4348setFilterQualityvDHp3xo$ui_graphics_release(i5);
        return bitmapPainter;
    }

    /* renamed from: BitmapPainter-QZhYCtY$default, reason: not valid java name */
    public static /* synthetic */ BitmapPainter m4350BitmapPainterQZhYCtY$default(ImageBitmap imageBitmap, long j5, long j6, int i5, int i6, Object obj) {
        if ((i6 & 2) != 0) {
        ...
        long j8 = j6;
        if ((i6 & 8) != 0) {
            i5 = FilterQuality.Companion.m3833getLowfv9h1I();
        }
        return m4349BitmapPainterQZhYCtY(imageBitmap, j7, j8, i5);
    }
}
