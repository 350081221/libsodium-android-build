...
public final class AndroidColorSpace_androidKt {
    @p4.l
    @RequiresApi(26)
    public static final ColorSpace toAndroidColorSpace(@p4.l androidx.compose.ui.graphics.colorspace.ColorSpace colorSpace) {
    ...
    @p4.l
    @RequiresApi(26)
    public static final androidx.compose.ui.graphics.colorspace.ColorSpace toComposeColorSpace(@p4.l ColorSpace colorSpace) {
        ColorSpaceVerificationHelper colorSpaceVerificationHelper = ColorSpaceVerificationHelper.INSTANCE;
