...
public final class AndroidPaint implements Paint {
    ...
    public AndroidPaint(@p4.l android.graphics.Paint paint) {
        this.internalPaint = paint;
        this._blendMode = BlendMode.Companion.m3676getSrcOver0nO6VwU();
    }
    ...
    public int mo3606getBlendMode0nO6VwU() {
        return this._blendMode;
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: getColor-0d7_KjU, reason: not valid java name */
    public long mo3607getColor0d7_KjU() {
    ...
    public int mo3608getFilterQualityfv9h1I() {
    ...
    public int mo3611getStyleTiuSbCo() {
    ...
    public void setAntiAlias(boolean z4) {
        AndroidPaint_androidKt.setNativeAntiAlias(this.internalPaint, z4);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setBlendMode-s9anfk8, reason: not valid java name */
    public void mo3612setBlendModes9anfk8(int i5) {
        if (!BlendMode.m3645equalsimpl0(this._blendMode, i5)) {
            this._blendMode = i5;
            AndroidPaint_androidKt.m3618setNativeBlendModeGB0RdKg(this.internalPaint, i5);
        }
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setColor-8_81llA, reason: not valid java name */
    public void mo3613setColor8_81llA(long j5) {
        AndroidPaint_androidKt.m3619setNativeColor4WTKRHQ(this.internalPaint, j5);
    }
    ...
    public void mo3614setFilterQualityvDHp3xo(int i5) {
        AndroidPaint_androidKt.m3620setNativeFilterQuality50PEsBU(this.internalPaint, i5);
    }

    @Override // androidx.compose.ui.graphics.Paint
    public void setPathEffect(@p4.m PathEffect pathEffect) {
        AndroidPaint_androidKt.setNativePathEffect(this.internalPaint, pathEffect);
        this.pathEffect = pathEffect;
    }

    @Override // androidx.compose.ui.graphics.Paint
    public void setShader(@p4.m Shader shader) {
    ...
    public void mo3615setStrokeCapBeK7IIE(int i5) {
        AndroidPaint_androidKt.m3621setNativeStrokeCapCSYIeUk(this.internalPaint, i5);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStrokeJoin-Ww9F2mQ, reason: not valid java name */
    public void mo3616setStrokeJoinWw9F2mQ(int i5) {
        AndroidPaint_androidKt.m3622setNativeStrokeJoinkLtJ_vA(this.internalPaint, i5);
    }
    ...
    public void mo3617setStylek9PVt8s(int i5) {
        AndroidPaint_androidKt.m3623setNativeStyle5YerkU(this.internalPaint, i5);
    }
