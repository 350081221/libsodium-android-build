...
public final class AndroidVertexMode_androidKt {
    ...
    public static final Canvas.VertexMode m3640toAndroidVertexModeJOOmi9M(int i5) {
        VertexMode.Companion companion = VertexMode.Companion;
        if (VertexMode.m4127equalsimpl0(i5, companion.m4133getTrianglesc2xauaI())) {
            return Canvas.VertexMode.TRIANGLES;
        }
        if (VertexMode.m4127equalsimpl0(i5, companion.m4132getTriangleStripc2xauaI())) {
            return Canvas.VertexMode.TRIANGLE_STRIP;
        }
        if (VertexMode.m4127equalsimpl0(i5, companion.m4131getTriangleFanc2xauaI())) {
