...
public interface PathEffect {
    ...
    public static final class Companion {
        ...
        @p4.l
        public final PathEffect chainPathEffect(@p4.l PathEffect pathEffect, @p4.l PathEffect pathEffect2) {
            return AndroidPathEffect_androidKt.actualChainPathEffect(pathEffect, pathEffect2);
        }

        @p4.l
        public final PathEffect cornerPathEffect(float f5) {
            return AndroidPathEffect_androidKt.actualCornerPathEffect(f5);
        }

        @p4.l
        public final PathEffect dashPathEffect(@p4.l float[] fArr, float f5) {
            return AndroidPathEffect_androidKt.actualDashPathEffect(fArr, f5);
        }

        @p4.l
        /* renamed from: stampedPathEffect-7aD1DOk, reason: not valid java name */
        public final PathEffect m4007stampedPathEffect7aD1DOk(@p4.l Path path, float f5, float f6, int i5) {
            return AndroidPathEffect_androidKt.m3630actualStampedPathEffect7aD1DOk(path, f5, f6, i5);
        }
    }
}
