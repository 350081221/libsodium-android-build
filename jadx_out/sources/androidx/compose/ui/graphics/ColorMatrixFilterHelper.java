...
final class ColorMatrixFilterHelper {
    ...
    public final float[] m3814getColorMatrix8unuwjk(@p4.l android.graphics.ColorMatrixColorFilter colorMatrixColorFilter) {
        android.graphics.ColorMatrix colorMatrix = new android.graphics.ColorMatrix();
        colorMatrixColorFilter.getColorMatrix(colorMatrix);
        return ColorMatrix.m3790constructorimpl(colorMatrix.getArray());
    }
}
