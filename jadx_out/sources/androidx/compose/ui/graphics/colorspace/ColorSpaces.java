...
public final class ColorSpaces {
    ...
    @p4.l
    public final ColorSpace getColorSpace$ui_graphics_release(int i5) {
        return getColorSpacesArray$ui_graphics_release()[i5];
    }
    ...
    @p4.m
    public final ColorSpace match(@p4.l @Size(9) float[] fArr, @p4.l TransferParameters transferParameters) {
        for (ColorSpace colorSpace : ColorSpacesArray) {
            if (ColorModel.m4139equalsimpl0(colorSpace.m4148getModelxdoWZVw(), ColorModel.Companion.m4146getRgbxdoWZVw())) {
                ...
                l0.n(adapt$default, "null cannot be cast to non-null type androidx.compose.ui.graphics.colorspace.Rgb");
