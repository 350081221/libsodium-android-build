...
public interface VectorConfig {
    ...
    public static final class DefaultImpls {
        @Deprecated
        public static <T> T getOrDefault(@l VectorConfig vectorConfig, @l VectorProperty<T> vectorProperty, T t5) {
            return (T) VectorConfig.super.getOrDefault(vectorProperty, t5);
        }
    }

    default <T> T getOrDefault(@l VectorProperty<T> vectorProperty, T t5) {
        return t5;
    }
}
