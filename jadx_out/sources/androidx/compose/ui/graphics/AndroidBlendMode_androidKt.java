...
public final class AndroidBlendMode_androidKt {
    ...
    public static final boolean m3584isSupporteds9anfk8(int i5) {
        if (Build.VERSION.SDK_INT < 29 && !BlendMode.m3645equalsimpl0(i5, BlendMode.Companion.m3676getSrcOver0nO6VwU()) && m3586toPorterDuffModes9anfk8(i5) == PorterDuff.Mode.SRC_OVER) {
            return false;
        }
        return true;
    }
    ...
    public static final android.graphics.BlendMode m3585toAndroidBlendModes9anfk8(int i5) {
        android.graphics.BlendMode blendMode;
        android.graphics.BlendMode blendMode2;
        android.graphics.BlendMode blendMode3;
        android.graphics.BlendMode blendMode4;
        ...
        if (BlendMode.m3645equalsimpl0(i5, companion.m3649getClear0nO6VwU())) {
            blendMode30 = android.graphics.BlendMode.CLEAR;
            return blendMode30;
        }
        if (BlendMode.m3645equalsimpl0(i5, companion.m3672getSrc0nO6VwU())) {
            blendMode29 = android.graphics.BlendMode.SRC;
            return blendMode29;
        }
        if (BlendMode.m3645equalsimpl0(i5, companion.m3655getDst0nO6VwU())) {
            blendMode28 = android.graphics.BlendMode.DST;
            return blendMode28;
        }
        if (BlendMode.m3645equalsimpl0(i5, companion.m3676getSrcOver0nO6VwU())) {
            blendMode27 = android.graphics.BlendMode.SRC_OVER;
            return blendMode27;
        }
        if (BlendMode.m3645equalsimpl0(i5, companion.m3659getDstOver0nO6VwU())) {
            blendMode26 = android.graphics.BlendMode.DST_OVER;
            return blendMode26;
        }
        if (BlendMode.m3645equalsimpl0(i5, companion.m3674getSrcIn0nO6VwU())) {
            blendMode25 = android.graphics.BlendMode.SRC_IN;
            return blendMode25;
        }
        if (BlendMode.m3645equalsimpl0(i5, companion.m3657getDstIn0nO6VwU())) {
            blendMode24 = android.graphics.BlendMode.DST_IN;
            return blendMode24;
        }
        if (BlendMode.m3645equalsimpl0(i5, companion.m3675getSrcOut0nO6VwU())) {
            blendMode23 = android.graphics.BlendMode.SRC_OUT;
            return blendMode23;
        }
        if (BlendMode.m3645equalsimpl0(i5, companion.m3658getDstOut0nO6VwU())) {
            blendMode22 = android.graphics.BlendMode.DST_OUT;
            return blendMode22;
        }
        if (BlendMode.m3645equalsimpl0(i5, companion.m3673getSrcAtop0nO6VwU())) {
            blendMode21 = android.graphics.BlendMode.SRC_ATOP;
            return blendMode21;
        }
        if (BlendMode.m3645equalsimpl0(i5, companion.m3656getDstAtop0nO6VwU())) {
            blendMode20 = android.graphics.BlendMode.DST_ATOP;
            return blendMode20;
        }
        if (BlendMode.m3645equalsimpl0(i5, companion.m3677getXor0nO6VwU())) {
            blendMode19 = android.graphics.BlendMode.XOR;
            return blendMode19;
        }
        if (BlendMode.m3645equalsimpl0(i5, companion.m3668getPlus0nO6VwU())) {
            blendMode18 = android.graphics.BlendMode.PLUS;
            return blendMode18;
        }
        if (BlendMode.m3645equalsimpl0(i5, companion.m3665getModulate0nO6VwU())) {
            blendMode17 = android.graphics.BlendMode.MODULATE;
            return blendMode17;
        }
        if (BlendMode.m3645equalsimpl0(i5, companion.m3670getScreen0nO6VwU())) {
            blendMode16 = android.graphics.BlendMode.SCREEN;
            return blendMode16;
        }
        if (BlendMode.m3645equalsimpl0(i5, companion.m3667getOverlay0nO6VwU())) {
            blendMode15 = android.graphics.BlendMode.OVERLAY;
            return blendMode15;
        }
        if (BlendMode.m3645equalsimpl0(i5, companion.m3653getDarken0nO6VwU())) {
            blendMode14 = android.graphics.BlendMode.DARKEN;
            return blendMode14;
        }
        if (BlendMode.m3645equalsimpl0(i5, companion.m3663getLighten0nO6VwU())) {
            blendMode13 = android.graphics.BlendMode.LIGHTEN;
            return blendMode13;
        }
        if (BlendMode.m3645equalsimpl0(i5, companion.m3652getColorDodge0nO6VwU())) {
            blendMode12 = android.graphics.BlendMode.COLOR_DODGE;
            return blendMode12;
        }
        if (BlendMode.m3645equalsimpl0(i5, companion.m3651getColorBurn0nO6VwU())) {
            blendMode11 = android.graphics.BlendMode.COLOR_BURN;
            return blendMode11;
        }
        if (BlendMode.m3645equalsimpl0(i5, companion.m3661getHardlight0nO6VwU())) {
            blendMode10 = android.graphics.BlendMode.HARD_LIGHT;
            return blendMode10;
        }
        if (BlendMode.m3645equalsimpl0(i5, companion.m3671getSoftlight0nO6VwU())) {
            blendMode9 = android.graphics.BlendMode.SOFT_LIGHT;
            return blendMode9;
        }
        if (BlendMode.m3645equalsimpl0(i5, companion.m3654getDifference0nO6VwU())) {
            blendMode8 = android.graphics.BlendMode.DIFFERENCE;
            return blendMode8;
        }
        if (BlendMode.m3645equalsimpl0(i5, companion.m3660getExclusion0nO6VwU())) {
            blendMode7 = android.graphics.BlendMode.EXCLUSION;
            return blendMode7;
        }
        if (BlendMode.m3645equalsimpl0(i5, companion.m3666getMultiply0nO6VwU())) {
            blendMode6 = android.graphics.BlendMode.MULTIPLY;
            return blendMode6;
        }
        if (BlendMode.m3645equalsimpl0(i5, companion.m3662getHue0nO6VwU())) {
            blendMode5 = android.graphics.BlendMode.HUE;
            return blendMode5;
        }
        if (BlendMode.m3645equalsimpl0(i5, companion.m3669getSaturation0nO6VwU())) {
            blendMode4 = android.graphics.BlendMode.SATURATION;
            return blendMode4;
        }
        if (BlendMode.m3645equalsimpl0(i5, companion.m3650getColor0nO6VwU())) {
            blendMode3 = android.graphics.BlendMode.COLOR;
            return blendMode3;
        }
        if (BlendMode.m3645equalsimpl0(i5, companion.m3664getLuminosity0nO6VwU())) {
    ...
    @RequiresApi(29)
    public static final int toComposeBlendMode(@p4.l android.graphics.BlendMode blendMode) {
        int ordinal;
        int[] iArr = WhenMappings.$EnumSwitchMapping$0;
        ordinal = blendMode.ordinal();
        switch (iArr[ordinal]) {
            case 1:
                return BlendMode.Companion.m3649getClear0nO6VwU();
            case 2:
                return BlendMode.Companion.m3672getSrc0nO6VwU();
            case 3:
                return BlendMode.Companion.m3655getDst0nO6VwU();
            case 4:
                return BlendMode.Companion.m3676getSrcOver0nO6VwU();
            case 5:
                return BlendMode.Companion.m3659getDstOver0nO6VwU();
            case 6:
                return BlendMode.Companion.m3674getSrcIn0nO6VwU();
            case 7:
                return BlendMode.Companion.m3657getDstIn0nO6VwU();
            case 8:
                return BlendMode.Companion.m3675getSrcOut0nO6VwU();
            case 9:
                return BlendMode.Companion.m3658getDstOut0nO6VwU();
            case 10:
                return BlendMode.Companion.m3673getSrcAtop0nO6VwU();
            case 11:
                return BlendMode.Companion.m3656getDstAtop0nO6VwU();
            case 12:
                return BlendMode.Companion.m3677getXor0nO6VwU();
            case 13:
                return BlendMode.Companion.m3668getPlus0nO6VwU();
            case 14:
                return BlendMode.Companion.m3665getModulate0nO6VwU();
            case 15:
                return BlendMode.Companion.m3670getScreen0nO6VwU();
            case 16:
                return BlendMode.Companion.m3667getOverlay0nO6VwU();
            case 17:
                return BlendMode.Companion.m3653getDarken0nO6VwU();
            case 18:
                return BlendMode.Companion.m3663getLighten0nO6VwU();
            case 19:
                return BlendMode.Companion.m3652getColorDodge0nO6VwU();
            case 20:
                return BlendMode.Companion.m3651getColorBurn0nO6VwU();
            case 21:
                return BlendMode.Companion.m3661getHardlight0nO6VwU();
            case 22:
                return BlendMode.Companion.m3671getSoftlight0nO6VwU();
            case 23:
                return BlendMode.Companion.m3654getDifference0nO6VwU();
            case 24:
                return BlendMode.Companion.m3660getExclusion0nO6VwU();
            case 25:
                return BlendMode.Companion.m3666getMultiply0nO6VwU();
            case 26:
                return BlendMode.Companion.m3662getHue0nO6VwU();
            case 27:
                return BlendMode.Companion.m3669getSaturation0nO6VwU();
            case 28:
                return BlendMode.Companion.m3650getColor0nO6VwU();
            case 29:
                return BlendMode.Companion.m3664getLuminosity0nO6VwU();
            default:
                return BlendMode.Companion.m3676getSrcOver0nO6VwU();
        }
    }
    ...
    public static final PorterDuff.Mode m3586toPorterDuffModes9anfk8(int i5) {
        BlendMode.Companion companion = BlendMode.Companion;
        if (BlendMode.m3645equalsimpl0(i5, companion.m3649getClear0nO6VwU())) {
