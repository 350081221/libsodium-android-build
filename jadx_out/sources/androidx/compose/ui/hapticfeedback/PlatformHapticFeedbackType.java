...
public final class PlatformHapticFeedbackType {
    ...
    private static final int LongPress = HapticFeedbackType.m4401constructorimpl(0);
    private static final int TextHandleMove = HapticFeedbackType.m4401constructorimpl(9);

    private PlatformHapticFeedbackType() {
    }

    /* renamed from: getLongPress-5zf0vsI, reason: not valid java name */
    public final int m4409getLongPress5zf0vsI() {
        return LongPress;
    }

    /* renamed from: getTextHandleMove-5zf0vsI, reason: not valid java name */
    public final int m4410getTextHandleMove5zf0vsI() {
