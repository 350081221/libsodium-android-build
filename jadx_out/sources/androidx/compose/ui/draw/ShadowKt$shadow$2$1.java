...
final class ShadowKt$shadow$2$1 extends n0 implements l<GraphicsLayerScope, r2> {
    ...
    public ShadowKt$shadow$2$1(float f5, Shape shape, boolean z4, long j5, long j6) {
        super(1);
        this.$elevation = f5;
        this.$shape = shape;
        this.$clip = z4;
    ...
    public final void invoke2(@p4.l GraphicsLayerScope graphicsLayerScope) {
        graphicsLayerScope.setShadowElevation(graphicsLayerScope.mo304toPx0680j_4(this.$elevation));
        graphicsLayerScope.setShape(this.$shape);
        graphicsLayerScope.setClip(this.$clip);
        graphicsLayerScope.mo3923setAmbientShadowColor8_81llA(this.$ambientColor);
        graphicsLayerScope.mo3925setSpotShadowColor8_81llA(this.$spotColor);
    }
}
