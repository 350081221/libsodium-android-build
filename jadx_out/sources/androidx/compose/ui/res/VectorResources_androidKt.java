...
public final class VectorResources_androidKt {
    @l
    public static final ImageVectorCache.ImageVectorEntry loadVectorResourceInner(@m Resources.Theme theme, @l Resources resources, @l XmlResourceParser xmlResourceParser, int i5) throws XmlPullParserException {
    ...
    public static /* synthetic */ ImageVectorCache.ImageVectorEntry loadVectorResourceInner$default(Resources.Theme theme, Resources resources, XmlResourceParser xmlResourceParser, int i5, int i6, Object obj) throws XmlPullParserException {
        if ((i6 & 1) != 0) {
            theme = null;
        }
        return loadVectorResourceInner(theme, resources, xmlResourceParser, i5);
    }

    @l
    @Composable
    public static final ImageVector vectorResource(@l ImageVector.Companion companion, @DrawableRes int i5, @m Composer composer, int i6) {
        composer.startReplaceableGroup(44534090);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(44534090, i6, -1, "androidx.compose.ui.res.vectorResource (VectorResources.android.kt:47)");
        }
        Context context = (Context) composer.consume(AndroidCompositionLocals_androidKt.getLocalContext());
        Resources resources = Resources_androidKt.resources(composer, 0);
        Resources.Theme theme = context.getTheme();
        Object[] objArr = {Integer.valueOf(i5), resources, theme, resources.getConfiguration()};
        ...
        if (z4 || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = vectorResource(companion, theme, resources, i5);
    ...
    public static /* synthetic */ ImageVector vectorResource$default(ImageVector.Companion companion, Resources.Theme theme, Resources resources, int i5, int i6, Object obj) throws XmlPullParserException {
        if ((i6 & 1) != 0) {
            theme = null;
        }
        return vectorResource(companion, theme, resources, i5);
    }

    @l
    public static final ImageVector vectorResource(@l ImageVector.Companion companion, @m Resources.Theme theme, @l Resources resources, int i5) throws XmlPullParserException {
