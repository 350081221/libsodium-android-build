...
public final class IntRect {
    ...
    public static /* synthetic */ void m6190getSizeYbymL2g$annotations() {
    }
    ...
    public final boolean m6191containsgyyYBs(long j5) {
        return IntOffset.m6172getXimpl(j5) >= this.left && IntOffset.m6172getXimpl(j5) < this.right && IntOffset.m6173getYimpl(j5) >= this.top && IntOffset.m6173getYimpl(j5) < this.bottom;
    }
    ...
    public final long m6198getSizeYbymL2g() {
    ...
    public final IntRect inflate(int i5) {
        return new IntRect(this.left - i5, this.top - i5, this.right + i5, this.bottom + i5);
    }
    ...
    public final IntRect translate(int i5, int i6) {
        return new IntRect(this.left + i5, this.top + i6, this.right + i5, this.bottom + i6);
    }

    @Stable
    @l
    /* renamed from: translate--gyyYBs, reason: not valid java name */
    public final IntRect m6202translategyyYBs(long j5) {
        return new IntRect(this.left + IntOffset.m6172getXimpl(j5), this.top + IntOffset.m6173getYimpl(j5), this.right + IntOffset.m6172getXimpl(j5), this.bottom + IntOffset.m6173getYimpl(j5));
    }
}
