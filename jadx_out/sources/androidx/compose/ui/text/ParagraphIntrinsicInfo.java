...
public final class ParagraphIntrinsicInfo {
    ...
    public ParagraphIntrinsicInfo(@l ParagraphIntrinsics paragraphIntrinsics, int i5, int i6) {
    ...
    public static /* synthetic */ ParagraphIntrinsicInfo copy$default(ParagraphIntrinsicInfo paragraphIntrinsicInfo, ParagraphIntrinsics paragraphIntrinsics, int i5, int i6, int i7, Object obj) {
        ...
        if ((i7 & 2) != 0) {
            i5 = paragraphIntrinsicInfo.startIndex;
        }
        if ((i7 & 4) != 0) {
            i6 = paragraphIntrinsicInfo.endIndex;
        }
    ...
    @l
    public final ParagraphIntrinsicInfo copy(@l ParagraphIntrinsics paragraphIntrinsics, int i5, int i6) {
    ...
    public boolean equals(@m Object obj) {
        ...
        return l0.g(this.intrinsics, paragraphIntrinsicInfo.intrinsics) && this.startIndex == paragraphIntrinsicInfo.startIndex && this.endIndex == paragraphIntrinsicInfo.endIndex;
    }
