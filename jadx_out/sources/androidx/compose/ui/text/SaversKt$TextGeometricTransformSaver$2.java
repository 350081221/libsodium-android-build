...
final class SaversKt$TextGeometricTransformSaver$2 extends n0 implements l<Object, TextGeometricTransform> {
    ...
    @Override // v3.l
    @m
    public final TextGeometricTransform invoke(@p4.l Object obj) {
        l0.n(obj, "null cannot be cast to non-null type kotlin.collections.List<kotlin.Float>");
        List list = (List) obj;
