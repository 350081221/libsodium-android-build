...
public final class AndroidFontUtils_androidKt {
    ...
    public static final int getAndroidTypefaceStyle(boolean z4, boolean z5) {
        if (z5 && z4) {
            return 3;
        }
        if (z4) {
    ...
    public static final int m5608getAndroidTypefaceStyleFO1MlWM(@l FontWeight fontWeight, int i5) {
        boolean z4;
        ...
        return getAndroidTypefaceStyle(z4, FontStyle.m5654equalsimpl0(i5, FontStyle.Companion.m5660getItalic_LCdwA()));
    }
}
