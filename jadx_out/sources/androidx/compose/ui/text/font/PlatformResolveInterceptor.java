...
public interface PlatformResolveInterceptor {
    ...
    @m
    default FontFamily interceptFontFamily(@m FontFamily fontFamily) {
        return fontFamily;
    }

    /* renamed from: interceptFontStyle-T2F_aPo, reason: not valid java name */
    default int m5679interceptFontStyleT2F_aPo(int i5) {
        return i5;
    }

    /* renamed from: interceptFontSynthesis-Mscr08Y, reason: not valid java name */
    default int m5680interceptFontSynthesisMscr08Y(int i5) {
        return i5;
    }

    @l
    default FontWeight interceptFontWeight(@l FontWeight fontWeight) {
        return fontWeight;
    }
}
