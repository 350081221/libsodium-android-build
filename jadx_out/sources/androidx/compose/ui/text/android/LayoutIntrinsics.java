...
public final class LayoutIntrinsics {
    ...
    public LayoutIntrinsics(@p4.l CharSequence charSequence, @p4.l TextPaint textPaint, int i5) {
    ...
    public final float getMaxIntrinsicWidth() {
        ...
        if (getBoringMetrics() != null) {
            f5 = Float.valueOf(r0.width);
        } else {
            f5 = null;
        }
        if (f5 == null) {
            CharSequence charSequence = this.charSequence;
            f5 = Float.valueOf((float) Math.ceil(Layout.getDesiredWidth(charSequence, 0, charSequence.length(), this.textPaint)));
        }
        shouldIncreaseMaxIntrinsic = LayoutIntrinsicsKt.shouldIncreaseMaxIntrinsic(f5.floatValue(), this.charSequence, this.textPaint);
        if (shouldIncreaseMaxIntrinsic) {
            f5 = Float.valueOf(f5.floatValue() + 0.5f);
        }
