...
public final class SpannedExtensionsKt {
    public static final boolean hasSpan(@p4.l Spanned spanned, @p4.l Class<?> cls) {
        return spanned.nextSpanTransition(-1, spanned.length(), cls) != spanned.length();
    }

    public static final boolean hasSpan(@p4.l Spanned spanned, @p4.l Class<?> cls, int i5, int i6) {
