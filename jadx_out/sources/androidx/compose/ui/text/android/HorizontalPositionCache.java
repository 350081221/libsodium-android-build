...
final class HorizontalPositionCache {
    ...
    public HorizontalPositionCache(@p4.l TextLayout textLayout) {
    ...
    */
    ...
    public final float getPrimaryDownstream(int i5) {
        return get(i5, false, false, true);
    }

    public final float getPrimaryUpstream(int i5) {
        return get(i5, true, true, true);
    }

    public final float getSecondaryDownstream(int i5) {
        return get(i5, false, false, false);
    }

    public final float getSecondaryUpstream(int i5) {
        return get(i5, true, true, false);
    }
}
