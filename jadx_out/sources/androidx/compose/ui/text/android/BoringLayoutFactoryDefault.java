...
final class BoringLayoutFactoryDefault {
    ...
    @DoNotInline
    @u3.m
    public static final BoringLayout create(@p4.l CharSequence charSequence, @p4.l TextPaint textPaint, int i5, @p4.l Layout.Alignment alignment, float f5, float f6, @p4.l BoringLayout.Metrics metrics, boolean z4, @p4.m TextUtils.TruncateAt truncateAt, int i6) {
        return new BoringLayout(charSequence, textPaint, i5, alignment, f5, f6, metrics, z4, truncateAt, i6);
    }
