...
public final class ParagraphIntrinsicsKt {
    @l
    @k(message = "Font.ResourceLoader is deprecated, instead use FontFamily.Resolver", replaceWith = @b1(expression = "ParagraphIntrinsics(text, style, spanStyles, placeholders, density, fontFamilyResolver", imports = {}))
    public static final ParagraphIntrinsics ParagraphIntrinsics(@l String str, @l TextStyle textStyle, @l List<AnnotatedString.Range<SpanStyle>> list, @l List<AnnotatedString.Range<Placeholder>> list2, @l Density density, @l Font.ResourceLoader resourceLoader) {
    ...
    public static /* synthetic */ ParagraphIntrinsics ParagraphIntrinsics$default(String str, TextStyle textStyle, List list, List list2, Density density, Font.ResourceLoader resourceLoader, int i5, Object obj) {
        if ((i5 & 4) != 0) {
            list = w.E();
        }
        List list3 = list;
    ...
    @l
    public static final ParagraphIntrinsics ParagraphIntrinsics(@l String str, @l TextStyle textStyle, @l List<AnnotatedString.Range<SpanStyle>> list, @l List<AnnotatedString.Range<Placeholder>> list2, @l Density density, @l FontFamily.Resolver resolver) {
