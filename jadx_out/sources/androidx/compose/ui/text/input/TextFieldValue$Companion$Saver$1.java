...
final class TextFieldValue$Companion$Saver$1 extends n0 implements p<SaverScope, TextFieldValue, Object> {
    ...
    public final Object invoke(@l SaverScope saverScope, @l TextFieldValue textFieldValue) {
        ArrayList r5;
        r5 = w.r(SaversKt.save(textFieldValue.getAnnotatedString(), SaversKt.getAnnotatedStringSaver(), saverScope), SaversKt.save(TextRange.m5533boximpl(textFieldValue.m5783getSelectiond9O1mEE()), SaversKt.getSaver(TextRange.Companion), saverScope));
        return r5;
    }
}
