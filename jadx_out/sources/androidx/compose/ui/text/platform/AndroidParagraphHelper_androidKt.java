...
public final class AndroidParagraphHelper_androidKt {
    ...
    @l
    public static final CharSequence createCharSequence(@l String str, float f5, @l TextStyle textStyle, @l List<AnnotatedString.Range<SpanStyle>> list, @l List<AnnotatedString.Range<Placeholder>> list2, @l Density density, @l r<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> rVar, boolean z4) {
        CharSequence charSequence;
        Spannable spannableString;
        if (z4 && EmojiCompat.isConfigured()) {
            charSequence = EmojiCompat.get().process(str);
            l0.m(charSequence);
        } else {
            charSequence = str;
        }
        if (list.isEmpty() && list2.isEmpty() && l0.g(textStyle.getTextIndent(), TextIndent.Companion.getNone()) && TextUnitKt.m6253isUnspecifiedR2X_6o(textStyle.m5584getLineHeightXSAIIZE())) {
            return charSequence;
        }
        ...
        if (l0.g(textStyle.getTextDecoration(), TextDecoration.Companion.getUnderline())) {
        ...
        if (isIncludeFontPaddingEnabled(textStyle) && textStyle.getLineHeightStyle() == null) {
            SpannableExtensions_androidKt.m5814setLineHeightr9BaKPg(spannableString, textStyle.m5584getLineHeightXSAIIZE(), f5, density);
        } else {
            ...
            SpannableExtensions_androidKt.m5813setLineHeightKmRG4DE(spannable, textStyle.m5584getLineHeightXSAIIZE(), f5, density, lineHeightStyle);
        }
    ...
    public static final boolean isIncludeFontPaddingEnabled(@l TextStyle textStyle) {
