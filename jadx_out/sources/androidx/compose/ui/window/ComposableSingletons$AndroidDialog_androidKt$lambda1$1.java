...
final class ComposableSingletons$AndroidDialog_androidKt$lambda1$1 extends n0 implements p<Composer, Integer, r2> {
    ...
    public final void invoke(@m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(210148896, i5, -1, "androidx.compose.ui.window.ComposableSingletons$AndroidDialog_androidKt.lambda-1.<anonymous> (AndroidDialog.android.kt:215)");
        }
        if (ComposerKt.isTraceInProgress()) {
