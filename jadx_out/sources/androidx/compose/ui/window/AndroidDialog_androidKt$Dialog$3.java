...
public final class AndroidDialog_androidKt$Dialog$3 extends n0 implements p<Composer, Integer, r2> {
    ...
    public AndroidDialog_androidKt$Dialog$3(v3.a<r2> aVar, DialogProperties dialogProperties, p<? super Composer, ? super Integer, r2> pVar, int i5, int i6) {
        super(2);
