...
public final class AndroidPopup_androidKt$Popup$9 extends n0 implements p<Composer, Integer, r2> {
    ...
    public AndroidPopup_androidKt$Popup$9(PopupPositionProvider popupPositionProvider, v3.a<r2> aVar, PopupProperties popupProperties, p<? super Composer, ? super Integer, r2> pVar, int i5, int i6) {
        super(2);
