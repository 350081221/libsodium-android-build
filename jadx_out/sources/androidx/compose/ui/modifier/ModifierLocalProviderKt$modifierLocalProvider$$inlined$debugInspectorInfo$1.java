...
public final class ModifierLocalProviderKt$modifierLocalProvider$$inlined$debugInspectorInfo$1 extends n0 implements l<InspectorInfo, r2> {
    ...
    public final void invoke2(@p4.l InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set(DatabaseFileArchive.COLUMN_KEY, this.$key$inlined);
        inspectorInfo.getProperties().set(b.f22420d, this.$value$inlined);
    }
}
