...
public interface LayoutModifierNode extends DelegatableNode {
    default int maxIntrinsicHeight(@l IntrinsicMeasureScope intrinsicMeasureScope, @l IntrinsicMeasurable intrinsicMeasurable, int i5) {
        return NodeMeasuringIntrinsics.INSTANCE.maxHeight$ui_release(new NodeMeasuringIntrinsics.MeasureBlock() { // from class: androidx.compose.ui.node.LayoutModifierNode$maxIntrinsicHeight$1
            ...
            public final MeasureResult mo5003measure3p2s80s(@l MeasureScope measureScope, @l Measurable measurable, long j5) {
                return LayoutModifierNode.this.mo82measure3p2s80s(measureScope, measurable, j5);
            }
    ...
    @l
    /* renamed from: measure-3p2s80s */
    MeasureResult mo82measure3p2s80s(@l MeasureScope measureScope, @l Measurable measurable, long j5);
