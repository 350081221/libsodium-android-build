...
public final class NodeCoordinatorKt {
    ...
    public static final /* synthetic */ Modifier.Node m5201access$nextUntilhw7D004(DelegatableNode delegatableNode, int i5, int i6) {
        return m5202nextUntilhw7D004(delegatableNode, i5, i6);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: nextUntil-hw7D004, reason: not valid java name */
    public static final Modifier.Node m5202nextUntilhw7D004(DelegatableNode delegatableNode, int i5, int i6) {
        Modifier.Node child$ui_release = delegatableNode.getNode().getChild$ui_release();
        if (child$ui_release == null || (child$ui_release.getAggregateChildKindSet$ui_release() & i5) == 0) {
            return null;
        }
