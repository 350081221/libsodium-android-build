...
public final class SwipeToDismissKt$SwipeToDismiss$2$1$1$1 extends n0 implements l<Density, IntOffset> {
    ...
    public /* bridge */ /* synthetic */ IntOffset invoke(Density density) {
        return IntOffset.m6163boximpl(m1462invokeBjo55l4(density));
    }

    /* renamed from: invoke-Bjo55l4, reason: not valid java name */
    public final long m1462invokeBjo55l4(@p4.l Density density) {
        int L0;
        L0 = d.L0(this.$state.getOffset().getValue().floatValue());
