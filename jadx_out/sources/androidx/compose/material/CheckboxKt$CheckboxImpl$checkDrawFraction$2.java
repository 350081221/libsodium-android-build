...
final class CheckboxKt$CheckboxImpl$checkDrawFraction$2 extends n0 implements q<Transition.Segment<ToggleableState>, Composer, Integer, FiniteAnimationSpec<Float>> {
    ...
    public final FiniteAnimationSpec<Float> invoke(@l Transition.Segment<ToggleableState> segment, @m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1707702900, i5, -1, "androidx.compose.material.CheckboxImpl.<anonymous> (Checkbox.kt:267)");
        }
