...
public final class MenuKt$DropdownMenuContent$2 extends n0 implements p<Composer, Integer, r2> {
    ...
    public MenuKt$DropdownMenuContent$2(Modifier modifier, ScrollState scrollState, q<? super ColumnScope, ? super Composer, ? super Integer, r2> qVar) {
        super(2);
