...
final class ThreeLine$ListItem$1$2 extends n0 implements p<Composer, Integer, r2> {
    ...
    public ThreeLine$ListItem$1$2(p<? super Composer, ? super Integer, r2> pVar, p<? super Composer, ? super Integer, r2> pVar2, p<? super Composer, ? super Integer, r2> pVar3) {
        super(2);
    ...
    public final void invoke(@m Composer composer, int i5) {
        ...
        p<Composer, Integer, r2> pVar = this.$overlineText;
        if (pVar != null) {
