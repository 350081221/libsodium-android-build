...
final class BottomSheetScaffoldKt$BottomSheet$3 extends n0 implements p<Composer, Integer, r2> {
    final /* synthetic */ q<ColumnScope, Composer, Integer, r2> $content;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public BottomSheetScaffoldKt$BottomSheet$3(q<? super ColumnScope, ? super Composer, ? super Integer, r2> qVar) {
        super(2);
        this.$content = qVar;
    }
    ...
    public final void invoke(@m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1944994153, i5, -1, "androidx.compose.material.BottomSheet.<anonymous> (BottomSheetScaffold.kt:653)");
        }
