...
final class ComposableSingletons$ScaffoldKt$lambda7$1 extends n0 implements q<SnackbarHostState, Composer, Integer, r2> {
    ...
    public final void invoke(@l SnackbarHostState snackbarHostState, @m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-147687984, i5, -1, "androidx.compose.material.ComposableSingletons$ScaffoldKt.lambda-7.<anonymous> (Scaffold.kt:318)");
        }
