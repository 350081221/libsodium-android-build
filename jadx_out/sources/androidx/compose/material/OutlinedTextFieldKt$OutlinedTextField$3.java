...
final class OutlinedTextFieldKt$OutlinedTextField$3 extends n0 implements q<p<? super Composer, ? super Integer, ? extends r2>, Composer, Integer, r2> {
    ...
    public static final class AnonymousClass1 extends n0 implements p<Composer, Integer, r2> {
        ...
        public final void invoke(@m Composer composer, int i5) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1823843281, i5, -1, "androidx.compose.material.OutlinedTextField.<anonymous>.<anonymous> (OutlinedTextField.kt:208)");
            }
    ...
    public final void invoke(@l p<? super Composer, ? super Integer, r2> pVar, @m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1710364390, i6, -1, "androidx.compose.material.OutlinedTextField.<anonymous> (OutlinedTextField.kt:194)");
        }
        ...
        textFieldDefaults.OutlinedTextFieldDecorationBox(str, pVar, z4, z5, visualTransformation, mutableInteractionSource, z6, pVar2, pVar3, pVar4, pVar5, textFieldColors, null, ComposableLambdaKt.composableLambda(composer, -1823843281, true, new AnonymousClass1(z4, z6, mutableInteractionSource, textFieldColors, this.$shape)), composer, (i7 << 3) & 112, 27648, 4096);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
    }
