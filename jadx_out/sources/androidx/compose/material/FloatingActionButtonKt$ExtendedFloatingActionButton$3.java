...
public final class FloatingActionButtonKt$ExtendedFloatingActionButton$3 extends n0 implements p<Composer, Integer, r2> {
    ...
    public FloatingActionButtonKt$ExtendedFloatingActionButton$3(p<? super Composer, ? super Integer, r2> pVar, a<r2> aVar, Modifier modifier, p<? super Composer, ? super Integer, r2> pVar2, MutableInteractionSource mutableInteractionSource, Shape shape, long j5, long j6, FloatingActionButtonElevation floatingActionButtonElevation, int i5, int i6) {
        super(2);
        this.$text = pVar;
        this.$onClick = aVar;
