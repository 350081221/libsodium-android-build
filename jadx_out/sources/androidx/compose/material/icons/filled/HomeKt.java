...
public final class HomeKt {
    ...
    @l
    public static final ImageVector getHome(@l Icons.Filled filled) {
        ImageVector imageVector = _home;
        if (imageVector != null) {
            l0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Filled.Home", Dp.m6044constructorimpl(24.0f), Dp.m6044constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
