...
public final class FavoriteKt {
    ...
    @l
    public static final ImageVector getFavorite(@l Icons.Filled filled) {
        ImageVector imageVector = _favorite;
        if (imageVector != null) {
            l0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Filled.Favorite", Dp.m6044constructorimpl(24.0f), Dp.m6044constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
