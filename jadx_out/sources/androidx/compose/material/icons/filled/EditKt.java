...
public final class EditKt {
    ...
    @l
    public static final ImageVector getEdit(@l Icons.Filled filled) {
        ImageVector imageVector = _edit;
        if (imageVector != null) {
            l0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Filled.Edit", Dp.m6044constructorimpl(24.0f), Dp.m6044constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
