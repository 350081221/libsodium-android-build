...
public final class StarKt {
    ...
    @l
    public static final ImageVector getStar(@l Icons.Filled filled) {
        ImageVector imageVector = _star;
        if (imageVector != null) {
            l0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Filled.Star", Dp.m6044constructorimpl(24.0f), Dp.m6044constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
