...
public final class MenuKt {
    ...
    @l
    public static final ImageVector getMenu(@l Icons.Filled filled) {
        ImageVector imageVector = _menu;
        if (imageVector != null) {
            l0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Filled.Menu", Dp.m6044constructorimpl(24.0f), Dp.m6044constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
