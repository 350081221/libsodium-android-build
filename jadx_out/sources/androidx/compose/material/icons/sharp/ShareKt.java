...
public final class ShareKt {
    ...
    @l
    public static final ImageVector getShare(@l Icons.Sharp sharp) {
        ImageVector imageVector = _share;
        if (imageVector != null) {
            l0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.Share", Dp.m6044constructorimpl(24.0f), Dp.m6044constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
