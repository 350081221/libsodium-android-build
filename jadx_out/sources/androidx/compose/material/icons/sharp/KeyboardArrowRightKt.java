...
public final class KeyboardArrowRightKt {
    ...
    @l
    public static final ImageVector getKeyboardArrowRight(@l Icons.Sharp sharp) {
        ImageVector imageVector = _keyboardArrowRight;
        if (imageVector != null) {
            l0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.KeyboardArrowRight", Dp.m6044constructorimpl(24.0f), Dp.m6044constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
    ...
    @k(message = "Use the AutoMirrored version at Icons.AutoMirrored.Sharp.KeyboardArrowRight", replaceWith = @b1(expression = "Icons.AutoMirrored.Sharp.KeyboardArrowRight", imports = {"androidx.compose.material.icons.automirrored.sharp.KeyboardArrowRight"}))
