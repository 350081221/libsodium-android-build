...
public final class ArrowBackKt {
    ...
    @l
    public static final ImageVector getArrowBack(@l Icons.Sharp sharp) {
        ImageVector imageVector = _arrowBack;
        if (imageVector != null) {
            l0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.ArrowBack", Dp.m6044constructorimpl(24.0f), Dp.m6044constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
    ...
    @k(message = "Use the AutoMirrored version at Icons.AutoMirrored.Sharp.ArrowBack", replaceWith = @b1(expression = "Icons.AutoMirrored.Sharp.ArrowBack", imports = {"androidx.compose.material.icons.automirrored.sharp.ArrowBack"}))
