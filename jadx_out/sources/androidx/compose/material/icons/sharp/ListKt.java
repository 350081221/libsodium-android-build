...
public final class ListKt {
    ...
    @l
    public static final ImageVector getList(@l Icons.Sharp sharp) {
        ImageVector imageVector = _list;
        if (imageVector != null) {
            l0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.List", Dp.m6044constructorimpl(24.0f), Dp.m6044constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
    ...
    @k(message = "Use the AutoMirrored version at Icons.AutoMirrored.Sharp.List", replaceWith = @b1(expression = "Icons.AutoMirrored.Sharp.List", imports = {"androidx.compose.material.icons.automirrored.sharp.List"}))
