...
public final class ArrowForwardKt {
    ...
    @l
    public static final ImageVector getArrowForward(@l Icons.Sharp sharp) {
        ImageVector imageVector = _arrowForward;
        if (imageVector != null) {
            l0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.ArrowForward", Dp.m6044constructorimpl(24.0f), Dp.m6044constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
    ...
    @k(message = "Use the AutoMirrored version at Icons.AutoMirrored.Sharp.ArrowForward", replaceWith = @b1(expression = "Icons.AutoMirrored.Sharp.ArrowForward", imports = {"androidx.compose.material.icons.automirrored.sharp.ArrowForward"}))
