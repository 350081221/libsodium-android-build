...
public final class KeyboardArrowRightKt {
    ...
    @l
    public static final ImageVector getKeyboardArrowRight(@l Icons.AutoMirrored.TwoTone twoTone) {
        ImageVector imageVector = _keyboardArrowRight;
        if (imageVector != null) {
            l0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.TwoTone.KeyboardArrowRight", Dp.m6044constructorimpl(24.0f), Dp.m6044constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
