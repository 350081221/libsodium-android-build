...
public final class ArrowForwardKt {
    ...
    @l
    public static final ImageVector getArrowForward(@l Icons.AutoMirrored.Rounded rounded) {
        ImageVector imageVector = _arrowForward;
        if (imageVector != null) {
            l0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.Rounded.ArrowForward", Dp.m6044constructorimpl(24.0f), Dp.m6044constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
