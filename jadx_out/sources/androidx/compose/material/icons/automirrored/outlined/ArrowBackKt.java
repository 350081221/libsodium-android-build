...
public final class ArrowBackKt {
    ...
    @l
    public static final ImageVector getArrowBack(@l Icons.AutoMirrored.Outlined outlined) {
        ImageVector imageVector = _arrowBack;
        if (imageVector != null) {
            l0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.Outlined.ArrowBack", Dp.m6044constructorimpl(24.0f), Dp.m6044constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
