...
public final class SendKt {
    ...
    @l
    public static final ImageVector getSend(@l Icons.AutoMirrored.Sharp sharp) {
        ImageVector imageVector = _send;
        if (imageVector != null) {
            l0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.Sharp.Send", Dp.m6044constructorimpl(24.0f), Dp.m6044constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
