...
public final class AddCircleKt {
    ...
    @l
    public static final ImageVector getAddCircle(@l Icons.TwoTone twoTone) {
        ImageVector imageVector = _addCircle;
        if (imageVector != null) {
            l0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.AddCircle", Dp.m6044constructorimpl(24.0f), Dp.m6044constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
