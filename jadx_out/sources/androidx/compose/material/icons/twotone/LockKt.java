...
public final class LockKt {
    ...
    @l
    public static final ImageVector getLock(@l Icons.TwoTone twoTone) {
        ImageVector imageVector = _lock;
        if (imageVector != null) {
            l0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.Lock", Dp.m6044constructorimpl(24.0f), Dp.m6044constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
