...
public final class KeyboardArrowDownKt {
    ...
    @l
    public static final ImageVector getKeyboardArrowDown(@l Icons.Rounded rounded) {
        ImageVector imageVector = _keyboardArrowDown;
        if (imageVector != null) {
            l0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.KeyboardArrowDown", Dp.m6044constructorimpl(24.0f), Dp.m6044constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
