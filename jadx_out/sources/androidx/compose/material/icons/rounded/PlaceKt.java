...
public final class PlaceKt {
    ...
    @l
    public static final ImageVector getPlace(@l Icons.Rounded rounded) {
        ImageVector imageVector = _place;
        if (imageVector != null) {
            l0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Place", Dp.m6044constructorimpl(24.0f), Dp.m6044constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
