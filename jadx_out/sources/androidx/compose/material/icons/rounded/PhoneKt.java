...
public final class PhoneKt {
    ...
    @l
    public static final ImageVector getPhone(@l Icons.Rounded rounded) {
        ImageVector imageVector = _phone;
        if (imageVector != null) {
            l0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Phone", Dp.m6044constructorimpl(24.0f), Dp.m6044constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
