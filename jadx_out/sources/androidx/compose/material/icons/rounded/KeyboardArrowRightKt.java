...
public final class KeyboardArrowRightKt {
    ...
    @l
    public static final ImageVector getKeyboardArrowRight(@l Icons.Rounded rounded) {
        ImageVector imageVector = _keyboardArrowRight;
        if (imageVector != null) {
            l0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.KeyboardArrowRight", Dp.m6044constructorimpl(24.0f), Dp.m6044constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
    ...
    @k(message = "Use the AutoMirrored version at Icons.AutoMirrored.Rounded.KeyboardArrowRight", replaceWith = @b1(expression = "Icons.AutoMirrored.Rounded.KeyboardArrowRight", imports = {"androidx.compose.material.icons.automirrored.rounded.KeyboardArrowRight"}))
