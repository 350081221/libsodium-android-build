...
public final class FaceKt {
    ...
    @l
    public static final ImageVector getFace(@l Icons.Rounded rounded) {
        ImageVector imageVector = _face;
        if (imageVector != null) {
            l0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Face", Dp.m6044constructorimpl(24.0f), Dp.m6044constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
