...
public final class ArrowForwardKt {
    ...
    @l
    public static final ImageVector getArrowForward(@l Icons.Rounded rounded) {
        ImageVector imageVector = _arrowForward;
        if (imageVector != null) {
            l0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.ArrowForward", Dp.m6044constructorimpl(24.0f), Dp.m6044constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
    ...
    @k(message = "Use the AutoMirrored version at Icons.AutoMirrored.Rounded.ArrowForward", replaceWith = @b1(expression = "Icons.AutoMirrored.Rounded.ArrowForward", imports = {"androidx.compose.material.icons.automirrored.rounded.ArrowForward"}))
