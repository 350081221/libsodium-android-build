...
public final class SendKt {
    ...
    @l
    public static final ImageVector getSend(@l Icons.Rounded rounded) {
        ImageVector imageVector = _send;
        if (imageVector != null) {
            l0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Send", Dp.m6044constructorimpl(24.0f), Dp.m6044constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
    ...
    @k(message = "Use the AutoMirrored version at Icons.AutoMirrored.Rounded.Send", replaceWith = @b1(expression = "Icons.AutoMirrored.Rounded.Send", imports = {"androidx.compose.material.icons.automirrored.rounded.Send"}))
