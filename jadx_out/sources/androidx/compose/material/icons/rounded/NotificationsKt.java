...
public final class NotificationsKt {
    ...
    @l
    public static final ImageVector getNotifications(@l Icons.Rounded rounded) {
        ImageVector imageVector = _notifications;
        if (imageVector != null) {
            l0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Notifications", Dp.m6044constructorimpl(24.0f), Dp.m6044constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
