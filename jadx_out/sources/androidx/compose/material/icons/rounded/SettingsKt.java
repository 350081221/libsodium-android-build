...
public final class SettingsKt {
    ...
    @l
    public static final ImageVector getSettings(@l Icons.Rounded rounded) {
        ImageVector imageVector = _settings;
        if (imageVector != null) {
            l0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Settings", Dp.m6044constructorimpl(24.0f), Dp.m6044constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
