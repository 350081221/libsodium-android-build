...
public final class KeyboardArrowLeftKt {
    ...
    @l
    public static final ImageVector getKeyboardArrowLeft(@l Icons.Rounded rounded) {
        ImageVector imageVector = _keyboardArrowLeft;
        if (imageVector != null) {
            l0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.KeyboardArrowLeft", Dp.m6044constructorimpl(24.0f), Dp.m6044constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
    ...
    @k(message = "Use the AutoMirrored version at Icons.AutoMirrored.Rounded.KeyboardArrowLeft", replaceWith = @b1(expression = "Icons.AutoMirrored.Rounded.KeyboardArrowLeft", imports = {"androidx.compose.material.icons.automirrored.rounded.KeyboardArrowLeft"}))
