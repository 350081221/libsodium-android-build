...
public final class ExitToAppKt {
    ...
    @l
    public static final ImageVector getExitToApp(@l Icons.Outlined outlined) {
        ImageVector imageVector = _exitToApp;
        if (imageVector != null) {
            l0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.ExitToApp", Dp.m6044constructorimpl(24.0f), Dp.m6044constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
    ...
    @k(message = "Use the AutoMirrored version at Icons.AutoMirrored.Outlined.ExitToApp", replaceWith = @b1(expression = "Icons.AutoMirrored.Outlined.ExitToApp", imports = {"androidx.compose.material.icons.automirrored.outlined.ExitToApp"}))
