...
public final class ShoppingCartKt {
    ...
    @l
    public static final ImageVector getShoppingCart(@l Icons.Outlined outlined) {
        ImageVector imageVector = _shoppingCart;
        if (imageVector != null) {
            l0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.ShoppingCart", Dp.m6044constructorimpl(24.0f), Dp.m6044constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
