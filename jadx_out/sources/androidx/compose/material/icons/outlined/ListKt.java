...
public final class ListKt {
    ...
    @l
    public static final ImageVector getList(@l Icons.Outlined outlined) {
        ImageVector imageVector = _list;
        if (imageVector != null) {
            l0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.List", Dp.m6044constructorimpl(24.0f), Dp.m6044constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
    ...
    @k(message = "Use the AutoMirrored version at Icons.AutoMirrored.Outlined.List", replaceWith = @b1(expression = "Icons.AutoMirrored.Outlined.List", imports = {"androidx.compose.material.icons.automirrored.outlined.List"}))
