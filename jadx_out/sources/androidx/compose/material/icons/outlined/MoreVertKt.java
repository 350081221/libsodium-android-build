...
public final class MoreVertKt {
    ...
    @l
    public static final ImageVector getMoreVert(@l Icons.Outlined outlined) {
        ImageVector imageVector = _moreVert;
        if (imageVector != null) {
            l0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.MoreVert", Dp.m6044constructorimpl(24.0f), Dp.m6044constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
