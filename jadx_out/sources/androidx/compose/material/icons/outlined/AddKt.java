...
public final class AddKt {
    ...
    @l
    public static final ImageVector getAdd(@l Icons.Outlined outlined) {
        ImageVector imageVector = _add;
        if (imageVector != null) {
            l0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.Add", Dp.m6044constructorimpl(24.0f), Dp.m6044constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
