...
public final class ArrowForwardKt {
    ...
    @l
    public static final ImageVector getArrowForward(@l Icons.Outlined outlined) {
        ImageVector imageVector = _arrowForward;
        if (imageVector != null) {
            l0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.ArrowForward", Dp.m6044constructorimpl(24.0f), Dp.m6044constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
    ...
    @k(message = "Use the AutoMirrored version at Icons.AutoMirrored.Outlined.ArrowForward", replaceWith = @b1(expression = "Icons.AutoMirrored.Outlined.ArrowForward", imports = {"androidx.compose.material.icons.automirrored.outlined.ArrowForward"}))
