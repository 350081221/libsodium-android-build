...
public final class KeyboardArrowLeftKt {
    ...
    @l
    public static final ImageVector getKeyboardArrowLeft(@l Icons.Outlined outlined) {
        ImageVector imageVector = _keyboardArrowLeft;
        if (imageVector != null) {
            l0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.KeyboardArrowLeft", Dp.m6044constructorimpl(24.0f), Dp.m6044constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
    ...
    @k(message = "Use the AutoMirrored version at Icons.AutoMirrored.Outlined.KeyboardArrowLeft", replaceWith = @b1(expression = "Icons.AutoMirrored.Outlined.KeyboardArrowLeft", imports = {"androidx.compose.material.icons.automirrored.outlined.KeyboardArrowLeft"}))
