...
public final class KeyboardArrowRightKt {
    ...
    @l
    public static final ImageVector getKeyboardArrowRight(@l Icons.Outlined outlined) {
        ImageVector imageVector = _keyboardArrowRight;
        if (imageVector != null) {
            l0.m(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.KeyboardArrowRight", Dp.m6044constructorimpl(24.0f), Dp.m6044constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
    ...
    @k(message = "Use the AutoMirrored version at Icons.AutoMirrored.Outlined.KeyboardArrowRight", replaceWith = @b1(expression = "Icons.AutoMirrored.Outlined.KeyboardArrowRight", imports = {"androidx.compose.material.icons.automirrored.outlined.KeyboardArrowRight"}))
