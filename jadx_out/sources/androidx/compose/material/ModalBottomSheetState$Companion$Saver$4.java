...
final class ModalBottomSheetState$Companion$Saver$4 extends n0 implements l<ModalBottomSheetValue, ModalBottomSheetState> {
    ...
    public ModalBottomSheetState$Companion$Saver$4(AnimationSpec<Float> animationSpec, l<? super ModalBottomSheetValue, Boolean> lVar, boolean z4) {
        super(1);
