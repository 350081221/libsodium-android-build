...
public final class SwipeableKt$PreUpPostDownNestedScrollConnection$1 implements NestedScrollConnection {
    ...
    private final float toFloat(long j5) {
    ...
    */
    public java.lang.Object mo390onPostFlingRZ2iAVY(long r5, long r7, @p4.l kotlin.coroutines.d<? super androidx.compose.ui.unit.Velocity> r9) {
        /*
            r4 = this;
        ...
        L33:
            ...
            float r0 = androidx.compose.ui.unit.Velocity.m6279getXimpl(r7)
            float r2 = androidx.compose.ui.unit.Velocity.m6280getYimpl(r7)
            ...
            return r9
        L53:
            androidx.compose.ui.unit.Velocity r5 = androidx.compose.ui.unit.Velocity.m6270boximpl(r7)
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.SwipeableKt$PreUpPostDownNestedScrollConnection$1.mo390onPostFlingRZ2iAVY(long, long, kotlin.coroutines.d):java.lang.Object");
    }
    ...
    public long mo391onPostScrollDzOQY0M(long j5, long j6, int i5) {
        if (NestedScrollSource.m4761equalsimpl0(i5, NestedScrollSource.Companion.m4766getDragWNlRxjI())) {
            return toOffset(this.$this_PreUpPostDownNestedScrollConnection.performDrag(toFloat(j6)));
        }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public java.lang.Object mo632onPreFlingQWom1Mo(long r7, @p4.l kotlin.coroutines.d<? super androidx.compose.ui.unit.Velocity> r9) {
        /*
            r6 = this;
        ...
        L33:
            kotlin.e1.n(r9)
            float r9 = androidx.compose.ui.unit.Velocity.m6279getXimpl(r7)
            float r2 = androidx.compose.ui.unit.Velocity.m6280getYimpl(r7)
        ...
        L72:
            ...
            long r7 = r7.m6290getZero9UxMQ8M()
        L78:
            androidx.compose.ui.unit.Velocity r7 = androidx.compose.ui.unit.Velocity.m6270boximpl(r7)
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.SwipeableKt$PreUpPostDownNestedScrollConnection$1.mo632onPreFlingQWom1Mo(long, kotlin.coroutines.d):java.lang.Object");
    }
    ...
    public long mo392onPreScrollOzD1aCk(long j5, int i5) {
        float f5 = toFloat(j5);
        if (f5 < 0.0f && NestedScrollSource.m4761equalsimpl0(i5, NestedScrollSource.Companion.m4766getDragWNlRxjI())) {
            return toOffset(this.$this_PreUpPostDownNestedScrollConnection.performDrag(f5));
        }
        return Offset.Companion.m3509getZeroF1C5BW0();
    }
}
