...
final class SliderKt$RangeSlider$2$startThumbSemantics$1$1 extends n0 implements l<Float, r2> {
    ...
    public SliderKt$RangeSlider$2$startThumbSemantics$1$1(State<? extends l<? super f<Float>, r2>> state, float f5) {
        super(1);
