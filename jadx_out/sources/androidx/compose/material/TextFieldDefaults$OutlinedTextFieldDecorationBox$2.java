...
public final class TextFieldDefaults$OutlinedTextFieldDecorationBox$2 extends n0 implements p<Composer, Integer, r2> {
    ...
    public TextFieldDefaults$OutlinedTextFieldDecorationBox$2(TextFieldDefaults textFieldDefaults, String str, p<? super Composer, ? super Integer, r2> pVar, boolean z4, boolean z5, VisualTransformation visualTransformation, InteractionSource interactionSource, boolean z6, p<? super Composer, ? super Integer, r2> pVar2, p<? super Composer, ? super Integer, r2> pVar3, p<? super Composer, ? super Integer, r2> pVar4, p<? super Composer, ? super Integer, r2> pVar5, TextFieldColors textFieldColors, PaddingValues paddingValues, p<? super Composer, ? super Integer, r2> pVar6, int i5, int i6, int i7) {
        super(2);
