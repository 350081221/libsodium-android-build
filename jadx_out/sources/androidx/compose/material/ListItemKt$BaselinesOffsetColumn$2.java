...
public final class ListItemKt$BaselinesOffsetColumn$2 extends n0 implements p<Composer, Integer, r2> {
    ...
    public ListItemKt$BaselinesOffsetColumn$2(List<Dp> list, Modifier modifier, p<? super Composer, ? super Integer, r2> pVar, int i5, int i6) {
        super(2);
        this.$offsets = list;
