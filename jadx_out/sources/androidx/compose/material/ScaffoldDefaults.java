...
public final class ScaffoldDefaults {
    ...
    @l
    @h(name = "getContentWindowInsets")
    @Composable
    public final WindowInsets getContentWindowInsets(@m Composer composer, int i5) {
        composer.startReplaceableGroup(423092031);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(423092031, i5, -1, "androidx.compose.material.ScaffoldDefaults.<get-contentWindowInsets> (Scaffold.kt:365)");
        }
