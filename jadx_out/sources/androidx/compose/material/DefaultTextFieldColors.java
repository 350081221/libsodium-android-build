...
final class DefaultTextFieldColors implements TextFieldColors {
    ...
    private DefaultTextFieldColors(long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, long j13, long j14, long j15, long j16, long j17, long j18, long j19, long j20, long j21, long j22, long j23, long j24, long j25) {
        ...
        this.focusedLabelColor = j20;
        this.unfocusedLabelColor = j21;
        this.disabledLabelColor = j22;
        this.errorLabelColor = j23;
        this.placeholderColor = j24;
        this.disabledPlaceholderColor = j25;
    }

    public /* synthetic */ DefaultTextFieldColors(long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, long j13, long j14, long j15, long j16, long j17, long j18, long j19, long j20, long j21, long j22, long j23, long j24, long j25, w wVar) {
    ...
    public State<Color> backgroundColor(boolean z4, @m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1423938813, i5, -1, "androidx.compose.material.DefaultTextFieldColors.backgroundColor (TextFieldDefaults.kt:791)");
        }
    ...
    public State<Color> cursorColor(boolean z4, @m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1446422485, i5, -1, "androidx.compose.material.DefaultTextFieldColors.cursorColor (TextFieldDefaults.kt:823)");
        }
        if (z4) {
    ...
    public boolean equals(@m Object obj) {
        ...
        if (Color.m3735equalsimpl0(this.textColor, defaultTextFieldColors.textColor) && Color.m3735equalsimpl0(this.disabledTextColor, defaultTextFieldColors.disabledTextColor) && Color.m3735equalsimpl0(this.cursorColor, defaultTextFieldColors.cursorColor) && Color.m3735equalsimpl0(this.errorCursorColor, defaultTextFieldColors.errorCursorColor) && Color.m3735equalsimpl0(this.focusedIndicatorColor, defaultTextFieldColors.focusedIndicatorColor) && Color.m3735equalsimpl0(this.unfocusedIndicatorColor, defaultTextFieldColors.unfocusedIndicatorColor) && Color.m3735equalsimpl0(this.errorIndicatorColor, defaultTextFieldColors.errorIndicatorColor) && Color.m3735equalsimpl0(this.disabledIndicatorColor, defaultTextFieldColors.disabledIndicatorColor) && Color.m3735equalsimpl0(this.leadingIconColor, defaultTextFieldColors.leadingIconColor) && Color.m3735equalsimpl0(this.disabledLeadingIconColor, defaultTextFieldColors.disabledLeadingIconColor) && Color.m3735equalsimpl0(this.errorLeadingIconColor, defaultTextFieldColors.errorLeadingIconColor) && Color.m3735equalsimpl0(this.trailingIconColor, defaultTextFieldColors.trailingIconColor) && Color.m3735equalsimpl0(this.disabledTrailingIconColor, defaultTextFieldColors.disabledTrailingIconColor) && Color.m3735equalsimpl0(this.errorTrailingIconColor, defaultTextFieldColors.errorTrailingIconColor) && Color.m3735equalsimpl0(this.backgroundColor, defaultTextFieldColors.backgroundColor) && Color.m3735equalsimpl0(this.focusedLabelColor, defaultTextFieldColors.focusedLabelColor) && Color.m3735equalsimpl0(this.unfocusedLabelColor, defaultTextFieldColors.unfocusedLabelColor) && Color.m3735equalsimpl0(this.disabledLabelColor, defaultTextFieldColors.disabledLabelColor) && Color.m3735equalsimpl0(this.errorLabelColor, defaultTextFieldColors.errorLabelColor) && Color.m3735equalsimpl0(this.placeholderColor, defaultTextFieldColors.placeholderColor) && Color.m3735equalsimpl0(this.disabledPlaceholderColor, defaultTextFieldColors.disabledPlaceholderColor)) {
            return true;
        }
        return false;
    }
    ...
    public State<Color> indicatorColor(boolean z4, boolean z5, @l InteractionSource interactionSource, @m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(998675979, i5, -1, "androidx.compose.material.DefaultTextFieldColors.indicatorColor (TextFieldDefaults.kt:774)");
        }
    ...
    public State<Color> labelColor(boolean z4, boolean z5, @l InteractionSource interactionSource, @m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(727091888, i5, -1, "androidx.compose.material.DefaultTextFieldColors.labelColor (TextFieldDefaults.kt:805)");
        }
        State<Boolean> collectIsFocusedAsState = FocusInteractionKt.collectIsFocusedAsState(interactionSource, composer, (i5 >> 6) & 14);
        if (!z4) {
    ...
    public State<Color> leadingIconColor(boolean z4, boolean z5, @m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1016171324, i5, -1, "androidx.compose.material.DefaultTextFieldColors.leadingIconColor (TextFieldDefaults.kt:717)");
        }
        if (!z4) {
    ...
    public State<Color> placeholderColor(boolean z4, @m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(264799724, i5, -1, "androidx.compose.material.DefaultTextFieldColors.placeholderColor (TextFieldDefaults.kt:796)");
        }
        if (z4) {
    ...
    public State<Color> textColor(boolean z4, @m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(9804418, i5, -1, "androidx.compose.material.DefaultTextFieldColors.textColor (TextFieldDefaults.kt:818)");
        }
        if (z4) {
            j5 = this.textColor;
        } else {
    ...
    public State<Color> trailingIconColor(boolean z4, boolean z5, @m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(225259054, i5, -1, "androidx.compose.material.DefaultTextFieldColors.trailingIconColor (TextFieldDefaults.kt:744)");
        }
        if (!z4) {
    ...
    @l
    @Composable
    public State<Color> leadingIconColor(boolean z4, boolean z5, @l InteractionSource interactionSource, @m Composer composer, int i5) {
        long j5;
        composer.startReplaceableGroup(-1519634405);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1519634405, i5, -1, "androidx.compose.material.DefaultTextFieldColors.leadingIconColor (TextFieldDefaults.kt:732)");
        }
        if (!z4) {
            j5 = this.disabledLeadingIconColor;
        } else if (z5) {
    ...
    public State<Color> trailingIconColor(boolean z4, boolean z5, @l InteractionSource interactionSource, @m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1383318157, i5, -1, "androidx.compose.material.DefaultTextFieldColors.trailingIconColor (TextFieldDefaults.kt:759)");
        }
        if (!z4) {
            j5 = this.disabledTrailingIconColor;
        } else if (z5) {
