...
public final class TwoLine$ListItem$2 extends n0 implements p<Composer, Integer, r2> {
    ...
    public TwoLine$ListItem$2(TwoLine twoLine, Modifier modifier, p<? super Composer, ? super Integer, r2> pVar, p<? super Composer, ? super Integer, r2> pVar2, p<? super Composer, ? super Integer, r2> pVar3, p<? super Composer, ? super Integer, r2> pVar4, p<? super Composer, ? super Integer, r2> pVar5, int i5, int i6) {
        super(2);
