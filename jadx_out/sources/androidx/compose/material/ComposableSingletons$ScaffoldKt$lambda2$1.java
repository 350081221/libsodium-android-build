...
final class ComposableSingletons$ScaffoldKt$lambda2$1 extends n0 implements p<Composer, Integer, r2> {
    ...
    public final void invoke(@m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-212732681, i5, -1, "androidx.compose.material.ComposableSingletons$ScaffoldKt.lambda-2.<anonymous> (Scaffold.kt:189)");
        }
        if (ComposerKt.isTraceInProgress()) {
