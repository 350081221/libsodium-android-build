...
final class ComposableSingletons$AppBarKt$lambda2$1 extends n0 implements q<RowScope, Composer, Integer, r2> {
    ...
    public final void invoke(@l RowScope rowScope, @m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-771938130, i5, -1, "androidx.compose.material.ComposableSingletons$AppBarKt.lambda-2.<anonymous> (AppBar.kt:171)");
        }
        if (ComposerKt.isTraceInProgress()) {
