...
public final class SwitchKt$Switch$5 extends n0 implements p<Composer, Integer, r2> {
    ...
    public SwitchKt$Switch$5(boolean z4, l<? super Boolean, r2> lVar, Modifier modifier, boolean z5, MutableInteractionSource mutableInteractionSource, SwitchColors switchColors, int i5, int i6) {
        super(2);
        this.$checked = z4;
