...
@f(c = "androidx.compose.material.SnackbarHostKt$animatedScale$1", f = "SnackbarHost.kt", i = {}, l = {370}, m = "invokeSuspend", n = {}, s = {})
...
final class SnackbarHostKt$animatedScale$1 extends o implements p<s0, d<? super r2>, Object> {
    ...
    public SnackbarHostKt$animatedScale$1(Animatable<Float, AnimationVector1D> animatable, boolean z4, AnimationSpec<Float> animationSpec, d<? super SnackbarHostKt$animatedScale$1> dVar) {
        super(2, dVar);
    ...
    public final Object invoke(@l s0 s0Var, @m d<? super r2> dVar) {
        return ((SnackbarHostKt$animatedScale$1) create(s0Var, dVar)).invokeSuspend(r2.f19517a);
    }
