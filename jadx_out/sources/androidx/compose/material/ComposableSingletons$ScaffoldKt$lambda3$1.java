...
final class ComposableSingletons$ScaffoldKt$lambda3$1 extends n0 implements q<SnackbarHostState, Composer, Integer, r2> {
    ...
    public final void invoke(@l SnackbarHostState snackbarHostState, @m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(2086581188, i5, -1, "androidx.compose.material.ComposableSingletons$ScaffoldKt.lambda-3.<anonymous> (Scaffold.kt:190)");
        }
