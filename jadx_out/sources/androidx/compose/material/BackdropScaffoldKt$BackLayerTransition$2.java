...
public final class BackdropScaffoldKt$BackLayerTransition$2 extends n0 implements p<Composer, Integer, r2> {
    ...
    public BackdropScaffoldKt$BackLayerTransition$2(BackdropValue backdropValue, p<? super Composer, ? super Integer, r2> pVar, p<? super Composer, ? super Integer, r2> pVar2, int i5) {
        super(2);
