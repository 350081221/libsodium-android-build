...
public final class ElevationDefaults {
    ...
    @m
    public final AnimationSpec<Dp> incomingAnimationSpecForInteraction(@l Interaction interaction) {
        TweenSpec tweenSpec;
    ...
    @m
    public final AnimationSpec<Dp> outgoingAnimationSpecForInteraction(@l Interaction interaction) {
        TweenSpec tweenSpec;
        TweenSpec tweenSpec2;
        TweenSpec tweenSpec3;
        TweenSpec tweenSpec4;
