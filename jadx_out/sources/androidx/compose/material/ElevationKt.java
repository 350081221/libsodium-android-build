...
public final class ElevationKt {
    ...
    public static final Object m1337animateElevationrAjV9yQ(@l Animatable<Dp, ?> animatable, float f5, @m Interaction interaction, @m Interaction interaction2, @l d<? super r2> dVar) {
    ...
    public static /* synthetic */ Object m1338animateElevationrAjV9yQ$default(Animatable animatable, float f5, Interaction interaction, Interaction interaction2, d dVar, int i5, Object obj) {
        if ((i5 & 2) != 0) {
            interaction = null;
        }
        if ((i5 & 4) != 0) {
        ...
        return m1337animateElevationrAjV9yQ(animatable, f5, interaction, interaction2, dVar);
    }
}
