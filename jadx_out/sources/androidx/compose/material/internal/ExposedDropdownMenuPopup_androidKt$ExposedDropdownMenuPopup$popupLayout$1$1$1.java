...
public final class ExposedDropdownMenuPopup_androidKt$ExposedDropdownMenuPopup$popupLayout$1$1$1 extends n0 implements p<Composer, Integer, r2> {
    ...
    /* renamed from: androidx.compose.material.internal.ExposedDropdownMenuPopup_androidKt$ExposedDropdownMenuPopup$popupLayout$1$1$1$2, reason: invalid class name */
    /* loaded from: classes.dex */
    public static final class AnonymousClass2 extends n0 implements l<IntSize, r2> {
        final /* synthetic */ PopupLayout $this_apply;
        ...
        public /* bridge */ /* synthetic */ r2 invoke(IntSize intSize) {
            m1521invokeozmzZPI(intSize.m6218unboximpl());
            return r2.f19517a;
        }

        /* renamed from: invoke-ozmzZPI, reason: not valid java name */
        public final void m1521invokeozmzZPI(long j5) {
            this.$this_apply.m1523setPopupContentSizefhxjrPA(IntSize.m6206boximpl(j5));
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    @i0(d1 = {"\u0000\b\n\u0002\u0018\u0002\n\u0002\b\u0003\u0010\u0003\u001a\u00020\u0000H\u000b¢\u0006\u0004\b\u0001\u0010\u0002"}, d2 = {"Lkotlin/r2;", "invoke", "(Landroidx/compose/runtime/Composer;I)V", "<anonymous>"}, k = 3, mv = {1, 8, 0})
    /* renamed from: androidx.compose.material.internal.ExposedDropdownMenuPopup_androidKt$ExposedDropdownMenuPopup$popupLayout$1$1$1$3, reason: invalid class name */
    /* loaded from: classes.dex */
    public static final class AnonymousClass3 extends n0 implements p<Composer, Integer, r2> {
        ...
        public final void invoke(@m Composer composer, int i5) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1347607057, i5, -1, "androidx.compose.material.internal.ExposedDropdownMenuPopup.<anonymous>.<anonymous>.<anonymous>.<anonymous> (ExposedDropdownMenuPopup.android.kt:112)");
            }
    ...
    public final void invoke(@m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(580081703, i5, -1, "androidx.compose.material.internal.ExposedDropdownMenuPopup.<anonymous>.<anonymous>.<anonymous> (ExposedDropdownMenuPopup.android.kt:101)");
        }
        ...
        ComposableLambda composableLambda = ComposableLambdaKt.composableLambda(composer, 1347607057, true, new AnonymousClass3(this.$currentContent$delegate));
