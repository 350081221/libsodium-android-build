...
final class ModalBottomSheetState$Companion$Saver$2 extends n0 implements l<ModalBottomSheetValue, ModalBottomSheetState> {
    ...
    public ModalBottomSheetState$Companion$Saver$2(Density density, AnimationSpec<Float> animationSpec, l<? super ModalBottomSheetValue, Boolean> lVar, boolean z4) {
        super(1);
    ...
    @Override // v3.l
    @m
    public final ModalBottomSheetState invoke(@p4.l ModalBottomSheetValue modalBottomSheetValue) {
