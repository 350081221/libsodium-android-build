...
final class TextFieldKt$TextField$2 extends n0 implements q<p<? super Composer, ? super Integer, ? extends r2>, Composer, Integer, r2> {
    ...
    public final void invoke(@l p<? super Composer, ? super Integer, r2> pVar, @m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(989834338, i6, -1, "androidx.compose.material.TextField.<anonymous> (TextField.kt:214)");
        }
        TextFieldDefaults.INSTANCE.TextFieldDecorationBox(this.$value, pVar, this.$enabled, this.$singleLine, this.$visualTransformation, this.$interactionSource, this.$isError, this.$label, this.$placeholder, this.$leadingIcon, this.$trailingIcon, this.$colors, null, composer, (i6 << 3) & 112, 3072, 4096);
        if (ComposerKt.isTraceInProgress()) {
