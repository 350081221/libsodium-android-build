...
public final class NavigationRailKt$NavigationRailItemBaselineLayout$3 extends n0 implements p<Composer, Integer, r2> {
    ...
    public NavigationRailKt$NavigationRailItemBaselineLayout$3(p<? super Composer, ? super Integer, r2> pVar, p<? super Composer, ? super Integer, r2> pVar2, float f5, int i5) {
        super(2);
        this.$icon = pVar;
        this.$label = pVar2;
