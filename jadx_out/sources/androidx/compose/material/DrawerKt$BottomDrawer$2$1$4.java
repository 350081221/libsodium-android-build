...
final class DrawerKt$BottomDrawer$2$1$4 extends n0 implements l<SemanticsPropertyReceiver, r2> {
    ...
    public static final class AnonymousClass1 extends n0 implements a<Boolean> {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        @f(c = "androidx.compose.material.DrawerKt$BottomDrawer$2$1$4$1$1", f = "Drawer.kt", i = {}, l = {748}, m = "invokeSuspend", n = {}, s = {})
        ...
        /* loaded from: classes.dex */
        public static final class C00421 extends o implements p<s0, d<? super r2>, Object> {
            final /* synthetic */ BottomDrawerState $drawerState;
            int label;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C00421(BottomDrawerState bottomDrawerState, d<? super C00421> dVar) {
                super(2, dVar);
            ...
            public final d<r2> create(@m Object obj, @p4.l d<?> dVar) {
                return new C00421(this.$drawerState, dVar);
            }

            @Override // v3.p
            @m
            public final Object invoke(@p4.l s0 s0Var, @m d<? super r2> dVar) {
                return ((C00421) create(s0Var, dVar)).invokeSuspend(r2.f19517a);
            }
            ...
            public final Object invokeSuspend(@p4.l Object obj) {
                ...
                if (i5 != 0) {
                    ...
                    this.label = 1;
                    if (bottomDrawerState.close(this) == l5) {
                        return l5;
                    }
                }
                return r2.f19517a;
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        AnonymousClass1(BottomDrawerState bottomDrawerState, s0 s0Var) {
            super(0);
            this.$drawerState = bottomDrawerState;
            this.$scope = s0Var;
        }
        ...
        public final Boolean invoke() {
            if (this.$drawerState.confirmStateChange$material_release(BottomDrawerValue.Closed)) {
                k.f(this.$scope, null, null, new C00421(this.$drawerState, null), 3, null);
            }
            return Boolean.TRUE;
        }
    }
