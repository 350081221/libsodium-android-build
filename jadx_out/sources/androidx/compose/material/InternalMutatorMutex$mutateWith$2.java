...
@f(c = "androidx.compose.material.InternalMutatorMutex$mutateWith$2", f = "InternalMutatorMutex.kt", i = {0, 0, 1, 1}, l = {177, 138}, m = "invokeSuspend", n = {"mutator", "$this$withLock_u24default$iv", "mutator", "$this$withLock_u24default$iv"}, s = {"L$0", "L$1", "L$0", "L$1"})
...
public final class InternalMutatorMutex$mutateWith$2<R> extends o implements p<s0, d<? super R>, Object> {
    ...
    public InternalMutatorMutex$mutateWith$2(MutatePriority mutatePriority, InternalMutatorMutex internalMutatorMutex, p<? super T, ? super d<? super R>, ? extends Object> pVar, T t5, d<? super InternalMutatorMutex$mutateWith$2> dVar) {
        super(2, dVar);
