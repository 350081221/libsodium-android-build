...
public final class MenuKt$DropdownMenuContent$alpha$2 extends n0 implements q<Transition.Segment<Boolean>, Composer, Integer, FiniteAnimationSpec<Float>> {
    ...
    @l
    @Composable
    public final FiniteAnimationSpec<Float> invoke(@l Transition.Segment<Boolean> segment, @m Composer composer, int i5) {
