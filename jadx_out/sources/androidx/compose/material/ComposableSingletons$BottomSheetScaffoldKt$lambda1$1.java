...
final class ComposableSingletons$BottomSheetScaffoldKt$lambda1$1 extends n0 implements q<SnackbarHostState, Composer, Integer, r2> {
    ...
    public final void invoke(@l SnackbarHostState snackbarHostState, @m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(239945703, i5, -1, "androidx.compose.material.ComposableSingletons$BottomSheetScaffoldKt.lambda-1.<anonymous> (BottomSheetScaffold.kt:440)");
        }
