...
public final class TextKt$ProvideTextStyle$1 extends n0 implements p<Composer, Integer, r2> {
    ...
    public TextKt$ProvideTextStyle$1(TextStyle textStyle, p<? super Composer, ? super Integer, r2> pVar, int i5) {
        super(2);
