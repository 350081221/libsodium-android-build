...
public final class BottomNavigationDefaults {
    ...
    public final float m1219getElevationD9Ej5fM() {
        return Elevation;
    }
    ...
    public final WindowInsets getWindowInsets(@m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1427252235, i5, -1, "androidx.compose.material.BottomNavigationDefaults.<get-windowInsets> (BottomNavigation.kt:265)");
        }
