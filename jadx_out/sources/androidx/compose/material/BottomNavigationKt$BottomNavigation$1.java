...
public final class BottomNavigationKt$BottomNavigation$1 extends n0 implements p<Composer, Integer, r2> {
    ...
    public BottomNavigationKt$BottomNavigation$1(WindowInsets windowInsets, q<? super RowScope, ? super Composer, ? super Integer, r2> qVar) {
        super(2);
    ...
    public final void invoke(@m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-352628062, i5, -1, "androidx.compose.material.BottomNavigation.<anonymous> (BottomNavigation.kt:114)");
        }
