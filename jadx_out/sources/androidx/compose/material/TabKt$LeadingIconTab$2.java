...
public final class TabKt$LeadingIconTab$2 extends n0 implements p<Composer, Integer, r2> {
    ...
    public TabKt$LeadingIconTab$2(Modifier modifier, boolean z4, MutableInteractionSource mutableInteractionSource, Indication indication, boolean z5, a<r2> aVar, p<? super Composer, ? super Integer, r2> pVar, p<? super Composer, ? super Integer, r2> pVar2) {
        super(2);
    ...
    public final void invoke(@m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(866677691, i5, -1, "androidx.compose.material.LeadingIconTab.<anonymous> (Tab.kt:169)");
        }
        Modifier modifier = this.$modifier;
        f5 = TabKt.SmallTabHeight;
        Modifier m794selectableO2vRcR0 = SelectableKt.m794selectableO2vRcR0(SizeKt.m588height3ABfNKs(modifier, f5), this.$selected, this.$interactionSource, this.$ripple, this.$enabled, Role.m5366boximpl(Role.Companion.m5379getTabo7Vup1c()), this.$onClick);
        f6 = TabKt.HorizontalTextPadding;
        Modifier fillMaxWidth$default = SizeKt.fillMaxWidth$default(PaddingKt.m555paddingVpY3zN4$default(m794selectableO2vRcR0, f6, 0.0f, 2, null), 0.0f, 1, null);
