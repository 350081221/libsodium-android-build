...
public final class SnackbarHostKt$FadeInFadeOutWithScale$3 extends n0 implements p<Composer, Integer, r2> {
    ...
    public SnackbarHostKt$FadeInFadeOutWithScale$3(SnackbarData snackbarData, Modifier modifier, q<? super SnackbarData, ? super Composer, ? super Integer, r2> qVar, int i5, int i6) {
        super(2);
