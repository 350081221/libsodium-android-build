...
final class NavigationRailKt$placeIcon$1 extends n0 implements l<Placeable.PlacementScope, r2> {
    ...
    public NavigationRailKt$placeIcon$1(Placeable placeable, int i5, int i6) {
        super(1);
