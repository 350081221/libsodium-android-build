...
public final class ModalBottomSheetState$anchoredDraggableState$1 extends n0 implements l<Float, Float> {
    ...
    public final Float invoke(float f5) {
        ...
        f6 = ModalBottomSheetKt.ModalBottomSheetPositionalThreshold;
