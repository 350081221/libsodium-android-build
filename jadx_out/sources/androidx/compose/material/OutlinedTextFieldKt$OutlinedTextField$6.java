...
public final class OutlinedTextFieldKt$OutlinedTextField$6 extends n0 implements p<Composer, Integer, r2> {
    ...
    public OutlinedTextFieldKt$OutlinedTextField$6(String str, l<? super String, r2> lVar, Modifier modifier, boolean z4, boolean z5, TextStyle textStyle, p<? super Composer, ? super Integer, r2> pVar, p<? super Composer, ? super Integer, r2> pVar2, p<? super Composer, ? super Integer, r2> pVar3, p<? super Composer, ? super Integer, r2> pVar4, boolean z6, VisualTransformation visualTransformation, KeyboardOptions keyboardOptions, KeyboardActions keyboardActions, boolean z7, int i5, MutableInteractionSource mutableInteractionSource, Shape shape, TextFieldColors textFieldColors, int i6, int i7, int i8) {
        super(2);
        this.$value = str;
