...
final class SwitchKt$Switch$3$1 extends o implements p<s0, d<? super r2>, Object> {
    ...
    public SwitchKt$Switch$3$1(boolean z4, AnchoredDraggableState<Boolean> anchoredDraggableState, d<? super SwitchKt$Switch$3$1> dVar) {
        super(2, dVar);
        this.$checked = z4;
    ...
    public final Object invoke(@l s0 s0Var, @m d<? super r2> dVar) {
        return ((SwitchKt$Switch$3$1) create(s0Var, dVar)).invokeSuspend(r2.f19517a);
    }
    ...
    public final Object invokeSuspend(@l Object obj) {
        ...
        if (i5 != 0) {
            ...
            if (this.$checked != this.$anchoredDraggableState.getCurrentValue().booleanValue()) {
                ...
                Boolean a5 = b.a(this.$checked);
                this.label = 1;
                if (AnchoredDraggableKt.animateTo$default(anchoredDraggableState, a5, 0.0f, this, 2, null) == l5) {
                    return l5;
                }
            }
        }
