...
public final class CheckboxKt$Checkbox$3 extends n0 implements p<Composer, Integer, r2> {
    ...
    public CheckboxKt$Checkbox$3(boolean z4, l<? super Boolean, r2> lVar, Modifier modifier, boolean z5, MutableInteractionSource mutableInteractionSource, CheckboxColors checkboxColors, int i5, int i6) {
        super(2);
        this.$checked = z4;
