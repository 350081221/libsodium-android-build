...
final class CheckboxKt$CheckboxImpl$checkCenterGravitationShiftFraction$2 extends n0 implements q<Transition.Segment<ToggleableState>, Composer, Integer, FiniteAnimationSpec<Float>> {
    ...
    @l
    @Composable
    public final FiniteAnimationSpec<Float> invoke(@l Transition.Segment<ToggleableState> segment, @m Composer composer, int i5) {
        FiniteAnimationSpec<Float> snap;
        composer.startReplaceableGroup(1075283605);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1075283605, i5, -1, "androidx.compose.material.CheckboxImpl.<anonymous> (Checkbox.kt:283)");
        }
        ...
        if (initialState == toggleableState) {
            ...
            snap = segment.getTargetState() == toggleableState ? AnimationSpecKt.snap(100) : AnimationSpecKt.tween$default(100, 0, null, 6, null);
        }
        if (ComposerKt.isTraceInProgress()) {
