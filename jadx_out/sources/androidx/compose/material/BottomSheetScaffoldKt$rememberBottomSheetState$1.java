...
final class BottomSheetScaffoldKt$rememberBottomSheetState$1 extends n0 implements l<BottomSheetValue, Boolean> {
    ...
    @Override // v3.l
    @p4.l
    public final Boolean invoke(@p4.l BottomSheetValue bottomSheetValue) {
        return Boolean.TRUE;
    }
}
