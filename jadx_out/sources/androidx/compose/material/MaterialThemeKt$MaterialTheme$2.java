...
public final class MaterialThemeKt$MaterialTheme$2 extends n0 implements p<Composer, Integer, r2> {
    ...
    public MaterialThemeKt$MaterialTheme$2(Colors colors, Typography typography, Shapes shapes, p<? super Composer, ? super Integer, r2> pVar, int i5, int i6) {
        super(2);
        this.$colors = colors;
