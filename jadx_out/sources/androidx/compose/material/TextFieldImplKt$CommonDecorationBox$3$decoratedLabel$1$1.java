...
public final class TextFieldImplKt$CommonDecorationBox$3$decoratedLabel$1$1 extends n0 implements p<Composer, Integer, r2> {
    ...
    public TextFieldImplKt$CommonDecorationBox$3$decoratedLabel$1$1(float f5, long j5, p<? super Composer, ? super Integer, r2> pVar, boolean z4, long j6) {
        super(2);
    ...
    public final void invoke(@m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(362863774, i5, -1, "androidx.compose.material.CommonDecorationBox.<anonymous>.<anonymous>.<anonymous> (TextFieldImpl.kt:121)");
        }
        ...
        TextFieldImplKt.m1504DecorationeuL9pac(this.$labelContentColor, textStyle, null, this.$it, composer, 384, 0);
        if (ComposerKt.isTraceInProgress()) {
