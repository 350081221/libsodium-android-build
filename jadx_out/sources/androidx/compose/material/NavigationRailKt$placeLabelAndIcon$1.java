...
final class NavigationRailKt$placeLabelAndIcon$1 extends n0 implements l<Placeable.PlacementScope, r2> {
    ...
    public NavigationRailKt$placeLabelAndIcon$1(float f5, Placeable placeable, int i5, int i6, int i7, Placeable placeable2, int i8, int i9) {
        super(1);
