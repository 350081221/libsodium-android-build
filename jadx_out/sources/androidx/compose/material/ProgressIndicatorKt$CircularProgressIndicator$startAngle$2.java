...
public final class ProgressIndicatorKt$CircularProgressIndicator$startAngle$2 extends n0 implements l<KeyframesSpec.KeyframesSpecConfig<Float>, r2> {
    ...
    public final void invoke2(@p4.l KeyframesSpec.KeyframesSpecConfig<Float> keyframesSpecConfig) {
        ...
        KeyframesSpec.KeyframeEntity<Float> at = keyframesSpecConfig.at((KeyframesSpec.KeyframesSpecConfig<Float>) Float.valueOf(0.0f), TTAdConstant.STYLE_SIZE_RADIO_2_3);
