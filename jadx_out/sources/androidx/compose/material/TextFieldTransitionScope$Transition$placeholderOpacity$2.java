...
public final class TextFieldTransitionScope$Transition$placeholderOpacity$2 extends n0 implements q<Transition.Segment<InputPhase>, Composer, Integer, FiniteAnimationSpec<Float>> {
    ...
    @l
    @Composable
    public final FiniteAnimationSpec<Float> invoke(@l Transition.Segment<InputPhase> segment, @m Composer composer, int i5) {
        FiniteAnimationSpec<Float> tween;
        composer.startReplaceableGroup(-1079955085);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1079955085, i5, -1, "androidx.compose.material.TextFieldTransitionScope.Transition.<anonymous> (TextFieldImpl.kt:286)");
        }
