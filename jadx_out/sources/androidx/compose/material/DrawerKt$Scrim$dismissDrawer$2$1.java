...
public final class DrawerKt$Scrim$dismissDrawer$2$1 extends n0 implements l<SemanticsPropertyReceiver, r2> {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public DrawerKt$Scrim$dismissDrawer$2$1(String str, a<r2> aVar) {
        super(1);
