...
public final class SliderKt$sliderTapModifier$$inlined$debugInspectorInfo$1 extends n0 implements l<InspectorInfo, r2> {
    ...
    public SliderKt$sliderTapModifier$$inlined$debugInspectorInfo$1(DraggableState draggableState, MutableInteractionSource mutableInteractionSource, float f5, boolean z4, State state, State state2, MutableState mutableState, boolean z5) {
        super(1);
