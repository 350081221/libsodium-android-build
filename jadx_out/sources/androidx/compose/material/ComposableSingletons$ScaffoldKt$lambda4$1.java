...
final class ComposableSingletons$ScaffoldKt$lambda4$1 extends n0 implements p<Composer, Integer, r2> {
    ...
    public final void invoke(@m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(10046167, i5, -1, "androidx.compose.material.ComposableSingletons$ScaffoldKt.lambda-4.<anonymous> (Scaffold.kt:191)");
        }
        if (ComposerKt.isTraceInProgress()) {
