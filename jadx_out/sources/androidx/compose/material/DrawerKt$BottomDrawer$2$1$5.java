...
final class DrawerKt$BottomDrawer$2$1$5 extends n0 implements p<Composer, Integer, r2> {
    final /* synthetic */ q<ColumnScope, Composer, Integer, r2> $drawerContent;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public DrawerKt$BottomDrawer$2$1$5(q<? super ColumnScope, ? super Composer, ? super Integer, r2> qVar) {
        super(2);
    ...
    public final void invoke(@m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(457750254, i5, -1, "androidx.compose.material.BottomDrawer.<anonymous>.<anonymous>.<anonymous> (Drawer.kt:757)");
        }
