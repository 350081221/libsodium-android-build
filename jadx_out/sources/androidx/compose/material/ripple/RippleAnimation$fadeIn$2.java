...
@f(c = "androidx.compose.material.ripple.RippleAnimation$fadeIn$2", f = "RippleAnimation.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
@i0(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\u0010\u0002\u001a\u00020\u0001*\u00020\u0000H\u008a@"}, d2 = {"Lkotlinx/coroutines/s0;", "Lkotlinx/coroutines/l2;", "<anonymous>"}, k = 3, mv = {1, 8, 0})
/* loaded from: classes.dex */
public final class RippleAnimation$fadeIn$2 extends o implements p<s0, d<? super l2>, Object> {
    private /* synthetic */ Object L$0;
    int label;
    final /* synthetic */ RippleAnimation this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    @f(c = "androidx.compose.material.ripple.RippleAnimation$fadeIn$2$1", f = "RippleAnimation.kt", i = {}, l = {89}, m = "invokeSuspend", n = {}, s = {})
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    @f(c = "androidx.compose.material.ripple.RippleAnimation$fadeIn$2$2", f = "RippleAnimation.kt", i = {}, l = {95}, m = "invokeSuspend", n = {}, s = {})
    @i0(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\u0010\u0002\u001a\u00020\u0001*\u00020\u0000H\u008a@"}, d2 = {"Lkotlinx/coroutines/s0;", "Lkotlin/r2;", "<anonymous>"}, k = 3, mv = {1, 8, 0})
    ...
    public static final class AnonymousClass2 extends o implements p<s0, d<? super r2>, Object> {
        ...
        public final Object invokeSuspend(@l Object obj) {
            ...
            if (i5 != 0) {
                ...
                Float e5 = b.e(1.0f);
                TweenSpec tween$default = AnimationSpecKt.tween$default(Opcodes.SHR_INT_LIT8, 0, EasingKt.getFastOutSlowInEasing(), 2, null);
                this.label = 1;
                if (Animatable.animateTo$default(animatable, e5, tween$default, null, null, this, 12, null) == l5) {
                    return l5;
                }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    @f(c = "androidx.compose.material.ripple.RippleAnimation$fadeIn$2$3", f = "RippleAnimation.kt", i = {}, l = {101}, m = "invokeSuspend", n = {}, s = {})
    @i0(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\u0010\u0002\u001a\u00020\u0001*\u00020\u0000H\u008a@"}, d2 = {"Lkotlinx/coroutines/s0;", "Lkotlin/r2;", "<anonymous>"}, k = 3, mv = {1, 8, 0})
    ...
    public static final class AnonymousClass3 extends o implements p<s0, d<? super r2>, Object> {
        ...
        public final Object invokeSuspend(@l Object obj) {
            ...
            if (i5 != 0) {
                ...
                Float e5 = b.e(1.0f);
                TweenSpec tween$default = AnimationSpecKt.tween$default(Opcodes.SHR_INT_LIT8, 0, EasingKt.getLinearEasing(), 2, null);
                this.label = 1;
                if (Animatable.animateTo$default(animatable, e5, tween$default, null, null, this, 12, null) == l5) {
                    return l5;
                }
    ...
    public final Object invoke(@l s0 s0Var, @m d<? super l2> dVar) {
        return ((RippleAnimation$fadeIn$2) create(s0Var, dVar)).invokeSuspend(r2.f19517a);
    }
    ...
    public final Object invokeSuspend(@l Object obj) {
        ...
        if (this.label == 0) {
            ...
            k.f(s0Var, null, null, new AnonymousClass2(this.this$0, null), 3, null);
            f5 = k.f(s0Var, null, null, new AnonymousClass3(this.this$0, null), 3, null);
            return f5;
        }
        throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
    }
