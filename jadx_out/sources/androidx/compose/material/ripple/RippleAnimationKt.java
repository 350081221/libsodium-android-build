...
public final class RippleAnimationKt {
    private static final float BoundedRippleExtraRadius = Dp.m6044constructorimpl(10);
    ...
    public static final float m1536getRippleEndRadiuscSwnlzA(@l Density density, boolean z4, long j5) {
        float m3491getDistanceimpl = Offset.m3491getDistanceimpl(OffsetKt.Offset(Size.m3562getWidthimpl(j5), Size.m3559getHeightimpl(j5))) / 2.0f;
        if (z4) {
            return m3491getDistanceimpl + density.mo304toPx0680j_4(BoundedRippleExtraRadius);
        }
        return m3491getDistanceimpl;
    }

    /* renamed from: getRippleStartRadius-uvyYCjk, reason: not valid java name */
    public static final float m1537getRippleStartRadiusuvyYCjk(long j5) {
        return Math.max(Size.m3562getWidthimpl(j5), Size.m3559getHeightimpl(j5)) * 0.3f;
    }
}
