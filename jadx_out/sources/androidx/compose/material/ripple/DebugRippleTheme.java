...
final class DebugRippleTheme implements RippleTheme {
    ...
    public long mo1369defaultColorWaAFU9c(@m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(2042140174, i5, -1, "androidx.compose.material.ripple.DebugRippleTheme.defaultColor (RippleTheme.kt:214)");
        }
        long m1543defaultRippleColor5vOe2sY = RippleTheme.Companion.m1543defaultRippleColor5vOe2sY(Color.Companion.m3760getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public RippleAlpha rippleAlpha(@m Composer composer, int i5) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1629816343, i5, -1, "androidx.compose.material.ripple.DebugRippleTheme.rippleAlpha (RippleTheme.kt:217)");
        }
        RippleAlpha m1542defaultRippleAlphaDxMtmZc = RippleTheme.Companion.m1542defaultRippleAlphaDxMtmZc(Color.Companion.m3760getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
