...
class VersionedParcelStream extends VersionedParcel {
    ...
    public static class FieldBuffer {
        ...
        FieldBuffer(int i5, DataOutputStream dataOutputStream) {
        ...
        void flushField() throws IOException {
            ...
            int i6 = this.mFieldId << 16;
            if (size >= 65535) {
                i5 = 65535;
            } else {
                i5 = size;
            }
            this.mTarget.writeInt(i6 | i5);
            if (size >= 65535) {
    ...
    public void writeBoolean(boolean z4) {
        try {
            this.mCurrentOutput.writeBoolean(z4);
        } catch (IOException e5) {
            throw new VersionedParcel.ParcelException(e5);
        }
    }
    ...
    public void writeDouble(double d5) {
        try {
            this.mCurrentOutput.writeDouble(d5);
        } catch (IOException e5) {
            throw new VersionedParcel.ParcelException(e5);
        }
    }
    ...
    public void writeFloat(float f5) {
        try {
            this.mCurrentOutput.writeFloat(f5);
        } catch (IOException e5) {
            throw new VersionedParcel.ParcelException(e5);
        }
    }
    ...
    public void writeLong(long j5) {
        try {
            this.mCurrentOutput.writeLong(j5);
        } catch (IOException e5) {
            throw new VersionedParcel.ParcelException(e5);
        }
    }
