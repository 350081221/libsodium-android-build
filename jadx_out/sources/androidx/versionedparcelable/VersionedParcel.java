...
public abstract class VersionedParcel {
    ...
    public Exception readException(Exception exc, int i5) {
        ...
        return (readField(i5) && (readExceptionCode = readExceptionCode()) != 0) ? readException(readExceptionCode, readString()) : exc;
    }
    ...
    protected abstract void writeBoolean(boolean z4);
    ...
    protected abstract void writeByteArray(byte[] bArr, int i5, int i6);
    ...
    protected abstract void writeDouble(double d5);
    ...
    protected abstract void writeFloat(float f5);
    ...
    protected abstract void writeLong(long j5);
