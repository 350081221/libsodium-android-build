...
public final class c {
    ...
    public static String b(int i5) {
        return String.format(Locale.getDefault(), "%05d", Integer.valueOf(i5));
    }
    ...
    */
    public static byte[] g(byte[]... r7) {
        ...
        L41:
            ...
            r2 = r1
        L44:
            a1.e.d(r7)     // Catch: java.lang.Throwable -> L52
            if (r1 == 0) goto L4c
        ...
        L5f:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: s0.c.g(byte[][]):byte[]");
    }

    public static byte[] h(String str, byte[] bArr, String str2) {
        return o0.e.d(str, bArr, str2);
    }

    /* JADX WARN: Not initialized variable reg: 1, insn: 0x0076: MOVE (r0 I:??[OBJECT, ARRAY]) = (r1 I:??[OBJECT, ARRAY]) (LINE:119), block:B:42:0x0076 */
    /* JADX WARN: Removed duplicated region for block: B:45:0x0079 A[EXC_TOP_SPLITTER, SYNTHETIC] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public s0.b c(s0.d r6, java.lang.String r7) {
        /*
            r5 = this;
            r0 = 0
            ...
            byte[] r2 = new byte[r2]     // Catch: java.lang.Exception -> L57 java.lang.Throwable -> L75
            r1.read(r2)     // Catch: java.lang.Exception -> L57 java.lang.Throwable -> L75
            boolean r3 = r5.f22337a     // Catch: java.lang.Exception -> L57 java.lang.Throwable -> L75
            if (r3 == 0) goto L42
            java.lang.String r3 = r5.f22338b     // Catch: java.lang.Exception -> L57 java.lang.Throwable -> L75
        ...
        L42:
            ...
            if (r6 == 0) goto L4c
            byte[] r2 = o0.b.b(r2)     // Catch: java.lang.Exception -> L57 java.lang.Throwable -> L75
        L4c:
        ...
        L5e:
            ...
            r4 = r1
        L61:
            a1.e.d(r6)     // Catch: java.lang.Throwable -> L75
            if (r1 == 0) goto L69
        ...
        L7c:
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: s0.c.c(s0.d, java.lang.String):s0.b");
    }

    public d d(b bVar, boolean z4, String str) {
        byte[] g5;
        if (bVar == null) {
            return null;
        }
        ...
        if (z4) {
            try {
                bytes2 = o0.b.a(bytes2);
            } catch (Exception unused) {
                z4 = false;
            }
        }
        if (this.f22337a) {
            g5 = g(bytes, e(this.f22338b, k0.a.f18999f), h(this.f22338b, bytes2, str));
        } else {
            g5 = g(bytes, bytes2);
        }
        return new d(z4, g5);
