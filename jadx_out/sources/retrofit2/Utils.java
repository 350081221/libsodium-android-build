...
final class Utils {
    ...
    public static final class ParameterizedTypeImpl implements ParameterizedType {
        ...
        public ParameterizedTypeImpl(@Nullable Type type, Type type2, Type... typeArr) {
            ...
            if (type2 instanceof Class) {
                ...
                if (z4 != (((Class) type2).getEnclosingClass() == null)) {
        ...
        public String toString() {
            ...
            for (int i5 = 1; i5 < this.typeArguments.length; i5++) {
                sb.append(", ");
                sb.append(Utils.typeToString(this.typeArguments[i5]));
            }
            sb.append(">");
            return sb.toString();
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static Type getParameterLowerBound(int i5, ParameterizedType parameterizedType) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static RuntimeException parameterError(Method method, Throwable th, int i5, String str, Object... objArr) {
        return methodError(method, th, str + " (parameter #" + (i5 + 1) + ")", objArr);
    }
    ...
    */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static RuntimeException parameterError(Method method, int i5, String str, Object... objArr) {
        return methodError(method, str + " (parameter #" + (i5 + 1) + ")", objArr);
    }
}
