...
public final class c {
    ...
    public static String f15906a = "idnjfhncnsfuobcnt847y929o449u474w7j3h22aoddc98euk#%&&)*&^%#";

    public static String a() {
        String str = new String();
        for (int i5 = 0; i5 < f15906a.length() - 1; i5 += 4) {
            str = str + f15906a.charAt(i5);
        }
        return str;
    }
    ...
    public static String b(String str, String str2) {
        try {
            ...
            byte[] f5 = f();
            SecretKeySpec secretKeySpec = new SecretKeySpec(SecretKeyFactory.getInstance("PBKDF2WithHmacSHA1").generateSecret(d5).getEncoded(), "AES");
            Cipher cipher = Cipher.getInstance("AES/CBC/PKCS5Padding");
            cipher.init(1, secretKeySpec, new IvParameterSpec(f5));
            byte[] salt = d5.getSalt();
    ...
    public static String e(String str, String str2) {
        ...
        try {
            ...
            if (length <= 16) {
                ...
                SecretKeySpec secretKeySpec = new SecretKeySpec(SecretKeyFactory.getInstance("PBKDF2WithHmacSHA1").generateSecret(new PBEKeySpec(d5.getPassword(), Arrays.copyOf(bArr, 16), 10, 128)).getEncoded(), "AES");
                Cipher cipher = Cipher.getInstance("AES/CBC/PKCS5Padding");
    ...
    public static byte[] f() {
        try {
            ...
            for (int i5 = 0; i5 < 48; i5 += 2) {
                sb.append("AsAgAtA5A6AdAgABABACADAfAsAdAfAsAgAaAgA3A5A6=8=0".charAt(i5));
            }
