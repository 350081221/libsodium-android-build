...
public final class q0<T> extends io.reactivex.rxjava3.internal.operators.maybe.a<T, T> {
    ...
    static final class a<T> implements io.reactivex.rxjava3.core.a0<T>, io.reactivex.rxjava3.disposables.e {
        ...
        final io.reactivex.rxjava3.core.a0<? super T> f17379a;

        /* renamed from: b, reason: collision with root package name */
        io.reactivex.rxjava3.disposables.e f17380b;
        ...
        public void dispose() {
            ...
            this.f17380b = io.reactivex.rxjava3.internal.disposables.c.DISPOSED;
        }
        ...
        public void onSubscribe(io.reactivex.rxjava3.disposables.e eVar) {
            if (io.reactivex.rxjava3.internal.disposables.c.validate(this.f17380b, eVar)) {
                this.f17380b = eVar;
