...
public final class e0<T, R> extends io.reactivex.rxjava3.core.o<R> {
    ...
    final io.reactivex.rxjava3.core.d0<T> f17270b;

    /* renamed from: c, reason: collision with root package name */
    final m3.o<? super T, ? extends Iterable<? extends R>> f17271c;
    ...
    public e0(io.reactivex.rxjava3.core.d0<T> d0Var, m3.o<? super T, ? extends Iterable<? extends R>> oVar) {
        this.f17270b = d0Var;
        this.f17271c = oVar;
    }
    ...
    protected void O6(org.reactivestreams.p<? super R> pVar) {
        this.f17270b.a(new a(pVar, this.f17271c));
    }
}
