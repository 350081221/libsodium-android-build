...
public final class v2<T> extends io.reactivex.rxjava3.internal.operators.observable.a<T, T> {
    ...
    final m3.o<? super io.reactivex.rxjava3.core.i0<Object>, ? extends io.reactivex.rxjava3.core.n0<?>> f18134b;
    ...
    static final class a<T> extends AtomicInteger implements io.reactivex.rxjava3.core.p0<T>, io.reactivex.rxjava3.disposables.e {
        ...
        final a<T>.C0511a inner = new C0511a();
        ...
        /* loaded from: classes3.dex */
        final class C0511a extends AtomicReference<io.reactivex.rxjava3.disposables.e> implements io.reactivex.rxjava3.core.p0<Object> {
    ...
    public v2(io.reactivex.rxjava3.core.n0<T> n0Var, m3.o<? super io.reactivex.rxjava3.core.i0<Object>, ? extends io.reactivex.rxjava3.core.n0<?>> oVar) {
        super(n0Var);
        this.f18134b = oVar;
    }
    ...
    protected void l6(io.reactivex.rxjava3.core.p0<? super T> p0Var) {
        ...
        try {
            io.reactivex.rxjava3.core.n0<?> apply = this.f18134b.apply(M8);
