...
public final class z0<T, R> extends io.reactivex.rxjava3.internal.operators.observable.a<T, R> {
    ...
    final m3.o<? super T, ? extends io.reactivex.rxjava3.core.d0<? extends R>> f18199b;

    /* renamed from: c, reason: collision with root package name */
    final boolean f18200c;
    ...
    static final class a<T, R> extends AtomicInteger implements io.reactivex.rxjava3.core.p0<T>, io.reactivex.rxjava3.disposables.e {
        ...
        /* loaded from: classes3.dex */
        final class C0516a extends AtomicReference<io.reactivex.rxjava3.disposables.e> implements io.reactivex.rxjava3.core.a0<R>, io.reactivex.rxjava3.disposables.e {
        ...
        a(io.reactivex.rxjava3.core.p0<? super R> p0Var, m3.o<? super T, ? extends io.reactivex.rxjava3.core.d0<? extends R>> oVar, boolean z4) {
        ...
        void innerComplete(a<T, R>.C0516a c0516a) {
            this.set.c(c0516a);
            if (get() == 0) {
                boolean z4 = false;
        ...
        void innerError(a<T, R>.C0516a c0516a, Throwable th) {
            this.set.c(c0516a);
        ...
        void innerSuccess(a<T, R>.C0516a c0516a, R r5) {
            this.set.c(c0516a);
            if (get() == 0) {
                boolean z4 = false;
                if (compareAndSet(0, 1)) {
        ...
        public void onNext(T t5) {
            try {
                ...
                if (!this.cancelled && this.set.b(c0516a)) {
                    d0Var.a(c0516a);
                }
            } catch (Throwable th) {
    ...
    public z0(io.reactivex.rxjava3.core.n0<T> n0Var, m3.o<? super T, ? extends io.reactivex.rxjava3.core.d0<? extends R>> oVar, boolean z4) {
        super(n0Var);
        this.f18199b = oVar;
        this.f18200c = z4;
    }
    ...
    protected void l6(io.reactivex.rxjava3.core.p0<? super R> p0Var) {
        this.f17528a.subscribe(new a(p0Var, this.f18199b, this.f18200c));
    }
}
