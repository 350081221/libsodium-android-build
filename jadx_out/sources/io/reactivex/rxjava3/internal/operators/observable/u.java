...
public final class u<T, U> extends io.reactivex.rxjava3.internal.operators.observable.a<T, U> {
    ...
    final m3.o<? super T, ? extends io.reactivex.rxjava3.core.n0<? extends U>> f18110b;

    /* renamed from: c, reason: collision with root package name */
    final int f18111c;

    /* renamed from: d, reason: collision with root package name */
    final io.reactivex.rxjava3.internal.util.j f18112d;
    ...
    static final class a<T, R> extends AtomicInteger implements io.reactivex.rxjava3.core.p0<T>, io.reactivex.rxjava3.disposables.e {
        ...
        /* loaded from: classes3.dex */
        public static final class C0510a<R> extends AtomicReference<io.reactivex.rxjava3.disposables.e> implements io.reactivex.rxjava3.core.p0<R> {
        ...
        a(io.reactivex.rxjava3.core.p0<? super R> p0Var, m3.o<? super T, ? extends io.reactivex.rxjava3.core.n0<? extends R>> oVar, int i5, boolean z4) {
            this.downstream = p0Var;
            this.mapper = oVar;
            this.bufferSize = i5;
            this.tillTheEnd = z4;
            this.observer = new C0510a<>(p0Var, this);
        }
    ...
    static final class b<T, U> extends AtomicInteger implements io.reactivex.rxjava3.core.p0<T>, io.reactivex.rxjava3.disposables.e {
        ...
        b(io.reactivex.rxjava3.core.p0<? super U> p0Var, m3.o<? super T, ? extends io.reactivex.rxjava3.core.n0<? extends U>> oVar, int i5) {
            this.downstream = p0Var;
            this.mapper = oVar;
            this.bufferSize = i5;
    ...
    public u(io.reactivex.rxjava3.core.n0<T> n0Var, m3.o<? super T, ? extends io.reactivex.rxjava3.core.n0<? extends U>> oVar, int i5, io.reactivex.rxjava3.internal.util.j jVar) {
        super(n0Var);
        this.f18110b = oVar;
        this.f18112d = jVar;
        this.f18111c = Math.max(8, i5);
    }

    @Override // io.reactivex.rxjava3.core.i0
    public void l6(io.reactivex.rxjava3.core.p0<? super U> p0Var) {
        boolean z4;
        if (c3.b(this.f17528a, p0Var, this.f18110b)) {
            return;
        }
        if (this.f18112d == io.reactivex.rxjava3.internal.util.j.IMMEDIATE) {
            this.f17528a.subscribe(new b(new io.reactivex.rxjava3.observers.m(p0Var), this.f18110b, this.f18111c));
            return;
        }
        io.reactivex.rxjava3.core.n0<T> n0Var = this.f17528a;
        m3.o<? super T, ? extends io.reactivex.rxjava3.core.n0<? extends U>> oVar = this.f18110b;
        int i5 = this.f18111c;
        if (this.f18112d == io.reactivex.rxjava3.internal.util.j.END) {
            z4 = true;
        } else {
            z4 = false;
        }
        n0Var.subscribe(new a(p0Var, oVar, i5, z4));
    }
}
