...
public final class j3<T> extends io.reactivex.rxjava3.internal.operators.flowable.a<T, T> {
    ...
    final m3.d<? super Integer, ? super Throwable> f16831c;
    ...
    static final class a<T> extends AtomicInteger implements io.reactivex.rxjava3.core.t<T> {
        ...
        a(org.reactivestreams.p<? super T> pVar, m3.d<? super Integer, ? super Throwable> dVar, io.reactivex.rxjava3.internal.subscriptions.i iVar, org.reactivestreams.o<? extends T> oVar) {
    ...
    public j3(io.reactivex.rxjava3.core.o<T> oVar, m3.d<? super Integer, ? super Throwable> dVar) {
        super(oVar);
        this.f16831c = dVar;
    }
    ...
    public void O6(org.reactivestreams.p<? super T> pVar) {
        ...
        new a(pVar, this.f16831c, iVar, this.f16598b).subscribeNext();
    }
}
