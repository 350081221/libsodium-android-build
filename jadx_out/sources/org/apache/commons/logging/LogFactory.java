...
public abstract class LogFactory {
    ...
    public static LogFactory getFactory() throws LogConfigurationException {
        ...
        try {
            ...
            if (isDiagnosticsEnabled()) {
                logDiagnostic("[LOOKUP] A security exception occurred while trying to create an instance of the custom factory class: [" + e5.getMessage().trim() + "]. Trying alternative implementations...");
            }
        } catch (RuntimeException e6) {
            if (isDiagnosticsEnabled()) {
                logDiagnostic("[LOOKUP] An exception occurred while trying to create an instance of the custom factory class: [" + e6.getMessage().trim() + "] as specified by a system property.");
            }
            throw e6;
        }
        if (factory == null) {
        ...
        try {
            ...
            try {
                try {
                    ...
                    throw new LogConfigurationException("Unexpected IllegalAccessException", e5);
                }
    ...
    protected static LogFactory newFactory(final String factoryClass, final ClassLoader classLoader, ClassLoader contextClassLoader) throws LogConfigurationException {
        Object result = AccessController.doPrivileged((PrivilegedAction<Object>) new PrivilegedAction() { // from class: org.apache.commons.logging.LogFactory.2
            @Override // java.security.PrivilegedAction
            public Object run() {
    ...
    protected static Object createFactory(String factoryClass, ClassLoader classLoader) {
        ...
        try {
            ...
            if (logFactoryClass != null && !LogFactory.class.isAssignableFrom(logFactoryClass)) {
                return new LogConfigurationException("The chosen LogFactory implementation does not extend LogFactory. Please check your configuration.", e7);
            }
            return new LogConfigurationException(e7);
        }
    }
    ...
    private static boolean implementsLogFactory(Class logFactoryClass) {
        ...
        if (logFactoryClass != null) {
            try {
                ...
                logDiagnostic("[CUSTOM LOG FACTORY] LinkageError thrown whilst trying to determine whether the compatibility was caused by a classloader conflict: " + e6.getMessage());
            } catch (SecurityException e7) {
                logDiagnostic("[CUSTOM LOG FACTORY] SecurityException thrown whilst trying to determine whether the compatibility was caused by a classloader conflict: " + e7.getMessage());
            }
        }
            ...
            public Object run() {
                try {
                    ...
                    if (LogFactory.isDiagnosticsEnabled()) {
                        LogFactory.logDiagnostic("Exception while trying to find configuration file " + name + ":" + e5.getMessage());
                    }
                    return null;
    ...
    private static final Properties getConfigurationFile(ClassLoader classLoader, String fileName) {
        ...
        if (isDiagnosticsEnabled()) {
            if (props == null) {
                ...
                logDiagnostic("[LOOKUP] Properties file of name '" + fileName + "' found at '" + propsUrl + k0.f19765b);
            }
        }
        return props;
    }
    ...
    private static void initDiagnostics() {
        ...
        try {
            ...
            try {
                ...
                classLoaderName = GrsBaseInfo.CountryCodeSource.UNKNOWN;
            }
    ...
    public static String objectId(Object o5) {
        if (o5 == null) {
            return "null";
        }
        return o5.getClass().getName() + "@" + System.identityHashCode(o5);
    }
}
