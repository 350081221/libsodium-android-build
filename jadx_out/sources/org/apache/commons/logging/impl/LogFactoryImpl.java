...
public class LogFactoryImpl extends LogFactory {
    ...
    public String[] getAttributeNames() {
        ...
        for (int i5 = 0; i5 < results.length; i5++) {
            results[i5] = (String) names.elementAt(i5);
        }
        return results;
    }
    ...
    protected Log newInstance(String name) throws LogConfigurationException {
        ...
        try {
            ...
            Throwable c5 = e5.getTargetException();
            if (c5 != null) {
                throw new LogConfigurationException(c5);
            }
            throw new LogConfigurationException(e5);
        } catch (LogConfigurationException lce) {
            throw lce;
        } catch (Throwable t5) {
            throw new LogConfigurationException(t5);
        }
    }
    ...
    private Log discoverLogImplementation(String logCategory) throws LogConfigurationException {
        ...
        for (int i5 = 0; i5 < classesToDiscover.length && result == null; i5++) {
            result = createLogFromClass(classesToDiscover[i5], logCategory, true);
        }
        if (result == null) {
    ...
    private String findUserSpecifiedLogClassName() {
        ...
        if (specifiedClass == null) {
            ...
            try {
                ...
                if (isDiagnosticsEnabled()) {
                    logDiagnostic("No access allowed to system property 'org.apache.commons.logging.Log' - " + e5.getMessage());
                }
            }
        }
        if (specifiedClass == null) {
            ...
            try {
                ...
                if (isDiagnosticsEnabled()) {
                    logDiagnostic("No access allowed to system property 'org.apache.commons.logging.log' - " + e6.getMessage());
                }
            }
        }
        if (specifiedClass != null) {
    ...
    private Log createLogFromClass(String logAdapterClassName, String logCategory, boolean affectState) throws LogConfigurationException {
        ...
        while (true) {
            ...
            try {
                if (isDiagnosticsEnabled()) {
                    String resourceName = logAdapterClassName.replace(d.f15957a, ClassPathElement.SEPARATOR_CHAR) + ".class";
                    if (currentCL != null) {
                ...
                try {
                    c5 = Class.forName(logAdapterClassName, true, currentCL);
                    ...
                    try {
                        c5 = Class.forName(logAdapterClassName);
                ...
                constructor = c5.getConstructor(this.logConstructorSignature);
                o5 = constructor.newInstance(params);
            } catch (ExceptionInInitializerError e5) {
                String msg3 = "" + e5.getMessage();
                ...
                handleFlawedDiscovery(logAdapterClassName, currentCL, t5);
            }
            if (o5 instanceof Log) {
                logAdapterClass = c5;
                logAdapter = (Log) o5;
                break;
            }
            handleFlawedHierarchy(currentCL, c5);
            if (currentCL == null) {
                break;
            }
    ...
    private ClassLoader getLowestClassLoader(ClassLoader c12, ClassLoader c22) {
        if (c12 == null) {
            return c22;
        }
        if (c22 == null) {
        ...
        for (ClassLoader current = c12; current != null; current = current.getParent()) {
            if (current == c22) {
                return c12;
            }
        }
        for (ClassLoader current2 = c22; current2 != null; current2 = current2.getParent()) {
            if (current2 == c12) {
                return c22;
            }
        }
    ...
    private void handleFlawedHierarchy(ClassLoader badClassLoader, Class badClass) throws LogConfigurationException {
        ...
        while (true) {
            ...
            if (!logInterfaceName.equals(interfaces[i5].getName())) {
                i5++;
            } else {
                implementsLog = true;
                break;
