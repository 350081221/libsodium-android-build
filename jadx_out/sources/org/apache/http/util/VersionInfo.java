...
public class VersionInfo {
    ...
    public static final VersionInfo[] loadVersionInfo(String[] pckgs, ClassLoader clsldr) {
        ...
        int i5 = vil.size();
        return (VersionInfo[]) vil.toArray(new VersionInfo[i5]);
    }
    ...
    public static final VersionInfo loadVersionInfo(String pckg, ClassLoader clsldr) {
        ...
        Properties vip = null;
        try {
            InputStream is = clsldr.getResourceAsStream(pckg.replace(d.f15957a, ClassPathElement.SEPARATOR_CHAR) + "/" + VERSION_PROPERTY_FILE);
            if (is != null) {
                try {
