...
public final class RouteTracker implements RouteInfo, Cloneable {
    ...
    public final boolean equals(Object o5) {
        if (o5 == this) {
            return true;
        }
        if (!(o5 instanceof RouteTracker)) {
            return false;
        }
        RouteTracker that = (RouteTracker) o5;
        boolean equal = this.targetHost.equals(that.targetHost);
        boolean equal2 = (this.connected == that.connected && this.secure == that.secure && this.tunnelled == that.tunnelled && this.layered == that.layered) & equal & (this.localAddress == that.localAddress || (this.localAddress != null && this.localAddress.equals(that.localAddress))) & (this.proxyChain == that.proxyChain || !(this.proxyChain == null || that.proxyChain == null || this.proxyChain.length != that.proxyChain.length));
        if (equal2 && this.proxyChain != null) {
            for (int i5 = 0; equal2 && i5 < this.proxyChain.length; i5++) {
                equal2 = this.proxyChain[i5].equals(that.proxyChain[i5]);
            }
        }
        return equal2;
    }
    ...
    public final int hashCode() {
        ...
        if (this.proxyChain != null) {
            ...
            for (int i5 = 0; i5 < this.proxyChain.length; i5++) {
                hc ^= this.proxyChain[i5].hashCode();
            }
        }
        if (this.connected) {
            hc ^= 286331153;
