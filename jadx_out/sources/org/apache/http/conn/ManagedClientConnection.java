...
public interface ManagedClientConnection extends HttpClientConnection, HttpInetConnection, ConnectionReleaseTrigger {
    ...
    void tunnelProxy(HttpHost httpHost, boolean z4, HttpParams httpParams) throws IOException;

    void tunnelTarget(boolean z4, HttpParams httpParams) throws IOException;
