...
public abstract class AbstractConnPool implements RefQueueHandler {
    ...
    public abstract void freeEntry(BasicPoolEntry basicPoolEntry, boolean z4, long j5, TimeUnit timeUnit);
    ...
    public void enableConnectionGC() throws IllegalStateException {
        ...
        try {
            ...
            Thread t5 = new Thread(this.refWorker);
            t5.setDaemon(true);
            t5.setName("RefQueueWorker@" + this);
            t5.start();
        } catch (Throwable th) {
            this.poolLock.unlock();
            throw th;
