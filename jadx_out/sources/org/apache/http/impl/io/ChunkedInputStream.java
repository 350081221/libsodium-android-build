...
public class ChunkedInputStream extends InputStream {
    ...
    public int read(byte[] b5, int off, int len) throws IOException {
        ...
        int count = this.in.read(b5, off, Math.min(len, this.chunkSize - this.pos));
        this.pos += count;
        return count;
    }
    ...
    private int getChunkSize() throws IOException {
        ...
        this.buffer.clear();
        int i5 = this.in.readLine(this.buffer);
        if (i5 == -1) {
    ...
    private void parseTrailerHeaders() throws IOException {
        try {
            ...
            IOException ioe = new MalformedChunkCodingException("Invalid footer: " + e5.getMessage());
            ExceptionUtils.initCause(ioe, e5);
            throw ioe;
        }
    }
