...
public class BrowserCompatSpec extends CookieSpecBase {
    ...
    public List<Cookie> parse(Header header, CookieOrigin origin) throws MalformedCookieException {
        ...
        int i12 = headervalue.toLowerCase(Locale.ENGLISH).indexOf("expires=");
        if (i12 != -1) {
            int i13 = i12 + "expires=".length();
            int i22 = headervalue.indexOf(59, i13);
            if (i22 == -1) {
                i22 = headervalue.length();
            }
            try {
                DateUtils.parseDate(headervalue.substring(i13, i22), this.datepatterns);
