...
public class TileSystemWebMercator extends TileSystem {
    ...
    public double getLatitudeFromY01(double d5) {
        return 90.0d - ((Math.atan(Math.exp(((d5 - 0.5d) * 2.0d) * 3.141592653589793d)) * 360.0d) / 3.141592653589793d);
    }

    @Override // org.osmdroid.util.TileSystem
    public double getLongitudeFromX01(double d5) {
        return getMinLongitude() + ((getMaxLongitude() - getMinLongitude()) * d5);
    }
    ...
    @Override // org.osmdroid.util.TileSystem
    public double getX01FromLongitude(double d5) {
        return (d5 - getMinLongitude()) / (getMaxLongitude() - getMinLongitude());
    }

    @Override // org.osmdroid.util.TileSystem
    public double getY01FromLatitude(double d5) {
