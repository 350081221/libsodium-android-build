...
public class IconOverlay extends Overlay {
    ...
    public void draw(Canvas canvas, Projection projection) {
        ...
        if (this.mFlat) {
            orientation = -this.mBearing;
        } else {
            orientation = projection.getOrientation() - this.mBearing;
        }
        float f5 = orientation;
        Drawable drawable = this.mIcon;
        Point point = this.mPositionPixels;
        Overlay.drawAt(canvas, drawable, point.x, point.y, false, f5);
    }
