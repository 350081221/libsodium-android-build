...
public abstract class NonAcceleratedOverlay extends Overlay {
    ...
    public final void draw(Canvas canvas, MapView mapView, boolean z4) {
        if (isUsingBackingBitmap() && canvas.isHardwareAccelerated()) {
            if (!z4 && canvas.getWidth() != 0 && canvas.getHeight() != 0) {
                ...
                onDraw(this.mBackingCanvas, canvas, mapView, z4);
                canvas.save();
        ...
        onDraw(canvas, canvas, mapView, z4);
    }
    ...
    protected void onDraw(Canvas canvas, Canvas canvas2, MapView mapView, boolean z4) {
        onDraw(canvas, mapView, z4);
    }

    protected abstract void onDraw(Canvas canvas, MapView mapView, boolean z4);
