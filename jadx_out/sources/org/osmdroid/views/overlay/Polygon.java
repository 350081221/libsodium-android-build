...
public class Polygon extends PolyOverlayWithIW {
    ...
    public static ArrayList<GeoPoint> pointsAsCircle(GeoPoint geoPoint, double d5) {
        ArrayList<GeoPoint> arrayList = new ArrayList<>(60);
        for (int i5 = 0; i5 < 360; i5 += 6) {
            arrayList.add(geoPoint.destinationPoint(d5, i5));
        }
        return arrayList;
    }
    ...
    public static ArrayList<IGeoPoint> pointsAsRect(GeoPoint geoPoint, double d5, double d6) {
        ArrayList<IGeoPoint> arrayList = new ArrayList<>(4);
        GeoPoint destinationPoint = geoPoint.destinationPoint(d5 * 0.5d, 90.0d);
        GeoPoint destinationPoint2 = geoPoint.destinationPoint(d6 * 0.5d, 180.0d);
