...
public class b {
    ...
    public static final Object f21624a = new a(0);
    ...
    public b(Map map) {
        this.f21625b = map == null ? new HashMap() : map;
    }
    ...
    public b(c cVar) {
        ...
        while (true) {
            ...
            if (d5 != null) {
                b(d5);
                this.f21625b.put(obj, d5);
            } else {
                this.f21625b.remove(obj);
            }
            char c7 = cVar.c();
            if (c7 != ',' && c7 != ';') {
                if (c7 != '}') {
    ...
    */
    ...
    public final Object a(String str) {
        Object obj = str == null ? null : this.f21625b.get(str);
        if (obj != null) {
            return obj;
        }
    ...
    public final Iterator a() {
        return this.f21625b.keySet().iterator();
    }

    public final boolean b(String str) {
        return this.f21625b.containsKey(str);
    }
    ...
    public String toString() {
        try {
            ...
            while (a5.hasNext()) {
                ...
                stringBuffer.append(':');
                stringBuffer.append(a(this.f21625b.get(next)));
            }
            stringBuffer.append('}');
