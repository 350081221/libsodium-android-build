...
public final class a {
    ...
    private static final String f22724a = "";

    /* renamed from: b, reason: collision with root package name */
    private static final String f22725b = "HexUtil";
    ...
    public static String a(String str) {
        ...
        try {
            ...
            c.d(f22725b, "byte array 2 hex string exception : " + e5.getMessage());
            return "";
        }
    }
    ...
    public static byte[] c(String str) {
        ...
        try {
            ...
            c.d(f22725b, "hex string 2 byte array exception : " + e5.getMessage());
        }
        return bArr;
    }
}
