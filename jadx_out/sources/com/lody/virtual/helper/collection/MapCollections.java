...
public abstract class MapCollections<K, V> {
    ...
    final class ArrayIterator<T> implements Iterator<T> {
        ...
        @Override // java.util.Iterator
        public T next() {
            T t5 = (T) MapCollections.this.colGetEntry(this.mIndex, this.mOffset);
            this.mIndex++;
        ...
        public void remove() {
            if (this.mCanRemove) {
                ...
                MapCollections.this.colRemoveAt(i5);
                return;
            }
    ...
    final class MapIterator implements Iterator<Map.Entry<K, V>>, Map.Entry<K, V> {
        ...
        public V setValue(V v4) {
            if (this.mEntryValid) {
                return (V) MapCollections.this.colSetValue(this.mIndex, v4);
            }
            throw new IllegalStateException("This container does not support retaining Map.Entry objects");
        }
    ...
    final class ValuesCollection implements Collection<V> {
        ...
        public boolean removeAll(Collection<?> collection) {
            ...
            boolean z4 = false;
            while (i5 < colGetSize) {
                if (collection.contains(MapCollections.this.colGetEntry(i5, 1))) {
                    MapCollections.this.colRemoveAt(i5);
                    i5--;
                    colGetSize--;
                    z4 = true;
    ...
    protected abstract Object colGetEntry(int i5, int i6);
    ...
    protected abstract void colPut(K k5, V v4);

    protected abstract void colRemoveAt(int i5);

    protected abstract V colSetValue(int i5, V v4);
    ...
    public Object[] toArrayHelper(int i5) {
        int colGetSize = colGetSize();
        Object[] objArr = new Object[colGetSize];
        for (int i6 = 0; i6 < colGetSize; i6++) {
            objArr[i6] = colGetEntry(i6, i5);
        }
        return objArr;
    }

    public <T> T[] toArrayHelper(T[] tArr, int i5) {
        int colGetSize = colGetSize();
        if (tArr.length < colGetSize) {
            tArr = (T[]) ((Object[]) Array.newInstance(tArr.getClass().getComponentType(), colGetSize));
        }
        for (int i6 = 0; i6 < colGetSize; i6++) {
            tArr[i6] = colGetEntry(i6, i5);
        }
        if (tArr.length > colGetSize) {
