...
public class AppWidgetManagerStub extends BinderInvocationProxy {
    ...
    public void onBindMethods() {
        ...
        addMethodProxy(new ResultStaticMethodProxy("hasBindAppWidgetPermission", bool));
        addMethodProxy(new ResultStaticMethodProxy("setBindAppWidgetPermission", 0));
        addMethodProxy(new ResultStaticMethodProxy("bindAppWidgetId", bool));
        ...
        addMethodProxy(new ResultStaticMethodProxy("isBoundWidgetPackage", bool));
        addMethodProxy(new ResultStaticMethodProxy("updateAppWidgetProviderInfo", 0));
        addMethodProxy(new ResultStaticMethodProxy("requestPinAppWidget", bool));
        addMethodProxy(new ResultStaticMethodProxy("noteAppWidgetTapped", 0));
    }
}
