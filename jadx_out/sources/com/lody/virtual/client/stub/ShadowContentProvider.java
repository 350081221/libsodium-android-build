...
public class ShadowContentProvider extends ContentProvider {
    ...
    private Bundle initProcess(Bundle bundle) {
        ...
        ClientConfig clientConfig = (ClientConfig) bundle.getParcelable("_VA_|_client_config_");
        int i5 = bundle.getInt("_VA_|_core_pid_", -1);
        VClient vClient = VClient.get();
        vClient.initProcess(clientConfig);
        vClient.setCorePid(i5);
        Bundle bundle2 = new Bundle();
        BundleCompat.putBinder(bundle2, "_VA_|_client_", vClient.asBinder());
