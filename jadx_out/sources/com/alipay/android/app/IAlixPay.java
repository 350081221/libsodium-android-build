        ...
        public static class a implements IAlixPay {
            ...
            public String Pay(String str) throws RemoteException {
                ...
                try {
                    ...
                    this.f2688a.transact(1, obtain, obtain2, 0);
            ...
            public void deployFastConnect() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.f2688a.transact(6, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public int getVersion() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.f2688a.transact(8, obtain, obtain2, 0);
                    obtain2.readException();
            ...
            public boolean manager(String str) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeString(str);
                    boolean z4 = false;
                    this.f2688a.transact(7, obtain, obtain2, 0);
                    obtain2.readException();
            ...
            public String pay02(String str, Map map) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeString(str);
                    obtain.writeMap(map);
                    this.f2688a.transact(9, obtain, obtain2, 0);
                    obtain2.readException();
                    return obtain2.readString();
                } finally {
                    obtain2.recycle();
            ...
            public String prePay(String str) throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    obtain.writeString(str);
                    this.f2688a.transact(5, obtain, obtain2, 0);
                    obtain2.readException();
                    return obtain2.readString();
                } finally {
                    obtain2.recycle();
            ...
            public void r03(String str, String str2, Map map) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeMap(map);
                    this.f2688a.transact(10, obtain, null, 1);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public void registerCallback(IRemoteServiceCallback iRemoteServiceCallback) throws RemoteException {
                ...
                try {
                    ...
                    this.f2688a.transact(3, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void registerCallback03(IRemoteServiceCallback iRemoteServiceCallback, String str, Map map) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeString(str);
                    obtain.writeMap(map);
                    this.f2688a.transact(11, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public String test() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.f2688a.transact(2, obtain, obtain2, 0);
                    obtain2.readException();
                    return obtain2.readString();
                } finally {
                    obtain2.recycle();
            ...
            public void unregisterCallback(IRemoteServiceCallback iRemoteServiceCallback) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeStrongBinder(iBinder);
                    this.f2688a.transact(4, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
