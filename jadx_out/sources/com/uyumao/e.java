...
public class e {
    ...
    public static Context f13663a;

    /* renamed from: b, reason: collision with root package name */
    public static WeakReference<Future<?>> f13664b;

    /* renamed from: c, reason: collision with root package name */
    public static WeakReference<Future<?>> f13665c;
    ...
    public static JSONArray e(Context context) {
        ...
        try {
            if (a(context, "android.permission.ACCESS_WIFI_STATE") && (wifiManager = (WifiManager) context.getSystemService(NetworkUtil.NETWORK_TYPE_WIFI)) != null) {
    ...
    public static String[] g(Context context) {
        ...
        String[] strArr = {"", ""};
        try {
            if (a(context, "android.permission.ACCESS_WIFI_STATE") && a(context, "android.permission.ACCESS_COARSE_LOCATION") && a(context, "android.permission.ACCESS_FINE_LOCATION") && (wifiManager = (WifiManager) context.getApplicationContext().getSystemService(NetworkUtil.NETWORK_TYPE_WIFI)) != null && (connectionInfo = wifiManager.getConnectionInfo()) != null) {
    ...
    public static JSONObject a(JSONObject jSONObject, String str, String str2, boolean z4) throws Exception {
        SystemClock.elapsedRealtime();
        URL url = new URL(str);
        return new JSONObject(a(jSONObject.toString(), (HttpURLConnection) url.openConnection(), str2));
    }
    ...
    public static boolean a(File file, byte[] bArr, boolean z4) {
    ...
    */
    ...
    public static String a(String str, HttpURLConnection httpURLConnection, String str2) throws Exception {
        ...
        byte[] a5 = a(byteArrayOutputStream.toByteArray(), bytes);
        httpURLConnection.setRequestMethod(HttpPost.METHOD_NAME);
        httpURLConnection.setReadTimeout(30000);
        httpURLConnection.setConnectTimeout(30000);
        httpURLConnection.addRequestProperty(HTTP.CONTENT_TYPE, "application/octet-stream");
        httpURLConnection.addRequestProperty(HTTP.CONTENT_ENCODING, "xgzip");
        httpURLConnection.addRequestProperty("appkey", str2);
        httpURLConnection.setFixedLengthStreamingMode(a5.length);
        httpURLConnection.setDoOutput(true);
        try {
            inputStream = httpURLConnection.getOutputStream();
            inputStream.write(a5);
            n.a(inputStream);
            ...
            if (responseCode == 200 && TextUtils.equals("xgzip", httpURLConnection.getHeaderField(HTTP.CONTENT_ENCODING))) {
                byte[] a6 = a(byteArrayOutputStream.toByteArray(), bytes);
                byteArrayOutputStream.reset();
                a(a6, byteArrayOutputStream);
            }
                    ...
                    for (CellInfo cellInfo : allCellInfo) {
                        if (cellInfo.isRegistered()) {
                            ...
                            if (cellInfo instanceof CellInfoLte) {
                                ...
                                jSONObject3.put("mnc", substring3);
