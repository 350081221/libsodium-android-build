...
public abstract class RegisterAllocator {
    ...
    public final int getCategoryForSsaReg(int i5) {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public final RegisterSpec getDefinitionSpecForSsaReg(int i5) {
        SsaInsn definitionForRegister = this.ssaMeth.getDefinitionForRegister(i5);
        if (definitionForRegister == null) {
            return null;
        }
        ...
        if (indexOf >= 0) {
            if (indexOf == insns.size() - 1) {
                ...
                for (int i5 = 0; i5 < size; i5++) {
                    this.interference.add(reg, sources.get(i5).getReg());
                }
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public boolean isDefinitionMoveParam(int i5) {
        SsaInsn definitionForRegister = this.ssaMeth.getDefinitionForRegister(i5);
