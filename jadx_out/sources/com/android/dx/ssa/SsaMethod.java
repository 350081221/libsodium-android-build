...
public final class SsaMethod {
    ...
    private SsaMethod(RopMethod ropMethod, int i5, boolean z4) {
        this.paramWidth = i5;
        this.isStatic = z4;
    ...
    public static BitSet bitSetFromLabelList(BasicBlockList basicBlockList, IntList intList) {
        ...
        for (int i5 = 0; i5 < size; i5++) {
            bitSet.set(basicBlockList.indexOfLabel(intList.get(i5)));
        }
        return bitSet;
    }
    ...
    private void buildUseList() {
        if (!this.backMode) {
            ...
            forEachInsn(new SsaInsn.Visitor() { // from class: com.android.dx.ssa.SsaMethod.2
                private void addToUses(SsaInsn ssaInsn) {
                    ...
                    for (int i6 = 0; i6 < size; i6++) {
                        SsaMethod.this.useList[sources.get(i6).getReg()].add(ssaInsn);
                    }
                }
            ...
            for (int i6 = 0; i6 < this.registerCount; i6++) {
                this.unmodifiableUseList[i6] = Collections.unmodifiableList(this.useList[i6]);
            }
            return;
        }
    ...
    private void convertRopToSsaBlocks(RopMethod ropMethod) {
        ...
        for (int i5 = 0; i5 < size; i5++) {
            this.blocks.add(SsaBasicBlock.newFromRop(ropMethod, i5, this));
        }
    ...
    public static IntList indexListFromLabelList(BasicBlockList basicBlockList, IntList intList) {
        ...
        int size = intList.size();
        for (int i5 = 0; i5 < size; i5++) {
            intList2.add(basicBlockList.indexOfLabel(intList.get(i5)));
        }
        return intList2;
    }

    public static SsaMethod newFromRopMethod(RopMethod ropMethod, int i5, boolean z4) {
        SsaMethod ssaMethod = new SsaMethod(ropMethod, i5, z4);
    ...
    private void removeFromUseList(SsaInsn ssaInsn, RegisterSpecList registerSpecList) {
        ...
        for (int i5 = 0; i5 < size; i5++) {
            if (!this.useList[registerSpecList.get(i5).getReg()].remove(ssaInsn)) {
                throw new RuntimeException("use not found");
            }
        }
    }

    public int blockIndexToRopLabel(int i5) {
        if (i5 < 0) {
            return -1;
        }
        return this.blocks.get(i5).getRopLabel();
    }

    public int borrowSpareRegister(int i5) {
        int i6 = this.spareRegisterBase;
        int i7 = this.borrowedSpareRegisters;
        int i8 = i6 + i7;
        this.borrowedSpareRegisters = i7 + i5;
        this.registerCount = Math.max(this.registerCount, i5 + i8);
        return i8;
    }
    ...
    public void deleteInsns(Set<SsaInsn> set) {
        ...
        for (SsaInsn ssaInsn2 : set) {
            ...
            while (true) {
                ...
                SsaInsn ssaInsn3 = insns.get(size);
                if (ssaInsn2 == ssaInsn3) {
                    onInsnRemoved(ssaInsn3);
                    insns.remove(size);
                    break;
                }
                size--;
            ...
            if (block != getExitBlock() && (size2 == 0 || ssaInsn.getOriginalRopInsn() == null || ssaInsn.getOriginalRopInsn().getOpcode().getBranchingness() == 1)) {
    ...
    public SsaInsn getDefinitionForRegister(int i5) {
        if (!this.backMode) {
            SsaInsn[] ssaInsnArr = this.definitionList;
            if (ssaInsnArr != null) {
                return ssaInsnArr[i5];
            }
    ...
    public SsaBasicBlock getExitBlock() {
        int i5 = this.exitBlockIndex;
        if (i5 < 0) {
            return null;
        }
        return this.blocks.get(i5);
    }
    ...
    public ArrayList<SsaInsn>[] getUseListCopy() {
        ...
        for (int i5 = 0; i5 < this.registerCount; i5++) {
            arrayListArr[i5] = new ArrayList<>(this.useList[i5]);
        }
        return arrayListArr;
    }

    public List<SsaInsn> getUseListForRegister(int i5) {
        if (this.unmodifiableUseList == null) {
            buildUseList();
        }
        return this.unmodifiableUseList[i5];
    }
    ...
    public void makeExitBlock() {
        if (this.exitBlockIndex < 0) {
            ...
            int i5 = this.exitBlockIndex;
            int i6 = this.maxLabel;
            this.maxLabel = i6 + 1;
            SsaBasicBlock ssaBasicBlock = new SsaBasicBlock(i5, i6, this);
    ...
    public SsaBasicBlock makeNewGotoBlock() {
        ...
        this.maxLabel = i5 + 1;
        SsaBasicBlock ssaBasicBlock = new SsaBasicBlock(size, i5, this);
    ...
    public int makeNewSsaReg() {
        int i5 = this.registerCount;
        int i6 = i5 + 1;
        this.registerCount = i6;
        this.spareRegisterBase = i6;
        onInsnsChanged();
        return i5;
    }
    ...
    public void onSourcesChanged(SsaInsn ssaInsn, RegisterSpecList registerSpecList) {
        ...
        int size = sources.size();
        for (int i5 = 0; i5 < size; i5++) {
            this.useList[sources.get(i5).getReg()].add(ssaInsn);
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void setNewRegCount(int i5) {
