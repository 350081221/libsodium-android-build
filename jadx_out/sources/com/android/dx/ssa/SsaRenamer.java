...
public class SsaRenamer implements Runnable {
    ...
    private class BlockRenamer implements SsaInsn.Visitor {
        ...
        private void addMapping(int i5, RegisterSpec registerSpec) {
            int reg = registerSpec.getReg();
            LocalItem localItem = registerSpec.getLocalItem();
            RegisterSpec[] registerSpecArr = this.currentMapping;
            registerSpecArr[i5] = registerSpec;
        ...
        public void visitMoveInsn(NormalSsaInsn normalSsaInsn) {
            ...
            if (Optimizer.getPreserveLocals() && (!z4 || !SsaRenamer.equalsHandlesNulls(localItem2, localItem) || SsaRenamer.this.threshold != 0)) {
                if (z4 && localItem == null && SsaRenamer.this.threshold == 0) {
    ...
    public SsaRenamer(SsaMethod ssaMethod) {
        ...
        for (int i5 = 0; i5 < this.ropRegCount; i5++) {
            registerSpecArr[i5] = RegisterSpec.make(i5, Type.VOID);
        }
        this.startsForBlocks[ssaMethod.getEntryBlockIndex()] = registerSpecArr;
    }

    static /* synthetic */ int access$108(SsaRenamer ssaRenamer) {
        int i5 = ssaRenamer.nextSsaReg;
        ssaRenamer.nextSsaReg = i5 + 1;
        return i5;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public LocalItem getLocalForNewReg(int i5) {
        if (i5 < this.ssaRegToLocalItems.size()) {
            return this.ssaRegToLocalItems.get(i5);
        }
        return null;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public boolean isBelowThresholdRegister(int i5) {
        return i5 < this.threshold;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public boolean isVersionZeroRegister(int i5) {
        return i5 < this.ropRegCount;
    }
    ...
    public SsaRenamer(SsaMethod ssaMethod, int i5) {
        this(ssaMethod);
        this.threshold = i5;
    }
}
