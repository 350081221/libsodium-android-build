...
public final class PhiInsn extends SsaInsn {
    ...
    public static class Operand {
        ...
        public Operand(RegisterSpec registerSpec, int i5, int i6) {
    ...
    public RegisterSpecList getSources() {
        ...
        for (int i5 = 0; i5 < size; i5++) {
            this.sources.set(i5, this.operands.get(i5).regSpec);
        }
    ...
    public int predBlockIndexForSourcesIndex(int i5) {
        return this.operands.get(i5).blockIndex;
    }

    public List<SsaBasicBlock> predBlocksForReg(int i5, SsaMethod ssaMethod) {
        ArrayList arrayList = new ArrayList();
        Iterator<Operand> it = this.operands.iterator();
        while (it.hasNext()) {
            Operand next = it.next();
            if (next.regSpec.getReg() == i5) {
    ...
    protected final String toHumanWithInline(String str) {
        ...
        if (size == 0) {
            ...
            for (int i5 = 0; i5 < size; i5++) {
                sb.append(" ");
                sb.append(this.sources.get(i5).toHuman() + "[b=" + Hex.u2(this.operands.get(i5).ropLabel) + "]");
            }
        }
        return sb.toString();
    }
    ...
    @Override // com.android.dx.ssa.SsaInsn
    /* renamed from: clone */
    public PhiInsn mo6428clone() {
        throw new UnsupportedOperationException("can't clone phi");
    }

    public PhiInsn(int i5, SsaBasicBlock ssaBasicBlock) {
        super(RegisterSpec.make(i5, Type.VOID), ssaBasicBlock);
        this.operands = new ArrayList<>();
        this.ropResultReg = i5;
    }
}
