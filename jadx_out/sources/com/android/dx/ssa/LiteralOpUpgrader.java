...
public class LiteralOpUpgrader {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void replacePlainInsn(NormalSsaInsn normalSsaInsn, RegisterSpecList registerSpecList, int i5, Constant constant) {
        Insn plainCstInsn;
        Insn originalRopInsn = normalSsaInsn.getOriginalRopInsn();
        Rop ropFor = Rops.ropFor(i5, normalSsaInsn.getResult(), registerSpecList, constant);
        if (constant == null) {
