...
public final class Dominators {
    ...
    private Dominators(SsaMethod ssaMethod, DomFront.DomInfo[] domInfoArr, boolean z4) {
        this.meth = ssaMethod;
    ...
    private void run() {
        ...
        while (true) {
            ...
            SsaBasicBlock ssaBasicBlock = this.vertex.get(i7);
            DFSInfo dFSInfo = this.info[ssaBasicBlock.getIndex()];
            ...
            for (int nextSetBit = preds.nextSetBit(0); nextSetBit >= 0; nextSetBit = preds.nextSetBit(nextSetBit + 1)) {
                ...
                if (this.info[ssaBasicBlock2.getIndex()] != null && (i6 = this.info[eval(ssaBasicBlock2).getIndex()].semidom) < dFSInfo.semidom) {
                    dFSInfo.semidom = i6;
                }
            }
        ...
        for (i5 = 2; i5 <= size; i5++) {
            SsaBasicBlock ssaBasicBlock4 = this.vertex.get(i5);
