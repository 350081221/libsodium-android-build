...
public final class TwoColumnOutput {
    ...
    public TwoColumnOutput(Writer writer, int i5, int i6, String str) {
        if (writer == null) {
        ...
        if (str != null) {
            ...
            this.leftColumn = new IndentingWriter(stringWriter, i5);
            this.rightColumn = new IndentingWriter(stringWriter2, i6, str);
            return;
        }
    ...
    public static String toString(String str, int i5, String str2, String str3, int i6) {
        StringWriter stringWriter = new StringWriter((str.length() + str3.length()) * 3);
        TwoColumnOutput twoColumnOutput = new TwoColumnOutput(stringWriter, i5, i6, str2);
        try {
    ...
    private static void writeSpaces(Writer writer, int i5) throws IOException {
        while (i5 > 0) {
            writer.write(32);
            i5--;
        }
    ...
    public TwoColumnOutput(OutputStream outputStream, int i5, int i6, String str) {
        this(new OutputStreamWriter(outputStream), i5, i6, str);
    }
}
