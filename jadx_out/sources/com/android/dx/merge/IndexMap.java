...
public final class IndexMap {
    ...
    private final class EncodedValueTransformer {
        ...
        public void transformAnnotation(EncodedValueReader encodedValueReader) {
            ...
            for (int i5 = 0; i5 < readAnnotation; i5++) {
        ...
        private void writeTypeAndArg(int i5, int i6) {
            this.out.writeByte(i5 | (i6 << 5));
        }
    ...
    public int adjustAnnotation(int i5) {
        return this.annotationOffsets.get(Integer.valueOf(i5)).intValue();
    }

    public int adjustAnnotationDirectory(int i5) {
        return this.annotationDirectoryOffsets.get(Integer.valueOf(i5)).intValue();
    }

    public int adjustAnnotationSet(int i5) {
        return this.annotationSetOffsets.get(Integer.valueOf(i5)).intValue();
    }

    public int adjustAnnotationSetRefList(int i5) {
        return this.annotationSetRefListOffsets.get(Integer.valueOf(i5)).intValue();
    }

    public int adjustCallSite(int i5) {
        return this.callSiteIds[i5];
    }

    public int adjustEncodedArray(int i5) {
        return this.encodedArrayValueOffset.get(Integer.valueOf(i5)).intValue();
    }
    ...
    public int adjustField(int i5) {
        return this.fieldIds[i5] & m2.f19496d;
    }

    public int adjustMethod(int i5) {
        return this.methodIds[i5] & m2.f19496d;
    }

    public int adjustMethodHandle(int i5) {
        return this.methodHandleIds.get(Integer.valueOf(i5)).intValue();
    }

    public int adjustProto(int i5) {
        return this.protoIds[i5] & m2.f19496d;
    }

    public int adjustString(int i5) {
        if (i5 == -1) {
            return -1;
        }
        return this.stringIds[i5];
    }

    public int adjustType(int i5) {
        if (i5 == -1) {
            return -1;
        }
        return 65535 & this.typeIds[i5];
    }
    ...
    public TypeList adjustTypeList(TypeList typeList) {
        ...
        for (int i5 = 0; i5 < sArr.length; i5++) {
            sArr[i5] = (short) adjustType(sArr[i5]);
        }
        return new TypeList(this.target, sArr);
    }

    public int adjustTypeListOffset(int i5) {
        return this.typeListOffsets.get(Integer.valueOf(i5)).intValue();
    }

    public void putAnnotationDirectoryOffset(int i5, int i6) {
        if (i5 > 0 && i6 > 0) {
            this.annotationDirectoryOffsets.put(Integer.valueOf(i5), Integer.valueOf(i6));
            return;
        }
        throw new IllegalArgumentException();
    }

    public void putAnnotationOffset(int i5, int i6) {
        if (i5 > 0 && i6 > 0) {
            this.annotationOffsets.put(Integer.valueOf(i5), Integer.valueOf(i6));
            return;
        }
        throw new IllegalArgumentException();
    }

    public void putAnnotationSetOffset(int i5, int i6) {
        if (i5 > 0 && i6 > 0) {
            this.annotationSetOffsets.put(Integer.valueOf(i5), Integer.valueOf(i6));
            return;
        }
        throw new IllegalArgumentException();
    }

    public void putAnnotationSetRefListOffset(int i5, int i6) {
        if (i5 > 0 && i6 > 0) {
            this.annotationSetRefListOffsets.put(Integer.valueOf(i5), Integer.valueOf(i6));
            return;
        }
        throw new IllegalArgumentException();
    }

    public void putEncodedArrayValueOffset(int i5, int i6) {
        if (i5 > 0 && i6 > 0) {
            this.encodedArrayValueOffset.put(Integer.valueOf(i5), Integer.valueOf(i6));
            return;
        }
        throw new IllegalArgumentException();
    }

    public void putTypeListOffset(int i5, int i6) {
        if (i5 > 0 && i6 > 0) {
            this.typeListOffsets.put(Integer.valueOf(i5), Integer.valueOf(i6));
            return;
        }
        throw new IllegalArgumentException();
    }
    ...
    public MethodHandle adjust(MethodHandle methodHandle) {
        ...
        if (methodHandle.getMethodHandleType().isField()) {
            adjustMethod = adjustField(methodHandle.getFieldOrMethodId());
        } else {
            adjustMethod = adjustMethod(methodHandle.getFieldOrMethodId());
        }
        return new MethodHandle(dex, methodHandleType, unused1, adjustMethod, methodHandle.getUnused2());
    }
