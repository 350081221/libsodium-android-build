...
public class AttributeFactory {
    ...
    public final Attribute parse(DirectClassFile directClassFile, int i5, int i6, ParseObserver parseObserver) {
        String str;
            ...
            if (i5 >= 0 && i5 < 4) {
                ...
                try {
                    ...
                    if (parseObserver != null) {
                        try {
                            parseObserver.parsed(bytes, i6, 2, "name: " + cstString2.toHuman());
                            parseObserver.parsed(bytes, i7, 4, "length: " + Hex.u4(i8));
                    ...
                    return parse0(directClassFile, i5, cstString2.getString(), i6 + 6, i8, parseObserver);
    ...
    public Attribute parse0(DirectClassFile directClassFile, int i5, String str, int i6, int i7, ParseObserver parseObserver) {
        ByteArray bytes = directClassFile.getBytes();
        RawAttribute rawAttribute = new RawAttribute(str, bytes, i6, i7, directClassFile.getConstantPool());
        if (parseObserver != null) {
            parseObserver.parsed(bytes, i6, i7, "attribute data");
        }
        return rawAttribute;
    }
}
