...
public final class ConcreteMethod implements Method {
    ...
    public final boolean isDefaultOrStaticInterfaceMethod() {
        if ((this.classFile.getAccessFlags() & 512) != 0 && !getNat().isClassInit()) {
            return true;
        }
        return false;
    }
    ...
    public SourcePosition makeSourcePosistion(int i5) {
        return new SourcePosition(getSourceFile(), i5, this.lineNumbers.pcToLine(i5));
    }
}
