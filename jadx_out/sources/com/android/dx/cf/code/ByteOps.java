...
public class ByteOps {
    ...
    static {
        ...
        while (i5 < 2498) {
            int i6 = 16;
            int digit = (Character.digit(OPCODE_DETAILS.charAt(i5), 16) << 4) | Character.digit(OPCODE_DETAILS.charAt(i5 + 1), 16);
            char charAt = OPCODE_DETAILS.charAt(i5 + 3);
            if (charAt != '-') {
                if (charAt != 'I') {
                    if (charAt != 'W') {
                        if (charAt != 'p') {
            ...
            int i7 = i5 + 5;
            if (OPCODE_DETAILS.charAt(i7 - 1) == ':') {
                while (true) {
                    char charAt2 = OPCODE_DETAILS.charAt(i7);
                    if (charAt2 != 'D') {
                        if (charAt2 != 'F') {
                            if (charAt2 != 'c') {
                                if (charAt2 != 'f') {
            ...
            int indexOf = OPCODE_DETAILS.indexOf(59, i7);
            OPCODE_INFO[digit] = i6;
            OPCODE_NAMES[digit] = OPCODE_DETAILS.substring(i7, indexOf);
            i5 = indexOf + 1;
        }
    }
    ...
    public static int opInfo(int i5) {
        return OPCODE_INFO[i5];
    }

    public static String opName(int i5) {
        String[] strArr = OPCODE_NAMES;
        String str = strArr[i5];
        if (str == null) {
            String str2 = "unused_" + Hex.u1(i5);
            strArr[i5] = str2;
            return str2;
        }
        return str;
