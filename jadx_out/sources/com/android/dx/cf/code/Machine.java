...
public interface Machine {
    ...
    void auxIntArg(int i5);

    void auxSwitchArg(SwitchList switchList);

    void auxTargetArg(int i5);
    ...
    void localArg(Frame frame, int i5);

    void localInfo(boolean z4);

    void localTarget(int i5, Type type, LocalItem localItem);

    void popArgs(Frame frame, int i5);
    ...
    void run(Frame frame, int i5, int i6);
}
