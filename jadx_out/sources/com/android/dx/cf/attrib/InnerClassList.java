...
public final class InnerClassList extends FixedSizeList {
    ...
    public static class Item {
        ...
        public Item(CstType cstType, CstType cstType2, CstString cstString, int i5) {
            if (cstType != null) {
    ...
    public void set(int i5, CstType cstType, CstType cstType2, CstString cstString, int i6) {
        set0(i5, new Item(cstType, cstType2, cstString, i6));
    }
}
