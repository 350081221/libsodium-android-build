...
public final class Opcodes {
    ...
    public static int extractOpcodeFromUnit(int i5) {
        int i6 = i5 & 255;
        return (i6 == 0 || i6 == 255) ? i5 : i6;
    }

    public static boolean isValidShape(int i5) {
        int i6;
        if (i5 < -1) {
            return false;
        }
        return i5 == -1 || (i6 = i5 & 255) == 0 || i6 == 255 || (i5 & MotionEventCompat.ACTION_POINTER_INDEX_MASK) == 0;
    }
}
