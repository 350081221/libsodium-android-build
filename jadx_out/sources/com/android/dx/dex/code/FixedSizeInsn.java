...
public abstract class FixedSizeInsn extends DalvInsn {
    ...
    @Override // com.android.dx.dex.code.DalvInsn
    public final String listingString0(boolean z4) {
        return getOpcode().getFormat().listingString(this, z4);
    }

    @Override // com.android.dx.dex.code.DalvInsn
    public final DalvInsn withRegisterOffset(int i5) {
        return withRegisters(getRegisters().withOffset(i5));
    }
