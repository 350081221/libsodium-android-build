...
public final class Form21c extends InsnFormat {
    ...
    public boolean isCompatible(DalvInsn dalvInsn) {
        ...
        if (!(constant instanceof CstType) && !(constant instanceof CstFieldRef) && !(constant instanceof CstString) && !(constant instanceof CstMethodHandle) && !(constant instanceof CstProtoRef)) {
            return false;
        }
        return true;
    }
