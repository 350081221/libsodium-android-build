...
public final class Form35c extends InsnFormat {
    ...
    public boolean isCompatible(DalvInsn dalvInsn) {
        ...
        if ((!(constant instanceof CstMethodRef) && !(constant instanceof CstType) && !(constant instanceof CstCallSiteRef)) || wordCount(cstInsn.getRegisters()) < 0) {
            return false;
        }
        return true;
    }
    ...
    public void writeTo(AnnotatedOutput annotatedOutput, DalvInsn dalvInsn) {
        ...
        InsnFormat.write(annotatedOutput, InsnFormat.opcodeUnit(dalvInsn, InsnFormat.makeByte(i9, size)), (short) index, InsnFormat.codeUnit(i5, i6, i7, i8));
    }
}
