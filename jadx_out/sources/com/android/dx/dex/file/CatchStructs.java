...
public final class CatchStructs {
    ...
    private static void annotateAndConsumeHandlers(CatchHandlerList catchHandlerList, int i5, int i6, String str, PrintWriter printWriter, AnnotatedOutput annotatedOutput) {
        String human = catchHandlerList.toHuman(str, Hex.u2(i5) + ": ");
        if (printWriter != null) {
    ...
    private void annotateEntries(String str, PrintWriter printWriter, AnnotatedOutput annotatedOutput) {
        ...
        for (int i8 = 0; i8 < size; i8++) {
            CatchTable.Entry entry = this.table.get(i8);
            ...
            if (z4) {
                annotatedOutput.annotate(i5, str3);
                annotatedOutput.annotate(i6, human);
            } else {
        ...
        for (Map.Entry<CatchHandlerList, Integer> entry2 : this.handlerOffsets.entrySet()) {
            ...
            if (catchHandlerList != null) {
                annotateAndConsumeHandlers(catchHandlerList, i7, intValue - i7, str2, printWriter, annotatedOutput);
            }
            catchHandlerList = key;
            i7 = intValue;
        }
        annotateAndConsumeHandlers(catchHandlerList, i7, this.encodedHandlers.length - i7, str2, printWriter, annotatedOutput);
    }
    ...
    public void encode(DexFile dexFile) {
        ...
        for (int i5 = 0; i5 < size; i5++) {
            this.handlerOffsets.put(this.table.get(i5).getHandlers(), null);
        }
        if (this.handlerOffsets.size() <= 65535) {
            ...
            for (Map.Entry<CatchHandlerList, Integer> entry : this.handlerOffsets.entrySet()) {
                ...
                for (int i6 = 0; i6 < size2; i6++) {
                    CatchHandlerList.Entry entry2 = key.get(i6);
    ...
    public void writeTo(DexFile dexFile, AnnotatedOutput annotatedOutput) {
        ...
        int size = this.table.size();
        for (int i5 = 0; i5 < size; i5++) {
            CatchTable.Entry entry = this.table.get(i5);
