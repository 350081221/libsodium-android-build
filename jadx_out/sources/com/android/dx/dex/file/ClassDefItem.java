...
public final class ClassDefItem extends IndexedItem {
    ...
    public ClassDefItem(CstType cstType, int i5, CstType cstType2, TypeList typeList, CstString cstString) {
    ...
    public void debugPrint(Writer writer, boolean z4) {
        ...
        printWriterFor.println(i.f138d);
    }
    ...
    public void writeTo(DexFile dexFile, AnnotatedOutput annotatedOutput) {
        ...
        if (this.sourceFile != null) {
            i5 = dexFile.getStringIds().indexOf(this.sourceFile);
        }
        if (this.classData.isEmpty()) {
            absoluteOffset2 = 0;
        } else {
        ...
        if (annotates) {
            ...
            if (absoluteOffsetOr0 != 0) {
                ...
                for (int i6 = 0; i6 < size; i6++) {
                    annotatedOutput.annotate(0, "    " + list.getType(i6).toHuman());
                }
            }
            StringBuilder sb3 = new StringBuilder();
            sb3.append("  source_file_idx:     ");
            sb3.append(Hex.u4(i5));
            sb3.append(" // ");
            CstString cstString = this.sourceFile;
            if (cstString != null) {
