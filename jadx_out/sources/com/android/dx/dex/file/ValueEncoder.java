...
public final class ValueEncoder {
    ...
    public void writeAnnotation(Annotation annotation, boolean z4) {
        boolean z5;
        if (z4 && this.out.annotates()) {
            z5 = true;
        } else {
            z5 = false;
        }
        ...
        for (NameValuePair nameValuePair : nameValuePairs) {
            ...
            if (z5) {
                this.out.annotate(0, "  elements[" + i5 + "]:");
                i5++;
    ...
    public void writeArray(CstArray cstArray, boolean z4) {
        boolean z5;
        if (z4 && this.out.annotates()) {
            z5 = true;
        } else {
        ...
        for (int i5 = 0; i5 < size; i5++) {
            Constant constant = list.get(i5);
            if (z5) {
                this.out.annotate("  [" + Integer.toHexString(i5) + "] " + constantToHuman(constant));
            }
    ...
    public static void addContents(DexFile dexFile, Constant constant) {
        ...
        if (constant instanceof CstArray) {
            ...
            int size = list.size();
            for (int i5 = 0; i5 < size; i5++) {
                addContents(dexFile, list.get(i5));
            }
            return;
        }
