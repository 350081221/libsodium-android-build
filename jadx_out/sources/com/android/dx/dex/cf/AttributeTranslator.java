...
public class AttributeTranslator {
    ...
    public static Annotations getAnnotations(AttributeList attributeList) {
        ...
        if (sourceDebugExtension != null) {
            return Annotations.combine(annotations0, sourceDebugExtension);
        }
        return annotations0;
    }
    ...
    public static Annotations getClassAnnotations(DirectClassFile directClassFile, CfOptions cfOptions) {
        ...
        try {
            Annotations translateInnerClasses = translateInnerClasses(thisClass, attributes, z4);
            if (translateInnerClasses != null) {
                annotations = Annotations.combine(annotations, translateInnerClasses);
            }
        } catch (Warning e5) {
            cfOptions.warn.println("warning: " + e5.getMessage());
        }
        if (translateEnclosingMethod != null) {
    ...
    private static Annotations translateInnerClasses(CstType cstType, AttributeList attributeList, boolean z4) {
        ...
        for (int i5 = 0; i5 < size; i5++) {
            InnerClassList.Item item2 = innerClasses.get(i5);
        ...
        if (size2 != 0) {
            ...
            for (int i6 = 0; i6 < size2; i6++) {
                stdTypeList.set(i6, (Type) arrayList.get(i6));
            }
