...
public final class Rops {
    ...
    */
    ...
    public static Rop opFilledNewArray(TypeBearer typeBearer, int i5) {
        ...
        if (i5 >= 0) {
            ...
            for (int i6 = 0; i6 < i5; i6++) {
                stdTypeList.set(i6, componentType);
            }
    ...
    public static Rop ropFor(int i5, TypeBearer typeBearer, TypeList typeList, Constant constant) {
        Type componentType;
        Type componentType2;
        switch (i5) {
            case 1:
            ...
            case 57:
            default:
                throw new RuntimeException("unknown opcode " + RegOps.opName(i5));
            case 43:
                return CHECK_CAST;
            case 44:
                return INSTANCE_OF;
