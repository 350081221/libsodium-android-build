...
public final class StdTypeList extends FixedSizeList implements TypeList {
    ...
    public static int compareContents(TypeList typeList, TypeList typeList2) {
        ...
        for (int i5 = 0; i5 < min; i5++) {
            int compareTo = typeList.getType(i5).compareTo(typeList2.getType(i5));
            if (compareTo != 0) {
                return compareTo;
            }
        }
    ...
    public static boolean equalContents(TypeList typeList, TypeList typeList2) {
        ...
        for (int i5 = 0; i5 < size; i5++) {
            if (!typeList.getType(i5).equals(typeList2.getType(i5))) {
                return false;
            }
        }
        return true;
    ...
    public static int hashContents(TypeList typeList) {
        ...
        for (int i6 = 0; i6 < size; i6++) {
            i5 = (i5 * 31) + typeList.getType(i6).hashCode();
        }
        return i5;
    }
    ...
    public int getWordCount() {
        ...
        int i5 = 0;
        for (int i6 = 0; i6 < size; i6++) {
            i5 += get(i6).getCategory();
        }
        return i5;
    }

    public void set(int i5, Type type) {
        set0(i5, type);
    }
    ...
    public StdTypeList withFirst(Type type) {
        ...
        while (i5 < size) {
            int i6 = i5 + 1;
            stdTypeList.set0(i6, getOrNull0(i5));
            i5 = i6;
        }
        return stdTypeList;
    }
