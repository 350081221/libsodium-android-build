...
public final class CstInteger extends CstLiteral32 {
    ...
    private CstInteger(int i5) {
        super(i5);
    }

    public static CstInteger make(int i5) {
        CstInteger[] cstIntegerArr = cache;
        int length = (Integer.MAX_VALUE & i5) % cstIntegerArr.length;
        CstInteger cstInteger = cstIntegerArr[length];
        if (cstInteger != null && cstInteger.getValue() == i5) {
            return cstInteger;
        }
        CstInteger cstInteger2 = new CstInteger(i5);
