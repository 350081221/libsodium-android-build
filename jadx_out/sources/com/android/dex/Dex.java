...
public final class Dex {
    ...
    private final class FieldIdTable extends AbstractList<FieldId> implements RandomAccess {
        ...
        public FieldId get(int i5) {
            Dex.checkBounds(i5, Dex.this.tableOfContents.fieldIds.size);
            Dex dex = Dex.this;
            return dex.open(dex.tableOfContents.fieldIds.off + (i5 * 8)).readFieldId();
        }
    }
    ...
    private final class MethodIdTable extends AbstractList<MethodId> implements RandomAccess {
        ...
        @Override // java.util.AbstractList, java.util.List
        public MethodId get(int i5) {
            Dex.checkBounds(i5, Dex.this.tableOfContents.methodIds.size);
            Dex dex = Dex.this;
            return dex.open(dex.tableOfContents.methodIds.off + (i5 * 8)).readMethodId();
        }
    }
    ...
    private final class ProtoIdTable extends AbstractList<ProtoId> implements RandomAccess {
        ...
        @Override // java.util.AbstractList, java.util.List
        public ProtoId get(int i5) {
            Dex.checkBounds(i5, Dex.this.tableOfContents.protoIds.size);
            Dex dex = Dex.this;
            return dex.open(dex.tableOfContents.protoIds.off + (i5 * 12)).readProtoId();
        }
    }
    ...
    public final class Section implements ByteInput, ByteOutput {
        ...
        private int findCatchHandlerIndex(Code.CatchHandler[] catchHandlerArr, int i5) {
            for (int i6 = 0; i6 < catchHandlerArr.length; i6++) {
                if (catchHandlerArr[i6].getOffset() == i5) {
                    return i6;
                }
            }
        ...
        private byte[] getBytesFrom(int i5) {
            byte[] bArr = new byte[this.data.position() - i5];
            this.data.position(i5);
            this.data.get(bArr);
            return bArr;
        }

        private Code.CatchHandler readCatchHandler(int i5) {
            int i6;
            ...
            return new Code.CatchHandler(iArr, iArr2, i6, i5);
        }
        ...
        private Code.CatchHandler[] readCatchHandlers() {
            ...
            for (int i5 = 0; i5 < readUleb128; i5++) {
                catchHandlerArr[i5] = readCatchHandler(this.data.position() - position);
            }
        ...
        private ClassData.Field[] readFields(int i5) {
            ClassData.Field[] fieldArr = new ClassData.Field[i5];
            int i6 = 0;
            for (int i7 = 0; i7 < i5; i7++) {
                i6 += readUleb128();
                fieldArr[i7] = new ClassData.Field(i6, readUleb128());
            }
            return fieldArr;
        }

        private ClassData.Method[] readMethods(int i5) {
            ClassData.Method[] methodArr = new ClassData.Method[i5];
            int i6 = 0;
            for (int i7 = 0; i7 < i5; i7++) {
                i6 += readUleb128();
                methodArr[i7] = new ClassData.Method(i6, readUleb128(), readUleb128());
            }
            return methodArr;
        }

        private Code.Try[] readTries(int i5, Code.CatchHandler[] catchHandlerArr) {
            Code.Try[] tryArr = new Code.Try[i5];
            for (int i6 = 0; i6 < i5; i6++) {
                tryArr[i6] = new Code.Try(readInt(), readUnsignedShort(), findCatchHandlerIndex(catchHandlerArr, readUnsignedShort()));
            }
            return tryArr;
        }
        ...
        public byte[] readByteArray(int i5) {
        ...
        public short[] readShortArray(int i5) {
            if (i5 == 0) {
        ...
        public void writeShort(short s5) {
            this.data.putShort(s5);
        }

        public void writeSleb128(int i5) {
            try {
        ...
        public void writeUleb128(int i5) {
            try {
        ...
        public void writeUleb128p1(int i5) {
            writeUleb128(i5 + 1);
        }
        ...
        public void writeUnsignedShort(int i5) {
            ...
            throw new IllegalArgumentException("Expected an unsigned short: " + i5);
        }
    ...
    public final class StringTable extends AbstractList<String> implements RandomAccess {
        ...
        public String get(int i5) {
            Dex.checkBounds(i5, Dex.this.tableOfContents.stringIds.size);
            Dex dex = Dex.this;
            return dex.open(dex.tableOfContents.stringIds.off + (i5 * 4)).readString();
        }
    }
    ...
    private final class TypeIndexToDescriptorIndexTable extends AbstractList<Integer> implements RandomAccess {
        ...
        public Integer get(int i5) {
            return Integer.valueOf(Dex.this.descriptorIndexFromTypeIndex(i5));
        }
    }
    ...
    private final class TypeIndexToDescriptorTable extends AbstractList<String> implements RandomAccess {
        ...
        @Override // java.util.AbstractList, java.util.List
        public String get(int i5) {
            return Dex.this.strings.get(Dex.this.descriptorIndexFromTypeIndex(i5));
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static void checkBounds(int i5, int i6) {
        if (i5 < 0 || i5 >= i6) {
    ...
    public Section appendSection(int i5, String str) {
        if ((i5 & 3) == 0) {
            int i6 = this.nextSectionStart + i5;
    ...
    public int descriptorIndexFromTypeIndex(int i5) {
        checkBounds(i5, this.tableOfContents.typeIds.size);
        return this.data.getInt(this.tableOfContents.typeIds.off + (i5 * 4));
    }
    ...
    public Section open(int i5) {
        if (i5 >= 0 && i5 < this.data.capacity()) {
            ByteBuffer duplicate = this.data.duplicate();
            duplicate.order(ByteOrder.LITTLE_ENDIAN);
        ...
        throw new IllegalArgumentException("position=" + i5 + " length=" + this.data.capacity());
    }
    ...
    public TypeList readTypeList(int i5) {
        if (i5 == 0) {
            return TypeList.EMPTY;
        }
        return open(i5).readTypeList();
    }
    ...
    public Dex(int i5) throws IOException {
