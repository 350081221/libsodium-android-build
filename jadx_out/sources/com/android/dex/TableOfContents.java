...
public final class TableOfContents {
    ...
    public TableOfContents() {
        ...
        Section section15 = new Section(o.a.f12708r);
        this.codes = section15;
        Section section16 = new Section(8194);
        this.stringDatas = section16;
        Section section17 = new Section(o.a.f12710t);
        this.debugInfos = section17;
        Section section18 = new Section(o.a.f12711u);
    ...
    private Section getSection(short s5) {
        for (Section section : this.sections) {
            if (section.type == s5) {
                return section;
            }
        }
        throw new IllegalArgumentException("No such map item: " + ((int) s5));
    }
    ...
    private void readMap(Dex.Section section) throws IOException {
        ...
        while (i6 < readInt) {
            ...
            int i7 = section3.size;
            if ((i7 != 0 && i7 != readInt2) || ((i5 = section3.off) != -1 && i5 != readInt3)) {
    ...
    public void writeHeader(Dex.Section section, int i5) throws IOException {
        section.write(DexFormat.apiToMagic(i5).getBytes("UTF-8"));
