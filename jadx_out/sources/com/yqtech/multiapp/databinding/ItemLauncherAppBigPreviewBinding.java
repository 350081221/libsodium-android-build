...
public final class ItemLauncherAppBigPreviewBinding implements ViewBinding {
    ...
    @NonNull
    public static ItemLauncherAppBigPreviewBinding bind(@NonNull View view) {
                            ...
                            if (shapeableImageView != null) {
                                ...
                                if (linearLayout != null) {
                                    ...
                                    if (textView3 != null) {
                                        ...
                                        if (textView4 != null) {
                                            return new ItemLauncherAppBigPreviewBinding((FrameLayout) view, imageView, textView, imageView2, imageView3, textView2, shapeableImageView, linearLayout, textView3, textView4);
                                        }
                                    }
                                }
                            }
    ...
    @NonNull
    public static ItemLauncherAppBigPreviewBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static ItemLauncherAppBigPreviewBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z4) {
        View inflate = layoutInflater.inflate(R.layout.item_launcher_app_big_preview, viewGroup, false);
        if (z4) {
