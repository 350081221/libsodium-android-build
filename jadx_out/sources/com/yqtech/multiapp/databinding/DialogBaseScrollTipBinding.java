...
public final class DialogBaseScrollTipBinding implements ViewBinding {
    ...
    private DialogBaseScrollTipBinding(@NonNull ConstraintLayout constraintLayout, @NonNull MaterialButton materialButton, @NonNull MaterialButton materialButton2, @NonNull ImageView imageView, @NonNull ImageView imageView2, @NonNull LinearLayout linearLayout, @NonNull ScrollView scrollView, @NonNull TextView textView, @NonNull TextView textView2, @NonNull TextView textView3) {
    ...
    @NonNull
    public static DialogBaseScrollTipBinding bind(@NonNull View view) {
                            ...
                            if (scrollView != null) {
                                ...
                                if (textView != null) {
                                    ...
                                    if (textView2 != null) {
                                        ...
                                        if (textView3 != null) {
                                            return new DialogBaseScrollTipBinding((ConstraintLayout) view, materialButton, materialButton2, imageView, imageView2, linearLayout, scrollView, textView, textView2, textView3);
                                        }
                                    }
                                }
                            }
    ...
    @NonNull
    public static DialogBaseScrollTipBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static DialogBaseScrollTipBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z4) {
        View inflate = layoutInflater.inflate(R.layout.dialog_base_scroll_tip, viewGroup, false);
        if (z4) {
