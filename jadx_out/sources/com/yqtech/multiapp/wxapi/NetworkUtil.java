...
public class NetworkUtil {
    ...
    static class HttpsThread extends Thread {
        ...
        public HttpsThread(Handler handler, String str, int i5) {
        ...
        public void run() {
            ...
            try {
                ...
                Log.e(NetworkUtil.TAG, e6.getMessage());
            }
        }
    }

    public static void getImage(Handler handler, String str, int i5) {
        new HttpsThread(handler, str, i5).start();
    }

    public static void sendWxAPI(Handler handler, String str, int i5) {
        new HttpsThread(handler, str, i5).start();
    }
}
