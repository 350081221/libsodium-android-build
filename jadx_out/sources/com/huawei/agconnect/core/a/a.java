...
public class a extends AGCInitFinishManager {
    ...
    private static final List<AGCInitFinishManager.AGCInitFinishCallback> f7799a = new CopyOnWriteArrayList();

    public static void a() {
        Iterator<AGCInitFinishManager.AGCInitFinishCallback> it = f7799a.iterator();
        while (it.hasNext()) {
            it.next().onFinish();
        }
    }
    ...
    public void addAGCInitFinishCallback(AGCInitFinishManager.AGCInitFinishCallback aGCInitFinishCallback) {
        if (aGCInitFinishCallback != null) {
            f7799a.add(aGCInitFinishCallback);
        }
    }
}
