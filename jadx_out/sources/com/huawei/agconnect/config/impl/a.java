...
public class a extends AGConnectApp {
    ...
    private static final Map<String, AGConnectApp> f7742a = new HashMap();
    ...
    private AGConnectServicesConfig f7745d;

    private a(Context context, String str) {
        this.f7745d = AGConnectServicesConfig.fromContext(context, str);
    }
    ...
    public static AGConnectApp a(Context context, String str) {
        ...
        synchronized (f7743b) {
            Map<String, AGConnectApp> map = f7742a;
    ...
    public void setApiKey(String str) {
        this.f7745d.setParam("/client/api_key", str);
    }

    @Override // com.huawei.agconnect.AGConnectApp
    public void setAppId(String str) {
        this.f7745d.setParam("/client/app_id", str);
    }

    @Override // com.huawei.agconnect.AGConnectApp
    public void setClientId(String str) {
        this.f7745d.setParam("/client/client_id", str);
    }

    @Override // com.huawei.agconnect.AGConnectApp
    public void setClientSecret(String str) {
        this.f7745d.setParam("/client/client_secret", str);
    }

    @Override // com.huawei.agconnect.AGConnectApp
    public void setCpId(String str) {
        this.f7745d.setParam("/client/cp_id", str);
    }
    ...
    public void setParam(String str, String str2) {
        ...
        this.f7745d.setParam(str, str2);
    }

    @Override // com.huawei.agconnect.AGConnectApp
    public void setProductId(String str) {
        this.f7745d.setParam("/client/product_id", str);
    }
}
