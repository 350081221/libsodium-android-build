...
public class a extends HttpsURLConnection {
    ...
    public class abc implements l {
        ...
        public void bcd(k kVar) {
            ...
            try {
                this.abc.cde(a.this.abc.getResponseCode());
            } catch (Throwable th) {
                com.huawei.agconnect.apms.abc.bcd(th, com.huawei.agconnect.apms.abc.abc("failed to get status code: "), a.def);
            }
            long contentLength = a.this.abc.getContentLength();
            long j5 = kVar.abc;
    ...
    public class bcd implements l {
        ...
        public void bcd(k kVar) {
            ...
            String requestProperty = a.this.abc.getRequestProperty("Content-length");
            long j5 = kVar.abc;
            if (requestProperty != null) {
                try {
                    j5 = Long.parseLong(requestProperty);
                } catch (Throwable th2) {
                    com.huawei.agconnect.apms.abc.bcd(th2, com.huawei.agconnect.apms.abc.abc("failed to get content length: "), a.def);
                }
            }
            this.abc.bcd(j5);
            a.this.abc(this.abc);
    ...
    public a(HttpsURLConnection httpsURLConnection) {
        ...
        this.cde = null;
        this.abc = httpsURLConnection;
        bcd();
        if (httpsURLConnection.getURL() != null) {
            edc.abc(httpsURLConnection.getURL().getHost(), this.bcd);
        }
        String abc2 = q1.abc();
        if (TextUtils.isEmpty(httpsURLConnection.getRequestProperty(HeaderType.X_TRACE_ID))) {
            httpsURLConnection.setRequestProperty(HeaderType.X_TRACE_ID, abc2);
        }
        if (TextUtils.isEmpty(httpsURLConnection.getRequestProperty(HeaderType.X_MICROSERVICE_NAME))) {
            httpsURLConnection.setRequestProperty(HeaderType.X_MICROSERVICE_NAME, "APMS");
        }
        this.bcd.jih = abc2;
    }
    ...
    public InputStream getErrorStream() {
        ...
        try {
            ...
            if (iVar == null || iVar.available() == 0) {
                if (this.abc.getErrorStream() == null) {
                    def.debug("error stream is null.");
            ...
            StringBuilder abc2 = com.huawei.agconnect.apms.abc.abc("failed to get error stream: ");
    ...
    public HostnameVerifier getHostnameVerifier() {
        return this.abc.getHostnameVerifier();
    }
    ...
    public Certificate[] getLocalCertificates() {
        return this.abc.getLocalCertificates();
    }

    @Override // javax.net.ssl.HttpsURLConnection
    public Principal getLocalPrincipal() {
        return this.abc.getLocalPrincipal();
    }
    ...
    public Principal getPeerPrincipal() throws SSLPeerUnverifiedException {
        try {
            return this.abc.getPeerPrincipal();
    ...
    public SSLSocketFactory getSSLSocketFactory() {
        return this.abc.getSSLSocketFactory();
    }

    @Override // javax.net.ssl.HttpsURLConnection
    public Certificate[] getServerCertificates() throws SSLPeerUnverifiedException {
        try {
            return this.abc.getServerCertificates();
        } catch (SSLPeerUnverifiedException e5) {
            abc(e5);
            throw e5;
        }
    ...
    public void setHostnameVerifier(HostnameVerifier hostnameVerifier) {
        this.abc.setHostnameVerifier(hostnameVerifier);
    }
    ...
    public void setSSLSocketFactory(SSLSocketFactory sSLSocketFactory) {
        this.abc.setSSLSocketFactory(sSLSocketFactory);
    }
