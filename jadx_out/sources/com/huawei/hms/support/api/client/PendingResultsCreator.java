...
public final class PendingResultsCreator {
    ...
    public static class DiscardedPendingResult<R extends Result> extends EmptyPendingResult {
        ...
        public DiscardedPendingResult(R r5) {
            setResult(r5);
        }
    }
    ...
    public static class InstantPendingResult<R extends Result> extends EmptyPendingResult {
        public InstantPendingResult(R r5) {
            setResult(r5);
        }
    ...
    public static <R extends Result> PendingResult<R> discardedPendingResult(R r5) {
        return new DiscardedPendingResult(r5);
    }

    public static <R extends Result> OptionalPendingResult<R> instantPendingResult(R r5) {
        return new OptionalPendingResultImpl(new InstantPendingResult(r5));
    }
}
