...
public final class Status extends Result implements Parcelable {
    ...
    public void startResolutionForResult(Activity activity, int i5) throws IntentSender.SendIntentException {
        if (hasResolution()) {
            PendingIntent pendingIntent = this.pendingIntent;
            if (pendingIntent != null) {
                activity.startIntentSenderForResult(pendingIntent.getIntentSender(), i5, null, 0, 0, 0);
            } else {
                activity.startActivityForResult(this.intent, i5);
            }
        }
    }
    ...
    public Status(int i5, String str, Intent intent) {
        this.statusCode = i5;
        this.statusMessage = str;
        this.intent = intent;
    }
