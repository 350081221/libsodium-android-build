...
public class HiAnalyticsUtil {
    ...
    private static HiAnalyticsUtil f8786b;

    /* renamed from: c, reason: collision with root package name */
    private static HiAnalyticsUtils f8787c;
    ...
    public static HiAnalyticsUtil getInstance() {
        ...
        synchronized (f8785a) {
            if (f8786b == null) {
                f8786b = new HiAnalyticsUtil();
                f8787c = HiAnalyticsUtils.getInstance();
            }
            hiAnalyticsUtil = f8786b;
        }
    ...
    public void onBuoyEvent(Context context, String str, String str2) {
        f8787c.onBuoyEvent(context, str, str2);
    }

    public void onEvent(Context context, String str, Map<String, String> map) {
        f8787c.onEvent(context, str, map);
    }

    public void onEvent2(Context context, String str, String str2) {
        f8787c.onEvent2(context, str, str2);
    }

    public void onNewEvent(Context context, String str, Map map) {
        f8787c.onNewEvent(context, str, map);
    }
    ...
    public boolean hasError(Context context) {
        return f8787c.hasError(context);
    }
