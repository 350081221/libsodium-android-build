...
public final class ActivityMgr implements Application.ActivityLifecycleCallbacks {
    ...
    public WeakReference<Activity> f8784a;
    ...
    public Activity getCurrentActivity() {
        if (this.f8784a == null) {
            HMSLog.i("ActivityMgr", "mCurrentActivity is " + this.f8784a);
            return null;
        }
        HMSLog.i("ActivityMgr", "mCurrentActivity.get() is " + this.f8784a.get());
    ...
    public void onActivityCreated(Activity activity, Bundle bundle) {
        ...
        this.f8784a = new WeakReference<>(activity);
    }
