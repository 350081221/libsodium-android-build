...
import com.huawei.secure.android.common.ssl.util.l;
...
public class a {
        ...
        for (X509Certificate x509Certificate2 : list) {
            if (x509Certificate2 != null) {
                try {
                    ...
                    HMSLog.e("X509CertUtil", "verify failed " + e5.getMessage());
                }
            }
            return false;
        }
    ...
    public static List<String> c(String str) {
        try {
            ...
            HMSLog.e("X509CertUtil", "Failed to getCertChain: " + e5.getMessage());
            return Collections.emptyList();
        }
    }
    ...
    public static X509Certificate a(String str) {
        ...
        try {
            ...
            HMSLog.e("X509CertUtil", "getCert failed : " + e5.getMessage());
            return null;
        }
    }
    ...
    public static X509Certificate a(byte[] bArr) {
        try {
            ...
            HMSLog.e("X509CertUtil", "Failed to get cert: " + e5.getMessage());
            return null;
        }
    }
    ...
    public static boolean a(X509Certificate x509Certificate, String str, String str2) {
        try {
            ...
            HMSLog.e("X509CertUtil", " plainText exception: " + e5.getMessage());
            return false;
        }
    }
    ...
    public static boolean a(X509Certificate x509Certificate, byte[] bArr, byte[] bArr2) {
        try {
            ...
            HMSLog.e("X509CertUtil", "failed checkSignature : " + e5.getMessage());
            return false;
        }
    }
