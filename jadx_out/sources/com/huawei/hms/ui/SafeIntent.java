...
public class SafeIntent extends Intent {
    ...
    public boolean getBooleanExtra(String str, boolean z4) {
        try {
            return super.getBooleanExtra(str, z4);
        } catch (Exception unused) {
            return z4;
        }
    }
    ...
    @Override // android.content.Intent
    public byte getByteExtra(String str, byte b5) {
        try {
            return super.getByteExtra(str, b5);
        } catch (Exception unused) {
            return b5;
        }
    }
    ...
    @Override // android.content.Intent
    public char getCharExtra(String str, char c5) {
        try {
            return super.getCharExtra(str, c5);
        } catch (Exception unused) {
            return c5;
        }
    }
    ...
    @Override // android.content.Intent
    public double getDoubleExtra(String str, double d5) {
        try {
            return super.getDoubleExtra(str, d5);
        } catch (Exception unused) {
            return d5;
        }
    }
    ...
    @Override // android.content.Intent
    public float getFloatExtra(String str, float f5) {
        try {
            return super.getFloatExtra(str, f5);
        } catch (Exception unused) {
            return f5;
        }
    }
    ...
    @Override // android.content.Intent
    public int getIntExtra(String str, int i5) {
        try {
            return super.getIntExtra(str, i5);
        } catch (Exception unused) {
            return i5;
        }
    }
    ...
    @Override // android.content.Intent
    public long getLongExtra(String str, long j5) {
        try {
            return super.getLongExtra(str, j5);
        } catch (Exception unused) {
            return j5;
        }
    }
    ...
    @Override // android.content.Intent
    public short getShortExtra(String str, short s5) {
        try {
            return super.getShortExtra(str, s5);
        } catch (Exception unused) {
            return s5;
        }
    }
