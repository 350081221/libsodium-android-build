...
public class ReflectionUtils {
    ...
    public static Field getField(Object obj, String str) {
        if (obj != null && !TextUtils.isEmpty(str)) {
            try {
                ...
                Logger.e(TAG, "Exception in getField :: IllegalArgumentException:", e5);
            } catch (NoSuchFieldException e6) {
                Logger.e(TAG, "Exception in getField :: NoSuchFieldException:", e6);
            } catch (SecurityException e7) {
                Logger.e(TAG, "not security int method getField,SecurityException:", e7);
            }
        }
        return null;
    }
    ...
    public static Object getFieldObj(Object obj, String str) {
        ...
        try {
            ...
            Logger.e(TAG, "Exception in getFieldObj :: IllegalAccessException:", e5);
            return null;
        } catch (IllegalArgumentException e6) {
            Logger.e(TAG, "Exception in getFieldObj :: IllegalArgumentException:", e6);
            return null;
        } catch (NoSuchFieldException e7) {
            Logger.e(TAG, "Exception in getFieldObj :: NoSuchFieldException:", e7);
            return null;
        } catch (SecurityException e8) {
            Logger.e(TAG, "not security int method getFieldObj,SecurityException:", e8);
            return null;
        }
    }
    ...
    public static Method getMethod(Class<?> cls, String str, Class<?>... clsArr) {
        if (cls != null && str != null) {
            try {
                ...
                Logger.e(TAG, "NoSuchMethodException:", e5);
                return null;
            } catch (SecurityException e6) {
                Logger.e(TAG, "SecurityException:", e6);
                return null;
            }
        }
    ...
    public static Object getStaticFieldObj(String str, String str2) {
        ...
        try {
            ...
            Logger.e(TAG, "not security int method getStaticFieldObj,SecurityException:", e8);
            return null;
        }
    }
    ...
    private static Object invoke(Object obj, Method method, Object... objArr) throws UnsupportedOperationException {
        ...
        try {
            ...
            Logger.e(TAG, "RuntimeException in invoke:", e5);
            return null;
        } catch (Exception e6) {
            Logger.e(TAG, "Exception in invoke:", e6);
            return null;
        }
    }
    ...
    public static Object invokeStaticMethod(String str, String str2, Object... objArr) {
        ...
        if (objArr != null) {
            ...
            for (int i5 = 0; i5 < length; i5++) {
                setClassType(clsArr, objArr[i5], i5);
            }
        } else {
            clsArr = null;
        }
    ...
    private static void setClassType(Class<?>[] clsArr, Object obj, int i5) {
