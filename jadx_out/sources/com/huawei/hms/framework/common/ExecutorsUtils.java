...
public class ExecutorsUtils {
    ...
    public static ExecutorService newFixedThreadPool(int i5, String str) {
        return new ThreadPoolExcutorEnhance(i5, i5, 0L, TimeUnit.MILLISECONDS, new LinkedBlockingQueue(), createThreadFactory(str));
    }

    public static ScheduledExecutorService newScheduledThreadPool(int i5, String str) {
        return new ScheduledThreadPoolExecutorEnhance(i5, createThreadFactory(str));
    }
