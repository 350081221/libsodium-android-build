...
public class NetworkUtil {
    ...
    private static String[] getDnsServerIpsFromConnectionManager(Context context) {
        ...
        if (context != null && (connectivityManager = (ConnectivityManager) ContextCompat.getSystemService(context, "connectivity")) != null) {
            try {
                ...
                Logger.i(TAG, "getActiveNetworkInfo failed, exception:" + e5.getClass().getSimpleName());
            } catch (RuntimeException e6) {
                Logger.i(TAG, "getActiveNetworkInfo failed, exception:" + e6.getClass().getSimpleName());
            }
        }
    ...
    public static String getHost(String str) {
        ...
        try {
            ...
            Logger.w(TAG, e5.getClass().getSimpleName());
            return "";
        }
    }
    ...
    */
    private static int getHwNetworkType(android.content.Context r3) {
        ...
        La:
            ...
            r2 = 21
            if (r0 < r2) goto L3f
            android.telephony.ServiceState r3 = com.huawei.hms.framework.common.a.a(r3)     // Catch: java.lang.NoClassDefFoundError -> L28 java.lang.NoSuchMethodError -> L30 java.lang.SecurityException -> L38
            if (r3 == 0) goto L3f
    ...
    public static NetworkInfo getNetworkInfo(Context context) {
        ...
        try {
            ...
            Logger.i(TAG, "getActiveNetworkInfo failed, exception:" + e5.getClass().getSimpleName() + e5.getMessage());
            return null;
        }
    }
        ...
        if (context != null) {
            ...
            if (systemService instanceof ConnectivityManager) {
                try {
                    ...
                    Logger.i(TAG, "getNetworkStatus exception" + e5.getClass().getSimpleName() + e5.getMessage());
                }
            } else {
    ...
    private static SignalStrength getSignalStrength(Context context) {
        ...
        if (context != null && Build.VERSION.SDK_INT >= 28) {
            Object systemService = ContextCompat.getSystemService(context, HintConstants.AUTOFILL_HINT_PHONE);
            if (systemService instanceof TelephonyManager) {
                signalStrength = ((TelephonyManager) systemService).createForSubscriptionId(SubscriptionManager.getDefaultDataSubscriptionId()).getSignalStrength();
    ...
    public static String getWifiGatewayIp(Context context) {
        ...
        Object systemService = ContextCompat.getSystemService(context.getApplicationContext(), com.efs.sdk.base.core.util.NetworkUtil.NETWORK_TYPE_WIFI);
        ...
        try {
            ...
            Logger.i(TAG, "getWifiGatewayIp error!" + e5.getClass().getSimpleName() + e5.getMessage());
            return " ";
        }
    }
    ...
    public static int getWifiRssi(Context context) {
        ...
        try {
            ...
            Logger.i(TAG, "getWifiRssiLevel did not has permission!" + e5.getClass().getSimpleName() + e5.getMessage());
            return INVALID_RSSI;
        }
    }
    ...
    private static int groupNetworkType(int i5) {
        if (i5 == -1) {
            return -1;
        }
        if (i5 != 1) {
            return (i5 == 2 || i5 == 3 || i5 == 4 || i5 == 5) ? 6 : 0;
        }
        return 1;
    }
    ...
    public static int getNetworkType(NetworkInfo networkInfo, Context context) {
        ...
        if (i5 != 0 || Build.VERSION.SDK_INT < 25) {
            return i5;
        }
        if (hwNetworkType != 16) {
