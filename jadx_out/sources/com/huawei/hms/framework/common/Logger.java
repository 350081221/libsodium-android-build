...
public class Logger {
    ...
    public static class ThrowableWrapper extends Throwable {
        ...
        private ThrowableWrapper(Throwable th) {
            ...
            int i5 = ((th instanceof IOException) || (th instanceof JSONException)) ? 8 : 20;
            if (stackTrace.length > i5) {
                setStackTrace((StackTraceElement[]) Arrays.copyOf(stackTrace, i5));
            } else {
    ...
    private static String complexMsg(String str, int i5) {
        if (!TextUtils.isEmpty(str)) {
            return getCallMethodInfo(i5) + "|" + str;
        }
        return getCallMethodInfo(i5);
    }
    ...
    private static void extLogPrintln(int i5, String str, String str2) {
        if (i5 != 2) {
            if (i5 != 3) {
                if (i5 != 4) {
                    if (i5 != 5) {
    ...
    private static String getCallMethodInfo(int i5) {
    ...
    private static boolean isAPPLoggable(int i5) {
        return extLogger != null && i5 >= 3;
    }

    private static boolean isKitLoggable(int i5) {
        return kitPrint && isLoggable(i5);
    }

    public static boolean isLoggable(int i5) {
        return Log.isLoggable(TAG_NETWORKKIT_PRE, i5);
    }

    private static int logPrintln(int i5, String str, String str2) {
        if (isAPPLoggable(i5)) {
            extLogPrintln(i5, complexAppTag(str), complexMsg(str2, 7));
        }
        if (isKitLoggable(i5)) {
            return Log.println(i5, complexTag(str), complexMsg(str2, 7));
        }
        return 1;
    }

    public static void println(int i5, String str, Object obj) {
        if (i5 < 3) {
            return;
        }
        logPrintln(i5, str, obj == null ? "null" : obj.toString());
    }

    public static void setExtLogger(ExtLogger extLogger2, boolean z4) {
        extLogger = extLogger2;
        kitPrint = z4;
        i(TAG, "logger = " + extLogger2 + z4);
    }
    ...
    public static void println(int i5, String str, String str2, Object... objArr) {
        if (i5 < 3) {
            return;
        }
        if (str2 == null) {
        ...
        try {
            logPrintln(i5, str, StringUtils.format(str2, objArr));
        } catch (IllegalFormatException e5) {
            w(TAG, "log format error" + str2, e5);
        }
    }
