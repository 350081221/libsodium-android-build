...
public class AssetsUtil {
    ...
    public static String[] list(final Context context, final String str) {
        ...
        try {
            ...
            Logger.w(TAG, "get local config files from sp task interrupted", e5);
            return new String[0];
        } catch (ExecutionException e6) {
            Logger.w(TAG, "get local config files from sp task failed", e6);
            return new String[0];
        } finally {
    ...
    public static InputStream open(Context context, String str) throws IOException {
        ...
        try {
            ...
            Logger.e(TAG, "AssetManager has been destroyed", e5);
            return null;
        }
    }
}
