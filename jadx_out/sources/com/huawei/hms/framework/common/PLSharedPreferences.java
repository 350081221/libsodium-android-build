...
public class PLSharedPreferences {
    ...
    public Map<String, String> getHashMap(String str) {
        ...
        try {
            ...
            Logger.w(TAG, "getHashMap parse Json to map error: %s", StringUtils.anonymizeMessage(e5.getMessage()));
        }
        return hashMap;
    }
        ...
        if (this.sp != null && map != null) {
            ...
            for (Map.Entry<String, String> entry : map.entrySet()) {
                try {
                    ...
                    Logger.w(TAG, "putHashMap one object error: %s", StringUtils.anonymizeMessage(e5.getMessage()));
                }
            }
