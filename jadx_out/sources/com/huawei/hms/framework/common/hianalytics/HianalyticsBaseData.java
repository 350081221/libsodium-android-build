...
public abstract class HianalyticsBaseData {
    ...
    public HianalyticsBaseData putIfNotDefault(String str, long j5, long j6) {
    ...
    public String toString() {
        ...
        try {
            ...
            Logger.w(TAG, "catch JSONException", e5);
        }
        return jSONObject.toString();
    }

    public HianalyticsBaseData put(String str, long j5) {
        if (str == null) {
            Logger.v(TAG, "key = null : value = " + j5);
        } else {
            this.data.put(str, "" + j5);
        }
        return this;
    }
