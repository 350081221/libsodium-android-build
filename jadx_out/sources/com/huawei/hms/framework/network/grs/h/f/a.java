...
public class a {
    public static HttpsURLConnection a(String str, Context context, String str2) {
        ...
        String b5 = com.huawei.hms.framework.network.grs.h.a.b(context, "NetworkKit-grs", str2);
        Logger.d("URLConnectionHelper", "request to grs server with a User-Agent header is:" + b5);
        httpsURLConnection.setRequestProperty(HTTP.USER_AGENT, b5);
