...
public class GrsBaseInfo implements Cloneable {
    ...
    private StringBuffer getStringBuffer(StringBuffer stringBuffer, boolean z4, Context context) {
        ...
        stringBuffer.append(bi.f12269o);
        stringBuffer.append(ContainerUtils.KEY_VALUE_DELIMITER);
    ...
    public String getGrsParasKey(boolean z4, boolean z5, Context context) {
        ...
        com.huawei.hms.framework.network.grs.f.b a5 = com.huawei.hms.framework.network.grs.f.b.a(context.getPackageName(), this);
        com.huawei.hms.framework.network.grs.local.model.a a6 = a5 != null ? a5.a() : null;
        String grsReqParamJoint = getGrsReqParamJoint(z4, z5, a6 != null ? a6.b() : "", context);
    ...
    public String getGrsReqParamJoint(boolean z4, boolean z5, String str, Context context) {
        ...
        if (!TextUtils.isEmpty(uid)) {
            ...
            stringBuffer.append(ContainerUtils.KEY_VALUE_DELIMITER);
            if (z4) {
                a5 = com.huawei.hms.framework.network.grs.h.b.b(uid);
            } else if (z5) {
                a5 = com.huawei.hms.framework.network.grs.h.b.a(uid);
            } else {
                stringBuffer.append(uid);
            }
