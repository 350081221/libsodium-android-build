...
public class c extends a {
    ...
    private List<com.huawei.hms.framework.network.grs.local.model.b> a(JSONObject jSONObject) {
        ...
        try {
            ...
            Logger.w("LocalManagerV1", "parse countryGroups failed maybe json style is wrong. %s", StringUtils.anonymizeMessage(e5.getMessage()));
            return new ArrayList();
        }
    }
    ...
    public int a(String str) {
        ...
        try {
            ...
            long j5 = jSONObject.getLong("cacheControl");
            JSONArray jSONArray = jSONObject.getJSONArray("services");
            this.f8418a.b(string);
            this.f8418a.a(j5);
            if (jSONArray != null) {
            ...
            Logger.w("LocalManagerV1", "parse appbean failed maybe json style is wrong. %s", StringUtils.anonymizeMessage(e5.getMessage()));
            return -1;
        }
    }
    ...
    public int b(String str) {
        ...
        try {
            ...
            if (jSONObject.length() != 0) {
                this.f8419b.addAll(a(jSONObject));
            }
            return 0;
        } catch (JSONException e5) {
            Logger.w("LocalManagerV1", "parse countrygroup failed maybe json style is wrong. %s", StringUtils.anonymizeMessage(e5.getMessage()));
            return -1;
        }
    }
