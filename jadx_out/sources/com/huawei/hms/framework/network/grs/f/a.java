...
public abstract class a {
    ...
    protected com.huawei.hms.framework.network.grs.local.model.a f8418a;

    /* renamed from: b, reason: collision with root package name */
    protected List<com.huawei.hms.framework.network.grs.local.model.b> f8419b;

    /* renamed from: c, reason: collision with root package name */
    protected Map<String, String> f8420c = new ConcurrentHashMap(16);

    /* renamed from: d, reason: collision with root package name */
    protected boolean f8421d = false;

    /* renamed from: e, reason: collision with root package name */
    protected boolean f8422e = false;

    /* renamed from: f, reason: collision with root package name */
    protected boolean f8423f = false;

    /* renamed from: g, reason: collision with root package name */
    protected Set<String> f8424g = new HashSet(16);
    ...
    private int f(String str) {
        ...
        if (this.f8422e && (b5 = b(str)) != 0) {
            return b5;
        }
        int a5 = a(str);
        return a5 != 0 ? a5 : e(str);
    }
    ...
    private int g(String str) {
        ...
        return (!this.f8422e || !((list = this.f8419b) == null || list.isEmpty()) || (c5 = c(str)) == 0) ? d(str) : c5;
    }
    ...
    public String a(Context context, com.huawei.hms.framework.network.grs.e.a aVar, GrsBaseInfo grsBaseInfo, String str, String str2, boolean z4) {
        Map<String, String> a5 = a(context, aVar, grsBaseInfo, str, z4);
        if (a5 != null) {
            return a5.get(str2);
        }
    ...
    public List<com.huawei.hms.framework.network.grs.local.model.b> a(JSONArray jSONArray) {
        ...
        try {
            ...
            for (int i5 = 0; i5 < jSONArray.length(); i5++) {
                ...
                bVar.a(jSONObject.getString(DownloadProviderHook.COLUMN_DESCRIPTION));
            ...
            Logger.w("AbstractLocalManager", "parse countrygroup failed maybe json style is wrong. %s", StringUtils.anonymizeMessage(e5.getMessage()));
            return new ArrayList();
        }
    }
    ...
    public Map<String, String> a(Context context, com.huawei.hms.framework.network.grs.e.a aVar, GrsBaseInfo grsBaseInfo, String str, boolean z4) {
        com.huawei.hms.framework.network.grs.local.model.a aVar2 = this.f8418a;
        if (aVar2 == null) {
            Logger.w("AbstractLocalManager", "application data is null.");
            return null;
        }
        com.huawei.hms.framework.network.grs.local.model.c a5 = aVar2.a(str);
        if (a5 == null) {
            Logger.w("AbstractLocalManager", "service not found in local config{%s}", str);
            return null;
        }
        String b5 = e.b(context, aVar, a5.b(), grsBaseInfo, z4);
        if (b5 == null) {
            Logger.w("AbstractLocalManager", "country not found by routeby in local config{%s}", a5.b());
            return null;
        }
        List<com.huawei.hms.framework.network.grs.local.model.b> a6 = a5.a();
        com.huawei.hms.framework.network.grs.local.model.d a7 = a5.a(((a6 == null || a6.size() == 0) ? this.f8420c : a(a6, grsBaseInfo, b5)).get(b5));
        if (a7 == null) {
            return null;
        }
        return a7.a();
    ...
    public void a() {
        com.huawei.hms.framework.network.grs.local.model.a aVar = this.f8418a;
        if (aVar != null) {
            aVar.a();
            this.f8423f = true;
        }
    ...
    public void a(GrsBaseInfo grsBaseInfo) {
        this.f8420c.put("no_route_country", "no-country");
        List<com.huawei.hms.framework.network.grs.local.model.b> list = this.f8419b;
        if (list == null || list.isEmpty()) {
            return;
        }
        for (com.huawei.hms.framework.network.grs.local.model.b bVar : this.f8419b) {
            if (bVar.a().contains(grsBaseInfo.getIssueCountry())) {
                this.f8420c.put(grsBaseInfo.getIssueCountry(), bVar.b());
            }
            if (bVar.a().contains(grsBaseInfo.getRegCountry())) {
                this.f8420c.put(grsBaseInfo.getRegCountry(), bVar.b());
            }
            if (bVar.a().contains(grsBaseInfo.getSerCountry())) {
                this.f8420c.put(grsBaseInfo.getSerCountry(), bVar.b());
            }
        }
        this.f8419b = null;
    }
    ...
    */
    public void b(org.json.JSONArray r15) {
        ...
        Lc:
            ...
            r3.b(r4)
            java.util.Set<java.lang.String> r5 = r14.f8424g
            boolean r5 = r5.contains(r4)
            if (r5 != 0) goto Lf2
            java.util.Set<java.lang.String> r5 = r14.f8424g
            r5.add(r4)
            boolean r5 = r14.f8422e
            if (r5 == 0) goto Lf2
        ...
        Ldf:
            r3.a(r2)
            com.huawei.hms.framework.network.grs.local.model.a r2 = r14.f8418a
            if (r2 != 0) goto Led
    ...
    public int c(String str) {
        ...
        try {
            ...
            this.f8419b.addAll(a(jSONArray));
            return 0;
        } catch (JSONException e5) {
            Logger.w("AbstractLocalManager", "parse countrygroup failed maybe json style is wrong. %s", StringUtils.anonymizeMessage(e5.getMessage()));
            return -1;
    ...
    public int d(String str) {
        try {
            ...
            Logger.w("AbstractLocalManager", "parse 2.0 services failed maybe because of json style.please check! %s", StringUtils.anonymizeMessage(e5.getMessage()));
            return -1;
        }
    }
