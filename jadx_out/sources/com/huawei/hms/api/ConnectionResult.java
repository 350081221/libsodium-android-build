...
public final class ConnectionResult implements Parcelable {
    ...
    static class a implements Parcelable.Creator<ConnectionResult> {
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public ConnectionResult[] newArray(int i5) {
    ...
    public final void startResolutionForResult(Activity activity, int i5) throws IntentSender.SendIntentException {
        if (hasResolution()) {
            HuaweiApiAvailability.getInstance().resolveError(activity, this.connectionErrorCode, i5, this.pendingIntent);
        }
    }
    ...
    public void writeToParcel(Parcel parcel, int i5) {
        ...
        this.pendingIntent.writeToParcel(parcel, i5);
    }

    ConnectionResult(int i5, int i6, PendingIntent pendingIntent, String str) {
        this.apiVersion = i5;
        this.connectionErrorCode = i6;
