...
public final class b extends HuaweiApiAvailability {
    ...
    private static final b f8335a = new b();

    /* loaded from: classes3.dex */
    class a implements BusResponseCallback {

        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ k[] f8336a;
        ...
        public BusResponseResult innerError(Activity activity, int i5, String str) {
            HMSLog.e("HuaweiApiAvailabilityImpl", "Test foreground bus error: resultCode " + i5 + ", errMessage" + str);
            this.f8336a[0].c(new AvailabilityException());
            return null;
        }

        @Override // com.huawei.hms.activity.internal.BusResponseCallback
        public BusResponseResult succeedReturn(Activity activity, int i5, Intent intent) {
            HMSLog.i("HuaweiApiAvailabilityImpl", "Test foreground bus success: resultCode " + i5 + ", data" + intent);
            return null;
        }
    }
    ...
    public PendingIntent b(Context context, int i5) {
        HMSLog.i("HuaweiApiAvailabilityImpl", "Enter getResolveErrorPendingIntent, errorCode: " + i5);
        Intent a5 = a(context, i5);
        if (a5 != null) {
            return PendingIntent.getActivity(context, 0, a5, 67108864);
        }
        return null;
    }
    ...
    public Task<Void> checkApiAccessible(HuaweiApi<?> huaweiApi, HuaweiApi<?>... huaweiApiArr) {
        Task<Void> b5 = new k().b();
        if (huaweiApi != null) {
            try {
                a(huaweiApi);
            } catch (AvailabilityException e5) {
                HMSLog.i("HuaweiApiAvailabilityImpl", "checkApi has AvailabilityException " + e5.getMessage());
            }
        }
    ...
    @Override // com.huawei.hms.api.HuaweiApiAvailability
    public Dialog getErrorDialog(Activity activity, int i5, int i6) {
        Checker.checkNonNull(activity, "activity must not be null.");
        HMSLog.i("HuaweiApiAvailabilityImpl", "Enter getErrorDialog, errorCode: " + i5);
        return getErrorDialog(activity, i5, i6, null);
    }

    @Override // com.huawei.hms.api.HuaweiApiAvailability
    public String getErrorString(int i5) {
        HMSLog.i("HuaweiApiAvailabilityImpl", "Enter getErrorString, errorCode: " + i5);
        return ConnectionResult.getErrorString(i5);
    }
    ...
    public Task<Void> getHuaweiServicesReady(Activity activity) {
        ...
        if (resolveErrorIntent != null) {
            ForegroundIntentBuilder.registerResponseCallback(ResolutionDelegate.CALLBACK_METHOD, new a(this, kVarArr));
            ...
            kVarArr[0].c(new AvailabilityException());
        }
        return b5;
    }

    @Override // com.huawei.hms.api.HuaweiApiAvailability
    public Intent getResolveErrorIntent(Activity activity, int i5) {
        HMSLog.i("HuaweiApiAvailabilityImpl", "Enter getResolveErrorIntent, errorCode: " + i5);
        if (i5 != 1 && i5 != 2) {
            if (i5 != 6) {
                if (i5 == 9 && Util.isAvailableLibExist(activity)) {
    ...
    @Override // com.huawei.hms.api.HuaweiApiAvailability
    public PendingIntent getResolveErrorPendingIntent(Activity activity, int i5) {
        HMSLog.i("HuaweiApiAvailabilityImpl", "Enter getResolveErrorPendingIntent, errorCode: " + i5);
        Intent resolveErrorIntent = getResolveErrorIntent(activity, i5);
        if (resolveErrorIntent != null) {
    ...
    public boolean isUserResolvableError(int i5) {
        return isUserResolvableError(i5, null);
    }

    @Override // com.huawei.hms.api.HuaweiApiAvailability
    public boolean isUserResolvableError(int i5, PendingIntent pendingIntent) {
        if (i5 == 0) {
            return false;
        }
        return pendingIntent != null || i5 == 1 || i5 == 2 || i5 == 6 || i5 == 9;
    }
    ...
    @Override // com.huawei.hms.api.HuaweiApiAvailability
    public void resolveError(Activity activity, int i5, int i6) {
        resolveError(activity, i5, i6, null);
    }

    @Override // com.huawei.hms.api.HuaweiApiAvailability
    public boolean showErrorDialogFragment(Activity activity, int i5, int i6) {
        return showErrorDialogFragment(activity, i5, i6, null);
    }

    @Override // com.huawei.hms.api.HuaweiApiAvailability
    public void showErrorNotification(Context context, int i5) {
        Checker.checkNonNull(context, "context must not be null.");
        HMSLog.i("HuaweiApiAvailabilityImpl", "Enter showErrorNotification, errorCode: " + i5);
        if (!(context instanceof Activity)) {
            HMSLog.i("HuaweiApiAvailabilityImpl", "context not instanceof Activity");
            return;
        }
        Dialog errorDialog = getErrorDialog((Activity) context, i5, 0);
        if (errorDialog == null) {
    ...
    @Override // com.huawei.hms.api.HuaweiApiAvailability
    public void resolveError(Activity activity, int i5, int i6, PendingIntent pendingIntent) {
        Checker.checkNonNull(activity, "activity must not be null.");
        if (pendingIntent != null) {
            HMSLog.i("HuaweiApiAvailabilityImpl", "Enter resolveError, param pendingIntent is not null. and.errorCode: " + i5);
        } else {
            HMSLog.i("HuaweiApiAvailabilityImpl", "Enter resolveError, param pendingIntent is  null. get pendingIntent from error code.and.errorCode: " + i5);
            pendingIntent = getResolveErrorPendingIntent(activity, i5);
        }
        if (pendingIntent != null) {
            HMSLog.i("HuaweiApiAvailabilityImpl", "In resolveError, start pendingIntent.errorCode: " + i5);
            try {
                activity.startIntentSenderForResult(pendingIntent.getIntentSender(), i6, null, 0, 0, 0);
            } catch (IntentSender.SendIntentException unused) {
                HMSLog.e("HuaweiApiAvailabilityImpl", "Enter resolveError, start pendingIntent failed.errorCode: " + i5);
            }
        }
    }
    ...
    public Intent a(Context context, int i5) {
        ...
        if (i5 != 6) {
            if (i5 == 9 && Util.isAvailableLibExist(context)) {
    ...
    public Dialog getErrorDialog(Activity activity, int i5, int i6, DialogInterface.OnCancelListener onCancelListener) {
        Checker.checkNonNull(activity, "activity must not be null.");
        HMSLog.i("HuaweiApiAvailabilityImpl", "Enter getErrorDialog, errorCode: " + i5);
        return a(activity, i5, DialogRedirect.getInstance(activity, a(activity, i5), i6), onCancelListener);
    }

    @Override // com.huawei.hms.api.HuaweiApiAvailability
    public int isHuaweiMobileServicesAvailable(Context context, int i5) {
        Checker.checkNonNull(context, "context must not be null.");
        return HuaweiMobileServicesUtil.isHuaweiMobileServicesAvailable(context, i5);
    }

    @Override // com.huawei.hms.api.HuaweiApiAvailability
    public boolean showErrorDialogFragment(Activity activity, int i5, Fragment fragment, int i6, DialogInterface.OnCancelListener onCancelListener) {
        return showErrorDialogFragment(activity, i5, i6, onCancelListener);
    }

    @Override // com.huawei.hms.api.HuaweiApiAvailability
    public PendingIntent getErrPendingIntent(Context context, int i5, int i6) {
        HMSLog.i("HuaweiApiAvailabilityImpl", "Enter getResolveErrorPendingIntent, errorCode: " + i5 + " requestCode: " + i6);
        Intent a5 = a(context, i5);
        if (a5 != null) {
            return PendingIntent.getActivity(context, i6, a5, 67108864);
        }
        return null;
    }
    ...
    public Task<Void> checkApiAccessible(HuaweiApiCallable huaweiApiCallable, HuaweiApiCallable... huaweiApiCallableArr) {
        ...
        if (huaweiApiCallable != null) {
            try {
                ...
                HMSLog.i("HuaweiApiAvailabilityImpl", "HuaweiApiCallable checkApi has AvailabilityException " + e5.getMessage());
            }
        }
    ...
    private Intent a(Activity activity, int i5) {
        HMSLog.i("HuaweiApiAvailabilityImpl", "getErrorResolutionIntent, errorCode: " + i5);
        if (i5 == 1 || i5 == 2) {
    ...
    private static Dialog a(Activity activity, int i5, DialogRedirect dialogRedirect, DialogInterface.OnCancelListener onCancelListener) {
        if (i5 == 0) {
            return null;
        }
        AlertDialog.Builder builder = new AlertDialog.Builder(activity, NotInstalledHmsDialogHelper.getDialogThemeId(activity));
        builder.setMessage(ConnectionErrorMessages.getErrorMessage(activity, i5));
        if (onCancelListener != null) {
            builder.setOnCancelListener(onCancelListener);
        }
        builder.setPositiveButton(ConnectionErrorMessages.getErrorDialogButtonMessage(activity, i5), dialogRedirect);
        String errorTitle = ConnectionErrorMessages.getErrorTitle(activity, i5);
        if (errorTitle != null) {
