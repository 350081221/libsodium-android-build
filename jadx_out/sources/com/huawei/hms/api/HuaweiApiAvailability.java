...
public abstract class HuaweiApiAvailability {
    ...
    public static void setServicesVersionCode(int i5) {
        SERVICES_VERSION_CODE = i5;
    }
    ...
    public abstract PendingIntent getErrPendingIntent(Context context, int i5, int i6);

    public abstract PendingIntent getErrPendingIntent(Context context, ConnectionResult connectionResult);

    public abstract Dialog getErrorDialog(Activity activity, int i5, int i6);

    public abstract Dialog getErrorDialog(Activity activity, int i5, int i6, DialogInterface.OnCancelListener onCancelListener);

    public abstract String getErrorString(int i5);

    public abstract Task<Void> getHuaweiServicesReady(Activity activity);

    public abstract Intent getResolveErrorIntent(Activity activity, int i5);

    public abstract PendingIntent getResolveErrorPendingIntent(Activity activity, int i5);
    ...
    public abstract int isHuaweiMobileServicesAvailable(Context context, int i5);

    public abstract boolean isUserResolvableError(int i5);

    public abstract boolean isUserResolvableError(int i5, PendingIntent pendingIntent);

    public abstract void popupErrNotification(Context context, ConnectionResult connectionResult);

    public abstract void resolveError(Activity activity, int i5, int i6);

    public abstract void resolveError(Activity activity, int i5, int i6, PendingIntent pendingIntent);

    public abstract boolean showErrorDialogFragment(Activity activity, int i5, int i6);

    public abstract boolean showErrorDialogFragment(Activity activity, int i5, int i6, DialogInterface.OnCancelListener onCancelListener);

    public abstract boolean showErrorDialogFragment(Activity activity, int i5, Fragment fragment, int i6, DialogInterface.OnCancelListener onCancelListener);

    public abstract void showErrorNotification(Context context, int i5);
}
