...
public abstract class HuaweiMobileServicesUtil {
    ...
    public static Dialog getErrorDialog(int i5, Activity activity, int i6) {
        return HuaweiApiAvailability.getInstance().getErrorDialog(activity, i5, i6, null);
    }

    public static String getErrorString(int i5) {
        return HuaweiApiAvailability.getInstance().getErrorString(i5);
    }
    ...
    public static int isHuaweiMobileServicesAvailable(Context context, int i5) {
        ...
        if (!HMSPackageManager.getInstance(context).isApkUpdateNecessary(i5)) {
            return 0;
        }
    ...
    public static boolean isUserRecoverableError(int i5) {
        return HuaweiApiAvailability.getInstance().isUserResolvableError(i5);
    }

    public static boolean popupErrDlgFragment(int i5, Activity activity, int i6, DialogInterface.OnCancelListener onCancelListener) {
        return HuaweiApiAvailability.getInstance().showErrorDialogFragment(activity, i5, i6, onCancelListener);
    }
    ...
    public static boolean showErrorDialogFragment(int i5, Activity activity, int i6) {
        return HuaweiApiAvailability.getInstance().showErrorDialogFragment(activity, i5, i6, null);
    }

    public static void showErrorNotification(int i5, Context context) {
        HuaweiApiAvailability.getInstance().showErrorNotification(context, i5);
    }

    public static Dialog getErrorDialog(int i5, Activity activity, int i6, DialogInterface.OnCancelListener onCancelListener) {
        return HuaweiApiAvailability.getInstance().getErrorDialog(activity, i5, i6, onCancelListener);
    }

    public static boolean popupErrDlgFragment(int i5, Activity activity, Fragment fragment, int i6, DialogInterface.OnCancelListener onCancelListener) {
        return HuaweiApiAvailability.getInstance().showErrorDialogFragment(activity, i5, fragment, i6, onCancelListener);
    }
