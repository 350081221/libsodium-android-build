...
public class BindingFailedResolution implements IBridgeActivityDelegate, ServiceConnection {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void finishBridgeActivity(int i5) {
        Activity activity = getActivity();
        if (activity != null && !activity.isFinishing()) {
            HMSLog.i(TAG, "finishBridgeActivity：" + i5);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void fireStartResult(boolean z4) {
        if (this.isStarting) {
    ...
    private void noticeBindResult(boolean z4, int i5) {
        FailedBinderCallBack.BinderCallBack binderCallBack;
        if (z4 && (binderCallBack = this.callBack) != null) {
            binderCallBack.binderCallBack(i5);
        }
    }
    ...
    public void onBridgeActivityCreate(Activity activity) {
        ...
        com.huawei.hms.api.a.f8332b.a(activity);
        selfDestroyHandle();
    ...
    public void onBridgeActivityDestroy() {
        ...
        com.huawei.hms.api.a.f8332b.b(this.curActivity);
    ...
    protected void onStartResult(boolean z4) {
        if (getActivity() == null) {
            return;
        }
        if (z4) {
