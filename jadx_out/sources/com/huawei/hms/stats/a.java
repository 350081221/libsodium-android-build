...
public class a {
    ...
    public static int f8758a;

    /* renamed from: b, reason: collision with root package name */
    public static final Object f8759b = new Object();
    ...
    public static boolean a(Context context) {
        ...
        if (packageManager != null) {
            try {
                ...
                HMSLog.e("AnalyticsSwitchHolder", "In getBiIsReportSetting, Failed to read meta data bi report setting.", e5);
            }
        }
    ...
    public static boolean b(Context context) {
        ...
        if (packageManager != null) {
            try {
                ...
                HMSLog.e("AnalyticsSwitchHolder", "In getBiSetting, Failed to read meta data bisetting.", e5);
            }
        }
        ...
        synchronized (f8759b) {
            ...
            if (f8758a == 0) {
                ...
                if (a(context)) {
                    ...
                    try {
                        int i5 = Settings.Secure.getInt(context.getContentResolver(), "hw_app_analytics_state");
                        HMSLog.i("AnalyticsSwitchHolder", "hw_app_analytics_state value is " + i5);
                        if (i5 == 1) {
                            f8758a = 1;
                        } else {
                            f8758a = 2;
