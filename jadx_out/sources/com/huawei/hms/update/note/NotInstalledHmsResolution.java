...
public class NotInstalledHmsResolution implements IBridgeActivityDelegate {
    ...
    public Dialog f8807a;

    /* renamed from: b, reason: collision with root package name */
    public Activity f8808b;
    ...
    public final void a(Activity activity) {
        a();
        this.f8807a = NotInstalledHmsDialogHelper.getDialogBuilder(activity).setPositiveButton(NotInstalledHmsDialogHelper.getConfirmResId(activity), new a(activity)).show();
    }
