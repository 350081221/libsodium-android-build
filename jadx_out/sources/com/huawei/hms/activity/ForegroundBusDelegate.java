...
public class ForegroundBusDelegate implements IBridgeActivityDelegate {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void errorReturn(int i5, String str) {
        HMSLog.e(TAG, str);
        ...
        if (responseCallback != null) {
            BusResponseResult innerError = responseCallback.innerError(this.mThisWeakRef.get(), i5, str);
            if (innerError == null) {
    ...
    public void startApkHubActivity() {
        ...
        try {
            ...
            HMSLog.e(TAG, "Launch sign in Intent failed. hms is probably being updated：", e5);
            errorReturn(0, "launch bus intent failed");
        }
    }

    private void succeedReturn(int i5, Intent intent) {
    ...
    public boolean onBridgeActivityResult(int i5, int i6, Intent intent) {
        if (i5 == REQUEST_CODE_BUS) {
            ...
            BusResponseCallback responseCallback = getResponseCallback(this.innerHeader.getResponseCallbackKey());
            if (responseCallback == null) {
                succeedReturn(i6, intent);
                return true;
            }
            BusResponseResult succeedReturn = responseCallback.succeedReturn(this.mThisWeakRef.get(), i6, intent);
