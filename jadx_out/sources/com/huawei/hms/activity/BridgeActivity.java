...
public class BridgeActivity extends Activity {
    ...
    public static final int f8116b = a("ro.build.hw_emui_api_level", 0);

    /* renamed from: a, reason: collision with root package name */
    public IBridgeActivityDelegate f8117a;

    /* loaded from: classes3.dex */
    public class a implements View.OnApplyWindowInsetsListener {

        /* renamed from: a, reason: collision with root package name */
        public final /* synthetic */ ViewGroup f8118a;
        ...
        public WindowInsets onApplyWindowInsets(View view, WindowInsets windowInsets) {
            try {
                ...
                if (invoke == null) {
                    ...
                    ViewGroup viewGroup = this.f8118a;
                    if (viewGroup != null) {
                        viewGroup.setPadding(rect.left, 0, rect.right, 0);
                    }
                }
            } catch (ClassNotFoundException | IllegalAccessException | NoSuchMethodException | InvocationTargetException e5) {
                HMSLog.e("BridgeActivity", "An exception occurred while reading: onApplyWindowInsets" + e5.getMessage());
            }
    ...
    public static void a(Window window, boolean z4) {
        try {
            ...
            HMSLog.e("BridgeActivity", "In setHwFloating, Failed to call Window.setHwFloating()." + e5.getMessage());
        }
    }
    ...
    public final boolean b() {
        ...
        try {
            ...
            this.f8117a = iBridgeActivityDelegate;
            try {
                iBridgeActivityDelegate.onBridgeActivityCreate(this);
                return true;
            } catch (RuntimeException e5) {
                HMSLog.e("BridgeActivity", "Run time Exception." + e5.getMessage());
                return false;
            }
        } catch (ClassCastException | ClassNotFoundException | IllegalAccessException | InstantiationException e6) {
            HMSLog.e("BridgeActivity", "In initialize, Failed to create 'IUpdateWizard' instance." + e6.getMessage());
            return false;
        }
    }
    ...
    public final void c() {
        try {
            ...
            HMSLog.w("BridgeActivity", "requestWindowFeature " + e5.getMessage());
        }
    ...
    public void onActivityResult(int i5, int i6, Intent intent) {
        ...
        super.onActivityResult(i5, i6, safeIntent);
        IBridgeActivityDelegate iBridgeActivityDelegate = this.f8117a;
        if (iBridgeActivityDelegate != null && !iBridgeActivityDelegate.onBridgeActivityResult(i5, i6, safeIntent) && !isFinishing()) {
    ...
    public final void a() {
        ...
        if (findViewById != null && (findViewById instanceof ViewGroup)) {
            ...
            try {
                ...
                HMSLog.e("BridgeActivity", "An exception occurred while reading: setDisplaySideMode" + e5.getMessage());
            }
    ...
    public static int a(String str, int i5) {
        try {
            ...
            return ((Integer) cls.getDeclaredMethod("getInt", String.class, Integer.TYPE).invoke(cls, str, Integer.valueOf(i5))).intValue();
