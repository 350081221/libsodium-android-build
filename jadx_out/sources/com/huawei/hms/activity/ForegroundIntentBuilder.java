...
public class ForegroundIntentBuilder {
    ...
    public ForegroundIntentBuilder setApiLevel(int i5) {
        this.foregroundHeader.setApiLevel(i5);
        return this;
    }
    ...
    public ForegroundIntentBuilder setKitSdkVersion(int i5) {
        this.foregroundHeader.setKitSdkVersion(i5);
        return this;
    }

    public ForegroundIntentBuilder setMinApkVersion(int i5) {
        this.innerHeader.setApkVersion(i5);
        return this;
    }
