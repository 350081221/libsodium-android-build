    ...
    */
    ...
    public static String b(Context context) {
        ...
        try {
            ...
            HMSLog.e("AGCUtils", "In getMetaDataCpId, Failed to read meta data for the CpId.", e5);
            return "";
        }
    }
    ...
    public static String a(Context context) {
        ...
        try {
            ...
            HMSLog.e("AGCUtils", "In getMetaDataAppId, Failed to read meta data for the AppID.", e5);
            return "";
        }
    }
}
