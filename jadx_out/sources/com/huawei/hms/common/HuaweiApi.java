...
public class HuaweiApi<TOption extends Api.ApiOptions> {
        ...
        */
        ...
        public void innerConnectionFailed(ConnectionResult connectionResult) {
            ...
            while (it.hasNext()) {
                ...
                if (this.mConnectionResult.getResolution() != null && z4) {
        ...
        synchronized void connect(int i5, TaskApiCallbackWrapper taskApiCallbackWrapper) {
            ...
            if (this.mApi.getActivity() != null) {
                if (this.mResolveClientBean == null) {
                    this.mResolveClientBean = new ResolveClientBean(this.mClient, i5);
                }
        ...
        */
        private void notifyCpException(com.huawei.hms.common.HuaweiApi.RequestHandler r9, java.lang.Exception r10) {
            /*
                ...
                com.huawei.hmf.tasks.k r4 = r4.getTaskCompletionSource()     // Catch: java.lang.RuntimeException -> L2c
        ...
        public void run() {
            ...
            try {
                ...
                notifyCpException(requestHandler, e5);
            }
        }
    }
    ...
    public HuaweiApi(Activity activity, Api<TOption> api, TOption toption, AbstractClientBuilder abstractClientBuilder, int i5) {
        Checker.checkNonNull(activity, "Null activity is not permitted.");
        this.mActivity = new WeakReference<>(activity);
        init(activity, api, toption, abstractClientBuilder, i5, null);
    }

    private void init(Context context, Api<TOption> api, TOption toption, AbstractClientBuilder abstractClientBuilder, int i5, String str) {
        this.mContext = context.getApplicationContext();
        this.mOption = toption;
        this.mClientBuilder = abstractClientBuilder;
        setHostAppId(context);
        this.mSubAppInfo = new SubAppInfo("");
        this.mKitSdkVersion = i5;
        if (!TextUtils.isEmpty(str)) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void innerDisconnect(HuaweiApi<?> huaweiApi, k<Boolean> kVar) {
        HMSLog.i(TAG, "innerDisconnect.");
        try {
            huaweiApi.getClient(RequestManager.getHandler().getLooper(), null).disconnect();
            kVar.d(Boolean.TRUE);
        } catch (Exception e5) {
            HMSLog.w(TAG, "disconnect the binder failed for:" + e5.getMessage());
        }
    }
    ...
    private <TResult, TClient extends AnyClient> Task<TResult> sendRequest(TaskApiCall<TClient, TResult> taskApiCall) {
        ...
        if (taskApiCall.getToken() == null) {
            ...
            kVar = new k(taskApiCall.getToken());
        }
        RequestManager.getHandler().post(new RequestRunnable(this, new TaskApiCallWrapper(taskApiCall, kVar)));
        return kVar.b();
    }
    ...
    public Task<Boolean> disconnectService() {
        ...
        RequestManager.getHandler().post(new Runnable() { // from class: com.huawei.hms.common.HuaweiApi.1
            @Override // java.lang.Runnable
            public void run() {
                HuaweiApi.this.innerDisconnect(this, kVar);
            }
        });
        return kVar.b();
    }
    ...
    public <TResult, TClient extends AnyClient> Task<TResult> doWrite(TaskApiCall<TClient, TResult> taskApiCall) {
        ...
        if (taskApiCall == null) {
            ...
            k kVar = new k();
            kVar.c(new ApiException(Status.FAILURE));
            return kVar.b();
        }
    ...
    public HuaweiApi(Activity activity, Api<TOption> api, TOption toption, AbstractClientBuilder abstractClientBuilder, int i5, String str) {
        Checker.checkNonNull(activity, "Null activity is not permitted.");
        this.mActivity = new WeakReference<>(activity);
        init(activity, api, toption, abstractClientBuilder, i5, str);
    }
    ...
    public HuaweiApi(Context context, Api<TOption> api, TOption toption, AbstractClientBuilder abstractClientBuilder, int i5) {
        Checker.checkNonNull(context, "Null context is not permitted.");
        init(context, api, toption, abstractClientBuilder, i5, null);
    }

    public HuaweiApi(Context context, Api<TOption> api, TOption toption, AbstractClientBuilder abstractClientBuilder, int i5, String str) {
        Checker.checkNonNull(context, "Null context is not permitted.");
        init(context, api, toption, abstractClientBuilder, i5, str);
    }
