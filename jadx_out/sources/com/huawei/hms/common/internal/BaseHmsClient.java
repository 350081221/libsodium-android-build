...
public abstract class BaseHmsClient implements AidlApiClient {
    ...
    private void checkAvailabilityAndConnect(int i5, boolean z4) {
        ...
        HMSLog.i(TAG, "Enter connect, Connection Status: " + i6);
        if (!z4 && (i6 == 3 || i6 == 5)) {
            return;
        }
        if (getMinApkVersion() > i5) {
            i5 = getMinApkVersion();
        }
        HMSLog.i(TAG, "connect minVersion:" + i5 + " packageName:" + this.mClientSettings.getInnerHmsPkg());
        ...
        if (Util.isAvailableLibExist(this.mContext)) {
            AvailableAdapter availableAdapter = new AvailableAdapter(i5);
        ...
        int isHuaweiMobileServicesAvailable2 = HuaweiApiAvailability.getInstance().isHuaweiMobileServicesAvailable(this.mContext, i5);
    ...
    private BinderAdapter.BinderCallBack newBinderCallBack() {
        return new BinderAdapter.BinderCallBack() { // from class: com.huawei.hms.common.internal.BaseHmsClient.1
            ...
            public void onBinderFailed(int i5) {
                onBinderFailed(i5, null);
            }
            ...
            @Override // com.huawei.hms.adapter.BinderAdapter.BinderCallBack
            public void onBinderFailed(int i5, Intent intent) {
                if (intent != null) {
                    ...
                    if (activeActivity != null) {
                        ...
                        FailedBinderCallBack.getInstance().setCallBack(Long.valueOf(time), new FailedBinderCallBack.BinderCallBack() { // from class: com.huawei.hms.common.internal.BaseHmsClient.1.1
                            ...
                            public void binderCallBack(int i6) {
                                if (i6 != 0) {
    ...
    private void notice(AvailableAdapter availableAdapter, int i5) {
        HMSLog.i(TAG, "enter notice");
        if (!getClientSettings().isHasActivity()) {
            if (i5 == 29) {
                i5 = 9;
            }
            notifyFailed(new ConnectionResult(26, HuaweiApiAvailability.getInstance().getErrPendingIntent(this.mContext, i5, 0)));
        } else {
            ...
            if (activeActivity != null) {
                availableAdapter.startNotice(activeActivity, new AvailableAdapter.AvailableCallBack() { // from class: com.huawei.hms.common.internal.BaseHmsClient.2
                    ...
                    public void onComplete(int i6) {
                        BaseHmsClient.this.notifyFailed(i6);
                    }
                });
            } else {
                notifyFailed(26);
    ...
    public void notifyFailed(int i5) {
        HMSLog.i(TAG, "notifyFailed result: " + i5);
        Message message = new Message();
        message.what = RequestManager.NOTIFY_CONNECT_FAILED;
        message.obj = new ConnectionResultWrapper(this.internalRequest, new ConnectionResult(i5));
    ...
    private void resolution(AvailableAdapter availableAdapter, int i5) {
    ...
    public void connect(int i5) {
        checkAvailabilityAndConnect(i5, false);
    }
    ...
    public void disconnect() {
        ...
        HMSLog.i(TAG, "Enter disconnect, Connection Status: " + i5);
        if (i5 != 1) {
            if (i5 != 3) {
                if (i5 == 5) {
    ...
    void setConnectStatus(int i5) {
        if (this.mClientSettings.isUseInnerHms()) {
            INNER_CONN_STATUS.set(i5);
        } else {
            CONN_STATUS.set(i5);
        }
    }
    ...
    public void connect(int i5, boolean z4) {
        checkAvailabilityAndConnect(i5, z4);
    }
