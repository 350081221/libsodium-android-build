...
public class Util {
    ...
    public static int getHmsVersion(Context context) {
        ...
        try {
            ...
            HMSLog.e(TAG, "In getHmsVersion, Failed to read meta data for the HMS VERSION.", e5);
            return 0;
        }
    }
    ...
    public static String getProcessName(Context context, int i5) {
        return UIUtil.getProcessName(context, i5);
    }
            ...
            if (!availableInit) {
                ...
                if (packageManager == null) {
                    ...
                    try {
                        ...
                        HMSLog.e(TAG, "In isAvailableLibExist, Failed to read meta data for the availableLoaded.", e5);
                    }
                    z4 = false;
                    isAvailableAvailable = z4;
                    availableInit = true;
                }
                z4 = true;
                isAvailableAvailable = z4;
    ...
    public static void unBindServiceCatchException(Context context, ServiceConnection serviceConnection) {
        try {
            ...
            HMSLog.e(TAG, "On unBindServiceException:" + e5.getMessage());
        }
    }
}
