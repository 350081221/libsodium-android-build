...
public class i extends PushPreferences {
    ...
    public String b(String str) {
        try {
            ...
            HMSLog.e(TAG, "getSecureData" + e5.getMessage());
            return "";
        }
    }
    ...
    public boolean c(String str) {
        try {
            ...
            HMSLog.e(TAG, "removeToken" + e5.getMessage());
            return false;
        }
    }
    ...
    public String a(String str) {
        ...
        try {
            return PushEncrypter.decrypter(this.f8727b, getString(str));
        } catch (Exception e5) {
            HMSLog.e(TAG, "getSecureData" + e5.getMessage());
            return "";
        }
    ...
    public boolean a(String str, String str2) {
        ...
        try {
            return saveString(str, PushEncrypter.encrypter(this.f8727b, str2));
        } catch (Exception e5) {
            HMSLog.e(TAG, "saveSecureData" + e5.getMessage());
            return false;
        }
    }
