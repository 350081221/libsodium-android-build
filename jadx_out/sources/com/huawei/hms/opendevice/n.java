...
public class n {
    ...
    public enum b {
        IOS("ios"),
        ANDROID(SharedLibraryInfo.PLATFORM_PACKAGE_NAME),
        HARMONY("harmony"),
        WINDOWS("windows"),
        EMBED("embed"),
        OTHERS("others");
    ...
    public static String c(Context context, String str, String str2) {
        try {
            ...
            jSONObject2.put(bi.M, TimeZone.getDefault().getID());
            jSONObject2.put(bi.O, SystemUtils.getLocalCountry());
            JSONObject jSONObject3 = new JSONObject();
            jSONObject3.put(HeaderType.AGENT_VERSION, new PackageManagerHelper(context).getPackageVersionName("com.huawei.android.pushagent"));
            jSONObject3.put("hms_version", String.valueOf(Util.getHmsVersion(context)));
            JSONObject jSONObject4 = new JSONObject();
            jSONObject4.put("dev_type", a.MOBILE.a());
            jSONObject4.put("dev_sub_type", HintConstants.AUTOFILL_HINT_PHONE);
            jSONObject4.put("os_type", b.ANDROID.a());
            jSONObject4.put(bi.f12279y, String.valueOf(HwBuildEx.VERSION.EMUI_SDK_INT));
            jSONObject.put("id", UUID.randomUUID().toString());
            jSONObject.put("global", jSONObject2);
            jSONObject.put("push_agent", jSONObject3);
            jSONObject.put("hardware", jSONObject4);
            jSONObject.put(com.huawei.agconnect.credential.obs.c.f7851a, str);
    ...
    public static boolean d(Context context, String str, String str2) {
        i a5 = i.a(context);
        if (!a5.containsKey("reportAaidAndToken")) {
            HMSLog.d("ReportAaidToken", "It hasn't been reported, this time needs report.");
            return true;
        }
        if (TextUtils.isEmpty(a5.getString("reportAaidAndToken"))) {
