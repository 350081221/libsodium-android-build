...
public class APIEvent {
    ...
    public APIEvent(Long l5, String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9) {
        this.id = l5;
        this.code = str;
        this.timestamp = str2;
        this.type = str3;
    ...
    public Map toMap() {
        ...
        linkedHashMap.put("api_name", this.name);
