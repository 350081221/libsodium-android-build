...
public final class e {
    ...
    private static e f8216b = new e();

    /* renamed from: a, reason: collision with root package name */
    public final Map<String, d> f8217a = new HashMap();
    ...
    public static String a(String str) {
        return b.a().f8206a.getPubKeyVersion(str);
    }

    public static void a(d dVar, String str) {
        byte[] rsaPublicKey = b.a().f8206a.getRsaPublicKey(str);
