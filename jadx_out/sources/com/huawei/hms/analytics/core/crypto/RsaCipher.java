...
public class RsaCipher {
    ...
    private static final Charset f8193a = Charset.forName("UTF-8");
    ...
    public static String encrypt(byte[] bArr, String str) {
        ...
        try {
            return HAHexUtil.byteArray2HexString(a.f(str.getBytes(f8193a), KeyFactory.getInstance(d.f20838a).generatePublic(new X509EncodedKeySpec(bArr))));
