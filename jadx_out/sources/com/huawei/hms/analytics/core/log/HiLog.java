...
public class HiLog {
    ...
    private static LogAdapter f8194a;
    ...
    public static void d(String str, String str2) {
        ...
        f8194a.println(3, str, str2);
    }

    public static void d(String str, String str2, String str3) {
        if (a()) {
            f8194a.println(3, str, str2, str3);
        }
    }
    ...
    public static void e(String str, String str2) {
        ...
        f8194a.println(6, str, str2);
    }

    public static void e(String str, String str2, String str3) {
        if (d()) {
            f8194a.println(6, str, str2, str3);
        }
    }
    ...
    public static void i(String str, String str2) {
        ...
        f8194a.println(4, str, str2);
    }

    public static void i(String str, String str2, String str3) {
        if (b()) {
            f8194a.println(4, str, str2, str3);
        }
    }
    ...
    public static void i(String str, String str2, Object... objArr) {
        ...
        f8194a.println(4, str, String.format(Locale.ROOT, str2, objArr));
    }

    public static synchronized void init(int i5, String str) {
    ...
    public static void w(String str, String str2) {
        ...
        f8194a.println(5, str, str2);
    }

    public static void w(String str, String str2, String str3) {
        if (c()) {
            f8194a.println(5, str, str2, str3);
        }
    }
}
