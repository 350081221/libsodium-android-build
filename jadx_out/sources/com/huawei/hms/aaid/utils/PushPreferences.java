    ...
    */
    ...
    public final File a(Context context, String str) {
        try {
            ...
            HMSLog.e(TAG, "get failed error." + e5.getMessage());
            return null;
        }
    }
    ...
    public final SharedPreferences b(Context context, String str) {
        ...
        try {
            ...
            return (SharedPreferences) declaredConstructor.newInstance(a5, 0);
        } catch (Exception e5) {
            HMSLog.e(TAG, "get SharedPreferences error." + e5.getMessage());
            return null;
        }
    }

    public boolean clear() {
        SharedPreferences sharedPreferences = this.f8115a;
    ...
    public boolean removeKey(String str) {
        ...
        SharedPreferences sharedPreferences = this.f8115a;
        if (sharedPreferences == null || !sharedPreferences.contains(str) || (edit = this.f8115a.edit()) == null) {
            return false;
        }
    ...
    public boolean write(ContentValues contentValues) {
        if (this.f8115a == null || contentValues == null) {
            return false;
        }
        boolean z4 = true;
    ...
    public boolean removeKey(String[] strArr) {
        ...
        for (String str : strArr) {
            if (this.f8115a.contains(str)) {
                this.f8115a.edit().remove(str);
            }
        }
        this.f8115a.edit().commit();
        return true;
    }
}
