...
public enum ErrorEnum {
    SUCCESS(0, 0, SyncStorageEngine.MESG_SUCCESS),
    ...
    ErrorEnum(int i5, int i6, String str) {
        this.internalCode = i5;
        this.externalCode = i6;
        this.message = str;
    }

    public static ErrorEnum fromCode(int i5) {
        return ENUM_MAPPER.get(i5, ERROR_UNKNOWN);
    }
