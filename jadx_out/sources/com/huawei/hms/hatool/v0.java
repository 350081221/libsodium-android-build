...
public class v0 {
    ...
    public static String a(String str) {
        ...
        try {
            ...
            y.b("hmsSdk", "getHostByURI error : " + e5.getMessage());
            return null;
        }
    }
    ...
    public static String a(String str, int i5) {
        ...
        stringBuffer.append(split[split.length - i5]);
        for (int i6 = 1; i6 < i5; i6++) {
            stringBuffer.append(".");
            stringBuffer.append(split[(split.length - i5) + i6]);
        }
    ...
    public static boolean a(String str, String str2, int i5) {
        ...
        if (TextUtils.isEmpty(a5) || TextUtils.isEmpty(str2)) {
            ...
            if (!TextUtils.isEmpty(a6)) {
                if (str2.equals(b2.d.b(a5))) {
                    return true;
                }
                if (!str2.equals(b2.d.b(a6))) {
                    return false;
                }
                try {
                    String substring = a5.substring(0, a5.length() - a6.length());
    ...
    public static boolean b(String str) {
        if (k1.f8607a.booleanValue()) {
            return true;
        }
        for (String str2 : f8686a) {
            if (a(str, str2, 2)) {
                return true;
            }
        }
