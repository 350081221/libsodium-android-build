...
public abstract class a0 {
    ...
    public static b0 a(String str, byte[] bArr, Map<String, String> map) {
        return a(str, bArr, map, HttpPost.METHOD_NAME);
    }
    ...
    public static b0 a(String str, byte[] bArr, Map<String, String> map, String str2) {
        ...
        int i5 = PackageHelper.INSTALL_PARSE_FAILED_UNEXPECTED_EXCEPTION;
        try {
            try {
    ...
    public static HttpURLConnection a(String str, int i5, Map<String, String> map, String str2) {
        if (TextUtils.isEmpty(str)) {
        ...
        httpURLConnection.setRequestProperty(HTTP.CONTENT_LEN, String.valueOf(i5));
    ...
    */
    public static void a(java.net.HttpURLConnection r2) {
        /*
            ...
            com.huawei.secure.android.common.ssl.h r0 = com.huawei.secure.android.common.ssl.h.f(r1)     // Catch: java.lang.IllegalAccessException -> L11 java.io.IOException -> L14 java.security.GeneralSecurityException -> L17 java.security.KeyStoreException -> L1a java.security.NoSuchAlgorithmException -> L1d
            goto L23
        L11:
