...
public abstract class f {
    ...
    public static String a(String str, String str2) {
        ...
        String a5 = a("android.os.SystemProperties", str, str2);
        return TextUtils.isEmpty(a5) ? a("com.huawei.android.os.SystemPropertiesEx", str, str2) : a5;
    }

    public static String a(String str, String str2, String str3) {
        Object a5 = a(str, "get", new Class[]{String.class, String.class}, new Object[]{str2, str3});
        return a5 != null ? (String) a5 : str3;
    }

    public static String b() {
        String a5 = a("com.huawei.android.os.SystemPropertiesEx", "ro.huawei.build.display.id", "");
        y.c("hmsSdk", "SystemPropertiesEx: get rom_ver: " + a5);
