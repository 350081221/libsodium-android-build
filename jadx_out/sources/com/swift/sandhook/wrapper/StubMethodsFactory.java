        ...
        synchronized (StubMethodsFactory.class) {
            while (curStub <= 300) {
                try {
                    ...
                    curStub = i5 + 1;
                    sb.append(i5);
                    return StubMethodsFactory.class.getDeclaredMethod(sb.toString(), new Class[0]);
                } catch (NoSuchMethodException unused) {
                }
            }
            try {
                curStub++;
                return ((Class) proxyGenClass.invoke(null, "SandHookerStubClass_" + curStub, null, StubMethodsFactory.class.getClassLoader(), new Method[]{proxyGenClass}, null)).getDeclaredMethods()[0];
            } catch (Throwable th) {
                th.printStackTrace();
                return null;
            }
