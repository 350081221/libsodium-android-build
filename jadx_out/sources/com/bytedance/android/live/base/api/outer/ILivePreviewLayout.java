...
public interface ILivePreviewLayout {
    ...
    public static class Builder {
        ...
        public Builder setAutoEnterEnable(boolean z4) {
            this.autoEnterEnable = z4;
            return this;
        }

        public Builder setCanShowDislike(boolean z4) {
            this.canShowDislike = z4;
            return this;
        }
        ...
        public Builder setEnablePullToRefresh(boolean z4) {
            this.enablePullToRefresh = z4;
            return this;
        }
        ...
        public Builder setShowTopList(boolean z4) {
            this.showTopList = z4;
            return this;
        }

        public Builder setShowTopListAtOnce(boolean z4) {
            this.showTopListAtOnce = z4;
            return this;
        }

        public Builder setSmoothEnterEnable(boolean z4) {
            this.smoothEnterEnable = z4;
            return this;
        }
    }
