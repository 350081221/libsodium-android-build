...
public interface ILiveHostContextParam {
    ...
    public static class Builder {
        ...
        public Builder setAid(int i5) {
            this.aid = i5;
            return this;
        }

        public Builder setAppIcon(int i5) {
            this.appIcon = i5;
            return this;
        }
        ...
        public Builder setIsBoe(boolean z4) {
            this.isBoe = z4;
            return this;
        }

        public Builder setIsDebug(boolean z4) {
            this.isDebug = z4;
            return this;
        }
        ...
        public Builder setRunInLiveProcess(boolean z4) {
            this.runInLiveProcess = z4;
            return this;
        }
