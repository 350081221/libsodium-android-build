...
public class JavaCallsUtils {
    ...
    public static class JavaParam<T> {
        ...
        public JavaParam(Class<? extends T> cls, T t5) {
            this.clazz = cls;
            this.obj = t5;
        }
    }
    ...
    public static <T> T callMethod(Object obj, String str, Object... objArr) {
        try {
            ...
            Log.w(LOG_TAG, "Meet exception when call Method '" + str + "' in " + obj, e5);
            return null;
        }
    }
    ...
    public static <T> T callStaticMethod(String str, String str2, Object... objArr) {
        try {
            ...
            Log.w(LOG_TAG, "Meet exception when call Method '" + str2 + "' in " + str, e5);
            return null;
        }
    }
    ...
    private static boolean compareClassLists(Class<?>[] clsArr, Class<?>[] clsArr2) {
        ...
        for (int i5 = 0; i5 < clsArr.length; i5++) {
            if (!clsArr[i5].isAssignableFrom(clsArr2[i5])) {
                Map<Class<?>, Class<?>> map = PRIMITIVE_MAP;
                if (!map.containsKey(clsArr[i5]) || !map.get(clsArr[i5]).equals(map.get(clsArr2[i5]))) {
                    return false;
                }
            }
        }
    ...
    public static <T> T newEmptyInstance(Class<?> cls) {
        try {
            ...
            Log.w(LOG_TAG, "Meet exception when make instance as a " + cls.getSimpleName(), e5);
            return null;
        }
    }
    ...
    public static <T> T newEmptyInstanceOrThrow(Class<?> cls) {
        ...
        for (int i5 = 0; i5 < parameterTypes.length; i5++) {
            objArr[i5] = getDefaultValue(parameterTypes[i5]);
        }
    ...
    public static Object newInstance(String str, Object... objArr) {
        try {
            ...
            Log.w(LOG_TAG, "Meet exception when make instance as a " + str, e5);
            return null;
        }
    }
