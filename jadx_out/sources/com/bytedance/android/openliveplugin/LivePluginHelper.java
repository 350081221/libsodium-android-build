...
public class LivePluginHelper {
    ...
    private static final ILiveInitCallback loadingLiveInitCallback = new ILiveInitCallback() { // from class: com.bytedance.android.openliveplugin.LivePluginHelper.6
        ...
        public void onLiveInitFailed(String str) {
            ...
            Toast.makeText((Context) LivePluginHelper.hostActivity.get(), R.string.D, 1).show();
        }
    ...
    public static void enterCommerceOrderList(Activity activity) {
        ...
        ZeusPlatformUtils.registerZeusPluginLoadStateListener("com.byted.live.lite", new PluginStateListener() { // from class: com.bytedance.android.openliveplugin.LivePluginHelper.5
            ...
            public void onPluginStateChanged(int i5, String str) {
                if ((i5 == 4 || i5 == 7 || i5 == 10) && LiveLoadingDialog.dismiss() && LivePluginHelper.hostActivity.get() != null) {
                    Toast.makeText((Context) LivePluginHelper.hostActivity.get(), R.string.D, 1).show();
                }
            }
        });
    ...
    public static void init(Application application, String str, ILiveHostContextParam.Builder builder, ILiveInitCallback iLiveInitCallback, boolean z4) {
        init(application, str, builder, iLiveInitCallback, z4, false);
    }

    public static void init(Application application, String str, ILiveHostContextParam.Builder builder, ILiveInitCallback iLiveInitCallback, boolean z4, boolean z5) {
        if (ZeusPlatformUtils.hasInitZeus) {
            ZeusPlatformUtils.fetchPlugin("com.byted.live.lite");
        } else {
            ZeusPlatformUtils.initZeus(application, z4, "com.byted.live.lite");
        }
        initLive(application, str, builder, iLiveInitCallback, z5);
    }

    public static void initLive(final Application application, final String str, final ILiveHostContextParam.Builder builder, final ILiveInitCallback iLiveInitCallback, final boolean z4) {
        runInLiveProcess = z4;
            ...
            public void run() {
                ...
                if (LivePluginHelper.prepare(new Runnable() { // from class: com.bytedance.android.openliveplugin.LivePluginHelper.2.1
                    ...
                    public void run() {
                        ...
                        LivePluginHelper.realInitLivePlugin(application, str, builder, iLiveInitCallback, z4);
                    }
                })) {
    ...
    public static boolean prepare(Runnable runnable) {
        ...
        ZeusPlatformUtils.registerZeusPluginLoadStateListener("com.byted.live.lite", new PluginStateListener() { // from class: com.bytedance.android.openliveplugin.LivePluginHelper.4
            @Override // com.bytedance.android.dy.sdk.pangle.PluginStateListener
            public void onPluginStateChanged(int i5, String str) {
                if (i5 != 6 || LivePluginHelper.sInstallCallback == null) {
                    return;
                }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static void realInitLivePlugin(final Application application, final String str, final ILiveHostContextParam.Builder builder, final ILiveInitCallback iLiveInitCallback, final boolean z4) {
        sExecutor.execute(new Runnable() { // from class: com.bytedance.android.openliveplugin.LivePluginHelper.1
            ...
            public void run() {
                ...
                LiveReflectFacade.initLiveInPlugin(application, str, builder, z4, LiveInitCallback.INSTANCE);
            }
        });
    }

    public static void setApmEnable(boolean z4) {
        ZeusPlatformUtils.setApmEnable(z4);
    }
    ...
    public static void setHostVersionCodeTag(long j5) {
        ZeusPlatformUtils.setHostVersionCodeTag(j5);
    }
    ...
    public static void setStopAppLogOnEnterBackground(boolean z4) {
        stopAppLogOnEnterBackground = z4;
    }
