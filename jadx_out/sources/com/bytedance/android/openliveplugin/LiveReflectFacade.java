...
public class LiveReflectFacade {
    ...
    public static void initLiveInPlugin(Application application, String str, ILiveHostContextParam.Builder builder, boolean z4, ILiveInitCallback iLiveInitCallback) {
        JavaCallsUtils.callStaticMethodWithClassLoader("com.bytedance.android.openlive.plugin.LivePluginFacade", "initLiveInPlugin", ZeusPlatformUtils.getPluginClassloader("com.byted.live.lite"), application, str, builder, Boolean.valueOf(z4), iLiveInitCallback);
    }
