...
public final class d implements Bridge {
    ...
    private static volatile d f4964a;

    /* renamed from: b, reason: collision with root package name */
    private final Context f4965b;

    /* renamed from: c, reason: collision with root package name */
    private AdDownloadModel.Builder f4966c;

    /* renamed from: d, reason: collision with root package name */
    private AdDownloadModel f4967d;

    /* renamed from: e, reason: collision with root package name */
    private AdDownloadController.Builder f4968e;

    /* renamed from: f, reason: collision with root package name */
    private AdDownloadController f4969f;

    /* renamed from: g, reason: collision with root package name */
    private AdDownloadEventConfig.Builder f4970g;

    /* renamed from: h, reason: collision with root package name */
    private AdDownloadEventConfig f4971h;
    ...
    private int av() {
        AdDownloadController adDownloadController = this.f4969f;
    ...
    private void b(Map<String, Object> map) {
        ...
        AdDownloadModel.Builder a5 = a(((Long) map.get("id")).longValue(), (String) map.get(TTDownloadField.TT_APP_ICON), ((Boolean) map.get(TTDownloadField.TT_IS_SHOW_NOTIFICATION)).booleanValue(), ((Boolean) map.get(TTDownloadField.TT_IS_AUTO_INSTALL_WITHOUT_NOTIFICATION)).booleanValue(), (String) map.get(TTDownloadField.TT_LOG_EXTRA), (JSONObject) map.get(TTDownloadField.TT_EXTRA_JSON), (JSONObject) map.get(TTDownloadField.TT_DOWNLOAD_SETTINGS), (String) map.get(TTDownloadField.TT_FILE_PATH), (String) map.get(TTDownloadField.TT_DOWNLOAD_URL), (String) map.get(TTDownloadField.TT_APP_NAME), (String) map.get(TTDownloadField.TT_PACKAGE_NAME), ((Boolean) map.get(TTDownloadField.TT_IS_NEED_INDEPENDENT_PROCESS)).booleanValue(), (String) map.get(TTDownloadField.TT_OPEN_URL), (String) map.get(TTDownloadField.TT_WEB_TITLE), (String) map.get(TTDownloadField.TT_WEB_URL));
        this.f4966c = a5;
        this.f4967d = a5.build();
    }
    ...
    public int A() {
        AdDownloadEventConfig adDownloadEventConfig = this.f4971h;
    ...
    public long F() {
        AdDownloadModel adDownloadModel = this.f4967d;
    ...
    public ValueSet values() {
        return com.bykv.a.a.a.a.b.a().h(0, c.f4940a).g(1, Boolean.valueOf(c.f4941b)).e(10000, 3).k();
    }
    ...
    private void d(Map<String, Object> map) {
        ...
        this.f4970g = isEnableV3Event;
        if (jSONObject != null) {
            isEnableV3Event.setExtraEventObject(jSONObject);
        }
        this.f4971h = this.f4970g.build();
    }
    ...
    private void f(int i5) {
        ...
        adDownloadController.setDownloadMode(i5);
    }
    ...
    private void c(Map<String, Object> map) {
        ...
        this.f4968e = enableOppoAutoDownload;
        this.f4969f = enableOppoAutoDownload.build();
    }
    ...
    private void f(Map<String, Object> map) {
        ...
        com.ss.android.download.api.model.d a5 = new d.a().a(str6).b((String) map.get(TTDownloadField.TT_QUICK_APP_MODEL_EXTRA_DATA)).a();
        ...
        AdDownloadModel.Builder fileUriProvider = new AdDownloadModel.Builder().setExpectFileLength(longValue).setMd5(str).setId(longValue3).setExtraValue(longValue2).setIsAd(booleanValue).setModelType(intValue).setLogExtra(str10).setAppIcon(str9).setBackupUrls(list2).setNotificationJumpUrl(str2).setClickTrackUrl(list).setMimeType(str3).setHeaders(map2).setIsShowToast(booleanValue2).setIsShowNotification(booleanValue7).setNeedWifi(booleanValue3).setFileName(str4).setVersionCode(intValue2).setVersionName(str5).setQuickAppModel(a5).setAutoInstallWithoutNotification(booleanValue8).setExecutorGroup(intValue3).setStartToast(str7).setSdkMonitorScene(str8).setAutoInstall(booleanValue4).setDistinctDir(booleanValue5).setEnablePause(booleanValue6).setExtra(jSONObject).setFileUriProvider(new IDownloadFileUriProvider() { // from class: com.bytedance.sdk.openadsdk.downloadnew.d.2
        ...
        this.f4967d = this.f4966c.build();
    }

    public <T> T a(Class<T> cls, int i5, Map<String, Object> map) {
        DownloadModel d5;
        DownloadModel d6;
        DownloadEventConfig e5;
        DownloadController f5;
        DownloadModel d7;
        DownloadEventConfig e6;
        DownloadController f6;
        DownloadEventConfig e7;
        DownloadController f7;
        DownloadEventConfig e8;
        DownloadController f8;
        switch (i5) {
            case 0:
                return (T) Boolean.valueOf(c.a(g(map.get("activity")), h(map.get(TTDownloadField.TT_EXIT_INSTALL_LISTENER))));
            case 1:
                return (T) c.a().f();
            case 2:
                try {
            ...
            case 5:
                ...
                AdDownloadModel adDownloadModel2 = this.f4967d;
                if (adDownloadModel2 == null) {
                    d5 = d(map.get(TTDownloadField.TT_DOWNLOAD_MODEL));
                } else {
                    d5 = d(adDownloadModel2);
                }
                c.a().a(this.f4965b, intValue, c(map.get(TTDownloadField.TT_DOWNLOAD_STATUSCHANGE_LISTENER)), d5);
                return null;
            case 6:
                AdDownloadModel adDownloadModel3 = this.f4967d;
                return (T) Boolean.valueOf(c.a(this.f4965b, adDownloadModel3 == null ? (String) map.get(TTDownloadField.TT_DOWNLOAD_URL) : adDownloadModel3.getDownloadUrl()));
            case 7:
                c.b();
                return null;
            case 8:
                AdDownloadModel adDownloadModel4 = this.f4967d;
            ...
            case 12:
                ...
                AdDownloadModel adDownloadModel5 = this.f4967d;
                if (adDownloadModel5 == null) {
                    d6 = d(map.get(TTDownloadField.TT_DOWNLOAD_MODEL));
                } else {
                    d6 = d(adDownloadModel5);
                }
                AdDownloadEventConfig adDownloadEventConfig = this.f4971h;
                if (adDownloadEventConfig == null) {
                    e5 = e(map.get(TTDownloadField.TT_DOWNLOAD_EVENT_CONFIG));
                } else {
                    e5 = e(adDownloadEventConfig);
                }
                AdDownloadController adDownloadController = this.f4969f;
                if (adDownloadController == null) {
                    f5 = f(map.get(TTDownloadField.TT_DOWNLOAD_CONTROLLER));
                } else {
                    f5 = f(adDownloadController);
                }
                IDownloadButtonClickListener j5 = j(map.get(TTDownloadField.TT_DOWNLOAD_BUTTON_CLICK_LISTENER));
                if (a(j5)) {
                    return (T) Boolean.valueOf(c.a(this.f4965b, uri, d6, e5, f5, j5));
                }
                return (T) Boolean.valueOf(c.a(this.f4965b, uri, d6, e5, f5));
            case 13:
                ...
                AdDownloadModel adDownloadModel6 = this.f4967d;
                if (adDownloadModel6 == null) {
                    d7 = d(map.get(TTDownloadField.TT_DOWNLOAD_MODEL));
                } else {
                    d7 = d(adDownloadModel6);
                }
                DownloadModel downloadModel = d7;
                AdDownloadEventConfig adDownloadEventConfig2 = this.f4971h;
                if (adDownloadEventConfig2 == null) {
                    e6 = e(map.get(TTDownloadField.TT_DOWNLOAD_EVENT_CONFIG));
                } else {
                    e6 = e(adDownloadEventConfig2);
                }
                DownloadEventConfig downloadEventConfig = e6;
                AdDownloadController adDownloadController2 = this.f4969f;
                if (adDownloadController2 == null) {
                    f6 = f(map.get(TTDownloadField.TT_DOWNLOAD_CONTROLLER));
                } else {
                    f6 = f(adDownloadController2);
                }
                DownloadController downloadController = f6;
                DownloadStatusChangeListener c5 = c(map.get(TTDownloadField.TT_DOWNLOAD_STATUSCHANGE_LISTENER));
                IDownloadButtonClickListener j6 = j(map.get(TTDownloadField.TT_DOWNLOAD_BUTTON_CLICK_LISTENER));
                if (a(j6)) {
                    c.a().e().a(this.f4965b, str, booleanValue, downloadModel, downloadEventConfig, downloadController, c5, intValue2, j6);
                    return null;
                }
                c.a().e().a(this.f4965b, str, booleanValue, downloadModel, downloadEventConfig, downloadController, c5, intValue2);
                return null;
            case 14:
                AdDownloadModel adDownloadModel7 = this.f4967d;
                long longValue = adDownloadModel7 == null ? ((Long) map.get("id")).longValue() : adDownloadModel7.getId();
                AdDownloadModel adDownloadModel8 = this.f4967d;
                return (T) Boolean.valueOf(c.a().e().a(this.f4965b, longValue, adDownloadModel8 == null ? (String) map.get(TTDownloadField.TT_LOG_EXTRA) : adDownloadModel8.getLogExtra(), (DownloadStatusChangeListener) null, ((Integer) map.get(TTDownloadField.TT_HASHCODE)).intValue()));
            case 15:
                return (T) Boolean.valueOf(c.a((Uri) map.get("uri")));
            case 16:
                AdDownloadModel adDownloadModel9 = this.f4967d;
                String downloadUrl = adDownloadModel9 == null ? (String) map.get(TTDownloadField.TT_DOWNLOAD_URL) : adDownloadModel9.getDownloadUrl();
                AdDownloadModel adDownloadModel10 = this.f4967d;
                ...
                AdDownloadEventConfig adDownloadEventConfig3 = this.f4971h;
                if (adDownloadEventConfig3 == null) {
                    e7 = e(map.get(TTDownloadField.TT_DOWNLOAD_EVENT_CONFIG));
                } else {
                    e7 = e(adDownloadEventConfig3);
                }
                DownloadEventConfig downloadEventConfig2 = e7;
                AdDownloadController adDownloadController3 = this.f4969f;
                if (adDownloadController3 == null) {
                    f7 = f(map.get(TTDownloadField.TT_DOWNLOAD_CONTROLLER));
                } else {
                    f7 = f(adDownloadController3);
                }
                c.a().a(downloadUrl, longValue2, intValue3, downloadEventConfig2, f7);
                return null;
            case 17:
                AdDownloadModel adDownloadModel11 = this.f4967d;
                ...
                AdDownloadEventConfig adDownloadEventConfig4 = this.f4971h;
                if (adDownloadEventConfig4 == null) {
                    e8 = e(map.get(TTDownloadField.TT_DOWNLOAD_EVENT_CONFIG));
                } else {
                    e8 = e(adDownloadEventConfig4);
                }
                DownloadEventConfig downloadEventConfig3 = e8;
                AdDownloadController adDownloadController4 = this.f4969f;
                if (adDownloadController4 == null) {
                    f8 = f(map.get(TTDownloadField.TT_DOWNLOAD_CONTROLLER));
                } else {
                    f8 = f(adDownloadController4);
                }
                c.a().a(downloadUrl2, longValue3, intValue4, downloadEventConfig3, f8, i(map.get(TTDownloadField.TT_ITEM_CLICK_LISTENER)), j(map.get(TTDownloadField.TT_DOWNLOAD_BUTTON_CLICK_LISTENER)));
                return null;
            case 18:
                AdDownloadModel adDownloadModel12 = this.f4967d;
            ...
            case 19:
                AdDownloadModel adDownloadModel13 = this.f4967d;
            ...
            case 23:
                if (((Boolean) map.get(TTDownloadField.TT_MATE_IS_EMPTY)).booleanValue()) {
                    ...
                    this.f4966c = builder;
                    this.f4967d = builder.build();
                    return null;
                }
                b(map);
                return null;
            case 24:
                a((String) map.get(TTDownloadField.TT_APP_ICON), (String) map.get(TTDownloadField.TT_APP_NAME), (String) map.get(TTDownloadField.TT_PACKAGE_NAME));
                return null;
            case 25:
            ...
            case 123:
                e((String) map.get(TTDownloadField.TT_MD5));
                return null;
            case 124:
            ...
            case 127:
                ...
                return null;
            case 128:
                f((String) map.get(TTDownloadField.TT_APP_NAME));
                return null;
            case 129:
            ...
            case 135:
                ...
                return null;
            case 136:
                j((String) map.get(TTDownloadField.TT_PACKAGE_NAME));
                return null;
            case 137:
    ...
    public AdDownloadModel g(boolean z4) {
        AdDownloadModel adDownloadModel = this.f4967d;
        if (adDownloadModel == null) {
            return null;
        }
    ...
    public AdDownloadModel h(boolean z4) {
        AdDownloadModel adDownloadModel = this.f4967d;
        if (adDownloadModel == null) {
            return null;
        }
    ...
    public AdDownloadModel i(boolean z4) {
        AdDownloadModel adDownloadModel = this.f4967d;
        if (adDownloadModel == null) {
            return null;
        }
    ...
    public void b(int i5) {
        ...
        adDownloadEventConfig.setDownloadScene(i5);
    }
    ...
    public void b(long j5) {
        ...
        adDownloadModel.setExtraValue(j5);
    }
    ...
    public AdDownloadModel d(int i5) {
        AdDownloadModel adDownloadModel = this.f4967d;
        if (adDownloadModel == null) {
            return null;
        }
        return adDownloadModel.setVersionCode(i5);
    }
    ...
    public AdDownloadModel e(int i5) {
        AdDownloadModel adDownloadModel = this.f4967d;
        if (adDownloadModel == null) {
            return null;
        }
        return adDownloadModel.setFunnelType(i5);
    }
    ...
    public AdDownloadModel c(long j5) {
        AdDownloadModel adDownloadModel = this.f4967d;
        if (adDownloadModel == null) {
            return null;
        }
        return adDownloadModel.setId(j5);
    }

    public AdDownloadModel c(int i5) {
        AdDownloadModel adDownloadModel = this.f4967d;
        if (adDownloadModel == null) {
            return null;
        }
        return adDownloadModel.setModelType(i5);
    }
    ...
    public AdDownloadModel f(boolean z4) {
        AdDownloadModel adDownloadModel = this.f4967d;
        if (adDownloadModel == null) {
            return null;
        }
    ...
    private AdDownloadModel.Builder a(long j5, String str, boolean z4, boolean z5, String str2, JSONObject jSONObject, JSONObject jSONObject2, String str3, String str4, String str5, String str6, boolean z6, String str7, String str8, String str9) {
        AdDownloadModel.Builder fileUriProvider = new AdDownloadModel.Builder().setAdId(j5).setAppIcon(str).setIsShowNotification(z4).setAutoInstallWithoutNotification(z5).setLogExtra(str2).setExtra(jSONObject).setDistinctDir(true).setIsAd(true).setFileUriProvider(new IDownloadFileUriProvider() { // from class: com.bytedance.sdk.openadsdk.downloadnew.d.1
            @Override // com.ss.android.socialbase.downloader.depend.IDownloadFileUriProvider
        ...
        fileUriProvider.setDeepLink(a(j5, str7, str8, str9));
        return fileUriProvider;
    }

    private DeepLink a(long j5, String str, String str2, String str3) {
    ...
    private void a(String str, String str2, String str3) {
        AdDownloadModel.Builder builder = this.f4966c;
        if (builder == null) {
            return;
        }
        this.f4967d = builder.setAppIcon(str).setAppName(str2).setPackageName(str3).build();
    }

    private void a(int i5, int i6, boolean z4, boolean z5, boolean z6) {
        AdDownloadController.Builder isAddToDownloadManage = new AdDownloadController.Builder().setLinkMode(i5).setDownloadMode(i6).setIsEnableBackDialog(true).setIsAddToDownloadManage(false);
        this.f4968e = isAddToDownloadManage;
        if (z4) {
            isAddToDownloadManage.setEnableAH(z5);
            this.f4968e.setEnableAM(z6);
        }
        this.f4969f = this.f4968e.build();
    }
    ...
    public void a(int i5) {
        ...
        adDownloadController.setLinkMode(i5);
    }
    ...
    private void a(boolean z4, Object obj) {
        AdDownloadController adDownloadController = this.f4969f;
        if (adDownloadController == null) {
            return;
        }
        try {
            ...
            this.f4969f.setEnableOppoAutoDownload(z4);
    ...
    public void a(long j5) {
        ...
        adDownloadModel.setExpectFileLength(j5);
    }
