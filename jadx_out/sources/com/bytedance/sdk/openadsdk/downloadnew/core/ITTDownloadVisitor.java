...
public interface ITTDownloadVisitor {
    ...
    void execute(int i5, String str, Map<String, Object> map, ITTHttpCallback iTTHttpCallback);

    void executeLogUpload(TTDownloadEventModel tTDownloadEventModel, boolean z4);
    ...
    void showDialogByDelegate(WeakReference<Context> weakReference, boolean z4, DialogBuilder dialogBuilder);

    AlertDialog showDialogBySelf(Activity activity, boolean z4, DialogBuilder dialogBuilder);
}
