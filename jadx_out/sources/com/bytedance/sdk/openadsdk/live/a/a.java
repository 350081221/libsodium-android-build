...
public class a implements IHostPermission {
    ...
    private TTCustomController f5018a;

    public a(TTCustomController tTCustomController) {
        if (tTCustomController == null) {
            this.f5018a = new TTCustomController() { // from class: com.bytedance.sdk.openadsdk.live.a.a.1
            };
        } else {
            this.f5018a = tTCustomController;
        }
    }

    @Override // com.bytedance.android.live.base.api.IHostPermission
    public boolean alist() {
        TTCustomController tTCustomController = this.f5018a;
        if (tTCustomController == null) {
            return false;
        }
