...
public class MediationSplashRequestInfoImpl implements Bridge {
    ...
    public <T> T call(int i5, ValueSet valueSet, Class<T> cls) {
        ...
        if (i5 == 8530) {
            IMediationSplashRequestInfo iMediationSplashRequestInfo2 = this.f5059a;
        ...
        if (i5 == 8532) {
            IMediationSplashRequestInfo iMediationSplashRequestInfo3 = this.f5059a;
        ...
        if (i5 == 8533) {
            IMediationSplashRequestInfo iMediationSplashRequestInfo4 = this.f5059a;
            if (iMediationSplashRequestInfo4 != null) {
                return (T) iMediationSplashRequestInfo4.getAppkey();
            }
            return null;
        }
        if (i5 == 8531 && (iMediationSplashRequestInfo = this.f5059a) != null) {
