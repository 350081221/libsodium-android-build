...
public class MediationUserInfoForSegmentImpl implements Bridge {
    ...
    public ValueSet values() {
        ...
        MediationConfigUserInfoForSegment mediationConfigUserInfoForSegment = this.f5062a;
        ...
        MediationConfigUserInfoForSegment mediationConfigUserInfoForSegment2 = this.f5062a;
        if (mediationConfigUserInfoForSegment2 != null) {
            i5 = mediationConfigUserInfoForSegment2.getAge();
        } else {
            i5 = 0;
        }
        create.add(8469, i5);
        MediationConfigUserInfoForSegment mediationConfigUserInfoForSegment3 = this.f5062a;
        String str5 = "";
        ...
        create.add(8470, str);
        MediationConfigUserInfoForSegment mediationConfigUserInfoForSegment4 = this.f5062a;
        ...
        MediationConfigUserInfoForSegment mediationConfigUserInfoForSegment5 = this.f5062a;
        ...
        MediationConfigUserInfoForSegment mediationConfigUserInfoForSegment6 = this.f5062a;
        ...
        MediationConfigUserInfoForSegment mediationConfigUserInfoForSegment7 = this.f5062a;
