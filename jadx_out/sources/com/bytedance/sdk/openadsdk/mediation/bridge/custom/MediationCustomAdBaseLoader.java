...
public abstract class MediationCustomAdBaseLoader implements IMediationAdLoader {
    ...
    public <T> T call(int i5, ValueSet valueSet, Class<T> cls) {
        ...
        return (T) callMethod(i5, valueSet, cls);
    }

    public final void callLoadFail(int i5, String str) {
        if (this.mGmAdLoader != null) {
            MediationValueSetBuilder create = MediationValueSetBuilder.create();
            create.add(8014, i5);
            create.add(8015, str);
    ...
    public abstract <T> T callMethod(int i5, ValueSet valueSet, Class<T> cls);
    ...
    public void receiveBidResult(boolean z4, double d5, int i5, @Nullable Map<String, Object> map) {
    }
