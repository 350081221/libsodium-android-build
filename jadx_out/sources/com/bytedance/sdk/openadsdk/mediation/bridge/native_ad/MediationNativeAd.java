...
public class MediationNativeAd implements Bridge {
    ...
    public String getAdm() {
        MediationAdLoaderImpl mediationAdLoaderImpl = this.f5219a;
    ...
    public boolean isClientBidding() {
        return this.f5219a.isClientBidding();
    }

    public boolean isExpress() {
        Bridge bridge = this.mGMAd;
        if (bridge != null) {
            return ((Boolean) bridge.call(o.a.f12711u, null, Boolean.class)).booleanValue();
        }
        return false;
    }

    public boolean isMultiBidding() {
        return this.f5219a.isMultiBidding();
    }

    public boolean isServerBidding() {
        return this.f5219a.isServerBidding();
    }
    ...
    public void notifyDislikeSelect(int i5, String str) {
        if (this.mGMAd != null) {
            MediationValueSetBuilder create = MediationValueSetBuilder.create();
            create.add(8038, i5);
            create.add(8039, str);
    ...
    public void notifyOnDownloadFailed(long j5, long j6, String str, String str2) {
        if (this.mGMAd != null) {
            MediationValueSetBuilder create = MediationValueSetBuilder.create();
            create.add(8062, j5);
            create.add(8063, j6);
    ...
    public void notifyOnDownloadFinished(long j5, String str, String str2) {
        if (this.mGMAd != null) {
            MediationValueSetBuilder create = MediationValueSetBuilder.create();
            create.add(8062, j5);
            create.add(8066, str);
    ...
    public void notifyOnDownloadPause(long j5, long j6, String str, String str2) {
        if (this.mGMAd != null) {
            MediationValueSetBuilder create = MediationValueSetBuilder.create();
            create.add(8062, j5);
            create.add(8063, j6);
    ...
    public void notifyOnProgressUpdate(long j5, long j6, int i5, int i6) {
        if (this.mGMAd != null) {
            MediationValueSetBuilder create = MediationValueSetBuilder.create();
            create.add(8062, j5);
            create.add(8063, j6);
    ...
    public void notifyOnVideoError(int i5, String str) {
        if (this.mGMAd != null) {
            MediationValueSetBuilder create = MediationValueSetBuilder.create();
            create.add(8014, i5);
            create.add(8015, str);
    ...
    public void notifyRenderFail(View view, int i5, String str) {
        if (this.mGMAd != null) {
            MediationValueSetBuilder create = MediationValueSetBuilder.create();
    ...
    public void notifyRenderSuccess(float f5, float f6) {
        if (this.mGMAd != null) {
            MediationValueSetBuilder create = MediationValueSetBuilder.create();
            create.add(8040, f5);
            create.add(8041, f6);
