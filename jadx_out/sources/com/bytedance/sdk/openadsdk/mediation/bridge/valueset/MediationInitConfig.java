...
public class MediationInitConfig {
    ...
    private ValueSet f5225a;

    /* renamed from: b, reason: collision with root package name */
    private ValueSet f5226b;

    /* renamed from: c, reason: collision with root package name */
    private ValueSet f5227c;

    private MediationInitConfig(ValueSet valueSet) {
        this.f5225a = valueSet;
        if (valueSet != null) {
            this.f5227c = (ValueSet) valueSet.objectValue(8457, ValueSet.class);
            this.f5226b = (ValueSet) this.f5225a.objectValue(8475, ValueSet.class);
        }
        a();
    }
    ...
    public String getADNName() {
        return e() ? this.f5225a.stringValue(8003) : "";
    }
    ...
    public String getAppId() {
        if (e()) {
            return this.f5225a.stringValue(3);
        }
        return null;
    }

    public String getAppKey() {
        return e() ? this.f5225a.stringValue(8005) : "";
    }
    ...
    public String getAppName() {
        return e() ? this.f5225a.stringValue(8) : "";
    }
    ...
    public String getClassName() {
        return e() ? this.f5225a.stringValue(8010) : "";
    }

    public Bridge getCustomGMConfiguration() {
        if (e()) {
            return (Bridge) this.f5225a.objectValue(8401, Bridge.class);
        }
        return null;
    }
    ...
    public MediationCustomInitConfig getCustomInitConfig() {
        if (e()) {
            return (MediationCustomInitConfig) this.f5225a.objectValue(8099, MediationCustomInitConfig.class);
        }
        return null;
    }
    ...
    public ValueSet getCustomInitConfigValueSet() {
        if (e()) {
            return (ValueSet) this.f5225a.objectValue(8545, ValueSet.class);
        }
        return null;
    }
    ...
    public Map getCustomInitMap() {
        if (e()) {
            return (Map) this.f5225a.objectValue(8400, Map.class);
        }
        return null;
    }

    public JSONObject getCustomLocalConfig() {
        ValueSet valueSet = this.f5227c;
        if (valueSet != null) {
    ...
    public Bridge getInitCallback() {
        if (e()) {
            return (Bridge) this.f5225a.objectValue(JosStatusCodes.RNT_CODE_NETWORK_ERROR, Bridge.class);
        }
        return null;
    }
    ...
    public boolean isCustom() {
        if (e()) {
            return this.f5225a.booleanValue(8098);
        }
        return false;
    }
