...
public abstract class MediationAdLoaderImpl implements IMediationAdLoader {
    ...
    public final void load(Context context, ValueSet valueSet) {
        ...
        if (extraObject != null && (extraObject.get("bidding_token") instanceof String)) {
            str = (String) extraObject.get("bidding_token");
        } else {
            str = "";
        }
        if (TextUtils.equals(str, "true")) {
            if (this.mGmAdLoader != null) {
                ...
                create2.add(8043, this);
                this.mGmAdLoader.call(8138, create2.build(), null);
                return;
            }
            return;
        }
    ...
    public void notifyAdCache(Bridge bridge, int i5, String str) {
        if (this.mGmAdLoader != null) {
    ...
    public void notifyAdFailed(int i5, String str) {
        if (this.mGmAdLoader != null) {
            MediationValueSetBuilder create = MediationValueSetBuilder.create();
            create.add(8014, i5);
            create.add(8015, str);
