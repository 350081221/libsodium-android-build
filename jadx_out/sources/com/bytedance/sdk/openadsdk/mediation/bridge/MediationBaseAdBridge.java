...
public abstract class MediationBaseAdBridge implements Bridge {
    ...
    public double getCpm() {
        ...
        Double d5 = null;
        if (bridge != null) {
            d5 = (Double) bridge.call(8143, null, Double.class);
        }
        if (d5 == null) {
            return 0.0d;
        }
    ...
    public Map<String, Object> getCustomData() {
        MediationAdSlotValueSet mediationAdSlotValueSet = this.f5167a;
    ...
    public void setImageMode(int i5) {
        if (this.mGMAd != null) {
            MediationValueSetBuilder create = MediationValueSetBuilder.create();
            create.add(8060, i5);
            this.mGMAd.call(o.a.A, create.build(), Void.class);
        }
    }
    ...
    public void setLevelTag(String str) {
        if (!TextUtils.isEmpty(str) && this.mGMAd != null) {
            MediationValueSetBuilder create = MediationValueSetBuilder.create();
            create.add(8058, str);
            this.mGMAd.call(o.a.f12716z, create.build(), Void.class);
        }
    }
