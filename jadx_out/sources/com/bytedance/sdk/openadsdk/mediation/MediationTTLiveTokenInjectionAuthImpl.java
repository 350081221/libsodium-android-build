...
public class MediationTTLiveTokenInjectionAuthImpl implements Bridge, ITTLiveTokenInjectionAuth {
    ...
    public <T> T call(int i5, ValueSet valueSet, Class<T> cls) {
        ...
        if (i5 == 8525 && (valueSet2 = (ValueSet) valueSet.objectValue(8526, ValueSet.class)) != null) {
    ...
    public TTLiveToken getTokenInfo() {
        ITTLiveTokenInjectionAuth iTTLiveTokenInjectionAuth = this.f5061a;
