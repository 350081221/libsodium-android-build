...
public interface TTRewardVideoAd extends TTClientBidding {
    ...
    public interface RewardAdInteractionListener {
        ...
        void onRewardArrived(boolean z4, int i5, Bundle bundle);

        @Deprecated
        void onRewardVerify(boolean z4, int i5, String str, int i6, String str2);
    ...
    public interface RewardAdPlayAgainController {
        ...
        void getPlayAgainCondition(int i5, Callback callback);
    }
    ...
    @Deprecated
    void setShowDownLoadBar(boolean z4);
