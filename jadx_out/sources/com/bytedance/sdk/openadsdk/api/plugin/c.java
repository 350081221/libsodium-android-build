...
final class c {
    ...
    private static SharedPreferences f4846b;

    /* renamed from: c, reason: collision with root package name */
    private static final List<Pair<String, JSONObject>> f4847c = new CopyOnWriteArrayList();

    /* renamed from: a, reason: collision with root package name */
    static final Map<String, String> f4845a = new HashMap();

    public static void b(String str, JSONObject jSONObject) {
        f4847c.add(new Pair<>(str, jSONObject));
    }
    ...
    public static JSONObject f(String str, JSONObject jSONObject) {
        String str2 = TTAdSdk.SDK_VERSION_NAME;
        JSONObject jSONObject2 = new JSONObject();
        try {
            jSONObject.put("os_api", Build.VERSION.SDK_INT);
            jSONObject.put("support_abi", Arrays.toString(Build.SUPPORTED_ABIS));
            jSONObject2.put("ad_sdk_version", TTAdSdk.SDK_VERSION_NAME);
            String a5 = e.a(TTAdSdk.BUILT_IN_PLUGIN_NAME);
    ...
    public static void a(int i5, String str, long j5) {
        ...
        try {
            jSONObject.putOpt("duration", Long.valueOf(j5));
            jSONObject.putOpt(PluginConstants.KEY_ERROR_CODE, Integer.valueOf(i5));
    ...
    public static void b(List<JSONObject> list) {
        ...
        if (f4846b == null) {
            f4846b = TTAppContextHolder.getContext().getSharedPreferences("tt_sdk_settings_other", 0);
        }
        String format = String.format("https://%s%s", f4846b.getString("url_stats", "api-access.pangolin-sdk-toutiao.com"), "/api/ad/union/sdk/stats/batch/");
        JSONObject jSONObject = new JSONObject();
        try {
            List<Pair<String, JSONObject>> list2 = f4847c;
            if (list2.size() > 0) {
    ...
    public static void a() {
        List<Pair<String, JSONObject>> list = f4847c;
        if (list.size() <= 0) {
            return;
        }
        try {
