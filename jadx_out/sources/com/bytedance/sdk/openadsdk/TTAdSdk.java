...
public final class TTAdSdk {
    ...
    public static final int SDK_VERSION_CODE = 6415;
    public static final String SDK_VERSION_NAME = "6.4.1.5";
    public static final String S_C = "main";

    /* renamed from: a, reason: collision with root package name */
    private static final a f4749a = new f();

    /* renamed from: b, reason: collision with root package name */
    private static volatile TTAdConfig f4750b;
    ...
    public static void start(Callback callback) {
        a(f4750b, "TTAdConfig is null, please exec TTAdSdk.init before TTAdSdk.start.");
        a aVar = f4749a;
        if (aVar == null) {
            callback.fail(4100, "Load initializer failed");
        } else {
            aVar.a(TTAppContextHolder.getContext(), f4750b, callback);
        }
    }

    public static void updateAdConfig(TTAdConfig tTAdConfig) {
        a.c b5;
        if (tTAdConfig == null || (b5 = f4749a.b()) == null) {
            return;
        }
        ...
        if (!bundle.keySet().isEmpty()) {
            b5.getExtra(ValueSet.class, bundle);
        }
