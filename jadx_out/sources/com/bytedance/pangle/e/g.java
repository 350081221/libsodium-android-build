...
public final class g {
    ...
    public static String a(String str, int i5) {
        ...
        for (int i6 = 1; i6 <= b5; i6++) {
            sb.append(new a(new File(com.bytedance.pangle.d.c.i(str, i5)), i6 == 1 ? "classes.dex" : "classes" + i6 + ".dex").getAbsolutePath());
            sb.append(":");
        }
        if (sb.length() != 0) {
    ...
    private static void a(Closeable closeable) {
        try {
            ...
            ZeusLogger.w(ZeusLogger.TAG_INSTALL, "Plugin-MultiDex Failed to close resource", e5);
        }
    }
