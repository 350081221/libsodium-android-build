...
public class a {
    ...
    private static Uri a(String str, Uri uri, String str2) {
        ...
        String a5 = b.a(pluginProcessNameByAuthority, str, uri);
        String encodeToString = TextUtils.isEmpty(a5) ? "" : Base64.encodeToString(a5.getBytes(), 10);
        return Uri.parse("content://" + ContentProviderManager.getInstance().getSystemProviderInfoMap().get(pluginProcessNameByAuthority).f4520b + File.separator + "proxy?provider_params=" + encodeToString);
    }
    ...
    public static Cursor a(ContentResolver contentResolver, Uri uri, String[] strArr, String str, String[] strArr2, String str2, String str3) {
        ...
        try {
            ...
            ZeusLogger.w(ZeusLogger.TAG_PROVIDER, "ContentProviderManager#query(5 params) throw exception:", e5);
            return null;
        }
    }
    ...
    public static String a(ContentResolver contentResolver, Uri uri, String str) {
        ...
        try {
            ...
            ZeusLogger.w(ZeusLogger.TAG_PROVIDER, "ContentProviderManager#getType throw exception:", e5);
            return null;
        }
    }
    ...
    public static Uri a(ContentResolver contentResolver, Uri uri, ContentValues contentValues, String str) {
        ...
        try {
            ...
            ZeusLogger.w(ZeusLogger.TAG_PROVIDER, "ContentProviderManager#insert throw exception:", e5);
            return null;
        }
    }
    ...
    public static int a(ContentResolver contentResolver, Uri uri, String str, String[] strArr, String str2) {
        ...
        try {
            ...
            ZeusLogger.w(ZeusLogger.TAG_PROVIDER, "ContentProviderManager#delete throw exception:", e5);
            return -1;
        }
    }
    ...
    public static int a(ContentResolver contentResolver, Uri uri, ContentValues contentValues, String str, String[] strArr, String str2) {
        ...
        try {
            ...
            ZeusLogger.w(ZeusLogger.TAG_PROVIDER, "ContentProviderManager#update throw exception:", e5);
            return 0;
        }
    }
        ...
        if (contentResolver != null && uri != null) {
            try {
                try {
                    ...
                    bundle.putString(ContentProviderManager.PROVIDER_PROXY_URI, a5.toString());
                    return contentResolver.call(a5, str, str2, bundle);
                } catch (Throwable th) {
    ...
    public static Bundle a(ContentResolver contentResolver, String str, String str2, String str3, Bundle bundle, String str4) {
        ...
        String str5 = ContentProviderManager.getInstance().getSystemProviderInfoMap().get(ContentProviderManager.getInstance().getPluginProcessNameByAuthority(str)).f4520b;
        if (bundle == null) {
            bundle = new Bundle();
        }
