...
public class ServiceManagerNative {
    ...
    public boolean bindServiceNative(Context context, Intent intent, final ServiceConnection serviceConnection, int i5, String str) {
        ...
        e a5 = b.a(queryServiceFromPlugin.processName);
        ...
        try {
            return a5.a(intent, this.serviceConn2ServiceConn.get(serviceConnection), i5, str);
