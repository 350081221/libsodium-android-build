...
public abstract class GenerateFragmentActivityWrapper extends FragmentActivity implements a {
    ...
    public PendingIntent createPendingResult(int i5, Intent intent, int i6) {
        return this.mOriginActivity.createPendingResult(i5, intent, i6);
    }
    ...
    public View findViewById(int i5) {
        return this.mOriginActivity.findViewById(i5);
    }
    ...
    public void finishActivity(int i5) {
        this.mOriginActivity.finishActivity(i5);
    }

    @Override // android.app.Activity
    public void finishActivityFromChild(Activity activity, int i5) {
        this.mOriginActivity.finishActivityFromChild(activity, i5);
    }
    ...
    public SharedPreferences getPreferences(int i5) {
        return this.mOriginActivity.getPreferences(i5);
    }
    ...
    public boolean moveTaskToBack(boolean z4) {
        return this.mOriginActivity.moveTaskToBack(z4);
    }
    ...
    public void onActivityReenter(int i5, Intent intent) {
        this.mOriginActivity.onActivityReenter(i5, intent);
    }
    ...
    public boolean onCreatePanelMenu(int i5, Menu menu) {
        return this.mOriginActivity.onCreatePanelMenu(i5, menu);
    }

    @Override // android.app.Activity, android.view.Window.Callback
    public View onCreatePanelView(int i5) {
        return this.mOriginActivity.onCreatePanelView(i5);
    }
    ...
    public boolean onKeyDown(int i5, KeyEvent keyEvent) {
        return this.mOriginActivity.onKeyDown(i5, keyEvent);
    }

    @Override // android.app.Activity, android.view.KeyEvent.Callback
    public boolean onKeyLongPress(int i5, KeyEvent keyEvent) {
        return this.mOriginActivity.onKeyLongPress(i5, keyEvent);
    }

    @Override // android.app.Activity, android.view.KeyEvent.Callback
    public boolean onKeyMultiple(int i5, int i6, KeyEvent keyEvent) {
        return this.mOriginActivity.onKeyMultiple(i5, i6, keyEvent);
    }

    @Override // android.app.Activity
    public boolean onKeyShortcut(int i5, KeyEvent keyEvent) {
        return this.mOriginActivity.onKeyShortcut(i5, keyEvent);
    }

    @Override // android.app.Activity, android.view.KeyEvent.Callback
    public boolean onKeyUp(int i5, KeyEvent keyEvent) {
        return this.mOriginActivity.onKeyUp(i5, keyEvent);
    }
    ...
    public boolean onMenuItemSelected(int i5, MenuItem menuItem) {
        return this.mOriginActivity.onMenuItemSelected(i5, menuItem);
    }

    @Override // android.app.Activity, android.view.Window.Callback
    public boolean onMenuOpened(int i5, Menu menu) {
        return this.mOriginActivity.onMenuOpened(i5, menu);
    }

    @Override // androidx.activity.ComponentActivity, android.app.Activity
    public void onMultiWindowModeChanged(boolean z4, Configuration configuration) {
        this.mOriginActivity.onMultiWindowModeChanged(z4, configuration);
    }
    ...
    public void onPanelClosed(int i5, Menu menu) {
        this.mOriginActivity.onPanelClosed(i5, menu);
    }
    ...
    public void onPictureInPictureModeChanged(boolean z4, Configuration configuration) {
        this.mOriginActivity.onPictureInPictureModeChanged(z4, configuration);
    }
    ...
    public boolean onPreparePanel(int i5, View view, Menu menu) {
        return this.mOriginActivity.onPreparePanel(i5, view, menu);
    }
    ...
    public void onProvideKeyboardShortcuts(List list, Menu menu, int i5) {
        this.mOriginActivity.onProvideKeyboardShortcuts(list, menu, i5);
    }
    ...
    public void onRequestPermissionsResult(int i5, String[] strArr, int[] iArr) {
        this.mOriginActivity.onRequestPermissionsResult(i5, strArr, iArr);
    }
    ...
    public void onTopResumedActivityChanged(boolean z4) {
        this.mOriginActivity.onTopResumedActivityChanged(z4);
    }
    ...
    public void onTrimMemory(int i5) {
        this.mOriginActivity.onTrimMemory(i5);
    }
    ...
    public void onWindowFocusChanged(boolean z4) {
        this.mOriginActivity.onWindowFocusChanged(z4);
    }
    ...
    public void overridePendingTransition(int i5, int i6) {
        this.mOriginActivity.overridePendingTransition(i5, i6);
    }
    ...
    public boolean requestVisibleBehind(boolean z4) {
        return this.mOriginActivity.requestVisibleBehind(z4);
    }
    ...
    public void setContentView(int i5) {
        this.mOriginActivity.setContentView(i5);
    }
    ...
    public void setFinishOnTouchOutside(boolean z4) {
        this.mOriginActivity.setFinishOnTouchOutside(z4);
    }

    @Override // android.app.Activity
    public void setImmersive(boolean z4) {
        this.mOriginActivity.setImmersive(z4);
    }

    @Override // android.app.Activity
    public void setInheritShowWhenLocked(boolean z4) {
        this.mOriginActivity.setInheritShowWhenLocked(z4);
    }
    ...
    public void setRequestedOrientation(int i5) {
        this.mOriginActivity.setRequestedOrientation(i5);
    }

    @Override // android.app.Activity
    public void setShowWhenLocked(boolean z4) {
        this.mOriginActivity.setShowWhenLocked(z4);
    }
    ...
    public void setTheme(int i5) {
        this.mOriginActivity.setTheme(i5);
    }
    ...
    public void setTitleColor(int i5) {
        this.mOriginActivity.setTitleColor(i5);
    }

    @Override // android.app.Activity
    public boolean setTranslucent(boolean z4) {
        return this.mOriginActivity.setTranslucent(z4);
    }

    @Override // android.app.Activity
    public void setTurnScreenOn(boolean z4) {
        this.mOriginActivity.setTurnScreenOn(z4);
    }

    @Override // android.app.Activity
    public void setVisible(boolean z4) {
        this.mOriginActivity.setVisible(z4);
    }

    @Override // android.app.Activity
    public void setVrModeEnabled(boolean z4, ComponentName componentName) {
        this.mOriginActivity.setVrModeEnabled(z4, componentName);
    }

    @Override // com.bytedance.pangle.wrapper.a
    public void setWrapperActivityTheme(int i5) {
        try {
            super.setTheme(i5);
    ...
    public void startActivityForResult(Intent intent, int i5) {
        this.mOriginActivity.startActivityForResult(intent, i5);
    }

    @Override // android.app.Activity
    public void startActivityFromChild(Activity activity, Intent intent, int i5) {
        this.mOriginActivity.startActivityFromChild(activity, intent, i5);
    }

    @Override // android.app.Activity
    public void startActivityFromFragment(Fragment fragment, Intent intent, int i5) {
        this.mOriginActivity.startActivityFromFragment(fragment, intent, i5);
    }

    @Override // android.app.Activity
    public boolean startActivityIfNeeded(Intent intent, int i5) {
        return this.mOriginActivity.startActivityIfNeeded(intent, i5);
    }

    @Override // android.app.Activity, android.content.ContextWrapper, android.content.Context
    public void startIntentSender(IntentSender intentSender, Intent intent, int i5, int i6, int i7) {
        this.mOriginActivity.startIntentSender(intentSender, intent, i5, i6, i7);
    }

    @Override // androidx.activity.ComponentActivity, android.app.Activity
    public void startIntentSenderForResult(IntentSender intentSender, int i5, Intent intent, int i6, int i7, int i8) {
        this.mOriginActivity.startIntentSenderForResult(intentSender, i5, intent, i6, i7, i8);
    }
    ...
    public void startIntentSenderFromChild(Activity activity, IntentSender intentSender, int i5, Intent intent, int i6, int i7, int i8) {
        this.mOriginActivity.startIntentSenderFromChild(activity, intentSender, i5, intent, i6, i7, i8);
    }

    @Override // androidx.fragment.app.FragmentActivity
    public void startIntentSenderFromFragment(androidx.fragment.app.Fragment fragment, IntentSender intentSender, int i5, Intent intent, int i6, int i7, int i8, Bundle bundle) {
        this.mOriginActivity.startIntentSenderFromFragment(fragment, intentSender, i5, intent, i6, i7, i8, bundle);
    }
    ...
    public void startSearch(String str, boolean z4, Bundle bundle, boolean z5) {
        this.mOriginActivity.startSearch(str, z4, bundle, z5);
    }
    ...
    public void takeKeyEvents(boolean z4) {
        this.mOriginActivity.takeKeyEvents(z4);
    }
    ...
    public void onMultiWindowModeChanged(boolean z4) {
        this.mOriginActivity.onMultiWindowModeChanged(z4);
    }

    @Override // androidx.activity.ComponentActivity, android.app.Activity
    public void onPictureInPictureModeChanged(boolean z4) {
        this.mOriginActivity.onPictureInPictureModeChanged(z4);
    }
    ...
    public ActionMode onWindowStartingActionMode(ActionMode.Callback callback, int i5) {
        return this.mOriginActivity.onWindowStartingActionMode(callback, i5);
    }
    ...
    public void setTitle(int i5) {
        this.mOriginActivity.setTitle(i5);
    }

    @Override // android.app.Activity
    public ActionMode startActionMode(ActionMode.Callback callback, int i5) {
        return this.mOriginActivity.startActionMode(callback, i5);
    }
    ...
    public void startActivityForResult(Intent intent, int i5, Bundle bundle) {
        this.mOriginActivity.startActivityForResult(intent, i5, bundle);
    }

    @Override // android.app.Activity
    public void startActivityFromChild(Activity activity, Intent intent, int i5, Bundle bundle) {
        this.mOriginActivity.startActivityFromChild(activity, intent, i5, bundle);
    }

    @Override // android.app.Activity
    public void startActivityFromFragment(Fragment fragment, Intent intent, int i5, Bundle bundle) {
        this.mOriginActivity.startActivityFromFragment(fragment, intent, i5, bundle);
    }

    @Override // android.app.Activity
    public boolean startActivityIfNeeded(Intent intent, int i5, Bundle bundle) {
        return this.mOriginActivity.startActivityIfNeeded(intent, i5, bundle);
    }

    @Override // android.app.Activity, android.content.ContextWrapper, android.content.Context
    public void startIntentSender(IntentSender intentSender, Intent intent, int i5, int i6, int i7, Bundle bundle) {
        this.mOriginActivity.startIntentSender(intentSender, intent, i5, i6, i7, bundle);
    }

    @Override // androidx.activity.ComponentActivity, android.app.Activity
    public void startIntentSenderForResult(IntentSender intentSender, int i5, Intent intent, int i6, int i7, int i8, Bundle bundle) {
        this.mOriginActivity.startIntentSenderForResult(intentSender, i5, intent, i6, i7, i8, bundle);
    }
    ...
    public void startIntentSenderFromChild(Activity activity, IntentSender intentSender, int i5, Intent intent, int i6, int i7, int i8, Bundle bundle) {
        this.mOriginActivity.startIntentSenderFromChild(activity, intentSender, i5, intent, i6, i7, i8, bundle);
    }
    ...
    @Override // androidx.fragment.app.FragmentActivity
    public void startActivityFromFragment(androidx.fragment.app.Fragment fragment, Intent intent, int i5) {
        this.mOriginActivity.startActivityFromFragment(fragment, intent, i5);
    }

    @Override // androidx.fragment.app.FragmentActivity
    public void startActivityFromFragment(androidx.fragment.app.Fragment fragment, Intent intent, int i5, Bundle bundle) {
        this.mOriginActivity.startActivityFromFragment(fragment, intent, i5, bundle);
    }
}
