...
public final class c {
    ...
    public static void a(b bVar, Bundle bundle) {
        ...
        if (plugin.isLoaded() && !TextUtils.isEmpty(stringExtra)) {
            ...
            try {
                ...
                i5 = activityInfo.theme;
                bVar.zeusSuperSetTheme(i5);
                ...
                try {
                    ...
                    if (requestedOrientation != i6) {
                        ((Activity) bVar).setRequestedOrientation(i6);
                    }
                ...
                throw new RuntimeException(e5 instanceof IllegalStateException ? "activityTheme:".concat(String.valueOf(i5)) : "", e5);
            }
        }
        try {
            bVar.zeusSuperOnCreate(null);
    ...
    public static void a(Activity activity, View view) {
        ...
        while (true) {
            ...
            a(activity, viewGroup.getChildAt(i5));
            i5++;
        }
    }
