...
public class IntentUtils {
    ...
    static HashMap<Long, WeakReference<Bundle>> f4256a = new HashMap<>();
    ...
    public static void a(Intent intent, String str) {
        ...
        if (longExtra != 0) {
            ...
            f4256a.put(Long.valueOf(longExtra), new WeakReference<>(extras));
    ...
    public static void a(Intent intent) {
        long longExtra = intent.getLongExtra("pangle_use_memory", 0L);
        if (longExtra != 0) {
            WeakReference<Bundle> remove = f4256a.remove(Long.valueOf(longExtra));
