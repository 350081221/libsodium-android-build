...
public abstract class GenerateProxyAppCompatActivity extends AppCompatActivity implements b {
    ...
    @Override // android.app.Activity
    public PendingIntent createPendingResult(int i5, Intent intent, int i6) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            return generatePluginAppCompatActivity.createPendingResult(i5, intent, i6);
        }
        return super.createPendingResult(i5, intent, i6);
    }
    ...
    public View findViewById(int i5) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            return generatePluginAppCompatActivity.findViewById(i5);
        }
    ...
    public void finishActivity(int i5) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.finishActivity(i5);
        } else {
    ...
    @Override // android.app.Activity
    public void finishActivityFromChild(Activity activity, int i5) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.finishActivityFromChild(activity, i5);
        } else {
            super.finishActivityFromChild(activity, i5);
        }
    }
    ...
    public SharedPreferences getPreferences(int i5) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            return generatePluginAppCompatActivity.getPreferences(i5);
        }
        return super.getPreferences(i5);
    }
    ...
    public boolean moveTaskToBack(boolean z4) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            return generatePluginAppCompatActivity.moveTaskToBack(z4);
        }
    ...
    public void onActivityReenter(int i5, Intent intent) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.onActivityReenter(i5, intent);
        } else {
    ...
    public void onActivityResult(int i5, int i6, Intent intent) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.onActivityResult(i5, i6, intent);
        } else {
    ...
    protected void onApplyThemeResource(Resources.Theme theme, int i5, boolean z4) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.onApplyThemeResource(theme, i5, z4);
        } else {
            super.onApplyThemeResource(theme, i5, z4);
        }
    }
    ...
    protected Dialog onCreateDialog(int i5) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            return generatePluginAppCompatActivity.onCreateDialog(i5);
        }
    ...
    public boolean onCreatePanelMenu(int i5, Menu menu) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            return generatePluginAppCompatActivity.onCreatePanelMenu(i5, menu);
        }
    ...
    public View onCreatePanelView(int i5) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            return generatePluginAppCompatActivity.onCreatePanelView(i5);
        }
    ...
    public boolean onKeyDown(int i5, KeyEvent keyEvent) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            return generatePluginAppCompatActivity.onKeyDown(i5, keyEvent);
        }
    ...
    public boolean onKeyLongPress(int i5, KeyEvent keyEvent) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            return generatePluginAppCompatActivity.onKeyLongPress(i5, keyEvent);
        }
    ...
    public boolean onKeyMultiple(int i5, int i6, KeyEvent keyEvent) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            return generatePluginAppCompatActivity.onKeyMultiple(i5, i6, keyEvent);
        }
    ...
    public boolean onKeyShortcut(int i5, KeyEvent keyEvent) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            return generatePluginAppCompatActivity.onKeyShortcut(i5, keyEvent);
        }
    ...
    public boolean onKeyUp(int i5, KeyEvent keyEvent) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            return generatePluginAppCompatActivity.onKeyUp(i5, keyEvent);
        }
    ...
    public boolean onMenuOpened(int i5, Menu menu) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            return generatePluginAppCompatActivity.onMenuOpened(i5, menu);
        }
    ...
    public void onMultiWindowModeChanged(boolean z4) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.onMultiWindowModeChanged(z4);
        } else {
    ...
    public void onPanelClosed(int i5, Menu menu) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.onPanelClosed(i5, menu);
        } else {
    ...
    public void onPictureInPictureModeChanged(boolean z4) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.onPictureInPictureModeChanged(z4);
        } else {
    ...
    protected void onPrepareDialog(int i5, Dialog dialog) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.onPrepareDialog(i5, dialog);
        } else {
    ...
    public boolean onPreparePanel(int i5, View view, Menu menu) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            return generatePluginAppCompatActivity.onPreparePanel(i5, view, menu);
        }
    ...
    public void onProvideKeyboardShortcuts(List list, Menu menu, int i5) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.onProvideKeyboardShortcuts(list, menu, i5);
        } else {
    ...
    public void onRequestPermissionsResult(int i5, String[] strArr, int[] iArr) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.onRequestPermissionsResult(i5, strArr, iArr);
        } else {
    ...
    public void onTitleChanged(CharSequence charSequence, int i5) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.onTitleChanged(charSequence, i5);
        } else {
    ...
    public void onTopResumedActivityChanged(boolean z4) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.onTopResumedActivityChanged(z4);
        } else {
    ...
    public void onTrimMemory(int i5) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.onTrimMemory(i5);
        } else {
    ...
    public void onWindowFocusChanged(boolean z4) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.onWindowFocusChanged(z4);
        } else {
    ...
    public void overridePendingTransition(int i5, int i6) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.overridePendingTransition(i5, i6);
        } else {
    ...
    @Override // android.app.Activity
    public boolean requestVisibleBehind(boolean z4) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            return generatePluginAppCompatActivity.requestVisibleBehind(z4);
        }
        return super.requestVisibleBehind(z4);
    }
    ...
    public void setContentView(int i5) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.setContentView(i5);
        } else {
    ...
    @Override // android.app.Activity
    public void setFinishOnTouchOutside(boolean z4) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.setFinishOnTouchOutside(z4);
        } else {
            super.setFinishOnTouchOutside(z4);
        }
    }

    @Override // android.app.Activity
    public void setImmersive(boolean z4) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.setImmersive(z4);
        } else {
            super.setImmersive(z4);
        }
    }

    @Override // android.app.Activity
    public void setInheritShowWhenLocked(boolean z4) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.setInheritShowWhenLocked(z4);
        } else {
            super.setInheritShowWhenLocked(z4);
        }
    }
    ...
    public void setRequestedOrientation(int i5) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.setRequestedOrientation(i5);
        } else {
    ...
    public void setShowWhenLocked(boolean z4) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.setShowWhenLocked(z4);
        } else {
    ...
    public void setTheme(int i5) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.setTheme(i5);
        } else {
            super.setTheme(i5);
        }
    }
    ...
    public void setTitle(int i5) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.setTitle(i5);
        } else {
            super.setTitle(i5);
        }
    }
    ...
    public void setTitleColor(int i5) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.setTitleColor(i5);
        } else {
            super.setTitleColor(i5);
        }
    }
    ...
    public boolean setTranslucent(boolean z4) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            return generatePluginAppCompatActivity.setTranslucent(z4);
        }
    ...
    public void setTurnScreenOn(boolean z4) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.setTurnScreenOn(z4);
        } else {
    ...
    public void setVisible(boolean z4) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.setVisible(z4);
        } else {
            super.setVisible(z4);
        }
    }
    ...
    @Override // android.app.Activity
    public void setVrModeEnabled(boolean z4, ComponentName componentName) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.setVrModeEnabled(z4, componentName);
        } else {
            super.setVrModeEnabled(z4, componentName);
        }
    }
    ...
    public void startActivityForResult(Intent intent, int i5) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.startActivityForResult(intent, i5);
        } else {
    ...
    @Override // android.app.Activity
    public void startActivityFromChild(Activity activity, Intent intent, int i5) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.startActivityFromChild(activity, intent, i5);
        } else {
    ...
    public void startActivityFromFragment(Fragment fragment, Intent intent, int i5) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.startActivityFromFragment(fragment, intent, i5);
        } else {
            super.startActivityFromFragment(fragment, intent, i5);
        }
    }
    ...
    public boolean startActivityIfNeeded(Intent intent, int i5) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            return generatePluginAppCompatActivity.startActivityIfNeeded(intent, i5);
        }
        return super.startActivityIfNeeded(intent, i5);
    }

    @Override // android.app.Activity, android.content.ContextWrapper, android.content.Context
    public void startIntentSender(IntentSender intentSender, Intent intent, int i5, int i6, int i7) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.startIntentSender(intentSender, intent, i5, i6, i7);
        } else {
            super.startIntentSender(intentSender, intent, i5, i6, i7);
        }
    }
    ...
    public void startIntentSenderForResult(IntentSender intentSender, int i5, Intent intent, int i6, int i7, int i8) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.startIntentSenderForResult(intentSender, i5, intent, i6, i7, i8);
        } else {
    ...
    @Override // android.app.Activity
    public void startIntentSenderFromChild(Activity activity, IntentSender intentSender, int i5, Intent intent, int i6, int i7, int i8) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.startIntentSenderFromChild(activity, intentSender, i5, intent, i6, i7, i8);
        } else {
            super.startIntentSenderFromChild(activity, intentSender, i5, intent, i6, i7, i8);
        }
    }
    ...
    public void startSearch(String str, boolean z4, Bundle bundle, boolean z5) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.startSearch(str, z4, bundle, z5);
        } else {
            super.startSearch(str, z4, bundle, z5);
        }
    }
    ...
    @Override // android.app.Activity
    public void takeKeyEvents(boolean z4) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.takeKeyEvents(z4);
        } else {
    ...
    public PendingIntent zeusSuperCreatePendingResult(int i5, Intent intent, int i6) {
        return super.createPendingResult(i5, intent, i6);
    }
    ...
    public View zeusSuperFindViewById(int i5) {
        return super.findViewById(i5);
    }
    ...
    public void zeusSuperFinishActivity(int i5) {
        super.finishActivity(i5);
    }

    public void zeusSuperFinishActivityFromChild(Activity activity, int i5) {
        super.finishActivityFromChild(activity, i5);
    }
    ...
    public SharedPreferences zeusSuperGetPreferences(int i5) {
        return super.getPreferences(i5);
    }
    ...
    public boolean zeusSuperMoveTaskToBack(boolean z4) {
        return super.moveTaskToBack(z4);
    }
    ...
    public void zeusSuperOnActivityReenter(int i5, Intent intent) {
        super.onActivityReenter(i5, intent);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public void zeusSuperOnActivityResult(int i5, int i6, Intent intent) {
        super.onActivityResult(i5, i6, intent);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public void zeusSuperOnApplyThemeResource(Resources.Theme theme, int i5, boolean z4) {
        super.onApplyThemeResource(theme, i5, z4);
    }
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public Dialog zeusSuperOnCreateDialog(int i5) {
        return super.onCreateDialog(i5);
    }
    ...
    public boolean zeusSuperOnCreatePanelMenu(int i5, Menu menu) {
        return super.onCreatePanelMenu(i5, menu);
    }

    public View zeusSuperOnCreatePanelView(int i5) {
        return super.onCreatePanelView(i5);
    }
    ...
    public boolean zeusSuperOnKeyDown(int i5, KeyEvent keyEvent) {
        return super.onKeyDown(i5, keyEvent);
    }

    public boolean zeusSuperOnKeyLongPress(int i5, KeyEvent keyEvent) {
        return super.onKeyLongPress(i5, keyEvent);
    }

    public boolean zeusSuperOnKeyMultiple(int i5, int i6, KeyEvent keyEvent) {
        return super.onKeyMultiple(i5, i6, keyEvent);
    }

    public boolean zeusSuperOnKeyShortcut(int i5, KeyEvent keyEvent) {
        return super.onKeyShortcut(i5, keyEvent);
    }

    public boolean zeusSuperOnKeyUp(int i5, KeyEvent keyEvent) {
        return super.onKeyUp(i5, keyEvent);
    }
    ...
    public boolean zeusSuperOnMenuOpened(int i5, Menu menu) {
        return super.onMenuOpened(i5, menu);
    }

    public void zeusSuperOnMultiWindowModeChanged(boolean z4) {
        super.onMultiWindowModeChanged(z4);
    }
    ...
    public void zeusSuperOnPanelClosed(int i5, Menu menu) {
        super.onPanelClosed(i5, menu);
    }
    ...
    public void zeusSuperOnPictureInPictureModeChanged(boolean z4) {
        super.onPictureInPictureModeChanged(z4);
    }
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public void zeusSuperOnPrepareDialog(int i5, Dialog dialog) {
        super.onPrepareDialog(i5, dialog);
    }
    ...
    public boolean zeusSuperOnPreparePanel(int i5, View view, Menu menu) {
        return super.onPreparePanel(i5, view, menu);
    }
    ...
    public void zeusSuperOnProvideKeyboardShortcuts(List list, Menu menu, int i5) {
        super.onProvideKeyboardShortcuts(list, menu, i5);
    }
    ...
    public void zeusSuperOnRequestPermissionsResult(int i5, String[] strArr, int[] iArr) {
        super.onRequestPermissionsResult(i5, strArr, iArr);
    }
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public void zeusSuperOnTitleChanged(CharSequence charSequence, int i5) {
        super.onTitleChanged(charSequence, i5);
    }

    public void zeusSuperOnTopResumedActivityChanged(boolean z4) {
        super.onTopResumedActivityChanged(z4);
    }
    ...
    public void zeusSuperOnTrimMemory(int i5) {
        super.onTrimMemory(i5);
    }
    ...
    public void zeusSuperOnWindowFocusChanged(boolean z4) {
        super.onWindowFocusChanged(z4);
    }
    ...
    public void zeusSuperOverridePendingTransition(int i5, int i6) {
        super.overridePendingTransition(i5, i6);
    }
    ...
    public boolean zeusSuperRequestVisibleBehind(boolean z4) {
        return super.requestVisibleBehind(z4);
    }
    ...
    public void zeusSuperSetContentView(int i5) {
        super.setContentView(i5);
    }
    ...
    public void zeusSuperSetFinishOnTouchOutside(boolean z4) {
        super.setFinishOnTouchOutside(z4);
    }

    public void zeusSuperSetImmersive(boolean z4) {
        super.setImmersive(z4);
    }

    public void zeusSuperSetInheritShowWhenLocked(boolean z4) {
        super.setInheritShowWhenLocked(z4);
    }
    ...
    public void zeusSuperSetRequestedOrientation(int i5) {
        super.setRequestedOrientation(i5);
    }

    public void zeusSuperSetShowWhenLocked(boolean z4) {
        super.setShowWhenLocked(z4);
    }
    ...
    @Override // com.bytedance.pangle.activity.b
    public void zeusSuperSetTheme(int i5) {
        super.setTheme(i5);
    }

    public void zeusSuperSetTitle(int i5) {
        super.setTitle(i5);
    }

    public void zeusSuperSetTitleColor(int i5) {
        super.setTitleColor(i5);
    }

    public boolean zeusSuperSetTranslucent(boolean z4) {
        return super.setTranslucent(z4);
    }

    public void zeusSuperSetTurnScreenOn(boolean z4) {
        super.setTurnScreenOn(z4);
    }

    public void zeusSuperSetVisible(boolean z4) {
        super.setVisible(z4);
    }

    public void zeusSuperSetVrModeEnabled(boolean z4, ComponentName componentName) {
        super.setVrModeEnabled(z4, componentName);
    }
    ...
    public void zeusSuperStartActivityForResult(Intent intent, int i5) {
        super.startActivityForResult(intent, i5);
    }

    public void zeusSuperStartActivityFromChild(Activity activity, Intent intent, int i5) {
        super.startActivityFromChild(activity, intent, i5);
    }

    public void zeusSuperStartActivityFromFragment(Fragment fragment, Intent intent, int i5) {
        super.startActivityFromFragment(fragment, intent, i5);
    }

    public boolean zeusSuperStartActivityIfNeeded(Intent intent, int i5) {
        return super.startActivityIfNeeded(intent, i5);
    }

    public void zeusSuperStartIntentSender(IntentSender intentSender, Intent intent, int i5, int i6, int i7) {
        super.startIntentSender(intentSender, intent, i5, i6, i7);
    }

    public void zeusSuperStartIntentSenderForResult(IntentSender intentSender, int i5, Intent intent, int i6, int i7, int i8) {
        super.startIntentSenderForResult(intentSender, i5, intent, i6, i7, i8);
    }

    public void zeusSuperStartIntentSenderFromChild(Activity activity, IntentSender intentSender, int i5, Intent intent, int i6, int i7, int i8) {
        super.startIntentSenderFromChild(activity, intentSender, i5, intent, i6, i7, i8);
    }
    ...
    public void zeusSuperStartSearch(String str, boolean z4, Bundle bundle, boolean z5) {
        super.startSearch(str, z4, bundle, z5);
    }
    ...
    public void zeusSuperTakeKeyEvents(boolean z4) {
        super.takeKeyEvents(z4);
    }
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public Dialog zeusSuperOnCreateDialog(int i5, Bundle bundle) {
    ...
    public void zeusSuperOnMultiWindowModeChanged(boolean z4, Configuration configuration) {
        super.onMultiWindowModeChanged(z4, configuration);
    }

    public void zeusSuperOnPictureInPictureModeChanged(boolean z4, Configuration configuration) {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public void zeusSuperOnPrepareDialog(int i5, Dialog dialog, Bundle bundle) {
    ...
    public ActionMode zeusSuperOnWindowStartingActionMode(ActionMode.Callback callback, int i5) {
    ...
    public ActionMode zeusSuperStartActionMode(ActionMode.Callback callback, int i5) {
    ...
    public void zeusSuperStartActivityForResult(Intent intent, int i5, Bundle bundle) {
        super.startActivityForResult(intent, i5, bundle);
    }

    public void zeusSuperStartActivityFromChild(Activity activity, Intent intent, int i5, Bundle bundle) {
        super.startActivityFromChild(activity, intent, i5, bundle);
    }

    public void zeusSuperStartActivityFromFragment(Fragment fragment, Intent intent, int i5, Bundle bundle) {
        super.startActivityFromFragment(fragment, intent, i5, bundle);
    }

    public boolean zeusSuperStartActivityIfNeeded(Intent intent, int i5, Bundle bundle) {
        return super.startActivityIfNeeded(intent, i5, bundle);
    }

    public void zeusSuperStartIntentSender(IntentSender intentSender, Intent intent, int i5, int i6, int i7, Bundle bundle) {
        super.startIntentSender(intentSender, intent, i5, i6, i7, bundle);
    }

    public void zeusSuperStartIntentSenderForResult(IntentSender intentSender, int i5, Intent intent, int i6, int i7, int i8, Bundle bundle) {
        super.startIntentSenderForResult(intentSender, i5, intent, i6, i7, i8, bundle);
    }

    public void zeusSuperStartIntentSenderFromChild(Activity activity, IntentSender intentSender, int i5, Intent intent, int i6, int i7, int i8, Bundle bundle) {
        super.startIntentSenderFromChild(activity, intentSender, i5, intent, i6, i7, i8, bundle);
    }
    ...
    protected Dialog onCreateDialog(int i5, Bundle bundle) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            return generatePluginAppCompatActivity.onCreateDialog(i5, bundle);
        }
        return super.onCreateDialog(i5, bundle);
    }
    ...
    public void onMultiWindowModeChanged(boolean z4, Configuration configuration) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.onMultiWindowModeChanged(z4, configuration);
        } else {
            super.onMultiWindowModeChanged(z4, configuration);
        }
    }
    ...
    public void onPictureInPictureModeChanged(boolean z4, Configuration configuration) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.onPictureInPictureModeChanged(z4, configuration);
        } else {
            super.onPictureInPictureModeChanged(z4, configuration);
        }
    }
    ...
    @Override // android.app.Activity
    protected void onPrepareDialog(int i5, Dialog dialog, Bundle bundle) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.onPrepareDialog(i5, dialog, bundle);
        } else {
            super.onPrepareDialog(i5, dialog, bundle);
        }
    }
    ...
    public ActionMode onWindowStartingActionMode(ActionMode.Callback callback, int i5) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            return generatePluginAppCompatActivity.onWindowStartingActionMode(callback, i5);
        }
        return super.onWindowStartingActionMode(callback, i5);
    }
    ...
    public ActionMode startActionMode(ActionMode.Callback callback, int i5) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            return generatePluginAppCompatActivity.startActionMode(callback, i5);
        }
        return super.startActionMode(callback, i5);
    }
    ...
    public void startActivityForResult(Intent intent, int i5, Bundle bundle) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.startActivityForResult(intent, i5, bundle);
        } else {
            super.startActivityForResult(intent, i5, bundle);
        }
    }
    ...
    @Override // android.app.Activity
    public void startActivityFromChild(Activity activity, Intent intent, int i5, Bundle bundle) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.startActivityFromChild(activity, intent, i5, bundle);
        } else {
            super.startActivityFromChild(activity, intent, i5, bundle);
        }
    }
    ...
    public void startActivityFromFragment(Fragment fragment, Intent intent, int i5, Bundle bundle) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.startActivityFromFragment(fragment, intent, i5, bundle);
        } else {
            super.startActivityFromFragment(fragment, intent, i5, bundle);
        }
    }
    ...
    public boolean startActivityIfNeeded(Intent intent, int i5, Bundle bundle) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            return generatePluginAppCompatActivity.startActivityIfNeeded(intent, i5, bundle);
        }
        return super.startActivityIfNeeded(intent, i5, bundle);
    }

    @Override // android.app.Activity, android.content.ContextWrapper, android.content.Context
    public void startIntentSender(IntentSender intentSender, Intent intent, int i5, int i6, int i7, Bundle bundle) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.startIntentSender(intentSender, intent, i5, i6, i7, bundle);
        } else {
            super.startIntentSender(intentSender, intent, i5, i6, i7, bundle);
        }
    }
    ...
    public void startIntentSenderForResult(IntentSender intentSender, int i5, Intent intent, int i6, int i7, int i8, Bundle bundle) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.startIntentSenderForResult(intentSender, i5, intent, i6, i7, i8, bundle);
        } else {
            super.startIntentSenderForResult(intentSender, i5, intent, i6, i7, i8, bundle);
        }
    }
    ...
    @Override // android.app.Activity
    public void startIntentSenderFromChild(Activity activity, IntentSender intentSender, int i5, Intent intent, int i6, int i7, int i8, Bundle bundle) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.startIntentSenderFromChild(activity, intentSender, i5, intent, i6, i7, i8, bundle);
        } else {
            super.startIntentSenderFromChild(activity, intentSender, i5, intent, i6, i7, i8, bundle);
        }
    }
    ...
    public void startActivityForResult(String str, Intent intent, int i5, Bundle bundle) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.startActivityForResult(intent, i5, bundle);
        } else {
