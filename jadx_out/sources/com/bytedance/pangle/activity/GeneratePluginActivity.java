...
public abstract class GeneratePluginActivity extends Activity implements IPluginActivity {
    ...
    public void _requestPermissions(String[] strArr, int i5) {
        this.mProxyActivity.requestPermissions(strArr, i5);
    }
    ...
    public PendingIntent createPendingResult(int i5, Intent intent, int i6) {
        return this.mProxyActivity.zeusSuperCreatePendingResult(i5, intent, i6);
    }
    ...
    public View findViewById(int i5) {
        return this.mProxyActivity.zeusSuperFindViewById(i5);
    }
    ...
    public void finishActivity(int i5) {
        this.mProxyActivity.zeusSuperFinishActivity(i5);
    }

    @Override // android.app.Activity
    public void finishActivityFromChild(Activity activity, int i5) {
        this.mProxyActivity.zeusSuperFinishActivityFromChild(activity, i5);
    }
    ...
    public SharedPreferences getPreferences(int i5) {
        return this.mProxyActivity.zeusSuperGetPreferences(i5);
    }
    ...
    public boolean moveTaskToBack(boolean z4) {
        return this.mProxyActivity.zeusSuperMoveTaskToBack(z4);
    }
    ...
    public void onActivityReenter(int i5, Intent intent) {
        this.mProxyActivity.zeusSuperOnActivityReenter(i5, intent);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    @Override // android.app.Activity
    public void onActivityResult(int i5, int i6, Intent intent) {
        this.mProxyActivity.zeusSuperOnActivityResult(i5, i6, intent);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    @Override // android.app.Activity, android.view.ContextThemeWrapper
    public void onApplyThemeResource(Resources.Theme theme, int i5, boolean z4) {
        this.mProxyActivity.zeusSuperOnApplyThemeResource(theme, i5, z4);
    }
    ...
    public Dialog onCreateDialog(int i5) {
        return this.mProxyActivity.zeusSuperOnCreateDialog(i5);
    }
    ...
    public boolean onCreatePanelMenu(int i5, Menu menu) {
        return this.mProxyActivity.zeusSuperOnCreatePanelMenu(i5, menu);
    }

    @Override // android.app.Activity, android.view.Window.Callback
    public View onCreatePanelView(int i5) {
        return this.mProxyActivity.zeusSuperOnCreatePanelView(i5);
    }
    ...
    public boolean onKeyDown(int i5, KeyEvent keyEvent) {
        return this.mProxyActivity.zeusSuperOnKeyDown(i5, keyEvent);
    }

    @Override // android.app.Activity, android.view.KeyEvent.Callback
    public boolean onKeyLongPress(int i5, KeyEvent keyEvent) {
        return this.mProxyActivity.zeusSuperOnKeyLongPress(i5, keyEvent);
    }

    @Override // android.app.Activity, android.view.KeyEvent.Callback
    public boolean onKeyMultiple(int i5, int i6, KeyEvent keyEvent) {
        return this.mProxyActivity.zeusSuperOnKeyMultiple(i5, i6, keyEvent);
    }

    @Override // android.app.Activity
    public boolean onKeyShortcut(int i5, KeyEvent keyEvent) {
        return this.mProxyActivity.zeusSuperOnKeyShortcut(i5, keyEvent);
    }

    @Override // android.app.Activity, android.view.KeyEvent.Callback
    public boolean onKeyUp(int i5, KeyEvent keyEvent) {
        return this.mProxyActivity.zeusSuperOnKeyUp(i5, keyEvent);
    }
    ...
    public boolean onMenuOpened(int i5, Menu menu) {
        return this.mProxyActivity.zeusSuperOnMenuOpened(i5, menu);
    }

    @Override // android.app.Activity
    public void onMultiWindowModeChanged(boolean z4) {
        this.mProxyActivity.zeusSuperOnMultiWindowModeChanged(z4);
    }
    ...
    public void onPanelClosed(int i5, Menu menu) {
        this.mProxyActivity.zeusSuperOnPanelClosed(i5, menu);
    }
    ...
    public void onPictureInPictureModeChanged(boolean z4) {
        this.mProxyActivity.zeusSuperOnPictureInPictureModeChanged(z4);
    }
    ...
    public void onPrepareDialog(int i5, Dialog dialog) {
        this.mProxyActivity.zeusSuperOnPrepareDialog(i5, dialog);
    }
    ...
    public boolean onPreparePanel(int i5, View view, Menu menu) {
        return this.mProxyActivity.zeusSuperOnPreparePanel(i5, view, menu);
    }
    ...
    public void onProvideKeyboardShortcuts(List list, Menu menu, int i5) {
        this.mProxyActivity.zeusSuperOnProvideKeyboardShortcuts(list, menu, i5);
    }
    ...
    public void onRequestPermissionsResult(int i5, String[] strArr, int[] iArr) {
        this.mProxyActivity.zeusSuperOnRequestPermissionsResult(i5, strArr, iArr);
    }
    ...
    public void onTitleChanged(CharSequence charSequence, int i5) {
        this.mProxyActivity.zeusSuperOnTitleChanged(charSequence, i5);
    }

    @Override // android.app.Activity
    public void onTopResumedActivityChanged(boolean z4) {
        this.mProxyActivity.zeusSuperOnTopResumedActivityChanged(z4);
    }
    ...
    public void onTrimMemory(int i5) {
        this.mProxyActivity.zeusSuperOnTrimMemory(i5);
    }
    ...
    public void onWindowFocusChanged(boolean z4) {
        this.mProxyActivity.zeusSuperOnWindowFocusChanged(z4);
    }
    ...
    public void overridePendingTransition(int i5, int i6) {
        this.mProxyActivity.zeusSuperOverridePendingTransition(i5, i6);
    }
    ...
    public boolean requestVisibleBehind(boolean z4) {
        return this.mProxyActivity.zeusSuperRequestVisibleBehind(z4);
    }
    ...
    public void setContentView(int i5) {
        ...
        this.mProxyActivity.zeusSuperSetContentView(i5);
        ZeusTransformUtils.clearConstructorCache();
    ...
    public void setFinishOnTouchOutside(boolean z4) {
        this.mProxyActivity.zeusSuperSetFinishOnTouchOutside(z4);
    }

    @Override // android.app.Activity
    public void setImmersive(boolean z4) {
        this.mProxyActivity.zeusSuperSetImmersive(z4);
    }

    @Override // android.app.Activity
    public void setInheritShowWhenLocked(boolean z4) {
        this.mProxyActivity.zeusSuperSetInheritShowWhenLocked(z4);
    }
    ...
    @Override // com.bytedance.pangle.activity.IPluginActivity
    public void setProxyTheme2Plugin(int i5) {
        try {
            super.setTheme(i5);
    ...
    public void setRequestedOrientation(int i5) {
        this.mProxyActivity.zeusSuperSetRequestedOrientation(i5);
    }

    @Override // android.app.Activity
    public void setShowWhenLocked(boolean z4) {
        this.mProxyActivity.zeusSuperSetShowWhenLocked(z4);
    }
    ...
    public void setTheme(int i5) {
        this.mProxyActivity.zeusSuperSetTheme(i5);
    }

    @Override // android.app.Activity
    public void setTitle(int i5) {
        this.mProxyActivity.zeusSuperSetTitle(i5);
    }

    @Override // android.app.Activity
    public void setTitleColor(int i5) {
        this.mProxyActivity.zeusSuperSetTitleColor(i5);
    }

    @Override // android.app.Activity
    public boolean setTranslucent(boolean z4) {
        return this.mProxyActivity.zeusSuperSetTranslucent(z4);
    }

    @Override // android.app.Activity
    public void setTurnScreenOn(boolean z4) {
        this.mProxyActivity.zeusSuperSetTurnScreenOn(z4);
    }

    @Override // android.app.Activity
    public void setVisible(boolean z4) {
        this.mProxyActivity.zeusSuperSetVisible(z4);
    }

    @Override // android.app.Activity
    public void setVrModeEnabled(boolean z4, ComponentName componentName) {
        this.mProxyActivity.zeusSuperSetVrModeEnabled(z4, componentName);
    }
    ...
    public void startActivityForResult(Intent intent, int i5) {
        this.mProxyActivity.zeusSuperStartActivityForResult(intent, i5);
    }

    @Override // android.app.Activity
    public void startActivityFromChild(Activity activity, Intent intent, int i5) {
        this.mProxyActivity.zeusSuperStartActivityFromChild(activity, intent, i5);
    }

    @Override // android.app.Activity
    public void startActivityFromFragment(Fragment fragment, Intent intent, int i5) {
        this.mProxyActivity.zeusSuperStartActivityFromFragment(fragment, intent, i5);
    }

    @Override // android.app.Activity
    public boolean startActivityIfNeeded(Intent intent, int i5) {
        return this.mProxyActivity.zeusSuperStartActivityIfNeeded(intent, i5);
    }

    @Override // android.app.Activity, android.content.ContextWrapper, android.content.Context
    public void startIntentSender(IntentSender intentSender, Intent intent, int i5, int i6, int i7) {
        this.mProxyActivity.zeusSuperStartIntentSender(intentSender, intent, i5, i6, i7);
    }

    @Override // android.app.Activity
    public void startIntentSenderForResult(IntentSender intentSender, int i5, Intent intent, int i6, int i7, int i8) {
        this.mProxyActivity.zeusSuperStartIntentSenderForResult(intentSender, i5, intent, i6, i7, i8);
    }
    ...
    public void startIntentSenderFromChild(Activity activity, IntentSender intentSender, int i5, Intent intent, int i6, int i7, int i8) {
        this.mProxyActivity.zeusSuperStartIntentSenderFromChild(activity, intentSender, i5, intent, i6, i7, i8);
    }
    ...
    public void startSearch(String str, boolean z4, Bundle bundle, boolean z5) {
        this.mProxyActivity.zeusSuperStartSearch(str, z4, bundle, z5);
    }
    ...
    public void takeKeyEvents(boolean z4) {
        this.mProxyActivity.zeusSuperTakeKeyEvents(z4);
    }
    ...
    public Dialog onCreateDialog(int i5, Bundle bundle) {
        return this.mProxyActivity.zeusSuperOnCreateDialog(i5, bundle);
    }
    ...
    public void onMultiWindowModeChanged(boolean z4, Configuration configuration) {
        this.mProxyActivity.zeusSuperOnMultiWindowModeChanged(z4, configuration);
    }

    @Override // android.app.Activity
    public void onPictureInPictureModeChanged(boolean z4, Configuration configuration) {
        this.mProxyActivity.zeusSuperOnPictureInPictureModeChanged(z4, configuration);
    }
    ...
    public void onPrepareDialog(int i5, Dialog dialog, Bundle bundle) {
        this.mProxyActivity.zeusSuperOnPrepareDialog(i5, dialog, bundle);
    }
    ...
    public ActionMode onWindowStartingActionMode(ActionMode.Callback callback, int i5) {
        return this.mProxyActivity.zeusSuperOnWindowStartingActionMode(callback, i5);
    }
    ...
    public ActionMode startActionMode(ActionMode.Callback callback, int i5) {
        return this.mProxyActivity.zeusSuperStartActionMode(callback, i5);
    }
    ...
    public void startActivityForResult(Intent intent, int i5, Bundle bundle) {
        this.mProxyActivity.zeusSuperStartActivityForResult(intent, i5, bundle);
    }

    @Override // android.app.Activity
    public void startActivityFromChild(Activity activity, Intent intent, int i5, Bundle bundle) {
        this.mProxyActivity.zeusSuperStartActivityFromChild(activity, intent, i5, bundle);
    }

    @Override // android.app.Activity
    public void startActivityFromFragment(Fragment fragment, Intent intent, int i5, Bundle bundle) {
        this.mProxyActivity.zeusSuperStartActivityFromFragment(fragment, intent, i5, bundle);
    }

    @Override // android.app.Activity
    public boolean startActivityIfNeeded(Intent intent, int i5, Bundle bundle) {
        return this.mProxyActivity.zeusSuperStartActivityIfNeeded(intent, i5, bundle);
    }

    @Override // android.app.Activity, android.content.ContextWrapper, android.content.Context
    public void startIntentSender(IntentSender intentSender, Intent intent, int i5, int i6, int i7, Bundle bundle) {
        this.mProxyActivity.zeusSuperStartIntentSender(intentSender, intent, i5, i6, i7, bundle);
    }

    @Override // android.app.Activity
    public void startIntentSenderForResult(IntentSender intentSender, int i5, Intent intent, int i6, int i7, int i8, Bundle bundle) {
        this.mProxyActivity.zeusSuperStartIntentSenderForResult(intentSender, i5, intent, i6, i7, i8, bundle);
    }
    ...
    public void startIntentSenderFromChild(Activity activity, IntentSender intentSender, int i5, Intent intent, int i6, int i7, int i8, Bundle bundle) {
        this.mProxyActivity.zeusSuperStartIntentSenderFromChild(activity, intentSender, i5, intent, i6, i7, i8, bundle);
    }
    ...
    public void startActivityForResult(String str, Intent intent, int i5, Bundle bundle) {
        this.mProxyActivity.startActivityForResult(str, intent, i5, bundle);
    }
