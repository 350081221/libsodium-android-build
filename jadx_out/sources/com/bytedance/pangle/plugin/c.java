...
public final class c {
    ...
    private static final i f4497a = i.a();
    ...
    public final boolean a(String str) {
        ...
        synchronized (plugin) {
            ...
            com.bytedance.pangle.log.a a5 = com.bytedance.pangle.log.a.a(ZeusLogger.TAG_LOAD, "PluginLoader", "loadPlugin:".concat(String.valueOf(str)));
            a(com.bytedance.pangle.c.b.f4278i, b.a.D, plugin.mPkgName, plugin.getVersion(), -1L, (String) null);
            ZeusPluginStateListener.postStateChange(str, 8, new Object[0]);
            StringBuilder sb = new StringBuilder();
            boolean a6 = a(str, plugin, sb);
            a5.a("loadPluginInternal:".concat(String.valueOf(a6)));
            if (a6) {
                plugin.setLifeCycle(3);
                a(com.bytedance.pangle.c.b.f4279j, b.a.E, plugin.mPkgName, plugin.getVersion(), a5.a(), sb.toString());
                ...
                a(com.bytedance.pangle.c.b.f4279j, b.a.F, plugin.mPkgName, plugin.getVersion(), -1L, sb.toString());
    ...
    /* JADX WARN: Removed duplicated region for block: B:33:0x01b0 A[Catch: all -> 0x0252, TryCatch #0 {all -> 0x0252, blocks: (B:31:0x018c, B:33:0x01b0, B:39:0x01d8, B:41:0x01de, B:42:0x01e1, B:44:0x01e9, B:45:0x024c, B:48:0x021f), top: B:30:0x018c }] */
    /* JADX WARN: Removed duplicated region for block: B:44:0x01e9 A[Catch: all -> 0x0252, TryCatch #0 {all -> 0x0252, blocks: (B:31:0x018c, B:33:0x01b0, B:39:0x01d8, B:41:0x01de, B:42:0x01e1, B:44:0x01e9, B:45:0x024c, B:48:0x021f), top: B:30:0x018c }] */
    /* JADX WARN: Removed duplicated region for block: B:48:0x021f A[Catch: all -> 0x0252, TryCatch #0 {all -> 0x0252, blocks: (B:31:0x018c, B:33:0x01b0, B:39:0x01d8, B:41:0x01de, B:42:0x01e1, B:44:0x01e9, B:45:0x024c, B:48:0x021f), top: B:30:0x018c }] */
    ...
    */
        ...
        if (activityInfoArr != null) {
            for (ActivityInfo activityInfo : activityInfoArr) {
                if (!TextUtils.isEmpty(activityInfo.processName) && activityInfo.processName.contains(":")) {
                    ...
                    activityInfo.processName = TTAdSdk.S_C;
                }
        ...
        if (serviceInfoArr != null) {
            for (ServiceInfo serviceInfo : serviceInfoArr) {
                if (!TextUtils.isEmpty(serviceInfo.processName) && serviceInfo.processName.contains(":")) {
                    ...
                    serviceInfo.processName = TTAdSdk.S_C;
                }
        ...
        if (activityInfoArr2 != null) {
            for (ActivityInfo activityInfo2 : activityInfoArr2) {
                if (!TextUtils.isEmpty(activityInfo2.processName) && activityInfo2.processName.contains(":")) {
                    ...
                    activityInfo2.processName = TTAdSdk.S_C;
                }
        ...
        if (providerInfoArr != null) {
            for (ProviderInfo providerInfo : providerInfoArr) {
                if (!TextUtils.isEmpty(providerInfo.processName) && providerInfo.processName.contains(":")) {
                    ...
                    providerInfo.processName = TTAdSdk.S_C;
                }
    ...
    private static void a(Plugin plugin, String str, File file, File file2) {
        ...
        if (com.bytedance.pangle.util.i.b()) {
            String a5 = g.a(plugin.mPkgName, plugin.getVersion());
            String[] split = a5.split(":");
            long currentTimeMillis = System.currentTimeMillis();
            boolean z4 = !com.bytedance.pangle.e.b.a(file2.getAbsolutePath(), split);
            ZeusLogger.d(ZeusLogger.TAG_LOAD, "useDirect:" + (System.currentTimeMillis() - currentTimeMillis) + " " + z4);
            PluginClassLoader pluginClassLoader2 = new PluginClassLoader(z4 ? "" : a5, file2, file.getAbsolutePath(), null);
