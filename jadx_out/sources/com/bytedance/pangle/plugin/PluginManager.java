...
public class PluginManager {
    ...
    private synchronized void parsePluginConfig() {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    for (String str3 : arrayList) {
                        try {
                            ...
                            ZeusLogger.errReport(ZeusLogger.TAG_INIT, "PluginManager parsePluginsJson failed. " + str3.trim(), e5);
                        }
                    }
                ...
                ZeusLogger.errReport(ZeusLogger.TAG_INIT, "PluginManager iterator metaData failed.", e7);
            }
        } catch (Exception e8) {
    ...
    public boolean checkPluginInstalled(String str) {
        ...
        ZeusLogger.d(ZeusLogger.TAG_PPM, "PluginManager checkPluginInstalled, " + str + " = " + z4);
        return z4;
    }
    ...
    public Plugin getPlugin(String str, boolean z4) {
    ...
    public void setAllowDownloadPlugin(String str, int i5, boolean z4) {
        ZeusLogger.d(ZeusLogger.TAG_PPM, "PluginManager setAllowDownloadPlugin, " + str + " " + i5 + " " + z4);
        if (getPlugin(str) != null) {
            ...
            edit.apply();
            ZeusLogger.i(ZeusLogger.TAG_INIT, "ZeusSpUtils markAllowDownloadFlag packageName=" + str + " version=" + i5 + " disable=" + z5);
        }
    }
    ...
    public void tryOfflineInternalPlugin(String str, int i5) {
        Plugin plugin = getPlugin(str);
        if (plugin != null && plugin.getInternalVersionCode() == i5) {
            ZeusLogger.d(ZeusLogger.TAG_PPM, "PluginManager offlineInternalPlugin, pkgName:" + str + " pluginVer:" + i5 + " apiVer:" + plugin.getApiVersionCode());
            l a5 = l.a();
