...
public class ZeusTransformUtils {
    ...
    public static boolean bindService(Object obj, Intent intent, ServiceConnection serviceConnection, int i5, String str) {
        if (obj instanceof Context) {
            return ServiceManagerNative.getInstance().bindServiceNative((Context) obj, intent, serviceConnection, i5, str);
        }
        try {
            return ((Boolean) MethodUtils.invokeMethod(obj, "bindService", new Object[]{intent, serviceConnection, Integer.valueOf(i5)}, new Class[]{Intent.class, ServiceConnection.class, Integer.TYPE})).booleanValue();
        } catch (Exception e5) {
            throw new RuntimeException(e5);
        }
    }

    public static void canThrowException(boolean z4) {
        sCanThrowException = z4;
    }
    ...
    public static String getAssetPaths(AssetManager assetManager) {
        ...
        if (i5 < 28 && (i5 != 27 || Build.VERSION.PREVIEW_SDK_INT <= 0)) {
            ...
            for (int i6 = 0; i6 < intValue; i6++) {
                try {
                    String str = (String) MethodUtils.invokeMethod(assetManager, "getCookieName", Integer.valueOf(i6 + 1));
    ...
    public static int getIdentifier(Object obj, String str, String str2, String str3, String str4) {
        if (obj instanceof Resources) {
            ...
            if (!TextUtils.equals(SharedLibraryInfo.PLATFORM_PACKAGE_NAME, str3)) {
                str3 = str4;
            }
    ...
    private static void handleAttrAfter(TypedArray typedArray, int[] iArr, int[] iArr2) {
        ...
        for (int i6 = 0; i6 < iArr2.length; i6++) {
            hashMap2.put((Integer) hashMap.get(Integer.valueOf(iArr2[i6])), Integer.valueOf(i6));
        }
        try {
    ...
    public static View inflate(LayoutInflater layoutInflater, int i5, ViewGroup viewGroup, boolean z4, String str) {
    ...
    public static int mapRes(int i5, String str, String str2) {
        if (i5 < 2130706432) {
            return i5;
        }
        ...
        if (identifier == 0) {
            ZeusLogger.d(ZeusLogger.TAG_RESOURCES, "Cant find res, resName = " + str2 + ", pluginResId = " + i5);
        }
        return identifier;
    }
    ...
    public static Object preCheckCast(Object obj, Class cls, String str) {
        ...
        if ((obj instanceof PluginContext) && z4) {
            return ((PluginContext) obj).mOriginContext;
        }
        if ((obj instanceof PluginFragmentActivityWrapper) && z4) {
            try {
                try {
        ...
        if ((obj instanceof PluginActivityWrapper) && z4) {
            return ((PluginActivityWrapper) obj).mOriginActivity;
        }
        if ((obj instanceof PluginApplicationWrapper) && z4) {
            return ((PluginApplicationWrapper) obj).mOriginApplication;
        }
        if ((obj instanceof GenerateProxyActivity) && z4) {
    ...
    public static void requestPermissions(Object obj, String[] strArr, int i5, String str) {
        Object obj2;
        if (obj instanceof IPluginActivity) {
            ((IPluginActivity) obj)._requestPermissions(strArr, i5);
            return;
        }
        ...
        try {
            MethodUtils.invokeMethod(obj, "requestPermissions", strArr, Integer.valueOf(i5));
        } catch (Exception e5) {
            throw new RuntimeException(e5);
        }
    }

    public static void setComponentEnabledSetting(PackageManager packageManager, ComponentName componentName, int i5, int i6) {
        try {
            packageManager.setComponentEnabledSetting(componentName, i5, i6);
        } catch (Throwable unused) {
        }
    }

    public static void setResult(Object obj, int i5, Intent intent, String str) {
        if (obj instanceof Activity) {
            try {
                ...
                if (readField != null) {
                    MethodUtils.invokeMethod(readField, "setResult", Integer.valueOf(i5), intent);
                    return;
                }
        ...
        try {
            MethodUtils.invokeMethod(obj, "setResult", Integer.valueOf(i5), intent);
        } catch (Exception e5) {
            throw new RuntimeException(e5);
        }
    }
    ...
    public static void startActivityForResult(Object obj, Intent intent, int i5, String str) {
        startActivityForResult(obj, intent, i5, null, str);
    }
    ...
    public static void supportFragmentWrapper(boolean z4) {
        sSupportFragmentWrapper = z4;
    }
    ...
    public static void startActivityForResult(Object obj, Intent intent, int i5, Bundle bundle, String str) {
        try {
            ComponentManager.startActivityForResult(obj, intent, i5, bundle, str);
        } catch (Throwable th) {
            if (obj instanceof Activity) {
                ComponentManager.startActivityForResult((Activity) obj, intent, i5, bundle, str);
                return;
            }
            try {
    ...
    public static TypedArray obtainStyledAttributes(Object obj, AttributeSet attributeSet, int[] iArr, int i5, int i6, String str) {
        if (obj instanceof Context) {
            int[] handleAttrBefore = handleAttrBefore(iArr);
            TypedArray obtainStyledAttributes = ((Context) obj).obtainStyledAttributes(attributeSet, handleAttrBefore);
            handleAttrAfter(obtainStyledAttributes, handleAttrBefore, iArr);
        ...
        if (obj instanceof Resources.Theme) {
            ...
            TypedArray obtainStyledAttributes2 = ((Resources.Theme) obj).obtainStyledAttributes(attributeSet, handleAttrBefore2, i5, i6);
            handleAttrAfter(obtainStyledAttributes2, handleAttrBefore2, iArr);
            return obtainStyledAttributes2;
        }
        try {
            return (TypedArray) MethodUtils.invokeMethod(obj, "obtainStyledAttributes", attributeSet, iArr, Integer.valueOf(i5), Integer.valueOf(i6));
        } catch (Exception e5) {
            throw new RuntimeException(e5);
        }
    }

    public static void setResult(Object obj, int i5, String str) {
        if (obj instanceof Activity) {
            try {
                Object readField = FieldUtils.readField(obj, "mProxyActivity");
                if (readField != null) {
                    MethodUtils.invokeMethod(readField, "setResult", Integer.valueOf(i5));
                    return;
                }
            } catch (Exception unused) {
        ...
        try {
            MethodUtils.invokeMethod(obj, "setResult", Integer.valueOf(i5));
        } catch (Exception e5) {
            throw new RuntimeException(e5);
        }
    }

    public static Intent registerReceiver(Object obj, PluginBroadcastReceiver pluginBroadcastReceiver, IntentFilter intentFilter, int i5, String str) {
        if (obj instanceof Context) {
            return ComponentManager.registerReceiver((Context) obj, pluginBroadcastReceiver, intentFilter, i5, str);
        }
        try {
            return (Intent) MethodUtils.invokeMethod(obj, "registerReceiver", pluginBroadcastReceiver, intentFilter, Integer.valueOf(i5));
        } catch (Exception e5) {
            throw new RuntimeException(e5);
        }
    }

    public static Intent registerReceiver(Object obj, PluginBroadcastReceiver pluginBroadcastReceiver, IntentFilter intentFilter, String str, Handler handler, int i5, String str2) {
        if (obj instanceof Context) {
            return ComponentManager.registerReceiver((Context) obj, pluginBroadcastReceiver, intentFilter, str, handler, i5, str2);
        }
        try {
            return (Intent) MethodUtils.invokeMethod(obj, "registerReceiver", pluginBroadcastReceiver, intentFilter, str, handler, Integer.valueOf(i5));
        } catch (Exception e5) {
            throw new RuntimeException(e5);
        }
    }

    public static View inflate(LayoutInflater layoutInflater, int i5, ViewGroup viewGroup, String str) {
        return inflate(layoutInflater, i5, viewGroup, viewGroup != null, str);
    }
    ...
    public static TypedArray obtainStyledAttributes(Object obj, int i5, int[] iArr, String str) {
        if (obj instanceof Context) {
            int[] handleAttrBefore = handleAttrBefore(iArr);
            TypedArray obtainStyledAttributes = ((Context) obj).obtainStyledAttributes(i5, handleAttrBefore);
            handleAttrAfter(obtainStyledAttributes, handleAttrBefore, iArr);
            return obtainStyledAttributes;
        }
        if (obj instanceof Resources.Theme) {
            int[] handleAttrBefore2 = handleAttrBefore(iArr);
            TypedArray obtainStyledAttributes2 = ((Resources.Theme) obj).obtainStyledAttributes(i5, handleAttrBefore2);
            handleAttrAfter(obtainStyledAttributes2, handleAttrBefore2, iArr);
            return obtainStyledAttributes2;
        }
        try {
            return (TypedArray) MethodUtils.invokeMethod(obj, "obtainStyledAttributes", Integer.valueOf(i5), iArr);
        } catch (Exception e5) {
            throw new RuntimeException(e5);
        }
    }

    public static View inflate(LayoutInflater layoutInflater, XmlPullParser xmlPullParser, ViewGroup viewGroup, boolean z4, String str) {
        Context context = layoutInflater.getContext();
        if (!(context instanceof PluginContext) && !(context instanceof PluginActivityWrapper) && ((isSupportLibIso(str) || !(context instanceof PluginFragmentActivityWrapper)) && !(context instanceof PluginApplicationWrapper))) {
        ...
        clearConstructorCache();
        View inflate = layoutInflater2.inflate(xmlPullParser, viewGroup, z4);
        clearConstructorCache();
        return inflate;
    }

    public static View inflate(Context context, int i5, ViewGroup viewGroup, String str) {
        if (!(context instanceof PluginContext) && !(context instanceof PluginActivityWrapper) && ((isSupportLibIso(str) || !(context instanceof PluginFragmentActivityWrapper)) && !(context instanceof PluginApplicationWrapper))) {
            context = wrapperContext(context, str);
        }
