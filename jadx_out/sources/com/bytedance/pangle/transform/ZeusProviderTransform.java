...
public class ZeusProviderTransform {
    ...
    public static void notifyChange(Object obj, Uri uri, ContentObserver contentObserver, String str) {
        if (obj instanceof ContentResolver) {
            ((ContentResolver) obj).notifyChange(com.bytedance.pangle.provider.a.a(uri, str), contentObserver);
            return;
        }
        try {
    ...
    public static void registerContentObserver(Object obj, Uri uri, boolean z4, ContentObserver contentObserver, String str) {
        if (obj instanceof ContentResolver) {
            ((ContentResolver) obj).registerContentObserver(com.bytedance.pangle.provider.a.a(uri, str), z4, contentObserver);
            return;
        }
        try {
            MethodUtils.invokeMethod(obj, "registerContentObserver", new Object[]{uri, Boolean.valueOf(z4), contentObserver}, new Class[]{Uri.class, Boolean.TYPE, ContentObserver.class});
        } catch (Exception e5) {
            throw new RuntimeException(e5);
        }
    }
    ...
    @RequiresApi(api = 24)
    public static void notifyChange(Object obj, Uri uri, ContentObserver contentObserver, int i5, String str) {
        if (obj instanceof ContentResolver) {
            ((ContentResolver) obj).notifyChange(com.bytedance.pangle.provider.a.a(uri, str), contentObserver, i5);
            return;
        }
        try {
            MethodUtils.invokeMethod(obj, "notifyChange", new Object[]{uri, contentObserver, Integer.valueOf(i5)}, new Class[]{Uri.class, ContentObserver.class, Integer.TYPE});
        } catch (Exception e5) {
            throw new RuntimeException(e5);
        }
    }
    ...
    public static void notifyChange(Object obj, Uri uri, ContentObserver contentObserver, boolean z4, String str) {
        if (obj instanceof ContentResolver) {
            ((ContentResolver) obj).notifyChange(com.bytedance.pangle.provider.a.a(uri, str), contentObserver, z4);
            return;
        }
        try {
            MethodUtils.invokeMethod(obj, "notifyChange", new Object[]{uri, contentObserver, Boolean.valueOf(z4)}, new Class[]{Uri.class, ContentObserver.class, Boolean.TYPE});
        } catch (Exception e5) {
            throw new RuntimeException(e5);
        }
    }
    ...
    @RequiresApi(api = 30)
    public static void notifyChange(Object obj, Collection<Uri> collection, ContentObserver contentObserver, int i5, String str) {
        if (obj instanceof ContentResolver) {
            ...
            ((ContentResolver) obj).notifyChange((Collection<Uri>) arrayList, contentObserver, i5);
            return;
        }
        try {
            MethodUtils.invokeMethod(obj, "notifyChange", new Object[]{collection, contentObserver, Integer.valueOf(i5)}, new Class[]{Collection.class, ContentObserver.class, Integer.TYPE});
        } catch (Exception e5) {
            throw new RuntimeException(e5);
        }
    }
