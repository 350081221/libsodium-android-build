...
public abstract class ZeusPluginStateListener {
    ...
    public static void postStateChange(@Nullable final String str, final int i5, final Object... objArr) {
        String str2;
            ...
            public final void run() {
                ...
                if (list != null && list.size() > 0) {
                    for (ZeusPluginStateListener zeusPluginStateListener : list) {
                        ...
                        zeusPluginStateListener.onPluginStateChange(str3, i5, objArr);
                    }
                }
            }
        });
        ...
        if (list != null && list.size() > 0) {
            for (ZeusPluginStateListener zeusPluginStateListener : list) {
                ...
                zeusPluginStateListener.onStateChangeOnCurThread(str2, i5, objArr);
            }
        }
    }
    ...
    public void onStateChangeOnCurThread(String str, int i5, Object... objArr) {
    }
}
