...
public final class c {
    ...
    private static c f4527d;

    /* renamed from: a, reason: collision with root package name */
    public final Map<String, a> f4528a = new ConcurrentHashMap();

    /* renamed from: b, reason: collision with root package name */
    public final Map<PluginBroadcastReceiver, BroadcastReceiver> f4529b = new ConcurrentHashMap();

    /* renamed from: c, reason: collision with root package name */
    public final Set<Integer> f4530c = new CopyOnWriteArraySet();
    ...
    public static class a {
        ...
        /* renamed from: b, reason: collision with root package name */
        public final Set<PluginBroadcastReceiver> f4532b = new CopyOnWriteArraySet();

        public final void a(PluginBroadcastReceiver pluginBroadcastReceiver) {
            if (pluginBroadcastReceiver != null) {
                this.f4532b.add(pluginBroadcastReceiver);
            }
        }

        public final void a(Context context, Intent intent) {
            Set<PluginBroadcastReceiver> set = this.f4532b;
            if (set == null || set.size() <= 0) {
                return;
            }
            for (PluginBroadcastReceiver pluginBroadcastReceiver : this.f4532b) {
                if (pluginBroadcastReceiver != null) {
                    try {
    ...
    public final void a(Context context, Intent intent) {
        ...
        Map<String, a> map = this.f4528a;
        if (map == null || map.size() <= 0) {
            return;
        }
        for (Map.Entry<String, a> entry : this.f4528a.entrySet()) {
