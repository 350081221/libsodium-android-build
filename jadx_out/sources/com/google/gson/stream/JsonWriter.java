...
public class JsonWriter implements Closeable, Flushable {
    ...
    private JsonWriter close(int i5, int i6, String str) throws IOException {
        int peek = peek();
        if (peek != i6 && peek != i5) {
            throw new IllegalStateException("Nesting problem.");
        }
    ...
    private JsonWriter open(int i5, String str) throws IOException {
        beforeValue();
        push(i5);
        this.out.write(str);
        return this;
