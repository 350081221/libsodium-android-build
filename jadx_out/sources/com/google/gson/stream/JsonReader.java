...
public class JsonReader implements Closeable {
    ...
    static {
        g.INSTANCE = new g() { // from class: com.google.gson.stream.JsonReader.1
    ...
    private void consumeNonExecutePrefix() throws IOException {
        ...
        if (i5 + cArr.length > this.limit && !fillBuffer(cArr.length)) {
            return;
        }
        int i6 = 0;
        while (true) {
            ...
            if (i6 < cArr2.length) {
                if (this.buffer[this.pos + i6] != cArr2[i6]) {
                    return;
                } else {
                    i6++;
                }
    ...
    */
    ...
    public String nextName() throws IOException {
        ...
        if (i5 == 14) {
            ...
            nextQuotedValue = nextQuotedValue(k0.f19765b);
        } else {
    ...
    public String nextString() throws IOException {
        ...
        if (i5 == 10) {
            ...
            str = nextQuotedValue(k0.f19765b);
        } else if (i5 == 11) {
