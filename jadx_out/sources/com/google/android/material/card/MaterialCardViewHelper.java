...
public class MaterialCardViewHelper {
    ...
    private Drawable insetDrawable(Drawable drawable) {
        ...
        if (this.materialCardView.getUseCompatPadding()) {
            i6 = (int) Math.ceil(calculateVerticalBackgroundPadding());
    ...
    public void animateCheckedIcon(boolean z4) {
        ...
        ValueAnimator ofFloat = ValueAnimator.ofFloat(this.checkedAnimationProgress, f5);
        ...
        valueAnimator2.setDuration(i5 * f6);
    ...
    public void recalculateCheckedIconPosition(int i5, int i6) {
        ...
        if (this.clickableForegroundDrawable != null) {
            if (this.materialCardView.getUseCompatPadding()) {
                i7 = (int) Math.ceil(calculateVerticalBackgroundPadding() * 2.0f);
            ...
            if (isCheckedIconEnd()) {
                i9 = ((i5 - this.checkedIconMargin) - this.checkedIconSize) - i8;
            } else {
            ...
            if (isCheckedIconBottom()) {
                ...
                i10 = ((i6 - this.checkedIconMargin) - this.checkedIconSize) - i7;
            }
            int i15 = i10;
            if (isCheckedIconEnd()) {
                i11 = this.checkedIconMargin;
            } else {
                i11 = ((i5 - this.checkedIconMargin) - this.checkedIconSize) - i8;
            }
            if (isCheckedIconBottom()) {
                i12 = ((i6 - this.checkedIconMargin) - this.checkedIconSize) - i7;
            } else {
