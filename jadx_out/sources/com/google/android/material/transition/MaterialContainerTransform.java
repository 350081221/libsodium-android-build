...
public final class MaterialContainerTransform extends Transition {
    ...
    private static final class TransitionDrawable extends Drawable {
        ...
        private void updateProgress(float f5) {
            ...
            if (this.entering) {
                lerp = TransitionUtils.lerp(0.0f, 255.0f, f5);
            } else {
                lerp = TransitionUtils.lerp(255.0f, 0.0f, f5);
            }
            ...
            float lerp2 = TransitionUtils.lerp(0.0f, 1.0f, floatValue, floatValue2, f5);
            if (!shouldMaskStartBounds) {
                lerp2 = 1.0f - lerp2;
            }
            ...
            float f14 = this.currentElevation;
            float f15 = (int) (calculateElevationDyMultiplier * f14);
            this.currentElevationDy = f15;
            this.shadowPaint.setShadowLayer(f14, (int) (calculateElevationDxMultiplier * f14), f15, SHADOW_COLOR);
    ...
    private static void captureValues(@NonNull TransitionValues transitionValues, @Nullable View view, @IdRes int i5, @Nullable ShapeAppearanceModel shapeAppearanceModel) {
        ...
        if (ViewCompat.isLaidOut(view4) || view4.getWidth() != 0 || view4.getHeight() != 0) {
            ...
            transitionValues.values.put(PROP_SHAPE_APPEARANCE, captureShapeAppearance(view4, locationOnScreen, shapeAppearanceModel));
        }
    }

    private static float getElevationOrDefault(float f5, View view) {
        return f5 != ELEVATION_NOT_SET ? f5 : ViewCompat.getElevation(view);
    }
    ...
    private void maybeApplyThemeValues(Context context, boolean z4) {
        ...
        if (z4) {
            i5 = com.google.android.material.R.attr.motionDurationLong2;
        } else {
            i5 = com.google.android.material.R.attr.motionDurationMedium4;
        }
        ...
        if (transitionValues != null && transitionValues2 != null) {
            ...
            if (rectF != null && shapeAppearanceModel != null) {
                ...
                if (rectF2 != null && shapeAppearanceModel2 != null) {
                    ...
                    float f5 = -locationOnScreen.left;
                    float f6 = -locationOnScreen.top;
                    RectF calculateDrawableBounds = calculateDrawableBounds(findAncestorById, view2, f5, f6);
                    rectF.offset(f5, f6);
                    rectF2.offset(f5, f6);
