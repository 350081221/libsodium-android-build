...
public class MaterialDividerItemDecoration extends RecyclerView.ItemDecoration {
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if (shouldDrawDivider(recyclerView, childAt)) {
                ...
                if (isLayoutRtl) {
                    ...
                    i6 = this.thickness + i7;
                } else {
                    i6 = round + this.tempRect.right;
                    i7 = i6 - this.thickness;
                }
                this.dividerDrawable.setBounds(i7, i8, i6, i9);
    ...
    private boolean shouldDrawDivider(@NonNull RecyclerView recyclerView, @NonNull View view) {
        ...
        if ((z4 && !this.lastItemDecorated) || !shouldDrawDivider(childAdapterPosition, (RecyclerView.Adapter<?>) adapter)) {
            return false;
        }
        return true;
    }
    ...
    protected boolean shouldDrawDivider(int i5, @Nullable RecyclerView.Adapter<?> adapter) {
        return true;
    }
