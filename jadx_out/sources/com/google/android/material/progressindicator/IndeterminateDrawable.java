    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        if (!getBounds().isEmpty() && isVisible() && canvas.getClipBounds(rect)) {
            ...
            for (int i6 = 0; i6 < this.animatorDelegate.activeIndicators.size(); i6++) {
                ...
                if (i6 > 0 && i5 > 0) {
                    this.drawingDelegate.fillTrack(canvas, this.paint, this.animatorDelegate.activeIndicators.get(i6 - 1).endFraction, activeIndicator3.startFraction, this.baseSpec.trackColor, alpha, i5);
                }
            }
            canvas.restore();
        }
