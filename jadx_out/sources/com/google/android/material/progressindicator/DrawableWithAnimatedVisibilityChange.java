...
public abstract class DrawableWithAnimatedVisibilityChange extends Drawable implements Animatable2Compat {
    ...
    @VisibleForTesting
    void setMockHideAnimationRunning(boolean z4, @FloatRange(from = 0.0d, to = 1.0d) float f5) {
        this.mockHideAnimationRunning = z4;
        this.mockGrowFraction = f5;
    }

    @VisibleForTesting
    void setMockShowAnimationRunning(boolean z4, @FloatRange(from = 0.0d, to = 1.0d) float f5) {
