...
public abstract class FabTransformationBehavior extends ExpandableTransformationBehavior {
    ...
    @NonNull
    protected AnimatorSet onCreateExpandedStateChangeAnimation(@NonNull final View view, @NonNull final View view2, final boolean z4, boolean z5) {
        ...
        createElevationAnimation(view, view2, z4, z5, onCreateMotionSpec, arrayList, arrayList2);
        RectF rectF = this.tmpRectF1;
        createTranslationAnimation(view, view2, z4, z5, onCreateMotionSpec, arrayList, arrayList2, rectF);
        float width = rectF.width();
        float height = rectF.height();
        createDependencyTranslationAnimation(view, view2, z4, onCreateMotionSpec, arrayList);
        createIconFadeAnimation(view, view2, z4, z5, onCreateMotionSpec, arrayList, arrayList2);
        createExpansionAnimation(view, view2, z4, z5, onCreateMotionSpec, width, height, arrayList, arrayList2);
        createColorAnimation(view, view2, z4, z5, onCreateMotionSpec, arrayList, arrayList2);
        createChildrenFadeAnimation(view, view2, z4, z5, onCreateMotionSpec, arrayList, arrayList2);
    ...
    protected abstract FabTransformationSpec onCreateMotionSpec(Context context, boolean z4);
