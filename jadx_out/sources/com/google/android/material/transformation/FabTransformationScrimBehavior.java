...
public class FabTransformationScrimBehavior extends ExpandableTransformationBehavior {
    ...
    private void createScrimAnimation(@NonNull View view, boolean z4, boolean z5, @NonNull List<Animator> list, List<Animator.AnimatorListener> list2) {
    ...
    @NonNull
    protected AnimatorSet onCreateExpandedStateChangeAnimation(@NonNull View view, @NonNull final View view2, final boolean z4, boolean z5) {
        ArrayList arrayList = new ArrayList();
        createScrimAnimation(view2, z4, z5, arrayList, new ArrayList());
