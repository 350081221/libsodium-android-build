...
public class SearchBarAnimationHelper {
    ...
    private ExpandCollapseAnimationHelper getExpandCollapseAnimationHelper(SearchBar searchBar, View view, @Nullable AppBarLayout appBarLayout) {
        ...
        return additionalUpdateListener.setCollapsedViewOffsetY(i5).addEndAnchoredViews(getEndAnchoredViews(view));
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$startExpandAnimation$0(SearchBar searchBar, View view, AppBarLayout appBarLayout, boolean z4) {
        AnimatorSet animatorSet = new AnimatorSet();
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void startExpandAnimation(final SearchBar searchBar, final View view, @Nullable final AppBarLayout appBarLayout, final boolean z4) {
        Animator animator;
        ...
        view.post(new Runnable() { // from class: com.google.android.material.search.c
            ...
            public final void run() {
                SearchBarAnimationHelper.this.lambda$startExpandAnimation$0(searchBar, view, appBarLayout, z4);
            }
        });
    }
