...
public class RippleUtils {
    ...
    private static class RippleUtilsLollipop {
        ...
        public static Drawable createOvalRipple(@NonNull Context context, @Px int i5) {
            ...
            return new RippleDrawable(MaterialColors.getColorStateList(context, com.google.android.material.R.attr.colorControlHighlight, ColorStateList.valueOf(0)), null, new InsetDrawable((Drawable) gradientDrawable, i5, i5, i5, i5));
        }
    }
