...
public abstract class HeaderBehavior<V extends View> extends ViewOffsetBehavior<V> {
    ...
    boolean canDragView(V v4) {
        return false;
    }

    final boolean fling(CoordinatorLayout coordinatorLayout, @NonNull V v4, int i5, int i6, float f5) {
        ...
        if (this.scroller.computeScrollOffset()) {
            ...
            ViewCompat.postOnAnimation(v4, flingRunnable);
            return true;
        }
    ...
    int getMaxDragOffset(@NonNull V v4) {
        return -v4.getHeight();
    }

    int getScrollRangeForDragFling(@NonNull V v4) {
        return v4.getHeight();
    }
    ...
    void onFlingFinished(CoordinatorLayout coordinatorLayout, V v4) {
    }
    ...
    public boolean onInterceptTouchEvent(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v4, @NonNull MotionEvent motionEvent) {
        ...
        if (motionEvent.getActionMasked() == 0) {
            ...
            if (canDragView(v4) && coordinatorLayout.isPointInChildBounds(v4, x4, y5)) {
                z4 = true;
            } else {
                z4 = false;
            }
    ...
    */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final int scroll(CoordinatorLayout coordinatorLayout, V v4, int i5, int i6, int i7) {
        return setHeaderTopBottomOffset(coordinatorLayout, v4, getTopBottomOffsetForScrollingSibling() - i5, i6, i7);
    }
    ...
    int setHeaderTopBottomOffset(CoordinatorLayout coordinatorLayout, V v4, int i5, int i6, int i7) {
        int clamp;
