...
public class BottomAppBar extends Toolbar implements CoordinatorLayout.AttachedBehavior {
    ...
    private void createMenuViewTranslationAnimation(final int i5, final boolean z4, @NonNull List<Animator> list) {
        ...
        if (Math.abs(actionMenuView.getTranslationX() - getActionMenuViewTranslationX(actionMenuView, i5, z4)) > 1.0f) {
            ...
            ofFloat2.addListener(new AnimatorListenerAdapter() { // from class: com.google.android.material.bottomappbar.BottomAppBar.7
                ...
                public void onAnimationEnd(Animator animator) {
                    ...
                    if (!this.cancelled) {
                        ...
                        BottomAppBar.this.translateActionMenuView(actionMenuView, i5, z4, z5);
                    }
                }
            });
    ...
    public float getFabTranslationX(int i5) {
        ...
        View findDependentView = findDependentView();
        int i7 = isLayoutRtl ? this.leftInset : this.rightInset;
        ...
        return ((getMeasuredWidth() / 2) - (i7 + i6)) * (isLayoutRtl ? -1 : 1);
    }
    ...
    protected void createFabDefaultXAnimation(final int i5, List<Animator> list) {
        FloatingActionButton findDependentFab = findDependentFab();
    ...
    protected int getActionMenuViewTranslationX(@NonNull ActionMenuView actionMenuView, int i5, boolean z4) {
        int i6;
        int left;
        int i7;
        boolean z5;
    ...
    boolean setFabDiameter(@Px int i5) {
        float f5 = i5;
    ...
    public void translateActionMenuView(@NonNull final ActionMenuView actionMenuView, final int i5, final boolean z4, boolean z5) {
        Runnable runnable = new Runnable() { // from class: com.google.android.material.bottomappbar.BottomAppBar.8
            @Override // java.lang.Runnable
            public void run() {
                actionMenuView.setTranslationX(BottomAppBar.this.getActionMenuViewTranslationX(r0, i5, z4));
            }
        };
        if (z5) {
