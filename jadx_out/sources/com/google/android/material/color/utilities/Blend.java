...
public class Blend {
    ...
    public static int cam16Ucs(int i5, int i6, double d5) {
    ...
    public static int hctHue(int i5, int i6, double d5) {
        return Hct.from(Cam16.fromInt(cam16Ucs(i5, i6, d5)).getHue(), Cam16.fromInt(i5).getChroma(), ColorUtils.lstarFromArgb(i5)).toInt();
    }
}
