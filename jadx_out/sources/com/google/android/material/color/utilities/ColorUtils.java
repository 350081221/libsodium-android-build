...
public class ColorUtils {
    ...
    public static int argbFromXyz(double d5, double d6, double d7) {
        ...
        double[] dArr3 = dArr[1];
        double d9 = (dArr3[0] * d5) + (dArr3[1] * d6) + (dArr3[2] * d7);
        double[] dArr4 = dArr[2];
        return argbFromRgb(delinearized(d8), delinearized(d9), delinearized((dArr4[0] * d5) + (dArr4[1] * d6) + (dArr4[2] * d7)));
    }
    ...
    public static int delinearized(double d5) {
        ...
        if (d6 <= 0.0031308d) {
            ...
            pow = (Math.pow(d6, 0.4166666666666667d) * 1.055d) - 0.055d;
        }
    ...
    static double labF(double d5) {
        return d5 > 0.008856451679035631d ? Math.pow(d5, 0.3333333333333333d) : ((d5 * 903.2962962962963d) + 16.0d) / 116.0d;
    }
    ...
    public static double[] labFromArgb(int i5) {
        ...
        return new double[]{(116.0d * labF2) - 16.0d, (labF - labF2) * 500.0d, (labF2 - labF(d10)) * 200.0d};
    }
    ...
    public static double linearized(int i5) {
        double d5 = i5 / 255.0d;
        return (d5 <= 0.040449936d ? d5 / 12.92d : Math.pow((d5 + 0.055d) / 1.055d, 2.4d)) * 100.0d;
    }
