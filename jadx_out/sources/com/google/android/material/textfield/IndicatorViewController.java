...
public final class IndicatorViewController {
    ...
    private void createCaptionAnimators(@NonNull List<Animator> list, boolean z4, @Nullable TextView textView, int i5, int i6, int i7) {
        ...
        if (textView != null && z4) {
            ...
            if (z5) {
                ...
                ObjectAnimator createCaptionOpacityAnimator = createCaptionOpacityAnimator(textView, z6);
                if (i5 == i7 && i6 != 0) {
                    z7 = true;
                }
                if (z7) {
    ...
    private int getIndicatorPadding(boolean z4, @DimenRes int i5, int i6) {
        return z4 ? this.context.getResources().getDimensionPixelSize(i5) : i6;
    }
    ...
    private void updateCaptionViewsVisibility(final int i5, final int i6, boolean z4) {
        ...
        if (z4) {
            ...
            createCaptionAnimators(arrayList, this.helperTextEnabled, this.helperTextView, 2, i5, i6);
            createCaptionAnimators(arrayList, this.errorEnabled, this.errorView, 1, i5, i6);
        ...
        this.textInputView.updateLabelState(z4);
