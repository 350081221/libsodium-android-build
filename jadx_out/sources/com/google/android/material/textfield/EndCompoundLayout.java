...
public class EndCompoundLayout extends LinearLayout {
    ...
    private void initEndIconView(TintTypedArray tintTypedArray) {
        ...
        if (tintTypedArray.hasValue(i8)) {
            ...
            if (tintTypedArray.hasValue(i11)) {
                this.endIconTintMode = ViewUtils.parseTintMode(tintTypedArray.getInt(i11, -1), null);
            }
    ...
    private void initErrorIconView(TintTypedArray tintTypedArray) {
        ...
        if (tintTypedArray.hasValue(i6)) {
            this.errorIconTintMode = ViewUtils.parseTintMode(tintTypedArray.getInt(i6, -1), null);
        }
    ...
    public void updateSuffixTextViewPadding() {
        ...
        if (!isEndIconVisible() && !isErrorIconVisible()) {
            i5 = ViewCompat.getPaddingEnd(this.textInputLayout.editText);
        } else {
            i5 = 0;
        }
        ViewCompat.setPaddingRelative(this.suffixTextView, getContext().getResources().getDimensionPixelSize(R.dimen.material_input_text_to_prefix_suffix_padding), this.textInputLayout.editText.getPaddingTop(), i5, this.textInputLayout.editText.getPaddingBottom());
    }
