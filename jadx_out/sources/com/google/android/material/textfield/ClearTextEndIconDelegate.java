...
public class ClearTextEndIconDelegate extends EndIconDelegate {
    ...
    public ClearTextEndIconDelegate(@NonNull EndCompoundLayout endCompoundLayout) {
        ...
        this.onFocusChangeListener = new View.OnFocusChangeListener() { // from class: com.google.android.material.textfield.e
            ...
            public final void onFocusChange(View view, boolean z4) {
                ClearTextEndIconDelegate.this.lambda$new$1(view, z4);
            }
        };
        Context context = endCompoundLayout.getContext();
        int i5 = R.attr.motionDurationShort3;
        this.animationFadeDuration = MotionUtils.resolveThemeDuration(context, i5, 100);
        this.animationScaleDuration = MotionUtils.resolveThemeDuration(endCompoundLayout.getContext(), i5, 150);
    ...
    private void animateIcon(boolean z4) {
        boolean z5;
