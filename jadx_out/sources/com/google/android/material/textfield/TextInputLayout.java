...
public class TextInputLayout extends LinearLayout implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public static class SavedState extends AbsSavedState {
        ...
        public String toString() {
            return "TextInputLayout.SavedState{" + Integer.toHexString(System.identityHashCode(this)) + " error=" + ((Object) this.error) + a1.i.f138d;
        }
    ...
    private MaterialShapeDrawable getDropDownMaterialShapeDrawable(boolean z4) {
        ...
        ShapeAppearanceModel build = ShapeAppearanceModel.builder().setTopLeftCornerSize(f5).setTopRightCornerSize(f5).setBottomLeftCornerSize(dimensionPixelOffset2).setBottomRightCornerSize(dimensionPixelOffset2).build();
        EditText editText2 = this.editText;
    ...
    protected void drawableStateChanged() {
        ...
        if (collapsingTextHelper != null) {
            z4 = collapsingTextHelper.setState(drawableState) | false;
        } else {
            z4 = false;
        }
        if (this.editText != null) {
    ...
    public void onGlobalLayout() {
        ...
        if (updateEditTextHeightBasedOnIcon || updateDummyDrawables) {
            this.editText.post(new Runnable() { // from class: com.google.android.material.textfield.q
