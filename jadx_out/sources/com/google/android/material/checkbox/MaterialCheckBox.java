...
public class MaterialCheckBox extends AppCompatCheckBox {
    ...
    public static class SavedState extends View.BaseSavedState {
        ...
        public String toString() {
            return "MaterialCheckBox.SavedState{" + Integer.toHexString(System.identityHashCode(this)) + " CheckedState=" + getCheckedStateString() + i.f138d;
        }
    ...
    static {
        ...
        FRAMEWORK_BUTTON_DRAWABLE_RES_ID = Resources.getSystem().getIdentifier("btn_check_material_anim", "drawable", SharedLibraryInfo.PLATFORM_PACKAGE_NAME);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.centerIfNoTextEnabled && TextUtils.isEmpty(getText()) && (buttonDrawable = CompoundButtonCompat.getButtonDrawable(this)) != null) {
            ...
            int width = ((getWidth() - buttonDrawable.getIntrinsicWidth()) / 2) * i5;
