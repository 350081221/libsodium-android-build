...
public class TooltipDrawable extends MaterialShapeDrawable implements TextDrawableHelper.TextDrawableDelegate {
    ...
    private void loadFromAttributes(@Nullable AttributeSet attributeSet, @AttrRes int i5, @StyleRes int i6) {
        ...
        boolean z4 = obtainStyledAttributes.getBoolean(R.styleable.Tooltip_showMarker, true);
        this.showMarker = z4;
        if (z4) {
    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        float f5 = (float) (-((this.arrowSize * Math.sqrt(2.0d)) - this.arrowSize));
        ...
        canvas.translate(calculatePointerOffset, f5);
        super.draw(canvas);
        drawText(canvas);
        canvas.restore();
    }
    ...
    public void setRevealFraction(@FloatRange(from = 0.0d, to = 1.0d) float f5) {
