...
public final class MaterialTimePicker extends DialogFragment implements TimePickerView.OnDoubleTapListener {
    ...
    public static final class Builder {
        ...
        public Builder setTimeFormat(int i5) {
            ...
            timeModel2.setMinute(i7);
            this.time.setHourOfDay(i6);
            return this;
        }
    ...
    private TimePickerPresenter initializeOrRetrieveActivePresenterForMode(int i5, @NonNull TimePickerView timePickerView, @NonNull ViewStub viewStub) {
        if (i5 == 0) {
    ...
    private void restoreState(@Nullable Bundle bundle) {
        ...
        this.inputMode = bundle.getInt(INPUT_MODE_EXTRA, i5);
    ...
    public final View onCreateView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        ...
        this.modeButton.setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.timepicker.MaterialTimePicker.3
            ...
            public void onClick(View view) {
                ...
                materialTimePicker.inputMode = i8;
