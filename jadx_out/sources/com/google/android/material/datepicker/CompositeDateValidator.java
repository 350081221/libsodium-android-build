...
public final class CompositeDateValidator implements CalendarConstraints.DateValidator {
    ...
    private static final Operator ANY_OPERATOR = new Operator() { // from class: com.google.android.material.datepicker.CompositeDateValidator.1
        ...
        @Override // com.google.android.material.datepicker.CompositeDateValidator.Operator
        public boolean isValid(@NonNull List<CalendarConstraints.DateValidator> list, long j5) {
    ...
    public interface Operator {
        ...
        boolean isValid(@NonNull List<CalendarConstraints.DateValidator> list, long j5);
    }
    ...
    public boolean isValid(long j5) {
        return this.operator.isValid(this.validators, j5);
    }
