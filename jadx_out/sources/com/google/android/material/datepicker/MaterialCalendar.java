                        ...
                        if (l5 != null && pair.second != null) {
                            ...
                            for (int i6 = spanCount; i6 <= spanCount2; i6++) {
                                ...
                                if (findViewByPosition3 != null) {
                                    ...
                                    if (i6 == spanCount && findViewByPosition != null) {
                                        i5 = findViewByPosition.getLeft() + (findViewByPosition.getWidth() / 2);
                                    } else {
                                        i5 = 0;
                                    }
                                    if (i6 == spanCount2 && findViewByPosition2 != null) {
                                        width = findViewByPosition2.getLeft() + (findViewByPosition2.getWidth() / 2);
                                    } else {
                                        width = recyclerView.getWidth();
                                    }
                                    canvas.drawRect(i5, top, width, bottom, MaterialCalendar.this.calendarStyle.rangeFill);
                                }
                            }
                        }
                    }
