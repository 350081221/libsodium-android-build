...
final class CalendarItemStyle {
    ...
    @NonNull
    public static CalendarItemStyle create(@NonNull Context context, @StyleRes int i5) {
        boolean z4;
        if (i5 != 0) {
            z4 = true;
        } else {
        ...
        Preconditions.checkArgument(z4, "Cannot create a CalendarItemStyle with a styleResId of 0");
