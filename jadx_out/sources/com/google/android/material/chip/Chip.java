...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate, Shapeable, MaterialCheckable<Chip> {
        ...
        protected void onPopulateNodeForVirtualView(int i5, @NonNull AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
            ...
            if (i5 == 1) {
                ...
                if (closeIconContentDescription != null) {
                    ...
                    accessibilityNodeInfoCompat.setContentDescription(context.getString(i6, objArr).trim());
                }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$new$0(CompoundButton compoundButton, boolean z4) {
    ...
    private void validateAttributes(@Nullable AttributeSet attributeSet) {
        ...
        if (attributeSet.getAttributeValue(NAMESPACE_ANDROID, ForeAndBackgroundEvent.BACKGROUND) != null) {
    ...
    protected void onFocusChanged(boolean z4, int i5, Rect rect) {
        ...
        if (this.touchHelperEnabled) {
            this.touchHelper.onFocusChanged(z4, i5, rect);
        }
    }
