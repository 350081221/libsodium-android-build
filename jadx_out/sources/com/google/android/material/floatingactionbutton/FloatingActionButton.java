...
public class FloatingActionButton extends VisibilityAwareImageButton implements TintableBackgroundView, TintableImageSourceView, ExpandableTransformationWidget, Shapeable, CoordinatorLayout.AttachedBehavior {
    ...
    public void setCompatHoveredFocusedTranslationZ(float f5) {
        getImpl().setHoveredFocusedTranslationZ(f5);
    }
    ...
    public void setCompatPressedTranslationZ(float f5) {
        getImpl().setPressedTranslationZ(f5);
    }
    ...
    public void setElevation(float f5) {
        ...
        getImpl().updateShapeElevation(f5);
    }

    public void setEnsureMinTouchTargetSize(boolean z4) {
        if (z4 != getImpl().getEnsureMinTouchTargetSize()) {
            getImpl().setEnsureMinTouchTargetSize(z4);
            requestLayout();
        }
    }
    ...
    public boolean setExpanded(boolean z4) {
        return this.expandableWidgetHelper.setExpanded(z4);
    }
    ...
    public void setImageResource(@DrawableRes int i5) {
        this.imageHelper.setImageResource(i5);
        onApplySupportImageTint();
    }
    ...
    public void setShadowPaddingEnabled(boolean z4) {
        getImpl().setShadowPaddingEnabled(z4);
    }
    ...
    public void setUseCompatPadding(boolean z4) {
        if (this.compatPadding != z4) {
            this.compatPadding = z4;
    ...
    */
    ...
    void hide(@Nullable OnVisibilityChangedListener onVisibilityChangedListener, boolean z4) {
        getImpl().hide(wrapOnVisibilityChangedListener(onVisibilityChangedListener), z4);
    }

    void show(@Nullable OnVisibilityChangedListener onVisibilityChangedListener, boolean z4) {
        getImpl().show(wrapOnVisibilityChangedListener(onVisibilityChangedListener), z4);
    }
}
