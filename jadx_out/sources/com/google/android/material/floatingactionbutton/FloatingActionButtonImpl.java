...
public class FloatingActionButtonImpl {
    ...
    private abstract class ShadowAnimatorImpl extends AnimatorListenerAdapter implements ValueAnimator.AnimatorUpdateListener {
        ...
        public void onAnimationUpdate(@NonNull ValueAnimator valueAnimator) {
            ...
            floatingActionButtonImpl.updateShapeElevation((int) (f5 + ((this.shadowSizeEnd - f5) * valueAnimator.getAnimatedFraction())));
        }
    }
    ...
    public void calculateImageMatrixFromScale(float f5, @NonNull Matrix matrix) {
        matrix.reset();
    ...
    private AnimatorSet createAnimator(@NonNull MotionSpec motionSpec, float f5, float f6, float f7) {
        ...
        ObjectAnimator ofObject = ObjectAnimator.ofObject(this.view, new ImageMatrixProperty(), new MatrixEvaluator() { // from class: com.google.android.material.floatingactionbutton.FloatingActionButtonImpl.3
            ...
            public Matrix evaluate(float f8, @NonNull Matrix matrix, @NonNull Matrix matrix2) {
                FloatingActionButtonImpl.this.imageMatrixScale = f8;
    ...
    private AnimatorSet createDefaultAnimator(final float f5, final float f6, final float f7, int i5, int i6) {
        AnimatorSet animatorSet = new AnimatorSet();
        ArrayList arrayList = new ArrayList();
        ...
        final float f8 = this.imageMatrixScale;
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.floatingactionbutton.FloatingActionButtonImpl.4
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                FloatingActionButtonImpl.this.imageMatrixScale = AnimationUtils.lerp(f8, f7, floatValue);
                FloatingActionButtonImpl.this.calculateImageMatrixFromScale(AnimationUtils.lerp(f8, f7, floatValue), matrix);
    ...
    private void workAroundOreoBug(ObjectAnimator objectAnimator) {
        ...
        objectAnimator.setEvaluator(new TypeEvaluator<Float>() { // from class: com.google.android.material.floatingactionbutton.FloatingActionButtonImpl.5
            ...
            public Float evaluate(float f5, Float f6, Float f7) {
                float floatValue = this.floatEvaluator.evaluate(f5, (Number) f6, (Number) f7).floatValue();
                if (floatValue < 0.1f) {
                    floatValue = 0.0f;
                }
    ...
    public void getPadding(@NonNull Rect rect) {
        ...
        int max = Math.max(touchTargetPadding, (int) Math.ceil(f5));
        int max2 = Math.max(touchTargetPadding, (int) Math.ceil(f5 * SHADOW_MULTIPLIER));
            ...
            createDefaultAnimator.addListener(new AnimatorListenerAdapter() { // from class: com.google.android.material.floatingactionbutton.FloatingActionButtonImpl.1
                ...
                public void onAnimationEnd(Animator animator2) {
                    ...
                    if (!this.cancelled) {
                        ...
                        floatingActionButton.internalSetVisibility(i6, z5);
    ...
    void onElevationsChanged(float f5, float f6, float f7) {
        jumpDrawableToCurrentState();
        updatePadding();
        updateShapeElevation(f5);
    }
    ...
    final void setImageMatrixScale(float f5) {
