...
public class BorderDrawable extends Drawable {
    ...
    public void setBorderWidth(@Dimension float f5) {
        if (this.borderWidth != f5) {
            this.borderWidth = f5;
            this.paint.setStrokeWidth(f5 * DRAW_STROKE_WIDTH_MULTIPLE);
            this.invalidateShader = true;
            invalidateSelf();
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void setGradientColors(@ColorInt int i5, @ColorInt int i6, @ColorInt int i7, @ColorInt int i8) {
        this.topOuterStrokeColor = i5;
        this.topInnerStrokeColor = i6;
        this.bottomOuterStrokeColor = i7;
        this.bottomInnerStrokeColor = i8;
    }
