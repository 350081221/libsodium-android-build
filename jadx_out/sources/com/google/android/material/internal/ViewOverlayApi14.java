    ...
    public static ViewOverlayApi14 createFrom(View view) {
        ...
        if (contentView != null) {
            ...
            for (int i5 = 0; i5 < childCount; i5++) {
                View childAt = contentView.getChildAt(i5);
    ...
    public static class OverlayViewGroup extends ViewGroup {
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            for (int i5 = 0; i5 < size; i5++) {
                this.drawables.get(i5).draw(canvas);
            }
        }
        ...
        protected ViewParent invalidateChildInParentFast(int i5, int i6, Rect rect) {
            if (this.hostView != null && invalidateChildInParentFastMethod != null) {
                try {
                    getOffset(new int[2]);
                    invalidateChildInParentFastMethod.invoke(this.hostView, Integer.valueOf(i5), Integer.valueOf(i6), rect);
                    return null;
