...
public class ScrimInsetsFrameLayout extends FrameLayout {
    ...
    public void setDrawBottomInsetForeground(boolean z4) {
        this.drawBottomInsetForeground = z4;
    }

    public void setDrawLeftInsetForeground(boolean z4) {
        this.drawLeftInsetForeground = z4;
    }

    public void setDrawRightInsetForeground(boolean z4) {
        this.drawRightInsetForeground = z4;
    }

    public void setDrawTopInsetForeground(boolean z4) {
        this.drawTopInsetForeground = z4;
    }
    ...
    public ScrimInsetsFrameLayout(@NonNull Context context, @Nullable AttributeSet attributeSet, int i5) {
