...
public final class ThemeEnforcement {
    ...
    private static void checkTextAppearance(@NonNull Context context, AttributeSet attributeSet, @NonNull @StyleableRes int[] iArr, @AttrRes int i5, @StyleRes int i6, @Nullable @StyleableRes int... iArr2) {
        boolean z4;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R.styleable.ThemeEnforcement, i5, i6);
        boolean z5 = false;
    ...
    private static boolean isCustomTextAppearanceValid(@NonNull Context context, AttributeSet attributeSet, @NonNull @StyleableRes int[] iArr, @AttrRes int i5, @StyleRes int i6, @NonNull @StyleableRes int... iArr2) {
    ...
    @NonNull
    public static TypedArray obtainStyledAttributes(@NonNull Context context, AttributeSet attributeSet, @NonNull @StyleableRes int[] iArr, @AttrRes int i5, @StyleRes int i6, @StyleableRes int... iArr2) {
    ...
    public static TintTypedArray obtainTintedStyledAttributes(@NonNull Context context, AttributeSet attributeSet, @NonNull @StyleableRes int[] iArr, @AttrRes int i5, @StyleRes int i6, @StyleableRes int... iArr2) {
        checkCompatibleTheme(context, attributeSet, i5, i6);
        checkTextAppearance(context, attributeSet, iArr, i5, i6, iArr2);
