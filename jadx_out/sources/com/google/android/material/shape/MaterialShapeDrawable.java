...
public class MaterialShapeDrawable extends Drawable implements TintAwareDrawable, Shapeable {
        ...
        ShapeAppearanceModel withTransformedCornerSizes = getShapeAppearanceModel().withTransformedCornerSizes(new ShapeAppearanceModel.CornerSizeUnaryOperator() { // from class: com.google.android.material.shape.MaterialShapeDrawable.2
            ...
            public CornerSize apply(@NonNull CornerSize cornerSize) {
                if (!(cornerSize instanceof RelativeCornerSize)) {
                    return new AdjustedCornerSize(f5, cornerSize);
                }
                return cornerSize;
            }
        });
    ...
    private boolean hasCompatShadow() {
        ...
        if (i5 != 1 && materialShapeDrawableState.shadowCompatRadius > 0 && (i5 == 2 || requiresCompatShadow())) {
            return true;
        }
        return false;
    }
    ...
    private void updateZ() {
        ...
        this.drawableState.shadowCompatOffset = (int) Math.ceil(z4 * SHADOW_OFFSET_MULTIPLIER);
        updateTintFilter();
    ...
    public boolean requiresCompatShadow() {
        ...
        if (!isRoundRect() && !this.path.isConvex() && i5 < 29) {
            return true;
        }
        return false;
    }
