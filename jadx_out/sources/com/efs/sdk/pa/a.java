...
public final class a implements PAANRListener {
    ...
    private PAFactory f6847a;

    /* renamed from: b, reason: collision with root package name */
    private PATraceListener f6848b;

    public a(PAFactory pAFactory) {
        this.f6847a = pAFactory;
        this.f6848b = pAFactory.getTraceListener();
        boolean enableTracer = pAFactory.getConfigManager().enableTracer();
        PATraceListener pATraceListener = this.f6848b;
