...
public class LaunchManager {
    ...
    private static LaunchConfigManager f6685a = null;

    /* renamed from: b, reason: collision with root package name */
    private static Context f6686b = null;

    /* renamed from: c, reason: collision with root package name */
    private static EfsReporter f6687c = null;

    /* renamed from: d, reason: collision with root package name */
    private static boolean f6688d = false;
    ...
    public static void init(Context context, final EfsReporter efsReporter) {
        ...
        if (!c.e(applicationContext)) {
            ...
            f6686b = context.getApplicationContext();
            f6687c = efsReporter;
            a.a(new Runnable() { // from class: com.efs.sdk.launch.LaunchManager.1
                @Override // java.lang.Runnable
                public final void run() {
                    try {
                        LaunchConfigManager unused = LaunchManager.f6685a = new LaunchConfigManager(applicationContext, efsReporter);
                        LaunchManager.a();
    ...
    public static void onTraceBegin(Context context, String str, long j5) {
        if (context != null) {
            try {
                if (!TextUtils.isEmpty(str)) {
    ...
    public static void onTraceEnd(Context context, String str, long j5) {
        if (context != null) {
            try {
                if (!TextUtils.isEmpty(str)) {
                    context.getApplicationContext();
