...
public class KVSection extends AbsSection {
    ...
    public KVSection putNum(String str, long j5) {
        this.dataMap.put(ILogProtocol.KEY_PREFIX_NUM.concat(String.valueOf(str)), Long.valueOf(j5));
        return this;
    }
    ...
    public KVSection putTimestamp(String str, long j5) {
        this.dataMap.put(ILogProtocol.KEY_PREFIX_TIMESTAMP.concat(String.valueOf(str)), Long.valueOf(j5));
        return this;
    }
}
