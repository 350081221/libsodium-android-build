...
public final class WXMediaMessage {
        ...
        public static WXMediaMessage fromBundle(Bundle bundle) {
            ...
            if (pathOldToNew != null && pathOldToNew.length() > 0) {
                try {
                    ...
                    Log.e(WXMediaMessage.TAG, "get media object from bundle failed: unknown ident " + pathOldToNew + ", ex = " + e5.getMessage());
                }
            }
            return wXMediaMessage;
        }
    ...
    public boolean checkArgs() {
        ...
        if (getType() == 8 && ((bArr4 = this.thumbData) == null || bArr4.length == 0)) {
            ...
            boolean z4 = true;
            if (!(getType() == 101) || ((bArr2 = this.thumbData) != null && bArr2.length <= 262144)) {
                if (!b.a(getType())) {
                    if (!(getType() == 101)) {
                        z4 = false;
                    }
                }
                if (z4 || (bArr = this.thumbData) == null || bArr.length <= 65536) {
    ...
    public void setThumbImage(Bitmap bitmap) {
        try {
            ...
            Log.e(TAG, "setThumbImage exception:" + e5.getMessage());
        }
    }
}
