...
class BaseWXApiImplV10 implements IWXAPI {
    ...
    public BaseWXApiImplV10(Context context, String str, boolean z4, int i5) {
        this.checkSignature = false;
        this.launchMode = 2;
        Log.d(TAG, "<init>, appId = " + str + ", checkSignature = " + z4 + ", launchMode = " + i5);
        this.context = context;
        this.appId = str;
        this.checkSignature = z4;
        this.launchMode = i5;
        b.f11281a = context.getApplicationContext();
        this.securityHelper = new WXAPiSecurityHelper(context.getApplicationContext());
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void callbackReq(SendReqCallback sendReqCallback, boolean z4) {
        if (sendReqCallback != null) {
            sendReqCallback.onSendFinish(z4);
        }
    }
    ...
    public boolean doLaunchApp(Bundle bundle) {
        ...
        try {
            ...
            Log.e(TAG, "getTokenFromWX fail, exception = " + e5);
        }
    ...
    private String getTokenFromWX(Context context) {
        Cursor query = context.getContentResolver().query(Uri.parse("content://com.tencent.mm.sdk.comm.provider/genTokenForOpenSdk"), null, null, new String[]{this.appId, "638065664"}, null);
    ...
    private boolean handleWxInternalRespType(String str, IWXAPIEventHandler iWXAPIEventHandler) {
        ...
        try {
            ...
            Log.e(TAG, "handleWxInternalRespType fail, ex = " + e5.getMessage());
        }
    ...
    private void launchWXUsingPendingIntent() {
        ...
        try {
            ...
            PendingIntent.getActivity(this.context, 1, this.context.getPackageManager().getLaunchIntentForPackage("com.tencent.mm"), PackageParserEx.GET_SIGNING_CERTIFICATES).send(this.context, 2, null, new PendingIntent.OnFinished() { // from class: com.tencent.mm.opensdk.openapi.BaseWXApiImplV10.3
                @Override // android.app.PendingIntent.OnFinished
                public void onSendFinished(PendingIntent pendingIntent, Intent intent, int i5, String str, Bundle bundle) {
                    Log.d(BaseWXApiImplV10.TAG, "onSendFinished resultCode: " + i5 + ", resultData: " + str);
                }
            }, null);
        } catch (Exception e5) {
            Log.e(TAG, "launchWXUsingPendingIntent pendingIntent send failed: " + e5.getMessage());
            openWXApp();
        }
    }
    ...
    private boolean sendPayReq(Context context, Bundle bundle) {
        if (wxappPayEntryClassname == null) {
            ...
            if (wxappPayEntryClassname == null) {
                try {
                    ...
                    Log.e(TAG, "get from metaData failed : " + e5.getMessage());
                }
            }
            if (wxappPayEntryClassname == null) {
        ...
        try {
            ...
            Log.e(TAG, "getTokenFromWX fail, exception = " + e6);
        }
    ...
    public int getWXAppSupportAPI() {
        ...
        if (this.wxSdkVersion == 0) {
            ...
            b.f11282b.submit(new Runnable() { // from class: com.tencent.mm.opensdk.openapi.BaseWXApiImplV10.1
                ...
                public void run() {
                    try {
                        ...
                        Log.w(BaseWXApiImplV10.TAG, e6.getMessage());
                    }
    ...
    public boolean handleIntent(Intent intent, IWXAPIEventHandler iWXAPIEventHandler) {
        try {
            ...
            Log.e(TAG, "handleIntent fail, ex = " + e5.getMessage());
        }
                ...
                case 4:
                    ...
                    if (str != null && str.contains("openbusinesswebview")) {
                        try {
                            ...
                            Log.e(TAG, "parse fail, ex = " + e6.getMessage());
                        }
                    }
    ...
    public boolean isWXAppInstalled() {
        ...
        try {
            ...
            Log.w(TAG, "isWXAppInstalled ex:" + e5.getMessage());
            return false;
        }
    }
    ...
    public boolean openWXApp() {
        ...
        if (isWXAppInstalled()) {
            try {
                ...
                str = "startActivity fail, exception = " + e5.getMessage();
            }
        } else {
    ...
    @Override // com.tencent.mm.opensdk.openapi.IWXAPI
    public boolean registerApp(String str, long j5) {
        if (this.detached) {
        ...
        c0225a.f11242a = "com.tencent.mm";
        c0225a.f11243b = ConstantsAPI.ACTION_HANDLE_APP_REGISTER;
        c0225a.f11244c = "weixin://registerapp?appid=" + this.appId;
        c0225a.f11245d = j5;
        return a.a(this.context, c0225a);
    }
    ...
    public boolean sendReq(BaseReq baseReq, final SendReqCallback sendReqCallback) {
        ...
        int doExtraSecurityCheck = this.securityHelper.doExtraSecurityCheck(this.appId, "638065664", extractMayNeedDoSecurityCheckUrl, new WXAPiSecurityHelper.ISecurityCheck() { // from class: com.tencent.mm.opensdk.openapi.BaseWXApiImplV10.2
            @Override // com.tencent.mm.opensdk.openapi.WXAPiSecurityHelper.ISecurityCheck
            public void onCheckFinish(boolean z4) {
                if (!z4) {
    ...
    public void unregisterApp() {
        ...
        a.C0225a c0225a = new a.C0225a();
        c0225a.f11242a = "com.tencent.mm";
        c0225a.f11243b = ConstantsAPI.ACTION_HANDLE_APP_UNREGISTER;
        c0225a.f11244c = "weixin://unregisterapp?appid=" + this.appId;
        a.a(this.context, c0225a);
    }
}
