...
public class MMKVContentProvider extends ContentProvider {
    ...
    private Bundle mmkvFromAshmemID(String str, int i5, int i6, String str2) throws RuntimeException {
        MMKV mmkvWithAshmemID = MMKV.mmkvWithAshmemID(getContext(), str, i5, i6, str2);
