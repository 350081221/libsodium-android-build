...
public class ZIDManager {
    ...
    public static ZIDManager f13625d;
    ...
    public class a implements Runnable {
        ...
        /* renamed from: b, reason: collision with root package name */
        public final /* synthetic */ IZIDCompletionCallback f13630b;

        public a(Context context, IZIDCompletionCallback iZIDCompletionCallback) {
            this.f13629a = context;
            this.f13630b = iZIDCompletionCallback;
        }

        @Override // java.lang.Runnable
        public void run() {
            String a5 = ZIDManager.a(ZIDManager.this, this.f13629a);
            if (TextUtils.isEmpty(a5)) {
                IZIDCompletionCallback iZIDCompletionCallback = this.f13630b;
            ...
            IZIDCompletionCallback iZIDCompletionCallback2 = this.f13630b;
            if (iZIDCompletionCallback2 != null) {
                iZIDCompletionCallback2.onSuccess(a5);
            }
        }
    }
    ...
    public class b implements Runnable {
        ...
        @Override // java.lang.Runnable
        public void run() {
            ZIDManager.this.b(this.f13632a);
        }
    }
    ...
    public class c implements Runnable {
        ...
        @Override // java.lang.Runnable
        public void run() {
            ZIDManager.a(ZIDManager.this, this.f13634a);
        }
    }
    ...
    */
    ...
    public static void configureDomain(Context context, String str) {
        ...
        String b5 = d.b(str);
        if (context == null || b5 == null || TextUtils.isEmpty(b5) || (a5 = com.umeng.umzid.a.a(context)) == null || (edit = a5.edit()) == null) {
            return;
        }
        edit.putString("inputDomain", b5).commit();
    }
    ...
    */
    ...
    public synchronized String getZID(Context context) {
        ...
        String d5 = d.d(applicationContext);
    ...
    /* JADX WARN: Removed duplicated region for block: B:39:0x0077 A[Catch: all -> 0x00a4, TryCatch #1 {, blocks: (B:3:0x0001, B:10:0x000f, B:13:0x0018, B:16:0x0020, B:19:0x0029, B:22:0x0031, B:24:0x0037, B:26:0x003d, B:28:0x0043, B:29:0x004c, B:31:0x0052, B:34:0x0059, B:36:0x0063, B:37:0x006f, B:39:0x0077, B:40:0x007f, B:42:0x0085, B:46:0x0095, B:51:0x0067), top: B:2:0x0001 }] */
    /* JADX WARN: Removed duplicated region for block: B:42:0x0085 A[Catch: all -> 0x00a4, TRY_LEAVE, TryCatch #1 {, blocks: (B:3:0x0001, B:10:0x000f, B:13:0x0018, B:16:0x0020, B:19:0x0029, B:22:0x0031, B:24:0x0037, B:26:0x003d, B:28:0x0043, B:29:0x004c, B:31:0x0052, B:34:0x0059, B:36:0x0063, B:37:0x006f, B:39:0x0077, B:40:0x007f, B:42:0x0085, B:46:0x0095, B:51:0x0067), top: B:2:0x0001 }] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public synchronized void init(android.content.Context r4, java.lang.String r5, com.umeng.umzid.IZIDCompletionCallback r6) {
        /*
            r3 = this;
            monitor-enter(r3)
            boolean r0 = com.umeng.umzid.d.h(r4)     // Catch: java.lang.Throwable -> La4
            r3.f13628c = r0     // Catch: java.lang.Throwable -> La4
            if (r0 != 0) goto Lb
            monitor-exit(r3)
            return
        Lb:
            ...
            r6.onFailure(r4, r5)     // Catch: java.lang.Throwable -> La4
        L16:
            monitor-exit(r3)
            return
        L18:
            boolean r0 = android.text.TextUtils.isEmpty(r5)     // Catch: java.lang.Throwable -> La4
            if (r0 == 0) goto L29
            if (r6 == 0) goto L27
        ...
        L27:
            ...
            return
        L29:
            android.content.Context r0 = r4.getApplicationContext()     // Catch: java.lang.Throwable -> La4
            if (r0 == 0) goto L4c
            if (r5 == 0) goto L4c
            boolean r1 = android.text.TextUtils.isEmpty(r5)     // Catch: java.lang.Throwable -> La4
            if (r1 != 0) goto L4c
            android.content.SharedPreferences r1 = com.umeng.umzid.a.a(r0)     // Catch: java.lang.Throwable -> La4
            if (r1 == 0) goto L4c
            android.content.SharedPreferences$Editor r1 = r1.edit()     // Catch: java.lang.Throwable -> La4
            if (r1 == 0) goto L4c
            java.lang.String r2 = "appkey"
            android.content.SharedPreferences$Editor r5 = r1.putString(r2, r5)     // Catch: java.lang.Throwable -> La4
            r5.commit()     // Catch: java.lang.Throwable -> La4
        L4c:
            java.lang.String r5 = com.umeng.umzid.d.d(r0)     // Catch: java.lang.Throwable -> La4
            if (r5 == 0) goto L67
            boolean r1 = android.text.TextUtils.isEmpty(r5)     // Catch: java.lang.Throwable -> La4
            if (r1 == 0) goto L59
            goto L67
        L59:
            com.umeng.umzid.ZIDManager$b r1 = new com.umeng.umzid.ZIDManager$b     // Catch: java.lang.Throwable -> La4
            r1.<init>(r0)     // Catch: java.lang.Throwable -> La4
            com.umeng.umzid.c.a(r1)     // Catch: java.lang.Throwable -> La4
            if (r6 == 0) goto L6f
            r6.onSuccess(r5)     // Catch: java.lang.Throwable -> La4
            goto L6f
        L67:
            com.umeng.umzid.ZIDManager$a r5 = new com.umeng.umzid.ZIDManager$a     // Catch: java.lang.Throwable -> La4
            r5.<init>(r0, r6)     // Catch: java.lang.Throwable -> La4
            com.umeng.umzid.c.a(r5)     // Catch: java.lang.Throwable -> La4
        L6f:
            java.lang.String r5 = ""
            android.content.SharedPreferences r6 = com.umeng.umzid.a.a(r4)     // Catch: java.lang.Throwable -> La4
            if (r6 == 0) goto L7f
            java.lang.String r5 = "uuid"
            java.lang.String r0 = ""
            java.lang.String r5 = r6.getString(r5, r0)     // Catch: java.lang.Throwable -> La4
        L7f:
            boolean r5 = android.text.TextUtils.isEmpty(r5)     // Catch: java.lang.Throwable -> La4
            if (r5 == 0) goto La2
            java.lang.String r5 = ""
            android.content.SharedPreferences r4 = com.umeng.umzid.a.a(r4)     // Catch: java.lang.Throwable -> La4
        ...
        L93:
            if (r4 == 0) goto La2
            android.content.SharedPreferences$Editor r4 = r4.edit()     // Catch: java.lang.Throwable -> La4
            java.lang.String r6 = "uuid"
            android.content.SharedPreferences$Editor r4 = r4.putString(r6, r5)     // Catch: java.lang.Throwable -> La4
            r4.commit()     // Catch: java.lang.Throwable -> La4
        La2:
            monitor-exit(r3)
            return
        La4:
    ...
    /* JADX WARN: Code restructure failed: missing block: B:84:0x00e3, code lost:
        ...
        r6 = null;
     */
    /* JADX WARN: Removed duplicated region for block: B:10:0x0073 A[Catch: all -> 0x0087, TryCatch #5 {all -> 0x0087, blocks: (B:6:0x0063, B:8:0x0069, B:10:0x0073, B:12:0x0080, B:14:0x0084), top: B:5:0x0063 }] */
    /* JADX WARN: Removed duplicated region for block: B:23:0x00f2  */
    /* JADX WARN: Removed duplicated region for block: B:26:0x010a  */
    /* JADX WARN: Removed duplicated region for block: B:38:0x0175  */
    /* JADX WARN: Removed duplicated region for block: B:47:0x0196 A[Catch: all -> 0x01aa, TryCatch #6 {all -> 0x01aa, blocks: (B:43:0x0186, B:45:0x018c, B:47:0x0196, B:49:0x01a3, B:51:0x01a7), top: B:42:0x0186 }] */
