...
public class ReportPolicy {
    ...
    public static class DebugPolicy extends ReportStrategy {
        ...
        public boolean shouldSendMessage(boolean z4) {
    ...
    public static class ReportByInterval extends ReportStrategy {
        ...
        public ReportByInterval(StatTracer statTracer, long j5) {
            this.mTracer = statTracer;
            setReportInterval(j5);
        }

        public static boolean isValidValue(int i5) {
            return ((long) i5) >= MIN_REPORT_INTERVAL;
        }
        ...
        public void setReportInterval(long j5) {
            long j6 = MIN_REPORT_INTERVAL;
            if (j5 >= j6 && j5 <= MAX_REPORT_INTERVAL) {
                this.mReportInterval = j5;
            } else {
                this.mReportInterval = j6;
            }
        }

        @Override // com.umeng.commonsdk.statistics.common.ReportPolicy.ReportStrategy
        public boolean shouldSendMessage(boolean z4) {
            return z4 || System.currentTimeMillis() - UMEnvelopeBuild.getLastSuccessfulBuildTime(UMModuleRegister.getAppContext()) >= this.mReportInterval;
        }
    }
    ...
    public static class ReportQuasiRealtime extends ReportStrategy {
        ...
        public void setReportInterval(long j5) {
            if (j5 >= MIN_REPORT_INTERVAL && j5 <= MAX_REPORT_INTERVAL) {
                this.mReportInterval = j5;
            } else {
