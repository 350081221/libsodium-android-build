...
public class DataHelper {
    ...
    public static boolean largeThanMaxSize(long j5, long j6) {
        return j5 > j6;
    }

    public static int random(int i5, String str) {
        if (new Random().nextFloat() < 0.001d) {
            ...
            try {
                i6 = Integer.parseInt(str.substring(9, 11), 16);
            } catch (Exception unused) {
            }
            return (i6 | 128) * 1000;
        }
    ...
    public static byte[] reverseHexString(String str) {
        ...
        while (i5 < length) {
            int i6 = i5 + 2;
            bArr[i5 / 2] = (byte) Integer.valueOf(str.substring(i5, i6), 16).intValue();
            i5 = i6;
        }
        return bArr;
    }
