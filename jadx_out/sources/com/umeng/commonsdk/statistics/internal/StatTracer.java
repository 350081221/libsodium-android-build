...
public class StatTracer implements b {
    ...
    private static class a {
        ...
        public static final StatTracer f13340a = new StatTracer();
    ...
    public long getFirstActivateTime() {
        SharedPreferences sharedPreferences = PreferenceWrapper.getDefault(mContext);
        long j5 = PreferenceWrapper.getDefault(mContext).getLong(KEY_FIRST_ACTIVATE_TIME, 0L);
        this.firstActivateTime = j5;
        if (j5 == 0) {
    ...
    public int getLastRequestLatency() {
        int i5 = this.mLastRequestLatency;
        if (i5 > 3600000) {
            return 3600000;
        }
        return i5;
    ...
    public void logSuccessfulRequest(boolean z4) {
    ...
    @Override // com.umeng.commonsdk.statistics.internal.b
    public void onRequestSucceed(boolean z4) {
        logSuccessfulRequest(z4);
    }
