...
public class d {
    ...
    public static int f13241a;

    /* renamed from: b, reason: collision with root package name */
    private static Object f13242b = new Object();
    ...
    public static File[] c(Context context) {
        ...
        try {
            synchronized (f13242b) {
                String str = context.getApplicationContext().getFilesDir() + File.separator + a.f13219f;
    ...
    */
    public static int a(android.content.Context r6, java.lang.String r7, java.lang.String r8, byte[] r9) {
        /*
            ...
            if (r6 == 0) goto L75
            r1 = 0
            java.lang.Object r2 = com.umeng.commonsdk.stateless.d.f13242b     // Catch: java.lang.Throwable -> L5d java.io.IOException -> L67
        ...
        synchronized (f13242b) {
            ...
            try {
                try {
                    ...
                    ULog.i("walle", "[stateless] write envelope, e is " + e5.getMessage());
                    throw e5;
                }
            } catch (Throwable th) {
                if (fileChannel != null) {
        ...
        try {
            synchronized (f13242b) {
                ...
                if (context != null && context.getApplicationContext() != null) {
                    String str = context.getApplicationContext().getFilesDir() + File.separator + a.f13218e;
                    if (!TextUtils.isEmpty(str)) {
    ...
    public static String a(Context context, boolean z4) {
        ...
        try {
            if (z4) {
                str = context.getApplicationContext().getFilesDir() + File.separator + a.f13218e;
            } else {
                str = context.getApplicationContext().getFilesDir() + File.separator + a.f13219f;
            }
            str2 = str;
            return str2;
        } catch (Throwable unused) {
                    ...
                    if (arrayList.size() >= i5) {
                        ...
                        if (ULog.DEBUG) {
                            for (int i6 = 0; i6 < arrayList.size(); i6++) {
                                ULog.i("AmapLBS", "[lbs-build] overrun native file is " + ((File) arrayList.get(i6)).getPath());
                            }
                        }
    ...
    public static void a(Context context, String str, final String str2, int i5) {
        if (str == null) {
            return;
        }
        try {
