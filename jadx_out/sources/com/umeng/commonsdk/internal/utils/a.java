...
public class a {
    ...
    public static List<C0245a> g(Context context) {
        String[] list;
        if (context == null) {
            return null;
        }
    ...
    public static int d(Context context) {
        ...
        Resources resources = context.getResources();
        return resources.getDimensionPixelSize(resources.getIdentifier("navigation_bar_height", "dimen", SharedLibraryInfo.PLATFORM_PACKAGE_NAME));
    }
