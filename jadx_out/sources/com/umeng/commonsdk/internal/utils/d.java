...
public class d {
    ...
    */
    ...
    public static String b() {
        String str = "";
        try {
            InputStream inputStream = new ProcessBuilder("/system/bin/cat", com.tendcloud.tenddata.k.f11748a).start().getInputStream();
    ...
    public static String c() {
        String str = "";
        try {
            InputStream inputStream = new ProcessBuilder("/system/bin/cat", com.tendcloud.tenddata.k.f11749b).start().getInputStream();
            byte[] bArr = new byte[24];
            while (inputStream.read(bArr) != -1) {
                str = str + new String(bArr);
            }
    ...
    public static String d() {
        ...
        try {
            bufferedReader = new BufferedReader(new FileReader(com.tendcloud.tenddata.k.f11750c));
            try {
