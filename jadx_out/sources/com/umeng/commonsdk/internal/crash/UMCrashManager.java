...
public class UMCrashManager {
            ...
            synchronized (mObject) {
                if (context != null && obj != null) {
                    ...
                    if (!TextUtils.isEmpty(str)) {
                        String str2 = context.getFilesDir() + File.separator + com.umeng.commonsdk.stateless.a.f13219f;
                        ...
                        try {
                            ...
                            jSONObject.put(bi.aR, CM_VERSION);
    ...
    public static void reportCrash(Context context, Throwable th) {
        synchronized (mObject) {
            if (!isReportCrash) {
                isReportCrash = true;
                UMWorkDispatch.sendEvent(context, com.umeng.commonsdk.internal.a.f13140u, b.a(context).a(), a.a(th));
            }
        }
    }
}
