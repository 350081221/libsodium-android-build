...
public class UMProcessDBHelper {
    ...
    public class InsertEventCallback implements FileLockCallback {
        ...
        public boolean onFileLock(String str, Object obj) {
            ...
            String str2 = com.umeng.analytics.process.a.f12799c;
            if (str.startsWith(str2)) {
                str = str.replaceFirst(str2, "");
            }
            UMProcessDBHelper.this.insertEvents(str.replace(com.umeng.analytics.process.a.f12800d, ""), (JSONArray) obj);
            return true;
        }
    }
    ...
    private class ProcessToMainCallback implements FileLockCallback {
        ...
        public boolean onFileLock(String str) {
            ...
            UMProcessDBHelper.this.processToMain(str.replace(com.umeng.analytics.process.a.f12800d, ""));
            return true;
        }
    ...
    private List<a> datasAdapter(String str, JSONArray jSONArray) {
        ...
        for (int i5 = 0; i5 < jSONArray.length(); i5++) {
            try {
                ...
                a aVar = new a();
                aVar.f12790c = jSONObject.optString("id");
                aVar.f12794g = UMUtils.getAppVersionName(this.mContext);
                aVar.f12795h = UMUtils.getAppVersionCode(this.mContext);
                aVar.f12789b = jSONObject.optString("__i");
                aVar.f12792e = jSONObject.optInt("__t");
                aVar.f12793f = str;
                ...
                aVar.f12791d = com.umeng.common.a.a().a(jSONObject.toString());
                jSONObject.remove("ds");
                arrayList.add(aVar);
    ...
    private boolean insertEvents_(String str, List<a> list) {
        ...
        try {
            SQLiteDatabase a5 = c.a(this.mContext).a(str);
            try {
                try {
                    a5.beginTransaction();
                    for (a aVar : list) {
                        try {
                            ...
                            contentValues.put("__i", aVar.f12789b);
                            contentValues.put("__e", aVar.f12790c);
                            contentValues.put("__t", Integer.valueOf(aVar.f12792e));
                            contentValues.put(a.InterfaceC0241a.f12810f, aVar.f12793f);
                            contentValues.put("__av", aVar.f12794g);
                            contentValues.put("__vc", aVar.f12795h);
                            contentValues.put("__s", aVar.f12791d);
                            SQLiteInstrumentation.insert(a5, a.InterfaceC0241a.f12805a, null, contentValues);
                        } catch (Exception unused) {
                        }
                    }
    ...
    public void processToMain(String str) {
        ...
        if (!readEventByProcess.isEmpty() && insertEvents_(com.umeng.analytics.process.a.f12804h, readEventByProcess)) {
    ...
    */
    private java.util.List<com.umeng.analytics.process.UMProcessDBHelper.a> readEventByProcess(java.lang.String r13) {
        /*
            ...
            r10 = 0
            r3 = r2
            android.database.Cursor r3 = com.huawei.agconnect.apms.instrument.SQLiteInstrumentation.query(r3, r4, r5, r6, r7, r8, r9, r10)     // Catch: java.lang.Throwable -> L94 java.lang.Exception -> L96
            if (r3 == 0) goto L8e
        L22:
            ...
            r4.f12788a = r5     // Catch: java.lang.Exception -> L8c java.lang.Throwable -> Lb9
            ...
            r4.f12789b = r5     // Catch: java.lang.Exception -> L8c java.lang.Throwable -> Lb9
            java.lang.String r5 = "__e"
            int r5 = r3.getColumnIndex(r5)     // Catch: java.lang.Exception -> L8c java.lang.Throwable -> Lb9
            java.lang.String r5 = r3.getString(r5)     // Catch: java.lang.Exception -> L8c java.lang.Throwable -> Lb9
            r4.f12790c = r5     // Catch: java.lang.Exception -> L8c java.lang.Throwable -> Lb9
            java.lang.String r5 = "__s"
            int r5 = r3.getColumnIndex(r5)     // Catch: java.lang.Exception -> L8c java.lang.Throwable -> Lb9
            java.lang.String r5 = r3.getString(r5)     // Catch: java.lang.Exception -> L8c java.lang.Throwable -> Lb9
            r4.f12791d = r5     // Catch: java.lang.Exception -> L8c java.lang.Throwable -> Lb9
            java.lang.String r5 = "__t"
            int r5 = r3.getColumnIndex(r5)     // Catch: java.lang.Exception -> L8c java.lang.Throwable -> Lb9
            int r5 = r3.getInt(r5)     // Catch: java.lang.Exception -> L8c java.lang.Throwable -> Lb9
            r4.f12792e = r5     // Catch: java.lang.Exception -> L8c java.lang.Throwable -> Lb9
            java.lang.String r5 = "__pn"
            int r5 = r3.getColumnIndex(r5)     // Catch: java.lang.Exception -> L8c java.lang.Throwable -> Lb9
            java.lang.String r5 = r3.getString(r5)     // Catch: java.lang.Exception -> L8c java.lang.Throwable -> Lb9
            r4.f12793f = r5     // Catch: java.lang.Exception -> L8c java.lang.Throwable -> Lb9
            java.lang.String r5 = "__av"
            int r5 = r3.getColumnIndex(r5)     // Catch: java.lang.Exception -> L8c java.lang.Throwable -> Lb9
            java.lang.String r5 = r3.getString(r5)     // Catch: java.lang.Exception -> L8c java.lang.Throwable -> Lb9
            r4.f12794g = r5     // Catch: java.lang.Exception -> L8c java.lang.Throwable -> Lb9
            java.lang.String r5 = "__vc"
            int r5 = r3.getColumnIndex(r5)     // Catch: java.lang.Exception -> L8c java.lang.Throwable -> Lb9
            java.lang.String r5 = r3.getString(r5)     // Catch: java.lang.Exception -> L8c java.lang.Throwable -> Lb9
            r4.f12795h = r5     // Catch: java.lang.Exception -> L8c java.lang.Throwable -> Lb9
        ...
        try {
            ...
            if (size > 0) {
                for (int i5 = 0; i5 < size; i5++) {
                    SQLiteInstrumentation.execSQL(sQLiteDatabase, "delete from __et_p where rowid=" + list.get(i5).f12788a);
                }
            } else {
                SQLiteInstrumentation.delete(sQLiteDatabase, a.InterfaceC0241a.f12805a, null, null);
            }
    ...
    */
    public void deleteMainProcessEventDatasByIds(java.util.List<java.lang.Integer> r8) {
        ...
        L14:
            ...
            com.huawei.agconnect.apms.instrument.SQLiteInstrumentation.delete(r1, r3, r4, r5)     // Catch: java.lang.Throwable -> L36 java.lang.Exception -> L46
            goto L14
        L32:
    ...
    */
    ...
    public JSONObject readVersionInfoFromColumId(Integer num) {
        ...
        cursor = null;
        try {
            sQLiteDatabase = c.a(this.mContext).a(com.umeng.analytics.process.a.f12804h);
            try {
                try {
                    sQLiteDatabase.beginTransaction();
                    Cursor query = SQLiteInstrumentation.query(sQLiteDatabase, a.InterfaceC0241a.f12805a, null, "rowid=?", new String[]{String.valueOf(num)}, null, null, null);
                    if (query != null) {
                        try {
                            try {
                                if (query.moveToNext()) {
                                    ...
                                    try {
                                        ...
                                        if (cursor != null) {
                                            try {
                                                ...
                                                c.a(this.mContext).b(com.umeng.analytics.process.a.f12804h);
                                                return jSONObject;
                                            }
                                        }
                                        if (sQLiteDatabase != null) {
