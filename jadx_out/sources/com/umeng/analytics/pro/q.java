...
public class q {
    public static JSONObject a(Context context, long j5, JSONObject jSONObject) {
        ...
        try {
            ...
            if (jSONObject3.has("analytics")) {
                ...
                if (jSONObject4.has(d.Z)) {
                    jSONObject4.remove(d.Z);
                }
                if (jSONObject4.has(d.U)) {
                    jSONObject4.remove(d.U);
                }
