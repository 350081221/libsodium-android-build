...
public class UMCrashContent {
    ...
    public static final String APM_STATE_FLUTTER = "apm_flutter_state";
    public static final String APM_STATE_HIT_WL = "hit_wl";
    public static final String APM_STATE_NATIVE_H5 = "apm_native_h5_state";
    public static final String APM_STATE_NET = "apm_netperf_state";
    public static final String APM_STATE_NET_REQUEST_BODY = "apm_netperf_bd_state";
    public static final String APM_STATE_PAGE = "apm_page_state";
    public static final String APM_STATE_POWER = "apm_power_state";
