...
public class a {
    ...
    public static String b(@NonNull Uri uri) {
        ...
        return b.a(uri.getQueryParameter("id"), uri.getQueryParameter("packagename"), uri.getQueryParameter("pkg"), uri.getQueryParameter(bi.f12269o), uri.getQueryParameter("appId"));
    }
