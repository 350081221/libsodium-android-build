...
public class d implements com.ss.android.socialbase.appdownloader.c.g, k {
    ...
    public void a(DownloadInfo downloadInfo, boolean z4) {
        ...
        a(downloadInfo, downloadInfo.getRealStatus(), z4);
    }
        ...
        com.ss.android.downloadlib.d.a().a(new Runnable() { // from class: com.ss.android.downloadlib.c.d.1
            ...
            public void run() {
                ...
                for (com.ss.android.downloadad.api.a.b bVar : com.ss.android.downloadlib.addownload.b.f.a().c().values()) {
                    int s5 = bVar.s();
                    if (s5 != 0) {
                        com.ss.android.socialbase.downloader.g.a a5 = com.ss.android.socialbase.downloader.g.a.a(s5);
                        if (a5.b("notification_opt_2") == 1 && (downloadInfo = Downloader.getInstance(com.ss.android.downloadlib.addownload.k.a()).getDownloadInfo(s5)) != null) {
                            if (m.b(bVar) && !m.c(bVar.e())) {
                                int spIntVal2 = downloadInfo.getSpIntVal("restart_notify_open_app_count");
                                if (spIntVal2 < a5.a("noti_open_restart_times", 1)) {
                                    h.a().e(bVar);
                                ...
                                if (spIntVal3 < a5.a("noti_continue_restart_times", 1)) {
                                    h.a().a(bVar);
                                    downloadInfo.setSpValue("restart_notify_continue_count", String.valueOf(spIntVal3 + 1));
                                }
                            } else if (downloadInfo.getRealStatus() == -3 && com.ss.android.socialbase.downloader.i.f.c(downloadInfo) && !m.b(bVar) && (spIntVal = downloadInfo.getSpIntVal("restart_notify_install_count")) < a5.a("noti_install_restart_times", 1)) {
                                h.a().c(bVar);
    ...
    @WorkerThread
    public void a(DownloadInfo downloadInfo, int i5, boolean z4) {
        com.ss.android.downloadlib.addownload.b.f.a().b();
        ...
        try {
            if (z4) {
                a5.c(downloadInfo.getFailedResumeCount());
            } else if (a5.D() == -1) {
                return;
            } else {
                a5.c(-1);
            ...
            com.ss.android.downloadlib.d.a.a().a("embeded_ad", "download_uncompleted", jSONObject, a5);
        } catch (Throwable th) {
            th.printStackTrace();
        }
    }
