            ...
            downloaderBuilder.notificationClickCallback(new af() { // from class: com.ss.android.downloadlib.e.2
                private boolean d(DownloadInfo downloadInfo) {
                    ...
                    if (t5 != null) {
                        ...
                        if (a6 != null && a6.c()) {
                            a5 = com.ss.android.socialbase.downloader.g.a.a(downloadInfo.getId()).a("ad_notification_jump_url", (String) null);
                        } else {
                            a5 = com.ss.android.downloadlib.addownload.i.a(downloadInfo);
                        }
                ...
                public boolean a(DownloadInfo downloadInfo) {
                    ...
                    boolean d5 = d(downloadInfo);
                    if (a5.a("disable_delete_dialog", 0) == 1) {
                        return true;
                    }
                    return d5;
                }
                ...
                public boolean c(DownloadInfo downloadInfo) {
                    ...
                    if (a5 != null) {
                        com.ss.android.downloadlib.b.a.a(a5);
                    } else {
