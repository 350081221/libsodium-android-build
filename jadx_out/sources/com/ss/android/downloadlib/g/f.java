...
public class f {
    ...
    public static void b(DownloadInfo downloadInfo, JSONObject jSONObject) {
        ...
        if (jSONObject == null || (a5 = com.ss.android.downloadlib.addownload.b.f.a().a(downloadInfo)) == null) {
            return;
        }
        try {
            c(downloadInfo, jSONObject);
            jSONObject.putOpt("time_after_click", Long.valueOf(System.currentTimeMillis() - a5.T()));
            jSONObject.putOpt("click_download_size", Long.valueOf(a5.U()));
            jSONObject.putOpt("download_length", Long.valueOf(downloadInfo.getCurBytes()));
            jSONObject.putOpt("download_apk_size", Long.valueOf(downloadInfo.getTotalBytes()));
            a5.A();
            com.ss.android.downloadlib.addownload.b.i.a().a(a5);
            jSONObject.put("click_pause_times", a5.z());
    ...
    public static void c(DownloadInfo downloadInfo, JSONObject jSONObject) {
        ...
        if (downloadInfo != null) {
            try {
                ...
                com.ss.android.downloadad.api.a.b a5 = com.ss.android.downloadlib.addownload.b.f.a().a(downloadInfo.getId());
                if (a5 != null) {
                    jSONObject.putOpt("click_download_time", Long.valueOf(a5.T()));
                    jSONObject.putOpt("click_download_size", Long.valueOf(a5.U()));
                }
            } catch (Exception e5) {
                e5.printStackTrace();
        ...
        jSONObject.putOpt("permission_notification", Integer.valueOf(i5));
    ...
    public static void a(JSONObject jSONObject, int i5) {
        ...
        JSONArray e5 = com.ss.android.socialbase.downloader.g.a.a(i5).e("ah_report_config");
        if (e5 != null) {
            for (int i6 = 0; i6 < e5.length(); i6++) {
                try {
                    String string = e5.getString(i6);
                    g.a a5 = com.ss.android.socialbase.appdownloader.f.a.a(string);
                    if (a5 != null) {
                        jSONObject.put(string.replaceAll("\\.", "_"), a5.f() + "_" + a5.g());
                    }
                } catch (Throwable th) {
                    th.printStackTrace();
                }
    ...
    public static void a(@NonNull JSONObject jSONObject) {
        try {
            ...
            jSONObject.putOpt("pure_enhanced_mode_enable", Integer.valueOf(i5));
        } catch (Exception e5) {
            e5.printStackTrace();
        }
    }
