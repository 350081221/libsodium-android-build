...
public class a {
    ...
    /* loaded from: classes3.dex */
    public static class C0189a implements InvocationHandler {
        ...
        public Object invoke(Object obj, Method method, Object[] objArr) throws Throwable {
            ...
            return method.invoke(this.f10082a, objArr);
        }

        private C0189a(Object obj) {
            this.f10082a = obj;
        }
    }
    ...
    public static void c() {
        ...
        try {
            ...
            declaredField2.set(obj, Proxy.newProxyInstance(Thread.currentThread().getContextClassLoader(), new Class[]{cls}, new C0189a(obj2)));
        } catch (Throwable unused) {
        }
    }
    ...
    public static void a(Object[] objArr) {
        if (com.ss.android.downloadlib.addownload.k.j().optInt("hook", 0) == 1 && (objArr[1] instanceof String)) {
            ...
            if (obj instanceof Intent) {
                ...
                if ("android.intent.action.VIEW".equals(intent.getAction()) && com.ss.android.socialbase.downloader.constants.e.f10511a.equals(intent.getType())) {
                    ...
                    if (com.ss.android.socialbase.appdownloader.f.e.e()) {
                        String optString2 = com.ss.android.downloadlib.addownload.k.j().optString("hook_kllk_arg1", "com." + com.ss.android.socialbase.downloader.constants.e.f10513c + ".market");
                        if (!"null".equals(optString2)) {
                            objArr[1] = optString2;
                        }
                        String optString3 = com.ss.android.downloadlib.addownload.k.j().optString("hook_kllk_arg2", "com.android.browser");
                        String optString4 = com.ss.android.downloadlib.addownload.k.j().optString("hook_kllk_arg3", "m.store." + com.ss.android.socialbase.downloader.constants.e.f10513c + "mobile.com");
                        StringBuilder sb = new StringBuilder();
                        sb.append(com.ss.android.socialbase.downloader.constants.e.f10513c);
                        ...
                        if (com.ss.android.downloadlib.addownload.k.j().optInt("hook_kllk_arg4", 0) == 1) {
                            ...
                            intent2.putExtra(com.ss.android.socialbase.downloader.constants.e.f10513c + "_extra_pkg_name", optString3);
