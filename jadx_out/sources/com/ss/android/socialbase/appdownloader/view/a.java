...
public class a extends Fragment {
    ...
    private Intent f() {
        ...
        int i5 = e5.getApplicationInfo().uid;
    ...
    public Intent b() {
        ...
        if (!TextUtils.isEmpty(str)) {
            ...
            if (lowerCase.contains(e.f10513c)) {
        ...
        return new Intent("android.settings.APPLICATION_DETAILS_SETTINGS", Uri.parse("package:" + e5.getPackageName()));
    }
