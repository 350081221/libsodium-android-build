...
public class g {
    ...
    private static Handler f10906a = new Handler(Looper.getMainLooper());

    public static com.ss.android.socialbase.downloader.model.a a(final DownloadTask downloadTask) {
        if (downloadTask == null) {
            return null;
        }
        return new a.AbstractBinderC0220a() { // from class: com.ss.android.socialbase.downloader.i.g.1
            ...
            public int a(int i5) throws RemoteException {
                return DownloadTask.this.getDownloadListenerSize(f.e(i5));
            }

            @Override // com.ss.android.socialbase.downloader.model.a
            public com.ss.android.socialbase.downloader.depend.i b(int i5) throws RemoteException {
                return g.a(DownloadTask.this.getSingleDownloadListener(f.e(i5)), i5 != com.ss.android.socialbase.downloader.constants.f.SUB.ordinal());
            }

            @Override // com.ss.android.socialbase.downloader.model.a
            public l c(int i5) throws RemoteException {
                return g.a(DownloadTask.this.getDownloadCompleteHandlerByIndex(i5));
            }

            @Override // com.ss.android.socialbase.downloader.model.a
            public com.ss.android.socialbase.downloader.depend.i a(int i5, int i6) throws RemoteException {
                return g.a(DownloadTask.this.getDownloadListenerByIndex(f.e(i5), i6), i5 != com.ss.android.socialbase.downloader.constants.f.SUB.ordinal());
            }
        };
    }

    public static com.ss.android.socialbase.downloader.depend.i a(final IDownloadListener iDownloadListener, final boolean z4) {
        ...
        return new i.a() { // from class: com.ss.android.socialbase.downloader.i.g.12
            ...
            public void b(final DownloadInfo downloadInfo) throws RemoteException {
                if (z4) {
                    g.f10906a.post(new Runnable() { // from class: com.ss.android.socialbase.downloader.i.g.12.5
            ...
            public void c(final DownloadInfo downloadInfo) throws RemoteException {
                if (z4) {
                    g.f10906a.post(new Runnable() { // from class: com.ss.android.socialbase.downloader.i.g.12.6
                        @Override // java.lang.Runnable
                        public void run() {
            ...
            public void d(final DownloadInfo downloadInfo) throws RemoteException {
                if (z4) {
                    g.f10906a.post(new Runnable() { // from class: com.ss.android.socialbase.downloader.i.g.12.7
                        @Override // java.lang.Runnable
                        public void run() {
            ...
            public void e(final DownloadInfo downloadInfo) throws RemoteException {
                if (z4) {
                    g.f10906a.post(new Runnable() { // from class: com.ss.android.socialbase.downloader.i.g.12.8
                        @Override // java.lang.Runnable
                        public void run() {
            ...
            public void f(final DownloadInfo downloadInfo) throws RemoteException {
                if (z4) {
                    g.f10906a.post(new Runnable() { // from class: com.ss.android.socialbase.downloader.i.g.12.10
                        @Override // java.lang.Runnable
                        public void run() {
            ...
            public void g(final DownloadInfo downloadInfo) throws RemoteException {
                if (z4) {
                    g.f10906a.post(new Runnable() { // from class: com.ss.android.socialbase.downloader.i.g.12.11
                        @Override // java.lang.Runnable
                        public void run() {
            ...
            public void h(final DownloadInfo downloadInfo) throws RemoteException {
                if (z4) {
                    g.f10906a.post(new Runnable() { // from class: com.ss.android.socialbase.downloader.i.g.12.12
                        @Override // java.lang.Runnable
                        public void run() {
            ...
            public void i(final DownloadInfo downloadInfo) throws RemoteException {
                ...
                if (iDownloadListener2 instanceof s) {
                    if (z4) {
                        g.f10906a.post(new Runnable() { // from class: com.ss.android.socialbase.downloader.i.g.12.4
                            @Override // java.lang.Runnable
                            public void run() {
            ...
            public void a(final DownloadInfo downloadInfo) throws RemoteException {
                if (z4) {
                    g.f10906a.post(new Runnable() { // from class: com.ss.android.socialbase.downloader.i.g.12.1
                        @Override // java.lang.Runnable
                        public void run() {
            ...
            public void b(final DownloadInfo downloadInfo, final BaseException baseException) throws RemoteException {
                if (z4) {
                    g.f10906a.post(new Runnable() { // from class: com.ss.android.socialbase.downloader.i.g.12.2
                        @Override // java.lang.Runnable
                        public void run() {
            ...
            public void c(final DownloadInfo downloadInfo, final BaseException baseException) throws RemoteException {
                if (z4) {
                    g.f10906a.post(new Runnable() { // from class: com.ss.android.socialbase.downloader.i.g.12.3
                        @Override // java.lang.Runnable
                        public void run() {
            ...
            public void a(final DownloadInfo downloadInfo, final BaseException baseException) throws RemoteException {
                if (z4) {
                    g.f10906a.post(new Runnable() { // from class: com.ss.android.socialbase.downloader.i.g.12.9
                        @Override // java.lang.Runnable
                        public void run() {
    ...
    public static y a(final z zVar) {
        ...
        return new y.a() { // from class: com.ss.android.socialbase.downloader.i.g.23
            ...
            public void a(int i5, DownloadInfo downloadInfo, String str, String str2) throws RemoteException {
                z.this.a(i5, downloadInfo, str, str2);
            }
    ...
    public static ah a(final com.ss.android.socialbase.downloader.downloader.s sVar) {
        ...
        return new ah.a() { // from class: com.ss.android.socialbase.downloader.i.g.27
            ...
            public long a(int i5, int i6) throws RemoteException {
                return com.ss.android.socialbase.downloader.downloader.s.this.a(i5, i6);
            }
        };
    }
    ...
    public static p a(final r rVar) {
        ...
        return new p.a() { // from class: com.ss.android.socialbase.downloader.i.g.31
            ...
            public boolean a(long j5, long j6, o oVar) throws RemoteException {
                return r.this.a(j5, j6, g.a(oVar));
            }
        };
    }
    ...
    public static com.ss.android.socialbase.downloader.depend.f a(final n nVar) {
        ...
        return new f.a() { // from class: com.ss.android.socialbase.downloader.i.g.3
            ...
            public void a(DownloadInfo downloadInfo, BaseException baseException, int i5) throws RemoteException {
                n.this.a(downloadInfo, baseException, i5);
            }
        };
    }
    ...
    public static com.ss.android.socialbase.downloader.depend.e a(final com.ss.android.socialbase.downloader.downloader.h hVar) {
        ...
        return new e.a() { // from class: com.ss.android.socialbase.downloader.i.g.5
            ...
            public int a(long j5) throws RemoteException {
                return com.ss.android.socialbase.downloader.downloader.h.this.a(j5);
            }
        };
    }
    ...
    public static DownloadTask a(com.ss.android.socialbase.downloader.model.a aVar) {
        ...
        try {
            ...
            com.ss.android.socialbase.downloader.depend.i b5 = aVar.b(fVar.ordinal());
            if (b5 != null) {
                downloadTask.mainThreadListenerWithHashCode(b5.hashCode(), a(b5));
            }
            com.ss.android.socialbase.downloader.constants.f fVar2 = com.ss.android.socialbase.downloader.constants.f.SUB;
            com.ss.android.socialbase.downloader.depend.i b6 = aVar.b(fVar2.ordinal());
            if (b6 != null) {
                downloadTask.subThreadListenerWithHashCode(b6.hashCode(), a(b6));
            }
            com.ss.android.socialbase.downloader.constants.f fVar3 = com.ss.android.socialbase.downloader.constants.f.NOTIFICATION;
            com.ss.android.socialbase.downloader.depend.i b7 = aVar.b(fVar3.ordinal());
            if (b7 != null) {
                downloadTask.notificationListenerWithHashCode(b7.hashCode(), a(b7));
            }
    ...
    private static void a(DownloadTask downloadTask, com.ss.android.socialbase.downloader.model.a aVar, com.ss.android.socialbase.downloader.constants.f fVar) throws RemoteException {
        ...
        for (int i5 = 0; i5 < aVar.a(fVar.ordinal()); i5++) {
            com.ss.android.socialbase.downloader.depend.i a5 = aVar.a(fVar.ordinal(), i5);
            if (a5 != null) {
                sparseArray.put(a5.a(), a(a5));
            }
        }
    ...
    private static void a(DownloadTask downloadTask, com.ss.android.socialbase.downloader.model.a aVar) throws RemoteException {
        for (int i5 = 0; i5 < aVar.l(); i5++) {
            l c5 = aVar.c(i5);
            if (c5 != null) {
                downloadTask.addDownloadCompleteHandler(a(c5));
            }
        }
    }
    ...
    public static z a(final y yVar) {
        ...
        return new z() { // from class: com.ss.android.socialbase.downloader.i.g.7
            ...
            public void a(int i5, DownloadInfo downloadInfo, String str, String str2) {
                try {
                    y.this.a(i5, downloadInfo, str, str2);
                } catch (RemoteException e5) {
                    e5.printStackTrace();
                }
            }
        ...
        return new m() { // from class: com.ss.android.socialbase.downloader.i.g.8
            ...
            public void a(DownloadInfo downloadInfo) throws BaseException {
                try {
                    ...
                    throw new BaseException(PointerIconCompat.TYPE_TEXT, e5);
                }
            }
    ...
    public static com.ss.android.socialbase.downloader.downloader.h a(final com.ss.android.socialbase.downloader.depend.e eVar) {
        ...
        return new com.ss.android.socialbase.downloader.downloader.h() { // from class: com.ss.android.socialbase.downloader.i.g.11
            ...
            public int a(long j5) {
                try {
                    return com.ss.android.socialbase.downloader.depend.e.this.a(j5);
                } catch (RemoteException e5) {
                    e5.printStackTrace();
                    return 0;
                }
    ...
    public static n a(final com.ss.android.socialbase.downloader.depend.f fVar) {
        ...
        return new n() { // from class: com.ss.android.socialbase.downloader.i.g.13
            ...
            public void a(DownloadInfo downloadInfo, BaseException baseException, int i5) {
                ...
                try {
                    com.ss.android.socialbase.downloader.depend.f.this.a(downloadInfo, baseException, i5);
                } catch (RemoteException e5) {
                    e5.printStackTrace();
                }
            }
    ...
    public static r a(final p pVar) {
        ...
        return new r() { // from class: com.ss.android.socialbase.downloader.i.g.19
            ...
            public boolean a(long j5, long j6, q qVar) {
                try {
                    return p.this.a(j5, j6, g.a(qVar));
                } catch (RemoteException e5) {
                    e5.printStackTrace();
                    return false;
                }
