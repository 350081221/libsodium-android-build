...
public class c {
    public static void a(int i5, SparseArray<IDownloadListener> sparseArray, boolean z4, DownloadInfo downloadInfo, BaseException baseException) {
            ...
            try {
                if (sparseArray.size() > 0) {
                    ...
                    for (int i6 = 0; i6 < clone.size(); i6++) {
                        IDownloadListener iDownloadListener = clone.get(clone.keyAt(i6));
