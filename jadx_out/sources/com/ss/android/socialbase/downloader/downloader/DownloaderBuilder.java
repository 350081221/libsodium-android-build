...
public class DownloaderBuilder {
    ...
    public DownloaderBuilder downloadExpSwitch(int i5) {
        this.downloadExpSwitch = i5;
        return this;
    }
    ...
    public DownloaderBuilder maxDownloadPoolSize(int i5) {
        this.maxDownloadPoolSize = i5;
        return this;
    }
    ...
    public DownloaderBuilder writeBufferSize(int i5) {
