...
public class DownloadReceiver extends BroadcastReceiver {
    ...
    private static final String f10571a = "DownloadReceiver";
        ...
        if (context != null && intent != null) {
            ...
            if (action.equals("android.net.conn.CONNECTIVITY_CHANGE")) {
                if (com.ss.android.socialbase.downloader.c.a.a()) {
                    com.ss.android.socialbase.downloader.c.a.a(f10571a, "Received broadcast intent for android.net.conn.CONNECTIVITY_CHANGE");
                }
                a(context, action);
