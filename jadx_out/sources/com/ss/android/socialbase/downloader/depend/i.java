...
public interface i extends IInterface {
    ...
    public static abstract class a extends Binder implements i {
        ...
        public static i a(IBinder iBinder) {
            ...
            return new C0207a(iBinder);
        }

        public static i b() {
            return C0207a.f10555a;
        }
        ...
        /* loaded from: classes3.dex */
        public static class C0207a implements i {

            /* renamed from: a, reason: collision with root package name */
            public static i f10555a;

            /* renamed from: b, reason: collision with root package name */
            private IBinder f10556b;
            ...
            public int a() throws RemoteException {
                ...
                try {
                    ...
                    if (!this.f10556b.transact(1, obtain, obtain2, 0) && a.b() != null) {
                        return a.b().a();
                    }
            ...
            public void b(DownloadInfo downloadInfo) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.f10556b.transact(3, obtain, obtain2, 0) && a.b() != null) {
                        a.b().b(downloadInfo);
                    } else {
                        obtain2.readException();
                    }
            ...
            public void c(DownloadInfo downloadInfo) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.f10556b.transact(4, obtain, obtain2, 0) && a.b() != null) {
                        a.b().c(downloadInfo);
                    } else {
                        obtain2.readException();
                    }
            ...
            public void d(DownloadInfo downloadInfo) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.f10556b.transact(5, obtain, obtain2, 0) && a.b() != null) {
                        a.b().d(downloadInfo);
                    } else {
                        obtain2.readException();
                    }
            ...
            public void e(DownloadInfo downloadInfo) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.f10556b.transact(6, obtain, obtain2, 0) && a.b() != null) {
                        a.b().e(downloadInfo);
                    } else {
                        obtain2.readException();
                    }
            ...
            public void f(DownloadInfo downloadInfo) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.f10556b.transact(8, obtain, obtain2, 0) && a.b() != null) {
                        a.b().f(downloadInfo);
                    } else {
                        obtain2.readException();
                    }
            ...
            public void g(DownloadInfo downloadInfo) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.f10556b.transact(9, obtain, obtain2, 0) && a.b() != null) {
                        a.b().g(downloadInfo);
                    } else {
                        obtain2.readException();
                    }
            ...
            public void h(DownloadInfo downloadInfo) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.f10556b.transact(10, obtain, obtain2, 0) && a.b() != null) {
                        a.b().h(downloadInfo);
                    } else {
                        obtain2.readException();
                    }
            ...
            public void i(DownloadInfo downloadInfo) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.f10556b.transact(13, obtain, obtain2, 0) && a.b() != null) {
                        a.b().i(downloadInfo);
                    } else {
                        obtain2.readException();
                    }
            ...
            public void a(DownloadInfo downloadInfo) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.f10556b.transact(2, obtain, obtain2, 0) && a.b() != null) {
                        a.b().a(downloadInfo);
                    } else {
                        obtain2.readException();
                    }
            ...
            public void b(DownloadInfo downloadInfo, BaseException baseException) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.f10556b.transact(11, obtain, obtain2, 0) && a.b() != null) {
            ...
            public void c(DownloadInfo downloadInfo, BaseException baseException) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.f10556b.transact(12, obtain, obtain2, 0) && a.b() != null) {
            ...
            public void a(DownloadInfo downloadInfo, BaseException baseException) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.f10556b.transact(7, obtain, obtain2, 0) && a.b() != null) {
