...
public class AdDownloadEventConfig implements DownloadEventConfig {
    ...
    public static final class Builder {
        ...
        public Builder setDownloadScene(int i5) {
            this.eventConfig.mDownloadScene = i5;
            return this;
        }
        ...
        public Builder setIsEnableClickEvent(boolean z4) {
            this.eventConfig.mIsEnableClickEvent = z4;
            return this;
        }

        @Deprecated
        public Builder setIsEnableCompletedEvent(boolean z4) {
            return this;
        }

        @Deprecated
        public Builder setIsEnableNoChargeClickEvent(boolean z4) {
            return this;
        }

        public Builder setIsEnableV3Event(boolean z4) {
            this.eventConfig.mIsEnableV3Event = z4;
            return this;
        }
    ...
    public JSONObject toJson() {
        ...
        try {
            ...
            jSONObject.putOpt("enable_click_event", Integer.valueOf(i5));
            if (!this.mIsEnableV3Event) {
                i6 = 0;
            }
            jSONObject.putOpt("enable_v3_event", Integer.valueOf(i6));
            jSONObject.putOpt("extra", this.mExtraJson);
            jSONObject.putOpt("params_json", this.mParamsJson);
        } catch (Exception e5) {
            k.u().a(e5, "AdDownloadEventConfig toJson");
        }
        return jSONObject;
    }
