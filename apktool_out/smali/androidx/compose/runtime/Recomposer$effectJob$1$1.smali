...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroidx/compose/runtime/Recomposer;-><init>(Lkotlin/coroutines/g;)V
.end annotation
...
.method public final invoke(Ljava/lang/Throwable;)V
    ...
    .line 5
    :try_start_0
    invoke-static {v2}, Landroidx/compose/runtime/Recomposer;->access$getRunnerJob$p(Landroidx/compose/runtime/Recomposer;)Lkotlinx/coroutines/l2;
    ...
    .line 6
    invoke-static {v2}, Landroidx/compose/runtime/Recomposer;->access$get_state$p(Landroidx/compose/runtime/Recomposer;)Lkotlinx/coroutines/flow/e0;

    move-result-object v5

    sget-object v6, Landroidx/compose/runtime/Recomposer$State;->ShuttingDown:Landroidx/compose/runtime/Recomposer$State;

    invoke-interface {v5, v6}, Lkotlinx/coroutines/flow/e0;->setValue(Ljava/lang/Object;)V
    ...
    .line 8
    invoke-interface {v3, v0}, Lkotlinx/coroutines/l2;->cancel(Ljava/util/concurrent/CancellationException;)V

    goto :goto_0

    .line 9
    :cond_0
    invoke-static {v2}, Landroidx/compose/runtime/Recomposer;->access$getWorkContinuation$p(Landroidx/compose/runtime/Recomposer;)Lkotlinx/coroutines/p;
    ...
    .line 11
    :goto_1
    invoke-static {v2, v4}, Landroidx/compose/runtime/Recomposer;->access$setWorkContinuation$p(Landroidx/compose/runtime/Recomposer;Lkotlinx/coroutines/p;)V
    ...
    invoke-interface {v3, v4}, Lkotlinx/coroutines/l2;->t0(Lv3/l;)Lkotlinx/coroutines/n1;
