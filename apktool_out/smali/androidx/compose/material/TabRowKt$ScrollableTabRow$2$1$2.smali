...
.field final synthetic $layoutHeight:Lkotlin/jvm/internal/k1$f;

.field final synthetic $layoutWidth:Lkotlin/jvm/internal/k1$f;
...
# direct methods
.method constructor <init>(ILjava/util/List;Landroidx/compose/ui/layout/SubcomposeMeasureScope;Lv3/p;Landroidx/compose/material/ScrollableTabData;IJLkotlin/jvm/internal/k1$f;Lkotlin/jvm/internal/k1$f;Lv3/q;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(I",
    ...
    iput-object p4, p0, Landroidx/compose/material/TabRowKt$ScrollableTabRow$2$1$2;->$divider:Lv3/p;
    ...
    iput-object p9, p0, Landroidx/compose/material/TabRowKt$ScrollableTabRow$2$1$2;->$layoutWidth:Lkotlin/jvm/internal/k1$f;

    iput-object p10, p0, Landroidx/compose/material/TabRowKt$ScrollableTabRow$2$1$2;->$layoutHeight:Lkotlin/jvm/internal/k1$f;

    iput-object p11, p0, Landroidx/compose/material/TabRowKt$ScrollableTabRow$2$1$2;->$indicator:Lv3/q;
...
.method public final invoke(Landroidx/compose/ui/layout/Placeable$PlacementScope;)V
    ...
    invoke-direct {v7, v8, v9, v10}, Landroidx/compose/material/TabPosition;-><init>(FFLkotlin/jvm/internal/w;)V
    ...
    iget-object v4, v0, Landroidx/compose/material/TabRowKt$ScrollableTabRow$2$1$2;->$divider:Lv3/p;

    invoke-interface {v2, v3, v4}, Landroidx/compose/ui/layout/SubcomposeMeasureScope;->subcompose(Ljava/lang/Object;Lv3/p;)Ljava/util/List;

    move-result-object v2

    iget-wide v3, v0, Landroidx/compose/material/TabRowKt$ScrollableTabRow$2$1$2;->$constraints:J

    iget-object v5, v0, Landroidx/compose/material/TabRowKt$ScrollableTabRow$2$1$2;->$layoutWidth:Lkotlin/jvm/internal/k1$f;

    iget-object v15, v0, Landroidx/compose/material/TabRowKt$ScrollableTabRow$2$1$2;->$layoutHeight:Lkotlin/jvm/internal/k1$f;
    ...
    .line 15
    iget v10, v5, Lkotlin/jvm/internal/k1$f;->element:I
    ...
    .line 18
    iget v6, v15, Lkotlin/jvm/internal/k1$f;->element:I
    ...
    iget-object v5, v0, Landroidx/compose/material/TabRowKt$ScrollableTabRow$2$1$2;->$indicator:Lv3/q;

    invoke-direct {v4, v5, v1}, Landroidx/compose/material/TabRowKt$ScrollableTabRow$2$1$2$3;-><init>(Lv3/q;Ljava/util/List;)V
    ...
    .line 20
    iget-object v3, v0, Landroidx/compose/material/TabRowKt$ScrollableTabRow$2$1$2;->$layoutWidth:Lkotlin/jvm/internal/k1$f;

    iget-object v4, v0, Landroidx/compose/material/TabRowKt$ScrollableTabRow$2$1$2;->$layoutHeight:Lkotlin/jvm/internal/k1$f;
    ...
    iget v9, v3, Lkotlin/jvm/internal/k1$f;->element:I

    iget v10, v4, Lkotlin/jvm/internal/k1$f;->element:I
