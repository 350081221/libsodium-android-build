...
.method private final connectSocket(IILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    .line 81
    :try_start_1
    invoke-static {v1}, Lokio/y0;->v(Ljava/net/Socket;)Lokio/n1;
    ...
    .line 90
    .line 91
    invoke-static {v1}, Lokio/y0;->q(Ljava/net/Socket;)Lokio/l1;
    ...
    .line 99
    iput-object p1, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lokio/m;
    :try_end_1
...
.method private final connectTls(Lokhttp3/internal/connection/ConnectionSpecSelector;)V
    ...
    .line 217
    invoke-static {p1, v2, v6, v2}, Lkotlin/text/v;->r(Ljava/lang/String;Ljava/lang/String;ILjava/lang/Object;)Ljava/lang/String;
    ...
    .line 286
    .line 287
    invoke-direct {v5, v6, v7, v8, v9}, Lokhttp3/Handshake;-><init>(Lokhttp3/TlsVersion;Lokhttp3/CipherSuite;Ljava/util/List;Lv3/a;)V
    ...
    .line 304
    .line 305
    invoke-virtual {v3, v0, v4}, Lokhttp3/CertificatePinner;->check$okhttp(Ljava/lang/String;Lv3/a;)V
...
.method private final connectTunnel(IIILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    .line 33
    .line 34
    iput-object v3, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lokio/m;
...
.method private final createTunnel(IILokhttp3/Request;Lokhttp3/HttpUrl;)Lokhttp3/Request;
    ...
    .line 32
    .line 33
    iget-object v2, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lokio/m;
    ...
    .line 41
    invoke-direct {v3, v4, p0, v0, v2}, Lokhttp3/internal/http1/Http1ExchangeCodec;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/RealConnection;Lokio/BufferedSource;Lokio/m;)V
    ...
    .line 50
    .line 51
    invoke-virtual {v5, v6, v7, v8}, Lokio/p1;->timeout(JLjava/util/concurrent/TimeUnit;)Lokio/p1;
    ...
    .line 129
    .line 130
    invoke-static {v2, p3, v1}, Lkotlin/text/v;->K1(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    .line 174
    :cond_3
    invoke-interface {v0}, Lokio/BufferedSource;->g()Lokio/l;
    ...
    .line 178
    invoke-virtual {p1}, Lokio/l;->e0()Z
    ...
    .line 183
    .line 184
    invoke-interface {v2}, Lokio/m;->g()Lokio/l;
...
.method private final createTunnelRequest()Lokhttp3/Request;
    ...
    .line 115
    :cond_1
    invoke-static {v1, v2}, Lcom/huawei/agconnect/apms/instrument/okhttp3/OkHttp3Instrumentation;->body(Lokhttp3/Response$Builder;Lokhttp3/ResponseBody;)Lokhttp3/Response$Builder;
...
.method private final startHttp2(I)V
    ...
    .line 42
    invoke-virtual {v4, v0, v5, v1, v2}, Lokhttp3/internal/http2/Http2Connection$Builder;->socket(Ljava/net/Socket;Ljava/lang/String;Lokio/BufferedSource;Lokio/m;)Lokhttp3/internal/http2/Http2Connection$Builder;
...
.method public final connect(IIIIZLokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    .line 280
    .line 281
    iput-object v12, v7, Lokhttp3/internal/connection/RealConnection;->sink:Lokio/m;
...
.method public final newCodec$okhttp(Lokhttp3/OkHttpClient;Lokhttp3/internal/http/RealInterceptorChain;)Lokhttp3/internal/http/ExchangeCodec;
    ...
    .line 42
    .line 43
    invoke-interface {v1}, Lokio/n1;->timeout()Lokio/p1;
    ...
    .line 53
    .line 54
    invoke-virtual {v0, v3, v4, v5}, Lokio/p1;->timeout(JLjava/util/concurrent/TimeUnit;)Lokio/p1;
    ...
    .line 70
    .line 71
    invoke-direct {v0, p1, p0, v1, v2}, Lokhttp3/internal/http1/Http1ExchangeCodec;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/RealConnection;Lokio/BufferedSource;Lokio/m;)V
...
.method public final newWebSocketStreams$okhttp(Lokhttp3/internal/connection/Exchange;)Lokhttp3/internal/ws/RealWebSocket$Streams;
    ...
    .line 29
    .line 30
    invoke-direct {v0, v1, v2, p1}, Lokhttp3/internal/connection/RealConnection$newWebSocketStreams$1;-><init>(Lokio/BufferedSource;Lokio/m;Lokhttp3/internal/connection/Exchange;)V
