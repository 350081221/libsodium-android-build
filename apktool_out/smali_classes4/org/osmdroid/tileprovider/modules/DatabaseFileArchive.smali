...
.method public getImage(Lorg/osmdroid/tileprovider/tilesource/e;J)[B
    .locals 12
    ...
    .line 43
    iget-boolean v0, p0, Lorg/osmdroid/tileprovider/modules/DatabaseFileArchive;->mIgnoreTileSource:Z
    :try_end_0
    ...
    .line 216
    invoke-interface {p1}, Lorg/osmdroid/config/c;->k()Z
    ...
    .line 221
    .line 222
    const-string p1, "Skipping DatabaseFileArchive lookup, database is closed"
...
.method public getInputStream(Lorg/osmdroid/tileprovider/tilesource/e;J)Ljava/io/InputStream;
    ...
    .line 2
    :try_start_0
    invoke-virtual {p0, p1, p2, p3}, Lorg/osmdroid/tileprovider/modules/DatabaseFileArchive;->getImage(Lorg/osmdroid/tileprovider/tilesource/e;J)[B
...
.method public getTileSources()Ljava/util/Set;
    ...
    .line 20
    :cond_0
    invoke-static {v1, v2, v4}, Lcom/huawei/agconnect/apms/instrument/SQLiteInstrumentation;->rawQuery(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;[Ljava/lang/String;)Landroid/database/Cursor;
