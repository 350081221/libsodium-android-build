...
.method public a(Lcom/ss/android/download/api/config/b;)Lcom/ss/android/download/api/a;
    ...
    .line 8
    invoke-static {p1}, Lcom/ss/android/downloadlib/addownload/k;->a(Lcom/ss/android/download/api/config/b;)V
...
.method public a(Lcom/ss/android/download/api/config/g;)Lcom/ss/android/download/api/a;
    ...
    .line 2
    invoke-static {p1}, Lcom/ss/android/downloadlib/addownload/k;->a(Lcom/ss/android/download/api/config/g;)V
...
.method public a(Lcom/ss/android/download/api/config/h;)Lcom/ss/android/download/api/a;
    ...
    .line 4
    invoke-static {p1}, Lcom/ss/android/downloadlib/addownload/k;->a(Lcom/ss/android/download/api/config/h;)V
...
.method public a(Lcom/ss/android/download/api/config/i;)Lcom/ss/android/download/api/a;
    ...
    .line 1
    invoke-static {p1}, Lcom/ss/android/downloadlib/addownload/k;->a(Lcom/ss/android/download/api/config/i;)V

    return-object p0
.end method

.method public a(Lcom/ss/android/download/api/config/j;)Lcom/ss/android/download/api/a;
    .locals 0
    ...
    .line 5
    invoke-static {p1}, Lcom/ss/android/downloadlib/addownload/k;->a(Lcom/ss/android/download/api/config/j;)V

    return-object p0
.end method

.method public a(Lcom/ss/android/download/api/config/l;)Lcom/ss/android/download/api/a;
    .locals 0
    .param p1    # Lcom/ss/android/download/api/config/l;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param

    .line 3
    invoke-static {p1}, Lcom/ss/android/downloadlib/addownload/k;->a(Lcom/ss/android/download/api/config/l;)V

    return-object p0
.end method

.method public a(Lcom/ss/android/download/api/config/q;)Lcom/ss/android/download/api/a;
    .locals 0

    .line 15
    invoke-static {p1}, Lcom/ss/android/downloadlib/addownload/k;->a(Lcom/ss/android/download/api/config/q;)V
...
.method public a(Lcom/ss/android/download/api/model/a;)Lcom/ss/android/download/api/a;
    ...
    .line 6
    invoke-static {p1}, Lcom/ss/android/downloadlib/addownload/k;->a(Lcom/ss/android/download/api/model/a;)V
...
.method public a()V
    ...
    .line 16
    invoke-static {}, Lcom/ss/android/downloadlib/addownload/k;->x()Z
    ...
    invoke-static {v0}, Lcom/ss/android/downloadlib/addownload/k;->a(Lcom/ss/android/download/api/b/a;)V
    ...
    invoke-static {}, Lcom/ss/android/downloadlib/addownload/k;->w()Ljava/lang/String;
