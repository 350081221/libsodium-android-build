...
.method synthetic constructor <init>(Lcom/lody/virtual/server/pm/VPackageManagerService$1;)V
    ...
    .line 3
    invoke-direct {p0}, Lcom/lody/virtual/server/pm/VPackageManagerService$ActivityIntentResolver;-><init>()V

    return-void
.end method

.method static synthetic access$300(Lcom/lody/virtual/server/pm/VPackageManagerService$ActivityIntentResolver;)Ljava/util/HashMap;
    .locals 0
...
.method public final addActivity(Lcom/lody/virtual/server/pm/parser/VPackage$ActivityComponent;Ljava/lang/String;)V
    ...
    .line 2
    .line 3
    invoke-virtual {p1}, Lcom/lody/virtual/server/pm/parser/VPackage$Component;->getComponentName()Landroid/content/ComponentName;
    ...
    .line 9
    .line 10
    iget-object v0, p1, Lcom/lody/virtual/server/pm/parser/VPackage$Component;->intents:Ljava/util/ArrayList;
    ...
    .line 72
    .line 73
    iget-object v5, p1, Lcom/lody/virtual/server/pm/parser/VPackage$Component;->className:Ljava/lang/String;
    ...
    .line 92
    :cond_0
    invoke-virtual {p0, v3}, Lcom/lody/virtual/server/pm/IntentResolver;->addFilter(Lcom/lody/virtual/server/pm/parser/VPackage$IntentInfo;)V
...
.method protected isPackageForFilter(Ljava/lang/String;Lcom/lody/virtual/server/pm/parser/VPackage$ActivityIntentInfo;)Z
    ...
    iget-object p2, p2, Lcom/lody/virtual/server/pm/parser/VPackage$Component;->owner:Lcom/lody/virtual/server/pm/parser/VPackage;
...
.method protected newResult(Lcom/lody/virtual/server/pm/parser/VPackage$ActivityIntentInfo;II)Landroid/content/pm/ResolveInfo;
    ...
    .line 3
    iget-object v1, v0, Lcom/lody/virtual/server/pm/parser/VPackage$Component;->owner:Lcom/lody/virtual/server/pm/parser/VPackage;
    ...
    .line 4
    iget-object v2, v0, Lcom/lody/virtual/server/pm/parser/VPackage$ActivityComponent;->info:Landroid/content/pm/ActivityInfo;

    iget v3, p0, Lcom/lody/virtual/server/pm/VPackageManagerService$ActivityIntentResolver;->mFlags:I

    invoke-virtual {v1, v2, v3, p3}, Lcom/lody/virtual/server/pm/PackageSetting;->isEnabledAndMatchLPr(Landroid/content/pm/ComponentInfo;II)Z
    ...
    invoke-static {v0, v2, v4, p3, v1}, Lcom/lody/virtual/server/pm/parser/PackageParserEx;->generateActivityInfo(Lcom/lody/virtual/server/pm/parser/VPackage$ActivityComponent;ILcom/lody/virtual/server/pm/PackageUserState;IZ)Landroid/content/pm/ActivityInfo;
    ...
    .line 9
    iget-object p3, p1, Lcom/lody/virtual/server/pm/parser/VPackage$IntentInfo;->filter:Landroid/content/IntentFilter;
    ...
    .line 11
    iget-object p3, v0, Lcom/lody/virtual/server/pm/parser/VPackage$Component;->owner:Lcom/lody/virtual/server/pm/parser/VPackage;
    ...
    .line 13
    iget-boolean p2, p1, Lcom/lody/virtual/server/pm/parser/VPackage$IntentInfo;->hasDefault:Z

    iput-boolean p2, v1, Landroid/content/pm/ResolveInfo;->isDefault:Z

    .line 14
    iget p2, p1, Lcom/lody/virtual/server/pm/parser/VPackage$IntentInfo;->labelRes:I

    iput p2, v1, Landroid/content/pm/ResolveInfo;->labelRes:I

    .line 15
    iget-object p2, p1, Lcom/lody/virtual/server/pm/parser/VPackage$IntentInfo;->nonLocalizedLabel:Ljava/lang/String;

    iput-object p2, v1, Landroid/content/pm/ResolveInfo;->nonLocalizedLabel:Ljava/lang/CharSequence;

    .line 16
    iget p1, p1, Lcom/lody/virtual/server/pm/parser/VPackage$IntentInfo;->icon:I
...
.method queryIntentForPackage(Landroid/content/Intent;Ljava/lang/String;ILjava/util/ArrayList;I)Ljava/util/List;
    ...
    .line 33
    .line 34
    iget-object v1, v1, Lcom/lody/virtual/server/pm/parser/VPackage$Component;->intents:Ljava/util/ArrayList;
...
.method public final removeActivity(Lcom/lody/virtual/server/pm/parser/VPackage$ActivityComponent;Ljava/lang/String;)V
    ...
    .line 9
    .line 10
    iget-object p2, p1, Lcom/lody/virtual/server/pm/parser/VPackage$Component;->intents:Ljava/util/ArrayList;
    ...
    .line 18
    .line 19
    iget-object v1, p1, Lcom/lody/virtual/server/pm/parser/VPackage$Component;->intents:Ljava/util/ArrayList;
    ...
    .line 26
    .line 27
    invoke-virtual {p0, v1}, Lcom/lody/virtual/server/pm/IntentResolver;->removeFilter(Lcom/lody/virtual/server/pm/parser/VPackage$IntentInfo;)V
