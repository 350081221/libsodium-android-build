...
.method private createView(Landroid/content/Context;Landroid/widget/RemoteViews;Z)Landroid/view/View;
    .locals 4
    ...
    .line 15
    .line 16
    iget p3, p0, Lcom/lody/virtual/server/notification/RemoteViewsFixer;->notification_max_height:I
    ...
    .line 19
    :cond_1
    iget p3, p0, Lcom/lody/virtual/server/notification/RemoteViewsFixer;->notification_min_height:I

    .line 20
    .line 21
    :goto_0
    iget-object v1, p0, Lcom/lody/virtual/server/notification/RemoteViewsFixer;->mWidthCompat:Lcom/lody/virtual/server/notification/WidthCompat;

    .line 22
    .line 23
    iget v2, p0, Lcom/lody/virtual/server/notification/RemoteViewsFixer;->notification_panel_width:I

    .line 24
    .line 25
    iget v3, p0, Lcom/lody/virtual/server/notification/RemoteViewsFixer;->notification_side_padding:I

    .line 26
    .line 27
    invoke-virtual {v1, v0, v2, p3, v3}, Lcom/lody/virtual/server/notification/WidthCompat;->getNotificationWidth(Landroid/content/Context;III)I
    ...
    .line 60
    .line 61
    invoke-static {p2, v2}, Lcom/lody/virtual/helper/utils/VLog;->v(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 70
    invoke-virtual {v1, p1, p1, v0, p3}, Landroid/view/View;->layout(IIII)V
    ...
    .line 92
    invoke-virtual {v1, p1, p1, v0, p2}, Landroid/view/View;->layout(IIII)V
...
.method private init(Landroid/content/Context;)V
    ...
    .line 25
    .line 26
    invoke-direct {p0, p1, v0, v1, v2}, Lcom/lody/virtual/server/notification/RemoteViewsFixer;->getDimem(Landroid/content/Context;Landroid/content/Context;Ljava/lang/String;I)I
...
.method public makeRemoteViews(Ljava/lang/String;Landroid/content/Context;Landroid/widget/RemoteViews;ZZ)Landroid/widget/RemoteViews;
    ...
    .line 5
    :cond_0
    new-instance p1, Lcom/lody/virtual/server/notification/PendIntentCompat;

    .line 6
    .line 7
    invoke-direct {p1, p3}, Lcom/lody/virtual/server/notification/PendIntentCompat;-><init>(Landroid/widget/RemoteViews;)V
    ...
    .line 11
    .line 12
    invoke-virtual {p1}, Lcom/lody/virtual/server/notification/PendIntentCompat;->findPendIntents()I
    ...
    .line 19
    :cond_1
    sget v0, Lcom/lody/virtual/R$layout;->custom_notification:I
    ...
    :cond_2
    :goto_0
    sget v0, Lcom/lody/virtual/R$layout;->custom_notification_lite:I

    .line 23
    .line 24
    :goto_1
    sget-object v1, Lmirror/android/widget/RemoteViews;->ctor:Lmirror/RefConstructor;
    ...
    .line 59
    .line 60
    iget-object v4, p0, Lcom/lody/virtual/server/notification/RemoteViewsFixer;->mNotificationCompat:Lcom/lody/virtual/server/notification/NotificationCompat;

    .line 61
    .line 62
    invoke-virtual {v4}, Lcom/lody/virtual/server/notification/NotificationCompat;->getHostContext()Landroid/content/Context;
    ...
    .line 73
    :goto_2
    invoke-virtual {p0, p2, p3, p4}, Lcom/lody/virtual/server/notification/RemoteViewsFixer;->toView(Landroid/content/Context;Landroid/widget/RemoteViews;Z)Landroid/view/View;
    ...
    .line 81
    sget v4, Lcom/lody/virtual/R$id;->im_main:I
    ...
    .line 87
    .line 88
    sget p3, Lcom/lody/virtual/R$layout;->custom_notification:I
    ...
    .line 92
    :try_start_0
    iget-object p3, p0, Lcom/lody/virtual/server/notification/RemoteViewsFixer;->mNotificationCompat:Lcom/lody/virtual/server/notification/NotificationCompat;

    .line 93
    .line 94
    invoke-virtual {p3}, Lcom/lody/virtual/server/notification/NotificationCompat;->getHostContext()Landroid/content/Context;
    ...
    .line 98
    invoke-virtual {p0, p3, v1, p4}, Lcom/lody/virtual/server/notification/RemoteViewsFixer;->toView(Landroid/content/Context;Landroid/widget/RemoteViews;Z)Landroid/view/View;
    ...
    .line 102
    invoke-virtual {p1, v1, p3, p2}, Lcom/lody/virtual/server/notification/PendIntentCompat;->setPendIntent(Landroid/widget/RemoteViews;Landroid/view/View;Landroid/view/View;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 114
    .line 115
    invoke-static {p2, p1, p3}, Lcom/lody/virtual/helper/utils/VLog;->e(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method toView(Landroid/content/Context;Landroid/widget/RemoteViews;Z)Landroid/view/View;
    .locals 0

    .line 1
    :try_start_0
    invoke-direct {p0, p1, p2, p3}, Lcom/lody/virtual/server/notification/RemoteViewsFixer;->createView(Landroid/content/Context;Landroid/widget/RemoteViews;Z)Landroid/view/View;
