...
# direct methods
.method public static lmn()Lorg/json/JSONArray;
    .locals 4
    ...
    :catch_0
    const-string v0, "ABTskIdHolder"

    const-string v1, "cache abProperty is error, json exception"
...
.method public static lmn(Lorg/json/JSONArray;)Lorg/json/JSONArray;
    ...
    :catch_0
    const-string v3, "ABTskIdHolder"

    const-string v4, "cache ab info is error"
