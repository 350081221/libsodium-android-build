...
.method public constructor <init>(Lcom/huawei/agconnect/common/api/BackendService$Options;)V
    ...
    invoke-static {p1}, Lcom/huawei/agconnect/common/api/BackendService$Options;->access$400(Lcom/huawei/agconnect/common/api/BackendService$Options;)Lcom/huawei/agconnect/common/api/RequestThrottle$Throttle;
    ...
    invoke-static {p1}, Lcom/huawei/agconnect/common/api/BackendService$Options;->access$500(Lcom/huawei/agconnect/common/api/BackendService$Options;)Lcom/huawei/agconnect/common/api/BackendService$AccessTokenType;

    move-result-object v0

    iput-object v0, p0, Lcom/huawei/agconnect/common/api/BackendService$Options$Builder;->accessTokenType:Lcom/huawei/agconnect/common/api/BackendService$AccessTokenType;

    invoke-static {p1}, Lcom/huawei/agconnect/common/api/BackendService$Options;->access$600(Lcom/huawei/agconnect/common/api/BackendService$Options;)Lcom/huawei/agconnect/https/Adapter$Factory;
    ...
    invoke-static {p1}, Lcom/huawei/agconnect/common/api/BackendService$Options;->access$700(Lcom/huawei/agconnect/common/api/BackendService$Options;)J

    move-result-wide v0

    iput-wide v0, p0, Lcom/huawei/agconnect/common/api/BackendService$Options$Builder;->timeout:J

    invoke-static {p1}, Lcom/huawei/agconnect/common/api/BackendService$Options;->access$800(Lcom/huawei/agconnect/common/api/BackendService$Options;)Ljava/util/concurrent/TimeUnit;
    ...
    invoke-static {p1}, Lcom/huawei/agconnect/common/api/BackendService$Options;->access$900(Lcom/huawei/agconnect/common/api/BackendService$Options;)Lcom/huawei/agconnect/AGConnectInstance;
...
.method public build()Lcom/huawei/agconnect/common/api/BackendService$Options;
    ...
    new-instance v12, Lcom/huawei/agconnect/common/api/BackendService$Options;
    ...
    invoke-direct/range {v0 .. v11}, Lcom/huawei/agconnect/common/api/BackendService$Options;-><init>(ZZZLcom/huawei/agconnect/common/api/RequestThrottle$Throttle;Lcom/huawei/agconnect/common/api/BackendService$AccessTokenType;Lcom/huawei/agconnect/https/Adapter$Factory;JLjava/util/concurrent/TimeUnit;Lcom/huawei/agconnect/AGConnectInstance;Lcom/huawei/agconnect/common/api/BackendService$1;)V
